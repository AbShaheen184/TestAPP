...
public final class c {
    ...
    public c(androidx.navigationevent.c cVar, c0 c0Var) {
        ...
        kotlinx.coroutines.future.a.q("At least one dispatcher (NavigationEventDispatcher or OnBackPressedDispatcher) must be non-null.");
        throw null;
    }
    ...
    public final void b(b bVar) throws Exception {
