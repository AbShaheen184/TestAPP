...
public abstract class p extends androidx.core.app.b implements y0, androidx.lifecycle.j, androidx.savedstate.g, e0, androidx.navigationevent.d, androidx.activity.result.i {
    ...
    public p() {
        ...
        if (getLifecycle() == null) {
            kotlinx.coroutines.future.a.u("getLifecycle() returned null in ComponentActivity's constructor. Please make sure you are lazily constructing your Lifecycle in the first call to getLifecycle() rather than relying on field initialization.");
            throw null;
        }
        final int i = 0;
    ...
    public androidx.lifecycle.viewmodel.c getDefaultViewModelCreationExtras() {
        ...
        if (application != null) {
            linkedHashMap.put(t0.d, getApplication());
        }
    ...
    public x0 getViewModelStore() {
        if (getApplication() == null) {
            kotlinx.coroutines.future.a.u("Your activity is not yet attached to the Application instance. You can't request ViewModel before onCreate call.");
            return null;
        }
    ...
    public void onPictureInPictureUiStateChanged(PictureInPictureUiState pictureInPictureUiState) {
        ...
        com.google.android.material.shape.f fVarB = androidx.compose.ui.text.android.i.b(pictureInPictureUiState);
        Iterator<androidx.core.util.a> it = this.onPictureInPictureUiStateChangedListeners.iterator();
        it.getClass();
        while (it.hasNext()) {
            it.next().accept(fVarB);
        }
    }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if (x0Var == null && objOnRetainCustomNonConfigurationInstance == null) {
            return null;
        }
        j jVar2 = new j();
    ...
    public final <I, O> androidx.activity.result.c registerForActivityResult(final androidx.activity.result.contract.a aVar, final androidx.activity.result.h hVar, final androidx.activity.result.b bVar) {
        ...
        androidx.lifecycle.t tVar = new androidx.lifecycle.t() { // from class: androidx.activity.result.d
            ...
            public final void g(v vVar, n nVar) {
                ...
                a aVar3 = (a) androidx.work.impl.v.A(str2, bundle);
                if (aVar3 != null) {
                    bundle.remove(str2);
    ...
    public void reportFullyDrawn() {
        try {
            if (kotlin.math.a.w()) {
                Trace.beginSection(kotlin.math.a.S("reportFullyDrawn() for ComponentActivity"));
            }
