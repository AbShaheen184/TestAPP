...
public abstract class r extends Dialog implements androidx.lifecycle.v, e0, androidx.navigationevent.d, androidx.savedstate.g {
    ...
    public r(ContextThemeWrapper contextThemeWrapper, int i) {
        super(contextThemeWrapper, 0);
        this.y = new androidx.savedstate.f(new androidx.savedstate.internal.a(this, new androidx.navigation.internal.h(this, 6)));
        final int i2 = 0;
