...
public class j implements Menu {
    ...
    public com.google.firebase.platforminfo.d e;
    ...
    public j(Context context) {
        ...
        if (resources.getConfiguration().keyboard != 1) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                zD = androidx.arch.core.executor.d.D(viewConfiguration);
            } else {
    ...
    public final k a(int i, int i2, int i3, CharSequence charSequence) {
        ...
        int i5 = ((-65536) & i3) >> 16;
        if (i5 < 0 || i5 >= 6) {
            kotlinx.coroutines.future.a.q("order does not contain a valid category.");
            return null;
        }
    ...
    public boolean e(j jVar, MenuItem menuItem) {
        ...
        com.google.firebase.platforminfo.d dVar = this.e;
        return (dVar == null || (mVar = ((ActionMenuView) dVar.e).V) == null || !((Toolbar) ((com.google.firebase.platforminfo.d) mVar).e).g0.a()) ? false : true;
    }
