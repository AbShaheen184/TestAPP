...
public final class k implements MenuItem {
    ...
    public final Drawable getIcon() {
        ...
        Drawable drawableV = v.v(this.n.a, i);
        this.m = 0;
        this.l = drawableV;
        return b(drawableV);
    }
    ...
    public final void setShowAsAction(int i) {
        int i2 = i & 3;
        if (i2 != 0 && i2 != 1 && i2 != 2) {
            kotlinx.coroutines.future.a.q("SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually exclusive.");
            return;
        }
        this.y = i;
        j jVar = this.n;
