...
public class ActionBarOverlayLayout extends ViewGroup implements androidx.core.view.p, androidx.core.view.q {
        ...
        if (this.y == null) {
            ...
            if (callbackFindViewById instanceof s0) {
                ...
                if (!(callbackFindViewById instanceof Toolbar)) {
                    kotlinx.coroutines.future.a.u("Can't make a decor toolbar out of ".concat(callbackFindViewById.getClass().getSimpleName()));
                    return;
                }
    ...
    public void setIcon(int i) {
        j();
        m2 m2Var = (m2) this.A;
        m2Var.d = i != 0 ? androidx.work.impl.v.v(m2Var.a.getContext(), i) : null;
        m2Var.c();
    }
    ...
    public void setLogo(int i) {
        j();
        m2 m2Var = (m2) this.A;
        m2Var.e = i != 0 ? androidx.work.impl.v.v(m2Var.a.getContext(), i) : null;
        m2Var.c();
    }
