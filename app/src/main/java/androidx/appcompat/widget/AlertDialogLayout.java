    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int i12 = ((LinearLayout.LayoutParams) d1Var).gravity;
                if (i12 < 0) {
                    i12 = i10;
                }
                ...
                if (absoluteGravity != 1) {
                    if (absoluteGravity != 5) {
                        i7 = ((LinearLayout.LayoutParams) d1Var).leftMargin + paddingLeft;
                    } else {
                        i5 = paddingRight - measuredWidth;
                        i6 = ((LinearLayout.LayoutParams) d1Var).rightMargin;
                    }
                    if (h(i11)) {
                        paddingTop += intrinsicHeight;
                    }
                    int i13 = paddingTop + ((LinearLayout.LayoutParams) d1Var).topMargin;
                    childAt.layout(i7, i13, measuredWidth + i7, i13 + measuredHeight2);
                    paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) d1Var).bottomMargin + i13;
                } else {
                    i5 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + ((LinearLayout.LayoutParams) d1Var).leftMargin;
                    i6 = ((LinearLayout.LayoutParams) d1Var).rightMargin;
                }
                i7 = i5 - i6;
                if (h(i11)) {
                ...
                int i14 = paddingTop + ((LinearLayout.LayoutParams) d1Var).topMargin;
                childAt.layout(i7, i14, measuredWidth + i7, i14 + measuredHeight2);
                paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) d1Var).bottomMargin + i14;
            }
        }
    }
            ...
            while (i9 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) d1Var).width == -1) {
                        int i10 = ((LinearLayout.LayoutParams) d1Var).height;
                        ...
                        ((LinearLayout.LayoutParams) d1Var).height = i10;
                    }
                }
                i9++;
