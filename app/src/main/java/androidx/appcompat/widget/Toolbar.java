...
public class Toolbar extends ViewGroup {
    ...
    public ArrayList h0;
    public final com.google.firebase.platforminfo.d i0;
    public m2 j0;
    public h2 k0;
    public boolean l0;
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.i0 = new com.google.firebase.platforminfo.d((Object) this);
        this.p0 = new z0(this, 2);
        Context context2 = getContext();
        int[] iArr = androidx.appcompat.a.s;
        c2 c2VarR = c2.R(context2, attributeSet, iArr, R.attr.toolbarStyle);
        androidx.core.view.s0.l(this, context, iArr, attributeSet, (TypedArray) c2VarR.z, R.attr.toolbarStyle);
        ...
        Drawable drawableC = c2VarR.C(16);
        if (drawableC != null) {
        ...
        Drawable drawableC2 = c2VarR.C(11);
        if (drawableC2 != null) {
            setLogo(drawableC2);
        }
        ...
        if (typedArray.hasValue(29)) {
            setTitleTextColor(c2VarR.y(29));
        }
        if (typedArray.hasValue(20)) {
            setSubtitleTextColor(c2VarR.y(20));
        }
    ...
    public s0 getWrapper() {
        ...
        if (this.j0 == null) {
            ...
            c2 c2VarR = c2.R(getContext(), null, androidx.appcompat.a.a, R.attr.actionBarStyle);
            TypedArray typedArray = (TypedArray) c2VarR.z;
            m2Var.l = c2VarR.C(15);
            ...
            Drawable drawableC = c2VarR.C(20);
            if (drawableC != null) {
                m2Var.e = drawableC;
                m2Var.c();
            }
            Drawable drawableC2 = c2VarR.C(17);
            if (drawableC2 != null) {
                m2Var.d = drawableC2;
                m2Var.c();
            }
    ...
    public void setNavigationContentDescription(CharSequence charSequence) {
        ...
        if (wVar != null) {
            wVar.setContentDescription(charSequence);
            coil3.svg.internal.a.Q(this.A, charSequence);
        }
    }
    ...
    public void setCollapseIcon(int i) {
        setCollapseIcon(androidx.work.impl.v.v(getContext(), i));
    }
    ...
    public void setNavigationIcon(int i) {
        setNavigationIcon(androidx.work.impl.v.v(getContext(), i));
    }

    public void setLogo(int i) {
        setLogo(androidx.work.impl.v.v(getContext(), i));
    }
