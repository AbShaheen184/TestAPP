    ...
    public void setVisibility(int i) {
        ...
        if (weakReference != null) {
            ...
            if (view != null) {
                ...
                kotlinx.coroutines.future.a.u("setVisibility called on un-referenced view");
                return;
            }
        }
        ...
        if (i == 0 || i == 4) {
            ...
            if (!(parent instanceof ViewGroup)) {
                kotlinx.coroutines.future.a.u("ViewStub must have a non-null ViewGroup viewParent");
                return;
            }
            if (this.e == 0) {
                kotlinx.coroutines.future.a.q("ViewStub must have a valid layoutResource");
                return;
            }
