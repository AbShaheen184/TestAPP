...
public final class c2 implements androidx.compose.runtime.saveable.f, androidx.core.view.inputmethod.g, androidx.media3.extractor.text.d, androidx.media3.extractor.ts.z, com.google.common.util.concurrent.j0 {
    public Object A;
    ...
    public c2(int i) {
        ...
        switch (i) {
            ...
            case 6:
                ...
                break;
            case 8:
                this.A = new com.google.firebase.heartbeatinfo.e(3);
                break;
            case 10:
    ...
    public static com.caverock.androidsvg.w0 D(com.caverock.androidsvg.u0 u0Var, String str) {
        com.caverock.androidsvg.w0 w0VarD;
        com.caverock.androidsvg.w0 w0Var = (com.caverock.androidsvg.w0) u0Var;
        if (str.equals(w0Var.c)) {
            return w0Var;
        }
        for (Object obj : u0Var.getChildren()) {
            if (obj instanceof com.caverock.androidsvg.w0) {
                com.caverock.androidsvg.w0 w0Var2 = (com.caverock.androidsvg.w0) obj;
                if (str.equals(w0Var2.c)) {
                    return w0Var2;
                }
                if ((obj instanceof com.caverock.androidsvg.u0) && (w0VarD = D((com.caverock.androidsvg.u0) obj, str)) != null) {
                    return w0VarD;
                }
            }
        }
    ...
    public static c2 R(Context context, AttributeSet attributeSet, int[] iArr, int i) {
    ...
    public androidx.compose.ui.geometry.a B() {
        ...
        float fC;
        int i2;
        com.caverock.androidsvg.r0 r0Var = (com.caverock.androidsvg.r0) this.y;
        com.caverock.androidsvg.c0 c0Var = r0Var.r;
        com.caverock.androidsvg.c0 c0Var2 = r0Var.s;
        if (c0Var == null || c0Var.g() || (i = c0Var.y) == 9 || i == 2 || i == 3) {
            return new androidx.compose.ui.geometry.a(-1.0f, -1.0f, -1.0f, -1.0f);
        }
        float fC2 = c0Var.c();
        if (c0Var2 == null) {
            androidx.compose.ui.geometry.a aVar = ((com.caverock.androidsvg.r0) this.y).o;
            fC = aVar != null ? (aVar.e * fC2) / aVar.d : fC2;
        } else {
            if (c0Var2.g() || (i2 = c0Var2.y) == 9 || i2 == 2 || i2 == 3) {
                return new androidx.compose.ui.geometry.a(-1.0f, -1.0f, -1.0f, -1.0f);
            }
            fC = c0Var2.c();
        }
    ...
    public Drawable C(int i) {
        ...
        return (!typedArray.hasValue(i) || (resourceId = typedArray.getResourceId(i, 0)) == 0) ? typedArray.getDrawable(i) : androidx.work.impl.v.v((Context) this.y, resourceId);
    }

    public Typeface E(int i, int i2, c0 c0Var) {
    ...
    public boolean J(CharSequence charSequence, int i, int i2, androidx.emoji2.text.y yVar) {
        if ((yVar.c & 3) == 0) {
    ...
    public void M(androidx.media3.datasource.h hVar, Uri uri, Map map, long j, long j2, androidx.media3.exoplayer.source.o0 o0Var) throws androidx.media3.exoplayer.source.k1 {
        ...
        if (nVarArrB.length == 1) {
            ...
            if (((androidx.media3.extractor.n) this.z) == null) {
                String str = "None of the available extractors (" + new androidx.emoji2.text.r(", ").d(com.google.common.collect.q.w(com.google.common.collect.h0.p(nVarArrB), new androidx.media3.common.p(5))) + ") could read the stream.";
                uri.getClass();
                throw new androidx.media3.exoplayer.source.k1(str, d0VarL.g());
            }
        }
    ...
    public boolean P(int i, androidx.constraintlayout.core.widgets.d dVar, androidx.constraintlayout.widget.f fVar) {
    ...
    public void S(androidx.lifecycle.n nVar) {
        androidx.lifecycle.r0 r0Var = (androidx.lifecycle.r0) this.A;
        if (r0Var != null) {
            r0Var.run();
        }
        androidx.lifecycle.r0 r0Var2 = new androidx.lifecycle.r0((androidx.lifecycle.x) this.y, nVar);
        this.A = r0Var2;
        ((Handler) this.z).postAtFrontOfQueue(r0Var2);
    }

    public Object T(CharSequence charSequence, int i, int i2, int i3, boolean z, androidx.emoji2.text.p pVar) {
        int i4;
        char c;
        androidx.emoji2.text.s sVar = new androidx.emoji2.text.s((androidx.emoji2.text.v) ((com.google.firebase.messaging.n) this.z).A);
            ...
            while (true) {
                if (iCharCount < i2 && i5 < i3 && zF) {
                    ...
                    if (c == 2) {
                        ...
                        if (!z && J(charSequence, i4, iCharCount, ((androidx.emoji2.text.v) sVar.g).b)) {
                            break;
                        }
        ...
        if (sVar.b == 2 && ((androidx.emoji2.text.v) sVar.f).b != null && ((sVar.d > 1 || sVar.b()) && i5 < i3 && zF && (z || !J(charSequence, i4, iCharCount, ((androidx.emoji2.text.v) sVar.f).b)))) {
    ...
    public com.caverock.androidsvg.w0 W(String str) {
        if (str == null) {
            return null;
        }
        ...
        if (strSubstring.equals(((com.caverock.androidsvg.r0) this.y).c)) {
            return (com.caverock.androidsvg.r0) this.y;
        }
        if (map.containsKey(strSubstring)) {
            return (com.caverock.androidsvg.w0) map.get(strSubstring);
        }
        com.caverock.androidsvg.w0 w0VarD = D((com.caverock.androidsvg.r0) this.y, strSubstring);
        map.put(strSubstring, w0VarD);
        return w0VarD;
    }
    ...
    public void Y(androidx.compose.ui.graphics.r rVar) {
        ((androidx.compose.ui.graphics.drawscope.b) this.A).e.c = rVar;
    }

    public void Z(androidx.compose.ui.unit.c cVar) {
    ...
    public void a0(androidx.compose.ui.unit.m mVar) {
    ...
    public void b(Object obj) {
        ...
        if (layoutParams == null) {
            kotlinx.coroutines.future.a.u("The media route button placeholder missing layout params.");
            return;
        }
    ...
    public void c(androidx.media3.common.util.v vVar) {
        long jD;
        long j;
        ((androidx.media3.common.util.g0) this.z).getClass();
        String str = androidx.media3.common.util.i0.a;
        androidx.media3.common.util.g0 g0Var = (androidx.media3.common.util.g0) this.z;
        synchronized (g0Var) {
            try {
                long j2 = g0Var.c;
                jD = j2 != -9223372036854775807L ? j2 + g0Var.b : g0Var.d();
            } catch (Throwable th) {
                throw th;
            }
        }
        androidx.media3.common.util.g0 g0Var2 = (androidx.media3.common.util.g0) this.z;
        synchronized (g0Var2) {
            j = g0Var2.b;
        }
        ...
        int iA = vVar.a();
        ((androidx.media3.extractor.h0) this.A).f(iA, vVar);
        ((androidx.media3.extractor.h0) this.A).g(jD, 1, iA, 0, null);
    }

    public void c0(androidx.constraintlayout.core.widgets.e eVar, int i, int i2, int i3) {
        int i4 = eVar.a0;
        int i5 = eVar.b0;
        eVar.a0 = 0;
        eVar.b0 = 0;
    ...
    @Override // androidx.media3.extractor.ts.z
    public void d(androidx.media3.common.util.g0 g0Var, androidx.media3.extractor.p pVar, androidx.media3.extractor.ts.e0 e0Var) {
        this.z = g0Var;
        e0Var.a();
        e0Var.b();
    ...
    public int f(long j) {
        ...
        int iB = androidx.media3.common.util.i0.b(jArr, j, false);
        if (iB < jArr.length) {
            return iB;
        }
        return -1;
    ...
    public void f0(androidx.constraintlayout.core.widgets.e eVar) {
    ...
    public void n(androidx.compose.ui.node.f0 f0Var, androidx.compose.ui.node.t tVar) {
    ...
    public void p(View view, int i, ViewGroup.LayoutParams layoutParams, boolean z) {
        ...
        if (p0VarG != null) {
            if (!p0VarG.j() && !p0VarG.o()) {
                ...
                sb.append(p0VarG);
                com.google.firebase.platforminfo.b.j(sb, recyclerView.w());
                return;
            }
            p0VarG.j &= -257;
        }
    ...
    public String q(String str, long j, int i, long j2) {
    ...
    public boolean r(androidx.compose.ui.node.f0 f0Var) {
    ...
    public String toString() {
        switch (this.e) {
            case 24:
                ...
                return sb.toString();
            case 25:
                return ((d3) this.z).toString() + ", hidden list:" + ((ArrayList) this.A).size();
            default:
    ...
    public androidx.compose.ui.graphics.r v() {
        return ((androidx.compose.ui.graphics.drawscope.b) this.A).e.c;
    }

    public View w(int i) {
        return ((androidx.recyclerview.widget.u) this.y).a.getChildAt(F(i));
    }
    ...
    public ColorStateList y(int i) {
        ...
        TypedArray typedArray = (TypedArray) this.z;
        return (!typedArray.hasValue(i) || (resourceId = typedArray.getResourceId(i, 0)) == 0 || (colorStateListL = _COROUTINE.a.L((Context) this.y, resourceId)) == null) ? typedArray.getColorStateList(i) : colorStateListL;
    }

    public androidx.compose.ui.text.intl.b z() {
    ...
    public c2(androidx.compose.runtime.t1 t1Var) {
        this.e = 2;
        this.y = new androidx.compose.runtime.internal.a(0);
        this.z = new androidx.compose.runtime.internal.c();
        this.A = new androidx.activity.compose.f(16, this, t1Var);
    }

    public c2(SystemForegroundService systemForegroundService) {
        this.e = 15;
        this.y = new androidx.lifecycle.x(systemForegroundService, true);
    ...
    public c2(View view) {
        ...
        this.A = new com.google.firebase.platforminfo.d(view);
    }
    ...
    public c2(androidx.compose.ui.graphics.drawscope.b bVar) {
        this.e = 5;
        this.A = bVar;
        this.y = new com.google.firebase.platforminfo.d(this);
    }
    ...
    public c2(com.google.firebase.messaging.n nVar, com.google.firebase.heartbeatinfo.e eVar, androidx.emoji2.text.d dVar, Set set) {
        this.e = 14;
        this.y = eVar;
        this.z = nVar;
        this.A = dVar;
        ...
        while (it.hasNext()) {
            ...
            T(str, 0, str.length(), 1, true, new androidx.emoji2.text.r(str, false));
        }
    }
    ...
    public c2(androidx.compose.ui.text.font.t tVar, c2 c2Var) {
        this.e = 9;
        this.y = tVar;
        this.z = c2Var;
        this.A = tVar.e;
