...
public final class h0 {
    ...
    public final void d(AttributeSet attributeSet, int i) {
        ...
        c2 c2VarR = c2.R(context, attributeSet, iArr3, i);
        TextView textView2 = this.a;
        androidx.core.view.s0.l(textView2, textView2.getContext(), iArr3, attributeSet, (TypedArray) c2VarR.z, i);
        ...
        if (typedArrayObtainStyledAttributes4.hasValue(11)) {
            if (!typedArrayObtainStyledAttributes4.hasValue(11) || (resourceId = typedArrayObtainStyledAttributes4.getResourceId(11, 0)) == 0 || (colorStateList = _COROUTINE.a.L(context, resourceId)) == null) {
        ...
        if (typedArrayObtainStyledAttributes4.hasValue(19)) {
            ...
            if (dimensionPixelSize2 != i2) {
                androidx.work.impl.v.N(textView, dimensionPixelSize2);
            }
            if (dimensionPixelSize3 != i2) {
                androidx.work.impl.v.O(textView, dimensionPixelSize3);
            }
            if (dimensionPixelSize != f) {
                if (i3 == i2) {
                    androidx.work.impl.v.P(textView, (int) dimensionPixelSize);
                } else if (Build.VERSION.SDK_INT >= 34) {
                    androidx.compose.ui.text.android.b.n(textView, i3, dimensionPixelSize);
                } else {
                    androidx.work.impl.v.P(textView, Math.round(TypedValue.applyDimension(i3, dimensionPixelSize, textView.getResources().getDisplayMetrics())));
                }
            }
        }
        i2 = -1;
    ...
    public final void g(int[] iArr, int i) {
        ...
        if (q0Var.j()) {
            ...
            if (length > 0) {
                ...
                if (!q0Var.i()) {
                    androidx.transition.k.l(Arrays.toString(iArr), "None of the preset sizes is valid: ");
                    return;
                }
            } else {
                q0Var.g = false;
    ...
    public final void h(int i) {
        ...
        if (q0Var.j()) {
            ...
            if (i != 1) {
                kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Unknown auto-size text type: "));
                return;
            }
            DisplayMetrics displayMetrics = q0Var.j.getResources().getDisplayMetrics();
    ...
    public final void k(Context context, c2 c2Var) {
        ...
        if (!context.isRestricted()) {
            try {
                Typeface typefaceE = c2Var.E(i5, this.j, new c0(this, i6, i7, new WeakReference(this.a)));
                if (typefaceE != null) {
                    if (i2 < 28 || this.k == -1) {
                        this.l = typefaceE;
                    } else {
                        this.l = g0.a(Typeface.create(typefaceE, 0), this.k, (this.j & 2) != 0);
                    }
                }
                this.m = this.l == null;
