...
public final class j implements androidx.appcompat.view.menu.p {
    ...
    public g O;
    public g P;
    public com.google.common.util.concurrent.k0 Q;
    public h R;
    ...
    public final boolean f() {
        ...
        com.google.common.util.concurrent.k0 k0Var = this.Q;
        if (k0Var != null && (actionMenuView = this.D) != null) {
            actionMenuView.removeCallbacks(k0Var);
            this.Q = null;
            return true;
        }
        g gVar = this.O;
    ...
    public final boolean i() {
        ...
        com.google.common.util.concurrent.k0 k0Var = new com.google.common.util.concurrent.k0(1, this, new g(this, this.y, this.z, this.E), false);
        this.Q = k0Var;
        this.D.post(k0Var);
        return true;
    }
    ...
    public final boolean j(androidx.appcompat.view.menu.t tVar) {
        ...
        if (tVar.hasVisibleItems()) {
            ...
            if (view != null) {
                ...
                if (!gVar2.b()) {
                    if (gVar2.e == null) {
                        kotlinx.coroutines.future.a.u("MenuPopupHelper cannot be used without an anchor");
                        return false;
                    }
