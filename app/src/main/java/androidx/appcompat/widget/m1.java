...
public abstract class m1 implements androidx.appcompat.view.menu.r {
    ...
    public m1(Context context, int i) {
        ...
        zVar.setBackgroundDrawable((!typedArrayObtainStyledAttributes2.hasValue(0) || (resourceId = typedArrayObtainStyledAttributes2.getResourceId(0, 0)) == 0) ? typedArrayObtainStyledAttributes2.getDrawable(0) : androidx.work.impl.v.v(context, resourceId));
