...
public abstract class n extends AutoCompleteTextView {
    ...
    public n(Context context, AttributeSet attributeSet) {
        ...
        c2 c2VarR = c2.R(getContext(), attributeSet, A, com.app.mlounge.R.attr.autoCompleteTextViewStyle);
        if (((TypedArray) c2VarR.z).hasValue(0)) {
            setDropDownBackgroundDrawable(c2VarR.C(0));
        }
        c2VarR.U();
        o oVar = new o(this);
        this.e = oVar;
    ...
    public void setDropDownBackgroundResource(int i) {
        setDropDownBackgroundDrawable(androidx.work.impl.v.v(getContext(), i));
    }
