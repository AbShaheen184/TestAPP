...
public final class t1 {
    ...
    public final Drawable a(Context context, int i) {
        ...
        if (this.e == null) {
            ...
            layerDrawableM = com.caverock.androidsvg.x1.M(this, context, R.dimen.abc_star_big);
        } else if (i == R.drawable.abc_ratingbar_indicator_material) {
            layerDrawableM = com.caverock.androidsvg.x1.M(this, context, R.dimen.abc_star_medium);
        } else if (i == R.drawable.abc_ratingbar_small_material) {
            layerDrawableM = com.caverock.androidsvg.x1.M(this, context, R.dimen.abc_star_small);
        } else {
            layerDrawableM = null;
        }
    ...
    public final synchronized ColorStateList f(Context context, int i) {
        ...
        if (colorStateList == null) {
            ...
            if (x1Var != null) {
                colorStateListN = x1Var.N(context, i);
            }
    ...
    public final Drawable g(Context context, int i, Drawable drawable) {
        ...
        if (this.e != null) {
            if (i == R.drawable.abc_seekbar_track_material) {
                ...
                com.caverock.androidsvg.x1.l0(drawableFindDrawableByLayerId, iC, mode2);
                com.caverock.androidsvg.x1.l0(layerDrawable.findDrawableByLayerId(android.R.id.secondaryProgress), y1.c(context, R.attr.colorControlNormal), mode2);
                com.caverock.androidsvg.x1.l0(layerDrawable.findDrawableByLayerId(android.R.id.progress), y1.c(context, R.attr.colorControlActivated), mode2);
                return drawable;
            }
            if (i == R.drawable.abc_ratingbar_material || i == R.drawable.abc_ratingbar_indicator_material || i == R.drawable.abc_ratingbar_small_material) {
                ...
                com.caverock.androidsvg.x1.l0(drawableFindDrawableByLayerId2, iB, mode3);
                com.caverock.androidsvg.x1.l0(layerDrawable2.findDrawableByLayerId(android.R.id.secondaryProgress), y1.c(context, R.attr.colorControlActivated), mode3);
                com.caverock.androidsvg.x1.l0(layerDrawable2.findDrawableByLayerId(android.R.id.progress), y1.c(context, R.attr.colorControlActivated), mode3);
                return drawable;
            }
        }
        com.caverock.androidsvg.x1 x1Var = this.e;
        if (x1Var != null) {
            ...
            boolean z = true;
            if (com.caverock.androidsvg.x1.k(i, (int[]) x1Var.a)) {
                i2 = R.attr.colorControlNormal;
            } else if (com.caverock.androidsvg.x1.k(i, (int[]) x1Var.c)) {
                i2 = R.attr.colorControlActivated;
            } else {
                if (com.caverock.androidsvg.x1.k(i, (int[]) x1Var.d)) {
