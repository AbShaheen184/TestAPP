...
public final class k0 {
    ...
    public k0(int i) {
        if (i >= 0) {
            ...
            kotlinx.coroutines.future.a.q("Capacity must be a positive value.");
            throw null;
        }
    }
    ...
    public final void b() {
        ...
        long[] jArr = this.a;
        if (jArr != w0.a) {
            kotlin.collections.o.o(jArr, -9187201950435737472L);
            long[] jArr2 = this.a;
            int i = this.f;
            int i2 = i >> 3;
            long j = 255 << ((i & 7) << 3);
        ...
        kotlin.collections.o.n(0, this.f, null, this.b);
        kotlin.collections.o.o(this.c, 4611686018427387903L);
        this.d = Integer.MAX_VALUE;
        this.e = Integer.MAX_VALUE;
        this.h = w0.a(this.f) - this.g;
    }
    ...
    public final boolean c(Object obj) {
        ...
        loop0: while (true) {
            ...
            for (long j3 = (~j2) & (j2 - 72340172838076673L) & (-9187201950435737472L); j3 != 0; j3 &= j3 - 1) {
                ...
                if (kotlin.jvm.internal.l.a(this.b[iNumberOfTrailingZeros], obj)) {
                    break loop0;
                }
            }
                ...
                if (this.h != 0 || ((this.a[iE >> 3] >> ((iE & 7) << 3)) & 255) == 254) {
                        ...
                        if (Long.compare((((long) this.g) * 32) ^ Long.MIN_VALUE, (((long) i13) * 25) ^ Long.MIN_VALUE) <= 0) {
                            ...
                            if (jArr3 == null) {
                                    ...
                                    if (j11 != 128 && j11 == 254) {
                                        ...
                                        if (((iE2 - i25) & i14) / 8 == ((i20 - i25) & i14) / 8) {
                                            ...
                                            if (((j13 >> i29) & j2) == 128) {
                                                ...
                                                jArr5[iE2] = (((long) i20) << 32) | ((long) i31);
                                            } else {
                                                j5 = j5;
                                                ...
                                                jArr5[iE2] = (((long) i32) << 32) | ((long) i20);
                                                i20--;
                                            }
                                            jArr3[jArr3.length - 1] = jArr3[0];
                                            i20++;
                                ...
                                if (i36 != Integer.MAX_VALUE) {
                                    this.d = (int) (jArr5[i36] & 4294967295L);
                                }
                                int i37 = this.e;
                                if (i37 != Integer.MAX_VALUE) {
                                    this.e = (int) (jArr5[i37] & 4294967295L);
                                }
                            }
                        }
                        iE = e(i4);
                    ...
                    while (i40 < i38) {
                        if (((jArr7[i40 >> 3] >> ((i40 & 7) << 3)) & 255) < j3) {
                            ...
                            jArr[i42] = j19;
                            jArr[(((iE3 - 7) & i39) + (i39 & 7)) >> 3] = j19;
                            objArr5[iE3] = obj4;
                            jArr10[iE3] = jArr8[i40];
                            iArr[i40] = iE3;
                        } else {
                            jArr = jArr9;
                        }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && !k0Var.c(objArr[(i << 3) + i3])) {
                            return false;
                        }
                        j >>= 8;
                    }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j) < 128) {
                            int i5 = (i2 << 3) + i4;
                            if (!kotlin.collections.p.x(collection, objArr[i5])) {
                                h(i5);
                            }
                        }
                        j >>= 8;
