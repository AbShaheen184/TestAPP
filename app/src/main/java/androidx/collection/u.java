...
public class u {
    ...
    public u(int i) {
        ...
        this.g = new com.google.android.gms.common.internal.k(1);
    }

    public void a() {
        View view = (View) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, (ArrayList) this.f);
    ...
    public Object h(Object obj) {
        Object objPut;
        obj.getClass();
        synchronized (((com.google.android.gms.common.internal.k) this.g)) {
            androidx.collection.internal.b bVar = (androidx.collection.internal.b) this.f;
            bVar.getClass();
            Object obj2 = bVar.e.get(obj);
            if (obj2 != null) {
                this.d++;
                return obj2;
            }
    ...
    public void n(int i) {
        ...
        while (true) {
            synchronized (((com.google.android.gms.common.internal.k) this.g)) {
                try {
                    if (this.c < 0 || (((androidx.collection.internal.b) this.f).e.isEmpty() && this.c != 0)) {
                        break;
                    }
                    if (this.c > i && !((androidx.collection.internal.b) this.f).e.isEmpty()) {
                        Set setEntrySet = ((androidx.collection.internal.b) this.f).e.entrySet();
                        setEntrySet.getClass();
                        Map.Entry entry = (Map.Entry) kotlin.collections.p.C(setEntrySet);
                        if (entry == null) {
                            return;
                        }
                        key = entry.getKey();
