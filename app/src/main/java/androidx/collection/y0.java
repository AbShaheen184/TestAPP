...
public class y0 {
    ...
    public final Object f(int i) {
        ...
        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Expected index to be within 0..size()-1, but was "));
        return null;
    }
    ...
    public final Object g(int i) {
        ...
        if (iArr.length <= 8 || i2 >= iArr.length / 3) {
            if (i < i4) {
                int i5 = i + 1;
                kotlin.collections.o.e(i, i5, i2, iArr, iArr);
                Object[] objArr2 = this.y;
                kotlin.collections.o.f(i3, i5 << 1, i2 << 1, objArr2, objArr2);
            }
            ...
            if (i > 0) {
                kotlin.collections.o.e(0, 0, i, iArr, this.e);
                kotlin.collections.o.f(0, 0, i3, objArr, this.y);
            }
            if (i < i4) {
                int i8 = i + 1;
                kotlin.collections.o.e(i, i8, i2, iArr, this.e);
                kotlin.collections.o.f(i3, i8 << 1, i2 << 1, objArr, this.y);
            }
        }
        if (i2 == this.z) {
            this.z = i4;
    ...
    public final Object put(Object obj, Object obj2) {
        ...
        if (i3 < i) {
            int[] iArr2 = this.e;
            int i5 = i3 + 1;
            kotlin.collections.o.e(i5, i3, i, iArr2, iArr2);
            Object[] objArr2 = this.y;
            kotlin.collections.o.f(i5 << 1, i3 << 1, this.z << 1, objArr2, objArr2);
        }
        int i6 = this.z;
        if (i == i6) {
            int[] iArr3 = this.e;
