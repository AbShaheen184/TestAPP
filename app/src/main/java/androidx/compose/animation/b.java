...
public abstract class b {
    ...
    static {
        ...
        float f8;
        float f9;
        float[] fArr = new float[Token.ASSIGN_LOGICAL_OR];
        a = fArr;
        float[] fArr2 = new float[Token.ASSIGN_LOGICAL_OR];
        float f10 = 0.0f;
        int i = 0;
        float f11 = 0.0f;
        while (true) {
    ...
    public static a a(float f) {
        float f2 = 0.0f;
        float f3 = 1.0f;
        float fC = kotlin.collections.i0.c(f, 0.0f, 1.0f);
        float f4 = 100;
        int i = (int) (f4 * fC);
        if (i < 100) {
            float f5 = i / f4;
