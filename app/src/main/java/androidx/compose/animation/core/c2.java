        ...
        switch (this.e) {
                ...
                while (CoroutineScopeKt.isActive(coroutineScope)) {
                    ...
                    kotlin.jvm.functions.l lVar = new kotlin.jvm.functions.l() { // from class: androidx.compose.animation.core.b2
                        ...
                        public final Object invoke(Object obj2) {
                            ...
                            e2 e2Var2 = e2Var;
                            boolean zG = e2Var2.g();
                            androidx.compose.runtime.h1 h1Var = e2Var2.g;
                            if (!zG) {
                                if (h1Var.g() == Long.MIN_VALUE) {
                                    h1Var.h(jLongValue);
                                    ((androidx.compose.runtime.j1) e2Var2.a.e).setValue(Boolean.TRUE);
                                }
                                long jG = jLongValue - h1Var.g();
                                float f = fJ;
                                if (f != 0.0f) {
                                    jG = kotlin.math.a.I(jG / ((double) f));
                                }
                                e2Var2.n(jG);
                                e2Var2.h(jG, f == 0.0f);
                            }
                    ...
                    this.z = fJ;
                    this.y = 1;
                    Object objA2 = androidx.compose.runtime.t.o(getContext()).a(lVar, this);
            ...
            case 1:
                ...
                if (i2 == 0) {
                    ...
                    m mVar = (m) this.B;
                    this.y = 1;
                    Object objC = d.c(dVar, f, mVar, this, 12);
