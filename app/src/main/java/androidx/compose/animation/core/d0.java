...
public final class d0 implements c0 {
    ...
    public d0(float f, float f2, float f3) {
        ...
        j1 j1Var = new j1();
        j1Var.a = 1.0f;
        j1Var.b = Math.sqrt(50.0d);
        j1Var.c = 1.0f;
        if (f < 0.0f) {
            v0.a("Damping ratio must be non-negative");
        }
        j1Var.c = f;
        double d = j1Var.b;
        if (((float) (d * d)) <= 0.0f) {
            v0.a("Spring stiffness constant must be positive.");
        }
        j1Var.b = Math.sqrt(f2);
        this.b = j1Var;
    }
    ...
    public final float b(long j, float f, float f2, float f3) {
        j1 j1Var = this.b;
        j1Var.a = f2;
        return Float.intBitsToFloat((int) (j1Var.a(f, f3, j / 1000000) & 4294967295L));
    }
    ...
    public final float e(long j, float f, float f2, float f3) {
        j1 j1Var = this.b;
        j1Var.a = f2;
        return Float.intBitsToFloat((int) (j1Var.a(f, f3, j / 1000000) >> 32));
    }
}
