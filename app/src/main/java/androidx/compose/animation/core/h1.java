...
public final class h1 extends j2 {
    ...
    public h1(androidx.navigation.i iVar) {
        super(0);
        this.y = androidx.compose.runtime.t.r(iVar);
        this.z = androidx.compose.runtime.t.r(iVar);
        this.A = iVar;
        this.D = new androidx.activity.w(this, 2);
        this.E = new androidx.compose.runtime.f1(0.0f);
            ...
            public final Object invoke(Object obj) {
                ...
                switch (i) {
                    ...
                    default:
                        ...
                        h1Var.I = jLongValue;
                        long jI = kotlin.math.a.I(j / ((double) h1Var.M));
                        ...
                        if (j0Var.i()) {
                            ...
                            kotlin.ranges.d dVarN = kotlin.collections.i0.n(0, i5);
                            int i6 = dVarN.e;
                            int i7 = dVarN.y;
                            if (i6 <= i7) {
                                while (true) {
                            ...
                            kotlin.collections.o.n(i5 - i3, i5, null, objArr2);
                            j0Var.b -= i3;
                        }
                        y0 y0Var2 = h1Var.K;
                        if (y0Var2 != null) {
                ...
                switch (i2) {
                    ...
                    default:
                        ...
                        if (j0Var.i()) {
                            ...
                            kotlin.collections.o.n(i6 - i4, i6, null, objArr2);
                            j0Var.b -= i4;
                        }
                        y0 y0Var2 = h1Var.K;
                        if (y0Var2 != null) {
    ...
    public static void C(y0 y0Var, long j) {
        ...
        y0Var.d = kotlin.collections.i0.c(((o) p2Var.t(j2, oVar, P, oVar2)).a(0), 0.0f, 1.0f);
    }

    public static final void w(h1 h1Var) {
        androidx.compose.runtime.f1 f1Var = h1Var.E;
        e2 e2Var = h1Var.B;
        if (e2Var == null) {
            return;
        }
        y0 y0Var = h1Var.K;
        if (y0Var == null) {
            if (h1Var.C <= 0 || f1Var.g() == 1.0f || kotlin.jvm.internal.l.a(h1Var.z.getValue(), h1Var.y.getValue())) {
                y0Var = null;
            } else {
                y0Var = new y0();
                y0Var.d = f1Var.g();
                long j = h1Var.C;
                y0Var.g = j;
                y0Var.h = kotlin.math.a.I((1.0d - ((double) f1Var.g())) * j);
                y0Var.e.e(0, f1Var.g());
            }
        }
        if (y0Var != null) {
    ...
    public static final Object x(h1 h1Var, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        if (i2 == 0) {
            ...
            if (h1Var.I == Long.MIN_VALUE) {
                x0 x0Var = h1Var.L;
                b1Var.z = 1;
                if (androidx.compose.runtime.t.o(b1Var.getContext()).a(x0Var, b1Var) != obj2) {
                }
            }
            return obj2;
        }
    ...
    public static final Object y(h1 h1Var, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        f1Var.e = value;
        f1Var.A = 2;
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(kotlin.coroutines.intrinsics.h.f(f1Var), 1);
    ...
    public static final Object z(h1 h1Var, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        if (!kotlin.jvm.internal.l.a(value, h1Var.A)) {
            g1Var.e = value;
            g1Var.A = 2;
            CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(kotlin.coroutines.intrinsics.h.f(g1Var), 1);
            cancellableContinuationImpl.initCancellability();
            h1Var.F = cancellableContinuationImpl;
            Mutex.DefaultImpls.unlock$default(mutex, null, 1, null);
            Object result = cancellableContinuationImpl.getResult();
    ...
    public final Object A(kotlin.coroutines.jvm.internal.c cVar) {
        ...
        this.M = fJ;
        Object objA = androidx.compose.runtime.t.o(cVar.getContext()).a(this.N, cVar);
    ...
    public final void E() {
        ...
        e2Var.l(kotlin.math.a.I(((double) this.E.g()) * ((Number) e2Var.l.getValue()).longValue()));
    }
