...
public final class u2 implements o2, androidx.compose.ui.text.input.q, androidx.compose.runtime.c, androidx.media3.extractor.mp4.c {
    ...
    public s i(long j, s sVar, s sVar2, s sVar3) {
        return ((com.google.firebase.messaging.n) this.z).i(j, sVar, sVar2, sVar3);
    }
    ...
    public int s() {
        int i = this.e;
        return i == -1 ? ((androidx.media3.common.util.v) this.z).D() : i;
    }

    @Override // androidx.compose.animation.core.m2
    public s t(long j, s sVar, s sVar2, s sVar3) {
        return ((com.google.firebase.messaging.n) this.z).t(j, sVar, sVar2, sVar3);
    }
    ...
    public u2(int i, int i2, z zVar) {
        this.e = i;
        this.y = i2;
        this.z = new com.google.firebase.messaging.n(new e0(i, i2, zVar));
    }
    ...
    public u2(androidx.media3.container.e eVar, androidx.media3.common.r rVar) {
        ...
        if ("audio/raw".equals(rVar.o)) {
            int iU = androidx.media3.common.util.i0.u(rVar.I) * rVar.G;
            if (iD % iU != 0) {
                androidx.media3.common.util.b.t("BoxParsers", "Audio sample size mismatch. stsd sample size: " + iU + ", stsz sample size: " + iD);
                iD = iU;
            }
        }
        this.e = iD == 0 ? -1 : iD;
