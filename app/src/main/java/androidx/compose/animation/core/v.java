...
public final class v implements z {
  ...
  0x0162: PHI (r12v41 float) = (r12v25 float), (r12v36 float) binds: [B:68:0x0160, B:81:0x0191] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final float a(float f) {
        ...
        if (Math.abs(d4 - 0.0d) >= 1.0E-7d) {
            ...
            if (d11 < 0.0d) {
                ...
                double dX = com.google.firebase.b.x((float) dSqrt) * 2.0f;
                float fCos = (float) ((Math.cos(dAcos / 3.0d) * dX) - d12);
                ...
                if (Float.isNaN(f10)) {
                    float fCos2 = (float) ((Math.cos((6.283185307179586d + dAcos) / 3.0d) * dX) - d12);
                    ...
                    if (Float.isNaN(f10)) {
                        float fCos3 = (float) ((Math.cos((dAcos + 12.566370614359172d) / 3.0d) * dX) - d12);
                        if (fCos3 >= 0.0f) {
                            f8 = fCos3;
                        }
                        f2 = f8 > 1.0f ? 1.0f : f8;
                ...
                float f11 = -com.google.firebase.b.x((float) d9);
                float f12 = (float) d12;
                ...
                float fX = (float) (((double) (com.google.firebase.b.x((float) ((-d9) + dSqrt2)) - com.google.firebase.b.x((float) (d9 + dSqrt2)))) - d12);
                if (fX >= 0.0f) {
                    f8 = fX;
                }
                f2 = f8 > 1.0f ? 1.0f : f8;
                if (Math.abs(f2 - fX) <= 1.05E-6f) {
                    f9 = f2;
                }
            }
    ...
    public final int hashCode() {
        return Float.hashCode(this.A) + androidx.privacysandbox.ads.adservices.java.internal.a.c(this.z, androidx.privacysandbox.ads.adservices.java.internal.a.c(this.y, Float.hashCode(this.e) * 31, 31), 31);
    }
    ...
    public final String toString() {
        ...
        sb.append(this.z);
        sb.append(", d=");
        return androidx.privacysandbox.ads.adservices.java.internal.a.s(sb, this.A, ')');
    }
}
