...
public final class e extends kotlin.jvm.internal.m implements kotlin.jvm.functions.l {
    ...
    /* JADX WARN: Type inference failed for: r2v42, types: [androidx.compose.ui.layout.d1, androidx.compose.ui.node.a] */
    ...
    public final Object invoke(Object obj) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                if (gVar2 != null) {
                    ...
                    if (eVar.invoke(gVar2) == y1Var) {
                        androidx.compose.ui.node.l.B(gVar2, eVar);
                    }
                }
                gVar.M = null;
                gVar.L = null;
            ...
            case 3:
                ...
                ((androidx.compose.material3.internal.r0) obj2).invoke(h0Var);
                h0Var.b();
                return yVar;
            case 4:
            ...
            case 6:
                ...
                if (bVar.n && bVar.w && jVar != null) {
                    ...
                    c2VarC0.v().f();
                    try {
                        ((c2) ((com.google.firebase.platforminfo.d) c2VarC0.y).e).v().a(jVar);
                        bVar.c(dVar2);
                    } finally {
            ...
            case 10:
                ...
                if (aVar.x() != Integer.MAX_VALUE) {
                    ...
                    for (Map.Entry entry : aVar.c().i.entrySet()) {
            ...
            case 11:
                ...
                return Boolean.TRUE;
            case 12:
                return Boolean.valueOf(((androidx.compose.ui.focus.e0) obj).T0(((androidx.compose.ui.focus.f) obj2).a));
            case 13:
                ...
                if (uVar.getInsetsListener().E.g() > 0) {
                    androidx.collection.z zVar = t1.a;
                    long jU = k0Var4.b().u();
                    androidx.collection.o0 o0Var2 = uVar.getInsetsListener().D;
                    int i4 = (int) (jU >> 32);
                    int i5 = (int) (jU & 4294967295L);
                    for (r1 r1Var : t1.b) {
                        Object objG = o0Var2.g(r1Var);
                        objG.getClass();
                        u1 u1Var = (u1) objG;
                        s1 s1Var = (s1) r1Var;
                        t1.a(k0Var4, s1Var.c, u1Var.h, i4, i5);
                        if (((Boolean) u1Var.b.getValue()).booleanValue()) {
                            t1.a(k0Var4, u1Var.f, u1Var.j, i4, i5);
                            t1.a(k0Var4, u1Var.g, u1Var.k, i4, i5);
                        }
                        t1.a(k0Var4, s1Var.d, u1Var.i, i4, i5);
                    }
                    ...
                    if (j0Var.i()) {
                        ...
                        int i6 = j0Var.b;
                        while (i2 < i6) {
                            androidx.compose.runtime.a1 a1Var = (androidx.compose.runtime.a1) objArr[i2];
                            androidx.compose.ui.layout.q qVar2 = (androidx.compose.ui.layout.q) qVar.get(i2);
                            Rect rect = (Rect) a1Var.getValue();
                            k0Var4.c(qVar2.b(), rect.left);
                            k0Var4.c(qVar2.d(), rect.top);
                            k0Var4.c(qVar2.c(), rect.right);
                            k0Var4.c(qVar2.a(), rect.bottom);
                            i2++;
                        }
                    }
                }
                return yVar;
            case 14:
                return Boolean.valueOf(((androidx.collection.n) obj2).a(((androidx.compose.ui.semantics.s) obj).g));
            case 15:
                return Boolean.valueOf(androidx.compose.ui.platform.i0.c((androidx.compose.ui.semantics.s) obj, (Resources) obj2));
            case 16:
                return new androidx.activity.compose.d((o1) obj2, 9);
            case 17:
                if (q1.b.compareAndSet(false, true)) {
            ...
            case 18:
                ...
                kotlin.jvm.functions.p pVar2 = ((androidx.compose.ui.platform.r1) obj2).A;
                if (pVar2 != null) {
                    pVar2.invoke(rVarV, (androidx.compose.ui.graphics.layer.b) dVar3.c0().z);
                }
                return yVar;
            case 19:
                ...
                w1 w1Var = (w1) obj2;
                androidx.compose.runtime.collection.b bVar2 = w1Var.d;
            ...
            case 20:
                ...
                return yVar;
            case 21:
                androidx.compose.ui.semantics.y.d((androidx.compose.ui.semantics.a0) obj, ((androidx.compose.ui.semantics.j) obj2).a);
                return yVar;
            case 22:
                androidx.compose.ui.semantics.y.c((androidx.compose.ui.semantics.a0) obj, (String) obj2);
                return yVar;
            case 23:
                ((List) obj).add((Float) ((androidx.compose.foundation.lazy.layout.t0) obj2).invoke());
                return true;
            case 24:
                ((androidx.compose.ui.node.f0) obj2).b0((androidx.compose.ui.unit.c) obj);
                return yVar;
            case 25:
                androidx.compose.ui.geometry.c cVar2 = (androidx.compose.ui.geometry.c) obj;
                androidx.compose.ui.viewinterop.o oVar = (androidx.compose.ui.viewinterop.o) obj2;
                if (oVar.K) {
                    BuildersKt__Builders_commonKt.launch$default(oVar.A0(), null, null, new androidx.activity.compose.p(oVar, cVar2, dVar, 22), 3, null);
                }
                return yVar;
            default:
