...
public abstract class s0 {
    ...
    public static final k1 b = androidx.compose.animation.core.e.n(0.0f, 400.0f, null, 5);
    public static final k1 c;
    public static final k1 d;

    static {
        androidx.compose.animation.core.e.n(0.0f, 400.0f, null, 5);
        long j = 1;
        long j2 = (j & 4294967295L) | (j << 32);
        c = androidx.compose.animation.core.e.n(0.0f, 400.0f, new androidx.compose.ui.unit.j(j2), 1);
        d = androidx.compose.animation.core.e.n(0.0f, 400.0f, new androidx.compose.ui.unit.l(j2), 1);
    }
    ...
    public static x0 b(androidx.compose.animation.core.b0 b0Var, int i) {
        if ((i & 1) != 0) {
            b0Var = androidx.compose.animation.core.e.n(0.0f, 400.0f, null, 5);
        }
