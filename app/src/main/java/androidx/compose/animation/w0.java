...
public final class w0 extends d1 {
    ...
    public final androidx.compose.ui.e M0() {
    ...
    public final androidx.compose.ui.layout.r0 c(androidx.compose.ui.layout.s0 s0Var, androidx.compose.ui.layout.p0 p0Var, long j) {
        ...
        if (this.L.a.n() == this.L.d.getValue()) {
            ...
            androidx.compose.ui.e eVarM0 = M0();
            if (eVarM0 == null) {
                eVarM0 = androidx.compose.ui.c.e;
            }
            this.T = eVarM0;
        }
        boolean zV = s0Var.V();
        ...
        if (zV) {
            ...
            long j2 = (((long) d1VarF.e) << 32) | (((long) d1VarF.y) & 4294967295L);
            this.S = j2;
            return s0Var.q((int) (j2 >> 32), (int) (4294967295L & j2), xVar, new e0(d1VarF, 1));
        }
        if (!((Boolean) this.Q.invoke()).booleanValue()) {
            androidx.compose.ui.layout.d1 d1VarF2 = p0Var.F(j);
            return s0Var.q(d1VarF2.e, d1VarF2.y, xVar, new e0(d1VarF2, 2));
        }
        o0 o0Var = this.R;
        x1 x1Var = o0Var.a;
        x1 x1Var2 = o0Var.b;
        ...
        androidx.compose.ui.layout.d1 d1VarF3 = p0Var.F(j);
        long j3 = (((long) d1VarF3.y) & 4294967295L) | (((long) d1VarF3.e) << 32);
        ...
        return s0Var.q((int) (jD >> 32), (int) (jD & 4294967295L), xVar, new t0(d1VarF3, androidx.compose.ui.unit.j.c(jA, 0L), j5, hVar));
    }
}
