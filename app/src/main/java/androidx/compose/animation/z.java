...
public final class z extends kotlin.jvm.internal.m implements kotlin.jvm.functions.a {
    ...
    public final Object invoke() {
        ...
        switch (this.y) {
            ...
            case 1:
                ((androidx.compose.ui.focus.e0) this.z).O0();
                return kotlin.y.a;
            case 2:
                j1 j1Var = ((androidx.compose.ui.graphics.vector.j0) this.z).F;
            ...
            case 4:
                return ((androidx.compose.ui.input.nestedscroll.i) this.z).M0();
            case 5:
                androidx.compose.ui.layout.f0 f0Var = (androidx.compose.ui.layout.f0) this.z;
                if (!((Boolean) f0Var.g.getValue()).booleanValue() && (zVar = f0Var.c) != null) {
                    zVar.l();
                }
                return kotlin.y.a;
            case 6:
                androidx.compose.ui.layout.m0 m0VarA = ((m1) this.z).a();
                ...
                if (m0VarA.K != ((androidx.compose.runtime.collection.b) ((androidx.collection.h0) f0Var2.o()).y).z) {
                    ...
                    if (f0Var2.F != null) {
                        ...
                        androidx.compose.ui.node.f0.X(f0Var2, false, 7);
                    }
                }
                return kotlin.y.a;
            case 7:
            ...
            case 9:
                return kotlin.y.a;
            case 10:
                androidx.compose.runtime.retain.c cVar = (androidx.compose.runtime.retain.c) ((a2) this.z).a.y;
                if (!cVar.y) {
                    if (cVar.z) {
            ...
            default:
                androidx.compose.ui.window.z zVar2 = (androidx.compose.ui.window.z) this.z;
                androidx.compose.ui.layout.x parentLayoutCoordinates = zVar2.getParentLayoutCoordinates();
                if (parentLayoutCoordinates == null || !parentLayoutCoordinates.l()) {
                    parentLayoutCoordinates = null;
                }
                return Boolean.valueOf((parentLayoutCoordinates == null || zVar2.m11getPopupContentSizebOM6tXw() == null) ? false : true);
        }
    }
}
