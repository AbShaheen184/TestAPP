...
public final class e extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    public final /* synthetic */ androidx.compose.foundation.gestures.p1 A;
    ...
    public e(androidx.compose.foundation.gestures.p1 p1Var, long j, androidx.compose.foundation.interaction.k kVar, j jVar, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.A = p1Var;
        this.B = j;
        this.C = kVar;
