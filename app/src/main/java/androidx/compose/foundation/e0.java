    ...
    public final void D(androidx.compose.ui.input.pointer.m mVar, androidx.compose.ui.input.pointer.n nVar, long j) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            if (!androidx.compose.ui.input.pointer.u.c((androidx.compose.ui.input.pointer.v) r13.get(i2))) {
                long jM0 = androidx.compose.ui.node.l.v(this).W.m0(((q2) androidx.compose.ui.node.l.h(this, androidx.compose.ui.platform.l1.s)).d());
                long jFloatToRawIntBits = (((long) Float.floatToRawIntBits(Math.max(0.0f, Float.intBitsToFloat((int) (jM0 >> 32)) - ((int) (j >> 32))) / 2.0f)) << 32) | (((long) Float.floatToRawIntBits(Math.max(0.0f, Float.intBitsToFloat((int) (jM0 & 4294967295L)) - ((int) (j & 4294967295L))) / 2.0f)) & 4294967295L);
                int size3 = r13.size();
