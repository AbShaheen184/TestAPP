...
public final class h1 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public /* synthetic */ h1(int i, kotlin.coroutines.d dVar, int i2, boolean z) {
        super(2, dVar);
        this.e = i2;
        this.z = i;
    }
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        switch (this.e) {
            case 0:
                h1 h1Var = new h1(2, 0, dVar);
                h1Var.y = obj;
                return h1Var;
            case 1:
                h1 h1Var2 = new h1(this.z, dVar, 1, false);
                h1Var2.y = obj;
                return h1Var2;
            case 2:
                h1 h1Var3 = new h1(this.z, dVar, 2, false);
                h1Var3.y = obj;
                return h1Var3;
            default:
                h1 h1Var4 = new h1(2, 3, dVar);
                h1Var4.y = obj;
                return h1Var4;
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        switch (this.e) {
            ...
            case 1:
                h1 h1Var = (h1) create((androidx.datastore.preferences.core.a) obj, (kotlin.coroutines.d) obj2);
                kotlin.y yVar = kotlin.y.a;
                h1Var.invokeSuspend(yVar);
                return yVar;
            case 2:
                h1 h1Var2 = (h1) create((androidx.datastore.preferences.core.a) obj, (kotlin.coroutines.d) obj2);
                kotlin.y yVar2 = kotlin.y.a;
                h1Var2.invokeSuspend(yVar2);
                return yVar2;
            default:
                h1 h1Var3 = new h1(2, 3, (kotlin.coroutines.d) obj2);
                h1Var3.y = (CoroutineScope) obj;
                return h1Var3.invokeSuspend(kotlin.y.a);
        }
    }
        ...
        switch (i) {
            case 0:
                ...
                while (JobKt.isActive(coroutineScope.getCoroutineContext())) {
                    ...
                    this.z = 1;
                    if (androidx.compose.runtime.t.o(getContext()).a(n1Var, this) == aVar) {
                        return aVar;
                    }
                }
                return yVar;
            case 1:
                ...
                aVar2.e(com.app.mlounge.data.local.prefs.y1.m1, new Integer(this.z));
                return yVar;
            case 2:
                ...
                aVar3.e(com.app.mlounge.data.local.prefs.y1.W0, new Integer(this.z));
                return yVar;
            default:
                int i3 = this.z;
                if (i3 == 0) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ h1(int i, int i2, kotlin.coroutines.d dVar) {
        super(i, dVar);
        this.e = i2;
    }
}
