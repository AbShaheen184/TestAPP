...
public final class k extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public k(float f, l lVar, o2 o2Var, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.A = f;
        this.B = lVar;
        this.C = o2Var;
        ...
        if (i == 0) {
            ...
            if (Math.abs(f) > 1.0f) {
                ...
                try {
                    ...
                    nVar = nVarB;
                    try {
                        Object objD = androidx.compose.animation.core.e.d(nVar, new androidx.compose.animation.core.w(xVar, androidx.compose.animation.core.e.j, nVarB.y.getValue(), nVarB.z), Long.MIN_VALUE, i0Var, this);
