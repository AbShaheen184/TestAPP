...
public final class l0 extends j {
    ...
    public l0(androidx.compose.foundation.interaction.k kVar, kotlin.jvm.functions.a aVar, kotlin.jvm.functions.a aVar2) {
    ...
    public final void P0(androidx.compose.ui.semantics.a0 a0Var) {
        if (this.j0 != null) {
            androidx.activity.w wVar = new androidx.activity.w(this, 3);
            kotlin.reflect.j[] jVarArr = androidx.compose.ui.semantics.y.a;
            a0Var.b(androidx.compose.ui.semantics.m.c, new androidx.compose.ui.semantics.a(null, wVar));
        }
    }

    @Override // androidx.compose.foundation.j
    public final androidx.compose.ui.input.pointer.l0 Q0() {
        m mVar = new m(this, 1);
    ...
    public final boolean Y0(KeyEvent keyEvent) {
        ...
        if (this.j0 != null) {
            ...
            if (c0Var.d(jB) == null) {
                c0Var.g(jB, BuildersKt__Builders_commonKt.launch$default(A0(), null, null, new androidx.compose.animation.core.c1(this, null, 1), 3, null));
                z = true;
            } else {
                z = false;
            }
