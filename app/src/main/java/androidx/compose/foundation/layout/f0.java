...
public final class f0 extends androidx.compose.ui.q implements androidx.compose.ui.node.w {
    public c0 L;
    public float M;
    ...
    public final androidx.compose.ui.layout.r0 c(androidx.compose.ui.layout.s0 s0Var, androidx.compose.ui.layout.p0 p0Var, long j) {
        ...
        int iG;
        int iG2;
        if (!androidx.compose.ui.unit.a.d(j) || this.L == c0.e) {
        ...
        if (!androidx.compose.ui.unit.a.c(j) || this.L == c0.y) {
        ...
        androidx.compose.ui.layout.d1 d1VarF = p0Var.F(androidx.compose.ui.unit.b.a(iJ, iH, iG2, iG));
        return s0Var.q(d1VarF.e, d1VarF.y, kotlin.collections.x.e, new j(d1VarF, 2));
    }
}
