...
public final class m implements c0 {
    ...
    public m(x xVar, z0 z0Var, kotlin.reflect.h hVar, c cVar, androidx.compose.foundation.layout.g gVar, androidx.compose.foundation.layout.e eVar, CoroutineScope coroutineScope, androidx.compose.ui.graphics.y yVar, f0 f0Var) {
        this.a = xVar;
        this.b = z0Var;
        this.c = hVar;
        this.d = cVar;
    ...
    public final r0 a(d0 d0Var, long j) throws Throwable {
        ...
        x xVar2 = this.a;
        a1 a1Var = xVar2.s;
        androidx.compose.foundation.lazy.u uVar2 = xVar2.d;
        a1Var.getValue();
        boolean z4 = xVar2.b || n1Var.V();
        o1 o1Var = o1.e;
        androidx.compose.foundation.s.h(j, o1Var);
        androidx.compose.ui.unit.m layoutDirection = n1Var.getLayoutDirection();
        z0 z0Var = this.b;
        int iI0 = n1Var.i0(z0Var.a(layoutDirection));
        int iI1 = n1Var.i0(z0Var.b(n1Var.getLayoutDirection()));
        int iI2 = n1Var.i0(z0Var.b);
        int iI3 = n1Var.i0(z0Var.d) + iI2;
        int i26 = iI1 + iI0;
        int i27 = iI3 - iI2;
        long jI = androidx.compose.ui.unit.b.i(-i26, -iI3, j);
        i iVar = (i) this.c.invoke();
        u uVar3 = iVar.b.b;
        c cVar = this.d;
        if (cVar.d != null && androidx.compose.ui.unit.a.b(cVar.b, jI) && cVar.c == n1Var.a()) {
            oVar = cVar.d;
            oVar.getClass();
        } else {
            cVar.b = jI;
        ...
        int iI4 = n1Var.i0(gVar.a());
        int iA = iVar.a();
        int iG2 = androidx.compose.ui.unit.a.g(j) - iI3;
        n1 n1Var2 = n1Var;
        k kVar4 = new k(iVar, d0Var, iI4, this.a, iI2, i27, (((long) iI0) << 32) | (((long) iI2) & 4294967295L));
        l lVar = new l(oVar, iA, iI4, kVar4, uVar3);
        int i28 = iA;
        u uVar4 = (u) lVar.f;
        androidx.activity.compose.h hVar = new androidx.activity.compose.h(17, uVar3, lVar);
        androidx.activity.compose.g gVar2 = new androidx.activity.compose.g(uVar3, 10);
        ...
        try {
            int iG3 = xVar2.g();
            int i29 = androidx.compose.foundation.lazy.layout.m.i(iVar, uVar2.e, iG3);
            if (iG3 != i29) {
                uVar2.b.h(i29);
                uVar2.f.b(iG3);
            }
            ...
            float fFloatValue = (n1Var2.V() || !z4) ? xVar2.g : ((Number) xVar2.v.b.y.getValue()).floatValue();
            androidx.compose.foundation.lazy.layout.v vVar = xVar2.m;
            boolean zV = n1Var2.V();
            n nVar2 = xVar2.c;
            a1 a1Var2 = xVar2.r;
            if (
