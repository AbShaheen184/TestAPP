...
public final class u {
    ...
    public t c(int i) {
        ...
        if (!((h) this.g).d) {
            ...
            if (i5 == this.i.size()) {
                ...
                for (int i7 = 0; i7 < i5; i7++) {
                    arrayList2.add(new b(coil3.svg.internal.a.a(1)));
                }
                this.i = arrayList2;
                r0 = arrayList2;
            }
        ...
        while (i11 < this.f && i12 < e()) {
            ...
            i12++;
            arrayList4.add(new b(coil3.svg.internal.a.a(iG)));
            iG = i3;
        }
    ...
    public int d(int i) {
        ...
        kotlin.collections.q.n(arrayList.size(), size);
        int i3 = size - 1;
        int i4 = 0;
        while (true) {
            if (i4 > i3) {
    ...
    public g0 f(b0 b0Var) {
        ...
        this.f++;
        if (b1Var != null) {
            okhttp3.internal.connection.o oVarB = ((okhttp3.internal.connection.g) b1Var.z).b();
            okhttp3.s sVar = b0Var.a;
            oVarB.getClass();
            sVar.getClass();
            okhttp3.s sVar2 = oVarB.j.h;
            if (sVar.e != sVar2.e || !kotlin.jvm.internal.l.a(sVar.d, sVar2.d)) {
                androidx.transition.k.k(arrayList.get(i - 1), " must retain the same host and port", "network interceptor ");
                return null;
            }
            if (this.f != 1) {
                androidx.transition.k.k(arrayList.get(i - 1), " must call proceed() exactly once", "network interceptor ");
                return null;
            }
        }
        int i2 = i + 1;
        ...
        androidx.transition.k.k(tVar, " must call proceed() exactly once", "network interceptor ");
        return null;
    }
