...
public final class x implements l2 {
    public static final androidx.compose.foundation.text.input.internal.o w = androidx.compose.runtime.saveable.l.b(new b2(5), new w1(5));
    ...
    public x(int i, int i2) {
        ...
        aVar.c = -1;
        this.a = aVar;
        this.d = new androidx.compose.foundation.lazy.u(i, i2, 1);
        this.e = new j1(z.a, androidx.compose.runtime.f.A);
    ...
    */
    public final java.lang.Object c(androidx.compose.foundation.j1 r6, kotlin.jvm.functions.p r7, kotlin.coroutines.jvm.internal.c r8) {
        ...
        L3c:
            kotlin.a.e(r8)
            androidx.compose.runtime.j1 r8 = r5.e
        ...
        L6b:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.x.c(androidx.compose.foundation.j1, kotlin.jvm.functions.p, kotlin.coroutines.jvm.internal.c):java.lang.Object");
    }
    ...
    public final void f(n nVar, boolean z, boolean z2) {
        ...
        androidx.compose.foundation.lazy.u uVar = this.d;
        if (z2) {
            uVar.getClass();
            if (!(((float) i3) >= 0.0f)) {
            ...
            if (this.i) {
                ...
                if (i7 != -1 && aVar.d != 0.0f && i7 != i2 && !r0.isEmpty()) {
                    ...
                    int i8 = aVar.d < 0.0f ? ((o) kotlin.collections.p.J(r0)).a + 1 : ((o) kotlin.collections.p.B(r0)).a - 1;
    ...
    public final void i(float f, n nVar) {
        if (this.i) {
            ...
            if (!r2.isEmpty()) {
                ...
                int i2 = z ? ((o) kotlin.collections.p.J(r3)).a + 1 : ((o) kotlin.collections.p.B(r3)).a - 1;
                if (i2 >= 0 && i2 < nVar.p) {
                    if (iB != aVar.a && iB >= 0) {
                        if (aVar.b != z) {
                            Object[] objArr = bVar.e;
                    ...
                    if (z) {
                        o oVar = (o) kotlin.collections.p.J(r3);
                        if (((org.jsoup.helper.n.F(oVar, o1Var) + ((int) (o1Var == o1.e ? oVar.n & 4294967295L : oVar.n >> 32))) + nVar.s) - nVar.o < (-f)) {
                    ...
                    } else if (nVar.n - org.jsoup.helper.n.F((o) kotlin.collections.p.B(r3), o1Var) < f) {
