...
public final class a1 implements l0 {
    ...
    public final boolean c(b bVar) {
        ...
        androidx.compose.ui.platform.coreshims.b.E("compose:lazy:prefetch:execute:item", -1L);
        return zD;
    }
    ...
    public final boolean d(b bVar) {
        ...
        int i5 = this.a;
        long j2 = i5;
        androidx.compose.ui.platform.coreshims.b.E("compose:lazy:prefetch:execute:item", j2);
        b1 b1Var = this.p;
        ...
        if (!this.g) {
            ...
            if (i5 >= 0 && i5 < iA2) {
                ...
                this.n = 0L;
                androidx.compose.ui.platform.coreshims.b.E("compose:lazy:prefetch:available_time_nanos", jA);
                if (!e()) {
                    if (f(this.m, dVar.a)) {
                        ...
                        try {
                            ...
                            this.i = objB;
                            androidx.compose.ui.layout.m0 m0VarA = ((m1) b1Var.z).a();
    ...
    public final void g() {
        ...
        this.m = j2;
        this.o = jB;
        androidx.compose.ui.platform.coreshims.b.E("compose:lazy:prefetch:available_time_nanos", j2);
    }
