...
public final class b1 implements androidx.media3.extractor.p {
    ...
    public okio.x g(int i) {
        ...
        synchronized (dVar.E) {
            ...
            androidx.work.impl.v.h(dVar.N, (okio.x) obj);
            xVar = (okio.x) obj;
        }
        return xVar;
    }
    ...
    public void h(androidx.media3.extractor.a0 a0Var) {
        ((androidx.media3.extractor.p) this.y).h(a0Var);
    }
    ...
    public okhttp3.internal.connection.n i() {
        ...
        kotlinx.coroutines.future.a.u("no connection for CONNECT tunnels");
        return null;
    }
    ...
    public synchronized void j() {
        try {
            ...
            this.z = boolM;
            if (boolM == null) {
                com.google.firebase.i iVar = new com.google.firebase.i(27);
        ...
        synchronized (hVar) {
            try {
                ...
                try {
                    ...
                    gVar.getClass();
                    xVar.getClass();
                    return new okhttp3.internal.cache.i(gVar.b0(xVar, false), new com.app.mlounge.ui.screens.player.s(7, hVar, this));
    ...
    public void o() {
        if (this.e) {
            ((androidx.media3.common.util.f0) this.A).d(new androidx.activity.l(this, 10));
            this.e = false;
        }
    }
    ...
    public boolean p(String str, String str2) {
        synchronized (this) {
            try {
                ...
                androidx.work.p pVar = new androidx.work.p(this, 8);
                ...
                ((com.google.firebase.crashlytics.internal.concurrency.d) ((q2) this.A).b).b.a(pVar);
                return true;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public com.google.android.datatransport.runtime.j s() throws SocketException {
        ...
        nVar.f();
        return new com.google.android.datatransport.runtime.j(this);
    }

    public String t() {
        if (!this.e) {
            this.e = true;
            com.google.android.gms.measurement.internal.d1 d1Var = (com.google.android.gms.measurement.internal.d1) this.A;
            this.z = d1Var.z().getString((String) this.y, null);
        }
    ...
    public void v(String str) {
        SharedPreferences.Editor editorEdit = ((com.google.android.gms.measurement.internal.d1) this.A).z().edit();
        editorEdit.putString((String) this.y, str);
        editorEdit.apply();
        this.z = str;
    }

    public b1(com.google.android.gms.measurement.internal.d1 d1Var, String str) {
        this.A = d1Var;
    ...
    public b1(Context context, Looper looper, Looper looper2, androidx.media3.exoplayer.x xVar, androidx.media3.common.util.d0 d0Var) {
        this.y = context.getApplicationContext();
        this.A = d0Var.a(looper, null);
        this.z = new androidx.media3.common.audio.a(this, d0Var.a(looper2, null), xVar);
    }
    ...
    public b1(x xVar, m1 m1Var, c1 c1Var) {
        this.y = xVar;
        this.z = m1Var;
        this.A = c1Var;
        this.e = true;
