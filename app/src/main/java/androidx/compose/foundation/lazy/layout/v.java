...
public final class v {
    ...
    public final void a(int i, Object obj) {
        androidx.privacysandbox.ads.adservices.java.internal.a.D(this.a.g(obj));
    }
    ...
    public final void c(int i, int i2, ArrayList arrayList, androidx.appcompat.widget.x xVar, j2 j2Var, boolean z, int i3, boolean z2, int i4, int i5) throws Throwable {
        ...
        for (int i12 = 0; i12 < size2; i12++) {
            ...
            androidx.privacysandbox.ads.adservices.java.internal.a.D(this.a.k(e0Var2.getKey()));
        }
        int[] iArr = new int[i3];
        ...
        if (z3 && xVar2 != null) {
            if (!arrayList3.isEmpty()) {
                if (arrayList3.size() > 1) {
                    kotlin.collections.t.s(new u(xVar2, 2), arrayList3);
                }
                if (arrayList3.size() > 0) {
                    ...
                    objG.getClass();
                    androidx.privacysandbox.ads.adservices.java.internal.a.D(objG);
                    e0Var3.h(0);
                    throw null;
                }
            ...
            if (!arrayList2.isEmpty()) {
                if (arrayList2.size() > 1) {
                    kotlin.collections.t.s(new u(xVar2, 0), arrayList2);
                }
                if (arrayList2.size() > 0) {
                    ...
                    objG2.getClass();
                    androidx.privacysandbox.ads.adservices.java.internal.a.D(objG2);
                    e0Var4.h(0);
                    throw null;
                }
                Arrays.fill(iArr, 0, i3, 0);
            ...
            while (true) {
                ...
                if ((((~j3) << 7) & j3 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i16 = 0; i16 < i15; i16++) {
                        if ((j4 & 255) < 128) {
                            androidx.privacysandbox.ads.adservices.java.internal.a.D(o0Var.g(objArr2[(i14 << 3) + i16]));
                        }
                        j4 >>= 8;
                    }
                    if (i15 != 8) {
        ...
        if (!arrayList4.isEmpty()) {
            if (arrayList4.size() > 1) {
                kotlin.collections.t.s(new u(xVar, 3), arrayList4);
            }
            if (arrayList4.size() > 0) {
                e0 e0Var5 = (e0) arrayList4.get(0);
                Object objG3 = o0Var.g(e0Var5.getKey());
                objG3.getClass();
                androidx.privacysandbox.ads.adservices.java.internal.a.D(objG3);
                e(iArr, e0Var5);
                if (!z) {
                    throw th;
                }
                ((e0) kotlin.collections.p.B(arrayList)).h(0);
                throw th;
            }
            Arrays.fill(iArr, 0, i3, 0);
        }
        ...
        if (!arrayList5.isEmpty()) {
            if (arrayList5.size() > 1) {
                kotlin.collections.t.s(new u(xVar, 1), arrayList5);
            }
            if (arrayList5.size() > 0) {
                e0 e0Var6 = (e0) arrayList5.get(0);
                Object objG4 = o0Var.g(e0Var6.getKey());
                objG4.getClass();
                androidx.privacysandbox.ads.adservices.java.internal.a.D(objG4);
                e(iArr, e0Var6);
                throw th;
            }
        }
                ...
                while (true) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                        ...
                        for (int i3 = 0; i3 < i2; i3++) {
                            if ((255 & j) < 128) {
                                androidx.privacysandbox.ads.adservices.java.internal.a.D(objArr[(i << 3) + i3]);
                                throw null;
                            }
                            j >>= 8;
                        }
