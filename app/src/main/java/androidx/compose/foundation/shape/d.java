...
public final class d implements n0 {
    ...
    public final a0 a(long j, m mVar, androidx.compose.ui.unit.c cVar) {
        ...
        if (fA + fA2 + fA3 + fA4 == 0.0f) {
            return new h0(n.b(0L, j));
        }
        androidx.compose.ui.geometry.c cVarB = n.b(0L, j);
        m mVar2 = m.e;
        ...
        return new i0(new androidx.compose.ui.geometry.d(cVarB.a, cVarB.b, cVarB.c, cVarB.d, jFloatToRawIntBits, jFloatToRawIntBits2, jFloatToRawIntBits3, (((long) Float.floatToRawIntBits(fA4)) << 32) | (((long) Float.floatToRawIntBits(fA4)) & 4294967295L)));
    }
