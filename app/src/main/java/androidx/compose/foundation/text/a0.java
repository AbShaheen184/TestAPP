...
public final class a0 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        switch (this.e) {
            case 0:
                a0 a0Var = new a0((androidx.compose.ui.input.pointer.y) this.z, (x0) this.A, (androidx.compose.foundation.text.selection.b1) this.B, dVar, 0);
                a0Var.y = obj;
                return a0Var;
            case 1:
    ...
    public final Object invokeSuspend(Object obj) throws UnsupportedEncodingException {
        ...
        switch (i) {
            case 0:
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, coroutineStart, new androidx.activity.compose.p(yVar2, (androidx.compose.foundation.text.selection.b1) obj2, r3, 9), 1, null);
                return yVar;
            case 1:
                    ...
                    if (iHashCode != -732362228) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (jVarC0 == null) {
                                ...
                                strD0.getClass();
                                String string = kotlin.text.k.g0(strD0).toString();
            ...
            case 3:
                ...
                rVar.getClass();
                String str3 = "ok";
                if (kotlin.text.r.u(str2, "http", false) && !kotlin.text.k.z(str2, "googleusercontent.com", false) && !kotlin.text.k.z(str2, ".m3u8", false) && !kotlin.text.k.z(str2, ".workers.dev", false)) {
                    try {
