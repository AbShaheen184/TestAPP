...
public final class c extends t {
    ...
    public final void h(androidx.compose.ui.geometry.c cVar) {
        ...
        w wVar = this.c;
        if (wVar != null) {
            wVar.l = new Rect(kotlin.math.a.H(cVar.a), kotlin.math.a.H(cVar.b), kotlin.math.a.H(cVar.c), kotlin.math.a.H(cVar.d));
    ...
    public final void k(androidx.activity.compose.c cVar) {
        ...
        if (qVar.K) {
            jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(qVar.A0(), null, CoroutineStart.UNDISPATCHED, new androidx.activity.compose.p(qVar, fVar, b == true ? 1 : 0, 12), 1, null);
        }
