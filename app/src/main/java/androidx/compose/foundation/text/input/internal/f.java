...
public final class f extends w0 {
    ...
    public f(e0 e0Var, androidx.compose.ui.text.input.x xVar, r0 r0Var, boolean z, boolean z2, boolean z3, androidx.compose.ui.text.input.q qVar, b1 b1Var, androidx.compose.ui.text.input.k kVar, y yVar) {
        this.b = e0Var;
        this.c = xVar;
        this.d = r0Var;
        this.e = z;
    ...
    public final void g(androidx.compose.ui.q qVar) {
        ...
        if (z6 != z || z2 != z3 || !kotlin.jvm.internal.l.a(kVar2, kVar) || this.g != z4 || !l0.c(xVar.b)) {
            androidx.compose.ui.node.l.m(iVar);
        }
        if (b1Var2.equals(b1Var)) {
            return;
        }
        b1Var2.g = new g(iVar, 0);
    }

    public final int hashCode() {
        return this.k.hashCode() + ((this.j.hashCode() + ((this.i.hashCode() + ((this.h.hashCode() + androidx.privacysandbox.ads.adservices.java.internal.a.h(androidx.privacysandbox.ads.adservices.java.internal.a.h(androidx.privacysandbox.ads.adservices.java.internal.a.h((this.d.hashCode() + ((this.c.hashCode() + (this.b.hashCode() * 31)) * 31)) * 31, 31, this.e), 31, this.f), 31, this.g)) * 31)) * 31)) * 31);
    }
