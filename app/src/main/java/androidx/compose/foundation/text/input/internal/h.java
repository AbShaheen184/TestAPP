...
public final /* synthetic */ class h implements kotlin.jvm.functions.l {
    ...
    public /* synthetic */ h(i iVar, a0 a0Var) {
        this.e = 3;
        this.y = iVar;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                i.P0(r0Var, (String) charSequenceB, iVar.Q, iVar.R);
                return bool;
            case 1:
                List list = (List) obj;
                if (iVar.P.d() != null) {
            ...
            case 2:
                i.P0(iVar.P, ((androidx.compose.ui.text.g) obj).y, iVar.Q, iVar.R);
                return Boolean.TRUE;
            default:
                ...
                if (iVar.Q || !iVar.R) {
                    ...
                    if (d0Var != null) {
                        List listK = kotlin.collections.q.k(new androidx.compose.ui.text.input.i(), new androidx.compose.ui.text.input.a(gVar, 1));
                        r0 r0Var2 = iVar.P;
                        o oVar = r0Var2.d;
                        androidx.compose.foundation.text.s sVar = r0Var2.v;
                        androidx.compose.ui.text.input.x xVarJ = oVar.j(listK);
                        d0Var.a(null, xVarJ);
                        sVar.invoke(xVarJ);
                    } else {
                        ...
                        if (i4 >= i3) {
                            ...
                            com.google.firebase.platforminfo.b.d(i4, "End index (", ") is less than start index (", i3);
                        }
