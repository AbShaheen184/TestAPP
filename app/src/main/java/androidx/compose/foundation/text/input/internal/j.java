...
public abstract class j {
    ...
    public static int d(r0 r0Var, HandwritingGesture handwritingGesture, b1 b1Var, q2 q2Var, androidx.activity.compose.g gVar) {
        long jH;
        int i;
        k1 k1VarD;
        k1 k1VarD2;
        ...
        if (handwritingGesture instanceof SelectGesture) {
            ...
            if (!(handwritingGesture instanceof SelectRangeGesture)) {
                ...
                if (handwritingGesture instanceof JoinOrSplitGesture) {
                    ...
                    int iA = r.a(r0Var, r.e(joinOrSplitGesture.getJoinOrSplitPoint()), q2Var);
                ...
                if (handwritingGesture instanceof InsertGesture) {
                    ...
                    int iA2 = r.a(r0Var, r.e(insertGesture.getInsertionPoint()), q2Var);
                ...
                if (j0Var != null) {
                    ...
                    if (xVarC == null) {
                        ...
                        long jT = xVarC.T(jE);
                        long jT2 = xVarC.T(jE2);
                        int iG = r.g(nVar, jT, q2Var);
                        int iG2 = r.g(nVar, jT2, q2Var);
                        if (iG != -1) {
                            if (iG2 != -1) {
                                iG = Math.min(iG, iG2);
                            }
                ...
                xVar2.e = -1;
                String strF = new kotlin.text.i("\\s+").f(gVar2.subSequence(l0.f(jH), l0.e(jH)).y, new androidx.activity.compose.h(24, xVar, xVar2));
                int i7 = xVar.e;
                if (i7 == -1 || (i = xVar2.e) == -1) {
                    return b(removeSpaceGesture, gVar);
                }
    ...
    public static boolean e(r0 r0Var, PreviewableHandwritingGesture previewableHandwritingGesture, b1 b1Var, CancellationSignal cancellationSignal) {
        androidx.compose.ui.text.i0 i0Var;
        ...
        if (gVar != null) {
            ...
            if (gVar.equals((k1VarD == null || (i0Var = k1VarD.a.a) == null) ? null : i0Var.a)) {
                ...
                if (cancellationSignal != null) {
                    cancellationSignal.setOnCancelListener(new m(b1Var, 0));
                }
                return true;
            }
        }
    ...
    public static void f(EditorInfo editorInfo) {
        editorInfo.setSupportedHandwritingGestures(kotlin.collections.q.k(SelectGesture.class, DeleteGesture.class, SelectRangeGesture.class, DeleteRangeGesture.class, JoinOrSplitGesture.class, InsertGesture.class, RemoveSpaceGesture.class));
        editorInfo.setSupportedHandwritingGesturePreviews(kotlin.collections.o.D(new Class[]{SelectGesture.class, DeleteGesture.class, SelectRangeGesture.class, DeleteRangeGesture.class}));
    }
}
