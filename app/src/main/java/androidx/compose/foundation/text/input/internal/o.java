...
public final class o implements androidx.compose.runtime.g, k0, androidx.compose.runtime.saveable.k, androidx.compose.ui.text.android.selection.d, androidx.emoji2.text.p {
    ...
    public o(int i) {
        ...
        switch (i) {
            ...
            case 19:
                ...
                break;
            case 21:
                this.y = new com.google.firebase.heartbeatinfo.e(3);
                ...
                if ((qVar.A & LibretroCore.SCREEN_WIDTH) != 0) {
                    while (qVar != null) {
                        if ((qVar.z & LibretroCore.SCREEN_WIDTH) != 0) {
                            ...
                            ?? bVar = 0;
                            while (E != 0) {
                                if (E instanceof androidx.compose.ui.node.o) {
                                    androidx.compose.ui.node.o oVar = (androidx.compose.ui.node.o) E;
                                    oVar.w0(androidx.compose.ui.node.l.t(oVar, LibretroCore.SCREEN_WIDTH));
                                } else if ((E.z & LibretroCore.SCREEN_WIDTH) != 0 && (E instanceof androidx.compose.ui.node.k)) {
    ...
    public List h(Integer num) {
        ...
        k2 k2Var = (k2) this.z;
        int i = k2Var.v;
        return i < 0 ? listH : kotlin.collections.p.O(androidx.work.impl.v.g(k2Var, num, i, Integer.valueOf(k2Var.E(i, k2Var.b))), listH);
    }
            ...
            while (i < size) {
                try {
                    ...
                    try {
                        ...
                        sb.append('\n');
                        kotlin.collections.p.H(list, sb, new s2(4, gVar, this), 60);
    ...
    public void p(androidx.core.provider.g gVar) {
        ...
        com.google.firebase.platforminfo.d dVar = (com.google.firebase.platforminfo.d) this.y;
        int i = gVar.b;
        if (i != 0) {
            lVar.execute(new androidx.core.provider.a(dVar, i, 0));
        } else {
            lVar.execute(new com.google.common.util.concurrent.k0(2, dVar, gVar.a));
        }
    }
    ...
    public void r() {
        if (((androidx.compose.ui.input.indirect.b) this.z) != null) {
            this.z = null;
            ((androidx.compose.foundation.j) this.y).T0(true);
        }
    }
    ...
    public void s(boolean z) {
        ...
        if (iVar.z != z) {
            if (iVar.y != null) {
                ...
                jVarA.getClass();
                t1.n(hVar, "initCallback cannot be null");
        ...
        switch (this.e) {
            case 23:
                ...
                if (((androidx.constraintlayout.core.h) this.y) != null) {
                    for (int i = 0; i < 9; i++) {
                        StringBuilder sbP = androidx.compose.runtime.j.p(string);
                        sbP.append(((androidx.constraintlayout.core.h) this.y).E[i]);
                        sbP.append(" ");
                        string = sbP.toString();
                    }
                }
    ...
    public o(f0 f0Var, q0 q0Var) {
        this.e = 16;
        this.y = f0Var;
        this.z = androidx.compose.runtime.t.r(q0Var);
    }
    ...
    public o(androidx.compose.material3.internal.p pVar) {
        this.e = 10;
        this.z = pVar;
        this.y = new androidx.compose.material3.internal.o(pVar);
    }
