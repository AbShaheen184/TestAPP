...
public abstract class r {
    public static final int a(r0 r0Var, long j, q2 q2Var) {
        long jT;
        int iG;
        k1 k1VarD = r0Var.d();
        if (k1VarD != null) {
            ...
            if (xVarC != null && (iG = g(nVar, (jT = xVarC.T(j)), q2Var)) != -1) {
                return nVar.g(androidx.compose.ui.geometry.b.a(jT, (nVar.b(iG) + nVar.f(iG)) / 2.0f, 1));
            }
        }
        return -1;
    }
    ...
    public static final ExtractedText d(androidx.compose.ui.text.input.x xVar) {
        ...
        extractedText.flags = !kotlin.text.k.A(xVar.a.y, '\n') ? 1 : 0;
    ...
    public static final int g(androidx.compose.ui.text.n nVar, long j, q2 q2Var) {
        float fG = q2Var != null ? q2Var.g() : 0.0f;
    ...
    public static final long h(r0 r0Var, androidx.compose.ui.geometry.c cVar, int i) {
        ...
        androidx.compose.ui.layout.x xVarC = r0Var.c();
        return (nVar == null || xVarC == null) ? l0.b : nVar.h(cVar.i(xVarC.T(0L)), i, h0.b);
    }
    ...
    public static final androidx.compose.ui.r l(androidx.compose.ui.r rVar, t tVar, r0 r0Var, b1 b1Var) {
        return rVar.d(new p(tVar, r0Var, b1Var));
    }
}
