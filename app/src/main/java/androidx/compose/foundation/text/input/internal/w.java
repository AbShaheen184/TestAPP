...
public final class w {
    ...
    public Rect l;
    public final s m;
    public kotlin.jvm.functions.l c = new w1(19);
    public kotlin.jvm.functions.l d = new w1(20);
    ...
    public final x a(EditorInfo editorInfo) {
        ...
        x xVar2 = new x(this.h, new com.google.firebase.platforminfo.d(this), this.i.c, this.e, this.f, this.g);
