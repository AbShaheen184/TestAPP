...
public final class x implements InputConnection {
    public final com.google.firebase.platforminfo.d a;
    ...
    public x(androidx.compose.ui.text.input.x xVar, com.google.firebase.platforminfo.d dVar, boolean z, r0 r0Var, b1 b1Var, q2 q2Var) {
        this.a = dVar;
        this.b = z;
        this.c = r0Var;
        this.d = b1Var;
    ...
    public final CharSequence getSelectedText(int i) {
        ...
        return com.imsdk.a.q(this.g).y;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextAfterCursor(int i, int i2) {
        return com.imsdk.a.r(this.g, i).y;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextBeforeCursor(int i, int i2) {
        return com.imsdk.a.s(this.g, i).y;
    }
    ...
    public final void performHandwritingGesture(HandwritingGesture handwritingGesture, Executor executor, IntConsumer intConsumer) {
        if (Build.VERSION.SDK_INT >= 34) {
            androidx.activity.compose.g gVar = new androidx.activity.compose.g(this, 22);
            r0 r0Var = this.c;
