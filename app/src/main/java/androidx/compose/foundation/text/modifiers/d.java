...
public final class d {
    ...
    public static long f(d dVar, long j, m mVar) {
        ...
        if ((bVar == null || mVar != bVar.a || !d0.h(m0Var, mVar).equals(bVar.b) || cVar.a() != bVar.c.e || dVar2 != bVar.d) && ((bVar = b.h) == null || mVar != bVar.a || !d0.h(m0Var, mVar).equals(bVar.b) || cVar.a() != bVar.c.e || dVar2 != bVar.d)) {
            bVar = new b(mVar, d0.h(m0Var, mVar), new androidx.compose.ui.unit.d(cVar.a(), cVar.U()), dVar2);
            b.h = bVar;
        }
        dVar.m = bVar;
        int i2 = dVar.g;
    ...
    public final int a(int i, m mVar) {
        ...
        r rVarE = e(mVar);
        long jU = t1.u(jA, this.e, this.d, rVarE.c());
        boolean z = this.e;
        int i4 = this.d;
        int i5 = this.f;
        int iJ = n0.j(new androidx.compose.ui.text.a((androidx.compose.ui.text.platform.d) rVarE, ((z || !(i4 == 2 || i4 == 4 || i4 == 5)) && i5 >= 1) ? i5 : 1, i4, jU).b());
    ...
    public final boolean b(long j, m mVar) {
        ...
        r rVarE = e(mVar);
        long jU = t1.u(jF, this.e, this.d, rVarE.c());
        boolean z3 = this.e;
        int i = this.d;
        int i2 = this.f;
        androidx.compose.ui.text.a aVar3 = new androidx.compose.ui.text.a((androidx.compose.ui.text.platform.d) rVarE, ((z3 || !(i == 2 || i == 4 || i == 5)) && i2 >= 1) ? i2 : 1, i, jU);
        this.p = jF;
    ...
    public final r e(m mVar) {
        ...
        if (dVar == null || mVar != this.o || dVar.a()) {
            ...
            w wVar = w.e;
            dVar = new androidx.compose.ui.text.platform.d(str, m0VarH, wVar, wVar, dVar2, cVar);
        }
        this.n = dVar;
        return dVar;
    }
    ...
    public final String toString() {
        ...
        sb.append(", history=");
        return androidx.privacysandbox.ads.adservices.java.internal.a.p(this.s, ", constraints=$)", sb);
    }
}
