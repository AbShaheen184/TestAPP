...
public final class b1 {
    ...
    public final androidx.compose.runtime.j1 x;
    public final androidx.compose.foundation.text.input.internal.o y;
    public final z0 z;
    public androidx.compose.ui.text.input.q b = m1.a;
    public kotlin.jvm.functions.l c = new w1(10);
    public final androidx.compose.runtime.j1 e = androidx.compose.runtime.t.r(new androidx.compose.ui.text.input.x(7, 0, (String) null));
    ...
    public b1(l1 l1Var) {
        ...
        this.o = 0L;
        this.q = 0L;
        this.r = androidx.compose.runtime.t.r(null);
        this.s = androidx.compose.runtime.t.r(null);
        this.t = -1;
        this.u = new androidx.compose.ui.text.input.x(7, 0L, (String) null);
        this.x = androidx.compose.runtime.t.r(Boolean.FALSE);
    ...
    public static final kotlin.k a(b1 b1Var) {
        String str;
        androidx.compose.ui.text.l0 l0Var;
        androidx.compose.ui.text.g gVarM = b1Var.m();
        if (gVarM == null || (str = gVarM.y) == null || (l0Var = b1Var.w) == null) {
            return null;
        }
        long j = l0Var.a;
        return new kotlin.k(str, new androidx.compose.ui.text.l0(androidx.compose.ui.text.d0.b(b1Var.b.v((int) (j >> 32)), b1Var.b.v((int) (j & 4294967295L)))));
    }

    public static final void b(b1 b1Var, androidx.compose.ui.text.l0 l0Var) {
        ...
        long j = l0Var.a;
        n nVar = b1Var.j;
        if (nVar == null || (gVarM = b1Var.m()) == null || (str = gVarM.y) == null) {
            return;
        }
        ...
        if (str.length() <= 0 || androidx.compose.ui.text.l0.c(jB) || (coroutineScope = b1Var.i) == null) {
            return;
        }
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new androidx.compose.foundation.gestures.h(nVar, str, jB, l0Var, b1Var, qVar, null), 3, null);
    }

    /* JADX WARN: Code duplicated, block: B:80:0x0155  */
    public static final long c(b1 b1Var, androidx.compose.ui.text.input.x xVar, long j, boolean z, boolean z2, androidx.collection.g gVar, boolean z3) {
        k1 k1VarD;
        long j2;
        z zVar;
        z zVar2;
        ...
        long jB = androidx.compose.ui.text.d0.b(qVar.v((int) (j3 >> 32)), b1Var.b.v((int) (j3 & 4294967295L)));
        ...
        if (z) {
            ...
            int i6 = (int) (jB >> 32);
            int i7 = (int) (jB & j2);
            zVar = new z(new y(android.support.v4.media.session.b.r(j0Var, i6), i6, 1L), new y(android.support.v4.media.session.b.r(j0Var, i7), i7, 1L), androidx.compose.ui.text.l0.g(jB));
        }
        ...
        switch (i8) {
            case 4:
                ...
                break;
            case 5:
                zVar2 = org.jsoup.helper.n.c(q0Var2, a0.c);
                break;
            case 6:
                zVar2 = org.jsoup.helper.n.c(q0Var2, a0.b);
                break;
            default:
                zVar2 = (z) q0Var2.z;
                w wVar3 = (w) q0Var2.A;
                if (zVar2 != null) {
                    ...
                    y yVar4 = zVar2.a;
                    if (q0Var2.y) {
                        yVarD = org.jsoup.helper.n.d(q0Var2, wVar3, yVar4);
                        yVar2 = yVar3;
                        yVar3 = yVar4;
                        yVar = yVarD;
                    } else {
                        yVarD = org.jsoup.helper.n.d(q0Var2, wVar3, yVar3);
                        yVar = yVar4;
                        yVar2 = yVarD;
                    }
                        ...
                        if (j4 != yVar6.c) {
                            ...
                            if (zVar3 == null && str2.length() != 0) {
                                ...
                                if (i9 == 0) {
                                    ...
                                    zVar2 = !z6 ? z.a(zVar4, null, org.jsoup.helper.n.l(yVar6, wVar4, iL), false, 1) : z.a(zVar4, org.jsoup.helper.n.l(yVar5, wVar4, iL), null, true, 2);
                                } else if (i9 != length) {
                                    boolean z7 = zVar3.c;
                                    int iO = z6 ^ z7 ? androidx.compose.foundation.text.n0.o(i9, str3) : androidx.compose.foundation.text.n0.l(i9, str3);
                                    zVar2 = !z6 ? z.a(zVar4, null, org.jsoup.helper.n.l(yVar6, wVar4, iO), z7, 1) : z.a(zVar4, org.jsoup.helper.n.l(yVar5, wVar4, iO), null, z7, 2);
                                } else {
                                    int iO2 = androidx.compose.foundation.text.n0.o(length, str3);
                                    zVar2 = !z6 ? z.a(zVar4, null, org.jsoup.helper.n.l(yVar6, wVar4, iO2), true, 1) : z.a(zVar4, org.jsoup.helper.n.l(yVar5, wVar4, iO2), null, false, 2);
                                }
                                break;
                            }
                        }
        ...
        long jB2 = androidx.compose.ui.text.d0.b(b1Var.b.j(zVar2.a.b), b1Var.b.j(zVar2.b.b));
        ...
        if (z3 && gVar2.y.length() > 0 && !z8 && !z9 && (aVar = b1Var.k) != null) {
            aVar.a(9);
        }
        b1Var.c.invoke(e(gVar2, jB2));
        b1Var.w = new androidx.compose.ui.text.l0(jB2);
        if (!z3) {
            b1Var.t(!androidx.compose.ui.text.l0.c(jB2));
        }
        ...
        if (r0Var3 != null) {
            r0Var3.m.setValue(Boolean.valueOf(!androidx.compose.ui.text.l0.c(jB2) && coil3.svg.internal.a.C(b1Var, true)));
        }
        androidx.compose.foundation.text.r0 r0Var4 = b1Var.d;
        if (r0Var4 != null) {
            z4 = false;
            r0Var4.n.setValue(Boolean.valueOf(!androidx.compose.ui.text.l0.c(jB2) && coil3.svg.internal.a.C(b1Var, false)));
        } else {
            z4 = false;
        }
        androidx.compose.foundation.text.r0 r0Var5 = b1Var.d;
        if (r0Var5 != null) {
            if (androidx.compose.ui.text.l0.c(jB2) && coil3.svg.internal.a.C(b1Var, true)) {
                z4 = true;
            }
    ...
    public final Job d(boolean z) {
        ...
        if (coroutineScope != null) {
            return BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, CoroutineStart.UNDISPATCHED, new w0(this, z, dVar, 0), 1, null);
        }
        return null;
    }
    ...
    public final void f() {
        CoroutineScope coroutineScope = this.i;
        if (coroutineScope != null) {
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, CoroutineStart.UNDISPATCHED, new t0(this, null, 1), 1, null);
        }
    }
    ...
    public final void g(androidx.compose.ui.geometry.b bVar) {
        if (!androidx.compose.ui.text.l0.c(n().b)) {
            ...
            k1 k1VarD = r0Var != null ? r0Var.d() : null;
    ...
    public final long l(boolean z) {
        ...
        androidx.compose.ui.text.p pVar = (androidx.compose.ui.text.p) arrayList.get(iV == length ? kotlin.collections.q.h(arrayList) : androidx.compose.ui.text.d0.d(iV, arrayList));
        androidx.compose.ui.text.a aVar = pVar.a;
        int iD2 = pVar.d(iV);
        androidx.compose.ui.text.android.l lVar = aVar.d;
        return (((long) Float.floatToRawIntBits(kotlin.collections.i0.c(nVar.b(iD), 0.0f, (int) (j4 & 4294967295L)))) & 4294967295L) | (((long) Float.floatToRawIntBits(kotlin.collections.i0.c(z2 ? lVar.h(iD2, false) : lVar.i(iD2, false), 0.0f, (int) (j4 >> 32)))) << 32);
    }
    ...
    public final void p() {
        CoroutineScope coroutineScope = this.i;
        if (coroutineScope != null) {
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, CoroutineStart.UNDISPATCHED, new t0(this, null, 2), 1, null);
        }
    }
    ...
    public final void r() {
        ...
        try {
            ...
            Job job = jVar.R;
            if ((job == null || !job.isActive()) && (fVar = (androidx.compose.foundation.text.contextmenu.provider.f) androidx.compose.ui.node.l.h(jVar, androidx.compose.foundation.text.contextmenu.provider.g.b)) != null) {
                jVar.R = BuildersKt__Builders_commonKt.launch$default(jVar.A0(), null, CoroutineStart.UNDISPATCHED, new androidx.compose.animation.b0(jVar, fVar, dVar, 13), 1, null);
            }
        } catch (Throwable th) {
            androidx.compose.runtime.snapshots.r.k(fVarE, fVarH, lVarE);
            throw th;
