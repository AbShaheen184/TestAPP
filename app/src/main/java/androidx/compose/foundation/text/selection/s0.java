...
public final class s0 {
    ...
    public s0(androidx.compose.ui.text.input.x xVar, androidx.compose.ui.text.input.q qVar, k1 k1Var, h1 h1Var) {
    ...
    public final List a(kotlin.jvm.functions.l lVar) {
        if (!androidx.compose.ui.text.l0.c(this.f)) {
            return kotlin.collections.q.k(new androidx.compose.ui.text.input.a("", 0), new androidx.compose.ui.text.input.w(androidx.compose.ui.text.l0.f(this.f), androidx.compose.ui.text.l0.f(this.f)));
        }
        androidx.compose.ui.text.input.g gVar = (androidx.compose.ui.text.input.g) lVar.invoke(this);
        if (gVar != null) {
            return kotlin.collections.q.j(gVar);
        }
        return null;
    }
    ...
    public final int g(androidx.compose.ui.text.j0 j0Var, int i) {
        ...
        h1 h1Var = this.e;
        if (h1Var.a == null) {
            h1Var.a = Float.valueOf(j0Var.c(iR).a);
        }
        androidx.compose.ui.text.n nVar = j0Var.b;
        int iD = nVar.d(iR) + i;
        if (iD < 0) {
    ...
    public final int h(k1 k1Var, int i) {
