...
public final class t implements n {
    ...
    public final androidx.compose.runtime.j1 g = androidx.compose.runtime.t.r(null);
    public final Object h = new Object();

    public t(kotlin.coroutines.j jVar, Context context, x xVar, androidx.compose.ui.text.intl.b bVar) {
        this.a = jVar;
        this.b = context;
        this.c = xVar;
        this.d = bVar;
    ...
    public static final Object a(t tVar, CharSequence charSequence, long j, TextClassifier textClassifier, kotlin.coroutines.jvm.internal.c cVar) throws Throwable {
        ...
        Mutex mutex2 = tVar.e;
        androidx.compose.runtime.j1 j1Var = tVar.g;
        ...
        try {
            if (i2 != 0) {
                ...
                try {
                    j1Var.setValue(new r0(charSequence3, j3, textClassificationClassifyText));
                    return yVar;
                } finally {
                    mutex2.unlock(obj3);
                }
    ...
    public final LocaleList c() {
        ...
        if (bVar == null) {
            return new LocaleList(((androidx.compose.ui.text.intl.a) androidx.compose.ui.text.intl.c.a.z().e.get(0)).a);
        }
        ArrayList arrayList = new ArrayList(kotlin.collections.r.p(bVar, 10));
