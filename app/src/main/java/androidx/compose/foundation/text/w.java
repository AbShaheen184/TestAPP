        ...
        try {
            ...
            if (j0Var4 != null) {
                ...
                if (!nVar.a.a()) {
                    ...
                    r0Var2.g.setValue(new androidx.compose.ui.unit.f(wVar.e.M(iJ)));
                    return s0Var.q(iIntValue, iIntValue2, kotlin.collections.c0.k(new kotlin.k(androidx.compose.ui.layout.d.a, Integer.valueOf(Math.round(j0Var3.d))), new kotlin.k(androidx.compose.ui.layout.d.b, Integer.valueOf(Math.round(j0Var3.e)))), new androidx.compose.animation.core.n1(23));
                }
                r0Var = r0Var3;
                j0Var = j0Var5;
            } else {
            ...
            if (iJ2 != iH) {
                ...
                if (cVar2 == null) {
                    kotlinx.coroutines.future.a.u("layoutIntrinsics must be called first");
                    return null;
                }
                iH = kotlin.collections.i0.d(n0.j(cVar2.c()), iJ2, iH);
            }
            ...
            androidx.compose.ui.text.n nVar2 = new androidx.compose.ui.text.n(cVar3, _COROUTINE.a.J(0, iH, 0, androidx.compose.ui.unit.a.g(j)), i4, w0Var.f);
            ...
            r0Var2.g.setValue(new androidx.compose.ui.unit.f(wVar.e.M(iJ)));
            return s0Var.q(iIntValue3, iIntValue4, kotlin.collections.c0.k(new kotlin.k(androidx.compose.ui.layout.d.a, Integer.valueOf(Math.round(j0Var3.d))), new kotlin.k(androidx.compose.ui.layout.d.b, Integer.valueOf(Math.round(j0Var3.e)))), new androidx.compose.animation.core.n1(23));
        } catch (Throwable th) {
            androidx.compose.runtime.snapshots.r.k(fVarE, fVarH, lVarE);
            throw th;
        }
