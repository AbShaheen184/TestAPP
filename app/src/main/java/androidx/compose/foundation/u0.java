...
public final class u0 extends androidx.compose.ui.node.k implements androidx.compose.ui.node.u1, androidx.compose.ui.node.o, androidx.compose.ui.node.i, androidx.compose.ui.node.h1, androidx.compose.ui.node.z1 {
    ...
    public u0(androidx.compose.foundation.interaction.k kVar, int i, c cVar) {
        this.N = kVar;
        this.O = cVar;
        androidx.compose.ui.focus.e0 e0Var = new androidx.compose.ui.focus.e0(i, new t0(2, this, u0.class, "onFocusStateChange", "onFocusStateChange(Landroidx/compose/ui/focus/FocusState;Landroidx/compose/ui/focus/FocusState;)V", 0, 0), 10);
        M0(e0Var);
        this.S = e0Var;
    }
    ...
    public final void P0(androidx.compose.foundation.interaction.k kVar, androidx.compose.foundation.interaction.i iVar) {
        if (!this.K) {
            kVar.a.tryEmit(iVar);
            return;
        }
        Job job = (Job) A0().getCoroutineContext().get(Job.Key);
        BuildersKt__Builders_commonKt.launch$default(A0(), null, null, new androidx.compose.animation.b0(kVar, iVar, job != null ? job.invokeOnCompletion(new androidx.activity.compose.h(10, kVar, iVar)) : null, null, 3), 3, null);
    }
                        ...
                        if ((qVar.z & 262144) != 0) {
                            ...
                            while (E != 0) {
                                if (E instanceof androidx.compose.ui.node.z1) {
                                    if (v0.L.equals(((androidx.compose.ui.node.z1) E).i())) {
                                        return;
                                    }
    ...
    public final void R0(androidx.compose.foundation.interaction.k kVar) {
        ...
        if (kVar2 != null && (dVar = this.P) != null) {
            kVar2.c(new androidx.compose.foundation.interaction.e(dVar));
        }
        this.P = null;
        this.N = kVar;
    }
    ...
    public final void g0() {
        ...
        androidx.compose.ui.node.l.r(this, new androidx.activity.compose.f(4, zVar, this));
    ...
    public final void n0(androidx.compose.ui.semantics.a0 a0Var) {
        boolean zA = this.S.R0().a();
        kotlin.reflect.j[] jVarArr = androidx.compose.ui.semantics.y.a;
        androidx.compose.ui.semantics.z zVar = androidx.compose.ui.semantics.w.k;
        kotlin.reflect.j jVar = androidx.compose.ui.semantics.y.a[4];
        a0Var.b(zVar, Boolean.valueOf(zA));
        a0Var.b(androidx.compose.ui.semantics.m.w, new androidx.compose.ui.semantics.a(null, new s0(0, this, u0.class, "requestFocus", "requestFocus()Z", 0, 0)));
    }
