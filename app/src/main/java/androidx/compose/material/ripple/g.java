...
public final class g {
            ...
            if (collectionValues == null) {
                ...
                for (bb bbVar : collectionValues) {
                    ...
                    if (i2 == 0) {
                        ...
                        if (i2 != 4) {
                            kotlinx.coroutines.future.a.u("Could not serialize Flag for override: ".concat(String.valueOf(bbVar.u())));
                            throw null;
                        }
                ...
                while (true) {
                        ...
                        for (String str2 : map.keySet()) {
                            ...
                            if (length <= 19) {
                                if (length == 0) {
                                    ...
                                    if (jCharAt >= 1) {
                                        ...
                                        if (obj instanceof String) {
                                            ...
                                            if (obj instanceof Double) {
                                                ...
                                                kotlinx.coroutines.future.a.u(j.n(new StringBuilder(str2.length() + 28 + strValueOf.length()), "Cannot serialize override ", str2, ": ", strValueOf));
                                                throw th;
                                            }
                                    ...
                                    if (obj instanceof String) {
                                        ...
                                        if (obj instanceof Double) {
                                            ...
                                            kotlinx.coroutines.future.a.u(j.n(new StringBuilder(str2.length() + 28 + strValueOf2.length()), "Cannot serialize override ", str2, ": ", strValueOf2));
                                            throw th;
                                        }
                                        l0Var.b(new jb(j2, str, 3, Double.doubleToRawLongBits(((Double) obj).doubleValue()), null));
                                    }
                                ...
                                if (obj instanceof String) {
                                    ...
                                    if (obj instanceof Double) {
                                        ...
                                        kotlinx.coroutines.future.a.u(j.n(new StringBuilder(str2.length() + 28 + strValueOf3.length()), "Cannot serialize override ", str2, ": ", strValueOf3));
                                        throw th;
                                    }
                                    l0Var.b(new jb(j2, str, 3, Double.doubleToRawLongBits(((Double) obj).doubleValue()), null));
                                }
                            ...
                            if (obj instanceof String) {
                                ...
                                if (obj instanceof Double) {
                                    ...
                                    kotlinx.coroutines.future.a.u(j.n(new StringBuilder(str2.length() + 28 + strValueOf4.length()), "Cannot serialize override ", str2, ": ", strValueOf4));
                                    throw th;
                                }
                                l0Var.b(new jb(j2, str, 3, Double.doubleToRawLongBits(((Double) obj).doubleValue()), null));
                            }
                    ...
                    if (objRemove == null) {
                        ...
                        if (!(objRemove instanceof Double)) {
                            ...
                            throw new IllegalStateException(j.n(new StringBuilder(String.valueOf(string).length() + 46 + string2.length()), "Cannot serialize override for existing flag ", string, ": ", string2));
                        }
    ...
    public static androidx.media3.datasource.cache.g h(int i, DataInputStream dataInputStream) throws IOException {
        ...
        if (i < 2) {
            ...
            androidx.localbroadcastmanager.content.b bVar = new androidx.localbroadcastmanager.content.b(5);
            bVar.o(Long.valueOf(j), "exo_len");
            iVar = i.c.b(bVar);
        } else {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                if (i5 < 0) {
                    kotlinx.coroutines.future.a.w(androidx.privacysandbox.ads.adservices.java.internal.a.n(i5, "Invalid value size: "));
                    return null;
                }
                int iMin = Math.min(i5, 10485760);
                byte[] bArrCopyOf = i0.b;
                int i6 = 0;
                while (i6 != i5) {
                    int i7 = i6 + iMin;
    ...
    public boolean b() {
        androidx.localbroadcastmanager.content.b bVar = (androidx.localbroadcastmanager.content.b) this.d;
    ...
    public int g(o oVar, u uVar, boolean z) {
        ...
        androidx.compose.ui.node.q qVar = (androidx.compose.ui.node.q) this.e;
        if (this.a) {
            return 0;
        }
        try {
            ...
            for (int i4 = 0; i4 < iG2; i4++) {
                ...
                if (b != false || androidx.compose.ui.input.pointer.u.b(vVar2)) {
                    ((androidx.compose.ui.node.f0) this.b).A(vVar2.c, (androidx.compose.ui.node.q) this.e, vVar2.i, true);
                    if (!qVar.e.h()) {
                        dVar.a(vVar2.a, qVar, androidx.compose.ui.input.pointer.u.b(vVar2));
                        qVar.clear();
                    }
                }
            }
    ...
    public void j(HashMap map) {
        ...
        try {
            androidx.media3.common.util.a aVarG = bVar.G();
            l lVar = (l) this.e;
            if (lVar == null) {
                this.e = new l(aVarG);
            } else {
