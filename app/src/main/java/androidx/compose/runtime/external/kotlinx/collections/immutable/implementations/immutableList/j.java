...
public final class j extends c {
    ...
    public final c c(int i, Object obj) {
        ...
        if (objArr.length < 32) {
            ...
            o.j(0, i, 6, objArr, objArr2);
            o.f(i + 1, i, objArr.length, objArr, objArr2);
            objArr2[i] = obj;
            return new j(objArr2);
        }
        Object[] objArrCopyOf = Arrays.copyOf(objArr, objArr.length);
        o.f(i + 1, i, objArr.length - 1, objArr, objArrCopyOf);
        objArrCopyOf[i] = obj;
    ...
    public final c h(b bVar) {
        ...
        return length == 0 ? y : new j(o.l(objArrCopyOf, 0, length));
    }
    ...
    public final c i(int i) {
        ...
        Object[] objArrCopyOf = Arrays.copyOf(objArr, objArr.length - 1);
        o.f(i, i + 1, objArr.length, objArr, objArrCopyOf);
        return new j(objArrCopyOf);
    }

    @Override // kotlin.collections.f, java.util.List
    public final int indexOf(Object obj) {
        return o.w(obj, this.e);
    }
