...
public final class h extends AbstractCollection implements Collection, kotlin.jvm.internal.markers.b {
    ...
    public final void clear() {
        switch (this.e) {
            case 0:
                ...
                break;
            default:
                ((kotlin.collections.builders.f) this.y).clear();
                break;
        }
    }
    ...
    public final boolean contains(Object obj) {
        switch (this.e) {
            ...
            default:
                return ((kotlin.collections.builders.f) this.y).containsValue(obj);
        }
    }
    ...
    public boolean isEmpty() {
        switch (this.e) {
            case 1:
                return ((kotlin.collections.builders.f) this.y).isEmpty();
            default:
    ...
    public final Iterator iterator() {
        switch (this.e) {
            ...
            default:
                kotlin.collections.builders.f fVar = (kotlin.collections.builders.f) this.y;
                fVar.getClass();
                return new kotlin.collections.builders.d(fVar, 2);
        }
    }
    ...
    public boolean removeAll(Collection collection) {
        switch (this.e) {
            case 1:
                collection.getClass();
                ((kotlin.collections.builders.f) this.y).c();
                break;
        }
    ...
    public final int size() {
        switch (this.e) {
            ...
            default:
                return ((kotlin.collections.builders.f) this.y).F;
        }
    }
}
