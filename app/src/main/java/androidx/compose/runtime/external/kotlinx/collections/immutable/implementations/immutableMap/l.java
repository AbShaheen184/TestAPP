...
public final class l implements e0, y, androidx.core.view.accessibility.n {
    ...
    public static final Object b(l lVar, kotlin.b bVar, kotlin.coroutines.jvm.internal.a aVar) {
    ...
    public static l d(Resources resources, int i, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        int i2;
        int i3;
        int color;
    ...
    public void c() {
        ...
        if (i >= 10) {
            ...
            while (it.hasNext()) {
                ...
                if (arrayList.size() <= 1) {
                    coil3.memory.e eVar = (coil3.memory.e) kotlin.collections.p.D(arrayList);
                    if ((eVar != null ? (coil3.j) eVar.a.get() : null) == null) {
                        it.remove();
                    }
                } else {
    ...
    public void g(int i, okio.c cVar) {
        while (true) {
            int i2 = i >> 1;
            if (i2 == 0) {
                break;
    ...
    public void h(androidx.sqlite.db.framework.b bVar, int i, int i2) {
    ...
    public kotlinx.serialization.json.d j() {
        androidx.fragment.app.h hVar = (androidx.fragment.app.h) this.z;
        byte bH = hVar.h();
        if (hVar.I() == 4) {
            androidx.fragment.app.h.x(hVar, "Unexpected leading comma", 0, null, 6);
    ...
    public long k(androidx.media3.extractor.k kVar) {
        ...
        int i5 = i2 & (~i3);
        kVar.e(vVar.a, 1, i4, false);
        while (i < i4) {
            i++;
            i5 = (vVar.a[i] & 255) + (i5 << 8);
        }
        this.y = i4 + 1 + this.y;
        return i5;
    }
    ...
    public void o(coil3.memory.a aVar, coil3.j jVar, Map map, long j) {
        ...
        switch (this.e) {
            case 5:
                ...
                while (true) {
                    int i2 = aVar.y;
                    if (i >= i2) {
                        return "UnsupportedBrands{major=" + i0.c0(this.y) + ", compatible=" + arrayList + "}";
                    }
                    _COROUTINE.a.s(i, i2);
                    arrayList.add(i0.c0(aVar.e[i]));
                    i++;
                }
                break;
            case 12:
    ...
    public l(l0 l0Var, androidx.fragment.app.h hVar) {
        this.e = 13;
        l0Var.getClass();
        this.z = hVar;
    }
