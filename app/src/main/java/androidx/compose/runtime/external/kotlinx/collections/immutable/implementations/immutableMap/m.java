...
public final class m {
    ...
    public static m j(int i, Object obj, Object obj2, int i2, Object obj3, Object obj4, int i3, androidx.compose.runtime.external.kotlinx.collections.immutable.internal.b bVar) {
        ...
        int iS = android.support.v4.media.session.b.s(i, i3);
        int iS2 = android.support.v4.media.session.b.s(i2, i3);
        if (iS != iS2) {
            return new m((1 << iS) | (1 << iS2), 0, iS < iS2 ? new Object[]{obj, obj2, obj3, obj4} : new Object[]{obj3, obj4, obj, obj2}, bVar);
        }
        return new m(0, 1 << iS, new Object[]{j(i, obj, obj2, i2, obj3, obj4, i3 + 5, bVar)}, bVar);
    }
    ...
    public final Object[] a(int i, int i2, int i3, Object obj, Object obj2, int i4, androidx.compose.runtime.external.kotlinx.collections.immutable.internal.b bVar) {
        ...
        kotlin.collections.o.j(0, i, 6, objArr, objArr2);
        kotlin.collections.o.f(i, i + 2, i5, objArr, objArr2);
        objArr2[iT - 1] = mVarJ;
        kotlin.collections.o.f(iT, i5, objArr.length, objArr, objArr2);
        return objArr2;
    }
    ...
    public final boolean c(Object obj) {
        kotlin.ranges.b bVarL = i0.l(i0.n(0, this.d.length), 2);
        int i = bVarL.e;
        int i2 = bVarL.y;
        int i3 = bVarL.z;
    ...
    public final boolean d(int i, int i2, Object obj) {
        int iS = 1 << android.support.v4.media.session.b.s(i, i2);
        if (h(iS)) {
            return kotlin.jvm.internal.l.a(obj, this.d[f(iS)]);
        }
        if (!i(iS)) {
            return false;
        }
    ...
    public final Object g(int i, int i2, Object obj) {
        ...
        kotlin.ranges.b bVarL = i0.l(i0.n(0, mVarS.d.length), 2);
        int i3 = bVarL.e;
        int i4 = bVarL.y;
        int i5 = bVarL.z;
    ...
    public final m k(int i, androidx.compose.runtime.internal.i iVar) {
        ...
        if (this.c != iVar.e) {
            return new m(0, 0, android.support.v4.media.session.b.f(i, objArr), iVar.e);
        }
        this.d = android.support.v4.media.session.b.f(i, objArr);
        return this;
    }
    ...
    public final m l(int i, Object obj, Object obj2, int i2, androidx.compose.runtime.internal.i iVar) {
        ...
        if (zH) {
            ...
            if (!kotlin.jvm.internal.l.a(obj, this.d[iF])) {
                ...
                if (bVar != bVar2) {
                    return new m(this.a ^ iS, this.b | iS, a(iF, iS, i, obj, obj2, i2, bVar2), bVar2);
                }
                this.d = a(iF, iS, i, obj, obj2, i2, bVar2);
                this.a ^= iS;
                this.b |= iS;
                return this;
            }
        ...
        if (!i(iS)) {
            ...
            if (bVar != bVar3) {
                return new m(this.a | iS, this.b, android.support.v4.media.session.b.e(objArr2, iF2, obj, obj2), bVar3);
            }
            this.d = android.support.v4.media.session.b.e(objArr2, iF2, obj, obj2);
            this.a |= iS;
            return this;
        }
        int iT = t(iS);
            ...
            if ((i5 > 0 && i3 <= i4) || (i5 < 0 && i4 <= i3)) {
                while (true) {
                    if (!kotlin.jvm.internal.l.a(obj, mVarS.d[i3])) {
                        if (i3 == i4) {
                            iVar.e(iVar.size() + 1);
                            mVarL = new m(0, 0, android.support.v4.media.session.b.e(mVarS.d, 0, obj, obj2), iVar.e);
                            break;
                        }
                        i3 += i5;
                    } else {
    ...
    public final m m(m mVar, int i, androidx.compose.runtime.external.kotlinx.collections.immutable.internal.a aVar, androidx.compose.runtime.internal.i iVar) {
        ...
        if (i > 30) {
            ...
            int length = this.d.length;
            kotlin.ranges.b bVarL = i0.l(i0.n(0, mVar.d.length), 2);
            int i4 = bVarL.e;
            int i5 = bVarL.y;
            int i6 = bVarL.z;
    ...
    public final m n(int i, Object obj, int i2, androidx.compose.runtime.internal.i iVar) {
        ...
        if (h(iS)) {
            ...
            return q(mVarS, mVarN, iT, iS, iVar.e);
        }
        return this;
    }
    ...
    public final m o(int i, Object obj, Object obj2, int i2, androidx.compose.runtime.internal.i iVar) {
        ...
        if (h(iS)) {
            ...
            return q(mVar, mVarO, iT, iS, iVar.e);
        }
        return this;
    }
    ...
    public final m p(int i, int i2, androidx.compose.runtime.internal.i iVar) {
        ...
        if (this.c != iVar.e) {
            return new m(i2 ^ this.a, this.b, android.support.v4.media.session.b.f(i, objArr), iVar.e);
        }
        this.d = android.support.v4.media.session.b.f(i, objArr);
        this.a ^= i2;
        return this;
    ...
    public final m q(m mVar, m mVar2, int i, int i2, androidx.compose.runtime.external.kotlinx.collections.immutable.internal.b bVar) {
        ...
        if (bVar2 != bVar) {
            return new m(this.a, i2 ^ this.b, android.support.v4.media.session.b.g(i, objArr), bVar);
        }
        this.d = android.support.v4.media.session.b.g(i, objArr);
        this.b ^= i2;
        return this;
    }
    ...
    */
    ...
    public final m v(int i, int i2, Object obj) {
        ...
        if (h(iS)) {
            ...
            if (kotlin.jvm.internal.l.a(obj, this.d[iF])) {
                Object[] objArr = this.d;
                if (objArr.length != 2) {
                    return new m(this.a ^ iS, this.b, android.support.v4.media.session.b.f(iF, objArr), null);
                }
                return null;
            }
            return this;
        ...
        if (i(iS)) {
                ...
                if ((i5 > 0 && i3 <= i4) || (i5 < 0 && i4 <= i3)) {
                    while (true) {
                        if (!kotlin.jvm.internal.l.a(obj, mVarS.d[i3])) {
                            ...
                            if (objArr2.length != 2) {
                                mVarV = new m(0, 0, android.support.v4.media.session.b.f(i3, objArr2), null);
                                break;
                            }
                            mVarV = null;
                            break;
            ...
            if (mVarV == null) {
                ...
                if (objArr3.length != 1) {
                    return new m(this.a, iS ^ this.b, android.support.v4.media.session.b.g(iT, objArr3), null);
                }
                return null;
            }
            if (mVarS != mVarV) {
                return w(iT, iS, mVarV);
            }
        }
        return this;
    }
    ...
    public final m w(int i, int i2, m mVar) {
        ...
        kotlin.collections.o.f(i + 2, i + 1, objArr3.length, objArrCopyOf2, objArrCopyOf2);
        kotlin.collections.o.f(iF + 2, iF, i, objArrCopyOf2, objArrCopyOf2);
