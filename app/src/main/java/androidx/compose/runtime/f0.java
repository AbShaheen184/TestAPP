...
public final class f0 extends androidx.compose.runtime.snapshots.y {
    ...
    public final boolean c(g0 g0Var, androidx.compose.runtime.snapshots.f fVar) {
        boolean z;
        boolean z2;
        ...
        if (this.f == h || (z2 && this.g != d(g0Var, fVar))) {
            z = false;
        }
        if (!z || !z2) {
            return z;
    ...
    public final int d(g0 g0Var, androidx.compose.runtime.snapshots.f fVar) throws Throwable {
                            ...
                            if ((j & 255) < 128) {
                                ...
                                if (i14 == 1) {
                                    if (wVar instanceof g0) {
                                        try {
                                            g0 g0Var2 = (g0) wVar;
                                            yVarG = g0Var2.g((f0) androidx.compose.runtime.snapshots.n.i(g0Var2.A, fVar), fVar, false, g0Var2.y);
                                        } catch (Throwable th) {
                                            th = th;
