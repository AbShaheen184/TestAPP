...
public final class k2 {
    ...
    public final void A(h2 h2Var, int i) {
        ...
        if (i == 0 && this.t == 0 && this.a.y == 0) {
            ...
            if (i2 == i3) {
                ...
                Object[] objArr2 = h2Var.z;
                int i4 = h2Var.A;
                HashMap map2 = h2Var.G;
                androidx.collection.z zVar2 = h2Var.H;
                this.b = iArr;
                this.c = objArr2;
                this.d = h2Var.F;
                this.g = i3;
        ...
        k2 k2VarE = h2Var.e();
        try {
            t.q(k2VarE, i, this, true, true, false);
            boolean z2 = true;
        } finally {
            k2VarE.e(z);
        }
    ...
    public final void B(int i) {
        ...
        if (i6 != i) {
            if (!this.d.isEmpty()) {
                ...
                ArrayList arrayList = this.d;
                if (i6 < i) {
                    for (int iA = j2.a(arrayList, i6, iO); iA < this.d.size() && (i3 = (aVar2 = (a) this.d.get(iA)).a) < 0 && (i4 = i3 + iO) < i; iA++) {
                        aVar2.a = i4;
                    }
                } else {
                    for (int iA2 = j2.a(arrayList, i, iO); iA2 < this.d.size() && (i2 = (aVar = (a) this.d.get(iA2)).a) >= 0; iA2++) {
                        aVar.a = -(iO - i2);
                    }
                }
            }
            if (i5 > 0) {
                ...
                int i9 = i6 * 5;
                if (i < i6) {
                    kotlin.collections.o.e(i8 + i7, i7, i9, iArr, iArr);
                } else {
                    kotlin.collections.o.e(i9, i9 + i8, i7 + i8, iArr, iArr);
                }
            }
            if (i < i6) {
                i6 = i + i5;
    ...
    public final boolean I(int i, int i2) {
        ...
        if (i2 > 0) {
            ...
            if (!arrayList.isEmpty()) {
                HashMap map = this.e;
                int i3 = i + i2;
                int iA = j2.a(this.d, i3, o() - this.h);
                if (iA >= this.d.size()) {
                    iA--;
                }
                int i4 = iA + 1;
    ...
    public final Object K(int i, int i2, Object obj) {
        ...
        int i3 = iN + i2;
        if (i3 < iN || i3 >= iG) {
            u.a("Write to an invalid slot index " + i2 + " for group " + i);
        }
        int iH = h(i3);
        Object[] objArr = this.c;
    ...
    public final p0 O(int i) {
        a aVarR;
        HashMap map = this.e;
        if (map == null || (aVarR = R(i)) == null) {
            return null;
        }
        return (p0) map.get(aVarR);
    }
    ...
    public final a R(int i) {
        ArrayList arrayList;
        int iD;
        if (i < 0 || i >= p() || (iD = j2.d((arrayList = this.d), i, p())) < 0) {
            return null;
        }
    ...
    public final void U(int i, Object obj) {
        ...
        if (iR >= iArr.length || (iArr[(iR * 5) + 1] & 1073741824) == 0) {
            u.a("Updating the node of a group at " + i + " that was not created with as a node group");
        }
    ...
    public final void a(int i) {
        ...
        if (i2 < this.v || i2 > this.u) {
            u.a("Cannot seek outside the current group (" + this.v + '-' + this.u + ')');
        }
        this.t = i2;
    ...
    public final void j() {
        ...
        if (i13 != 0 || i14 != 0) {
            while (iE2 != 0 && iE2 != iB2 && (i14 != 0 || i13 != 0)) {
                ...
                if (i14 != 0) {
                    int[] iArr4 = this.b;
                    j2.c(iArr4, iR2, (iArr4[(iR2 * 5) + 1] & 67108863) + i14);
                }
                int[] iArr5 = this.b;
    ...
    public final void l(int i) {
        boolean z = false;
        if (!(this.n <= 0)) {
            u.a("Cannot call ensureStarted() while inserting");
        }
        int i2 = this.v;
        if (i2 != i) {
            if (i >= i2 && i < this.u) {
            ...
            if (!z) {
                u.a("Started group at " + i + " must be a subgroup of the group at " + i2);
            }
            int i3 = this.t;
            int i4 = this.i;
            int i5 = this.j;
    ...
    public final void n(int i, kotlin.jvm.functions.p pVar) {
        ...
        while (i6 < iU) {
            ...
            while (iF < iF2) {
                ...
                if (!(obj instanceof c2) || (i5 = ((c2) obj).b) < 0) {
                    i4 = iE;
                ...
                while (true) {
                    if (yVar == null || a0Var == null || !a0Var.e(i13)) {
                        ...
                        if (i17 != i14) {
                            ...
                            if (i14 < i17) {
                                kotlinx.coroutines.future.a.q("The end index must be < start index");
                                return;
                            } else if (i14 != i17) {
                                if (i14 < i3) {
                                    int[] iArr3 = yVar.a;
                                    kotlin.collections.o.e(i17, i14, i3, iArr3, iArr3);
                                }
                                yVar.b -= i14 - i17;
                            }
                        }
    ...
    public final boolean v(int i, int i2) {
        ...
        if (i2 == this.v) {
            ...
            if (i2 > q0Var.a(0)) {
                ...
                int[] iArr = q0Var.a;
                int iMin = Math.min(iArr.length, q0Var.b);
                int i3 = 0;
                while (true) {
                    if (i3 >= iMin) {
                        i3 = -1;
    ...
    public final void w(int i) {
        if (i > 0) {
            ...
            if (i4 < i) {
                ...
                int i6 = iMax - i5;
                kotlin.collections.o.e(0, 0, i3 * 5, iArr, iArr2);
                kotlin.collections.o.e((i3 + i6) * 5, (i4 + i3) * 5, length * 5, iArr, iArr2);
                this.b = iArr2;
                i4 = i6;
            }
            int i7 = this.u;
