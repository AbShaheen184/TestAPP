...
public final class h implements g {
    ...
    public h(Map map, kotlin.jvm.functions.l lVar) {
        o0 o0Var;
        this.e = lVar;
                        ...
                        while (i12 < i11) {
                            if ((j6 & j3) < j2) {
                                ...
                                if (list.size() == 1) {
                                    ...
                                    if (objInvoke != null) {
                                        if (!a(objInvoke)) {
                                            kotlinx.coroutines.future.a.c(l.a(objInvoke));
                                            return null;
                                        }
                                        map.put(str, q.a(objInvoke));
                                    }
                                    jArr2 = jArr4;
                                } else {
                                    int size = list.size();
                                    ...
                                    while (i3 < size) {
                                        ...
                                        if (objInvoke2 != null && !a(objInvoke2)) {
                                            kotlinx.coroutines.future.a.c(l.a(objInvoke2));
                                            return null;
                                        }
    ...
    public final f d(String str, kotlin.jvm.functions.a aVar) {
        ...
        kotlinx.coroutines.future.a.q("Registered key is empty or blank");
        return null;
    }
}
