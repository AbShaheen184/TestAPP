...
public class b extends f {
                        ...
                        for (int i4 = 0; i4 < i3; i4++) {
                            if ((255 & j) < 128) {
                                for (y yVarC = ((w) objArr[(i2 << 3) + i4]).c(); yVarC != null; yVarC = yVarC.b) {
                                    long j2 = yVarC.a;
                                    if (j2 == jG || kotlin.collections.p.x(this.j, Long.valueOf(j2))) {
                                        t3 t3Var = n.a;
                                        yVarC.a = 0L;
                                    }
                                }
    ...
    public final r z(long j, p0 p0Var, HashMap map, l lVar) {
        ...
        if (length >= 0) {
                                    ...
                                    if (yVarS2.a != 1 && !yVarS.equals(yVarS2)) {
                                        ...
                                        if (!yVarD.equals(yVarS3)) {
                                            if (yVarD.equals(yVarS)) {
                                                ...
                                                arrayListO = arrayList4 == null ? new ArrayList() : arrayList4;
                                                arrayListO.add(wVar2);
            ...
            if (arrayListO != null) {
                size = arrayListO.size();
                for (i = 0; i < size; i++) {
                    p0Var.l((w) arrayListO.get(i));
                }
                arrayList3 = this.i;
                if (arrayList3 != null) {
                    arrayListO = kotlin.collections.p.O(arrayList3, arrayListO);
                }
                this.i = arrayListO;
            }
            return i.b;
