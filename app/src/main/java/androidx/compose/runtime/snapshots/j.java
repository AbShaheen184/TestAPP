...
public final class j {
    ...
    public static String c(com.google.firebase.g gVar) {
        gVar.a();
        com.google.firebase.j jVar = gVar.c;
        String str = jVar.e;
        if (str != null) {
            return str;
        }
    ...
    public int a(long j) {
        ...
        if (i > length) {
            ...
            ?? r2 = new int[i2];
            kotlin.collections.o.h(jArr, jArr2, 0, 0, jArr.length);
            kotlin.collections.o.i(0, 0, 14, (int[]) this.d, r2);
            this.c = jArr2;
            this.d = r2;
        }
        int i3 = this.a;
        ...
        if (this.b >= length2) {
            ...
            kotlin.collections.o.i(0, 0, 14, (int[]) this.e, r3);
            this.e = r3;
        }
        int i7 = this.b;
        int[] iArr = (int[]) this.e;
