...
public final class l implements Iterable, kotlin.jvm.internal.markers.a {
    ...
    public final l c(long j) {
        ...
        if (kotlin.jvm.internal.l.c(j2, j3) >= 0 && kotlin.jvm.internal.l.c(j2, 64) < 0) {
            ...
            if (i == 0) {
                ...
                if (iC > 0) {
                    kotlin.collections.o.h(jArr, jArr3, 0, 0, iC);
                }
                if (iC < i) {
                    kotlin.collections.o.h(jArr, jArr3, iC, iC + 1, length);
                }
                jArr2 = jArr3;
            }
            ...
            if (iC2 < 0 || kotlin.jvm.internal.l.c(j6, 128) >= 0) {
                ...
                if (iC3 < 0) {
                    ...
                    if (iC4 < 0) {
                        ...
                        kotlin.collections.o.h(jArr4, jArr5, 0, 0, i);
                        kotlin.collections.o.h(jArr4, jArr5, i + 1, i, length);
                        jArr5[i] = j;
                    ...
                    while (true) {
                        ...
                        if (j8 != 0) {
                            if (dVar == null) {
                                dVar = new com.google.firebase.platforminfo.d();
                                if (jArr4 != null) {
                                    ...
                                    if (jArrCopyOf.length != 0) {
                                        ...
                                        int i3 = b0Var.b;
                                        if (i2 != i3) {
                                            kotlin.collections.o.h(jArr7, jArr7, jArrCopyOf.length + i2, i2, i3);
                                        }
                                        kotlin.collections.o.h(jArrCopyOf, jArr7, i2, 0, jArrCopyOf.length);
                            ...
                            for (int i4 = 0; i4 < 64; i4++) {
                                if (((1 << i4) & j8) != 0) {
                                    ((androidx.collection.b0) dVar.e).a(j14 + ((long) i4));
                                }
                            }
                        } else {
                            j4 = j13;
                    ...
                    if (dVar == null) {
                        ...
                        androidx.collection.b0 b0Var2 = (androidx.collection.b0) dVar.e;
                        int i5 = b0Var2.b;
                        if (i5 != 0) {
                            jArr = new long[i5];
                            long[] jArr8 = b0Var2.a;
    ...
    public final Iterator iterator() {
        return kotlin.collections.builders.c.I(new k(this, null));
    }
    ...
    public final String toString() {
        ...
        sb.append(" [");
        ArrayList arrayList = new ArrayList(kotlin.collections.r.p(this, 10));
