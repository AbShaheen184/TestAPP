...
public abstract class n {
    public static final t3 a = new t3(9);
    ...
    static {
        ...
        long j3 = e;
        e = j2 + j3;
        a aVar = new a(j3, lVar, null, new t3(8));
        d = d.f(aVar.b);
        j = aVar;
    ...
    public static final void q(w wVar) {
        if (p(wVar)) {
            ...
            if (i2 == length) {
                ...
                kotlin.collections.o.e(i12, i10, i2, (int[]) xVar.z, iArr);
                kotlin.collections.o.i(0, i10, 6, (int[]) xVar.z, iArr);
                xVar.A = oVarArr2;
                xVar.z = iArr;
            } else {
                int i13 = i10 + 1;
                ...
                kotlin.collections.o.e(i13, i10, i2, iArr2, iArr2);
            }
