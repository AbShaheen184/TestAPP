...
public final class t {
    ...
    public final g0 d = new g0(this, 15);
    public final s2 e = new s2(this, 2);
    ...
    public final void d(Object obj, kotlin.jvm.functions.l lVar, kotlin.jvm.functions.a aVar) {
        ...
        if (j2 != -1 && j2 != androidx.compose.runtime.internal.k.b()) {
            StringBuilder sbO = androidx.compose.runtime.j.o(j2, "Detected multithreaded access to SnapshotStateObserver: previousThreadId=", "), currentThread={id=");
            sbO.append(androidx.compose.runtime.internal.k.b());
            sbO.append(", name=");
            sbO.append(Thread.currentThread().getName());
            sbO.append("}. Note that observation on multiple threads in layout/draw is not supported. Make sure your measure/layout/draw for each Owner (AndroidComposeView) is executed on the same thread.");
            p1.a(sbO.toString());
        }
        try {
            this.i = sVar;
            ...
            androidx.compose.runtime.r rVar = sVar.i;
            androidx.compose.runtime.collection.b bVarI = androidx.compose.runtime.t.i();
            try {
                bVarI.b(rVar);
                if (s2Var == null) {
                    aVar.invoke();
                    ...
                    if (fVar instanceof b0) {
                        ...
                        if (((b0) fVar).t == androidx.compose.runtime.internal.k.b()) {
                            ...
                            try {
                                ((b0) fVar).r = n.k(s2Var, lVar2, true);
                                ((b0) fVar).s = lVar3;
                                aVar.invoke();
                                ((b0) fVar).r = lVar2;
                                ((b0) fVar).s = lVar3;
                    ...
                    if (fVar == null || (fVar instanceof b)) {
                        b0Var = new b0(fVar instanceof b ? (b) fVar : null, s2Var, null, true, false);
                    } else {
                        b0Var = fVar.u(s2Var);
                    }
                    try {
    ...
    public final void e() {
        ...
        n.e(n.a);
        synchronized (n.c) {
            n.h = kotlin.collections.p.N(n.h, g0Var);
        }
