...
public final class u implements ListIterator, kotlin.jvm.internal.markers.a {
    ...
    public final Object next() {
        switch (this.e) {
            case 0:
                ...
                return obj;
            case 1:
                j0 j0Var = ((androidx.compose.ui.node.q) this.B).e;
                int i2 = this.y;
                this.y = i2 + 1;
    ...
    public final void remove() {
        switch (this.e) {
            ...
            case 2:
                ...
                int i = this.z;
                if (i == -1) {
                    kotlinx.coroutines.future.a.u("Call next() or previous() before removing element from the iterator.");
                    return;
                }
                aVar.c(i);
                this.y = this.z;
    ...
    public final void set(Object obj) {
        switch (this.e) {
            case 0:
                ...
                int i = this.z;
                if (i < 0) {
                    kotlinx.coroutines.future.a.u("Cannot call set before the first call to next() or previous() or immediately after a call to add() or remove()");
                    return;
                } else {
                    qVar.set(i, obj);
                    this.A = r.g(qVar);
            ...
            case 2:
                ...
                if (i2 != -1) {
                    ...
                    kotlinx.coroutines.future.a.u("Call next() or previous() before replacing element from the iterator.");
                    return;
                }
            default:
                c();
    ...
    public u(androidx.compose.ui.node.q qVar, int i, int i2) {
        this(qVar, (i2 & 1) != 0 ? 0 : i, 0, qVar.e.b);
        this.e = 1;
    }

    public u(androidx.compose.ui.node.q qVar, int i, int i2, int i3) {
        this.e = 1;
        this.B = qVar;
        this.y = i;
        this.z = i2;
