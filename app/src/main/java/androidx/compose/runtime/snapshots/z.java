...
public final class z implements ListIterator, kotlin.jvm.internal.markers.a {
    ...
    public final int nextIndex() {
        switch (this.e) {
            ...
            default:
                return (((d0) this.z).size() - 1) - ((ListIterator) this.y).previousIndex();
        }
    }
    ...
    public final int previousIndex() {
        switch (this.e) {
            ...
            default:
                return (((d0) this.z).size() - 1) - ((ListIterator) this.y).nextIndex();
        }
    }
