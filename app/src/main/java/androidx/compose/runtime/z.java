...
public final class z implements v {
    ...
    public z(w wVar, androidx.compose.ui.node.a2 a2Var) {
        this.e = wVar;
        this.y = a2Var;
        ...
        this.C = h2Var;
        this.D = _COROUTINE.a.D();
        this.E = new androidx.collection.p0();
        this.F = new androidx.collection.p0();
        this.G = _COROUTINE.a.D();
        androidx.compose.runtime.changelist.a aVar = new androidx.compose.runtime.changelist.a();
        this.H = aVar;
        androidx.compose.runtime.changelist.a aVar2 = new androidx.compose.runtime.changelist.a();
        this.I = aVar2;
        this.J = _COROUTINE.a.D();
        this.K = _COROUTINE.a.D();
        com.app.mlounge.data.music.e eVar = new com.app.mlounge.data.music.e(wVar, 13);
        this.Q = eVar;
        this.R = new androidx.compose.runtime.internal.l();
        s sVar = new s(a2Var, wVar, h2Var, r0Var, aVar, aVar2, eVar, this);
        wVar.p(sVar);
        this.S = sVar;
    }
    ...
    public final void b(Object obj, boolean z) {
        ...
        if (!z2) {
            s1 s1Var = (s1) objG;
            if (_COROUTINE.a.Z(o0Var, obj, s1Var) || s1Var.b(obj) == s0Var) {
                return;
            }
            if (s1Var.g == null || z) {
                p0Var.a(s1Var);
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i4) {
                    if ((j & 255) < 128) {
                        s1 s1Var2 = (s1) objArr[(i2 << 3) + i5];
                        if (_COROUTINE.a.Z(o0Var, obj, s1Var2)) {
                            i = i3;
                        } else {
                            i = i3;
                            if (s1Var2.b(obj) != s0Var) {
                                if (s1Var2.g == null || z) {
                                    p0Var.a(s1Var2);
                                } else {
                                    p0Var2.a(s1Var2);
                            ...
                            while (i19 < i18) {
                                if ((j12 & j2) < j) {
                                    ...
                                    if (obj5 instanceof androidx.collection.p0) {
                                                ...
                                                if ((((~j13) << c) & j13 & j3) != j3) {
                                                    ...
                                                    for (int i23 = 0; i23 < i22; i23 = i2 + 1) {
                                                        if ((j13 & j2) < j) {
                                                            ...
                                                            int i24 = (i21 << 3) + i2;
                                                            j7 = j13;
                                                            s1 s1Var = (s1) objArr4[i24];
                                                            if (p0Var5.c(s1Var) || p0Var4.c(s1Var)) {
                                                                p0Var6.m(i24);
                                                            }
                                                        } else {
                                                            i2 = i23;
                                        ...
                                        obj5.getClass();
                                        s1 s1Var2 = (s1) obj5;
                                        zG = p0Var5.c(s1Var2) || p0Var4.c(s1Var2);
                                    }
                                    if (zG) {
                                        o0Var2.l(i20);
                                    }
    ...
    public final void e(androidx.compose.runtime.changelist.a aVar) throws Throwable {
        ...
        s sVar = this.S;
        androidx.compose.runtime.tooling.d dVarD = sVar.D();
        androidx.compose.runtime.internal.l lVar4 = this.R;
        lVar4.g(this.B, dVarD);
        try {
            if (aVar.l.U()) {
                try {
                    if (aVar2.l.U() && this.N == null) {
                        lVar4.b();
                    }
                    return;
                } finally {
            ...
            l1 l1Var = this.N;
            if (l1Var == null || (cVar = l1Var.l) == null) {
                cVar = this.y;
            }
            try {
                Trace.beginSection(cVar.equals(l1Var != null ? l1Var.l : null) ? "Compose:recordChanges" : "Compose:applyChanges");
                try {
                    l1 l1Var2 = this.N;
                    if (l1Var2 == null || (lVar = l1Var2.k) == null) {
                        lVar = lVar4;
                    }
                    k2 k2VarE = this.C.e();
                    int i3 = 0;
                    try {
                        aVar.S(cVar, k2VarE, lVar, sVar.D());
                        k2VarE.e(true);
                        cVar.n();
                        Trace.endSection();
                        lVar4.c();
    ...
    public final l1 k(boolean z, kotlin.jvm.functions.p pVar) {
        if (this.N != null) {
            p1.b("A pausable composition is in progress");
        }
        l1 l1Var = new l1(this, this.e, this.S, this.B, pVar, z, this.y, this.A);
        this.N = l1Var;
        return l1Var;
    }
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (z) {
                                k2 k2VarE = this.C.e();
                                try {
                                    k2VarE.n(k2VarE.t, new androidx.compose.foundation.contextmenu.f(12, this.R, k2VarE));
                                    k2VarE.e(true);
                                    this.y.n();
                                    lVar.c();
                                } catch (Throwable th) {
                    ...
                    if (z || !this.B.e.g()) {
                        ...
                        try {
                            ...
                            if (z) {
                                k2 k2VarE = this.C.e();
                                try {
                                    k2VarE.n(k2VarE.t, new androidx.compose.animation.core.g0(this.R, 12));
                                    k2VarE.H();
                                    k2VarE.e(true);
                                    this.y.a();
                                    this.y.n();
    ...
    public final void o() {
        ...
        if (kotlin.jvm.internal.l.a(andSet, t.b)) {
            return;
        }
        if (andSet instanceof Set) {
            c((Set) andSet, false);
    ...
    public final void p() {
        ...
        if (kotlin.jvm.internal.l.a(andSet, t.b) || andSet == null) {
            return;
        }
        if (andSet instanceof Set) {
            c((Set) andSet, false);
    ...
    public final void r(ArrayList arrayList) {
        ...
        s sVar = this.S;
        if (arrayList.size() > 0) {
            ((z0) ((kotlin.k) arrayList.get(0)).e).getClass();
            throw null;
        }
        try {
            sVar.getClass();
    ...
    public final s0 s(s1 s1Var, Object obj) {
        z zVar;
        int i = s1Var.b;
        if ((i & 2) != 0) {
            s1Var.b = i | 4;
    ...
    public final s0 u(s1 s1Var, a aVar, Object obj) {
        synchronized (this.A) {
            try {
                z zVar = this.O;
                z zVar2 = null;
                ...
                if (zVar2 == null) {
                    ...
                    if (!(sVar.F && sVar.g0(s1Var, obj))) {
                        if (obj != null) {
                            ...
                            androidx.collection.o0 o0Var = this.K;
                            if (z) {
                                Object objG = o0Var.g(s1Var);
                                if (objG != null) {
                                    if (!(objG instanceof androidx.collection.p0)) {
                                        if (objG != f.C) {
                                            _COROUTINE.a.i(this.K, s1Var, obj);
                                            break;
                                        }
                                    } else {
                                        androidx.collection.p0 p0Var = (androidx.collection.p0) objG;
                ...
                if (zVar2 != null) {
                    return zVar2.u(s1Var, aVar, obj);
                }
                this.e.l(this);
                return this.S.F ? s0.z : s0.y;
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public final void v(Object obj) {
        ...
        if (!z) {
            s1 s1Var = (s1) objG;
            if (s1Var.b(obj) == s0.A) {
                _COROUTINE.a.i(o0Var, obj, s1Var);
                return;
            }
            return;
        }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        s1 s1Var2 = (s1) objArr[(i << 3) + i3];
                        if (s1Var2.b(obj) == s0.A) {
                            _COROUTINE.a.i(o0Var, obj, s1Var2);
                        }
                    }
                    j >>= 8;
                }
    ...
    public final boolean x() {
        synchronized (this.A) {
            l1 l1Var = this.N;
            boolean zV = false;
            if (l1Var != null && (l1Var.h.get() != m1.B || l1Var.i != androidx.compose.runtime.internal.k.b())) {
                AtomicReference atomicReference = l1Var.h;
                m1 m1Var = m1.C;
                m1 m1Var2 = m1.A;
            ...
            try {
                ...
                try {
                    s sVar = this.S;
                    androidx.compose.ui.graphics.a aVar = this.M;
                    androidx.compose.runtime.changelist.l0 l0Var = sVar.e.l;
                    if (!l0Var.U()) {
                        u.a("Expected applyChanges() to have been called");
                    }
                    if (o0Var.e > 0 || !sVar.s.isEmpty()) {
                        sVar.P = aVar;
                        try {
                            sVar.n(o0Var, null);
                            sVar.P = null;
    ...
    public final void y(androidx.compose.runtime.collection.d dVar) {
        ...
        while (true) {
            ...
            if (obj2 == null || obj2.equals(t.b)) {
                obj = dVar;
            } else if (obj2 instanceof Set) {
                obj = new Set[]{obj2, dVar};
            } else {
                if (!(obj2 instanceof Object[])) {
                    androidx.media3.exoplayer.source.t0.h(this.z, "corrupt pendingModifications: ");
                    return;
                }
                Set[] setArr = (Set[]) obj2;
    ...
    public final void z(Object obj) {
        ...
        boolean z3;
        s sVar = this.S;
        if (sVar.A <= 0 && (s1VarB = sVar.B()) != null) {
            boolean z4 = true;
            int i2 = s1VarB.b | 1;
            s1VarB.b = i2;
            if ((i2 & 32) == 0) {
                androidx.collection.f0 f0Var = s1VarB.f;
                if (f0Var == null) {
            ...
            _COROUTINE.a.i(this.D, obj, s1VarB);
            if (obj instanceof g0) {
                g0 g0Var = (g0) obj;
                f0 f0VarH = g0Var.h();
                androidx.collection.o0 o0Var = this.G;
                _COROUTINE.a.a0(o0Var, obj);
                androidx.collection.f0 f0Var2 = f0VarH.e;
                ...
                Object obj2 = f0VarH.f;
                androidx.collection.o0 o0Var2 = s1VarB.g;
                if (o0Var2 == null) {
