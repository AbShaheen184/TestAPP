...
public final class b extends kotlin.jvm.internal.m implements kotlin.jvm.functions.a {
    ...
    public final Object invoke() {
        ...
        switch (this.y) {
                        ...
                        if ((qVar.z & 8) != 0) {
                            ...
                            while (E != 0) {
                                if (E instanceof u1) {
                                    u1 u1Var = (u1) E;
                                    if (u1Var.F()) {
                                        androidx.compose.ui.semantics.n nVar = new androidx.compose.ui.semantics.n();
                                        zVar.e = nVar;
                                        nVar.A = true;
                                    }
                                    if (u1Var.v0()) {
                                        ((androidx.compose.ui.semantics.n) zVar.e).z = true;
                                    }
                                    u1Var.n0((a0) zVar.e);
                                } else if ((E.z & 8) != 0 && (E instanceof androidx.compose.ui.node.k)) {
                                    q qVar2 = ((androidx.compose.ui.node.k) E).M;
                                    int i = 0;
                                    while (qVar2 != null) {
                                        if ((qVar2.z & 8) != 0) {
                                            i++;
            ...
            case 6:
                androidx.compose.ui.platform.a0 a0Var = (androidx.compose.ui.platform.a0) this.A;
                j2 j2Var = (j2) this.z;
                androidx.compose.ui.semantics.k kVar = j2Var.B;
                androidx.compose.ui.semantics.k kVar2 = j2Var.C;
                Float f = j2Var.z;
                Float f2 = j2Var.A;
                float fFloatValue = (kVar == null || f == null) ? 0.0f : ((Number) kVar.a.invoke()).floatValue() - f.floatValue();
                float fFloatValue2 = (kVar2 == null || f2 == null) ? 0.0f : ((Number) kVar2.a.invoke()).floatValue() - f2.floatValue();
                if (fFloatValue != 0.0f || fFloatValue2 != 0.0f) {
                    int iA = a0Var.A(j2Var.e);
                    t tVar = (t) a0Var.s().b(a0Var.I);
                    if (tVar != null) {
                        try {
                            androidx.core.view.accessibility.d dVar = a0Var.K;
                            if (dVar != null) {
                                dVar.a.setBoundsInScreen(a0Var.k(tVar));
                            }
                            break;
                        } catch (IllegalStateException unused) {
                        }
                    }
                    t tVar2 = (t) a0Var.s().b(a0Var.J);
                    if (tVar2 != null) {
                        try {
                            androidx.core.view.accessibility.d dVar2 = a0Var.L;
                            if (dVar2 != null) {
                                dVar2.a.setBoundsInScreen(a0Var.k(tVar2));
                            }
                            break;
                    ...
                    a0Var.A.invalidate();
                    t tVar3 = (t) a0Var.s().b(iA);
                    if (tVar3 != null && (sVar = tVar3.a) != null && (f0Var = sVar.c) != null) {
                        if (kVar != null) {
                            a0Var.N.h(iA, kVar);
                        }
                        if (kVar2 != null) {
                ...
                if (kVar != null) {
                    j2Var.z = (Float) kVar.a.invoke();
                }
                if (kVar2 != null) {
                    j2Var.A = (Float) kVar2.a.invoke();
                }
                return y.a;
            case 7:
                ...
                if (d1Var2 != null) {
                    return org.jsoup.helper.n.b(0L, coil3.network.g.F(d1Var2.z));
                }
                return null;
            default:
                ((z) this.z).e = androidx.compose.ui.node.l.h((androidx.compose.ui.viewinterop.t) this.A, b1.a);
                return y.a;
        }
    }
}
