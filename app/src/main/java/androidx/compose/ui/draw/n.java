...
final class n extends w0 {
    ...
    public final void g(q qVar) {
        ...
        oVar.Q = this.e;
        if (z2) {
            androidx.compose.ui.node.l.l(oVar);
        }
        androidx.compose.ui.node.l.k(oVar);
    }

    public final int hashCode() {
        int iC = androidx.privacysandbox.ads.adservices.java.internal.a.c(this.d, (androidx.compose.ui.layout.i.b.hashCode() + ((this.c.hashCode() + androidx.privacysandbox.ads.adservices.java.internal.a.h(this.b.hashCode() * 31, 31, true)) * 31)) * 31, 31);
        androidx.compose.ui.graphics.m mVar = this.e;
        return iC + (mVar == null ? 0 : mVar.hashCode());
    }
