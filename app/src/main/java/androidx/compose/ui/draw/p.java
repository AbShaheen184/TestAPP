...
public final class p extends w0 {
    ...
    public final int hashCode() {
        int iH = androidx.privacysandbox.ads.adservices.java.internal.a.h((this.b.hashCode() + (Float.hashCode(androidx.compose.foundation.contextmenu.h.d) * 31)) * 31, 31, this.c);
        int i = t.j;
        return Long.hashCode(this.e) + androidx.privacysandbox.ads.adservices.java.internal.a.e(iH, 31, this.d);
    }
