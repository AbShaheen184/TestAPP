...
public abstract class d {
  ...
  0x00a5: PHI (r0v11 int) = (r0v5 int), (r0v6 int), (r0v7 int), (r0v8 int) binds: [B:54:0x00a3, B:57:0x00a8, B:60:0x00ac, B:63:0x00b0] A[DONT_GENERATE, DONT_INLINE]] */
    public static final Object A(e0 e0Var, int i, kotlin.jvm.functions.l lVar) {
        ...
        androidx.compose.foundation.lazy.layout.p pVarQ0;
        a1 a1Var;
        if (!e0Var.e.K) {
                ...
                while (qVar != null) {
                    if ((qVar.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                        ...
                        while (qVarE != null) {
                            ...
                            if ((qVarE.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0 && (qVarE instanceof androidx.compose.ui.node.k)) {
                                int i4 = 0;
        ...
        e0 e0Var2 = (e0) qVarE;
        if ((e0Var2 != null && kotlin.jvm.internal.l.a(e0Var2.Q0(), e0Var.Q0())) || (pVarQ0 = e0Var.Q0()) == null) {
            return null;
        }
        int i5 = 5;
        if (i == 5) {
            ...
            if (i == 6) {
                ...
                if (i == 3) {
                    ...
                    if (i == 4) {
                        ...
                        kotlinx.coroutines.future.a.u("Unsupported direction for beyond bounds layout");
                        return null;
                    }
                }
            }
        }
        if (pVarQ0.L.a() <= 0 || !pVarQ0.L.d() || !pVarQ0.K) {
            return lVar.invoke(androidx.compose.foundation.lazy.layout.p.O);
        }
        boolean zN0 = pVarQ0.N0(i3);
        androidx.compose.foundation.lazy.layout.q qVar3 = pVarQ0.L;
        int iB = zN0 ? qVar3.b() : qVar3.e();
        kotlin.jvm.internal.z zVar = new kotlin.jvm.internal.z();
        com.google.firebase.platforminfo.d dVar = pVarQ0.M;
        dVar.getClass();
        androidx.compose.foundation.lazy.layout.k kVar = new androidx.compose.foundation.lazy.layout.k(iB, iB);
        ((androidx.compose.runtime.collection.b) dVar.e).b(kVar);
        zVar.e = kVar;
        int iC = pVarQ0.L.c() * 2;
        int iA = pVarQ0.L.a();
        if (iC > iA) {
        ...
        while (objInvoke == null && pVarQ0.M0((androidx.compose.foundation.lazy.layout.k) zVar.e, i3) && i2 < iC) {
            ...
            com.google.firebase.platforminfo.d dVar2 = pVarQ0.M;
            dVar2.getClass();
            androidx.compose.foundation.lazy.layout.k kVar3 = new androidx.compose.foundation.lazy.layout.k(i6, i7);
            ((androidx.compose.runtime.collection.b) dVar2.e).b(kVar3);
            ((androidx.compose.runtime.collection.b) pVarQ0.M.e).j((androidx.compose.foundation.lazy.layout.k) zVar.e);
            zVar.e = kVar3;
            i2++;
            androidx.compose.ui.node.l.v(pVarQ0).k();
            objInvoke = lVar.invoke(new androidx.compose.foundation.lazy.layout.o(pVarQ0, zVar, i3));
        }
        ((androidx.compose.runtime.collection.b) pVarQ0.M.e).j((androidx.compose.foundation.lazy.layout.k) zVar.e);
        androidx.compose.ui.node.l.v(pVarQ0).k();
        return objInvoke;
    ...
    public static final boolean B(int i, androidx.compose.animation.h hVar, e0 e0Var, androidx.compose.ui.geometry.c cVar) {
        ...
        if (qVar2 == null) {
            androidx.compose.ui.node.l.b(bVar2, qVar);
        } else {
            bVar2.b(qVar2);
        }
        while (true) {
            ...
            if ((qVarE.A & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) == 0) {
                androidx.compose.ui.node.l.b(bVar2, qVarE);
            } else {
                while (qVarE != null) {
                    if ((qVarE.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                        ...
                        while (qVarE != null) {
                            ...
                            qVarE = androidx.compose.ui.node.l.e(bVar3);
                        }
                        break;
                    }
                    qVarE = qVarE.C;
  ...
  0x013a: PHI (r13v13 androidx.compose.ui.q) = (r13v7 androidx.compose.ui.q), (r13v14 androidx.compose.ui.q) binds: [B:91:0x0138, B:120:0x0187] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static final boolean C(e0 e0Var, e0 e0Var2, int i, androidx.compose.animation.h hVar) {
        ...
        if (e0Var.R0() != c0.y) {
            kotlinx.coroutines.future.a.u("This function should only be used within a parent that has focus.");
            return false;
        }
        ...
        if (qVar4 == null) {
            androidx.compose.ui.node.l.b(bVar2, qVar3);
        } else {
            bVar2.b(qVar4);
        }
        int i2 = 0;
        while (true) {
            ...
            if ((qVarE2.A & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) == 0) {
                androidx.compose.ui.node.l.b(bVar2, qVarE2);
            } else {
                while (qVarE2 != null) {
                    if ((qVarE2.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                        ...
                        while (qVarE2 != null) {
                            if (qVarE2 instanceof e0) {
                                ...
                                int i5 = 0;
                                for (androidx.compose.ui.q qVar5 = ((androidx.compose.ui.node.k) qVarE2).M; qVar5 != null; qVar5 = qVar5.C) {
                            ...
                            qVarE2 = androidx.compose.ui.node.l.e(bVar3);
                        }
                        break;
                    }
                    qVarE2 = qVarE2.C;
        ...
        if (i != 1) {
            if (i != 2) {
                kotlinx.coroutines.future.a.u("This function should only be used for 1-D focus search");
                return false;
            }
            kotlin.ranges.d dVarN = i0.n(0, i2);
            int i6 = dVarN.e;
            int i7 = dVarN.y;
            if (i6 <= i7) {
                boolean z = false;
            ...
            if (i != 1) {
                ...
                qVar2 = e0Var.e.B;
                f0VarV = androidx.compose.ui.node.l.v(e0Var);
                loop5: while (f0VarV != null) {
                    if ((((androidx.compose.ui.q) f0VarV.d0.g).A & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                        while (qVar2 != null) {
                            if ((qVar2.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                                qVarE = qVar2;
        ...
        kotlin.ranges.d dVarN2 = i0.n(0, i2);
        int i8 = dVarN2.e;
        int i9 = dVarN2.y;
        if (i8 <= i9) {
            boolean z2 = false;
                    ...
                    while (qVar2 != null) {
                        if ((qVar2.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                            ...
                            while (qVarE != null) {
                                ...
                                if ((qVarE.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) == 0 && (qVarE instanceof androidx.compose.ui.node.k)) {
                                    int i10 = 0;
                                    for (androidx.compose.ui.q qVar6 = ((androidx.compose.ui.node.k) qVarE).M; qVar6 != null; qVar6 = qVar6.C) {
    ...
    public static final Boolean D(int i, androidx.compose.animation.h hVar, e0 e0Var, androidx.compose.ui.geometry.c cVar) {
        int iOrdinal = e0Var.R0().ordinal();
        if (iOrdinal != 0) {
            if (iOrdinal == 1) {
                e0 e0VarO = o(e0Var);
                if (e0VarO == null) {
                    kotlinx.coroutines.future.a.u("ActiveParent must have a focusedChild");
                    return null;
                }
                int iOrdinal2 = e0VarO.R0().ordinal();
                if (iOrdinal2 != 0) {
                    if (iOrdinal2 == 1) {
                        ...
                        if (cVar == null) {
                            if (e0VarO.R0() != c0.y) {
                                kotlinx.coroutines.future.a.u("Searching for active node in inactive hierarchy");
                                return null;
                            }
                            e0 e0VarF = f(e0VarO);
                            if (e0VarF == null) {
    ...
    public static final boolean a(e0 e0Var, androidx.compose.animation.h hVar) {
        ...
        if (iOrdinal != 0) {
            if (iOrdinal == 1) {
                ...
                if (iOrdinal2 != 0) {
                    if (iOrdinal2 == 1) {
                        if (a(e0VarO, hVar) || n(e0Var, e0VarO, 2, hVar) || (e0VarO.O0().a && ((Boolean) hVar.invoke(e0VarO)).booleanValue())) {
                            return true;
                        }
                        return false;
                    }
            ...
            if (iOrdinal != 2) {
                ...
                if (!y(e0Var, hVar)) {
                    if (!(e0Var.O0().a ? ((Boolean) hVar.invoke(e0Var)).booleanValue() : false)) {
                        return false;
                    }
                }
                return true;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0090, code lost:
        ...
        kotlinx.coroutines.future.a.u("This function should only be used for 2-D focus search");
     */
    ...
    */
    public static final boolean b(androidx.compose.ui.geometry.c r18, androidx.compose.ui.geometry.c r19, androidx.compose.ui.geometry.c r20, int r21) {
        ...
        L8f:
            return r12
        L90:
            kotlinx.coroutines.future.a.u(r4)
        L93:
            r0 = 0
            return r0
        L95:
                ...
                while (qVarE != null) {
                    if ((qVarE.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                        ...
                        while (qVarE != null) {
                            if (qVarE instanceof e0) {
                                e0 e0Var2 = (e0) qVarE;
                                if (e0Var2.K && !androidx.compose.ui.node.l.v(e0Var2).o0) {
                                    if (e0Var2.O0().a) {
                                        bVar.b(e0Var2);
                                    } else {
                                        e(e0Var2, bVar);
    ...
    public static final e0 f(e0 e0Var) {
        e0 e0VarF = ((p) ((androidx.compose.ui.platform.u) androidx.compose.ui.node.l.w(e0Var)).getFocusOwner()).f();
    ...
    public static final boolean l(e0 e0Var, androidx.compose.animation.h hVar) {
        ...
        if (iOrdinal != 0) {
            ...
            if (iOrdinal != 2) {
                if (iOrdinal == 3) {
                    return e0Var.O0().a ? ((Boolean) hVar.invoke(e0Var)).booleanValue() : z(e0Var, hVar);
                }
                coil3.g.a();
                return false;
            }
    ...
    public static final boolean m(int i, androidx.compose.animation.h hVar, e0 e0Var, androidx.compose.ui.geometry.c cVar) {
        ...
        Boolean bool = (Boolean) A(e0Var, i, new g0(((p) ((androidx.compose.ui.platform.u) androidx.compose.ui.node.l.w(e0Var)).getFocusOwner()).f(), e0Var, cVar, i, hVar, 1));
        if (bool != null) {
    ...
    public static final boolean n(e0 e0Var, e0 e0Var2, int i, androidx.compose.animation.h hVar) {
        ...
        Boolean bool = (Boolean) A(e0Var, i, new g0(((p) ((androidx.compose.ui.platform.u) androidx.compose.ui.node.l.w(e0Var)).getFocusOwner()).f(), e0Var, e0Var2, i, hVar, 0));
        if (bool != null) {
            return bool.booleanValue();
        }
        return false;
    ...
    public static final e0 o(e0 e0Var) {
        ...
        if (z) {
            ...
            while (true) {
                ...
                if ((qVarE.A & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) == 0) {
                    androidx.compose.ui.node.l.b(bVar, qVarE);
                } else {
                    while (qVarE != null) {
                        if ((qVarE.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                            ...
                            while (qVarE != null) {
                                if (qVarE instanceof e0) {
                                    e0 e0Var2 = (e0) qVarE;
                                    if (e0Var2.e.K) {
                                        int iOrdinal = e0Var2.R0().ordinal();
    ...
    public static final b u(e0 e0Var, int i) {
        ...
        if (iOrdinal != 0) {
            ...
            if (iOrdinal == 1) {
                e0 e0VarO = o(e0Var);
                if (e0VarO == null) {
                    kotlinx.coroutines.future.a.q("ActiveParent with no focused child");
                    return null;
                }
                b bVarU = u(e0VarO, i);
                ...
                try {
                    u uVarO0 = e0Var.O0();
                    a aVar = new a(i);
                    p pVar = (p) ((androidx.compose.ui.platform.u) androidx.compose.ui.node.l.w(e0Var)).getFocusOwner();
                    e0 e0VarF = pVar.f();
                    uVarO0.k.invoke(aVar);
                    e0 e0VarF2 = pVar.f();
                    if (aVar.b) {
                        y yVar = y.b;
                        return bVar2;
    ...
    public static final b w(e0 e0Var, int i) {
        ...
        if (iOrdinal != 0) {
            ...
            if (iOrdinal != 2) {
                ...
                int iOrdinal2 = e0Var2.R0().ordinal();
                if (iOrdinal2 == 0) {
                    return v(e0Var2, i);
                }
                if (iOrdinal2 == 1) {
  ...
  0x0216: PHI (r12v3 int) = (r12v2 int), (r12v4 int) binds: [B:152:0x0214, B:160:0x0228] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static final boolean x(e0 e0Var) {
        ...
        c0 c0VarR0 = e0Var.R0();
        if (e0VarF == e0Var) {
            e0Var.N0(c0VarR0, c0VarR0);
            return true;
        }
        int i2 = 0;
        if ((e0VarF == null || e0VarF.L) && !e0Var.L && !((p) ((androidx.compose.ui.platform.u) androidx.compose.ui.node.l.w(e0Var)).getFocusOwner()).a.G()) {
            return false;
        }
        char c2 = 16;
        if (e0VarF != null) {
            ...
            while (f0VarV != null) {
                ...
                f0VarV = f0VarV.v();
                qVar = (f0VarV == null || (a1Var2 = f0VarV.d0) == null) ? null : (w1) a1Var2.f;
            }
        } else {
            bVar = null;
        }
        ...
        androidx.compose.ui.node.f0 f0VarV2 = androidx.compose.ui.node.l.v(e0Var);
        int i4 = 1;
        int i5 = 0;
        while (f0VarV2 != null) {
            if ((((androidx.compose.ui.q) f0VarV2.d0.g).A & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                while (qVar3 != null) {
                    if ((qVar3.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                        ...
                        while (qVarE2 != null) {
                            if (qVarE2 instanceof e0) {
                                ...
                                if ((qVarE2.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0 && (qVarE2 instanceof androidx.compose.ui.node.k)) {
                                    int i7 = i2;
            ...
            char c3 = c2;
            f0VarV2 = f0VarV2.v();
            qVar3 = (f0VarV2 == null || (a1Var = f0VarV2.d0) == null) ? null : (w1) a1Var.f;
            c2 = c3;
            i2 = 0;
        }
        if (i4 == 0 || e0VarF == null || d(e0VarF, false)) {
            androidx.compose.ui.node.l.r(e0Var, new androidx.compose.animation.z(e0Var, 1));
            int iOrdinal = e0Var.R0().ordinal();
            if (iOrdinal != 0) {
                if (iOrdinal == 1) {
                    ((p) ((androidx.compose.ui.platform.u) androidx.compose.ui.node.l.w(e0Var)).getFocusOwner()).i(e0Var);
                } else if (iOrdinal != 2) {
                    if (iOrdinal != 3) {
                        coil3.g.a();
                        return false;
                    ...
                    if (i < objArr.length) {
                        while (i >= 0) {
                            ...
                            if (pVar.f() == e0Var) {
                                ...
                                e0Var2.N0(c0Var, c0Var4);
                                i--;
                            }
                        }
                        if (pVar.f() == e0Var) {
                            e0Var.N0(c0VarR0, c0Var3);
                            if (pVar.f() != e0Var) {
                                return true;
                            }
                        }
