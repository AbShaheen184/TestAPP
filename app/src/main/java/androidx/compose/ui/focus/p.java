...
public final class p implements l {
  ...
  0x0105: PHI (r1v15 androidx.compose.ui.q) = (r1v9 androidx.compose.ui.q), (r1v16 androidx.compose.ui.q) binds: [B:86:0x0103, B:115:0x0151] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final boolean d(KeyEvent keyEvent, kotlin.jvm.functions.a aVar) {
        ...
        androidx.compose.ui.node.j jVar3;
        androidx.compose.ui.node.j jVar4;
        a1 a1Var2;
        ...
        try {
            ...
            if (e0VarF != null) {
                ...
                if (qVar2 == null) {
                    if (e0VarF == null) {
                        ...
                        loop15: while (true) {
                            ...
                            if ((((androidx.compose.ui.q) f0VarV.d0.g).A & 8192) != 0) {
                                while (qVar != null) {
                                    if ((qVar.z & 8192) != 0) {
                                        qVarE = qVar;
                                        bVar = null;
                        ...
                        jVar2 = (androidx.compose.ui.input.key.e) jVar;
                        if (jVar2 != null) {
                            qVar2 = ((androidx.compose.ui.q) jVar2).e;
                        } else {
                            qVar2 = null;
                        }
                    } else {
                        ...
                        qVar3 = e0VarF.e;
                        f0VarV2 = androidx.compose.ui.node.l.v(e0VarF);
                        loop11: while (true) {
                            if (f0VarV2 != null) {
                                jVar3 = null;
                                break;
                            }
                            if ((((androidx.compose.ui.q) f0VarV2.d0.g).A & 8192) != 0) {
                                while (qVar3 != null) {
                                    if ((qVar3.z & 8192) != 0) {
                                        bVar2 = null;
                                        qVarE2 = qVar3;
                        ...
                        jVar4 = (androidx.compose.ui.input.key.e) jVar3;
                        if (jVar4 != null) {
                            qVar2 = ((androidx.compose.ui.q) jVar4).e;
                        } else {
                            if (!e0Var.e.K) {
                                androidx.compose.ui.internal.a.b("visitAncestors called on an unattached node");
                            }
                        ...
                        while (qVar != null) {
                            if ((qVar.z & 8192) != 0) {
                                ...
                                while (qVarE != null) {
                                    ...
                                    if ((qVarE.z & 8192) == 0 && (qVarE instanceof androidx.compose.ui.node.k)) {
                                        androidx.compose.ui.q qVar6 = ((androidx.compose.ui.node.k) qVarE).M;
                                        int i2 = 0;
                                        while (qVar6 != null) {
                                            if ((qVar6.z & 8192) != 0) {
                                                i2++;
                ...
                loop11: while (true) {
                        ...
                        while (qVar3 != null) {
                            if ((qVar3.z & 8192) != 0) {
                                ...
                                while (qVarE2 != null) {
                                    ...
                                    if ((qVarE2.z & 8192) == 0 && (qVarE2 instanceof androidx.compose.ui.node.k)) {
                                        androidx.compose.ui.q qVar7 = ((androidx.compose.ui.node.k) qVarE2).M;
                                        int i3 = 0;
                                        while (qVar7 != null) {
                                            if ((qVar7.z & 8192) != 0) {
                                                i3++;
                    ...
                    f0VarV2 = f0VarV2.v();
                    qVar3 = (f0VarV2 != null || (a1Var2 = f0VarV2.d0) == null) ? null : (w1) a1Var2.f;
                }
                jVar4 = (androidx.compose.ui.input.key.e) jVar3;
                if (jVar4 != null) {
                    qVar2 = ((androidx.compose.ui.q) jVar4).e;
            ...
            if (qVar2 != null) {
                ...
                androidx.compose.ui.node.f0 f0VarV3 = androidx.compose.ui.node.l.v(qVar2);
                ArrayList arrayList = null;
                while (f0VarV3 != null) {
                    if ((((androidx.compose.ui.q) f0VarV3.d0.g).A & 8192) != 0) {
                        while (qVar8 != null) {
                            if ((qVar8.z & 8192) != 0) {
                                ...
                                while (qVarE3 != null) {
                                    ...
                                    } else if ((qVarE3.z & 8192) != 0 && (qVarE3 instanceof androidx.compose.ui.node.k)) {
                                        int i4 = 0;
                                        for (androidx.compose.ui.q qVar9 = ((androidx.compose.ui.node.k) qVarE3).M; qVar9 != null; qVar9 = qVar9.C) {
                                            if ((qVar9.z & 8192) != 0) {
                                                i4++;
                                                if (i4 == 1) {
                                                    qVarE3 = qVar9;
                                    ...
                                    qVarE3 = androidx.compose.ui.node.l.e(bVar3);
                                }
                            }
                            qVar8 = qVar8.B;
                        }
                    ...
                    f0VarV3 = f0VarV3.v();
                    qVar8 = (f0VarV3 == null || (a1Var3 = f0VarV3.d0) == null) ? null : (w1) a1Var3.f;
                }
                ...
                while (E != 0) {
                    ...
                    } else if ((E.z & 8192) != 0 && (E instanceof androidx.compose.ui.node.k)) {
                        androidx.compose.ui.q qVar10 = ((androidx.compose.ui.node.k) E).M;
                        int i6 = 0;
                        while (qVar10 != null) {
                            if ((qVar10.z & 8192) != 0) {
                                i6++;
                    ...
                    E = androidx.compose.ui.node.l.e(bVar4);
                }
                ...
                while (E2 != 0) {
                    ...
                    } else if ((E2.z & 8192) != 0 && (E2 instanceof androidx.compose.ui.node.k)) {
                        androidx.compose.ui.q qVar11 = ((androidx.compose.ui.node.k) E2).M;
                        int i7 = 0;
                        while (qVar11 != null) {
                            if ((qVar11.z & 8192) != 0) {
                                i7++;
                    ...
                    E2 = androidx.compose.ui.node.l.e(bVar5);
                }
                if (arrayList != null) {
    ...
    public final Boolean e(int i, androidx.compose.ui.geometry.c cVar, kotlin.jvm.functions.l lVar) {
        ...
        if (e0VarF != null) {
            ...
            if (i == 1) {
                ...
                if (i != 7 && i != 8) {
                    kotlinx.coroutines.future.a.u("invalid FocusDirection");
                    return null;
                }
                a aVar = new a(i);
                p pVar = (p) ((androidx.compose.ui.platform.u) androidx.compose.ui.node.l.w(e0VarF)).getFocusOwner();
                e0 e0VarF2 = pVar.f();
                if (i == 7) {
                    ...
                    if (!kotlin.jvm.internal.l.a(yVar, yVar4)) {
                        ...
                        if (i3 == 0) {
                            ...
                            for (int i4 = 0; i4 < i3; i4++) {
                                ...
                                if (qVar3 == null) {
                                    androidx.compose.ui.node.l.b(bVar2, qVar2);
                                } else {
                                    bVar2.b(qVar3);
                                }
                                while (true) {
                                            ...
                                            if ((qVarE.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                                                ...
                                                while (qVarE != null) {
                                                    if (qVarE instanceof e0) {
                                                        ...
                                                        int i6 = 0;
                                                        for (androidx.compose.ui.q qVar4 = ((androidx.compose.ui.node.k) qVarE).M; qVar4 != null; qVar4 = qVar4.C) {
        ...
        if (i != 8) {
            t0.h(f.a(i), "Focus search invoked with invalid FocusDirection ");
            return null;
        }
        ...
        androidx.compose.ui.node.f0 f0VarV = androidx.compose.ui.node.l.v(e0VarF5);
        loop5: while (true) {
            if (f0VarV == null) {
                e0Var = null;
                break;
                    ...
                    if ((qVar5.z & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
                        ...
                        while (qVarE2 != null) {
                            if (qVarE2 instanceof e0) {
                                ...
                                int i7 = 0;
                                for (androidx.compose.ui.q qVar6 = ((androidx.compose.ui.node.k) qVarE2).M; qVar6 != null; qVar6 = qVar6.C) {
            ...
            f0VarV = f0VarV.v();
            qVar5 = (f0VarV == null || (a1Var = f0VarV.d0) == null) ? null : (w1) a1Var.f;
        }
    ...
    public final boolean g(int i, boolean z) {
        e0 e0VarF = f();
        androidx.compose.ui.platform.u uVar = this.a;
        if (e0VarF == null || !e0VarF.L || !uVar.w(i)) {
                ...
                if (d0Var4.e != 0 || ((d0Var4.a[iB >> 3] >> ((iB & 7) << 3)) & 255) == 254) {
                    ...
                    if (i25 > i4) {
                        ...
                        if (Long.compare((((long) d0Var4.d) * 32) ^ Long.MIN_VALUE, (((long) i25) * 25) ^ Long.MIN_VALUE) <= 0) {
                            ...
                            i = i17;
                            j = j13;
                            int iU = kotlin.collections.o.u(jArr5);
                            int i30 = iU - 1;
