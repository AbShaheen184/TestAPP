...
public final class l extends c {
    ...
    public final long f(float f2, float f3, float f4, float f5, c cVar) {
        ...
        float fX = com.google.firebase.b.x(f6);
        float fX2 = com.google.firebase.b.x(f7);
        float fX3 = com.google.firebase.b.x(f8);
        float[] fArr2 = e;
        return a0.b((fArr2[6] * fX3) + (fArr2[3] * fX2) + (fArr2[0] * fX), (fArr2[7] * fX3) + (fArr2[4] * fX2) + (fArr2[1] * fX), (fArr2[8] * fX3) + (fArr2[5] * fX2) + (fArr2[2] * fX), f5, cVar);
    }
}
