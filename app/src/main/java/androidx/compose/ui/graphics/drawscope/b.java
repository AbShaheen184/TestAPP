...
public final class b implements d {
    ...
    public static n b(b bVar, long j, e eVar, float f, int i) {
        n nVarG = bVar.g(eVar);
    ...
    public final void A(long j, float f, long j2, e eVar) {
        this.e.c.n(f, j2, b(this, j, eVar, 1.0f, 3));
    }
    ...
    @Override // androidx.compose.ui.graphics.drawscope.d
    public final void e0(j jVar, long j, e eVar) {
        this.e.c.e(jVar, b(this, j, eVar, 1.0f, 3));
    }
    ...
    public final void r(long j, long j2, long j3, long j4, e eVar) {
        ...
        this.e.c.l(Float.intBitsToFloat(i), Float.intBitsToFloat(i2), Float.intBitsToFloat((int) (j3 >> 32)) + Float.intBitsToFloat(i), Float.intBitsToFloat((int) (j3 & 4294967295L)) + Float.intBitsToFloat(i2), Float.intBitsToFloat((int) (j4 >> 32)), Float.intBitsToFloat((int) (j4 & 4294967295L)), b(this, j, eVar, 1.0f, 3));
    }

    @Override // androidx.compose.ui.graphics.drawscope.d
    public final void s0(long j, float f, float f2, long j2, long j3, e eVar) {
        int i = (int) (j2 >> 32);
        int i2 = (int) (j2 & 4294967295L);
        this.e.c.s(Float.intBitsToFloat(i), Float.intBitsToFloat(i2), Float.intBitsToFloat((int) (j3 >> 32)) + Float.intBitsToFloat(i), Float.intBitsToFloat((int) (j3 & 4294967295L)) + Float.intBitsToFloat(i2), f, f2, b(this, j, eVar, 1.0f, 3));
    }
    ...
    public final void u0(long j, long j2, long j3, float f, int i) {
        ...
        this.e.c.m(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat((int) (j3 >> 32)) + Float.intBitsToFloat(i2), Float.intBitsToFloat((int) (4294967295L & j3)) + Float.intBitsToFloat(i3), b(this, j, g.a, f, i));
    }
    ...
    @Override // androidx.compose.ui.graphics.drawscope.d
    public final void z0(p pVar, long j, long j2, long j3, float f, e eVar) {
        int i = (int) (j >> 32);
