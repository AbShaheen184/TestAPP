...
public final class e0 extends l0 {
    ...
    public final Shader b(long j) {
        ...
        if (list2 == null) {
            if (list.size() < 2) {
                kotlinx.coroutines.future.a.q("colors must have length of at least 2 if colorStops is omitted.");
                return null;
            }
        } else if (list.size() != list2.size()) {
            kotlinx.coroutines.future.a.q("colors and colorStops arguments must have equal length.");
            return null;
        }
    ...
    public final int hashCode() {
        ...
        List list = this.d;
        return Integer.hashCode(0) + androidx.privacysandbox.ads.adservices.java.internal.a.e(androidx.privacysandbox.ads.adservices.java.internal.a.e((iHashCode + (list != null ? list.hashCode() : 0)) * 31, 31, this.e), 31, this.f);
    }
