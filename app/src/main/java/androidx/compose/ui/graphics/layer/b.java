...
public final class b {
        ...
        if (this.g) {
            ...
            if (z || dVar.J() > 0.0f) {
                ...
                if (jVar != null) {
                    ...
                    long jF = coil3.network.g.F(this.u);
                    long j = this.h;
                    long j2 = this.i;
    ...
    public final a0 d() {
        ...
        float f = this.j;
        if (f > 0.0f) {
            h0Var = new i0(_COROUTINE.a.c(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4, (((long) Float.floatToRawIntBits(f)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(f)))));
        } else {
