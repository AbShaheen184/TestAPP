...
public final class h implements d {
    ...
    public final void G(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.v = j;
            androidx.arch.core.executor.d.A(this.d, a0.y(j));
        }
    }
    ...
    public final void M(r rVar) {
        ...
        if (((androidx.compose.ui.graphics.c) rVar).a.isHardwareAccelerated()) {
            this.b.a(rVar, lVar, lVar.getDrawingTime());
        }
    }
     ...
     */
    @Override // androidx.compose.ui.graphics.layer.d
    public final void e(androidx.compose.ui.unit.c cVar, m mVar, b bVar, androidx.compose.animation.e eVar) {
        l lVar = this.d;
    ...
    public final void o(long j) {
        ...
        if (j2 != 9205357640488583168L) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                androidx.arch.core.executor.d.s(lVar);
                return;
            }
            this.q = true;
    ...
    public final void w(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.u = j;
            androidx.arch.core.executor.d.z(this.d, a0.y(j));
        }
    }
