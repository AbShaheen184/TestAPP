...
public abstract class b {
    ...
    public final void g(h0 h0Var, long j, float f, androidx.compose.ui.graphics.m mVar) {
        ...
        ((d) bVar.y.y).k(0.0f, 0.0f, fIntBitsToFloat, fIntBitsToFloat2);
        if (f > 0.0f) {
            try {
                if (Float.intBitsToFloat(i) > 0.0f && Float.intBitsToFloat(i2) > 0.0f) {
                    if (this.y) {
                        float fIntBitsToFloat3 = Float.intBitsToFloat(i);
                        c cVarB = org.jsoup.helper.n.b(0L, (((long) Float.floatToRawIntBits(Float.intBitsToFloat(i2))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat3) << 32));
                        r rVarV = bVar.y.v();
                        n nVarG3 = this.e;
                        if (nVarG3 == null) {
                            nVarG3 = a0.g();
