...
public abstract class b {
    ...
    public static final j0 d(f fVar, androidx.compose.runtime.s sVar) {
        androidx.compose.ui.unit.c cVar = (androidx.compose.ui.unit.c) sVar.j(l1.h);
        boolean zE = sVar.e((((long) Float.floatToRawIntBits(cVar.a())) & 4294967295L) | (((long) Float.floatToRawIntBits(fVar.j)) << 32));
        Object objQ = sVar.Q();
        if (zE || objQ == androidx.compose.runtime.n.a) {
            c cVar2 = new c();
            a(cVar2, fVar.f);
            long jFloatToRawIntBits = (((long) Float.floatToRawIntBits(cVar.W(fVar.b))) << 32) | (((long) Float.floatToRawIntBits(cVar.W(fVar.c))) & 4294967295L);
