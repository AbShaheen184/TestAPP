...
public final class f0 extends d0 {
    ...
    public f0(c cVar) {
        ...
        this.e = new a();
        this.f = h.A;
        this.g = androidx.compose.runtime.t.r(null);
        this.i = androidx.compose.runtime.t.r(new androidx.compose.ui.geometry.e(0L));
    ...
    public final void e(androidx.compose.ui.graphics.drawscope.d dVar, float f, androidx.compose.ui.graphics.m mVar) {
        ...
        if (!z || cVar.e == 16) {
            ...
            androidx.compose.ui.graphics.m mVar4 = (androidx.compose.ui.graphics.m) j1Var.getValue();
            int i4 = h0.a;
        ...
        if (z2 || !androidx.compose.ui.geometry.e.a(this.j, dVar.d())) {
            ...
            j1 j1Var2 = this.i;
            this.k = fIntBitsToFloat / Float.intBitsToFloat((int) (((androidx.compose.ui.geometry.e) j1Var2.getValue()).a >> 32));
            this.l = Float.intBitsToFloat((int) (dVar.d() & 4294967295L)) / Float.intBitsToFloat((int) (((androidx.compose.ui.geometry.e) j1Var2.getValue()).a & 4294967295L));
            ...
            if (gVarF != null || cVarA == null) {
                ...
                long jF = coil3.network.g.F(jCeil);
                ...
                aVar2.d = jF;
                cVar3.f();
                androidx.compose.ui.graphics.drawscope.d.G(bVar, androidx.compose.ui.graphics.t.b, 0L, 0L, 0.0f, 62);
                this.m.invoke(bVar);
                cVar3.q();
            ...
            long jF2 = coil3.network.g.F(jCeil);
            ...
            aVar4.d = jF2;
            cVar5.f();
            androidx.compose.ui.graphics.drawscope.d.G(bVar2, androidx.compose.ui.graphics.t.b, 0L, 0L, 0.0f, 62);
            this.m.invoke(bVar2);
            cVar5.q();
            ...
            if (i != iD) {
                ...
                j1 j1Var3 = this.i;
                this.k = fIntBitsToFloat2 / Float.intBitsToFloat((int) (((androidx.compose.ui.geometry.e) j1Var3.getValue()).a >> 32));
                this.l = Float.intBitsToFloat((int) (dVar.d() & 4294967295L)) / Float.intBitsToFloat((int) (((androidx.compose.ui.geometry.e) j1Var3.getValue()).a & 4294967295L));
                ...
                long jF3 = coil3.network.g.F(jCeil2);
                ...
                aVar6.d = jF3;
                cVar7.f();
                androidx.compose.ui.graphics.drawscope.d.G(bVar3, androidx.compose.ui.graphics.t.b, 0L, 0L, 0.0f, 62);
                this.m.invoke(bVar3);
                cVar7.q();
        ...
        if (mVar3 == null) {
            mVar3 = ((androidx.compose.ui.graphics.m) j1Var.getValue()) != null ? (androidx.compose.ui.graphics.m) j1Var.getValue() : this.h;
        }
    ...
    public final String toString() {
        ...
        sb.append("\n\tviewportWidth: ");
        j1 j1Var = this.i;
        sb.append(Float.intBitsToFloat((int) (((androidx.compose.ui.geometry.e) j1Var.getValue()).a >> 32)));
        sb.append("\n\tviewportHeight: ");
        sb.append(Float.intBitsToFloat((int) (((androidx.compose.ui.geometry.e) j1Var.getValue()).a & 4294967295L)));
        sb.append("\n");
        return sb.toString();
    }
}
