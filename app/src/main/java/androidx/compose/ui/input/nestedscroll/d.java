...
public final class d {
        ...
        if (i3 == 0) {
                            ...
                            if ((qVar.z & i4) != 0) {
                                ...
                                while (r13 != 0) {
                                    if (r13 instanceof z1) {
                                        z1Var2 = (z1) r13;
                                        i = i4;
                                        if (kotlin.jvm.internal.l.a(iVar3.i(), z1Var2.i()) && i.class == z1Var2.getClass()) {
                                            break loop0;
                                        }
                                    } else {
                                        i = i4;
                                        if ((r13.z & i) != 0 && (r13 instanceof k)) {
                                            q qVar2 = ((k) r13).M;
                                            int i5 = 0;
                                            while (qVar2 != null) {
                                                if ((qVar2.z & i) != 0) {
            ...
            if (iVar == null) {
                ...
                if (iVar5 == null || !iVar5.K) {
                    ...
                    q qVar3 = iVar5.e.B;
                    f0 f0VarV2 = l.v(iVar5);
                    loop3: while (true) {
                        if (f0VarV2 == null) {
                            z1Var = null;
                            break;
                        }
                        if ((((q) f0VarV2.d0.g).A & i) != 0) {
                            while (qVar3 != null) {
                                if ((qVar3.z & i) != 0) {
                                    ?? E2 = qVar3;
                                    ?? bVar4 = 0;
                                    while (E2 != 0) {
                                        if (E2 instanceof z1) {
                                            z1 z1Var3 = (z1) E2;
                                            if (kotlin.jvm.internal.l.a(iVar5.i(), z1Var3.i()) && i.class == z1Var3.getClass()) {
                                                z1Var = z1Var3;
                                                break loop3;
                                            }
                                        } else if ((E2.z & i) != 0 && (E2 instanceof k)) {
                                            q qVar4 = ((k) E2).M;
                                            int i7 = 0;
                                            while (qVar4 != null) {
                                                if ((qVar4.z & i) != 0) {
    ...
    public final Object b(long j, kotlin.coroutines.jvm.internal.c cVar) {
                        ...
                        while (qVar != null) {
                            if ((qVar.z & 262144) != 0) {
                                ...
                                while (E != 0) {
                                    if (E instanceof z1) {
                                        z1 z1Var2 = (z1) E;
                                        if (kotlin.jvm.internal.l.a(iVar.i(), z1Var2.i()) && i.class == z1Var2.getClass()) {
                                            z1Var = z1Var2;
                                            break loop0;
                                        }
        ...
        kotlin.a.e(objD0);
        j2 = ((androidx.compose.ui.unit.q) objD0).a;
        return new androidx.compose.ui.unit.q(j2);
    }
