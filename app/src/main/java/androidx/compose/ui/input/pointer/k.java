...
public final class k extends l {
    ...
    public final boolean a(androidx.collection.s sVar, androidx.compose.ui.layout.x xVar, q0 q0Var, boolean z) {
        ...
        if (E.K) {
            ...
            while (E != 0) {
                if (E instanceof r1) {
                    this.f = androidx.compose.ui.node.l.t((r1) E, 16);
                } else if ((E.z & 16) != 0 && (E instanceof androidx.compose.ui.node.k)) {
                    androidx.compose.ui.q qVar = ((androidx.compose.ui.node.k) E).M;
                    int i3 = 0;
                    while (qVar != null) {
                        if ((qVar.z & 16) != 0) {
                            i3++;
                ...
                while (true) {
                    ...
                    if (cVar.c(jD)) {
                        ...
                        if ((((j & 9223372034707292159L) + 36028792732385279L) & (-9223372034707292160L)) == 0 && (((j2 & 9223372034707292159L) + 36028792732385279L) & (-9223372034707292160L)) == 0) {
                            ...
                            ArrayList arrayList2 = new ArrayList((arrayList == null ? wVar : arrayList).size());
                            List list = arrayList == null ? wVar : arrayList;
                            int size = list.size();
                            int i5 = 0;
                            while (i5 < size) {
                                List list2 = list;
    ...
    public final boolean e(q0 q0Var, boolean z) {
        ...
        while (E2 != 0) {
            if (E2 instanceof r1) {
                ((r1) E2).D(mVar, n.e, j);
            } else if ((E2.z & 16) != 0 && (E2 instanceof androidx.compose.ui.node.k)) {
                androidx.compose.ui.q qVar = ((androidx.compose.ui.node.k) E2).M;
                int i = 0;
                while (qVar != null) {
                    if ((qVar.z & 16) != 0) {
                        i++;
        ...
        if (E.K) {
            ...
            while (E != 0) {
                ...
                E = androidx.compose.ui.node.l.e(bVar3);
            }
        }
        return true;
    }
