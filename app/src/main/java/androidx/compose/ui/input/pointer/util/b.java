...
public final class b {
    ...
    public static String g(com.android.volley.toolbox.b bVar) throws IOException {
        ...
        StringBuilder sbO = j.o(jF, "streamToBytes length=", ", maxLength=");
        sbO.append(j);
    ...
    public void h(coil3.memory.a aVar, coil3.j jVar, Map map, long j) {
        r0 r0Var = (r0) this.c;
        long j2 = r0Var.e;
        ...
        if (j > j2) {
            ...
            ((l) this.b).o(aVar, jVar, map, j);
            return;
        }
        coil3.memory.d dVar = new coil3.memory.d(jVar, map, j);
        Object objPut = linkedHashMap.put(aVar, dVar);
        r0Var.y = r0Var.d(aVar, dVar) + r0Var.c();
        if (objPut != null) {
            r0Var.y = r0Var.c() - r0Var.d(aVar, objPut);
            r0Var.a(aVar, objPut, dVar);
        }
        r0Var.e(r0Var.e);
    }
    ...
    public List i() {
        ...
        try {
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    do {
                        ...
                        try {
                            ...
                            s8Var.b();
                            ((t8) s8Var.y).u(j3);
                            arrayList.add(new k(j, j2, z, (t8) s8Var.d()));
                        } catch (IOException e) {
                            u0 u0Var = ((p1) mVar.e).C;
                            p1.m(u0Var);
                            u0Var.C.c(u0.D(str), e, "Data loss. Failed to merge raw event. appId");
                        }
                ...
                u0 u0Var2 = ((p1) mVar.e).C;
                p1.m(u0Var2);
                u0Var2.C.c(u0.D(str), e2, "Data loss. Error querying raw events batch. appId");
                list = arrayList;
            }
            list = list2;
            return list;
    ...
    public b(androidx.work.impl.k kVar) {
