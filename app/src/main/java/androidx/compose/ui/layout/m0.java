...
public final class m0 implements androidx.compose.runtime.i {
    ...
    public androidx.compose.runtime.w y;
    ...
    public static void d(f0 f0Var) {
        ...
        androidx.compose.runtime.l1 l1Var = f0Var.f;
        if (l1Var != null) {
            l1Var.h.set(androidx.compose.runtime.m1.y);
            androidx.compose.runtime.internal.l lVar = l1Var.k;
            if (lVar.d.h()) {
                p0Var = lVar.d;
            ...
            lVar.b();
            androidx.compose.runtime.z zVar = l1Var.a;
            zVar.N = null;
            if (p0Var != null) {
                zVar.R.k = p0Var;
                zVar.T = 2;
            ...
            f0Var.f = null;
            androidx.compose.runtime.z zVar2 = f0Var.c;
            if (zVar2 != null) {
                zVar2.m();
            }
            f0Var.c = null;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && (zVar = ((f0) objArr[(i << 3) + i3]).c) != null) {
                            zVar.m();
                        }
                        j >>= 8;
                    }
        ...
        if (l1Var != null) {
            ...
            try {
                ...
                if (z) {
                    while (!l1Var.c()) {
                        try {
                            l1Var.e(new androidx.compose.ui.graphics.a(20));
                        } catch (Throwable th) {
                            throw th;
                        }
                    }
            ...
            while (i2 >= i) {
                try {
                    ...
                    if (((androidx.collection.k0) this.H.y).c(obj2)) {
                        ...
                        f0Var4.O = true;
                        this.C.k(f0Var2);
                        androidx.compose.runtime.z zVar = f0Var3.c;
                        if (zVar != null) {
                            zVar.m();
                        }
                        this.e.S(i2, 1);
    ...
    public final void j(f0 f0Var, boolean z) {
        androidx.compose.runtime.z zVar;
        if (z || !f0Var.h) {
            f0Var.g = androidx.compose.runtime.t.r(Boolean.FALSE);
        } else {
        ...
        if (outOfFrameExecutor == null) {
            if (f0Var.h || (zVar = f0Var.c) == null) {
                return;
            }
            zVar.l();
            return;
        }
        androidx.compose.animation.z zVar3 = new androidx.compose.animation.z(f0Var, 5);
        ...
        if (zIsEmpty) {
            ...
            if (handler != null) {
                ...
                kotlinx.coroutines.future.a.q("schedule is called when outOfFrameExecutor is not available (view is detached)");
            }
        }
    }
    ...
    public final void k(androidx.compose.ui.node.f0 f0Var, Object obj, boolean z, kotlin.jvm.functions.p pVar) {
        ...
        if (objG == null) {
            ...
            f0Var2.b = fVar;
            f0Var2.c = null;
            f0Var2.g = androidx.compose.runtime.t.r(Boolean.TRUE);
        ...
        androidx.compose.runtime.z zVar2 = f0Var3.c;
        if (zVar2 != null) {
        ...
        if (z3 || z2 || f0Var3.d) {
            ...
            try {
                androidx.compose.ui.node.f0 f0Var4 = this.e;
                f0Var4.O = true;
                androidx.compose.runtime.z zVar3 = f0Var3.c;
                androidx.compose.runtime.w wVar = this.y;
                if (wVar == null) {
                ...
                if (zVar3 == null) {
                    if (z) {
                        ViewGroup.LayoutParams layoutParams = i3.a;
                        zVar = new androidx.compose.runtime.z(wVar, new a2(f0Var));
                    } else {
                        ViewGroup.LayoutParams layoutParams2 = i3.a;
                        zVar = new androidx.compose.runtime.z(wVar, new a2(f0Var));
                    }
                    zVar3 = zVar;
                } else {
                    if (zVar3.T == 3) {
                        if (z) {
                            ViewGroup.LayoutParams layoutParams3 = i3.a;
                            zVar = new androidx.compose.runtime.z(wVar, new a2(f0Var));
                        } else {
                            ViewGroup.LayoutParams layoutParams4 = i3.a;
                            zVar = new androidx.compose.runtime.z(wVar, new a2(f0Var));
                        }
                        zVar3 = zVar;
                    }
                ...
                if (((androidx.compose.ui.platform.u) androidx.compose.ui.node.i0.a(this.e)).getOutOfFrameExecutor() != null) {
                    ...
                    f0Var3.h = true;
                    fVar2 = new androidx.compose.runtime.internal.f(true, 1524156494, new androidx.compose.ui.contentcapture.e(i, f0Var3, fVar2));
                }
                if (z) {
                    if (f0Var3.e) {
                        zVar3.i();
                        zVar3.q();
                        f0Var3.f = zVar3.k(true, fVar2);
                    } else {
                        f0Var3.f = zVar3.k(zVar3.i(), fVar2);
                    }
                } else if (f0Var3.e) {
                    zVar3.i();
                    zVar3.q();
                    androidx.compose.runtime.s sVar = zVar3.S;
                    sVar.z = 0;
                    sVar.y = true;
                    zVar3.e.a(zVar3, fVar2);
                    sVar.u();
                } else {
                    zVar3.B(fVar2);
                }
    ...
    public final androidx.compose.ui.node.f0 l(Object obj) {
        ...
        objG3.getClass();
        f0 f0Var3 = (f0) objG3;
        f0Var3.g = androidx.compose.runtime.t.r(Boolean.TRUE);
        f0Var3.e = true;
        f0Var3.d = true;
        return f0Var2;
    }
