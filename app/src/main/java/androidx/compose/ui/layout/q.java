...
public final class q {
    ...
    public q(q[] qVarArr) {
        ...
        this.b = new p(1, new p1(pVarArr, 0));
        ...
        this.d = new p(1, new p1(pVarArr3, 1));
        ...
        switch (this.a) {
            case 0:
                ...
                for (q qVar : qVarArr) {
                    ...
                    kotlin.coroutines.intrinsics.h.b(sb, qVar, null);
                }
                sb.append((CharSequence) ")");
                return sb.toString();
            default:
                return androidx.privacysandbox.ads.adservices.java.internal.a.m(')', "RectRulers(", (String) this.f);
        }
    }
