...
public final class r extends androidx.core.view.w0 implements Runnable, androidx.core.view.s, View.OnAttachStateChangeListener {
    ...
    public final androidx.compose.runtime.g1 E;
    ...
    public r() {
        ...
        r1.a.getClass();
        o0Var.m(q1.b, new u1("caption bar"));
        o0Var.m(q1.c, new u1("display cutout"));
        o0Var.m(q1.d, new u1("ime"));
        o0Var.m(q1.e, new u1("mandatory system gestures"));
        o0Var.m(q1.f, new u1("navigation bars"));
        o0Var.m(q1.g, new u1("status bars"));
        o0Var.m(q1.h, new u1("system gestures"));
        o0Var.m(q1.i, new u1("tappable element"));
        o0Var.m(q1.j, new u1("waterfall"));
        this.D = o0Var;
        this.E = new androidx.compose.runtime.g1(0);
    ...
    public final void P(z1 z1Var) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j2 & 255) < 128) {
                            ...
                            u1Var.a.setValue(Boolean.valueOf(z1Var.a.u(i7)));
                            i = 8;
                        } else {
                            objArr2 = objArr3;
                            i = i3;
        ...
        if (hVarH == null) {
            ...
            androidx.core.graphics.c cVarA = hVarH.a();
            j = (((long) cVarA.a) << c3) | (((long) cVarA.b) << c2) | (((long) cVarA.c) << c) | ((long) cVarA.d);
        }
        androidx.collection.o0 o0Var = this.D;
        r1.a.getClass();
        Object objG2 = o0Var.g(q1.j);
        objG2.getClass();
        u1 u1Var2 = (u1) objG2;
        u1Var2.a.setValue(Boolean.valueOf(!a0.f(j, 0L)));
        if (!a0.f(u1Var2.h, j)) {
            u1Var2.h = j;
            u1Var2.i = j;
            z2 = z;
        ...
        if (hVarH == null) {
            ...
            List listF = Build.VERSION.SDK_INT >= 28 ? androidx.arch.core.executor.d.f(hVarH.a) : Collections.EMPTY_LIST;
            int size = listF.size();
            androidx.collection.j0 j0Var2 = this.F;
            if (size < j0Var2.b) {
                j0Var2.l(listF.size(), this.F.b);
                this.G.e(listF.size(), this.G.size());
                z2 = z;
            } else {
                int size2 = listF.size() - this.F.b;
                int i8 = 0;
                while (i8 < size2) {
                    androidx.collection.j0 j0Var3 = this.F;
                    j0Var3.a(androidx.compose.runtime.t.r(listF.get(j0Var3.b)));
            ...
            for (int i9 = 0; i9 < size3; i9++) {
                Rect rect = (Rect) listF.get(i9);
                androidx.compose.runtime.a1 a1Var = (androidx.compose.runtime.a1) this.F.f(i9);
                if (!kotlin.jvm.internal.l.a(a1Var.getValue(), rect)) {
                    a1Var.setValue(rect);
                    z2 = z;
                }
            }
        ...
        if ((z3 || this.E.g() != 0) && z2) {
            androidx.compose.runtime.g1 g1Var = this.E;
            g1Var.h(g1Var.g() + 1);
    ...
    public final void n(androidx.core.view.f1 f1Var) {
        ...
        if (r1Var != null) {
            ...
            u1Var.d.h(0L);
            u1Var.c.h(0.0f);
            u1Var.b.setValue(Boolean.FALSE);
            u1Var.j = -1L;
            u1Var.k = -1L;
            androidx.compose.runtime.g1 g1Var = this.E;
            g1Var.h(g1Var.g() + 1);
