...
public final class a1 {
    ...
    public a1(androidx.media3.exoplayer.c0 c0Var, androidx.media3.exoplayer.x xVar, androidx.media3.common.util.d0 d0Var, int i, int i2, int i3, int i4) {
        this.a = 1;
        this.b = c0Var;
        this.d = xVar;
        this.e = d0Var;
        this.f = new androidx.media3.common.t0();
        this.g = d0Var.a(c0Var.s, new androidx.media3.common.util.k(this, 1));
        this.h = new androidx.media3.common.util.y(this, i);
        this.i = new androidx.media3.common.util.z(this, i2);
        this.j = new androidx.media3.common.util.a0(this, i3);
        this.k = new androidx.media3.common.util.b0(this, i4);
        androidx.media3.common.util.x xVar2 = new androidx.media3.common.util.x(this);
        this.c = xVar2;
        c0Var.m.a(xVar2);
    }
    ...
    public static final void a(a1 a1Var, androidx.compose.ui.q qVar, d1 d1Var) {
        for (androidx.compose.ui.q qVar2 = qVar.B; qVar2 != null; qVar2 = qVar2.B) {
            if (qVar2 == ((z0) a1Var.c)) {
                ...
                d1Var.N = f0VarV != null ? (s) f0VarV.d0.d : null;
                a1Var.e = d1Var;
                return;
            } else {
                if ((qVar2.z & 2) != 0) {
    ...
    public static void j(androidx.compose.ui.p pVar, androidx.compose.ui.p pVar2, androidx.compose.ui.q qVar) {
        ...
        if (z) {
            ...
            if ((bVar.z & 8) != 0) {
                ((androidx.compose.ui.platform.u) l.w(bVar)).D();
            }
        }
        bVar.L = pVar2;
        bVar.z = e1.d(pVar2);
    ...
    public void b(String str, String str2) {
        ...
        if (map != null) {
            ...
            kotlinx.coroutines.future.a.u("Property \"autoMetadata\" has not been set");
        }
    }

    public com.google.android.datatransport.runtime.i c() {
        String strConcat = ((String) this.b) == null ? " transportName" : "";
        if (((com.google.android.datatransport.runtime.m) this.d) == null) {
        ...
        if (strConcat.isEmpty()) {
            return new com.google.android.datatransport.runtime.i((String) this.b, (Integer) this.c, (com.google.android.datatransport.runtime.m) this.d, ((Long) this.e).longValue(), ((Long) this.f).longValue(), (HashMap) this.g, (Integer) this.h, (String) this.i, (byte[]) this.j, (byte[]) this.k);
        }
        ...
        for (androidx.compose.ui.q qVar = ((w1) this.f).B; qVar != null; qVar = qVar.B) {
            ...
            if (wVarF != null) {
                ...
                if (d1Var2 != null) {
                    ...
                    w wVar = yVar.o0;
                    yVar.v1(wVarF);
                    if (wVar != qVar && (l1Var = yVar.i0) != null) {
                        ((androidx.compose.ui.platform.r1) l1Var).c();
                    }
                } else {
                    yVar = new y(f0Var, wVarF);
                    qVar.L0(yVar);
                }
                d1Var.N = yVar;
                yVar.M = d1Var;
    ...
    public ListenableFuture k(xc xcVar, Executor executor) {
        ...
        synchronized (this.i) {
            ...
            if (listenableFuture2 == null || !listenableFuture2.isDone()) {
                if (((ListenableFuture) this.k) == null) {
                    this.k = com.google.common.util.concurrent.m0.e(((com.google.android.material.internal.k) this.j).D(rf.a(new oe(this, 0)), (com.google.common.util.concurrent.w0) this.e));
                }
                listenableFuture = (ListenableFuture) this.k;
            } else {
                try {
                    com.google.common.util.concurrent.m0.b((ListenableFuture) this.k);
        ...
        return ((com.google.android.material.internal.k) this.j).D(rf.a(new b7(this, listenableFuture, xcVar, executor, 2)), com.google.common.util.concurrent.d0.e);
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    ArrayList arrayListA = rdVarB.a(rdVarB.a.d(rdVarB.d));
    ...
    public a1(String str, com.google.common.util.concurrent.p0 p0Var, se seVar, Executor executor, td tdVar, com.google.common.base.m mVar, com.google.android.gms.internal.measurement.f1 f1Var) {
        this.a = 3;
        this.i = new Object();
        this.j = new com.google.android.material.internal.k(3);
        this.k = null;
        this.b = str;
        this.c = com.google.common.util.concurrent.m0.e(p0Var);
        this.d = seVar;
        this.e = new com.google.common.util.concurrent.w0(executor);
        this.f = tdVar;
        this.g = mVar;
        this.h = f1Var;
    }
