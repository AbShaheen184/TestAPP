...
public final class a2 implements androidx.compose.runtime.c {
    ...
    public final void e() {
        ...
        androidx.compose.ui.viewinterop.w wVar = f0Var.M;
        if (wVar != null) {
            View view = wVar.y;
        ...
        f0Var.y = androidx.compose.ui.semantics.q.a.addAndGet(1);
        m1 m1Var2 = f0Var.L;
        if (m1Var2 != null) {
        ...
        if (m1Var3 != null) {
            ...
            if (androidx.compose.ui.platform.u.f() && (dVar = uVar2.l0) != null) {
                ...
                if (nVarX != null && nVarX.e.b(androidx.compose.ui.semantics.w.q)) {
                    a0Var.a(f0Var.y);
