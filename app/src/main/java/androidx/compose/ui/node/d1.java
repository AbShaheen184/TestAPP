...
public abstract class d1 extends n0 implements androidx.compose.ui.layout.p0, androidx.compose.ui.layout.x, n1 {
    ...
    public static d1 o1(androidx.compose.ui.layout.x xVar) {
        d1 d1Var;
    ...
    public final androidx.compose.ui.layout.r0 C0() {
        ...
        kotlinx.coroutines.future.a.u("Asking for measurement result of unmeasured layout modifier");
        return null;
    }
    ...
    public final long D(androidx.compose.ui.layout.x xVar, long j) {
        ...
        d1 d1VarO1 = o1(xVar);
        d1VarO1.d1();
        d1 d1VarQ0 = Q0(d1VarO1);
        while (d1VarO1 != d1VarQ0) {
            l1 l1Var = d1VarO1.i0;
            if (l1Var != null) {
            ...
            j = androidx.room.t.y(j, d1VarO1.W);
            d1VarO1 = d1VarO1.N;
            d1VarO1.getClass();
        }
        return K0(d1VarQ0, j);
    ...
    public final long E(long j) {
        ...
        return ((androidx.compose.ui.platform.u) i0.a(this.L)).t(X(j));
    }
    ...
    public final long I(long j) {
        ...
        uVar.E();
        return D(xVarG, androidx.compose.ui.geometry.b.d(androidx.compose.ui.graphics.f0.b(j, uVar.z0), xVarG.X(0L)));
    }

    @Override // androidx.compose.ui.node.n0
    public final void I0() {
        l0(this.W, this.X, this.Q);
    }

    public final void J0(d1 d1Var, androidx.compose.ui.geometry.a aVar, boolean z) {
        if (d1Var == this) {
            return;
        }
        d1 d1Var2 = this.N;
        if (d1Var2 != null) {
            d1Var2.J0(d1Var, aVar, z);
        }
        long j = this.W;
        float f = (int) (j >> 32);
        aVar.b -= f;
    ...
    @Override // androidx.compose.ui.layout.x
    public final void K(androidx.compose.ui.layout.x xVar, float[] fArr) {
        d1 d1VarO1 = o1(xVar);
        d1VarO1.d1();
        d1 d1VarQ0 = Q0(d1VarO1);
        androidx.compose.ui.graphics.f0.d(fArr);
        d1VarO1.r1(d1VarQ0, fArr);
        q1(d1VarQ0, fArr);
    }

    public final long K0(d1 d1Var, long j) {
        if (d1Var == this) {
            return j;
        }
        d1 d1Var2 = this.N;
        return (d1Var2 == null || kotlin.jvm.internal.l.a(d1Var, d1Var2)) ? R0(j) : R0(d1Var2.K0(d1Var, j));
    }
        ...
        for (androidx.compose.ui.q qVar = (w1) f0Var.d0.f; qVar != null; qVar = qVar.B) {
            if ((qVar.z & 64) != 0) {
                ...
                while (E != 0) {
                    if (E instanceof p1) {
                        objY0 = ((p1) E).y0(objY0);
                    } else if ((E.z & 64) != 0 && (E instanceof k)) {
                        androidx.compose.ui.q qVar2 = ((k) E).M;
                        int i = 0;
                        E = E;
                        bVar = bVar;
                        while (qVar2 != null) {
    ...
    public final long L0(long j) {
        ...
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (j & 4294967295L)) - d0();
    ...
    public final float M0(long j, long j2) {
        if (g0() >= Float.intBitsToFloat((int) (j2 >> 32)) && d0() >= Float.intBitsToFloat((int) (j2 & 4294967295L))) {
    ...
    public final void N0(androidx.compose.ui.graphics.r rVar, androidx.compose.ui.graphics.layer.b bVar) {
        ...
        androidx.compose.ui.platform.r1 r1Var = (androidx.compose.ui.platform.r1) l1Var;
        androidx.compose.ui.graphics.drawscope.b bVar2 = r1Var.J;
        r1Var.g();
        r1Var.Q = r1Var.e.a.J() > 0.0f;
        c2 c2Var = bVar2.y;
        c2Var.Y(rVar);
        c2Var.z = bVar;
        androidx.compose.ui.graphics.layer.b bVar3 = r1Var.e;
        androidx.compose.ui.graphics.r rVarV = bVar2.c0().v();
        androidx.compose.ui.graphics.layer.b bVar4 = (androidx.compose.ui.graphics.layer.b) bVar2.c0().z;
        ...
        if (z3) {
            ...
            if (a0VarD instanceof androidx.compose.ui.graphics.h0) {
                androidx.compose.ui.graphics.r.k(rVarV, ((androidx.compose.ui.graphics.h0) a0VarD).f);
                ...
                rVarV.a(((androidx.compose.ui.graphics.g0) a0VarD).f);
            }
        }
        if (bVar4 != null) {
        ...
        if (((androidx.compose.ui.graphics.c) rVarV).a.isHardwareAccelerated()) {
            dVar.M(rVarV);
        } else {
            ...
            long jF = coil3.network.g.F(bVar3.u);
            ...
            androidx.compose.ui.graphics.r rVarV2 = c2Var2.v();
            long jG = c2Var2.G();
    ...
    public final void O0(androidx.compose.ui.graphics.r rVar, androidx.compose.ui.graphics.layer.b bVar) {
        androidx.compose.ui.graphics.r rVar2;
        androidx.compose.ui.graphics.layer.b bVar2;
        androidx.compose.ui.q qVarV0 = V0(4);
        if (qVarV0 == null) {
            j1(rVar, bVar);
            return;
        }
        ...
        long jF = coil3.network.g.F(this.z);
        sharedDrawScope.getClass();
        androidx.compose.runtime.collection.b bVar3 = null;
        while (qVarV0 != null) {
            if (qVarV0 instanceof n) {
                rVar2 = rVar;
                bVar2 = bVar;
                sharedDrawScope.c(rVar2, jF, this, (n) qVarV0, bVar2);
            } else {
                rVar2 = rVar;
                bVar2 = bVar;
                if ((qVarV0.z & 4) != 0 && (qVarV0 instanceof k)) {
                    int i = 0;
                    for (androidx.compose.ui.q qVar = ((k) qVarV0).M; qVar != null; qVar = qVar.C) {
                        if ((qVar.z & 4) != 0) {
                            i++;
                            if (i == 1) {
                                qVarV0 = qVar;
    ...
    public final d1 Q0(d1 d1Var) {
        f0 f0VarV = d1Var.L;
        f0 f0Var = this.L;
        if (f0VarV == f0Var) {
            androidx.compose.ui.q qVarU0 = d1Var.U0();
            androidx.compose.ui.q qVarU1 = U0();
            if (!qVarU1.e.K) {
                androidx.compose.ui.internal.a.b("visitLocalAncestors called on an unattached node");
            }
            for (androidx.compose.ui.q qVar = qVarU1.e.B; qVar != null; qVar = qVar.B) {
                if ((qVar.z & 2) != 0 && qVar == qVarU0) {
                    return d1Var;
                }
            }
            return this;
        ...
        while (f0VarV != f0VarV2) {
            ...
            if (f0VarV == null || f0VarV2 == null) {
                kotlinx.coroutines.future.a.q("layouts are not part of the same hierarchy");
                return null;
            }
        }
        if (f0VarV2 != f0Var) {
            if (f0VarV != d1Var.L) {
                return (s) f0VarV.d0.d;
            }
            return d1Var;
        }
        return this;
    ...
    public final long R0(long j) {
        ...
        return r1Var.P ? jFloatToRawIntBits : androidx.compose.ui.graphics.f0.b(jFloatToRawIntBits, fArrA);
    }
    ...
    public abstract androidx.compose.ui.q U0();

    public final androidx.compose.ui.q V0(int i) {
        boolean zG = e1.g(i);
        androidx.compose.ui.q qVarU0 = U0();
        if (!zG && (qVarU0 = qVarU0.B) == null) {
            return null;
        }
        for (androidx.compose.ui.q qVarW0 = W0(zG); qVarW0 != null && (qVarW0.A & i) != 0; qVarW0 = qVarW0.C) {
            if ((qVarW0.z & i) != 0) {
                return qVarW0;
            }
            if (qVarW0 == qVarU0) {
    ...
    public final androidx.compose.ui.q W0(boolean z) {
        androidx.compose.ui.q qVarU0;
        a1 a1Var = this.L.d0;
        if (((d1) a1Var.e) == this) {
        ...
        if (d1Var == null || (qVarU0 = d1Var.U0()) == null) {
            return null;
        }
        return qVarU0.C;
    }
    ...
    public final long X(long j) {
        ...
        for (d1 d1Var = this; d1Var != null; d1Var = d1Var.N) {
            ...
            j = androidx.room.t.y(j, d1Var.W);
        }
        return j;
    }

    public final void X0(androidx.compose.ui.q qVar, b1 b1Var, long j, q qVar2, int i, boolean z) {
        if (qVar == null) {
            a1(b1Var, j, qVar2, i, z);
            return;
        }
        int i2 = qVar2.z;
        androidx.collection.j0 j0Var = qVar2.e;
        qVar2.c(i2 + 1, j0Var.b);
        qVar2.z++;
        j0Var.a(qVar);
        qVar2.y.a(l.a(-1.0f, z, false));
        X0(l.d(qVar, b1Var.b()), b1Var, j, qVar2, i, z);
        qVar2.z = i2;
    }

    public final void Y0(androidx.compose.ui.q qVar, b1 b1Var, long j, q qVar2, int i, boolean z, float f) {
        if (qVar == null) {
            a1(b1Var, j, qVar2, i, z);
            return;
        }
        ...
        qVar2.z++;
        j0Var.a(qVar);
        qVar2.y.a(l.a(f, z, false));
        i1(l.d(qVar, b1Var.b()), b1Var, j, qVar2, i, z, f, true);
        qVar2.z = i2;
    }

    public final void Z0(b1 b1Var, long j, q qVar, int i, boolean z) {
        boolean z2;
        boolean z3;
        androidx.compose.ui.q qVarV0 = V0(b1Var.b());
        if (!u1(j)) {
            if (i == 1) {
                float fM0 = M0(j, T0());
                if ((Float.floatToRawIntBits(fM0) & Integer.MAX_VALUE) < 2139095040) {
                    if (qVar.z != qVar.e.b - 1) {
                        if (l.g(qVar.b(), l.a(fM0, false, false)) <= 0) {
                            return;
                        }
                    }
                    Y0(qVarV0, b1Var, j, qVar, i, false, fM0);
                    return;
                }
                return;
            }
        ...
        if (fIntBitsToFloat >= 0.0f && fIntBitsToFloat2 >= 0.0f && fIntBitsToFloat < g0() && fIntBitsToFloat2 < d0()) {
            X0(qVarV0, b1Var, j, qVar, i, z);
            return;
        }
        float fM1 = i == 1 ? M0(j, T0()) : Float.POSITIVE_INFINITY;
        if ((Float.floatToRawIntBits(fM1) & Integer.MAX_VALUE) < 2139095040) {
            if (qVar.z != qVar.e.b - 1) {
                z2 = z;
                if (l.g(qVar.b(), l.a(fM1, z2, false)) > 0) {
                }
                i1(qVarV0, b1Var, j, qVar, i, z2, fM1, z3);
            }
            z2 = z;
            z3 = true;
            i1(qVarV0, b1Var, j, qVar, i, z2, fM1, z3);
    ...
    public void a1(b1 b1Var, long j, q qVar, int i, boolean z) {
        d1 d1Var = this.M;
        if (d1Var != null) {
            d1Var.Z0(b1Var, d1Var.R0(j), qVar, i, z);
        }
    }
    ...
    public final void e1() {
        androidx.compose.ui.q qVarU0;
        boolean zG = e1.g(128);
        androidx.compose.ui.q qVarW0 = W0(zG);
        if (qVarW0 == null || (qVarW0.e.A & 128) == 0) {
            return;
        }
        ...
        try {
            ...
            qVarU0 = U0();
            for (androidx.compose.ui.q qVarW1 = W0(zG); qVarW1 != null && (qVarW1.A & 128) != 0; qVarW1 = qVarW1.C) {
                if ((qVarW1.z & 128) != 0) {
                    ?? E = qVarW1;
                    ?? bVar = 0;
                    while (E != 0) {
                        if (E instanceof v) {
                            ((v) E).l(this.z);
                        } else if ((E.z & 128) != 0 && (E instanceof k)) {
                            androidx.compose.ui.q qVar = ((k) E).M;
                            int i = 0;
                            E = E;
                            bVar = bVar;
                            while (qVar != null) {
    ...
    public final long f(long j) {
        ...
        androidx.compose.ui.platform.u uVar = (androidx.compose.ui.platform.u) i0.a(this.L);
        uVar.E();
        return androidx.compose.ui.graphics.f0.b(jX, uVar.y0);
    }
    ...
    public final void f1() {
        ...
        for (androidx.compose.ui.q qVarW0 = W0(zG); qVarW0 != null && (qVarW0.A & 4194304) != 0; qVarW0 = qVarW0.C) {
            if ((qVarW0.z & 4194304) != 0) {
                ...
                while (E != 0) {
                    if (E instanceof v) {
                        ((v) E).s(this);
                    } else if ((E.z & 4194304) != 0 && (E instanceof k)) {
                        androidx.compose.ui.q qVar = ((k) E).M;
                        int i = 0;
                        E = E;
                        bVar = bVar;
    ...
    public final void h1() {
        ...
        androidx.compose.ui.q qVarW0 = W0(zG);
        if (qVarW0 == null || (qVarW0.e.A & 1048576) == 0) {
            return;
        }
        androidx.compose.ui.q qVarU0 = U0();
        if (!zG && (qVarU0 = qVarU0.B) == null) {
        ...
        for (androidx.compose.ui.q qVarW1 = W0(zG); qVarW1 != null && (qVarW1.A & 1048576) != 0; qVarW1 = qVarW1.C) {
            if ((qVarW1.z & 1048576) != 0) {
                androidx.compose.ui.q qVarE = qVarW1;
                androidx.compose.runtime.collection.b bVar = null;
                while (qVarE != null) {
                    if ((qVarE.z & 1048576) != 0 && (qVarE instanceof k)) {
                        int i = 0;
                        for (androidx.compose.ui.q qVar = ((k) qVarE).M; qVar != null; qVar = qVar.C) {
                            if ((qVar.z & 1048576) != 0) {
                                i++;
                                if (i == 1) {
                                    qVarE = qVar;
  ...
  0x01b2: PHI (r9v5 ??) = (r9v1 ??), (r9v1 ??), (r9v7 ??) binds: [B:51:0x0177, B:53:0x017b, B:67:0x01aa] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final void i1(androidx.compose.ui.q qVar, b1 b1Var, long j, q qVar2, int i, boolean z, float f, boolean z2) {
        ?? E;
        if (qVar == null) {
            a1(b1Var, j, qVar2, i, z);
            return;
        ...
        if (i2 == 3 || i2 == 4) {
            ...
            while (r8 != 0) {
                if (r8 instanceof r1) {
                    ...
                    if (Float.intBitsToFloat(i3) >= g0() + ((j2 == 0 || f0Var.X == mVar2) ? b1.a(2, jK) : b1.a(0, jK))) {
                        break;
                    }
                    ...
                    if (Float.intBitsToFloat(i5) >= b1.a(3, jK) + d0()) {
                        break;
                    }
                    androidx.collection.b0 b0Var = qVar2.y;
                    androidx.collection.j0 j0Var = qVar2.e;
                    int i6 = qVar2.z;
                    int i7 = j0Var.b;
                    if (i6 == i7 - 1) {
                        ...
                        qVar2.z++;
                        j0Var.a(qVar);
                        b0Var.a(l.a(0.0f, z, true));
                        i1(l.d(qVar, b1Var.b()), b1Var, j, qVar2, i2, z, f, z2);
                        qVar2.z = i6;
                        return;
                    }
                    long jB = qVar2.b();
                    ...
                    if (!l.n(jB)) {
                        if (l.j(jB) > 0.0f) {
                            int i9 = qVar2.z;
                            qVar2.c(i9 + 1, j0Var.b);
                            qVar2.z++;
                            j0Var.a(qVar);
                            b0Var.a(l.a(0.0f, z, true));
                            i1(l.d(qVar, b1Var.b()), b1Var, j, qVar2, i, z, f, z2);
                            qVar2.z = i9;
                            return;
                        }
                        return;
                    ...
                    qVar2.z = i11;
                    if (l.j(qVar2.b()) < 0.0f) {
                        qVar2.c(i8 + 1, qVar2.z + 1);
                    }
                    qVar2.z = i8;
                    return;
                }
                int i12 = 16;
                if ((r8.z & 16) == 0 || !(r8 instanceof k)) {
                    E = r8;
                    bVar = bVar;
                    E = l.e(bVar);
                } else {
                    androidx.compose.ui.q qVar3 = ((k) r8).M;
                    int i13 = 0;
                    while (qVar3 != null) {
                        if ((qVar3.z & 16) != 0) {
                            i13++;
        ...
        switch (b1Var.a) {
            case 0:
                ...
                while (E2 != 0) {
                    if (E2 instanceof r1) {
                        ((r1) E2).L();
                    } else if ((E2.z & 16) != 0 && (E2 instanceof k)) {
                        androidx.compose.ui.q qVar4 = ((k) E2).M;
                        int i14 = 0;
                        while (qVar4 != null) {
                            if ((qVar4.z & 16) != 0) {
                                i14++;
        ...
        i1(l.d(qVar, b1Var.b()), b1Var, j, qVar2, i, z, f, false);
    }

    public abstract void j1(androidx.compose.ui.graphics.r rVar, androidx.compose.ui.graphics.layer.b bVar);
    ...
    public final void k1(long j, float f, kotlin.jvm.functions.l lVar) {
        ...
        if (!zA) {
            ...
            l1 l1Var = this.i0;
            if (l1Var != null) {
                ((androidx.compose.ui.platform.r1) l1Var).d(j);
            } else {
                d1 d1Var = this.N;
                if (d1Var != null) {
                    d1Var.b1();
            ...
            m1 m1Var = f0Var.L;
            if (m1Var != null) {
                ((androidx.compose.ui.platform.u) m1Var).z(f0Var);
            }
        }
        this.X = f;
    ...
    public final void l1(androidx.compose.ui.geometry.a aVar, boolean z, boolean z2) {
        l1 l1Var = this.i0;
        if (l1Var != null) {
            if (this.P) {
                if (z2) {
                    long jT0 = T0();
                    float fIntBitsToFloat = Float.intBitsToFloat((int) (jT0 >> 32)) / 2.0f;
                    float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jT0 & 4294967295L)) / 2.0f;
                    long j = this.z;
    ...
    public final void m(float[] fArr) {
        ...
        d1 d1VarO1 = o1(androidx.compose.ui.layout.a0.g(this));
        r1(d1VarO1, fArr);
    ...
    public final void n1(androidx.compose.ui.layout.r0 r0Var) {
        ...
        if (r0Var != r0Var2) {
            ...
            if (r0Var2 == null || r0Var.b() != r0Var2.b() || r0Var.a() != r0Var2.a()) {
                ...
                l1 l1Var = this.i0;
                if (l1Var != null) {
                    ((androidx.compose.ui.platform.r1) l1Var).e((((long) iB) << 32) | (((long) iA) & 4294967295L));
                } else if (f0Var.I() && (d1Var = this.N) != null) {
                    d1Var.b1();
                }
                n0((((long) iA) & 4294967295L) | (((long) iB) << 32));
                if (this.Q != null) {
                    t1(false);
                }
                boolean zG = e1.g(4);
                androidx.compose.ui.q qVarU0 = U0();
                if (zG || (qVarU0 = qVarU0.B) != null) {
                    for (androidx.compose.ui.q qVarW0 = W0(zG); qVarW0 != null && (qVarW0.A & 4) != 0; qVarW0 = qVarW0.C) {
                        if ((qVarW0.z & 4) != 0) {
                            ?? E = qVarW0;
                            ?? bVar = 0;
                            while (E != 0) {
                                if (E instanceof n) {
                                    ((n) E).K();
                                } else if ((E.z & 4) != 0 && (E instanceof k)) {
                                    androidx.compose.ui.q qVar = ((k) E).M;
                                    int i2 = 0;
                                    E = E;
                                    bVar = bVar;
    ...
    public final androidx.compose.ui.geometry.c p1() {
        if (U0().K) {
            androidx.compose.ui.layout.x xVarG = androidx.compose.ui.layout.a0.g(this);
            ...
            aVar.d = Float.intBitsToFloat(i) + g0();
            aVar.e = Float.intBitsToFloat(i2) + d0();
            d1 d1Var = this;
            while (d1Var != xVarG) {
                d1Var.l1(aVar, false, true);
                if (!aVar.b()) {
                    d1Var = d1Var.N;
                    d1Var.getClass();
                }
    ...
    public final void q1(d1 d1Var, float[] fArr) {
        ...
        l1 l1Var = this.i0;
        if (l1Var == null || (fArrA = ((androidx.compose.ui.platform.r1) l1Var).a()) == null) {
            return;
        }
        androidx.compose.ui.graphics.f0.e(fArr, fArrA);
    }

    public final void r1(d1 d1Var, float[] fArr) {
        d1 d1Var2 = this;
        while (!d1Var2.equals(d1Var)) {
            l1 l1Var = d1Var2.i0;
            if (l1Var != null) {
                androidx.compose.ui.graphics.f0.e(fArr, ((androidx.compose.ui.platform.r1) l1Var).b());
            }
            long j = d1Var2.W;
    ...
    public final void s1(kotlin.jvm.functions.l lVar, boolean z) {
        m1 m1Var;
        ...
        if (!zH || lVar == null) {
            ...
            if (l1Var != null) {
                androidx.compose.ui.platform.r1 r1Var = (androidx.compose.ui.platform.r1) l1Var;
                if (!androidx.compose.ui.graphics.a0.r(r1Var.b())) {
                    f0Var.N();
                }
                r1Var.A = null;
                r1Var.B = null;
                r1Var.D = true;
                r1Var.f(false);
                androidx.compose.ui.graphics.y yVar = r1Var.y;
                if (yVar != null) {
                    yVar.a(r1Var.e);
                    androidx.compose.ui.platform.u uVar = r1Var.z;
                    ...
                    bVar.b(new WeakReference(r1Var, (ReferenceQueue) oVar.z));
                    uVar.d0.j(r1Var);
                }
                f0Var.h0 = true;
                c1Var.invoke();
                if (U0().K && f0Var.I() && (m1Var = f0Var.L) != null) {
                    ((androidx.compose.ui.platform.u) m1Var).z(f0Var);
                }
            }
            this.i0 = null;
        ...
        l1 r1Var2 = (l1) obj;
        if (r1Var2 != null) {
            androidx.compose.ui.platform.r1 r1Var3 = (androidx.compose.ui.platform.r1) r1Var2;
            androidx.compose.ui.graphics.y yVar2 = r1Var3.y;
            if (yVar2 == null) {
                throw androidx.compose.runtime.j.a("currently reuse is only supported when we manage the layer lifecycle");
            }
            if (!r1Var3.e.s) {
            ...
            r1Var3.O = false;
            r1Var3.P = true;
            androidx.compose.ui.graphics.f0.d(r1Var3.E);
            float[] fArr = r1Var3.F;
            if (fArr != null) {
                androidx.compose.ui.graphics.f0.d(fArr);
            }
            r1Var3.L = androidx.compose.ui.graphics.q0.b;
            r1Var3.Q = false;
            long j = Integer.MAX_VALUE;
            r1Var3.C = (j & 4294967295L) | (j << 32);
            r1Var3.M = null;
            r1Var3.K = 0;
        } else {
            r1Var2 = new androidx.compose.ui.platform.r1(uVar2.getGraphicsContext().b(), uVar2.getGraphicsContext(), uVar2, eVar, c1Var);
        }
        androidx.compose.ui.platform.r1 r1Var4 = (androidx.compose.ui.platform.r1) r1Var2;
        r1Var4.e(this.z);
        r1Var4.d(this.W);
        this.i0 = r1Var2;
        t1(true);
    ...
    public final void t1(boolean z) {
        ...
        if (lVar == null) {
            throw androidx.compose.runtime.j.a("updateLayerParameters requires a non-null layerBlock");
        }
        ...
        k0Var.J = f0Var.W;
        k0Var.K = f0Var.X;
        k0Var.I = coil3.network.g.F(this.z);
        ...
        uVar2.d = j;
        androidx.compose.ui.platform.r1 r1Var = (androidx.compose.ui.platform.r1) l1Var;
        androidx.compose.ui.platform.u uVar4 = r1Var.z;
        int i = k0Var.e | r1Var.K;
        r1Var.I = k0Var.K;
        r1Var.H = k0Var.J;
        int i2 = i & 4096;
        if (i2 != 0) {
        ...
        if ((i & 1) != 0) {
            androidx.compose.ui.graphics.layer.d dVar = r1Var.e.a;
            if (dVar.b() != f) {
                dVar.y(f);
            }
        }
        if ((i & 2) != 0) {
            androidx.compose.ui.graphics.layer.b bVar = r1Var.e;
            float f2 = k0Var.z;
        ...
        if ((i & 4) != 0) {
            androidx.compose.ui.graphics.layer.b bVar2 = r1Var.e;
            float f3 = k0Var.A;
        ...
        if ((i & 8) != 0) {
            androidx.compose.ui.graphics.layer.d dVar4 = r1Var.e.a;
            if (dVar4.A() != 0.0f) {
                dVar4.B();
            }
        }
        if ((i & 16) != 0) {
            androidx.compose.ui.graphics.layer.d dVar5 = r1Var.e.a;
            if (dVar5.s() != 0.0f) {
                dVar5.t();
            }
        }
        if ((i & 32) != 0) {
            ...
            if (k0Var.B > 0.0f && !r1Var.Q && (aVar2 = r1Var.B) != null) {
                aVar2.invoke();
            }
        }
        if ((i & 64) != 0) {
            androidx.compose.ui.graphics.layer.b bVar4 = r1Var.e;
            long j2 = k0Var.C;
        ...
        if ((i & 128) != 0) {
            androidx.compose.ui.graphics.layer.b bVar5 = r1Var.e;
            long j3 = k0Var.D;
        ...
        if ((i & LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY) != 0) {
            androidx.compose.ui.graphics.layer.d dVar9 = r1Var.e.a;
            if (dVar9.n() != 0.0f) {
                dVar9.F();
            }
        }
        if ((i & LibretroCore.SCREEN_WIDTH) != 0) {
            androidx.compose.ui.graphics.layer.d dVar10 = r1Var.e.a;
            if (dVar10.D() != 0.0f) {
                dVar10.q();
            }
        }
        if ((i & 512) != 0) {
            androidx.compose.ui.graphics.layer.d dVar11 = r1Var.e.a;
            if (dVar11.l() != 0.0f) {
                dVar11.u();
            }
        }
        if ((i & 2048) != 0) {
            androidx.compose.ui.graphics.layer.b bVar6 = r1Var.e;
            float f5 = k0Var.E;
        ...
        if (i2 != 0) {
            c = ' ';
            boolean zA = androidx.compose.ui.graphics.q0.a(r1Var.L, androidx.compose.ui.graphics.q0.b);
            androidx.compose.ui.graphics.layer.b bVar7 = r1Var.e;
            if (!zA) {
                long jFloatToRawIntBits = (((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (r1Var.L & 4294967295L)) * ((int) (r1Var.C & 4294967295L)))) & 4294967295L) | (((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (r1Var.L >> 32)) * ((int) (r1Var.C >> 32)))) << 32);
        ...
        if ((i & 16384) != 0) {
            androidx.compose.ui.graphics.layer.b bVar8 = r1Var.e;
            boolean z3 = k0Var.H;
            if (bVar8.w != z3) {
                bVar8.w = z3;
                bVar8.g = true;
        ...
        if ((131072 & i) != 0) {
            androidx.compose.ui.graphics.layer.d dVar13 = r1Var.e.a;
        }
        if ((262144 & i) != 0) {
            androidx.compose.ui.graphics.layer.d dVar14 = r1Var.e.a;
            if (!kotlin.jvm.internal.l.a(dVar14.i(), null)) {
                dVar14.x();
            }
        }
        if ((524288 & i) != 0) {
            androidx.compose.ui.graphics.layer.b bVar9 = r1Var.e;
            int i3 = k0Var.L;
        ...
        if ((32768 & i) != 0) {
            androidx.compose.ui.graphics.layer.d dVar16 = r1Var.e.a;
            if (dVar16.h() != 0) {
                dVar16.E(0);
            }
        }
        ...
        if (kotlin.jvm.internal.l.a(r1Var.M, k0Var.M)) {
            uVar = uVar4;
            z2 = false;
        } else {
            ...
            if (a0Var == null) {
                ...
                androidx.compose.ui.graphics.layer.b bVar10 = r1Var.e;
                ...
                if ((a0Var instanceof androidx.compose.ui.graphics.g0) && Build.VERSION.SDK_INT < 33 && (aVar = r1Var.B) != null) {
                    aVar.invoke();
                }
            }
            z2 = true;
        ...
        if (i != 0 || z2) {
            ...
            androidx.compose.ui.platform.u uVar5 = uVar;
            if (uVar5.I) {
                uVar5.O(0.0f);
            }
        }
        ...
        this.P = k0Var.H;
        this.T = k0Var.A;
        boolean z5 = uVar3.a == uVar2.a && uVar3.b == uVar2.b && uVar3.c == uVar2.c && androidx.compose.ui.graphics.q0.a(uVar3.d, uVar2.d);
        ...
        f0Var.N();
        androidx.compose.ui.platform.u uVar6 = (androidx.compose.ui.platform.u) i0.a(f0Var);
        androidx.compose.ui.spatial.b rectManager = uVar6.getRectManager();
        if (this == ((d1) f0Var.d0.e)) {
        ...
        if (f0Var.n0 > 0) {
            androidx.compose.foundation.text.input.internal.o oVar = uVar6.u0.e;
            oVar.getClass();
            if (f0Var.n0 > 0) {
    ...
    public final boolean u1(long j) {
        ...
        float fIntBitsToFloat = Float.intBitsToFloat((int) (j >> 32));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (j & 4294967295L));
        androidx.compose.ui.graphics.layer.b bVar = ((androidx.compose.ui.platform.r1) l1Var).e;
        if (bVar.w) {
