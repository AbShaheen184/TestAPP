...
public final class f0 implements androidx.compose.runtime.i, n1, h {
    ...
    public f0 K;
    public m1 L;
    public androidx.compose.ui.viewinterop.w M;
    public int N;
    public boolean O;
    public boolean P;
    public androidx.compose.ui.semantics.n Q;
    public boolean R;
    ...
    public q2 Y;
    public androidx.compose.runtime.b0 Z;
    public d0 a0;
    public d0 b0;
    public boolean c0;
    public final a1 d0;
    ...
    public f0(int i, boolean z) {
        ...
        this.D = true;
        this.H = new androidx.compose.foundation.text.input.internal.o(17, new androidx.compose.runtime.collection.b(new f0[16]), new androidx.compose.animation.z(this, 7));
        ...
        this.Y = q0;
        androidx.compose.runtime.b0.a.getClass();
        this.Z = androidx.compose.runtime.a0.b;
        d0 d0Var = d0.z;
        this.a0 = d0Var;
        this.b0 = d0Var;
        this.d0 = new a1(this);
    ...
    public static boolean Q(f0 f0Var) {
        v0 v0Var = f0Var.e0.p;
        return f0Var.P(v0Var.G ? new androidx.compose.ui.unit.a(v0Var.A) : null);
    }
    ...
    public static void V(f0 f0Var, boolean z, int i) {
        ...
        if (z3) {
            ...
            if (iOrdinal != 1) {
                kotlinx.coroutines.future.a.u("Intrinsics isn't used by the parent");
    ...
    public static void X(f0 f0Var, boolean z, int i) {
        m1 m1Var;
        f0 f0VarV;
        if ((i & 1) != 0) {
            z = false;
    ...
    public static void Y(f0 f0Var) {
        ...
        j0 j0Var = f0Var.e0;
        if (i != 1) {
            com.google.firebase.platforminfo.b.o(j0Var.d, "Unexpected state ");
            return;
        }
        if (j0Var.e) {
            V(f0Var, true, 6);
    ...
    public final void A(long j, q qVar, int i, boolean z) {
        a1 a1Var = this.d0;
        d1 d1Var = (d1) a1Var.e;
        androidx.compose.ui.graphics.k0 k0Var = d1.j0;
        ((d1) a1Var.e).Z0(d1.m0, d1Var.R0(j), qVar, i, z);
    }
    ...
    public final void C() {
        ...
        if (d1Var3 != null && d1Var3.i0 == null) {
            throw androidx.compose.runtime.j.a("layer was not set");
        }
        if (d1Var3 != null) {
            d1Var3.b1();
            return;
    ...
    public final void D() {
        ...
        l1 l1Var2 = ((s) a1Var.d).i0;
        if (l1Var2 != null) {
            ((androidx.compose.ui.platform.r1) l1Var2).c();
        }
    }
    ...
    public final void F() {
        ...
        androidx.compose.ui.semantics.n nVar = this.Q;
        this.R = true;
        kotlin.jvm.internal.z zVar = new kotlin.jvm.internal.z();
        zVar.e = new androidx.compose.ui.semantics.n();
        ...
        this.R = false;
        this.Q = (androidx.compose.ui.semantics.n) zVar.e;
        this.P = false;
        androidx.compose.ui.platform.u uVar = (androidx.compose.ui.platform.u) i0.a(this);
        uVar.getSemanticsOwner().b(this, nVar);
        uVar.D();
    }
    ...
    public final Boolean J() {
        r0 r0Var = this.e0.q;
        if (r0Var != null) {
            return Boolean.valueOf(r0Var.N != p0.z);
        }
        return null;
    }
    ...
    public final void K() {
        ...
        try {
            ...
            r0Var.A0(r0Var.L, r0Var.M);
            if (z && !r0Var.Y && (f0VarV = r0Var.C.a.v()) != null) {
                f0VarV.U(false);
            }
        } finally {
            r0Var.D = false;
    ...
    public final void T() {
        ...
        try {
            ...
            boolean z = v0Var.P;
            v0Var.A0(v0Var.K, v0Var.M, v0Var.L);
            if (z && !v0Var.c0 && (f0VarV = j0Var.a.v()) != null) {
                f0VarV.W(false);
            }
            v0Var.D = false;
        } catch (Throwable th) {
    ...
    public final void a() {
        androidx.compose.ui.viewinterop.w wVar = this.M;
        if (wVar != null) {
            wVar.a();
        }
    ...
    public final void a0(Throwable th) {
        androidx.compose.runtime.b0 b0Var = this.Z;
        ...
        jVar.getClass();
        androidx.compose.runtime.tooling.d dVar = (androidx.compose.runtime.tooling.d) androidx.compose.runtime.t.s(jVar, x2Var);
        if (dVar == null) {
            throw th;
        }
    ...
    public final void b0(androidx.compose.ui.unit.c cVar) {
    ...
    public final void d(m1 m1Var) {
        ...
        a1 a1Var = this.d0;
        ((d1) a1Var.e).N = f0VarV2 != null ? (s) f0VarV2.d0.d : null;
        this.L = m1Var;
        ...
        uVar.getClass();
        if (!androidx.compose.ui.platform.u.f() || (dVar = uVar.l0) == null || (nVarX = x()) == null || !nVarX.e.b(androidx.compose.ui.semantics.w.q)) {
            return;
        }
        dVar.E.a(this.y);
    ...
    public final void e0(androidx.compose.ui.layout.q0 q0Var) {
        ...
        if (oVar != null) {
            ((androidx.compose.runtime.j1) oVar.z).setValue(q0Var);
        }
        E();
    }
    ...
    public final void f0(androidx.compose.ui.r rVar) {
    ...
    public final void g0(q2 q2Var) {
        if (kotlin.jvm.internal.l.a(this.Y, q2Var)) {
            return;
        }
        this.Y = q2Var;
    ...
    public final void h() {
        ...
        g0Var2.h = null;
        r0 r0Var2 = j0Var.q;
        if (r0Var2 != null && (g0Var = r0Var2.O) != null) {
            g0Var.b = true;
            g0Var.c = false;
            g0Var.e = false;
            g0Var.d = false;
    ...
    public final List l() {
        r0 r0Var = this.e0.q;
        r0Var.getClass();
        androidx.compose.runtime.collection.b bVar = r0Var.P;
        j0 j0Var = r0Var.C;
        j0Var.a.n();
        if (!r0Var.Q) {
            return bVar.f();
    ...
    public final androidx.compose.ui.semantics.n x() {
    ...
    public f0(int i) {
        this(androidx.compose.ui.semantics.q.a.addAndGet(1), (i & 1) == 0);
    }
}
