...
public abstract class n0 extends androidx.compose.ui.layout.d1 implements x0, androidx.compose.ui.layout.s0 {
    public k0 C;
    ...
    public static void G0(d1 d1Var) {
        ...
        if (aVarK == null || (g0Var = ((v0) aVarK).U) == null) {
            return;
        }
        g0Var.f();
    }
    ...
    public abstract androidx.compose.ui.layout.r0 C0();
    ...
    public final void H0(androidx.collection.p0 p0Var) {
        f0 f0Var;
    ...
    public final void O(boolean z) {
        n0 n0VarD0 = D0();
        f0 f0VarB0 = n0VarD0 != null ? n0VarD0.B0() : null;
        if (kotlin.jvm.internal.l.a(f0VarB0, B0())) {
            this.F = z;
            return;
        }
        if ((f0VarB0 != null ? f0VarB0.e0.d : null) != b0.z) {
            if ((f0VarB0 != null ? f0VarB0.e0.d : null) != b0.A) {
                return;
            }
        }
        this.F = z;
    ...
    public final int b0(androidx.compose.ui.layout.a aVar) {
        int iQ0;
        if (!A0() || (iQ0 = q0(aVar)) == Integer.MIN_VALUE) {
            return Integer.MIN_VALUE;
        }
        boolean z = aVar instanceof androidx.compose.ui.layout.o1;
        long j = this.B;
        return iQ0 + ((int) (z ? j >> 32 : j & 4294967295L));
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void p0(f0 f0Var, androidx.compose.ui.layout.p pVar) {
        char c;
        long j;
        long j2;
        long j3;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void v0(q1 q1Var, long j, long j2) {
        boolean z;
        char c;
        long j3;
        long j4;
                ...
                if ((((~j8) << c3) & j8 & j7) != j7) {
                    ...
                    while (i12 < i11) {
                        if ((j8 & 255) < 128) {
                            ...
                            j6 = j7;
                            n0 n0Var = n0VarD0 == null ? this : n0VarD0;
                            i = i9;
                            n0 n0Var2 = n0Var;
                            while (true) {
                                ...
                                if (oVar3 != null) {
                                    z2 = zV;
                                    if (kotlin.collections.o.c(pVar3, (androidx.compose.ui.layout.p[]) oVar3.b)) {
                                        break;
                                    } else {
                                        break;
                                    }
    ...
    public final void w0(androidx.compose.ui.layout.r0 r0Var) {
        long j;
        long j2;
        androidx.collection.o0 o0Var = this.K;
        if (!this.H) {
            ...
            if (lVarE != null) {
                ...
                if (z || !F0().e) {
                    ...
                    androidx.compose.ui.layout.x xVarY0 = y0();
                    long jF = androidx.room.t.F(xVarY0.E(0L));
                    long jU = xVarY0.u();
                    j2 = jF;
                    j = jU;
                    z = (androidx.compose.ui.unit.j.a(jF, F0().y) && androidx.compose.ui.unit.l.a(jU, F0().z)) ? false : true;
                }
                if (z) {
                    q1 q1Var = this.E;
                    if (q1Var != null) {
                ...
                if (length >= 0) {
                    ...
                    while (true) {
                        ...
                        if ((((~j3) << 7) & j3 & (-9187201950435737472L)) == -9187201950435737472L) {
                            ...
                            for (int i3 = 0; i3 < i2; i3++) {
                                if ((255 & j3) < 128) {
                                    H0((androidx.collection.p0) objArr[(i << 3) + i3]);
                                }
                                j3 >>= 8;
                            }
                            if (i2 != 8) {
    ...
    public abstract androidx.compose.ui.layout.x y0();
}
