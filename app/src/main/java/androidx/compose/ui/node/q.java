...
public final class q implements List, kotlin.jvm.internal.markers.a {
    ...
    public final long b() {
        long jA = l.a(Float.POSITIVE_INFINITY, false, false);
        int i = this.z + 1;
        int i2 = this.e.b - 1;
        if (i > i2) {
            return jA;
            ...
            if (i <= i3 && i2 >= 0 && i2 <= i3) {
                if (i2 < i) {
                    ...
                    if (i2 != i) {
                        if (i2 < i3) {
                            long[] jArr = b0Var.a;
                            kotlin.collections.o.h(jArr, jArr, i, i2, i3);
                        }
                        b0Var.b -= i2 - i;
                        return;
                    }
