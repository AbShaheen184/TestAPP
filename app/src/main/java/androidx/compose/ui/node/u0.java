        ...
        switch (this.y) {
            case 0:
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    g0 g0Var = ((f0) objArr4[i12]).e0.p.U;
                    g0Var.e = g0Var.d;
                }
                break;
            case 1:
                v0 v0Var3 = this.z;
                v0Var3.C.a().F(v0Var3.Y);
                break;
            default:
                v0 v0Var4 = this.z;
                j0 j0Var3 = v0Var4.C;
                ...
                kotlin.jvm.functions.l lVar = v0Var4.d0;
                if (lVar == null) {
                    d1 d1VarA = j0Var3.a();
                    long j = v0Var4.e0;
                    float f = v0Var4.f0;
                    placementScope.getClass();
                    androidx.compose.ui.layout.c1.b(placementScope, d1VarA);
                    d1VarA.l0(androidx.compose.ui.unit.j.c(j, d1VarA.B), f, null);
                } else {
                    d1 d1VarA2 = j0Var3.a();
                    long j2 = v0Var4.e0;
                    float f2 = v0Var4.f0;
                    placementScope.getClass();
                    androidx.compose.ui.layout.c1.b(placementScope, d1VarA2);
                    d1VarA2.l0(androidx.compose.ui.unit.j.c(j2, d1VarA2.B), f2, lVar);
                }
                break;
        }
        return kotlin.y.a;
