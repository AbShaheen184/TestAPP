...
public final class a0 extends androidx.core.view.b implements View.OnAttachStateChangeListener, AccessibilityManager.AccessibilityStateChangeListener, AccessibilityManager.TouchExplorationStateChangeListener {
    ...
    static {
        ...
        int i = yVar2.b;
        if (i < 0) {
            com.google.firebase.platforminfo.b.l("");
            return;
        }
        int i2 = i + 32;
        yVar2.b(i2);
        ...
        int i3 = yVar2.b;
        if (i != i3) {
            kotlin.collections.o.e(i2, i, i3, iArr2, iArr2);
        }
        kotlin.collections.o.i(i, 0, 12, iArr, iArr2);
        yVar2.b += 32;
        l0 = yVar2;
    }
    ...
    public a0(u uVar) {
        ...
        this.f0 = new k2(uVar.getSemanticsOwner().a(), zVar);
    ...
    public static String t(androidx.compose.ui.semantics.s sVar) {
        ...
        if (sVar != null) {
            ...
            if (o0Var.c(zVar)) {
                return androidx.compose.ui.util.a.a((List) nVar.d(zVar), ",", null, 62);
            }
            androidx.compose.ui.semantics.z zVar2 = androidx.compose.ui.semantics.w.F;
            if (o0Var.c(zVar2)) {
                ...
                Object objG2 = o0Var.g(androidx.compose.ui.semantics.w.B);
                if (objG2 == null) {
                    objG2 = null;
                }
                List list = (List) objG2;
                if (list != null && (gVar = (androidx.compose.ui.text.g) kotlin.collections.p.D(list)) != null) {
                    return gVar.y;
                }
            }
        }
    ...
    public static final boolean x(androidx.compose.ui.semantics.k kVar, float f) {
        kotlin.jvm.functions.a aVar = kVar.a;
        if (f >= 0.0f || ((Number) aVar.invoke()).floatValue() <= 0.0f) {
            return f > 0.0f && ((Number) aVar.invoke()).floatValue() < ((Number) kVar.b.invoke()).floatValue();
        }
        return true;
    }

    public static final boolean y(androidx.compose.ui.semantics.k kVar) {
        kotlin.jvm.functions.a aVar = kVar.a;
    ...
    public static final boolean z(androidx.compose.ui.semantics.k kVar) {
        kotlin.jvm.functions.a aVar = kVar.a;
        if (((Number) aVar.invoke()).floatValue() < ((Number) kVar.b.invoke()).floatValue()) {
            return true;
        }
        ((Number) aVar.invoke()).floatValue();
        return false;
    ...
    public final void B(androidx.compose.ui.semantics.s sVar, k2 k2Var) {
        ...
        androidx.compose.ui.node.f0 f0Var = sVar.c;
        int size = listJ.size();
        ...
        androidx.collection.a0 a0Var2 = k2Var.b;
        int[] iArr2 = a0Var2.b;
        long[] jArr = a0Var2.a;
        ...
        List listJ2 = androidx.compose.ui.semantics.s.j(4, sVar);
        int size2 = listJ2.size();
        for (int i6 = 0; i6 < size2; i6++) {
            androidx.compose.ui.semantics.s sVar3 = (androidx.compose.ui.semantics.s) listJ2.get(i6);
            k2 k2Var2 = (k2) this.e0.b(sVar3.g);
            if (k2Var2 != null && s().a(sVar3.g)) {
                B(sVar3, k2Var2);
            }
        }
    }
    ...
    public final void G(int i) {
        w wVar = this.W;
        if (wVar != null) {
            androidx.compose.ui.semantics.s sVar = wVar.a;
            if (i != sVar.g) {
                return;
            }
            if (SystemClock.uptimeMillis() - wVar.f <= 1000) {
                AccessibilityEvent accessibilityEventO = o(A(sVar.g), 131072);
                ...
                accessibilityEventO.getText().add(t(sVar));
                C(accessibilityEventO);
            }
        }
        this.W = null;
    ...
    public final void H(androidx.collection.n nVar) {
        ...
        String str2;
        androidx.collection.n nVar4 = nVar;
                ...
                while (i25 < i24) {
                    if ((j3 & 255) < 128) {
                        ...
                        if (k2Var == null) {
                            ...
                            androidx.compose.ui.semantics.n nVar5 = k2Var.a;
                            androidx.collection.o0 o0Var3 = nVar5.e;
                            androidx.compose.ui.semantics.t tVar = (androidx.compose.ui.semantics.t) nVar4.b(i26);
                            int i27 = i23;
                            androidx.compose.ui.semantics.s sVar2 = tVar != null ? tVar.a : null;
                            if (sVar2 == null) {
                                throw androidx.compose.runtime.j.a("no value for specified key");
                            }
                            androidx.compose.ui.node.f0 f0Var2 = sVar2.c;
                            androidx.compose.ui.semantics.n nVar6 = sVar2.d;
                            iArr2 = iArr3;
                            int i28 = sVar2.g;
                            jArr2 = jArr3;
                            androidx.collection.o0 o0Var4 = nVar6.e;
                            i6 = i20;
                                    ...
                                    if ((((~j4) << 7) & j4 & (-9187201950435737472L)) != -9187201950435737472L) {
                                        ...
                                        while (i32 < i31) {
                                            if ((j4 & 255) < 128) {
                                                ...
                                                nVar3 = nVar5;
                                                androidx.compose.ui.semantics.z zVar2 = (androidx.compose.ui.semantics.z) obj;
                                                j = j4;
                                                androidx.compose.ui.semantics.z zVar3 = androidx.compose.ui.semantics.w.u;
                                                if (kotlin.jvm.internal.l.a(zVar2, zVar3) || kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.v)) {
                                                    ...
                                                    while (true) {
                                                        ...
                                                        int i36 = size;
                                                        if (((j2) arrayList4.get(i35)).e == i26) {
                                                            j2Var = (j2) arrayList4.get(i35);
                                                            break;
                                                        } else {
                                                            i35++;
                                                            size = i36;
                                                ...
                                                if (z) {
                                                    zVar = androidx.compose.ui.semantics.w.d;
                                                    if (kotlin.jvm.internal.l.a(zVar2, zVar)) {
                                                        ...
                                                        o0Var2 = o0Var3;
                                                        i13 = i34;
                                                    } else if (!kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.b) || kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.J)) {
                                                        i26 = i26;
                                                        arrayList4 = arrayList4;
                                                        i31 = i31;
                                                        f0Var3 = f0Var3;
                                                    ...
                                                    } else if (kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.c)) {
                                                        i12 = 8;
                                                        E(this, A(i26), 2048, 64, 8);
                                                        ...
                                                        androidx.compose.ui.semantics.z zVar4 = androidx.compose.ui.semantics.w.I;
                                                        arrayList4 = arrayList4;
                                                        if (kotlin.jvm.internal.l.a(zVar2, zVar4)) {
                                                            Object objG = o0Var4.g(androidx.compose.ui.semantics.w.y);
                                                            if (objG == null) {
                                                                objG = null;
                                                            }
                                                            androidx.compose.ui.semantics.j jVar = (androidx.compose.ui.semantics.j) objG;
                                                            if (jVar != null && jVar.a == 4) {
                                                                Object objG2 = o0Var4.g(zVar4);
                                                                if (objG2 == null) {
                                                                    objG2 = null;
                                                                }
                                                                if (kotlin.jvm.internal.l.a(objG2, Boolean.TRUE)) {
                                                                    ...
                                                                    f0Var3 = f0Var3;
                                                                    androidx.compose.ui.semantics.s sVar4 = new androidx.compose.ui.semantics.s(sVar3.a, true, f0Var3, nVar6);
                                                                    Object objG3 = sVar4.k().e.g(androidx.compose.ui.semantics.w.a);
                                                                    if (objG3 == null) {
                                                                        objG3 = null;
                                                                    }
                                                                    ...
                                                                    Object objG4 = sVar4.k().e.g(androidx.compose.ui.semantics.w.B);
                                                                    if (objG4 == null) {
                                                                        objG4 = null;
                                                                    }
                                                            ...
                                                            i31 = i31;
                                                            f0Var3 = f0Var3;
                                                            if (kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.a)) {
                                                                int iA = A(i26);
                                                                obj2.getClass();
                                                                ...
                                                                androidx.compose.ui.semantics.z zVar5 = androidx.compose.ui.semantics.w.F;
                                                                String str3 = "";
                                                                if (!kotlin.jvm.internal.l.a(zVar2, zVar5)) {
                                                                    Integer num6 = num5;
                                                                    i26 = i26;
                                                                    o0Var2 = o0Var3;
                                                                    androidx.compose.ui.semantics.z zVar6 = androidx.compose.ui.semantics.w.G;
                                                                    if (kotlin.jvm.internal.l.a(zVar2, zVar6)) {
                                                                        Object objG5 = o0Var4.g(zVar5);
                                                                        if (objG5 == null) {
                                                                            objG5 = null;
                                                                        }
                                                                        ...
                                                                        long j5 = ((androidx.compose.ui.text.l0) nVar6.d(zVar6)).a;
                                                                        num3 = num6;
                                                                        ...
                                                                        if (kotlin.jvm.internal.l.a(zVar2, zVar3) || kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.v)) {
                                                                            ...
                                                                            while (true) {
                                                                                if (i37 >= size2) {
                                                                                    ...
                                                                                    if (((j2) arrayList3.get(i37)).e == i26) {
                                                                                        j2Var2 = (j2) arrayList3.get(i37);
                                                                                        break;
                                                                                    }
                                                                                    i37++;
                                                                                }
                                                                            ...
                                                                            j2Var2.getClass();
                                                                            Object objG6 = o0Var4.g(zVar3);
                                                                            if (objG6 == null) {
                                                                                objG6 = null;
                                                                            }
                                                                            j2Var2.B = (androidx.compose.ui.semantics.k) objG6;
                                                                            Object objG7 = o0Var4.g(androidx.compose.ui.semantics.w.v);
                                                                            if (objG7 == null) {
                                                                                objG7 = null;
                                                                            }
                                                                            j2Var2.C = (androidx.compose.ui.semantics.k) objG7;
                                                                            if (j2Var2.y.contains(j2Var2)) {
                                                                                this.A.getSnapshotObserver().a.d(j2Var2, this.k0, new androidx.compose.ui.draw.b(6, j2Var2, this));
                                                                            }
                                                                        } else if (kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.k)) {
                                                                            obj2.getClass();
                                                                            ...
                                                                            androidx.compose.ui.semantics.z zVar7 = androidx.compose.ui.semantics.m.x;
                                                                            if (kotlin.jvm.internal.l.a(zVar2, zVar7)) {
                                                                                List list3 = (List) nVar6.d(zVar7);
                                                                                Object objG8 = o0Var2.g(zVar7);
                                                                                if (objG8 == null) {
                                                                                    objG8 = null;
                                                                                }
                                                                    ...
                                                                    i12 = 8;
                                                                } else if (o0Var4.c(androidx.compose.ui.semantics.m.k)) {
                                                                    Object objG10 = o0Var3.g(zVar5);
                                                                    if (objG10 == null) {
                                                                        objG10 = null;
                                                                    }
                                                                    ...
                                                                    int i41 = (i15 - i17) - i39;
                                                                    int i42 = (i16 - i17) - i39;
                                                                    androidx.compose.ui.semantics.z zVar8 = androidx.compose.ui.semantics.w.K;
                                                                    boolean zC = o0Var3.c(zVar8);
                                                                    boolean zC2 = o0Var4.c(zVar8);
                                                                    boolean zC3 = o0Var3.c(androidx.compose.ui.semantics.w.F);
                                                                    ...
                                                                    if (z3 || z4) {
                                                                        long j6 = ((androidx.compose.ui.text.l0) nVar6.d(androidx.compose.ui.semantics.w.G)).a;
                                                    ...
                                                    if (kotlin.jvm.internal.l.a(obj2, objG12)) {
                                                        ...
                                                        if (kotlin.jvm.internal.l.a(zVar2, zVar)) {
                                                            ...
                                                            o0Var2 = o0Var3;
                                                            i13 = i34;
                                                        } else if (kotlin.jvm.internal.l.a(zVar2, androidx.compose.ui.semantics.w.b)) {
                                                            i26 = i26;
                                                            arrayList4 = arrayList4;
                                                            i31 = i31;
                                                            f0Var3 = f0Var3;
                            ...
                            if (i9 == 0) {
                                ...
                                while (true) {
                                    if (!it.hasNext()) {
                                        ...
                                        if (!sVar.k().e.c((androidx.compose.ui.semantics.z) ((Map.Entry) it.next()).getKey())) {
                                            i10 = i7;
                                            break;
                                        }
                                    }
        ...
        if (f0Var.H() && !this.A.getAndroidViewsHandler$ui().getLayoutNodeToHolder().containsKey(f0Var)) {
            ...
            if (!nVarX.z) {
                for (androidx.compose.ui.node.f0 f0VarV = f0Var.v(); f0VarV != null; f0VarV = f0VarV.v()) {
                    androidx.compose.ui.semantics.n nVarX2 = f0VarV.x();
    ...
    public final void J(androidx.compose.ui.node.f0 f0Var) {
        if (f0Var.H() && !this.A.getAndroidViewsHandler$ui().getLayoutNodeToHolder().containsKey(f0Var)) {
            int i = f0Var.y;
            androidx.compose.ui.semantics.k kVar = (androidx.compose.ui.semantics.k) this.N.b(i);
            androidx.compose.ui.semantics.k kVar2 = (androidx.compose.ui.semantics.k) this.O.b(i);
            if (kVar == null && kVar2 == null) {
                return;
            }
            AccessibilityEvent accessibilityEventO = o(i, 4096);
            if (kVar != null) {
                accessibilityEventO.setScrollX((int) ((Number) kVar.a.invoke()).floatValue());
                accessibilityEventO.setMaxScrollX((int) ((Number) kVar.b.invoke()).floatValue());
            }
            if (kVar2 != null) {
                accessibilityEventO.setScrollY((int) ((Number) kVar2.a.invoke()).floatValue());
                accessibilityEventO.setMaxScrollY((int) ((Number) kVar2.b.invoke()).floatValue());
            }
            C(accessibilityEventO);
        }
    }

    public final boolean K(androidx.compose.ui.semantics.s sVar, int i, int i2, boolean z) {
        String strT;
        androidx.compose.ui.semantics.n nVar = sVar.d;
        int i3 = sVar.g;
        androidx.compose.ui.semantics.z zVar = androidx.compose.ui.semantics.m.j;
        if (nVar.e.c(zVar) && i0.b(sVar)) {
            kotlin.jvm.functions.q qVar = (kotlin.jvm.functions.q) ((androidx.compose.ui.semantics.a) sVar.d.d(zVar)).b;
            if (qVar != null) {
                return ((Boolean) qVar.invoke(Integer.valueOf(i), Integer.valueOf(i2), Boolean.valueOf(z))).booleanValue();
            }
        } else if ((i != i2 || i2 != this.R) && (strT = t(sVar)) != null) {
    ...
    public final void Q() {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j5 & 255) < 128) {
                            int i6 = iArr[(i3 << 3) + i5];
                            c2 = c3;
                            androidx.compose.ui.semantics.t tVar = (androidx.compose.ui.semantics.t) s().b(i6);
                            Object obj = null;
                            androidx.compose.ui.semantics.s sVar = tVar != null ? tVar.a : null;
                            if (sVar != null) {
                                if (!sVar.d.e.c(androidx.compose.ui.semantics.w.d)) {
                                    a0Var.a(i6);
                                    k2Var = (k2) zVar.b(i6);
                                    if (k2Var != null) {
                                        Object objG = k2Var.a.e.g(androidx.compose.ui.semantics.w.d);
                                ...
                                k2Var = (k2) zVar.b(i6);
                                if (k2Var != null) {
                                    Object objG2 = k2Var.a.e.g(androidx.compose.ui.semantics.w.d);
                ...
                if ((((~j10) << c) & j10 & j3) != j3) {
                    ...
                    for (int i24 = 0; i24 < i23; i24++) {
                        if ((j10 & j2) < j) {
                            int i25 = (i22 << 3) + i24;
                            int i26 = iArr3[i25];
                            androidx.compose.ui.semantics.s sVar2 = ((androidx.compose.ui.semantics.t) objArr[i25]).a;
                            androidx.compose.ui.semantics.n nVar = sVar2.d;
                            androidx.compose.ui.semantics.z zVar2 = androidx.compose.ui.semantics.w.d;
                            if (nVar.e.c(zVar2) && a0Var2.a(i26)) {
                                F(i26, 16, (String) sVar2.d.d(zVar2));
                            }
                            zVar.h(i26, new k2(sVar2, s()));
                        }
                        j10 >>= 8;
                    }
                    if (i23 != 8) {
        ...
        this.f0 = new k2(this.A.getSemanticsOwner().a(), s());
    }
    ...
    public final void j(int i, androidx.core.view.accessibility.d dVar, String str, Bundle bundle) {
        ...
        androidx.compose.ui.semantics.t tVar = (androidx.compose.ui.semantics.t) s().b(i);
        ...
        boolean zC = o0Var.c(androidx.compose.ui.semantics.m.a);
        u uVar = this.A;
        boolean z = false;
        if (zC && bundle != null && kotlin.jvm.internal.l.a(str, "android.view.accessibility.extra.DATA_TEXT_CHARACTER_LOCATION_KEY")) {
            ...
            if (i3 > 0 && i2 >= 0) {
                if (i2 < (strT != null ? strT.length() : Integer.MAX_VALUE)) {
                    androidx.compose.ui.text.j0 j0VarK = i0.k(nVar);
                    if (j0VarK == null) {
                        return;
                    }
                    ...
                    while (i4 < i3) {
                        ...
                        if (i5 >= j0VarK.a.a.y.length()) {
                            ...
                            androidx.compose.ui.node.d1 d1VarD = sVar.d();
                            long jX = 0;
                            if (d1VarD != null) {
                                if (!d1VarD.U0().K) {
                                    d1VarD = null;
                            ...
                            androidx.compose.ui.geometry.c cVarI = cVarB.i(jX);
                            androidx.compose.ui.geometry.c cVarG = sVar.g();
        ...
        androidx.compose.ui.semantics.z zVar = androidx.compose.ui.semantics.w.z;
        if (o0Var.c(zVar) && bundle != null && kotlin.jvm.internal.l.a(str, "androidx.compose.ui.semantics.testTag")) {
        ...
        if (kotlin.jvm.internal.l.a(str, "androidx.compose.ui.semantics.shapeRect")) {
            Object objG3 = o0Var.g(androidx.compose.ui.semantics.w.P);
            androidx.compose.ui.graphics.n0 n0Var2 = (androidx.compose.ui.graphics.n0) (objG3 == null ? null : objG3);
            if (n0Var2 != null) {
                Rect rect2 = new Rect();
                accessibilityNodeInfo.getBoundsInScreen(rect2);
                androidx.compose.ui.geometry.c cVarU2 = u(sVar, rect2, n0Var2);
        ...
        if (kotlin.jvm.internal.l.a(str, "androidx.compose.ui.semantics.shapeCorners")) {
            Object objG4 = o0Var.g(androidx.compose.ui.semantics.w.P);
            androidx.compose.ui.graphics.n0 n0Var3 = (androidx.compose.ui.graphics.n0) (objG4 == null ? null : objG4);
            if (n0Var3 != null) {
                Rect rect3 = new Rect();
                accessibilityNodeInfo.getBoundsInScreen(rect3);
                float[] fArrN = N(n0Var3.a(u(sVar, rect3, n0Var3).c(), f0Var.X, uVar.getDensity()));
                if (fArrN != null) {
        ...
        if (kotlin.jvm.internal.l.a(str, "androidx.compose.ui.semantics.shapeRegion")) {
            Object objG5 = o0Var.g(androidx.compose.ui.semantics.w.P);
            ...
            if (n0Var4 != null) {
                ...
                androidx.compose.ui.geometry.c cVarU3 = u(sVar, rect4, n0Var4);
    ...
    public final Rect k(androidx.compose.ui.semantics.t tVar) {
        androidx.compose.ui.unit.k kVar = tVar.b;
    ...
    */
    ...
    public final boolean m(long j, int i, boolean z) {
        ...
        if (z) {
            zVar = androidx.compose.ui.semantics.w.v;
        } else {
            if (z) {
                coil3.g.a();
                return false;
            }
            zVar = androidx.compose.ui.semantics.w.u;
        }
        Object[] objArr = nVarS.c;
        long[] jArr = nVarS.a;
        int length = jArr.length - 2;
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i6 < i5) {
                    if ((255 & j2) < 128) {
                        androidx.compose.ui.semantics.t tVar = (androidx.compose.ui.semantics.t) objArr[(i3 << 3) + i6];
                        androidx.compose.ui.unit.k kVar = tVar.b;
                        float f = kVar.a;
                        i2 = i4;
                        float f2 = kVar.b;
                        ...
                        if ((fIntBitsToFloat2 < f4) & (fIntBitsToFloat >= f) & (fIntBitsToFloat < f3) & (fIntBitsToFloat2 >= f2)) {
                            Object objG = tVar.a.d.e.g(zVar);
                            if (objG == null) {
                                objG = null;
                            }
                            androidx.compose.ui.semantics.k kVar2 = (androidx.compose.ui.semantics.k) objG;
                            if (kVar2 != null) {
                                kotlin.jvm.functions.a aVar = kVar2.a;
                                if (i < 0) {
                                    if (((Number) aVar.invoke()).floatValue() > 0.0f) {
                                        z2 = true;
                                    }
                                } else if (((Number) aVar.invoke()).floatValue() < ((Number) kVar2.b.invoke()).floatValue()) {
                                    z2 = true;
                                }
                            }
                        }
    ...
    public final AccessibilityEvent o(int i, int i2) {
        ...
        if (v() && (tVar = (androidx.compose.ui.semantics.t) s().b(i)) != null) {
            androidx.compose.ui.semantics.s sVar = tVar.a;
            accessibilityEventObtain.setPassword(sVar.d.e.c(androidx.compose.ui.semantics.w.K));
            Object objG = sVar.d.e.g(androidx.compose.ui.semantics.w.n);
            if (objG == null) {
                objG = null;
            }
            boolean zA = kotlin.jvm.internal.l.a(objG, Boolean.TRUE);
            if (Build.VERSION.SDK_INT >= 34) {
                androidx.compose.ui.text.android.b.l(accessibilityEventObtain, zA);
            }
        }
    ...
    public final int q(androidx.compose.ui.semantics.s sVar) {
        androidx.compose.ui.semantics.n nVar = sVar.d;
        if (!nVar.e.c(androidx.compose.ui.semantics.w.a)) {
            androidx.compose.ui.semantics.z zVar = androidx.compose.ui.semantics.w.G;
            if (nVar.e.c(zVar)) {
                return (int) (((androidx.compose.ui.text.l0) nVar.d(zVar)).a & 4294967295L);
            }
        }
        return this.R;
    }

    public final int r(androidx.compose.ui.semantics.s sVar) {
        androidx.compose.ui.semantics.n nVar = sVar.d;
        if (!nVar.e.c(androidx.compose.ui.semantics.w.a)) {
            androidx.compose.ui.semantics.z zVar = androidx.compose.ui.semantics.w.G;
            if (nVar.e.c(zVar)) {
                return (int) (((androidx.compose.ui.text.l0) nVar.d(zVar)).a >> 32);
            }
        }
        return this.R;
    }
    ...
    public final androidx.collection.n s() {
        if (this.V) {
            this.V = false;
            u uVar = this.A;
            this.X = androidx.compose.ui.semantics.v.b(uVar.getSemanticsOwner(), o.A);
            if (v()) {
                ...
                xVar2.a();
                androidx.compose.ui.semantics.t tVar = (androidx.compose.ui.semantics.t) zVar.b(-1);
                androidx.compose.ui.semantics.s sVar = tVar != null ? tVar.a : null;
                sVar.getClass();
                ArrayList arrayListB = androidx.compose.ui.semantics.d0.b(sVar, new androidx.compose.animation.e(zVar, 14), new androidx.compose.animation.e(resources, 15), kotlin.collections.q.j(sVar));
                int i = 1;
                int size = arrayListB.size() - 1;
                if (1 <= size) {
                    while (true) {
                        int i2 = ((androidx.compose.ui.semantics.s) arrayListB.get(i - 1)).g;
                        int i3 = ((androidx.compose.ui.semantics.s) arrayListB.get(i)).g;
                        xVar.f(i2, i3);
                        xVar2.f(i3, i2);
                        if (i == size) {
                            break;
    ...
    public final androidx.compose.ui.geometry.c u(androidx.compose.ui.semantics.s sVar, Rect rect, androidx.compose.ui.graphics.n0 n0Var) {
        y yVar = new y(n0Var);
        androidx.compose.ui.node.f0 f0Var = sVar.c;
                ...
                if ((qVar.z & 8) == 0) {
                    ...
                    while (qVarE != null) {
                        if (qVarE instanceof androidx.compose.ui.node.u1) {
                            ((androidx.compose.ui.node.u1) qVarE).n0(yVar);
                            if (yVar.e) {
                                jVar = qVarE;
                                break loop0;
                            }
                        } else if ((qVarE.z & 8) != 0 && (qVarE instanceof androidx.compose.ui.node.k)) {
                            int i = 0;
        ...
        androidx.compose.ui.node.j jVar2 = (androidx.compose.ui.node.u1) jVar;
        if (jVar2 == null || !((androidx.compose.ui.q) jVar2).e.K) {
            return androidx.compose.ui.layout.a0.e((androidx.compose.ui.node.d1) f0Var.d0.e, false);
        }
        androidx.compose.ui.node.d1 d1VarU = androidx.compose.ui.node.l.u(jVar2);
        androidx.compose.ui.geometry.c cVarS = androidx.compose.ui.layout.a0.g(d1VarU).s(d1VarU, true);
