...
public final class a3 implements androidx.lifecycle.t {
    public final /* synthetic */ kotlin.jvm.internal.z A;
    public final /* synthetic */ View B;
    public final /* synthetic */ CoroutineScope e;
    public final /* synthetic */ androidx.compose.runtime.e y;
    public final /* synthetic */ androidx.compose.runtime.y1 z;

    public a3(CoroutineScope coroutineScope, androidx.compose.runtime.e eVar, androidx.compose.runtime.y1 y1Var, kotlin.jvm.internal.z zVar, View view) {
    ...
    public final void g(androidx.lifecycle.v vVar, androidx.lifecycle.n nVar) {
        ...
        boolean z;
        switch (y2.a[nVar.ordinal()]) {
            case 1:
                BuildersKt__Builders_commonKt.launch$default(this.e, null, CoroutineStart.UNDISPATCHED, new z2(this.A, this.z, vVar, this, this.B, null), 1, null);
                return;
            case 2:
                ...
                androidx.compose.runtime.y1 y1Var = this.z;
                ...
                return;
            case 3:
                androidx.compose.runtime.y1 y1Var2 = this.z;
