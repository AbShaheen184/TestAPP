        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        androidx.collection.o0 o0Var = ((androidx.compose.ui.semantics.t) objArr[(i << 3) + i3]).a.d.e;
                        Object objG = o0Var.g(androidx.compose.ui.semantics.w.D);
                        if (objG == null) {
                            objG = null;
                        }
                        if (objG != null) {
                            Object objG2 = o0Var.g(androidx.compose.ui.semantics.m.n);
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        ...
                        if (kotlin.jvm.internal.l.a(objG, Boolean.TRUE)) {
                            Object objG2 = o0Var.g(androidx.compose.ui.semantics.m.m);
