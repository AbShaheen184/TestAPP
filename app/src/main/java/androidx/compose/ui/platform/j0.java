    ...
    public final Object invoke() {
        switch (this.y) {
            ...
            case 4:
                ...
                throw null;
            case 5:
                s0 s0Var = new s0(Looper.myLooper() == Looper.getMainLooper() ? Choreographer.getInstance() : (Choreographer) BuildersKt.runBlocking(Dispatchers.getMain(), new androidx.activity.compose.n(2, 1, null)), coil3.svg.internal.a.e(Looper.getMainLooper()));
