...
public final class r1 implements androidx.compose.ui.node.l1 {
    ...
    public androidx.compose.ui.unit.c H = _COROUTINE.b.a();
    ...
    public r1(androidx.compose.ui.graphics.layer.b bVar, androidx.compose.ui.graphics.y yVar, u uVar, kotlin.jvm.functions.p pVar, kotlin.jvm.functions.a aVar) {
        this.e = bVar;
        this.y = yVar;
        this.z = uVar;
        this.A = pVar;
    ...
    public final float[] b() {
        ...
        if (z) {
            ...
            if ((9223372034707292159L & jR) == 9205357640488583168L) {
                jR = _COROUTINE.b.r(coil3.network.g.F(this.C));
            }
