...
public final class b {
    ...
    public static boolean c(d1 d1Var) {
        l1 l1Var = d1Var.i0;
        return (l1Var == null || a0.r(((r1) l1Var).b())) ? false : true;
    }
    ...
    public static long g(f0 f0Var) {
        ...
        d1 d1Var = (d1) a1Var.e;
        long jC = 0;
        for (d1 d1Var2 = (s) a1Var.d; d1Var2 != null && d1Var2 != d1Var; d1Var2 = d1Var2.N) {
            if (c(d1Var2)) {
  ...
  0x018b: PHI (r3v7 androidx.compose.ui.spatial.d) = (r3v6 androidx.compose.ui.spatial.d), (r3v8 androidx.compose.ui.spatial.d) binds: [B:72:0x0189, B:74:0x018d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final void a() {
        ...
        if (this.e) {
            ...
            if (z) {
                ...
                if (dVar3 != null) {
                    while (dVar3 != null) {
                        f0 f0VarV = l.v(dVar3.b);
                        long jB = ((u) i0.a(f0VarV)).getRectManager().b(f0VarV);
                        long j19 = f0VarV.B;
                        dVar3.e = jB;
        ...
        if (z) {
            ...
            if (dVar3 != null) {
                while (dVar3 != null) {
                    f0 f0VarV2 = l.v(dVar3.b);
                    long jB2 = ((u) i0.a(f0VarV2)).getRectManager().b(f0VarV2);
                    long j110 = f0VarV2.B;
                    dVar3.e = jB2;
    ...
    public final void f(f0 f0Var, boolean z) {
        ...
        if (zI) {
            ...
            int iG0 = v0Var.g0();
            int iD0 = v0Var.d0();
            long j2 = (((long) iG0) << 32) | (((long) iD0) & 4294967295L);
            int i4 = f0Var.y;
            boolean z2 = f0Var.E;
            x xVar = this.a;
            if (!z2) {
                ...
                if (f0VarV != null) {
                    ...
                    while (i11 < jArr.length - 2 && i11 < i10) {
                        ...
                        if ((((int) jArr2[i11 + 2]) & i12) == i5) {
                            ...
                            int i14 = ((int) j3) + i7;
                            xVar.m(i9, i13, i14, i13 + iG0, i14 + iD0, i5, zF, zF2, zA, i11);
                            break;
                        }
                        jArr = jArr2;
                        i11 += 3;
                    ...
                    xVar.m(i4, i15, i16, i15 + iG0, i16 + iD0, (512 & 32) != 0 ? -1 : 0, zF, zF2, zA, -1);
                }
                this.d = true;
            } else if (z || !j.a(jC, f0Var.A) || !androidx.compose.ui.unit.l.a(j2, f0Var.B)) {
                if (f0VarV != null) {
                    int i17 = f0VarV.y;
                    int i18 = (int) (jC >> 32);
