...
public final class d {
    ...
    public final void a(long j, long j2, long j3, long j4, float[] fArr) {
        ...
        d1 d1VarT = l.t(eVar, 2);
        f0 f0VarV = l.v(eVar);
        boolean zI = f0VarV.I();
        a1 a1Var = f0VarV.d0;
        if (zI) {
            if (((d1) a1Var.e) != d1VarT) {
                long jFloatToRawIntBits = (((long) Float.floatToRawIntBits((int) (j & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits((int) (j >> 32)) << 32);
                long j6 = d1VarT.z;
                d1 d1Var = (d1) a1Var.e;
                d1Var.getClass();
                long jF = t.F(d1Var.D(d1VarT, jFloatToRawIntBits));
                cVar = new c(jF, (4294967295L & ((long) (((int) (jF & 4294967295L)) + ((int) (j6 & 4294967295L))))) | (((long) (((int) (jF >> 32)) + ((int) (j6 >> 32)))) << 32), j3, j4, j5, fArr, eVar);
            } else {
    ...
    public final void b() {
        ...
        if (dVar != null) {
            if (dVar.equals(this)) {
                ...
                this.d = null;
                if (dVar2 == null) {
                    f0 f0VarV = l.v(this.b.e);
                    if (f0VarV.E) {
                        ((u) i0.a(f0VarV)).getRectManager().a.s(f0VarV.y, false);
                        return;
                    }
                    return;
                }
