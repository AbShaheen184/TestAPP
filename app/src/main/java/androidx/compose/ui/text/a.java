...
public final class a {
    ...
    public a(androidx.compose.ui.text.platform.d dVar, int i, int i2, long j) {
        ...
        if (i2 == 2) {
            i3 = 0;
            if (!androidx.compose.ui.unit.o.a(m0Var.a.h, coil3.svg.internal.a.x(0)) && !androidx.compose.ui.unit.o.a(m0Var.a.h, androidx.compose.ui.unit.o.c) && (i13 = m0Var.b.a) != 0 && i13 != 5 && i13 != 4 && charSequence3.length() != 0) {
                ...
                boolean zP = okhttp3.internal.platform.android.g.p(spannable, androidx.compose.ui.text.android.style.c.class);
    ...
    public final long c(androidx.compose.ui.geometry.c cVar, int i, androidx.compose.ui.graphics.a aVar) {
        ...
        int i3 = (i != 0 && i == 1) ? 1 : 0;
        androidx.compose.animation.core.g0 g0Var = new androidx.compose.animation.core.g0(aVar, 16);
        androidx.compose.ui.text.android.l lVar = this.d;
        Layout layout = lVar.f;
        int i4 = Build.VERSION.SDK_INT;
        if (i4 >= 34) {
            iArrG = androidx.compose.ui.text.android.b.g(lVar, rectFX, i3, g0Var);
        } else {
            androidx.compose.runtime.internal.c cVarC = lVar.c();
            if (i3 == 1) {
                bVar = new androidx.compose.foundation.text.input.internal.o(20, layout.getText(), lVar.j());
            } else {
                CharSequence text = layout.getText();
            ...
            if (rectFX.top <= lVar.e(lineForVertical) || (lineForVertical = lineForVertical + 1) < lVar.g) {
                ...
                if (lineForVertical2 != 0 || rectFX.bottom >= lVar.g(0)) {
                    int iQ = _COROUTINE.a.Q(lVar, layout, cVarC, i5, rectFX, dVar, g0Var, true);
                    while (true) {
                        i2 = i5;
                        ...
                        i5 = i2 + 1;
                        iQ = _COROUTINE.a.Q(lVar, layout, cVarC, i5, rectFX, dVar, g0Var, true);
                    }
                    if (iQ == -1) {
                        iArrG = null;
                    } else {
                        int i6 = lineForVertical2;
                        int iQ2 = _COROUTINE.a.Q(lVar, layout, cVarC, i6, rectFX, dVar, g0Var, false);
                        while (iQ2 == -1 && i2 < i6) {
                            i6--;
                            iQ2 = _COROUTINE.a.Q(lVar, layout, cVarC, i6, rectFX, dVar, g0Var, false);
                        }
                        if (iQ2 == -1) {
                            iArrG = null;
                        } else {
                            iArrG = new int[]{dVar.g(iQ + 1), dVar.i(iQ2 - 1)};
                        }
                    }
                } else {
                    iArrG = null;
        ...
        return iArrG == null ? l0.b : d0.b(iArrG[0], iArrG[1]);
    }
