...
public final class h {
    ...
    public final CharSequence b() {
        ...
        if (charSequence2 instanceof Spanned) {
            ...
            if (okhttp3.internal.platform.android.g.p(spanned, CharacterStyle.class)) {
    ...
    public final float c() {
        ...
        if (fCeil != 0.0f) {
            ...
            if (charSequence instanceof Spanned) {
                ...
                if (okhttp3.internal.platform.android.g.p(spanned, androidx.compose.ui.text.android.style.f.class) || okhttp3.internal.platform.android.g.p(spanned, androidx.compose.ui.text.android.style.e.class)) {
                    fCeil += 0.5f;
