...
import com.caverock.androidsvg.j0;
...
public class e implements j0 {
    ...
    public float C() {
        o oVar = (o) this.e;
        float fA = oVar.a(this.b, this.c, (String) this.d);
        if (!Float.isNaN(fA)) {
            this.b = oVar.a;
        }
        return fA;
    ...
    public c0 D() {
        ...
        int iH = H();
        return iH == 0 ? new c0(1, fC) : new c0(iH, fC);
    }
    ...
    public int H() {
        ...
        try {
            int iM = b0.m(str.substring(i, i + 2).toLowerCase(Locale.US));
            this.b += 2;
            return iM;
    ...
    public void r(j0 j0Var) {
        ...
        for (int i2 = 0; i2 < this.b; i2++) {
            ...
            if (b == 0) {
                ...
                j0Var.c(fArr3[i], fArr3[i + 1], fArr3[i + 2], fArr3[i + 3], fArr3[i + 4], fArr3[i + 5]);
                i += 6;
            } else if (b == 3) {
                ...
                float f5 = fArr4[i + 2];
                i += 4;
                j0Var.a(f3, f4, f5, fArr4[i5]);
            } else if (b != 8) {
                boolean z = (b & 2) != 0;
                boolean z2 = (b & 1) != 0;
                float[] fArr5 = (float[]) this.e;
                j0Var.d(fArr5[i], fArr5[i + 1], fArr5[i + 2], z, z2, fArr5[i + 3], fArr5[i + 4]);
                i += 5;
            } else {
                j0Var.close();
            }
    ...
    public boolean u(int i) {
        ...
        return android.support.v4.media.session.b.v(Character.codePointBefore((CharSequence) this.d, i));
    }
    ...
    public boolean y(int i) {
        ...
        return android.support.v4.media.session.b.v(Character.codePointAt((CharSequence) this.d, i));
    }
    ...
    public e(int i, int i2, float[] fArr, float[] fArr2) {
        this.a = 3;
        this.b = i;
        _COROUTINE.a.o(((long) fArr.length) * 2 == ((long) fArr2.length) * 3);
        this.d = fArr;
        this.e = fArr2;
        this.c = i2;
    }
    ...
    public e(e eVar) {
        ...
        this.d = androidx.media3.common.util.b.d(fArr);
        this.e = androidx.media3.common.util.b.d((float[]) eVar.e);
        int i = eVar.c;
        if (i == 1) {
            this.c = 5;
        } else if (i != 2) {
