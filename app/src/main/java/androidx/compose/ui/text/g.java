...
public final class g implements CharSequence {
    ...
    public g(List list, String str) {
        ...
        this.z = arrayList;
        this.A = arrayList2;
        List listW = arrayList2 != null ? kotlin.collections.p.W(arrayList2, new f(i)) : null;
        if (listW == null || listW.isEmpty()) {
            return;
        }
        int i3 = ((e) kotlin.collections.p.B(listW)).c;
    ...
    public /* synthetic */ g(String str) {
        this(str, kotlin.collections.w.e);
    }
