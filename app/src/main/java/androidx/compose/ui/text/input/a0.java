...
public final class a0 implements s {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (tVar2 != null) {
                ...
                if (tVar2.h) {
                    tVar2.d = xVar3;
                    if (tVar2.f) {
                        ((InputMethodManager) c2Var3.z.getValue()).updateExtractedText((View) c2Var3.y, tVar2.e, com.google.firebase.b.X(xVar3));
                    }
                    l0 l0Var3 = xVar3.c;
                    long j = xVar3.b;
    ...
    public final void h(androidx.compose.ui.geometry.c cVar) {
        Rect rect;
        this.k = new Rect(kotlin.math.a.H(cVar.a), kotlin.math.a.H(cVar.b), kotlin.math.a.H(cVar.c), kotlin.math.a.H(cVar.d));
