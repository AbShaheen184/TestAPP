    ...
    public final void a() {
        ...
        if (inputMethodManager.isActive(view)) {
            ...
            if (z && iF >= 0) {
                ...
                float fC = i0.c(cVarC.a, 0.0f, (int) (j0Var.c >> 32));
                boolean zD = coil3.svg.internal.a.d(cVar, fC, cVarC.b);
                boolean zD2 = coil3.svg.internal.a.d(cVar, fC, cVarC.d);
                ...
                float f = cVarC.b;
                float f2 = cVarC.d;
                builder.setInsertionMarkerLocation(fC, f, f2, f2, i);
            }
            if (z2) {
                ...
                if (iF2 >= 0 && iF2 < iE) {
                    ...
                    while (iF2 < iE) {
                        ...
                        if (!coil3.svg.internal.a.d(cVar, f3, f4) || !coil3.svg.internal.a.d(cVar, f5, f6)) {
                            i5 |= 2;
                        }
                        if (j0Var.a(iV4) == jVar) {
                            i5 |= 4;
