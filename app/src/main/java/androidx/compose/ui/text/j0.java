...
public final class j0 {
    ...
    public j0(i0 i0Var, n nVar, long j) {
        ...
        if (!arrayList.isEmpty()) {
            p pVar = (p) kotlin.collections.p.J(arrayList);
    ...
    public final androidx.compose.ui.text.style.j a(int i) {
        ...
        ArrayList arrayList = nVar.h;
        p pVar = (p) arrayList.get(i == length ? kotlin.collections.q.h(arrayList) : d0.d(i, arrayList));
    ...
    public final androidx.compose.ui.graphics.j h(int i, int i2) {
        ...
        d0.g(nVar.h, d0.b(i, i2), new androidx.compose.foundation.layout.n0(i, i2, 3, jVarA));
        return jVarA;
    }

    public final int hashCode() {
        return this.f.hashCode() + androidx.privacysandbox.ads.adservices.java.internal.a.c(this.e, androidx.privacysandbox.ads.adservices.java.internal.a.c(this.d, androidx.privacysandbox.ads.adservices.java.internal.a.e((this.b.hashCode() + (this.a.hashCode() * 31)) * 31, 31, this.c), 31), 31);
    }
