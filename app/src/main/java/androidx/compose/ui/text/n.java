...
public final class n {
    ...
    public n(androidx.compose.runtime.internal.c cVar, long j, int i, int i2) {
        ...
        while (true) {
            ...
            if (!lVar.d) {
                if (i7 == this.b) {
                    i4 = i3;
                    if (i4 != kotlin.collections.q.h((ArrayList) this.a.B)) {
                    }
                } else {
                    i4 = i3;
                }
        ...
        for (int i8 = 0; i8 < size2; i8++) {
            ...
            kotlin.collections.p.t(arrayList3, arrayList4);
        }
        if (arrayList3.size() < ((List) this.a.z).size()) {
            ...
            arrayList3 = kotlin.collections.p.O(arrayList3, arrayList5);
        }
        this.g = arrayList3;
    }
    ...
    public final int d(int i) {
        ...
        ArrayList arrayList = this.h;
        if (i >= length) {
            iD = kotlin.collections.q.h(arrayList);
        } else {
    ...
    public final long h(androidx.compose.ui.geometry.c cVar, int i, androidx.compose.ui.graphics.a aVar) {
        ...
        float f3 = cVar.d;
        if (f2 >= f3 || iF == kotlin.collections.q.h(arrayList)) {
