...
public final class a extends w0 {
    ...
    public final androidx.compose.foundation.text.input.internal.o q(f1 f1Var, androidx.compose.foundation.text.input.internal.o oVar) {
        switch (this.A) {
            case 0:
                androidx.compose.ui.node.s sVar = (androidx.compose.ui.node.s) ((w) this.B).W.d0.d;
                if (!sVar.o0.K) {
                    return oVar;
                }
                ...
                int i7 = i6 >= 0 ? i6 : 0;
                return (i == 0 && i2 == 0 && i5 == 0 && i7 == 0) ? oVar : new androidx.compose.foundation.text.input.internal.o(26, h.l((androidx.core.graphics.c) oVar.y, i, i2, i5, i7), h.l((androidx.core.graphics.c) oVar.z, i, i2, i5, i7));
            default:
                androidx.compose.ui.window.v vVar = (androidx.compose.ui.window.v) this.B;
                if (vVar.I) {
                    return oVar;
                ...
                int i10 = cVarB.c;
                int i11 = cVarB.d;
                return new androidx.compose.foundation.text.input.internal.o(26, z1.b(cVar, i8, i9, i10, i11), z1.b((androidx.core.graphics.c) oVar.z, i8, i9, i10, i11));
        }
    }
}
