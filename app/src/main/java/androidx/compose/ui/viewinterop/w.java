...
public final class w extends h {
    ...
    public androidx.compose.runtime.saveable.f c0;
    public kotlin.jvm.functions.l d0;
    public kotlin.jvm.functions.l e0;
    public kotlin.jvm.functions.l f0;

    public w(Context context, kotlin.jvm.functions.l lVar, androidx.compose.runtime.q qVar, androidx.compose.runtime.saveable.g gVar, int i, m1 m1Var) {
        ...
        super(context, qVar, i, dVar, view, m1Var);
        this.a0 = view;
        this.b0 = dVar;
        ...
        if (gVar != null) {
            setSavableRegistryEntry(gVar.d(strValueOf, new g(this, 2)));
        }
        b bVar = b.C;
        this.d0 = bVar;
        this.e0 = bVar;
    ...
    private final void setSavableRegistryEntry(androidx.compose.runtime.saveable.f fVar) {
        androidx.compose.runtime.saveable.f fVar2 = this.c0;
        if (fVar2 != null) {
            ((c2) fVar2).e0();
        }
        this.c0 = fVar;
