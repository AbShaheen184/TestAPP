...
public final class a {
    ...
    public final float h(h hVar, boolean z) {
        int i = this.h;
        if (i == -1) {
            return 0.0f;
        }
    ...
    public final String toString() {
        ...
        String string = "";
        for (int i2 = 0; i != -1 && i2 < this.a; i2++) {
            StringBuilder sbP = j.p(string.concat(" -> "));
            sbP.append(this.g[i]);
            sbP.append(" : ");
            StringBuilder sbP2 = j.p(sbP.toString());
            sbP2.append(((h[]) this.c.A)[this.e[i]]);
