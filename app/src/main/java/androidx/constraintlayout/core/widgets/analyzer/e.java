...
public final class e {
    ...
    public e(androidx.room.a aVar, androidx.emoji2.text.g gVar, t0 t0Var) {
        int i;
        Object eVar;
        this.a = 1;
        q qVar = aVar.g;
        androidx.sqlite.db.a aVar2 = aVar.c;
        androidx.sqlite.b bVar = aVar.p;
        String str = aVar.b;
        this.d = aVar;
        this.e = gVar;
        Object obj = aVar.e;
        this.f = obj == null ? w.e : obj;
        if (bVar != null) {
            this.h = null;
            if (bVar.m()) {
                eVar = new androidx.room.coroutines.q(new androidx.localbroadcastmanager.content.b(this, bVar), str == null ? ":memory:" : str, t0Var);
            } else if (str == null) {
                eVar = new androidx.room.coroutines.e(new androidx.localbroadcastmanager.content.b(this, bVar));
            } else {
                androidx.localbroadcastmanager.content.b bVar2 = new androidx.localbroadcastmanager.content.b(this, bVar);
                int iOrdinal = qVar.ordinal();
                if (iOrdinal == 1) {
                    i = 1;
                } else {
                    if (iOrdinal != 2) {
                        com.google.firebase.platforminfo.b.r(qVar, "Can't get max number of reader for journal mode '");
                        throw null;
                    }
                    i = 4;
                }
                int iOrdinal2 = qVar.ordinal();
                if (iOrdinal2 != 1 && iOrdinal2 != 2) {
                    com.google.firebase.platforminfo.b.r(qVar, "Can't get max number of writers for journal mode '");
                    throw null;
                }
                eVar = new androidx.room.coroutines.e(bVar2, str, i);
            }
            this.g = eVar;
        } else {
            if (aVar2 == null) {
                kotlinx.coroutines.future.a.q("SQLiteManager was constructed with both null driver and open helper factory!");
                throw null;
            }
            Context context = aVar.a;
            context.getClass();
            androidx.sqlite.db.b bVarD = aVar2.d(new l0(context, str, new androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.l(this, gVar.a), false, false));
            this.h = bVarD;
            this.g = new androidx.room.coroutines.q(new androidx.media3.exoplayer.hls.c(bVarD), str == null ? ":memory:" : str, t0Var);
        }
        boolean z = qVar == q.z;
        androidx.sqlite.db.b bVar3 = (androidx.sqlite.db.b) this.h;
        if (bVar3 != null) {
            bVar3.setWriteAheadLoggingEnabled(z);
        }
    }
    ...
    public static final void a(e eVar, androidx.sqlite.a aVar) throws Throwable {
        ...
        q qVar2 = q.z;
        if (qVar == qVar2) {
            t1.t(aVar, "PRAGMA journal_mode = WAL");
        } else {
            t1.t(aVar, "PRAGMA journal_mode = TRUNCATE");
        }
        if (aVar2.g == qVar2) {
            t1.t(aVar, "PRAGMA synchronous = NORMAL");
        } else {
            t1.t(aVar, "PRAGMA synchronous = FULL");
        }
        ...
        try {
            ...
            if (i != i2) {
                ...
                try {
                    ...
                    t1.t(aVar, "PRAGMA user_version = " + i2);
                    lVar = y.a;
                } catch (Throwable th) {
    ...
    public static void f(androidx.sqlite.a aVar) {
        ...
        try {
            ...
            kotlin.collections.q.e(cVarU, null);
            if (j < 3000) {
                t1.t(aVar, "PRAGMA busy_timeout = 3000");
            }
        } catch (Throwable th) {
            try {
                throw th;
    ...
    public void j(androidx.sqlite.a aVar) {
        ...
        try {
            ...
            if (!z) {
                v vVarZ = gVar.z(aVar);
                if (!vVarZ.c) {
                    androidx.media3.exoplayer.source.t0.h(vVarZ.b, "Pre-packaged database has an invalid schema: ");
                    return;
                }
            }
            m(aVar);
    ...
    /* JADX WARN: Code duplicated, block: B:128:0x00a4 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:129:0x00a4 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:132:? A[LOOP:4: B:10:0x002a->B:132:?, LOOP_END, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:134:0x00a1 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:135:0x008c A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:138:0x0085 A[SYNTHETIC] */
    ...
    public void k(androidx.sqlite.a aVar, int i, int i2) {
        ...
        if (iterable != null) {
            ...
            while (it2.hasNext()) {
                ((androidx.room.migration.a) it2.next()).a(aVar);
            }
            v vVarZ = gVar.z(aVar);
            if (!vVarZ.c) {
                androidx.media3.exoplayer.source.t0.h(vVarZ.b, "Migration didn't properly handle: ");
                return;
            } else {
                gVar.x(aVar);
                m(aVar);
        ...
        if (i <= i2 || !aVar2.k) {
            Set set = aVar2.l;
            if (aVar2.j && (set == null || !set.contains(Integer.valueOf(i)))) {
                z3 = true;
            }
        }
        if (z3) {
        ...
        if (aVar2.o) {
            ...
            try {
                ...
                while (cVarU.Q()) {
                    ...
                    if (!r.u(strF, "sqlite_", false) && !strF.equals("android_metadata")) {
                        bVarG.add(new kotlin.k(strF, Boolean.valueOf(kotlin.jvm.internal.l.a(cVarU.F(1), "view"))));
                    }
                }
                ...
                while (true) {
                    ...
                    if (((Boolean) kVar2.y).booleanValue()) {
                        t1.t(aVar, "DROP VIEW IF EXISTS `" + str + '`');
                    } else {
                        t1.t(aVar, "DROP TABLE IF EXISTS `" + str + '`');
                    }
                }
            } catch (Throwable th) {
                try {
            ...
            if (z) {
                ...
                try {
                    ...
                    try {
                        ...
                        kotlin.collections.q.e(cVarU2, th);
                        throw th2;
                    }
                }
            } else {
                ...
                try {
                    v vVarZ = gVar.z(aVar);
                    if (!vVarZ.c) {
                        throw new IllegalStateException(("Pre-packaged database has an invalid schema: " + vVarZ.b).toString());
                    }
                    gVar.x(aVar);
                    m(aVar);
                    lVar = y.a;
    ...
    public void m(androidx.sqlite.a aVar) {
        ...
        t1.t(aVar, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '" + ((String) ((androidx.emoji2.text.g) this.e).b) + "')");
    }
    ...
    public String toString() {
        switch (this.a) {
            case 2:
                ...
                return p.I(arrayList, ", ", "FileMetadata(", ")", null, 56);
            default:
    ...
    public e(androidx.room.a aVar, androidx.navigation.compose.r rVar, t0 t0Var) {
        this.a = 1;
        this.d = aVar;
        this.e = new androidx.room.n("", -1, "");
        List list = aVar.e;
        w wVar = w.e;
        this.f = list == null ? wVar : list;
        p.N(list == null ? wVar : list, new androidx.room.o(new s2(this, 9)));
        Context context = aVar.a;
        androidx.collection.internal.b bVar = aVar.d;
    ...
    public /* synthetic */ e(boolean z, boolean z2, x xVar, Long l, Long l2, Long l3, Long l4) {
        this(z, z2, xVar, l, l2, l3, l4, kotlin.collections.x.e);
        this.a = 2;
    }
}
