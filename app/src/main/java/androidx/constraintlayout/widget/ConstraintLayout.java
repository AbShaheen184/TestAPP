...
public class ConstraintLayout extends ViewGroup {
    ...
    public final void j(int i) {
        String str;
        Context context = getContext();
        androidx.compose.foundation.text.input.internal.o oVar = new androidx.compose.foundation.text.input.internal.o(24, false);
        ...
        if (size6 > 0) {
            ...
            while (i34 < size6) {
                ...
                if (dVar5 instanceof androidx.constraintlayout.core.widgets.g) {
                    ...
                    z3 = z12;
                    fVar3 = fVar;
                    boolean zP = z13 | c2Var.P(1, dVar5, fVar3);
                    int iN7 = dVar5.n();
                    boolean z14 = zP;
                    int iK8 = dVar5.k();
                    if (iN7 != iN6) {
                ...
                while (i36 < size6) {
                    ...
                    if ((!(dVar6 instanceof androidx.constraintlayout.core.widgets.i) || (dVar6 instanceof androidx.constraintlayout.core.widgets.g)) && !(dVar6 instanceof androidx.constraintlayout.core.widgets.h)) {
                        ...
                        if (dVar6.f0 != 8 && ((!z2 || !dVar6.d.e.j || !dVar6.e.e.j) && !(dVar6 instanceof androidx.constraintlayout.core.widgets.g))) {
                            ...
                            i9 = i36;
                            int i37 = dVar6.Z;
                            zP2 |= c2Var.P(i35 == 1 ? 2 : 1, dVar6, fVar7);
                            fVar2 = fVar7;
                            int iN9 = dVar6.n();
                            i10 = i35;
                            int iK10 = dVar6.k();
