...
public abstract class c extends View {
    public androidx.constraintlayout.core.widgets.i A;
    public String B;
    public String C;
    public HashMap D;
    public int[] e;
    ...
    public final void a(String str) {
        ...
        if (!isInEditMode() || constraintLayout == null) {
            ...
            Object obj = (strTrim == null || (map = constraintLayout.J) == null || !map.containsKey(strTrim)) ? null : constraintLayout.J.get(strTrim);
        ...
        if (identifier != 0) {
            this.D.put(Integer.valueOf(identifier), strTrim);
            b(identifier);
        } else {
    ...
    public int[] getReferencedIds() {
        return Arrays.copyOf(this.e, this.y);
    }

    public abstract void h(androidx.constraintlayout.core.widgets.d dVar, boolean z);
