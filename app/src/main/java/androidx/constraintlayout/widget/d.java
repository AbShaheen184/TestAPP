...
public abstract class d {
    ...
    static {
        ...
        sparseIntArray.append(Token.ASSIGN_BITXOR, 49);
        sparseIntArray.append(Token.ASSIGN_BITAND, 50);
        ...
        sparseIntArray.append(Token.ASSIGN_URSH, 21);
        sparseIntArray.append(110, 22);
        sparseIntArray.append(Token.ASSIGN_ADD, 23);
        sparseIntArray.append(Token.ASSIGN_LSH, 24);
        sparseIntArray.append(Token.ASSIGN_SUB, 25);
        sparseIntArray.append(Token.ASSIGN_RSH, 26);
        sparseIntArray.append(Token.ASSIGN_LOGICAL_AND, 55);
        sparseIntArray.append(Token.ASSIGN_DIV, 54);
        ...
        sparseIntArray.append(Token.ASSIGN_LOGICAL_OR, 35);
        ...
        sparseIntArray.append(Token.ASSIGN_EXP, 66);
    }
}
