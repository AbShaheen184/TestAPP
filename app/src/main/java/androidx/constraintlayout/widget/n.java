                    ...
                    if (map2.containsKey(Integer.valueOf(id))) {
                        ...
                        if (iVar != null) {
                            ...
                            for (String str2 : map3.keySet()) {
                                ...
                                String strI = !bVar.a ? androidx.compose.runtime.j.i("set", str2) : str2;
                                int i3 = i2;
                                try {
                                    ...
                                    switch (iE) {
                                        case 0:
                                            map = map3;
                                            cls.getMethod(strI, cls3).invoke(childAt, Integer.valueOf(bVar.c));
                                            break;
                                        case 1:
                                            map = map3;
                                            cls.getMethod(strI, cls2).invoke(childAt, Float.valueOf(bVar.d));
                                            break;
                                        case 2:
                                            map = map3;
                                            cls.getMethod(strI, cls3).invoke(childAt, Integer.valueOf(bVar.g));
                                            break;
                                        case 3:
                                            ...
                                            break;
                                        case 4:
                                            cls.getMethod(strI, CharSequence.class).invoke(childAt, bVar.e);
                                            map = map3;
                                            break;
                                        case 5:
                                            cls.getMethod(strI, Boolean.TYPE).invoke(childAt, Boolean.valueOf(bVar.f));
                                            map = map3;
                                            break;
                                        case 6:
                                            cls.getMethod(strI, cls2).invoke(childAt, Float.valueOf(bVar.d));
