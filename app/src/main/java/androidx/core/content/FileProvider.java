...
public class FileProvider extends ContentProvider {
    ...
    public static Uri d(Context context, String str, File file) {
        ...
        try {
            ...
            if (entry == null) {
                kotlinx.coroutines.future.a.q(j.i("Failed to find configured root that contains ", canonicalPath));
                return null;
            }
            ...
            b.f(file, "Failed to resolve canonical path for ");
            return null;
        }
    }
    ...
    public static a e(Context context, String str) throws XmlPullParserException, IOException {
        ...
        if (providerInfoResolveContentProvider == null) {
            kotlinx.coroutines.future.a.q(j.i("Couldn't find meta-data for provider with authority ", str));
            return null;
        }
        ...
        if (xmlResourceParserLoadXmlMetaData == null) {
            kotlinx.coroutines.future.a.q("Missing android.support.FILE_PROVIDER_PATHS meta-data");
            return null;
        }
        while (true) {
            ...
            if (next == 2) {
                ...
                if (externalStorageDirectory == null) {
                    ...
                    if (TextUtils.isEmpty(attributeValue)) {
                        kotlinx.coroutines.future.a.q("Name must not be empty");
                        return null;
                    }
                    try {
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) {
        ...
        if ("r".equals(str)) {
            ...
            if (!"rwt".equals(str)) {
                kotlinx.coroutines.future.a.q(j.i("Invalid mode: ", str));
                return null;
            }
            i = 1006632960;
        }
