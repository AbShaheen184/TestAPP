            ...
            if (typeface != null) {
                ...
                try {
                    if (string.toLowerCase().endsWith(".xml")) {
                        ...
                        Typeface typefaceM = androidx.core.graphics.f.a.m(context, resources, i, string, i2);
                        if (typefaceM != null) {
                            uVar.l(androidx.core.graphics.f.b(resources, i, string, i4, i2), typefaceM);
                        }
                        if (bVar != null) {
                            if (typefaceM != null) {
                                new Handler(Looper.getMainLooper()).post(new androidx.activity.c(2, bVar, typefaceM));
                            } else {
                                bVar.a(-3);
                            }
                        }
