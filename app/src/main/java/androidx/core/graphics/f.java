...
public abstract class f {
    public static final _COROUTINE.b a;
    public static final u b;
    public static Paint c;

    static {
        Trace.beginSection(kotlin.math.a.S("TypefaceCompat static init"));
    ...
    public static Typeface a(Context context, androidx.core.content.res.d dVar, Resources resources, int i, String str, int i2, int i3, androidx.core.content.res.b bVar, boolean z) {
        ...
        if (dVar instanceof androidx.core.content.res.g) {
            ...
            if (!z2) {
                ...
                if (arrayList2.size() > 1) {
                    kotlinx.coroutines.future.a.q("Fallbacks with blocking fetches are not supported for performance reasons");
                    return null;
                }
                androidx.core.provider.d dVar4 = (androidx.core.provider.d) arrayList2.get(0);
                ...
                if (typeface2 != null) {
                    lVar.execute(new k0(i4, dVar3, typeface2));
                    typefaceJ = typeface2;
                } else if (i10 == -1) {
                    Object[] objArr = {dVar4};
                    ArrayList arrayList6 = new ArrayList(1);
                    Object obj2 = objArr[0];
                    androidx.core.provider.g gVarB = androidx.core.provider.h.b(strA2, context, androidx.compose.runtime.j.r(obj2, arrayList6, obj2, arrayList6), i3);
                    oVar.p(gVarB);
                    typefaceJ = gVarB.a;
                } else {
                    try {
                        try {
                            try {
                                androidx.core.provider.g gVar2 = (androidx.core.provider.g) androidx.core.provider.h.b.submit(new androidx.core.provider.e(strA2, context, dVar4, i3, 0)).get(i10, TimeUnit.MILLISECONDS);
                                oVar.p(gVar2);
                                typefaceJ = gVar2.a;
                        ...
                        ((androidx.core.provider.l) oVar.z).execute(new androidx.core.provider.a((com.google.firebase.platforminfo.d) oVar.y, i5, i7));
                    }
                }
            }
        } else {
            typefaceJ = a.j(context, (androidx.core.content.res.e) dVar, resources, i3);
            if (bVar != null) {
                if (typefaceJ != null) {
                    new Handler(Looper.getMainLooper()).post(new androidx.activity.c(i4, bVar, typefaceJ));
                } else {
                    bVar.a(-3);
                }
            }
        ...
        if (typefaceJ != null) {
            b.l(b(resources, i, str, i2, i3), typefaceJ);
        }
        return typefaceJ;
    }
