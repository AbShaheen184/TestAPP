...
public abstract class h {
    ...
    public static g b(String str, Context context, List list, int i) {
        ...
        Typeface typefaceK;
        u uVar = a;
        Trace.beginSection(kotlin.math.a.S("getFontSync"));
        try {
            ...
            try {
                ...
                if (list2.size() <= 1 || Build.VERSION.SDK_INT < 29) {
                    ...
                    try {
                        typefaceK = androidx.core.graphics.f.a.k(context, iVarArr2, i);
                        Trace.endSection();
                    } catch (Throwable th) {
                        Trace.endSection();
                        throw th;
                    ...
                    Trace.beginSection(kotlin.math.a.S("TypefaceCompat.createFromFontInfoWithFallback"));
                    try {
                        typefaceK = androidx.core.graphics.f.a.l(context, list2, i);
                        Trace.endSection();
                    } catch (Throwable th2) {
                        Trace.endSection();
                        throw th2;
                ...
                uVar.l(str, typefaceK);
                g gVar4 = new g(typefaceK);
                Trace.endSection();
                return gVar4;
