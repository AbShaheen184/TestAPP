...
public final class b {
    ...
    public final SpannableStringBuilder c(CharSequence charSequence) {
        ...
        boolean zE = fVar.e(charSequence, charSequence.length());
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        boolean zE2 = (zE ? g.b : g.a).e(charSequence, charSequence.length());
        String str2 = "";
        String str3 = c;
        String str4 = b;
        boolean z = this.a;
        ...
        boolean zE3 = (zE ? g.b : g.a).e(charSequence, charSequence.length());
