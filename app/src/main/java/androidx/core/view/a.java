...
public final class a extends View.AccessibilityDelegate {
    ...
    public final AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
        com.app.mlounge.data.music.e eVarB = this.a.b(view);
        if (eVarB != null) {
            return (AccessibilityNodeProvider) eVarB.y;
        }
        return null;
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        int i2 = 0;
        dVar.o(bool != null && bool.booleanValue());
        if (Build.VERSION.SDK_INT >= 28) {
            objValueOf = Boolean.valueOf(n0.b(view));
        } else {
        ...
        dVar.l(bool2 != null && bool2.booleanValue());
        dVar.n(s0.d(view));
        if (i >= 30) {
            tag2 = p0.b(view);
        } else {
        ...
        if (i >= 30) {
            androidx.compose.ui.graphics.layer.i.l(accessibilityNodeInfo, charSequence);
        } else {
                ...
                while (i5 < clickableSpanArr.length) {
                    ...
                    while (true) {
                        if (i6 >= sparseArray2.size()) {
                            iKeyAt = androidx.core.view.accessibility.d.d;
                            androidx.core.view.accessibility.d.d = iKeyAt + 1;
                            break;
                        } else {
        ...
        for (int i7 = 0; i7 < list.size(); i7++) {
            dVar.b((androidx.core.view.accessibility.b) list.get(i7));
        }
    }
