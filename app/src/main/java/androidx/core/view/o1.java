...
public class o1 extends w1 {
    ...
    private j D(View view) {
        ...
        v vVarG = androidx.compose.ui.contentcapture.b.g(display, 0);
        v vVarG2 = androidx.compose.ui.contentcapture.b.g(display, 1);
        v vVarG3 = androidx.compose.ui.contentcapture.b.g(display, 2);
        v vVarG4 = androidx.compose.ui.contentcapture.b.g(display, 3);
        return j.a(point.x, point.y, false, vVarG != null ? vVarG.b : 0, vVarG2 != null ? vVarG2.b : 0, vVarG3 != null ? vVarG3.b : 0, vVarG4 != null ? vVarG4.b : 0);
    }
    ...
    private static List<Rect> E(Rect[][] rectArr, int i) {
        ...
        for (int i2 = 1; i2 <= 512; i2 <<= 1) {
            if ((i & i2) != 0 && (rectArr2 = rectArr[okhttp3.internal.platform.android.g.q(i2)]) != null) {
                if (rectArr3 == null) {
                    rectArr3 = rectArr2;
                } else {
    ...
    private androidx.core.graphics.c J(View view) {
        if (Build.VERSION.SDK_INT >= 30) {
            com.google.firebase.platforminfo.b.n("getVisibleInsets() should not be called on API >= 30. Use WindowInsets.isVisible() instead.");
            return null;
        }
        if (!n) {
            L();
        ...
        if (i != 1) {
            if (i != 2) {
                if (i == 8) {
                    ...
                    cVarL = cVarArr != null ? cVarArr[okhttp3.internal.platform.android.g.q(8)] : null;
                    if (cVarL != null) {
                        return cVarL;
                    }
                    ...
                    if (i == 128) {
                        ...
                        if (hVarH != null) {
                            ...
                            return androidx.core.graphics.c.b(i4 >= 28 ? androidx.arch.core.executor.d.l(hVarH.a) : 0, i4 >= 28 ? androidx.arch.core.executor.d.n(hVarH.a) : 0, i4 >= 28 ? androidx.arch.core.executor.d.m(hVarH.a) : 0, i4 >= 28 ? androidx.arch.core.executor.d.k(hVarH.a) : 0);
                        }
                    }
                }
            } else {
