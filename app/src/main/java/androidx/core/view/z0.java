...
public final class z0 implements View.OnApplyWindowInsetsListener {
    ...
    public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
        ...
        int i17 = cVarI3.d;
        int i18 = cVarI4.d;
        androidx.compose.foundation.text.input.internal.o oVar = new androidx.compose.foundation.text.input.internal.o(26, androidx.core.graphics.c.b(iMin, iMin2, iMin3, Math.min(i17, i18)), androidx.core.graphics.c.b(Math.max(cVarI3.a, cVarI4.a), Math.max(i13, i14), Math.max(i15, i16), Math.max(i17, i18)));
        ...
        if (view != null) {
            ...
            com.google.firebase.platforminfo.b.h("view == null");
        }
        this.b = z1VarD;
        return a1.j(view, windowInsets);
    }
