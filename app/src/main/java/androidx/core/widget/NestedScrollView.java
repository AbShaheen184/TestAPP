...
public class NestedScrollView extends FrameLayout implements q {
    ...
    public final void addView(View view) {
        if (getChildCount() <= 0) {
            ...
            kotlinx.coroutines.future.a.u("ScrollView can host only one direct child");
        }
    }
    ...
    public final void computeScroll() {
        ...
        if (i2 <= 0 || t.r(edgeEffect) == 0.0f) {
            if (i2 < 0 && t.r(edgeEffect2) != 0.0f) {
                float f = height;
                iRound = Math.round(t.x(edgeEffect2, (i2 * 4.0f) / f, 0.5f) * (f / 4.0f));
                if (iRound != i2) {
                    edgeEffect2.finish();
                }
            }
        ...
        iRound = Math.round(t.x(edgeEffect, ((-i2) * 4.0f) / height, 0.5f) * ((-height) / 4.0f));
        if (iRound != i2) {
            edgeEffect.finish();
        }
        i2 -= iRound;
    ...
    public float getVerticalScrollFactorCompat() {
        if (this.a0 == 0.0f) {
            ...
            if (!context.getTheme().resolveAttribute(R.attr.listPreferredItemHeight, typedValue, true)) {
                kotlinx.coroutines.future.a.u("Expected theme to define listPreferredItemHeight.");
                return 0.0f;
            }
    ...
    public final boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (i != 0) {
            ...
            if (gVar.f == source && gVar.g == deviceId && gVar.e == i) {
                ...
                if (i6 >= 34) {
                    Method method = t0.a;
                    scaledMinimumFlingVelocity = androidx.compose.ui.text.android.b.i(viewConfiguration, deviceId2, i, source2);
                } else {
                    Method method2 = t0.a;
                ...
                if (i6 >= 34) {
                    scaledMaximumFlingVelocity = androidx.compose.ui.text.android.b.h(viewConfiguration, deviceId3, i, source3);
                } else {
            ...
            if (Build.VERSION.SDK_INT >= 34) {
                yVelocity = androidx.compose.ui.text.android.b.d(velocityTracker2, i);
            } else if (i == 0) {
        ...
        if (actionMasked != 0) {
            ...
            if (actionMasked == 1) {
                ...
                if (Math.abs(yVelocity) >= this.N) {
                    if (t.r(edgeEffect) != 0.0f) {
                        if (s(edgeEffect, yVelocity)) {
                            edgeEffect.onAbsorb(yVelocity);
                        } else {
                            i(-yVelocity);
                        }
                    } else if (t.r(edgeEffect2) != 0.0f) {
                        int i3 = -yVelocity;
                        if (s(edgeEffect2, i3)) {
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (t.r(edgeEffect) != 0.0f) {
                        fX = -t.x(edgeEffect, -height, x);
                        if (t.r(edgeEffect) == 0.0f) {
                            edgeEffect.onRelease();
                        }
                    } else if (t.r(edgeEffect2) != 0.0f) {
                        fX = t.x(edgeEffect2, height, 1.0f - x);
                        if (t.r(edgeEffect2) == 0.0f) {
                            edgeEffect2.onRelease();
                        }
                    } else {
    ...
    public final int r(int i, int i2, MotionEvent motionEvent, int i3, int i4, boolean z) {
        ...
        if (i9 >= 0) {
            if (i9 > scrollRange && z4) {
                t.x(edgeEffect, i8 / getHeight(), 1.0f - (i3 / getWidth()));
                if (motionEvent != null) {
                    z2 = false;
        ...
        if (z4) {
            t.x(edgeEffect2, (-i8) / getHeight(), i3 / getWidth());
            if (motionEvent != null) {
    ...
    public final boolean s(EdgeEffect edgeEffect, int i) {
        ...
        float fR = t.r(edgeEffect) * getHeight();
    ...
    public final boolean u(MotionEvent motionEvent) {
        ...
        EdgeEffect edgeEffect = this.B;
        if (t.r(edgeEffect) != 0.0f) {
            t.x(edgeEffect, 0.0f, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        ...
        t.x(edgeEffect2, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
