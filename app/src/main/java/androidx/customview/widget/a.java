...
public abstract class a extends androidx.core.view.b {
    ...
    public final boolean m(int i, Rect rect) {
        ...
        if (i == 1 || i == 2) {
            ...
            Collections.sort(arrayList2, new b(z, fVar));
            if (i == 1) {
                i2 = 0;
                ...
                if (i != 2) {
                    kotlinx.coroutines.future.a.q("direction must be one of {FOCUS_FORWARD, FOCUS_BACKWARD}.");
                    return false;
                }
            ...
            if (i != 17 && i != 33 && i != 66 && i != 130) {
                kotlinx.coroutines.future.a.q("direction must be one of {FOCUS_FORWARD, FOCUS_BACKWARD, FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}.");
                return false;
            }
            Rect rect2 = new Rect();
            int i8 = this.I;
            ...
            for (int i9 = 0; i9 < iF2; i9++) {
                ...
                if (dVar3 != dVar2) {
                    fVar.getClass();
                    dVar3.f(rect4);
                    if (coil3.svg.internal.a.A(i, rect2, rect4)) {
                        if (!coil3.svg.internal.a.A(i, rect2, rect3) || coil3.svg.internal.a.b(i, rect2, rect4, rect3)) {
                            rect3.set(rect4);
                            dVar = dVar3;
                        } else if (!coil3.svg.internal.a.b(i, rect2, rect3, rect4)) {
                            int iE = coil3.svg.internal.a.E(i, rect2, rect4);
                            int iF3 = coil3.svg.internal.a.F(i, rect2, rect4);
                            int i10 = (iF3 * iF3) + (iE * 13 * iE);
                            int iE2 = coil3.svg.internal.a.E(i, rect2, rect3);
                            int iF4 = coil3.svg.internal.a.F(i, rect2, rect3);
                            if (i10 < (iF4 * iF4) + (iE2 * 13 * iE2)) {
                                rect3.set(rect4);
                                dVar = dVar3;
                            }
                        }
