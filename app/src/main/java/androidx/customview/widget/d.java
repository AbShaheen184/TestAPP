...
public final class d {
    ...
    public d(Context context, CoordinatorLayout coordinatorLayout, g gVar) {
        if (gVar == null) {
            kotlinx.coroutines.future.a.q("Callback may not be null");
            throw null;
        }
    ...
    public final void b(View view, int i) {
        ...
        if (parent != coordinatorLayout) {
            t0.m(coordinatorLayout, ")", "captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
            return;
        }
        this.r = view;
        this.c = i;
    ...
    public final boolean h(int i, int i2, int i3, int i4) {
        ...
        float f6 = f3 / f4;
        g gVar = this.q;
        overScroller.startScroll(left, top, i5, i6, (int) ((e(i6, i4, gVar.A()) * f6) + (e(i5, i3, gVar.z(view)) * f5)));
        n(2);
        return true;
    }
    ...
    public final boolean o(int i, int i2) {
        ...
        kotlinx.coroutines.future.a.u("Cannot settleCapturedViewAt outside of a call to Callback#onViewReleased");
        return false;
    }
            ...
            for (int i4 = 0; i4 < pointerCount; i4++) {
                ...
                if (i(pointerId3)) {
                    ...
                    if (!z) {
                        ...
                        g gVar = this.q;
                        int iJ = gVar.j(viewG3, ((int) f) + left);
                        int top = viewG3.getTop();
                        int iK = gVar.k(viewG3, ((int) f2) + top);
                        int iZ = gVar.z(viewG3);
                        int iA = gVar.A();
                        if ((iZ == 0 || (iZ > 0 && iJ == left)) && (iA == 0 || (iA > 0 && iK == top))) {
                            break;
                        }
                        Math.abs(f);
                        Math.abs(f2);
