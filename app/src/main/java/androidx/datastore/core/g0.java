...
public final class g0 implements g1 {
    ...
    public g0(File file, x0 x0Var, k0 k0Var, androidx.activity.w wVar) {
        x0Var.getClass();
        k0Var.getClass();
        this.a = file;
        this.b = x0Var;
    ...
    public final Object a(l lVar, kotlin.coroutines.jvm.internal.c cVar) throws Throwable {
        ...
        try {
            ...
            kotlin.a.e(obj);
            if (this.e.get()) {
                kotlinx.coroutines.future.a.u("StorageConnection has already been disposed.");
                return null;
            }
                        ...
                        if (file == 0) {
                            ...
                            if (parentFile != null) {
                                ...
                                if (!parentFile.isDirectory()) {
                                    kotlinx.coroutines.future.a.x(file2, "Unable to create parent directories of ");
                                    return null;
                                }
                            }
                            f0Var.e = yVar;
