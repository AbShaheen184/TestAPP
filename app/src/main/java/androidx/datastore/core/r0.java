...
public final class r0 implements k0 {
    ...
    public r0(kotlin.coroutines.j jVar, File file) {
        jVar.getClass();
        file.getClass();
        this.a = jVar;
        this.b = file;
        Object obj = t0.b;
        this.c = FlowKt.channelFlow(new androidx.compose.animation.b0(file, (kotlin.coroutines.d) null, 25));
        this.d = ".lock";
        this.e = ".version";
                    ...
                    default:
                        ...
                        try {
                            ...
                            try {
                                ...
                                NativeSharedCounter nativeSharedCounter = y0.b;
                                if (nativeSharedCounter != null) {
                                    ...
                                    if (nativeSharedCounter.nativeTruncateFile(fd) == 0) {
                                        ...
                                        if (jNativeCreateSharedCounter >= 0) {
                                            ...
                                            kotlinx.coroutines.future.a.w("Failed to mmap counter file");
                                        }
                                        parcelFileDescriptorOpen.close();
                                        return z0Var;
                                    }
                                    kotlinx.coroutines.future.a.w("Failed to truncate counter file");
                                } else {
                                    kotlinx.coroutines.future.a.u("DataStore failed to load the native library to create SharedCounter.");
                                }
                                z0Var = null;
                                parcelFileDescriptorOpen.close();
                                return z0Var;
    ...
    public final Object a(y yVar) {
        ...
        if (oVar.a()) {
            z0 z0Var = (z0) ((a1) oVar.getValue());
            return new Integer(z0Var.b.nativeIncrementAndGetCounterValue(z0Var.c));
        }
                    ...
                    if (zTryLock) {
                        ...
                        try {
                            try {
                                ...
                                if ((message2 == null || !kotlin.text.r.u(message2, this.f, false)) && ((message = e.getMessage()) == null || !kotlin.text.r.u(message, "Resource deadlock would occur", false))) {
                                    throw e;
                                }
        ...
        try {
            try {
                try {
                    ...
                    p0Var.C = 2;
                    Object objA = j1.a(fileOutputStream, p0Var);
                    if (objA != aVar) {
                        lVar2 = lVar;
                        r9 = r12;
                        r10 = objA;
