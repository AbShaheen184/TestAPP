...
public final class w extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.l {
    ...
    public w(z zVar, kotlin.coroutines.j jVar, kotlin.jvm.functions.p pVar, kotlin.coroutines.d dVar) {
        super(1, dVar);
        this.z = zVar;
        this.B = jVar;
    ...
    public final kotlin.coroutines.d create(kotlin.coroutines.d dVar) {
        switch (this.e) {
            ...
            case 1:
                return new w((z) this.z, (kotlin.coroutines.j) this.B, (kotlin.jvm.functions.p) this.C, dVar);
            default:
            ...
            case 1:
                ...
                if (i2 != 0) {
                    if (i2 == 1) {
                        ...
                        kotlinx.coroutines.future.a.u("Data in DataStore was mutated but DataStore is only compatible with Immutable types.");
                    } else {
                        if (i2 == 3) {
                            Object obj4 = this.A;
                            kotlin.a.e(obj);
                ...
                cVar = (c) obj;
                kotlin.coroutines.j jVar = (kotlin.coroutines.j) this.B;
                ...
                this.A = cVar;
                this.y = 2;
                obj = BuildersKt.withContext(jVar, pVar, this);
                if (obj == aVar2) {
                    return aVar2;
                }
                obj2 = cVar.b;
            ...
            default:
                ...
                if (i3 == 0) {
                    ...
                    try {
                        ...
                        try {
                            x0 x0Var = i0Var.b;
                            i1 i1Var = new i1(fileOutputStream3);
                        ...
                        if (e instanceof FileNotFoundException) {
                            throw com.imsdk.a.E(file.getParent(), (FileNotFoundException) e);
                        }
                        throw e;
                    }
                } else {
                ...
                dagger.internal.d.b(fileOutputStream, null);
                return yVar;
        }
    }
