...
public final class a {
    ...
    public final Map a() {
        ...
        int iJ = c0.j(r.p(setEntrySet, 10));
        if (iJ < 16) {
            iJ = 16;
        }
    ...
    public final void b() {
        if (((AtomicBoolean) this.b.y).get()) {
            kotlinx.coroutines.future.a.u("Do mutate preferences once returned to DataStore.");
        }
    }
    ...
    public final void f(d dVar, Object obj) {
        ...
        if (z) {
            Set setUnmodifiableSet = Collections.unmodifiableSet(p.f0((Set) obj));
