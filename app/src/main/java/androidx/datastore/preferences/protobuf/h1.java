...
public final class h1 extends androidx.room.t {
    ...
    public final String n(byte[] bArr, int i, int i2) throws x {
        int i3;
        byte b;
        int i4;
        byte b2;
                    ...
                    if (b5 < 0) {
                        while (i < i5) {
                            ...
                            if (b < 0) {
                                ...
                                byte b6 = bArr[i3];
                                int i7 = i6 + 1;
                                if (b >= -62 || android.support.v4.media.session.b.u(b6)) {
                                    throw x.a();
                                }
                                ...
                                if (b >= -16) {
                                    ...
                                    byte b8 = bArr[i8];
                                    int i9 = i6 + 1;
                                    if (!android.support.v4.media.session.b.u(b4)) {
                                        if ((((b4 + 112) + (b << 28)) >> 30) != 0 && !android.support.v4.media.session.b.u(b7) && !android.support.v4.media.session.b.u(b8)) {
                                ...
                                byte b9 = bArr[i11];
                                int i12 = i6 + 1;
                                if (!android.support.v4.media.session.b.u(b3) || ((b == -32 && b3 < -96) || ((b == -19 && b3 >= -96) || android.support.v4.media.session.b.u(b9)))) {
                                    throw x.a();
                                }
                ...
                while (i < i5) {
                    ...
                    if (b < 0) {
                        ...
                        if (b >= -16) {
                            ...
                            byte b11 = bArr[i14];
                            int i15 = i6 + 1;
                            if (android.support.v4.media.session.b.u(b3)) {
                            }
                            throw x.a();
                        }
                        if (i3 < i5 - 2) {
                ...
                while (i7 < length) {
                    ...
                    if (cCharAt3 < 128 && i8 < i6) {
                        ...
                        if ((cCharAt3 >= 55296 && 57343 >= cCharAt3) || i8 > i6 - 3) {
                            ...
                            throw new i1(i7 - 1, length);
                        }
                        bArr[i8] = (byte) ((cCharAt3 >>> '\f') | LibretroCore.PSP_SCREEN_WIDTH);
                        int i12 = i8 + 2;
                        ...
                        if ((cCharAt5 >= 55296 && 57343 >= cCharAt5) || j4 > j5 - 3) {
                            ...
                            if (i14 != length2) {
                                ...
                                if (Character.isSurrogatePair(cCharAt5, cCharAt6)) {
                                    ...
                                    g1.j(bArr, j6, (byte) ((codePoint2 >>> 18) | 240));
                                    c2 = 128;
                                    g1.j(bArr, j6 + j2, (byte) (((codePoint2 >>> 12) & 63) | 128));
                                    g1.j(bArr, j6 + 2, (byte) (((codePoint2 >>> 6) & 63) | 128));
                                    g1.j(bArr, j6 + 3, (byte) ((codePoint2 & 63) | 128));
                                    j3 = j6 + 4;
                                    i13 = i14;
                                } else {
                                    i13 = i14;
                            ...
                            throw new i1(i13 - 1, length2);
                        }
                        g1.j(bArr, j4, (byte) ((cCharAt5 >>> '\f') | LibretroCore.PSP_SCREEN_WIDTH));
                        long j7 = j4;
                        g1.j(bArr, j4 + j2, (byte) (((cCharAt5 >>> 6) & 63) | 128));
                        j3 = j7 + 3;
                        g1.j(bArr, j7 + 2, (byte) ((cCharAt5 & '?') | 128));
                        c2 = 128;
                    } else {
                        j2 = j;
                        g1.j(bArr, j4, (byte) ((cCharAt5 >>> 6) | 960));
                        g1.j(bArr, j4 + j2, (byte) ((cCharAt5 & '?') | c));
                        j3 = j4 + 2;
                        c2 = c;
                    }
                    i13++;
