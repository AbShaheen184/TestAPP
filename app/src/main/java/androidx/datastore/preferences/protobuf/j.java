...
public final class j {
    ...
    public final int c;
    public int d;
    public final androidx.datastore.core.i1 e;

    public j(androidx.datastore.core.i1 i1Var, int i) {
        if (i < 0) {
            kotlinx.coroutines.future.a.q("bufferSize must be >= 0");
            throw null;
        }
    ...
    public final void A(String str) throws IOException {
        try {
            ...
            if (i2 > i3) {
                ...
                int iQ = j1.a.q(str, bArr, 0, length);
                D(iQ);
                n(bArr, 0, iQ);
                return;
            }
            ...
            try {
                try {
                    if (i4 == i) {
                        int i6 = i5 + i4;
                        this.d = i6;
                        int iQ2 = j1.a.q(str, bArr2, i6, i3 - i6);
                        this.d = i5;
                        d((iQ2 - i5) - i4);
                        this.d = iQ2;
                    } else {
                        int iA = j1.a(str);
                        d(iA);
                        this.d = j1.a.q(str, bArr2, this.d, iA);
                    }
        ...
        if (z) {
            while (true) {
                ...
                if (j2 == 0) {
                    ...
                    this.d = i + 1;
                    g1.j(bArr, i, (byte) ((((int) j) | 128) & 255));
                    j >>>= 7;
                }
            }
        } else {
    ...
    public final void p(int i, f fVar) throws IOException {
        B(i, 2);
        q(fVar);
    }
    ...
    public final void y(int i, a aVar, u0 u0Var) throws IOException {
        B(i, 2);
        D(aVar.a(u0Var));
        u0Var.e(aVar, this.a);
    }
