...
public final class j {
    ...
    public j(u uVar) {
        ...
        this.g = new com.google.firebase.heartbeatinfo.e(5);
        f fVar = new f();
        fVar.a = this;
        this.e = fVar;
    ...
    public final int b(CharSequence charSequence, int i) {
        ...
        t1.n(charSequence, "charSequence cannot be null");
    ...
    public final void e() {
        if (!(this.h == 1)) {
            kotlinx.coroutines.future.a.u("Set metadataLoadStrategy to LOAD_STRATEGY_MANUAL to execute manual loading");
            return;
        }
        if (c() == 1) {
            return;
    ...
    public final CharSequence g(int i, int i2, int i3, CharSequence charSequence) throws Throwable {
        ...
        if (i < 0) {
            kotlinx.coroutines.future.a.q("start cannot be negative");
            return null;
        }
        if (i2 < 0) {
            kotlinx.coroutines.future.a.q("end cannot be negative");
            return null;
        }
        t1.k("start should be <= than end", i <= i2);
        b0 b0Var = null;
        if (charSequence == null) {
            return null;
        }
        t1.k("start should be < than charSequence length", i <= charSequence.length());
        t1.k("end should be < than charSequence length", i2 <= charSequence.length());
        ...
        try {
            ...
            if (i4 != i5 || i4 >= charSequence.length()) {
                ...
                charSequence2 = charSequence;
                try {
                    b0 b0Var2 = (b0) c2Var.T(charSequence2, i4, i5, Integer.MAX_VALUE, z, new androidx.compose.foundation.text.input.internal.o(28, b0Var, (com.google.firebase.heartbeatinfo.e) c2Var.y));
                    if (b0Var2 != null) {
    ...
    public final void i(EditorInfo editorInfo) {
        ...
        androidx.emoji2.text.flatbuffer.b bVar = (androidx.emoji2.text.flatbuffer.b) ((com.google.firebase.messaging.n) fVar.c).y;
        int iB = bVar.b(4);
