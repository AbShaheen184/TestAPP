...
public class b extends InputStream implements DataInput, InputStreamRetargetInterface {
    ...
    public final void a(int i) throws IOException {
        ...
        while (i2 < i) {
            ...
            if (iSkip <= 0) {
                ...
                if (iSkip == -1) {
                    throw new EOFException(androidx.privacysandbox.ads.adservices.java.internal.a.q("Reached EOF while skipping ", i, " bytes."));
                }
            }
            i2 += iSkip;
        }
    ...
    public final int readInt() throws IOException {
        ...
        kotlinx.coroutines.future.a.t(this.z, "Invalid byte order: ");
        return 0;
    }
