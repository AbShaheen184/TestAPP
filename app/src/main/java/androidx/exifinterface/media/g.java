...
public final class g {
    ...
    public static ByteOrder q(b bVar) throws IOException {
        ...
        if (s2 != 19789) {
            kotlinx.coroutines.future.a.t(Integer.toHexString(s2), "Invalid byte order: ");
            return null;
        }
        if (z2) {
    ...
    public final void d(f fVar, int i) {
        ...
        if (i3 < 28) {
            com.google.firebase.platforminfo.b.n("Reading EXIF from HEIC files is supported from SDK 28 and above");
            return;
        }
        if (i == 15 && i3 < 31) {
            com.google.firebase.platforminfo.b.n("Reading EXIF from AVIF files is supported from SDK 31 and above");
            return;
        }
        ...
        while (true) {
            try {
                ...
                if (Arrays.equals(B, bArr2)) {
                    ...
                    byte[] bArr3 = N;
                    if (okhttp3.internal.platform.android.g.y(bArrCopyOfRange, bArr3)) {
    ...
    public final void o(f fVar) throws IOException {
        ...
        if (i != 7 && i != 10 && unsignedShort != 42) {
            kotlinx.coroutines.future.a.t(Integer.toHexString(unsignedShort), "Invalid start code: ");
            return;
        }
        int i2 = fVar.readInt();
        if (i2 < 8) {
            kotlinx.coroutines.future.a.w(androidx.privacysandbox.ads.adservices.java.internal.a.n(i2, "Invalid first Ifd offset: "));
            return;
        }
        int i3 = i2 - 8;
        if (i3 > 0) {
                        ...
                        if (num != null) {
                            if (unsignedShort3 != 3) {
                                ...
                                if (j5 > 0 || (i5 != -1 && j5 >= i5)) {
                                    hashSet = hashSet2;
                                    if (z3 != 0) {
                                        strH = j.h("Skip jump into the IFD since its offset is invalid: ", j5);
                                        if (i5 != -1) {
                                            strH = strH + " (total length: " + i5 + ")";
                                        }
    ...
    public final void u(b bVar) throws IOException {
        ...
        if (cVar3 != null) {
            ...
            if (Arrays.equals(iArr2, iArr) || (this.c == 3 && (cVar = (c) map.get("PhotometricInterpretation")) != null && (((iE = cVar.e(this.f)) == 1 && Arrays.equals(iArr, o)) || (iE == 6 && Arrays.equals(iArr, iArr2))))) {
                ...
                long[] jArrE = okhttp3.internal.platform.android.g.e(cVar4.g(this.f));
                long[] jArrE2 = okhttp3.internal.platform.android.g.e(cVar5.g(this.f));
