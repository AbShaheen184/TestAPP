...
public class h implements z {
    ...
    public h(String str, String str2) throws androidx.media3.common.util.j {
        this.e = 2;
        ...
        for (int i = 0; i < iArr2[0]; i++) {
            ...
            k kVar = new k(9);
            ((k[]) this.z)[i] = kVar;
            ((HashMap) this.B).put(str3, kVar);
        }
        this.C = new HashMap();
        int[] iArr4 = new int[1];
        GLES20.glGetProgramiv(this.y, 35718, iArr4, 0);
        this.A = new com.google.android.material.shape.f[iArr4[0]];
        for (int i5 = 0; i5 < iArr4[0]; i5++) {
            ...
            com.google.android.material.shape.f fVar = new com.google.android.material.shape.f(9);
            ((com.google.android.material.shape.f[]) this.A)[i5] = fVar;
            ((HashMap) this.C).put(str4, fVar);
        }
        androidx.media3.common.util.b.b();
    }
    ...
    public static void a(int i, int i2, String str) throws androidx.media3.common.util.j {
        int iGlCreateShader = GLES20.glCreateShader(i2);
        GLES20.glShaderSource(iGlCreateShader, str);
        GLES20.glCompileShader(iGlCreateShader);
        int[] iArr = {0};
        GLES20.glGetShaderiv(iGlCreateShader, 35713, iArr, 0);
        androidx.media3.common.util.b.c(GLES20.glGetShaderInfoLog(iGlCreateShader) + ", source: \n" + str, iArr[0] == 1);
    ...
    public t A(String str, boolean z) {
        ...
        z0 z0Var = (z0) this.A;
        z0Var.getClass();
        Iterator it = ((kotlin.sequences.a) kotlin.sequences.k.K(new b1(z0Var, 0))).iterator();
        do {
            if (!it.hasNext()) {
                next = null;
                break;
            ...
            next = it.next();
            tVar = (t) next;
            if (r.o((String) tVar.y.e, str, false)) {
                break;
            }
    ...
    public int D(String str) throws androidx.media3.common.util.j {
    ...
    public s G(s sVar, c2 c2Var, boolean z, t tVar) {
        ...
        while (true) {
            androidx.navigation.internal.i iVar = (androidx.navigation.internal.i) it;
            sVarE = null;
            if (!iVar.hasNext()) {
                break;
            }
        ...
        s sVar2 = (s) p.L(arrayList);
        v vVar2 = vVar.z;
        if (vVar2 != null && z && !vVar2.equals(tVar)) {
            sVarE = vVar2.e(c2Var, vVar);
        }
        return (s) p.L(o.q(new s[]{sVar, sVar2, sVarE}));
    }
        ...
        if (vVar.z() == 2) {
            ...
            if ((vVar.z() & 128) != 0) {
                ...
                if (i2 == 2 && c0Var.r == null) {
                    f0 f0VarA = tVar.a(21, new n(21, null, 0, null, i0.b));
                    c0Var.r = f0VarA;
                    if (f0VarA != null) {
                        f0VarA.d(g0Var, c0Var.m, new e0(iG, 21, 8192));
                    }
                }
                sparseArray2.clear();
                ...
                while (iA > 0) {
                    ...
                    while (true) {
                        ...
                        if (iZ2 == 5) {
                            ...
                            strTrim = vVar.x(3, StandardCharsets.UTF_8).trim();
                            iZ = vVar.z();
                        } else if (iZ2 == 89) {
                            ArrayList arrayList2 = new ArrayList();
                            while (vVar.b < iZ3) {
                                String strTrim2 = vVar.x(3, StandardCharsets.UTF_8).trim();
                                vVar.z();
                                g0 g0Var3 = g0Var;
                    ...
                    g0 g0Var4 = g0Var;
                    vVar.M(i4);
                    n nVar = new n(i5, strTrim, iZ, arrayList, Arrays.copyOfRange(vVar.a, i3, i4));
                    if (iG2 == 6 || iG2 == 5) {
                        iG2 = i5;
                    }
                    int i8 = i6 - (iG4 + 5);
                ...
                while (i11 < size) {
                    ...
                    if (f0Var != null) {
                        if (f0Var != c0Var.r) {
                            i = i10;
                            g0Var2 = g0Var5;
                            f0Var.d(g0Var2, c0Var.m, new e0(i, iKeyAt, 8192));
                        } else {
                            g0Var2 = g0Var5;
                            i = i10;
                        }
    ...
    public String g() {
        ...
        j('\"');
        int i = this.y;
        int iG = kotlin.text.k.G(str, '\"', i, 4);
        if (iG == -1) {
            m();
            y((byte) 1, false);
            throw null;
    ...
    public void n(boolean z) {
        for (d dVar : ((androidx.compose.ui.graphics.vector.g) this.B).p()) {
            if (dVar != null && z) {
                dVar.z.n(true);
            }
        }
    ...
    public String toString() {
        switch (this.e) {
            ...
            case 6:
                ...
                return androidx.privacysandbox.ads.adservices.java.internal.a.t(sb2, this.y, ')');
            default:
    ...
    public void y(byte b, boolean z) {
        ...
        int i = this.y;
        int i2 = z ? i - 1 : i;
        x(this, androidx.compose.runtime.j.k("Expected ", strK, ", but had '", (i == str.length() || i2 < 0) ? "EOF" : String.valueOf(str.charAt(i2)), "' instead"), i2, null, 4);
        throw null;
    }
    ...
    public h(y yVar, androidx.media3.exoplayer.dash.manifest.t tVar, byte[] bArr, m0[] m0VarArr, int i) {
        this.e = 3;
        this.z = yVar;
        this.A = tVar;
        this.B = bArr;
