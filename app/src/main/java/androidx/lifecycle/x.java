...
public final class x extends p {
    ...
    public final void a(u uVar) {
        ...
        if (((w) obj) == null && (vVar = (v) this.e.get()) != null) {
            ...
            while (wVar.a.compareTo(oVarC) < 0 && this.c.B.containsKey(uVar)) {
                ...
                if (nVar == null) {
                    com.google.firebase.platforminfo.b.o(wVar.a, "no event up from ");
                    return;
                } else {
                    wVar.a(vVar, nVar);
    ...
    public final o c(u uVar) {
        ...
        ArrayList arrayList = this.i;
        o oVar2 = arrayList.isEmpty() ? null : (o) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, arrayList);
        o oVar3 = this.d;
        oVar3.getClass();
    ...
    public final void d(String str) {
        if (this.b) {
            ...
            kotlinx.coroutines.future.a.c(androidx.privacysandbox.ads.adservices.java.internal.a.r("Method ", str, " must be called on the main thread"));
        }
    }
    ...
    public final void g() {
        ...
        v vVar = (v) this.e.get();
        if (vVar == null) {
            kotlinx.coroutines.future.a.u("LifecycleOwner of this LifecycleRegistry is already garbage collected. It is too late to change lifecycle state.");
            return;
        }
        while (true) {
            androidx.arch.core.internal.a aVar = this.c;
                ...
                if (iCompareTo < 0) {
                    ...
                    while (bVar.hasNext() && !this.h) {
                        ...
                        while (wVar.a.compareTo(this.d) > 0 && !this.h && this.c.B.containsKey(uVar)) {
                            ...
                            if (nVar2 == null) {
                                com.google.firebase.platforminfo.b.o(wVar.a, "no event down from ");
                                return;
                            } else {
                ...
                if (!this.h && cVar4 != null && this.d.compareTo(((w) cVar4.y).a) > 0) {
                    ...
                    while (dVar.hasNext() && !this.h) {
                        ...
                        while (wVar2.a.compareTo(this.d) < 0 && !this.h && this.c.B.containsKey(uVar2)) {
                            ...
                            if (nVar == null) {
                                com.google.firebase.platforminfo.b.o(wVar2.a, "no event up from ");
                                return;
                            } else {
                                wVar2.a(vVar, nVar);
                                arrayList.remove(arrayList.size() - 1);
