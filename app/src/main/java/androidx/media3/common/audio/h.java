...
public abstract class h {
    ...
    public static synchronized AudioManager l(Context context) {
        try {
            ...
            if (looperMyLooper != null && looperMyLooper != Looper.getMainLooper()) {
                ...
                androidx.media3.common.util.b.h().execute(new androidx.activity.c(3, applicationContext, gVar));
                gVar.a();
    ...
    public static Intent q(Context context, androidx.media3.common.util.s sVar, IntentFilter intentFilter) {
        return context.registerReceiver(sVar, intentFilter, null, null, 0);
    }
