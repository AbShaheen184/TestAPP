...
public final class r {
    ...
    static {
        ...
        androidx.compose.runtime.j.A(10, 11, 12, 13, 14);
        androidx.compose.runtime.j.A(15, 16, 17, 18, 19);
        androidx.compose.runtime.j.A(20, 21, 22, 23, 24);
        androidx.compose.runtime.j.A(25, 26, 27, 28, 29);
        androidx.compose.runtime.j.A(30, 31, 32, 33, 34);
        androidx.media3.common.util.i0.K(35);
        androidx.media3.common.util.i0.K(36);
        androidx.media3.common.util.i0.K(37);
    }
    ...
    public r(q qVar) {
        ...
        String str;
        this.a = qVar.a;
        String strR = androidx.media3.common.util.i0.R(qVar.d);
        this.d = strR;
        ...
        this.e = qVar.e;
        _COROUTINE.a.z("Auxiliary track type must only be set to a value other than AUXILIARY_TRACK_TYPE_UNDEFINED only when ROLE_FLAG_AUXILIARY is set", qVar.g == 0 || (qVar.f & 32768) != 0);
        this.f = qVar.f;
        this.g = qVar.g;
        int i2 = qVar.h;
        this.h = i2;
    ...
    public static String c(r rVar) {
        ...
        String str6 = rVar.n;
        int i11 = rVar.f;
        androidx.emoji2.text.r rVar2 = new androidx.emoji2.text.r(String.valueOf(','));
        StringBuilder sbP = androidx.compose.runtime.j.p("id=");
        sbP.append(rVar.a);
        sbP.append(", mimeType=");
        sbP.append(rVar.o);
        if (str6 != null) {
            sbP.append(", container=");
            sbP.append(str6);
        }
        if (str5 != null) {
            sbP.append(", primaryGroupId=");
            sbP.append(str5);
        }
        if (i10 != -1) {
            sbP.append(", bitrate=");
        ...
        if (mVar != null) {
            ...
            sbP.append(", drm=[");
            rVar2.a(sbP, linkedHashSet.iterator());
            sbP.append(']');
        }
        if (i9 != -1 && i8 != -1) {
            sbP.append(", res=");
        ...
        if (Math.copySign(d - 1.0d, 1.0d) > 0.001d && d != 1.0d && (!Double.isNaN(d) || !Double.isNaN(1.0d))) {
            ...
            sbP.append(String.format(Locale.US, "%.3f", objArr));
        }
        if (hVar != null) {
            int i14 = hVar.f;
            int i15 = hVar.e;
            if ((i15 != -1 && i14 != -1) || hVar.d()) {
                ...
                sbP.append(str2 + "/" + ((i15 == -1 || i14 == -1) ? "NA/NA" : i15 + "/" + i14));
            }
        }
        if (f != -1.0f) {
            sbP.append(", fps=");
        ...
        if (!h0Var.isEmpty()) {
            sbP.append(", labels=[");
            rVar2.a(sbP, com.google.common.collect.q.w(h0Var, new p(0)).iterator());
            sbP.append("]");
        }
        if (i2 != 0) {
            sbP.append(", selectionFlags=[");
            ...
            rVar2.a(sbP, arrayList.iterator());
            sbP.append("]");
        }
        if (i11 != 0) {
            sbP.append(", roleFlags=[");
            ...
            rVar2.a(sbP, arrayList2.iterator());
            sbP.append("]");
        } else {
            i = i11;
        }
        if ((i & 32768) != 0) {
            sbP.append(", auxiliaryTrackType=");
            int i16 = rVar.g;
            ...
            if (i16 == 0) {
                ...
                if (i16 != 4) {
                    kotlinx.coroutines.future.a.u("Unsupported auxiliary track type");
                    return null;
                }
                str = "depth metadata";
            }
    ...
    public final r d(r rVar) {
        ...
        String str5 = this.k;
        if (str5 == null) {
            String strW = androidx.media3.common.util.i0.w(i3, rVar.k);
            if (androidx.media3.common.util.i0.b0(strW).length == 1) {
                str5 = strW;
            }
        }
        String str6 = this.m;
    ...
    public final String toString() {
        ...
        sb.append(this.G);
        sb.append(", ");
        return androidx.privacysandbox.ads.adservices.java.internal.a.o(this.H, "])", sb);
    }
}
