    ...
    public final void a() {
        ...
        if (!zW || jO == -9223372036854775807L || j < jO) {
            ...
            if (zW && jO != -9223372036854775807L) {
                c0Var.V();
                f0Var.a.sendEmptyMessageDelayed(3, (int) Math.ceil((jO - j) / c0Var.n0.o.a));
            }
            this.e = false;
            return;
        }
        ...
        if (z && Objects.equals(objL, this.b) && iF == this.c && iG == this.d) {
            if (jElapsedRealtime - this.f >= i) {
                ((androidx.media3.exoplayer.x) a1Var.d).e.Q(new androidx.media3.exoplayer.j(2, new c0(3, i), 1003));
                return;
            }
            return;
        }
        ...
        this.d = iG;
        f0Var.e(3);
        f0Var.a.sendEmptyMessageDelayed(3, i);
    }
}
