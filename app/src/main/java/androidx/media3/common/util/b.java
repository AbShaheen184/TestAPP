...
public abstract class b {
    ...
    public static void b() throws j {
        ...
        if (z) {
            throw new j(sb.toString(), com.google.common.collect.h0.j(i, objArrCopyOf));
        }
    }

    public static void c(String str, boolean z) throws j {
        if (z) {
            return;
        }
        com.google.common.collect.e0 e0Var = com.google.common.collect.h0.y;
        throw new j(str, a1.B);
    }
    ...
    public static boolean m(String str) throws j {
        ...
        throw new j("Error in getDefaultEglDisplay, error code: 0x" + Integer.toHexString(iEglGetError), com.google.common.collect.h0.s(Integer.valueOf(iEglGetError)));
    }
    ...
    public static void s(MediaFormat mediaFormat, List list) {
        for (int i = 0; i < list.size(); i++) {
            mediaFormat.setByteBuffer(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "csd-"), ByteBuffer.wrap((byte[]) list.get(i)));
        }
    }
