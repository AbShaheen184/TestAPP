...
public abstract class e {
  ...
  0x073d: PHI (r4v17 int) = (r4v13 int), (r4v14 int), (r4v22 int), (r4v27 int), (r4v28 int), (r4v29 int), (r4v30 int) binds: [B:540:0x0729, B:561:0x076e, B:555:0x0758, B:550:0x0745, B:549:0x0742, B:548:0x073f, B:546:0x073b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static Pair b(androidx.media3.common.r rVar) {
        ...
        if ("video/dolby-vision".equals(rVar.o)) {
            if (strArrSplit.length < 3) {
                androidx.compose.runtime.j.y("Ignoring malformed Dolby Vision codec string: ", str2, "CodecSpecificDataUtil");
                return null;
            }
            ...
            if (num == null) {
                androidx.compose.runtime.j.y("Unknown Dolby Vision profile string: ", strGroup, "CodecSpecificDataUtil");
                return null;
            }
            ...
            androidx.compose.runtime.j.y("Unknown Dolby Vision level string: ", str3, "CodecSpecificDataUtil");
            return null;
        }
        ...
        switch (b2) {
            case 0:
                if (strArrSplit.length != 4) {
                    androidx.compose.runtime.j.y("Ignoring malformed AC-4 codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
                    ...
                    if (i == -1) {
                        b.t("CodecSpecificDataUtil", "Unknown AC-4 profile: " + i19 + "." + i20);
                        return null;
                    }
                    if (i21 == 0) {
                        i2 = 1;
                        ...
                        if (i21 != 3) {
                            ...
                            androidx.compose.runtime.j.x("Unknown AC-4 level: ", i21, "CodecSpecificDataUtil");
                            return null;
                        }
                        i2 = 8;
                    }
            ...
            case 1:
                if (strArrSplit.length < 4) {
                    androidx.compose.runtime.j.y("Ignoring malformed APV codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
                    ...
                    if (i22 == 33) {
                        ...
                        androidx.compose.runtime.j.x("Ignoring invalid APV profile: ", i22, "CodecSpecificDataUtil");
                        return null;
                    }
                    int i25 = (i23 / 30) * 2;
                    if (i23 % 30 == 0) {
                    ...
                    b.u("CodecSpecificDataUtil", "Ignoring malformed APV codec string: " + str2, e);
                    return null;
                }
            case 2:
                if (strArrSplit.length < 4) {
                    androidx.compose.runtime.j.y("Ignoring malformed AV1 codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
                    ...
                    if (i26 != 0) {
                        androidx.compose.runtime.j.x("Unknown AV1 profile: ", i26, "CodecSpecificDataUtil");
                        return null;
                    }
                    int i29 = 8;
                    if (i28 != 8 && i28 != 10) {
                        androidx.compose.runtime.j.x("Unknown AV1 bit depth: ", i28, "CodecSpecificDataUtil");
                        return null;
                    }
                    if (i28 == 8) {
                        i4 = 1;
                    ...
                    androidx.compose.runtime.j.x("Unknown AV1 level: ", i27, "CodecSpecificDataUtil");
                    return null;
            ...
            case 4:
                if (strArrSplit.length < 2) {
                    androidx.compose.runtime.j.y("Ignoring malformed AVC codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
                    if (strArrSplit[1].length() == 6) {
                        ...
                        i6 = 16;
                        if (strArrSplit.length < 3) {
                            b.t("CodecSpecificDataUtil", "Ignoring malformed AVC codec string: " + str2);
                            return null;
                        }
                    ...
                    if (i7 != 66) {
                        ...
                        if (i9 == i10) {
                            androidx.compose.runtime.j.x("Unknown AVC profile: ", i7, "CodecSpecificDataUtil");
                            return null;
                        }
                        switch (i8) {
                            case 10:
                        ...
                        androidx.compose.runtime.j.x("Unknown AVC level: ", i8, "CodecSpecificDataUtil");
                        return null;
                    }
                    i9 = 1;
                    i10 = -1;
            ...
            case 7:
                if (strArrSplit.length < 4) {
                    androidx.compose.runtime.j.y("Ignoring malformed IAMF codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
                    ...
                    switch (str5) {
                        ...
                        case "mp4a":
                            ...
                            break;
                        default:
                            b.t("CodecSpecificDataUtil", "Ignoring unknown codec identifier for IAMF auxiliary profile: " + strArrSplit[3]);
                            return null;
                    }
                    return new Pair(Integer.valueOf(i30 | 16777216 | i12), 0);
                } catch (NumberFormatException e2) {
                    b.u("CodecSpecificDataUtil", "Ignoring malformed primary profile in IAMF codec string: " + strArrSplit[1], e2);
                    return null;
                }
            case 8:
                if (strArrSplit.length != 3) {
                    androidx.compose.runtime.j.y("Ignoring malformed MP4A codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
            ...
            case 9:
                ...
                if (strArrSplit.length < 3) {
                    androidx.compose.runtime.j.y("Ignoring malformed H263 codec string: ", str2, "CodecSpecificDataUtil");
                    return pair;
                }
                try {
            ...
            case 10:
                if (strArrSplit.length < 3) {
                    androidx.compose.runtime.j.y("Ignoring malformed VP9 codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
                    ...
                    if (i14 == -1) {
                        androidx.compose.runtime.j.x("Unknown VP9 profile: ", i33, "CodecSpecificDataUtil");
                        return null;
                    }
                    if (i34 != 10) {
                        if (i34 == 11) {
                        ...
                        androidx.compose.runtime.j.x("Unknown VP9 level: ", i34, "CodecSpecificDataUtil");
                        return null;
                    }
                    i15 = 1;
                    i16 = -1;
            ...
            case 12:
                if (strArrSplit.length < 3) {
                    androidx.compose.runtime.j.y("Ignoring malformed VVC codec string: ", str2, "CodecSpecificDataUtil");
                    return null;
                }
                try {
                    ...
                    if (i35 == 1) {
                        ...
                        if (i35 != 65) {
                            b.t("CodecSpecificDataUtil", "Unknown VVC profile IDC: " + strArrSplit[1]);
                            return null;
                        }
                        i17 = 4;
                    }
                    ...
                    androidx.compose.runtime.j.y("Unknown VVC level string: ", str6, "CodecSpecificDataUtil");
                    return null;
    ...
    public static Pair c(String str, String[] strArr, androidx.media3.common.h hVar) {
        ...
        Integer numValueOf;
        if (strArr.length < 4) {
            androidx.compose.runtime.j.y("Ignoring malformed HEVC codec string: ", str, "CodecSpecificDataUtil");
            return null;
        }
        ...
        if ("1".equals(strGroup)) {
            ...
            if (!"6".equals(strGroup)) {
                androidx.compose.runtime.j.y("Unknown HEVC profile string: ", strGroup, "CodecSpecificDataUtil");
                return null;
            }
            i = 6;
        }
        ...
        androidx.compose.runtime.j.y("Unknown HEVC level string: ", str2, "CodecSpecificDataUtil");
        return null;
    }
}
