...
public final class g0 {
    ...
    public final synchronized long b(long j) {
        ...
        try {
            ...
            if (j2 != -9223372036854775807L) {
                String str = i0.a;
                long jY = i0.Y(j2, 90000L, 1000000L, RoundingMode.DOWN);
            ...
            long j6 = j;
            String str2 = i0.a;
            return a(i0.Y(j6, 1000000L, 90000L, RoundingMode.DOWN));
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public final synchronized long c(long j) {
        ...
        try {
            ...
            long j5 = j;
            String str2 = i0.a;
            return a(i0.Y(j5, 1000000L, 90000L, RoundingMode.DOWN));
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public final synchronized void g(long j, boolean z) {
        try {
            _COROUTINE.a.A(this.a == 9223372036854775806L);
            if (e()) {
                return;
            }
            if (z) {
