...
public final class v {
    ...
    public static int b(int i, int i2, int i3, int i4) {
        byte b = (byte) i3;
        return com.imsdk.a.k((byte) 0, okhttp3.internal.platform.android.g.d(((i & 7) << 2) | ((i2 & 48) >> 4)), okhttp3.internal.platform.android.g.d(((((byte) i2) & 15) << 4) | ((b & 60) >> 2)), okhttp3.internal.platform.android.g.d(((b & 3) << 6) | (((byte) i4) & 63)));
    }

    public static int d(Charset charset) {
        _COROUTINE.a.q(f.contains(charset), "Unsupported charset: %s", charset);
    ...
    public final int D() {
        ...
        kotlinx.coroutines.future.a.u(androidx.privacysandbox.ads.adservices.java.internal.a.n(iM, "Top bit not zero: "));
        return 0;
    }
    ...
    public final int E() {
        ...
        for (int i = 0; i < 9; i++) {
            if (this.b == this.c) {
                kotlinx.coroutines.future.a.u("Attempting to read a byte over the limit.");
                return 0;
            }
            long jZ = z();
            j |= (127 & jZ) << (i * 7);
    ...
    public final long F() {
        ...
        kotlinx.coroutines.future.a.u(androidx.compose.runtime.j.h("Top bit not zero: ", jT));
        return 0L;
    }
    ...
    public final long H() {
        ...
        if (i == 0) {
            throw new NumberFormatException(androidx.compose.runtime.j.h("Invalid UTF-8 sequence first byte: ", j));
        }
        f(i);
        for (int i4 = 1; i4 < i; i4++) {
            byte b = this.a[this.b + i4];
            if ((b & 192) != 128) {
                throw new NumberFormatException(androidx.compose.runtime.j.h("Invalid UTF-8 sequence continuation byte: ", j));
            }
            j = (j << 6) | ((long) (b & 63));
        }
        this.b += i;
    ...
    public final void L(int i) {
        _COROUTINE.a.o(i >= 0 && i <= this.a.length);
        this.c = i;
    }

    public final void M(int i) {
        _COROUTINE.a.o(i >= 0 && i <= this.c);
        this.b = i;
    }
    ...
    public final void f(int i) {
        ...
        com.google.firebase.platforminfo.b.i(androidx.privacysandbox.ads.adservices.java.internal.a.v("bytesNeeded= ", i, ", bytesLeft="), a());
    }
    ...
    public final char l(Charset charset, char[] cArr) {
        ...
        if (a() >= d(charset) && (iH = h(charset)) != 0) {
            long j = iH >>> 8;
            _COROUTINE.a.m("out of range: %s", j, (j >> 32) == 0);
            int i = (int) j;
            if (!Character.isSupplementaryCodePoint(i)) {
                long j2 = i;
                char c = (char) j2;
                _COROUTINE.a.m("Out of range: %s", j2, ((long) c) == j2);
                for (char c2 : cArr) {
                    if (c2 == c) {
                        this.b = com.imsdk.a.f(iH & 255) + this.b;
                        return c;
                    }
                }
            }
    ...
    public final String n(Charset charset) {
        ...
        if (charset.equals(StandardCharsets.UTF_8) || charset.equals(charset2)) {
            ...
            if (!charset.equals(StandardCharsets.UTF_16) && !charset.equals(StandardCharsets.UTF_16LE) && !charset.equals(StandardCharsets.UTF_16BE)) {
                com.google.firebase.platforminfo.b.f(charset, "Unsupported charset: ");
                return null;
            }
            i = 2;
        }
        ...
        while (true) {
            ...
            if ((charset.equals(StandardCharsets.UTF_8) || charset.equals(StandardCharsets.US_ASCII)) && i0.O(this.a[i2])) {
                break;
            }
            if (charset.equals(StandardCharsets.UTF_16) || charset.equals(StandardCharsets.UTF_16BE)) {
                byte[] bArr2 = this.a;
                if (bArr2[i2] == 0 && i0.O(bArr2[i2 + 1])) {
                    break;
                }
                if (charset.equals(StandardCharsets.UTF_16LE)) {
                    bArr = this.a;
                    if (bArr[i2 + 1] == 0 && i0.O(bArr[i2])) {
                        break;
                    }
                }
                i2 += i;
    ...
    public final int r() {
        ...
        kotlinx.coroutines.future.a.u(androidx.privacysandbox.ads.adservices.java.internal.a.n(iO, "Top bit not zero: "));
        return 0;
    }
