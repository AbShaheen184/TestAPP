...
public final class b implements g0 {
    ...
    public final ArrayList d() {
        _COROUTINE.a.z("Metadata is not an auxiliary tracks map", this.a.equals("auxiliary.tracks.map"));
        byte[] bArr = this.b;
        byte b = bArr[1];
    ...
    public final int hashCode() {
        return ((((Arrays.hashCode(this.b) + androidx.privacysandbox.ads.adservices.java.internal.a.g(527, 31, this.a)) * 31) + this.c) * 31) + this.d;
    }
    ...
    public final String toString() {
        ...
        if (i6 != 0) {
            if (i6 == 1) {
                ...
                byte[] bArr2 = this.b;
                _COROUTINE.a.k(bArr2.length, 4, "array too small: %s < %s", bArr2.length >= 4);
                string = String.valueOf(Float.intBitsToFloat(com.imsdk.a.k(bArr2[0], bArr2[1], bArr2[2], bArr2[3])));
            } else if (i6 == 67) {
                byte[] bArr3 = this.b;
                _COROUTINE.a.k(bArr3.length, 4, "array too small: %s < %s", bArr3.length >= 4);
                string = String.valueOf(com.imsdk.a.k(bArr3[0], bArr3[1], bArr3[2], bArr3[3]));
            } else if (i6 == 75) {
                ...
                if (bVar2 == null) {
                    ...
                    for (char c5 : cArr) {
                        if (com.imsdk.a.v(c5)) {
                            ...
                            _COROUTINE.a.z("Cannot call lowerCase() on a mixed-case alphabet", !z);
                            ...
                            if (aVar2.h) {
                                ...
                                for (i4 = 65; i4 <= 90; i4++) {
                                    ...
                                    if (b == -1) {
                                        ...
                                        c2 = (char) i5;
                                        if (z2) {
                                            kotlinx.coroutines.future.a.u(_COROUTINE.b.B("Can't ignoreCase() since '%s' and '%s' encode different values", Character.valueOf(c), Character.valueOf(c2)));
                                            return null;
                                        }
                                        bArrCopyOf[i5] = b;
                                    }
                ...
                string = String.valueOf(new androidx.media3.common.util.v(this.b).F());
            }
        } else if (this.a.equals("auxiliary.tracks.map")) {
            ArrayList arrayListD = d();
            StringBuilder sbP = androidx.compose.runtime.j.p("track types = ");
            new androidx.emoji2.text.r(String.valueOf(',')).a(sbP, arrayListD.iterator());
            string = sbP.toString();
        } else {
            byte[] bArr5 = this.b;
            String str2 = i0.a;
        ...
        return androidx.compose.runtime.j.m(new StringBuilder("mdta: key="), this.a, ", value=", string);
    }
}
