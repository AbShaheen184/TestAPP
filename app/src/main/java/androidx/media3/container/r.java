...
public abstract class r {
    ...
    public static n k(byte[] bArr, int i, int i2, com.google.firebase.messaging.n nVar) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        if (z) {
            ...
            if (nVar == null || (lVar2 = (l) nVar.A) == null) {
                iF = 0;
                iF2 = 0;
                i7 = 0;
                i9 = 0;
        ...
        if (vVar.d()) {
            if (vVar.d()) {
                ...
                if (iE3 == 255) {
                    ...
                    androidx.compose.runtime.j.x("Unexpected aspect_ratio_idc value: ", iE3, "NalUnitUtil");
                }
            }
            if (vVar.d()) {
                vVar.i();
            ...
            } else if (nVar == null || (lVar = (l) nVar.B) == null) {
                iF3 = -1;
                iG = -1;
                i13 = -1;
            } else {
    ...
    public static com.google.firebase.messaging.n l(byte[] bArr, int i, int i2) {
        int[] iArr;
        l lVar;
        int iE;
        int iE2;
        ...
        boolean z6 = i16 >= i12;
        if (!z4 || !z5 || !z6) {
            return new com.google.firebase.messaging.n(null, lVar2, null, null);
        }
        ...
        return new com.google.firebase.messaging.n(a1VarG, new l(a1Var3, iArr37, 0), lVar3, lVar);
    }
            ...
            if (vVar.d()) {
                if (!vVar.d()) {
                    ...
                    if (iE == 255) {
                        ...
                        androidx.compose.runtime.j.x("Unexpected aspect_ratio_idc value: ", iE, "NalUnitUtil");
                    }
                }
                if (vVar.d()) {
                    vVar.i();
