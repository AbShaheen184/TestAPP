...
public final class d implements androidx.media3.datasource.h {
    ...
    public final void h(androidx.media3.datasource.l lVar, boolean z) throws InterruptedIOException {
        o oVarL;
        ...
        if (lVarA.g == -1 && jT != -1) {
            this.K = jT;
            bVar.o(Long.valueOf(this.J + jT), "exo_len");
        }
        if (!(this.H == this.y)) {
            Uri uriV = hVar.v();
            this.E = uriV;
    ...
    @Override // androidx.media3.datasource.h
    public final Map l() {
        return !(this.H == this.y) ? this.A.l() : Collections.EMPTY_MAP;
    }
    ...
    public final int read(byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            if (!(hVar3 == hVar)) {
                ...
                androidx.localbroadcastmanager.content.b bVar = new androidx.localbroadcastmanager.content.b(5);
                bVar.o(Long.valueOf(this.J), "exo_len");
                this.e.c(str, bVar);
                return i3;
            }
            i3 = i4;
