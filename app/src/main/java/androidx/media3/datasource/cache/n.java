...
public final class n {
    ...
    public n(File file, k kVar) {
        ...
        x1 x1Var = new x1();
        x1Var.a = new HashMap();
        x1Var.b = new SparseArray();
        x1Var.c = new SparseBooleanArray();
        x1Var.d = new SparseBooleanArray();
        ...
        gVar.b = null;
        gVar.c = null;
        gVar.d = new androidx.localbroadcastmanager.content.b(file2);
        String str = i0.a;
        x1Var.e = gVar;
        x1Var.f = null;
        ...
        if (!zAdd) {
            com.google.firebase.platforminfo.b.k(file, "Another SimpleCache instance uses the folder: ");
            throw null;
        }
        this.a = file;
        this.b = kVar;
    ...
    public static void a(n nVar) {
        ...
        if (fileArrListFiles == null) {
            ...
            androidx.media3.common.util.b.f("SimpleCache", str);
            nVar.h = new a(str);
            return;
        }
        ...
        while (true) {
            ...
            if (name.endsWith(".uid")) {
                try {
                    ...
                    androidx.media3.common.util.b.f("SimpleCache", "Malformed UID file: " + file2);
                    file2.delete();
                }
            }
            i2++;
        ...
        if (j == -1) {
            try {
                ...
                if (!file3.createNewFile()) {
                    kotlinx.coroutines.future.a.x(file3, "Failed to create UID file: ");
                    jAbs = 0;
                }
                nVar.g = jAbs;
            } catch (IOException e2) {
                String str2 = "Failed to create cache UID: " + file;
                androidx.media3.common.util.b.g("SimpleCache", str2, e2);
        ...
        try {
            ...
            p1 it = k0.l(((HashMap) x1Var.a).keySet()).iterator();
            while (it.hasNext()) {
                x1Var.X((String) it.next());
            }
            try {
                x1Var.p0();
            } catch (IOException e3) {
                androidx.media3.common.util.b.g("SimpleCache", "Storing index file failed", e3);
            }
        } catch (IOException e4) {
            String str3 = "Failed to initialize cache indices: " + file;
            androidx.media3.common.util.b.g("SimpleCache", str3, e4);
    ...
    public final synchronized void c(String str, androidx.localbroadcastmanager.content.b bVar) {
        d();
        x1 x1Var = this.c;
        g gVarL = x1Var.L(str);
        i iVar = gVarL.e;
        ...
        if (!iVarB.equals(iVar)) {
            ((androidx.compose.material.ripple.g) x1Var.e).f(gVarL);
        }
        try {
            this.c.p0();
        } catch (IOException e) {
    ...
    public final o m(String str, o oVar) {
        ...
        gVarI.getClass();
        TreeSet treeSet = gVarI.c;
        _COROUTINE.a.A(treeSet.remove(oVar));
        file2.getClass();
        ...
        if (file2.renameTo(fileE)) {
            ...
            androidx.media3.common.util.b.t("CachedContent", "Failed to rename " + file2 + " to " + fileE);
            file = file2;
        }
        _COROUTINE.a.A(oVar.A);
