...
public final class o implements Comparable {
  ...
  0x009f: PHI (r2v15 java.util.regex.Matcher) = (r2v10 java.util.regex.Matcher), (r2v8 java.util.regex.Matcher) binds: [B:26:0x0095, B:22:0x0083] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static o d(File file, long j, x1 x1Var) {
        File file2;
        String strGroup;
        File fileE;
        ...
        if (!name.endsWith(".v3.exo")) {
            ...
            if (matcher.matches()) {
                ...
                if (i != 0) {
                    ...
                    Matcher matcher2 = i0.f.matcher(strGroup);
        ...
        if (matcher3.matches()) {
            ...
            strGroup5.getClass();
            String str2 = (String) ((SparseArray) x1Var.b).get(Integer.parseInt(strGroup5));
            if (str2 != null) {
    ...
    public static File e(File file, int i, long j, long j2) {
        ...
        sb.append(j);
        sb.append(".");
        return new File(file, androidx.privacysandbox.ads.adservices.java.internal.a.p(j2, ".v3.exo", sb));
    }
