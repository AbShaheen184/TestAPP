...
public final class p extends c {
    ...
    public final long t(l lVar) throws o {
        ...
        try {
            ...
            StringBuilder sbQ = androidx.compose.runtime.j.q("uri has query and/or fragment, which are not supported. Did you call Uri.parse() on a string containing '?' or '#'? Use Uri.fromFile(new File(path)) to avoid this. path=", path2, ",query=", query, ",fragment=");
            sbQ.append(fragment);
            throw new o(sbQ.toString(), e2, 1004);
