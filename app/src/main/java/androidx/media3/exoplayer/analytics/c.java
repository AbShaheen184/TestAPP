...
public final /* synthetic */ class c implements m, l, u, androidx.media3.common.util.h, com.google.common.base.g, androidx.concurrent.futures.j, com.google.android.datatransport.runtime.synchronization.b, com.google.android.datatransport.runtime.scheduling.persistence.e, com.google.firebase.inject.a, com.google.android.gms.tasks.d, com.google.android.gms.tasks.b, com.google.firebase.components.e, ContextAction {
    ...
    public Object apply(Object obj) {
        ...
        ArrayList arrayListX = gVar.x(sQLiteDatabase, kVar, aVar.b);
        for (com.google.android.datatransport.d dVar : com.google.android.datatransport.d.values()) {
            if (dVar != kVar.c) {
                int size = aVar.b - arrayListX.size();
                if (size <= 0) {
                    break;
                }
                arrayListX.addAll(gVar.x(sQLiteDatabase, kVar.b(dVar), size));
            }
        }
        HashMap map = new HashMap();
        StringBuilder sb = new StringBuilder("event_id IN (");
        for (int i = 0; i < arrayListX.size(); i++) {
            sb.append(((com.google.android.datatransport.runtime.scheduling.persistence.b) arrayListX.get(i)).a);
    ...
    public Object b(androidx.concurrent.futures.i iVar) {
        ...
        n nVar = iVar.c;
        if (nVar != null) {
            nVar.a(qVar, androidx.work.l.e);
        }
        executor.execute(new androidx.work.r(atomicBoolean, iVar, aVar, 1));
        return y.a;
    }
    ...
    public Object d(com.google.android.gms.tasks.i iVar) {
        com.google.firebase.messaging.f fVar = (com.google.firebase.messaging.f) this.y;
        String str = (String) this.z;
        synchronized (fVar) {
            ((androidx.collection.f) fVar.b).remove(str);
        }
        return iVar;
    }
        ...
        switch (this.e) {
            ...
            default:
                ...
                for (Map.Entry entry : ((HashMap) this.z).entrySet()) {
                    ((com.google.android.datatransport.runtime.scheduling.persistence.g) k0Var2.i).A(((Integer) entry.getValue()).intValue(), com.google.android.datatransport.runtime.firebase.transport.c.INVALID_PAYLOD, (String) entry.getKey());
                }
                break;
        }
        return null;
    ...
    public void f(Object obj, androidx.media3.common.o oVar) {
        j jVar = (j) ((b) obj);
        jVar.k((q0) this.z, new androidx.localbroadcastmanager.content.b(oVar, ((g) this.y).B));
    }
    ...
    public Object g(x1 x1Var) {
        ...
        switch (this.e) {
            case 12:
                ...
                com.google.firebase.i iVar = (com.google.firebase.i) this.z;
                Context context = (Context) x1Var.a(Context.class);
                switch (iVar.e) {
                    case 0:
