...
public final class b {
    ...
    public static b b(Context context, Intent intent, androidx.media3.common.e eVar, AudioDeviceInfo audioDeviceInfo, List list) {
        ...
        if (Build.VERSION.SDK_INT >= 33 && (androidx.media3.common.util.i0.P(context) || context.getPackageManager().hasSystemFeature("android.hardware.type.automotive"))) {
        ...
        for (AudioDeviceInfo audioDeviceInfo2 : audioDeviceInfo == null ? audioManagerL.getDevices(2) : new AudioDeviceInfo[]{audioDeviceInfo}) {
            if (com.google.firebase.b.H(audioDeviceInfo2.getType())) {
        ...
        j0Var.b(2);
        if (Build.VERSION.SDK_INT >= 29 && (androidx.media3.common.util.i0.P(context) || context.getPackageManager().hasSystemFeature("android.hardware.type.automotive"))) {
            a1 a1VarO = androidx.compose.ui.platform.coreshims.b.o(eVar);
            a1VarO.getClass();
            j0Var.c(a1VarO);
            return new b(a(10, com.imsdk.a.A(j0Var.g())), h0VarB, list);
        }
        ...
        if (intArrayExtra != null) {
            List listB = com.imsdk.a.b(intArrayExtra);
            listB.getClass();
            j0Var.c(listB);
        }
        return new b(a(intent.getIntExtra("android.media.extra.MAX_CHANNEL_COUNT", 10), com.imsdk.a.A(j0Var.g())), h0VarB, list);
    }
    ...
    public final Pair c(androidx.media3.common.e eVar, androidx.media3.common.r rVar) {
        ...
        if (iD == 18 && !androidx.media3.common.util.i0.l(sparseArray, 18)) {
            iD = 6;
        } else if ((iD == 8 && !androidx.media3.common.util.i0.l(sparseArray, 8)) || (iD == 30 && !androidx.media3.common.util.i0.l(sparseArray, 30))) {
            iD = 7;
        }
        if (!androidx.media3.common.util.i0.l(sparseArray, iD)) {
            return null;
        }
        ...
        if (i2 == -1 || iD == 18) {
            ...
            if (k0Var != null) {
                int iT = androidx.media3.common.util.i0.t(i2);
                if (iT != 0) {
        ...
        int iT2 = androidx.media3.common.util.i0.t(i);
        if (iT2 == 0) {
            return null;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        b bVar = (b) obj;
        return androidx.media3.common.util.i0.n(this.a, bVar.a) && this.b == bVar.b && Objects.equals(this.c, bVar.c) && Objects.equals(this.d, bVar.d);
    }

    public final int hashCode() {
        return Objects.hashCode(this.d) + ((Objects.hashCode(this.c) + ((androidx.media3.common.util.i0.o(this.a) + (this.b * 31)) * 31)) * 31);
    }
