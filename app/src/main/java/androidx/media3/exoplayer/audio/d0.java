...
public final class d0 {
    ...
    public final int h;
    public final c0 i;
    public final androidx.media3.common.util.o j = new androidx.media3.common.util.o(Thread.currentThread());
    public boolean k;
    public long l;
    public long m;
    public long n;
    ...
    public d0(AudioTrack audioTrack, p pVar, com.google.firebase.platforminfo.d dVar, float f, androidx.media3.common.util.d0 d0Var) {
        this.a = audioTrack;
        this.b = pVar;
        this.c = f;
        this.d = dVar;
        boolean zM = androidx.media3.common.util.i0.M(pVar.a);
        this.g = zM;
        if (zM) {
            this.h = androidx.media3.common.util.i0.u(pVar.a) * Integer.bitCount(pVar.c);
        } else {
            this.h = -1;
        }
        this.f = new g0(new com.app.mlounge.data.music.e(this, 28), d0Var, audioTrack, pVar.a, this.h, pVar.f);
        if (dVar != null) {
            this.e = new com.google.firebase.messaging.n(audioTrack, dVar);
        }
    ...
    public final long a() {
        ...
        Method method2;
        g0 g0Var2 = this.f;
        androidx.media3.common.util.d0 d0Var2 = g0Var2.b;
        y yVar = g0Var2.h;
        ...
        if (audioTrack.getPlayState() == 3) {
            ...
            if (jNanoTime2 - g0Var2.l >= 30000) {
                long jW = androidx.media3.common.util.i0.W(g0Var2.e, g0Var2.a());
                if (jW == 0) {
                    g0Var2 = g0Var2;
                    d0Var = d0Var2;
                    yVar = yVar;
                    ...
                    jArr[g0Var2.s] = androidx.media3.common.util.i0.E(g0Var2.i, jW) - jNanoTime2;
                        ...
                        if (jNanoTime2 - g0Var2.o >= 500000) {
                            try {
                                ...
                                try {
                                    ...
                                    g0Var2.n = jMax;
                                    if (jMax > 10000000) {
                                        androidx.media3.common.util.b.t("AudioTrackAudioOutput", "Ignoring impossibly large audio latency: " + jMax);
                                        g0Var2.n = 0L;
                                    }
                    ...
                    if (!z3 || jNanoTime2 - yVar.g >= yVar.f) {
                        ...
                        if (timestamp) {
                            ...
                            jB4 = androidx.media3.common.util.i0.B(f, jNanoTime2 - (xVar2.b.nanoTime / 1000)) + androidx.media3.common.util.i0.W(i2, xVar2.e);
                            if (Math.abs(j10 - jNanoTime2) > 5000000) {
                                long j13 = xVar.e;
                                eVar.getClass();
                                androidx.media3.common.util.b.t("AudioTrackAudioOutput", "Spurious audio timestamp (system clock mismatch): " + j13 + ", " + j10 + ", " + jNanoTime2 + ", " + jB3 + ", " + ((d0) eVar.y).b());
                                yVar.a(4);
                            } else {
                                yVar = yVar;
                                if (Math.abs(jB4 - jB3) > 5000000) {
                                    ...
                                    eVar.getClass();
                                    audioTrack = audioTrack;
                                    androidx.media3.common.util.b.t("AudioTrackAudioOutput", "Spurious audio timestamp (frame position mismatch): " + j14 + ", " + j10 + ", " + jNanoTime2 + ", " + jB3 + ", " + ((d0) eVar.y).b());
                                    yVar = yVar;
                                    i3 = 4;
                                    yVar.a(4);
                                } else {
                            ...
                            if (i4 != 0) {
                                ...
                                if (z4) {
                                    ...
                                    j9 = yVar.h;
                                    if (j8 <= j9) {
                                        if (Math.abs((androidx.media3.common.util.i0.B(f, jNanoTime2 - (xVar2.b.nanoTime / 1000)) + androidx.media3.common.util.i0.W(i2, xVar2.e)) - (androidx.media3.common.util.i0.B(f, jNanoTime2 - yVar.i) + androidx.media3.common.util.i0.W(i2, j9))) < 1000) {
                                            yVar.a(2);
                ...
                if (timestamp) {
                    ...
                    if (Math.abs(j10 - jNanoTime2) > 5000000) {
                        long j15 = xVar.e;
                        eVar.getClass();
                        androidx.media3.common.util.b.t("AudioTrackAudioOutput", "Spurious audio timestamp (system clock mismatch): " + j15 + ", " + j10 + ", " + jNanoTime2 + ", " + jB3 + ", " + ((d0) eVar.y).b());
                        yVar.a(4);
                    } else {
                        yVar = yVar;
                        if (Math.abs(jB4 - jB3) > 5000000) {
                            ...
                            eVar.getClass();
                            audioTrack = audioTrack;
                            androidx.media3.common.util.b.t("AudioTrackAudioOutput", "Spurious audio timestamp (frame position mismatch): " + j16 + ", " + j10 + ", " + jNanoTime2 + ", " + jB3 + ", " + ((d0) eVar.y).b());
                            yVar = yVar;
                            i3 = 4;
                            yVar.a(4);
                        } else {
            ...
            if (z2) {
                ...
                float f2 = g0Var.i;
                x xVar3 = yVar.a;
                jB = androidx.media3.common.util.i0.B(f2, jNanoTime - (xVar3.b.nanoTime / j)) + androidx.media3.common.util.i0.W(yVar.b, xVar3.e);
            } else {
                g0Var = g0Var2;
            ...
            if (playState == 3) {
                ...
                if (j2 != -9223372036854775807L) {
                    j3 = jK - g0Var.y;
                    jB2 = androidx.media3.common.util.i0.B(g0Var.i, jNanoTime - j2);
                    j4 = g0Var.y + jB2;
                    long jAbs = Math.abs(j4 - jK);
                    if (j3 != 0 && jAbs < 1000000) {
                        long j17 = (jB2 * 10) / 100;
                        jK = androidx.media3.common.util.i0.k(jK, j4 - j17, j4 + j17);
                    }
                }
                g0Var.z = jNanoTime;
                g0Var.y = jK;
        ...
        if (z2) {
            ...
            float f3 = g0Var.i;
            x xVar4 = yVar.a;
            jB = androidx.media3.common.util.i0.B(f3, jNanoTime - (xVar4.b.nanoTime / j)) + androidx.media3.common.util.i0.W(yVar.b, xVar4.e);
        } else {
            g0Var = g0Var2;
            jB = g0Var.b(jNanoTime);
        }
        ...
        if (playState == 3) {
            ...
            if (j2 != -9223372036854775807L) {
                ...
                if (j3 != 0) {
                    long j18 = (jB2 * 10) / 100;
                    jK = androidx.media3.common.util.i0.k(jK, j4 - j18, j4 + j18);
                }
            }
            g0Var.z = jNanoTime;
            g0Var.y = jK;
    ...
    public final boolean g(int i, long j, ByteBuffer byteBuffer) {
        ...
        androidx.media3.common.util.o oVar = this.j;
        oVar.getClass();
        ...
        if (threadCurrentThread == thread) {
            ...
            if (z3) {
                oVar.e(-1, new androidx.media3.exoplayer.analytics.d(23));
            }
        }
        ...
        if (z && (dVar = this.d) != null && (eVar = (f0Var = (f0) dVar.e).i) != null) {
            b bVar = b.f;
            f0Var.h = bVar;
            eVar.b(bVar);
        }
