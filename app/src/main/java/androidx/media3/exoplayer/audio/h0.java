...
public final class h0 extends androidx.media3.common.audio.n {
    ...
    public final void c(ByteBuffer byteBuffer) {
        ...
        while (iPosition < iLimit) {
            for (int i5 : iArr) {
                int iU = (androidx.media3.common.util.i0.u(this.b.c) * i5) + iPosition;
                int i6 = this.b.c;
                if (i6 == 2) {
                    ...
                    _COROUTINE.a.q(z, "Value out of range of 24-bit integer: %s", Integer.toHexString(i2));
                    _COROUTINE.a.o(byteBufferL.remaining() >= 3);
                    ...
                    if (i6 != 1879048192) {
                        kotlinx.coroutines.future.a.n(this.b.c, "Unexpected encoding: ");
                        return;
                    }
    ...
    public final androidx.media3.common.audio.j h(androidx.media3.common.audio.j jVar) throws androidx.media3.common.audio.l {
        ...
        int i2 = jVar.b;
        if (!androidx.media3.common.util.i0.M(i)) {
