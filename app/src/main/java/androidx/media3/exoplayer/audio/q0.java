...
public final class q0 extends androidx.media3.exoplayer.mediacodec.r implements androidx.media3.exoplayer.o0 {
    ...
    public final void F0() {
        ...
        if (!n0Var.n() || n0Var.F) {
            ...
            long jMin = Math.min(n0Var.t.a(), androidx.media3.common.util.i0.W(((p) n0Var.p.e).b, n0Var.j()));
            ...
            long jB = androidx.media3.common.util.i0.B(m0Var.a.a, jY);
            if (arrayDeque.isEmpty()) {
                ...
                if (!sVar.isActive()) {
                    ...
                    j = Long.MIN_VALUE;
                    long j4 = sVar.n;
                    jY = i == i2 ? androidx.media3.common.util.i0.Y(jY, jN, j4, RoundingMode.DOWN) : androidx.media3.common.util.i0.Y(jY, jN * ((long) i), j4 * ((long) i2), RoundingMode.DOWN);
                } else {
                    j = Long.MIN_VALUE;
            ...
            jMax = androidx.media3.common.util.i0.W(((p) n0Var.p.e).b, j5) + j2;
            long j6 = n0Var.Z;
            if (j5 > j6) {
                long jW = androidx.media3.common.util.i0.W(((p) n0Var.p.e).b, j5 - j6);
                n0Var.Z = j5;
                n0Var.a0 += jW;
                if (n0Var.b0 == null) {
    ...
    public final ArrayList R(androidx.media3.exoplayer.mediacodec.i iVar, androidx.media3.common.r rVar, boolean z) {
        ...
        Collections.sort(arrayList, new androidx.compose.ui.semantics.b0(new androidx.media3.exoplayer.analytics.c(2, this.f1, rVar), 1));
        return arrayList;
    }
    ...
    public final long S(long j, long j2, boolean z) {
        ...
        if (this.t1) {
            if (!n0Var.n()) {
                ...
                jY = androidx.media3.common.util.i0.W(((p) n0Var.p.e).b, n0Var.t.a.getBufferSizeInFrames());
            } else {
                long bufferSizeInFrames = n0Var.t.a.getBufferSizeInFrames();
                int iJ = androidx.media3.extractor.b.j(((p) n0Var.p.e).a);
                _COROUTINE.a.A(iJ != -2147483647);
                jY = androidx.media3.common.util.i0.Y(bufferSizeInFrames, 1000000L, iJ, RoundingMode.DOWN);
            }
    ...
    public final x1 U(androidx.media3.exoplayer.mediacodec.o oVar, androidx.media3.common.r rVar, MediaCrypto mediaCrypto, float f) {
        ...
        androidx.media3.common.util.b.o(mediaFormat, "max-input-size", i3);
        ...
        if ("audio/ac4".equals(str2)) {
            ...
            if (pairB != null) {
                ...
                androidx.media3.common.util.b.o(mediaFormat, "level", ((Integer) pairB.second).intValue());
            }
        ...
        if (Objects.equals(str2, "audio/iamf")) {
            ...
            int i6 = 12;
            if (bVar == null) {
                androidx.media3.common.util.b.t("MediaCodecAudioRenderer", "AudioCapabilities from the AudioSink are null, using default stereo output layout.");
        ...
        this.m1 = rVar4;
        return new x1(oVar, mediaFormat, rVar, null, mediaCrypto, this.i1);
    }
    ...
    public final void a(androidx.media3.common.l0 l0Var) {
        ...
        androidx.media3.common.l0 l0Var2 = new androidx.media3.common.l0(androidx.media3.common.util.i0.i(l0Var.a, 0.1f, 8.0f), androidx.media3.common.util.i0.i(l0Var.b, 0.1f, 8.0f));
        n0Var.x = l0Var2;
    ...
    public final void b0(Exception exc) {
        androidx.media3.common.util.b.g("MediaCodecAudioRenderer", "Audio codec error", exc);
        t tVar = this.g1;
    ...
    public final void d(int i, Object obj) {
        ...
        if (i0Var != null) {
            ...
            f0Var.f();
            if (f0Var.f == null) {
                f0Var.f = new androidx.media3.common.util.o(Thread.currentThread());
            }
            f0Var.f.a(i0Var);
        }
        n0Var.r();
    ...
    public final void d0(androidx.media3.exoplayer.b bVar) {
        ...
        Handler handler = tVar.a;
        if (handler != null) {
            handler.post(new androidx.activity.c(16, tVar, bVar));
        }
    }
    ...
    public final void g0(androidx.media3.common.r rVar, MediaFormat mediaFormat) throws androidx.media3.exoplayer.j {
        ...
        if (rVar2 != null) {
            ...
            if ("audio/raw".equals(rVar.o)) {
                ...
                iD = mediaFormat.containsKey("v-bits-per-sample") ? androidx.media3.common.util.i0.D(mediaFormat.getInteger("v-bits-per-sample"), ByteOrder.LITTLE_ENDIAN) : 2;
            }
            androidx.media3.common.q qVar = new androidx.media3.common.q();
            qVar.n = androidx.media3.common.i0.p("audio/raw");
            qVar.H = iD;
    ...
    public final void q(boolean z, boolean z2) {
        ...
        Handler handler = tVar.a;
        if (handler != null) {
            handler.post(new r(tVar, cVar, 6));
        }
        h1 h1Var = this.A;
        h1Var.getClass();
        boolean z3 = h1Var.b;
