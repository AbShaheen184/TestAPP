...
public final class s0 extends androidx.media3.common.audio.n {
    ...
    public final void c(ByteBuffer byteBuffer) {
        ...
        while (byteBuffer.hasRemaining() && !this.g.hasRemaining()) {
            ...
            if (i == 0) {
                ...
                _COROUTINE.a.A(this.t < this.s.length);
                ...
                int i6 = this.u + iMin;
                this.u = i6;
                _COROUTINE.a.A(i6 <= this.s.length);
        ...
        if (i == bArr.length || z) {
            if (this.r == 0) {
                if (z) {
                    ...
                    _COROUTINE.a.A(i >= bArr.length / 2);
            ...
            if (!(length % this.n == 0)) {
                kotlinx.coroutines.future.a.u(_COROUTINE.b.B("bytesConsumed is not aligned to frame size: %s", Integer.valueOf(length)));
                return;
            }
            _COROUTINE.a.A(i >= iM);
            this.u -= length;
    ...
    public final void o(int i, int i2) {
        ...
        _COROUTINE.a.l(i, "sizeToOutput is not aligned to frame size: %s", i % this.n == 0);
        _COROUTINE.a.A(this.t < this.s.length);
        byte[] bArr5 = this.v;
        _COROUTINE.a.l(i, "byteOutput size is not aligned to frame size %s", i % this.n == 0);
        if (i2 != 3) {
