...
public abstract class t0 {
    ...
    public static com.google.common.collect.h0 a(AudioDeviceInfo audioDeviceInfo) {
        ...
        for (AudioProfile audioProfile : audioProfiles) {
            if (audioProfile.getEncapsulationType() != 1 && androidx.media3.common.util.i0.M(audioProfile.getFormat())) {
    ...
    public static com.google.common.collect.h0 b(AudioDeviceInfo audioDeviceInfo) {
        ...
        boolean zH = com.google.firebase.b.H(audioDeviceInfo.getType());
        a1 a1Var = a;
        if (!zH) {
            ...
            if (audioDeviceInfo.getType() == 2) {
                ...
                androidx.media3.common.util.b.t("SpeakerLayoutUtil", "Built-in speaker's getSpeakerLayoutChannelMask not usable, defaulting to stereo.");
                return a1Var;
            }
                            ...
                            while (it.hasNext()) {
                                ...
                                if (audioDescriptorA.getStandard() == 2) {
                                    ...
                                    if (descriptor.length != 3) {
                                        androidx.media3.common.util.b.t("AudioDescriptorUtil", "Invalid SADB length: " + descriptor.length);
                                    } else {
                                        int i2 = 0;
