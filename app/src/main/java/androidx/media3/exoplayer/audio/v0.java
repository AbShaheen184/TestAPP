...
public final class v0 extends androidx.media3.common.audio.n {
    ...
    public final void c(ByteBuffer byteBuffer) {
        ...
        int iJ = androidx.media3.common.util.i0.j(length, 0, this.n);
        byteBufferL.put(this.m, 0, iJ);
        int iJ2 = androidx.media3.common.util.i0.j(length - iJ, 0, i2);
    ...
    public final long g(long j) {
        return Math.max(0L, j - androidx.media3.common.util.i0.W(this.b.a, this.j + this.i));
    }
    ...
    public final androidx.media3.common.audio.j h(androidx.media3.common.audio.j jVar) throws androidx.media3.common.audio.l {
        if (!androidx.media3.common.util.i0.M(jVar.c)) {
    ...
    @Override // androidx.media3.common.audio.n
    public final void k() {
        this.m = androidx.media3.common.util.i0.b;
    }
}
