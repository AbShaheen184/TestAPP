...
public final class c0 implements ExoPlayer, androidx.media3.common.q0 {
    ...
    public final b0 D;
    public final androidx.localbroadcastmanager.content.b E;
    public final androidx.localbroadcastmanager.content.b F;
    public int G;
    public boolean H;
    public int I;
    public int J;
    ...
    public final int Z;
    public androidx.media3.common.util.w a0;
    ...
    public final androidx.media3.common.util.f0 j;
    public final long j0;
    public final r k;
    public final long k0;
    public final k0 l;
    public final long l0;
    public final androidx.media3.common.util.o m;
    ...
    public final androidx.media3.common.util.d0 u;
    public final x v;
    public final y w;
    public final androidx.compose.foundation.lazy.layout.b1 x;
    public final androidx.media3.common.util.l0 y;
    public final androidx.media3.common.util.m0 z;
    public final androidx.media3.common.u0 a = new androidx.media3.common.u0();
    public final androidx.media3.common.util.g d = new androidx.media3.common.util.g();
    ...
    public c0(k kVar) {
        try {
            androidx.media3.common.util.b.k("ExoPlayerImpl", "Init " + Integer.toHexString(System.identityHashCode(this)) + " [AndroidXMedia3/1.10.1] [" + androidx.media3.common.util.i0.a + "]");
            Context context = kVar.a;
            Looper looper = kVar.h;
            androidx.media3.common.util.d0 d0Var = kVar.b;
            this.e = context.getApplicationContext();
            this.r = new androidx.media3.exoplayer.analytics.g(d0Var);
            this.g0 = kVar.i;
            this.b0 = kVar.j;
            this.Z = kVar.k;
            this.c0 = false;
            ...
            this.v = xVar;
            this.w = new y();
            a[] aVarArrK = ((androidx.work.impl.k) kVar.c.y).k(new Handler(looper), xVar, xVar, xVar, xVar);
            this.g = aVarArrK;
            _COROUTINE.a.A(aVarArrK.length > 0);
            this.h = new a[aVarArrK.length];
            int i = 0;
            while (true) {
                a[] aVarArr = this.h;
                if (i >= aVarArr.length) {
            ...
            this.u = d0Var;
            this.f = this;
            this.m = new androidx.media3.common.util.o(new CopyOnWriteArraySet(), looper, looper.getThread(), d0Var, new androidx.core.graphics.b(), true);
            this.n = new CopyOnWriteArraySet();
            this.p = new ArrayList();
            this.P = new androidx.media3.exoplayer.source.a1();
            this.Q = l.a;
            a[] aVarArr2 = this.g;
            ...
            for (int i5 = 0; i5 < sparseBooleanArray2.size(); i5++) {
                _COROUTINE.a.s(i5, sparseBooleanArray2.size());
            ...
            k0 k0Var = new k0(this.e, this.g, this.h, this.i, this.b, (g) kVar.f.get(), this.t, this.G, this.H, this.r, this.O, kVar.r, kVar.s, this.s, this.u, rVar, kVar2, this.Q, this.w, kVar.B);
            androidx.media3.common.util.f0 f0Var = k0Var.E;
            this.l = k0Var;
            ...
            androidx.media3.common.util.o oVar2 = this.m;
            gVar.getClass();
            oVar2.a(gVar);
            ...
            cVar.getClass();
            CopyOnWriteArrayList<androidx.media3.exoplayer.upstream.c> copyOnWriteArrayList = (CopyOnWriteArrayList) cVar.y;
            ...
            if (i6 >= 31) {
                this.u.a(k0Var.G, null).d(new t(this.e, kVar.y, this, kVar2));
            }
            Looper looper3 = this.s;
            androidx.media3.common.util.d0 d0Var2 = this.u;
            r rVar2 = new r(this);
            androidx.appcompat.widget.o oVar3 = new androidx.appcompat.widget.o();
            oVar3.b = d0Var2.a(looper2, null);
            oVar3.c = d0Var2.a(looper3, null);
            oVar3.e = 0;
            oVar3.f = 0;
            oVar3.d = rVar2;
            this.B = oVar3;
            oVar3.j(new androidx.activity.l(this, 13));
            ...
            androidx.media3.common.util.l0 l0Var = new androidx.media3.common.util.l0(context, looper2, this.u);
            this.y = l0Var;
            if (l0Var.b != z) {
                l0Var.b = z;
                l0Var.a(z, l0Var.c);
            }
            androidx.media3.common.util.d0 d0Var3 = this.u;
            androidx.media3.common.util.m0 m0Var = new androidx.media3.common.util.m0();
            new com.google.firebase.heartbeatinfo.e(context.getApplicationContext());
            d0Var3.a(looper2, null);
            d0Var3.a(Looper.getMainLooper(), null);
            this.z = m0Var;
            int i7 = androidx.media3.common.j.c;
            this.i0 = androidx.media3.common.f1.d;
            this.a0 = androidx.media3.common.util.w.c;
            this.D = i6 >= 34 ? new b0(this, context) : null;
            this.E = new androidx.localbroadcastmanager.content.b(8);
            this.F = new androidx.localbroadcastmanager.content.b(8);
            ...
            e0VarC.a = f0Var.a.obtainMessage(31, 0, 0, eVar);
            e0VarC.b();
            J(1, 3, this.b0);
    ...
    public final Pair A(androidx.media3.common.v0 v0Var, int i, long j) {
        ...
        if (i == -1 || i >= v0Var.o()) {
            i = v0Var.a(this.H);
            j = androidx.media3.common.util.i0.d0(v0Var.m(i, this.a, 0L).l);
        }
        return v0Var.i(this.a, this.o, i, androidx.media3.common.util.i0.Q(j));
    }

    public final void B(final int i, final int i2) {
        androidx.media3.common.util.w wVar = this.a0;
        if (i == wVar.a && i2 == wVar.b) {
            return;
        }
        this.a0 = new androidx.media3.common.util.w(i, i2);
        this.m.e(24, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.p
            @Override // androidx.media3.common.util.l
            public final void invoke(Object obj) {
                ((androidx.media3.common.o0) obj).D(i, i2);
            }
        });
        J(2, 14, new androidx.media3.common.util.w(i, i2));
    }
    ...
    public final void D(androidx.media3.common.o0 o0Var) {
        V();
        o0Var.getClass();
        androidx.media3.common.util.o oVar = this.m;
        if (oVar.i) {
            _COROUTINE.a.A(Thread.currentThread() == oVar.a);
        }
        CopyOnWriteArraySet<androidx.media3.common.util.n> copyOnWriteArraySet = oVar.d;
        for (androidx.media3.common.util.n nVar : copyOnWriteArraySet) {
            if (nVar.a.equals(o0Var)) {
                androidx.media3.common.util.m mVar = oVar.c;
                nVar.d = true;
                if (mVar != null && nVar.c) {
                    nVar.c = false;
    ...
    public final void E() {
        ...
        if (textureView != null) {
            if (textureView.getSurfaceTextureListener() != xVar) {
                androidx.media3.common.util.b.t("ExoPlayerImpl", "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    public final void F(long j, int i, boolean z) {
        ...
        if (v0Var.p() || i < v0Var.o()) {
            ...
            if (!gVar.F) {
                ...
                gVar.F = true;
                gVar.M(aVarH, -1, new v(16));
            }
            this.I++;
            if (x()) {
                androidx.media3.common.util.b.t("ExoPlayerImpl", "seekTo ignored because an ad is playing");
            ...
            this.l.E.b(3, new j0(v0Var, i, androidx.media3.common.util.i0.Q(j))).b();
    ...
    public final void K(androidx.media3.exoplayer.source.a aVar) {
        ...
        androidx.media3.exoplayer.source.a1 a1Var2 = this.P;
        int size = arrayList2.size();
        a1Var2.getClass();
        this.P = new androidx.media3.exoplayer.source.a1(new Random(a1Var2.a.nextLong())).a(size);
        ...
        this.l.E.b(17, new g0(arrayList2, this.P, iA, androidx.media3.common.util.i0.Q(-9223372036854775807L))).b();
    ...
    public final void N(int i) {
        ...
        if (this.G != i) {
            this.G = i;
            androidx.media3.common.util.f0 f0Var = this.l.E;
            f0Var.getClass();
            androidx.media3.common.util.e0 e0VarC = androidx.media3.common.util.f0.c();
            e0VarC.a = f0Var.a.obtainMessage(11, i, 0);
            e0VarC.b();
            q qVar = new q(i, 0);
            androidx.media3.common.util.o oVar = this.m;
            oVar.c(8, qVar);
    ...
    public final void P(Object obj) {
        ...
        if (!k0Var.g0 && k0Var.G.getThread().isAlive()) {
            ...
            k0Var.E.b(30, new Pair(obj, gVar)).b();
            if (j != -9223372036854775807L) {
                zB = gVar.b(j);
            }
        }
    ...
    public final void R() {
        ...
        com.google.firebase.platforminfo.d dVar = new com.google.firebase.platforminfo.d(26);
        androidx.core.text.f fVar = (androidx.core.text.f) dVar.e;
        SparseBooleanArray sparseBooleanArray = this.c.a.a;
        fVar.getClass();
        for (int i3 = 0; i3 < sparseBooleanArray.size(); i3++) {
            _COROUTINE.a.s(i3, sparseBooleanArray.size());
            fVar.b(sparseBooleanArray.keyAt(i3));
        }
        boolean z5 = !zX;
        dVar.f(4, z5);
        dVar.f(5, z && !zX);
        dVar.f(6, z2 && !zX);
        dVar.f(7, !zP && (z2 || !zV || z) && !zX);
        dVar.f(8, z3 && !zX);
        dVar.f(9, !zP && (z3 || (zV && z4)) && !zX);
        dVar.f(10, z5);
        dVar.f(11, z && !zX);
        dVar.f(12, z && !zX);
        androidx.media3.common.m0 m0Var2 = new androidx.media3.common.m0(fVar.c());
        this.R = m0Var2;
    ...
    public final void S(int i, boolean z) {
        ...
        f0Var.getClass();
        androidx.media3.common.util.e0 e0VarC = androidx.media3.common.util.f0.c();
        e0VarC.a = f0Var.a.obtainMessage(1, z ? 1 : 0, i3);
        e0VarC.b();
    ...
    public final void T(final c1 c1Var, int i, boolean z, int i2, long j, int i3, boolean z2) {
        ...
        if (z) {
            ...
            long jD0 = androidx.media3.common.util.i0.d0(jS);
            long jD1 = androidx.media3.common.util.i0.d0(jS2);
            ...
            int i11 = i10;
            long jD2 = androidx.media3.common.util.i0.d0(j);
            long jD3 = this.n0.b.b() ? androidx.media3.common.util.i0.d0(s(this.n0)) : jD2;
            androidx.media3.exoplayer.source.v vVar6 = this.n0.b;
            this.m.c(11, new m(i2, p0Var, new androidx.media3.common.p0(obj3, iH, c0Var3, obj4, i11, jD2, jD3, vVar6.b, vVar6.c)));
        } else {
        ...
        if (zBooleanValue) {
            this.m.c(1, new n(c0Var, iIntValue, 0));
        }
        if (c1Var2.f != c1Var.f) {
            final int i12 = 0;
            this.m.c(10, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
        ...
        if (tVar != tVar2) {
            ...
            oVar.getClass();
            final int i14 = 2;
            this.m.c(2, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
        ...
        if (z5) {
            final int i15 = 3;
            this.m.c(3, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
                public final void invoke(Object obj9) {
                    androidx.media3.common.o0 o0Var = (androidx.media3.common.o0) obj9;
                    switch (i15) {
        ...
        if (z4 || z3) {
            final int i16 = 4;
            this.m.c(-1, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
                public final void invoke(Object obj9) {
                    androidx.media3.common.o0 o0Var = (androidx.media3.common.o0) obj9;
                    switch (i16) {
        ...
        if (z4) {
            final int i17 = 5;
            this.m.c(4, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
                public final void invoke(Object obj9) {
                    androidx.media3.common.o0 o0Var = (androidx.media3.common.o0) obj9;
                    switch (i17) {
        ...
        if (z3 || c1Var2.m != c1Var.m) {
            final int i18 = 6;
            this.m.c(5, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
                public final void invoke(Object obj9) {
                    androidx.media3.common.o0 o0Var = (androidx.media3.common.o0) obj9;
                    switch (i18) {
        ...
        if (c1Var2.n != c1Var.n) {
            final int i19 = 7;
            this.m.c(6, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
                public final void invoke(Object obj9) {
                    androidx.media3.common.o0 o0Var = (androidx.media3.common.o0) obj9;
                    switch (i19) {
        ...
        if (c1Var2.m() != c1Var.m()) {
            final int i20 = 8;
            this.m.c(7, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
                public final void invoke(Object obj9) {
                    androidx.media3.common.o0 o0Var = (androidx.media3.common.o0) obj9;
                    switch (i20) {
        ...
        if (!c1Var2.o.equals(c1Var.o)) {
            final int i21 = 9;
            this.m.c(12, new androidx.media3.common.util.l() { // from class: androidx.media3.exoplayer.o
                @Override // androidx.media3.common.util.l
                public final void invoke(Object obj9) {
                    androidx.media3.common.o0 o0Var = (androidx.media3.common.o0) obj9;
                    switch (i21) {
    ...
    public final void U() {
        int iQ = q();
        androidx.media3.common.util.m0 m0Var = this.z;
        androidx.media3.common.util.l0 l0Var = this.y;
        boolean z = false;
        if (iQ != 1) {
            if (iQ == 2 || iQ == 3) {
                V();
    ...
    public final void V() {
        ...
        if (threadCurrentThread != looper.getThread()) {
            ...
            String strK = androidx.compose.runtime.j.k("Player is accessed on the wrong thread.\nCurrent thread: '", name, "'\nExpected thread: '", name2, "'\nSee https://developer.android.com/guide/topics/media/issues/player-accessed-on-wrong-thread");
            if (this.e0) {
                kotlinx.coroutines.future.a.u(strK);
            } else {
                androidx.media3.common.util.b.u("ExoPlayerImpl", strK, this.f0 ? null : new IllegalStateException());
                this.f0 = true;
            }
        }
    }
    ...
    public final long d() {
        ...
        if (c1Var.k.d != c1Var.b.d) {
            return androidx.media3.common.util.i0.d0(c1Var.a.m(h(), this.a, 0L).m);
        }
        long j2 = c1Var.q;
        if (this.n0.k.b()) {
            c1 c1Var2 = this.n0;
        ...
        androidx.media3.common.t0 t0Var = this.o;
        v0Var.g(obj, t0Var);
        return androidx.media3.common.util.i0.d0(j + t0Var.e);
    }
    ...
    public final long e(c1 c1Var) {
        ...
        if (!vVar.b()) {
            return androidx.media3.common.util.i0.d0(k(c1Var));
        }
        Object obj = c1Var.b.a;
        androidx.media3.common.t0 t0Var = this.o;
        v0Var.g(obj, t0Var);
        if (j == -9223372036854775807L) {
            return androidx.media3.common.util.i0.d0(v0Var.m(n(c1Var), this.a, 0L).l);
        }
        return androidx.media3.common.util.i0.d0(j) + androidx.media3.common.util.i0.d0(t0Var.e);
    }
    ...
    public final long j() {
        V();
        return androidx.media3.common.util.i0.d0(k(this.n0));
    }

    public final long k(c1 c1Var) {
        if (c1Var.a.p()) {
            return androidx.media3.common.util.i0.Q(this.p0);
        }
    ...
    public final long o() {
        ...
        if (!x()) {
            ...
            return androidx.media3.common.util.i0.d0(v0VarL.m(h(), this.a, 0L).m);
        }
        c1 c1Var = this.n0;
        androidx.media3.exoplayer.source.v vVar = c1Var.b;
        androidx.media3.common.v0 v0Var = c1Var.a;
        ...
        androidx.media3.common.t0 t0Var = this.o;
        v0Var.g(obj, t0Var);
        return androidx.media3.common.util.i0.d0(t0Var.a(vVar.b, vVar.c));
    }
    ...
    public final c1 z(c1 c1Var, androidx.media3.common.v0 v0Var, Pair pair) {
        List list;
        _COROUTINE.a.o(v0Var.p() || pair != null);
        androidx.media3.common.v0 v0Var2 = c1Var.a;
        long jE = e(c1Var);
        c1 c1VarJ = c1Var.j(v0Var);
        if (v0Var.p()) {
            androidx.media3.exoplayer.source.v vVar = c1.u;
            long jQ = androidx.media3.common.util.i0.Q(this.p0);
            c1 c1VarC = c1VarJ.d(vVar, jQ, jQ, jQ, 0L, androidx.media3.exoplayer.source.j1.d, this.b, com.google.common.collect.a1.B).c(vVar);
            c1VarC.q = c1VarC.s;
            return c1VarC;
        }
        ...
        long jQ2 = androidx.media3.common.util.i0.Q(jE);
        if (!v0Var2.p()) {
        ...
        if (!zEquals || jLongValue < jQ2) {
            ...
            _COROUTINE.a.A(!vVar3.b());
            androidx.media3.exoplayer.source.j1 j1Var = !zEquals ? androidx.media3.exoplayer.source.j1.d : c1VarJ.h;
            ...
            c1 c1VarC2 = c1VarJ.d(vVar3, jLongValue, jLongValue, jLongValue, 0L, j1Var, tVar, list).c(vVar3);
            c1VarC2.q = jLongValue;
            return c1VarC2;
        }
        if (jLongValue != jQ2) {
            androidx.media3.exoplayer.source.v vVar4 = vVar2;
            _COROUTINE.a.A(!vVar4.b());
