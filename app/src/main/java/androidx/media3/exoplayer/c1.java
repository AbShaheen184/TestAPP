...
public final class c1 {
    ...
    public final androidx.media3.exoplayer.source.j1 h;
    ...
    public c1(androidx.media3.common.v0 v0Var, androidx.media3.exoplayer.source.v vVar, long j, long j2, int i, j jVar, boolean z, androidx.media3.exoplayer.source.j1 j1Var, androidx.media3.exoplayer.trackselection.t tVar, List list, androidx.media3.exoplayer.source.v vVar2, boolean z2, int i2, int i3, androidx.media3.common.l0 l0Var, long j3, long j4, long j5, long j6, boolean z3) {
        this.a = v0Var;
        this.b = vVar;
        this.c = j;
        this.d = j2;
    ...
    public static c1 k(androidx.media3.exoplayer.trackselection.t tVar) {
        ...
        androidx.media3.exoplayer.source.j1 j1Var = androidx.media3.exoplayer.source.j1.d;
        ...
        return new c1(s0Var, vVar, -9223372036854775807L, 0L, 1, null, false, j1Var, tVar, a1Var, vVar, false, 1, 0, l0Var, 0L, 0L, 0L, 0L, false);
    }
    ...
    public final c1 d(androidx.media3.exoplayer.source.v vVar, long j, long j2, long j3, long j4, androidx.media3.exoplayer.source.j1 j1Var, androidx.media3.exoplayer.trackselection.t tVar, List list) {
        return new c1(this.a, vVar, j2, j3, this.e, this.f, this.g, j1Var, tVar, list, this.k, this.l, this.m, this.n, this.o, this.q, j4, j, SystemClock.elapsedRealtime(), this.p);
    }
    ...
    public final long l() {
        ...
        return androidx.media3.common.util.i0.Q(androidx.media3.common.util.i0.d0(j2) + ((long) ((SystemClock.elapsedRealtime() - j) * this.o.a)));
    }
