...
public final class e extends v0 {
    ...
    public e(long j, long j2, long j3, int i, long j4, long j5, long j6, androidx.media3.exoplayer.dash.manifest.c cVar, c0 c0Var, x xVar) {
        _COROUTINE.a.A(cVar.d == (xVar != null));
        this.b = j;
        this.c = j2;
        this.d = j3;
        this.e = i;
    ...
    public final t0 f(int i, t0 t0Var, boolean z) {
        ...
        long jD = cVar.d(i);
        long jQ = i0.Q(cVar.b(i).b - cVar.b(0).b) - this.f;
        t0Var.getClass();
    ...
    public final u0 m(int i, u0 u0Var, long j) {
        ...
        if (z3 && cVar.e != -9223372036854775807L && cVar.b == -9223372036854775807L) {
            ...
            if (i3 != -1 && (jVarC = ((androidx.media3.exoplayer.dash.manifest.m) ((androidx.media3.exoplayer.dash.manifest.a) hVarB.c.get(i3)).c.get(0)).c()) != null && jVarC.D(jD) != j4) {
