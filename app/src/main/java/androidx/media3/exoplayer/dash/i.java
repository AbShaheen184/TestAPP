...
public final class i extends androidx.media3.exoplayer.source.a {
    ...
    public final com.google.android.material.shape.f k;
    ...
    public i(c0 c0Var, androidx.media3.datasource.g gVar, androidx.media3.exoplayer.upstream.p pVar, androidx.appcompat.widget.x xVar, com.google.android.material.shape.f fVar, androidx.media3.exoplayer.drm.f fVar2, t2 t2Var, long j, long j2) {
        this.O = c0Var;
        this.P = c0Var.c;
        y yVar = c0Var.b;
        yVar.getClass();
        ...
        this.p = j2;
        this.k = fVar;
        this.n = new com.google.firebase.messaging.n(12);
        this.h = false;
        this.q = a(null);
        this.t = new Object();
    ...
    public final void p() {
        ...
        this.M = -9223372036854775807L;
        this.u.clear();
        com.google.firebase.messaging.n nVar2 = this.n;
        ((HashMap) nVar2.y).clear();
        ((HashMap) nVar2.z).clear();
        ((HashMap) nVar2.A).clear();
        this.l.c();
    }
    ...
    public final void u() {
        ...
        nVar.f(new com.google.android.material.shape.f(12), new h(dVar, 1), 1);
    }
    ...
    public final void w(IOException iOException) {
        androidx.media3.common.util.b.g("DashMediaSource", "Failed to resolve time offset.", iOException);
    ...
    public final void x(boolean z) {
        ...
        while (true) {
            ...
            if ((!zT || !z6) && !list4.isEmpty()) {
                ...
                if (jVarC2 == null || jVarC2.E(jD4, jQ6) == 0) {
                    jQ7 = jQ7;
                    break;
                }
        ...
        while (true) {
            ...
            if ((!zT2 || !z7) && !list6.isEmpty()) {
                ...
                long jE = jVarC3.E(jD3, jQ6);
                if (jE == j) {
                    j2 = j11;
                    break;
                } else {
                    long jM = (jVarC3.m(jD3, jQ6) + jE) - 1;
                    jMin3 = Math.min(jMin3, jVarC3.k(jM, jD3) + jVarC3.a(jM) + j11);
                }
            }
            i12++;
            jQ8 = j11;
        ...
        if (cVar4.d) {
            _COROUTINE.a.A(cVar4.a != -9223372036854775807L);
            long jQ9 = (jQ6 - i0.Q(this.G.a)) - jMax;
            x xVar4 = h().c;
            long jD0 = i0.d0(jQ9);
            ...
            if (jK2 > j20) {
                jK2 = i0.k(i0.d0(jQ9 - Math.min(j8, j13 / 2)), j19, j20);
            }
            long j22 = j20;
            float f2 = xVar4.d;
            if (f2 == -3.4028235E38f) {
            ...
            if (z3) {
                ...
                handler.postDelayed(cVar2, com.google.firebase.b.v(jQ4, 1000L, RoundingMode.CEILING));
            }
            if (this.H) {
                z();
                return;
        ...
        if (this.h) {
            ...
            if (z3) {
                ...
                handler2.postDelayed(cVar2, com.google.firebase.b.v(jQ4, 1000L, RoundingMode.CEILING));
            }
            if (this.H) {
                z();
                return;
