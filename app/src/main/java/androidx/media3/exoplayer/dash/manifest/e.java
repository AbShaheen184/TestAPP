...
public final class e extends DefaultHandler implements androidx.media3.exoplayer.upstream.p {
    ...
    public e() {
        try {
            ...
            t0.j("Couldn't create XmlPullParserFactory instance", e);
            throw null;
        }
    }
  ...
  0x0093: PHI (r13v30 int) = (r13v5 int), (r13v8 int), (r13v33 int) binds: [B:128:0x01a3, B:120:0x0190, B:47:0x008f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static int c(XmlPullParser xmlPullParser, String str) throws XmlPullParserException, IOException {
        ...
        switch (attributeValue) {
            ...
            case "tag:dolby.com,2015:dash:audio_channel_configuration:2015":
                ...
                if (attributeValue3 != null && attributeValue3.length() == 6) {
                    ...
                    if ((8388608 & i4) == 0) {
                        ...
                        String[] strArrB0 = i0.b0(str);
                        if (strArrB0.length != 0) {
                            List listD = u1.b('.').d(com.imsdk.a.B(strArrB0[0].trim()));
            ...
            case "urn:dolby:dash:audio_channel_configuration:2011":
                ...
                if (attributeValue5 != null) {
                    String strB = com.imsdk.a.B(attributeValue5);
                    strB.getClass();
                    switch (strB.hashCode()) {
                        case 1596796:
                            b = !strB.equals("4000") ? (byte) -1 : (byte) 0;
                            break;
                        case 2937391:
                            b = !strB.equals("a000") ? (byte) -1 : (byte) 1;
                            break;
                        case 3094034:
                            b = !strB.equals("f800") ? (byte) -1 : (byte) 2;
                            break;
                        case 3094035:
                            b = !strB.equals("f801") ? (byte) -1 : (byte) 3;
                            break;
                        case 3133436:
                            if (!strB.equals("fa01")) {
                                b = -1;
        ...
        do {
            xmlPullParser.next();
        } while (!androidx.media3.common.util.b.l(xmlPullParser, "AudioChannelConfiguration"));
        return i3;
    }
    ...
    public static ArrayList f(XmlPullParser xmlPullParser, ArrayList arrayList, boolean z2) throws XmlPullParserException, IOException {
        ...
        } while (!androidx.media3.common.util.b.l(xmlPullParser, "BaseURL"));
        if (text != null && androidx.media3.common.util.b.j(text)[0] != -1) {
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            ...
            String strQ = androidx.media3.common.util.b.q(bVar.a, text);
    ...
    public static Pair g(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (attributeValue3 != null) {
            String strB = com.imsdk.a.B(attributeValue3);
            strB.getClass();
            switch (strB) {
                ...
                case "urn:mpeg:dash:mp4protection:2011":
                    ...
                    if (!TextUtils.isEmpty(attributeValue2) && !"00000000-0000-0000-0000-000000000000".equals(attributeValue2)) {
                        ...
                        androidx.media3.common.util.b.t("MpdParser", "Ignoring <ContentProtection> with schemeIdUri=\"urn:mpeg:dash:mp4protection:2011\" (ClearKey) due to missing required default_KID attribute.");
                        uuid = null;
                        uuid2 = uuid;
                        text = uuid2;
                        A2 = uuid2;
        ...
        do {
            xmlPullParser.next();
            if ((androidx.media3.common.util.b.n(xmlPullParser, "clearkey:Laurl") || androidx.media3.common.util.b.n(xmlPullParser, "dashif:Laurl")) && xmlPullParser.next() == 4) {
                A2 = A2;
                text = xmlPullParser.getText();
            } else if (androidx.media3.common.util.b.n(xmlPullParser, "ms:laurl")) {
                A2 = A2;
                ...
                if (name.equals("pssh") && xmlPullParser.next() == 4) {
                    ...
                    UUID uuid4 = tVarH == null ? null : (UUID) tVarH.e;
                    if (uuid4 == null) {
                        androidx.media3.common.util.b.t("MpdParser", "Skipping malformed cenc:pssh data");
                        uuid = uuid4;
                        A2 = 0;
                        text = text;
                    } else {
                ...
                uuid3 = androidx.media3.common.g.e;
                if (!uuid3.equals(uuid) && androidx.media3.common.util.b.n(xmlPullParser, "mspr:pro") && xmlPullParser.next() == 4) {
        ...
        } while (!androidx.media3.common.util.b.l(xmlPullParser, "ContentProtection"));
    ...
    public static f i(XmlPullParser xmlPullParser, String str) throws XmlPullParserException, IOException {
        ...
        do {
            xmlPullParser.next();
        } while (!androidx.media3.common.util.b.l(xmlPullParser, str));
    ...
    public static long j(XmlPullParser xmlPullParser, String str, long j) {
        ...
        Matcher matcher = i0.e.matcher(attributeValue);
        if (!matcher.matches()) {
    ...
    public static c l(XmlPullParser xmlPullParser, Uri uri) throws XmlPullParserException, IOException {
        ...
        long jT = attributeValue2 == null ? -9223372036854775807L : i0.T(attributeValue2);
        ...
        long jT2 = attributeValue3 == null ? -9223372036854775807L : i0.T(attributeValue3);
        ...
        while (true) {
            ...
            if (androidx.media3.common.util.b.n(xmlPullParser, "BaseURL")) {
                if (i33 == 0) {
                    jD = d(xmlPullParser, jD);
                    i33 = i;
                }
                arrayList19.addAll(f(xmlPullParser, arrayListP, z2));
                ...
                i3 = i;
                String str32 = "lang";
                if (androidx.media3.common.util.b.n(xmlPullParser, "ProgramInformation")) {
                    ...
                    while (true) {
                        xmlPullParser.next();
                        long j24 = j17;
                        if (androidx.media3.common.util.b.n(xmlPullParser, "Title")) {
                            strNextText = xmlPullParser.nextText();
                        } else if (androidx.media3.common.util.b.n(xmlPullParser, "Source")) {
                            strNextText2 = xmlPullParser.nextText();
                        } else if (androidx.media3.common.util.b.n(xmlPullParser, "Copyright")) {
                        ...
                        if (androidx.media3.common.util.b.l(xmlPullParser, "ProgramInformation")) {
                            arrayListP = arrayListP;
                    ...
                    long j25 = j17;
                    if (androidx.media3.common.util.b.n(xmlPullParser, "UTCTiming")) {
                        ...
                        if (androidx.media3.common.util.b.n(xmlPullParser, "Location")) {
                            uriR = androidx.media3.common.util.b.r(uri.toString(), xmlPullParser.nextText());
                        } else if (androidx.media3.common.util.b.n(xmlPullParser, "ServiceDescription")) {
                            ...
                            while (true) {
                                xmlPullParser.next();
                                if (androidx.media3.common.util.b.n(xmlPullParser, "Latency")) {
                                    arrayListP = arrayListP;
                                    ...
                                    arrayListP = arrayListP;
                                    if (androidx.media3.common.util.b.n(xmlPullParser, "PlaybackRate")) {
                                ...
                                long j32 = j21;
                                long j33 = j28;
                                if (androidx.media3.common.util.b.l(xmlPullParser, "ServiceDescription")) {
                                    w wVar2 = new w();
                                    wVar2.a = j29;
                                    wVar2.b = j31;
                                    wVar2.c = j33;
                            ...
                            long j34 = jD;
                            long j35 = j21;
                            if (androidx.media3.common.util.b.n(xmlPullParser, "Period") && i34 == 0) {
                                ...
                                long j36 = j(xmlPullParser, "start", j23);
                                String str39 = "duration";
                                String str40 = "schemeIdUri";
                                long j37 = jT != j25 ? jT + j36 : j25;
                                long j38 = j(xmlPullParser, "duration", j25);
                                ...
                                while (true) {
                                    xmlPullParser.next();
                                    if (androidx.media3.common.util.b.n(xmlPullParser, str31)) {
                                        if (i35 == 0) {
                                            jD2 = d(xmlPullParser, jD2);
                                            i35 = i3;
                                        }
                                        arrayList23.addAll(f(xmlPullParser, arrayList20, z2));
                                        ...
                                        if (androidx.media3.common.util.b.n(xmlPullParser, "AdaptationSet")) {
                                            ...
                                            long j40 = attributeValue12 == null ? -1L : Long.parseLong(attributeValue12);
                                            ...
                                            while (true) {
                                                ...
                                                if (androidx.media3.common.util.b.n(xmlPullParser, str31)) {
                                                    ...
                                                    j8 = jD3;
                                                    arrayList33.addAll(f(xmlPullParser, arrayList3, z2));
                                                } else {
                                                    j8 = jD3;
                                                    if (androidx.media3.common.util.b.n(xmlPullParser, "ContentProtection")) {
                                                    ...
                                                    } else if (androidx.media3.common.util.b.n(xmlPullParser, "ContentComponent")) {
                                                        String attributeValue22 = xmlPullParser.getAttributeValue(null, str32);
                                                        if (str55 == null) {
                                                            str55 = attributeValue22;
                                                        } else if (attributeValue22 != null) {
                                                            _COROUTINE.a.A(str55.equals(attributeValue22));
                                                        }
                                                        int iH2 = h(xmlPullParser);
                                                        if (i40 == -1) {
                                                            i40 = iH2;
                                                        } else if (iH2 != -1) {
                                                            _COROUTINE.a.A(i40 == iH2 ? i3 : i2);
                                                        }
                                                        ...
                                                        if (androidx.media3.common.util.b.n(xmlPullParser, "Role")) {
                                                            arrayList29.add(i(xmlPullParser, "Role"));
                                                        } else {
                                                            String str58 = "AudioChannelConfiguration";
                                                            if (androidx.media3.common.util.b.n(xmlPullParser, "AudioChannelConfiguration")) {
                                                                ...
                                                                if (androidx.media3.common.util.b.n(xmlPullParser, "Accessibility")) {
                                                                    arrayList28.add(i(xmlPullParser, "Accessibility"));
                                                                } else if (androidx.media3.common.util.b.n(xmlPullParser, "EssentialProperty")) {
                                                                    arrayList30.add(i(xmlPullParser, "EssentialProperty"));
                                                                } else {
                                                                    arrayList25 = arrayList25;
                                                                    if (androidx.media3.common.util.b.n(xmlPullParser, "SupplementalProperty")) {
                                                                        arrayList31.add(i(xmlPullParser, "SupplementalProperty"));
                                                                        ...
                                                                        arrayList28 = arrayList28;
                                                                        if (androidx.media3.common.util.b.n(xmlPullParser, "Representation")) {
                                                                            ...
                                                                            while (true) {
                                                                                ...
                                                                                if (androidx.media3.common.util.b.n(xmlPullParser, str31)) {
                                                                                    ...
                                                                                    f4 = f;
                                                                                    arrayList39.addAll(f(xmlPullParser, arrayList34, z2));
                                                                                } else {
                                                                                    f4 = f;
                                                                                    if (androidx.media3.common.util.b.n(xmlPullParser, str58)) {
                                                                                        iC2 = c(xmlPullParser, str69);
                                                                                    } else {
                                                                                        String str77 = str46;
                                                                                        if (androidx.media3.common.util.b.n(xmlPullParser, str77)) {
                                                                                            str14 = str77;
                                                                                            ...
                                                                                            str58 = str58;
                                                                                            String str78 = str45;
                                                                                            if (androidx.media3.common.util.b.n(xmlPullParser, str78)) {
                                                                                                arrayList33 = arrayList33;
                                                                                                str31 = str31;
                                                                                                long jD5 = d(xmlPullParser, j42);
                                                                                                str45 = str78;
                                                                                                str14 = str77;
                                                                                                str55 = str55;
                                                                                                str69 = str69;
                                                                                                ...
                                                                                                str61 = str61;
                                                                                                str74 = str74;
                                                                                                sVarR = q(xmlPullParser, (o) sVar2, j43, j44, jD4, jD5, j45);
                                                                                                arrayList8 = arrayList37;
                                                                                                ...
                                                                                                j12 = j38;
                                                                                                String str79 = str42;
                                                                                                if (androidx.media3.common.util.b.n(xmlPullParser, str79)) {
                                                                                                    j = j46;
                                                                                                    long jD6 = d(xmlPullParser, j42);
                                                                                                    z2 = z2;
                                                                                                    arrayList34 = arrayList34;
                                                                                                    str42 = str79;
                                                                                                    j13 = j47;
                                                                                                    ...
                                                                                                    str42 = str79;
                                                                                                    j13 = j47;
                                                                                                    if (androidx.media3.common.util.b.n(xmlPullParser, str59)) {
                                                                                                        ...
                                                                                                        str74 = str74;
                                                                                                        arrayList7 = arrayList35;
                                                                                                        if (androidx.media3.common.util.b.n(xmlPullParser, str74)) {
                                                                                                            j14 = j42;
                                                                                                            arrayList36.add(i(xmlPullParser, str74));
                                                                                                            arrayList8 = arrayList37;
                                                                                                        } else {
                                                                                                            j14 = j42;
                                                                                                            ArrayList arrayList42 = arrayList36;
                                                                                                            if (androidx.media3.common.util.b.n(xmlPullParser, str64)) {
                                                                                                                arrayList36 = arrayList42;
                                                                                                                arrayList8 = arrayList37;
                                                                                                                arrayList8.add(i(xmlPullParser, str64));
                                                                                                            } else {
                                                                                                                arrayList36 = arrayList42;
                                                                                                                str62 = str62;
                                                                                                                arrayList8 = arrayList37;
                                                                                                                if (androidx.media3.common.util.b.n(xmlPullParser, str62)) {
                                                                                                                    j11 = j11;
                                                                                                                    arrayList38 = arrayList38;
                                                                                                                    arrayList38.add(i(xmlPullParser, str62));
                                                                                                                } else {
                                                                                                                    j11 = j11;
                                                                                                                    arrayList38 = arrayList38;
                                                                                                                    b(xmlPullParser);
                                                                                    ...
                                                                                    if (androidx.media3.common.util.b.l(xmlPullParser, str61)) {
                                                                                        if (androidx.media3.common.i0.k(str67)) {
                                                                                            strE = androidx.media3.common.i0.b(str69);
                                                                                        } else {
                                                                                            if (androidx.media3.common.i0.o(str67)) {
                                                                                                strE = androidx.media3.common.i0.j(str69);
                                                                                            } else if (androidx.media3.common.i0.n(str67) && !androidx.media3.common.i0.m(str67)) {
                                                                                                str16 = str67;
                                                                                                if ("application/mp4".equals(str16)) {
                                                                                                    strE = androidx.media3.common.i0.e(str69);
                                                                                            ...
                                                                                            if ("audio/eac3".equals(strE)) {
                                                                                                ...
                                                                                                if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                                    androidx.media3.common.h hVarX = i0.x(str17, str71, str73);
                                                                                                    if (str71 != 0) {
                                                                                                        str24 = str71;
                                                                                                    } else {
                                                                                                        str24 = str17;
                                                                                                ...
                                                                                                while (true) {
                                                                                                    ...
                                                                                                    if (i9 < arrayList29.size()) {
                                                                                                        ...
                                                                                                        String str81 = str16;
                                                                                                        if (!com.imsdk.a.j("urn:mpeg:dash:role:2011", fVar4.a)) {
                                                                                                            str23 = fVar4.b;
                                                                                                        ...
                                                                                                        while (i11 < arrayList10.size()) {
                                                                                                            ...
                                                                                                            if (com.imsdk.a.j("urn:mpeg:dash:role:2011", fVar3.a)) {
                                                                                                                iN |= n(fVar3.b);
                                                                                                            }
                                                                                                            i11++;
                                                                                                        ...
                                                                                                        while (i12 < arrayList28.size()) {
                                                                                                            ...
                                                                                                            int i46 = iN;
                                                                                                            str22 = fVar2.b;
                                                                                                            if (com.imsdk.a.j("urn:mpeg:dash:role:2011", str21)) {
                                                                                                                iN2 = n(str22);
                                                                                                            } else {
                                                                                                                if (com.imsdk.a.j("urn:tva:metadata:cs:AudioPurposeCS:2007", fVar2.a)) {
                                                                                                                    i13 = i22;
                                                                                                                } else if (str22 == null) {
                                                                                                        ...
                                                                                                        while (true) {
                                                                                                            if (i14 < arrayList8.size()) {
                                                                                                                ...
                                                                                                                if ((com.imsdk.a.j("http://dashif.org/thumbnail_tile", fVar.a) || com.imsdk.a.j("http://dashif.org/guidelines/thumbnail_tile", fVar.a)) && (str20 = fVar.b) != null) {
                                                                                                                    String str83 = i0.a;
                                                                                                        ...
                                                                                                        qVar.m = androidx.media3.common.i0.p(str82);
                                                                                                        ...
                                                                                                        qVar.N = iIntValue2;
                                                                                                        if (androidx.media3.common.i0.o(strE)) {
                                                                                                            qVar.u = i6;
                                                                                                            qVar.v = i7;
                                                                                                            qVar.y = fK2;
                                                                                                        } else {
                                                                                                            i15 = i6;
                                                                                                            i16 = i7;
                                                                                                            if (androidx.media3.common.i0.k(strE)) {
                                                                                                                qVar.F = i8;
                                                                                                                qVar.G = i42;
                                                                                                            } else if (androidx.media3.common.i0.n(strE)) {
                                                                                                                        ...
                                                                                                                        if (i19 < arrayList11.size()) {
                                                                                                                            ...
                                                                                                                            if (!"urn:scte:dash:cc:cea-608:2015".equals(str19) && str85 != null) {
                                                                                                                                ...
                                                                                                                                if (matcher.matches()) {
                                                                                                                                    ...
                                                                                                                                    androidx.media3.common.util.b.t("MpdParser", "Unable to parse CEA-608 channel number from: ".concat(str85));
                                                                                                                                }
                                                                                                                            }
                                                                                                                            i19++;
                                                                                                                            i3 = 1;
                                                                                                                        ...
                                                                                                                        if (i17 < arrayList11.size()) {
                                                                                                                            ...
                                                                                                                            if (!"urn:scte:dash:cc:cea-708:2015".equals(str18) && str86 != null) {
                                                                                                                                ...
                                                                                                                                if (matcher2.matches()) {
                                                                                                                                    ...
                                                                                                                                    androidx.media3.common.util.b.t("MpdParser", "Unable to parse CEA-708 service block number from: ".concat(str86));
                                                                                                                                }
                                                                                                                            }
                                                                                                                            i17++;
                                                                                                                        } else {
                                                                                                                ...
                                                                                                                qVar.K = i18;
                                                                                                            } else if (androidx.media3.common.i0.m(strE)) {
                                                                                                                qVar.u = i15;
                                                                                                                qVar.v = i16;
                                                                                                            }
                                                                                                        }
                                                                                                        ...
                                                                                                        i20 = androidx.media3.common.i0.i(rVar3.o);
                                                                                                        i21 = i43;
                                                                                                        if (i21 != -1) {
                                                                                                            if (i20 != -1) {
                                                                                                                if (i21 == i20) {
                                                                                            ...
                                                                                            str17 = str69;
                                                                                            if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                                androidx.media3.common.h hVarX2 = i0.x(str17, str71, str73);
                                                                                                if (str71 != 0) {
                                                                                                    str24 = str71;
                                                                                                } else {
                                                                                                    str24 = str17;
                                                                                                ...
                                                                                                if (i9 < arrayList29.size()) {
                                                                                                    ...
                                                                                                    while (true) {
                                                                                                        if (i14 < arrayList8.size()) {
                                                                                                            fVar = (f) arrayList8.get(i14);
                                                                                                            arrayList12 = arrayList8;
                                                                                                            if (com.imsdk.a.j("http://dashif.org/thumbnail_tile", fVar.a)) {
                                                                                                                String str89 = i0.a;
                                                                                                                strArrSplit = str20.split("x", -1);
                                                                                                                if (strArrSplit.length != 2) {
                                                                                                                    continue;
                                                                                                    ...
                                                                                                    qVar = new androidx.media3.common.q();
                                                                                                    qVar.a = attributeValue23;
                                                                                                    qVar.m = androidx.media3.common.i0.p(str88);
                                                                                                    qVar.n = androidx.media3.common.i0.p(strE);
                                                                                                    qVar.j = str17;
                                                                                                    qVar.i = i5;
                                                                                                    qVar.e = i10;
                                                                                                    ...
                                                                                                    i20 = androidx.media3.common.i0.i(rVar4.o);
                                                                                                    i21 = i43;
                                                                                                    if (i21 != -1) {
                                                                                                        if (i20 != -1) {
                                                                                                            if (i21 == i20) {
                                                                                        ...
                                                                                        if ("audio/eac3".equals(strE)) {
                                                                                            ...
                                                                                            if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                                androidx.media3.common.h hVarX3 = i0.x(str17, str71, str73);
                                                                                                if (str71 != 0) {
                                                                                                    str24 = str71;
                                                                                                } else {
                                                                                                    str24 = str17;
                                                                                            ...
                                                                                            while (true) {
                                                                                                ...
                                                                                                if (i9 < arrayList29.size()) {
                                                                                                    ...
                                                                                                    qVar = new androidx.media3.common.q();
                                                                                                    qVar.a = attributeValue23;
                                                                                                    qVar.m = androidx.media3.common.i0.p(str816);
                                                                                                    qVar.n = androidx.media3.common.i0.p(strE);
                                                                                                    qVar.j = str17;
                                                                                                    qVar.i = i5;
                                                                                                    qVar.e = i10;
                                                                                                    ...
                                                                                                    i20 = androidx.media3.common.i0.i(rVar5.o);
                                                                                                    i21 = i43;
                                                                                                    if (i21 != -1) {
                                                                                                        if (i20 != -1) {
                                                                                                            if (i21 == i20) {
                                                                                        ...
                                                                                        str17 = str69;
                                                                                        if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                            androidx.media3.common.h hVarX4 = i0.x(str17, str71, str73);
                                                                                            if (str71 != 0) {
                                                                                                str24 = str71;
                                                                                            } else {
                                                                                                str24 = str17;
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i9 < arrayList29.size()) {
                                                                                                ...
                                                                                                qVar = new androidx.media3.common.q();
                                                                                                qVar.a = attributeValue23;
                                                                                                qVar.m = androidx.media3.common.i0.p(str8113);
                                                                                                qVar.n = androidx.media3.common.i0.p(strE);
                                                                                                qVar.j = str17;
                                                                                                qVar.i = i5;
                                                                                                qVar.e = i10;
                                                                                                ...
                                                                                                i20 = androidx.media3.common.i0.i(rVar6.o);
                                                                                                i21 = i43;
                                                                                                if (i21 != -1) {
                                                                                                    if (i20 != -1) {
                                                                                                        if (i21 == i20) {
                                                                                ...
                                                                                if (androidx.media3.common.util.b.l(xmlPullParser, str61)) {
                                                                                    if (androidx.media3.common.i0.k(str67)) {
                                                                                        ...
                                                                                        if (androidx.media3.common.i0.o(str67)) {
                                                                                            strE = androidx.media3.common.i0.j(str69);
                                                                                        } else if (androidx.media3.common.i0.n(str67)) {
                                                                                            strE = str67;
                                                                                            str16 = strE;
                                                                                        } else {
                                                                                            str16 = str67;
                                                                                        ...
                                                                                        if ("audio/eac3".equals(strE)) {
                                                                                            ...
                                                                                            if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                                androidx.media3.common.h hVarX5 = i0.x(str17, str71, str73);
                                                                                                if (str71 != 0) {
                                                                                                    str24 = str71;
                                                                                                } else {
                                                                                                    str24 = str17;
                                                                                            ...
                                                                                            while (true) {
                                                                                                ...
                                                                                                if (i9 < arrayList29.size()) {
                                                                                                    ...
                                                                                                    qVar = new androidx.media3.common.q();
                                                                                                    qVar.a = attributeValue23;
                                                                                                    qVar.m = androidx.media3.common.i0.p(str81111);
                                                                                                    qVar.n = androidx.media3.common.i0.p(strE);
                                                                                                    qVar.j = str17;
                                                                                                    qVar.i = i5;
                                                                                                    qVar.e = i10;
                                                                                                    ...
                                                                                                    i20 = androidx.media3.common.i0.i(rVar7.o);
                                                                                                    i21 = i43;
                                                                                                    if (i21 != -1) {
                                                                                                        if (i20 != -1) {
                                                                                                            if (i21 == i20) {
                                                                                        ...
                                                                                        str17 = str69;
                                                                                        if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                            androidx.media3.common.h hVarX6 = i0.x(str17, str71, str73);
                                                                                            if (str71 != 0) {
                                                                                                str24 = str71;
                                                                                            } else {
                                                                                                str24 = str17;
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i9 < arrayList29.size()) {
                                                                                                ...
                                                                                                qVar = new androidx.media3.common.q();
                                                                                                qVar.a = attributeValue23;
                                                                                                qVar.m = androidx.media3.common.i0.p(str81118);
                                                                                                qVar.n = androidx.media3.common.i0.p(strE);
                                                                                                qVar.j = str17;
                                                                                                qVar.i = i5;
                                                                                                qVar.e = i10;
                                                                                                ...
                                                                                                i20 = androidx.media3.common.i0.i(rVar8.o);
                                                                                                i21 = i43;
                                                                                                if (i21 != -1) {
                                                                                                    if (i20 != -1) {
                                                                                                        if (i21 == i20) {
                                                                                    ...
                                                                                    if ("audio/eac3".equals(strE)) {
                                                                                        ...
                                                                                        if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                            androidx.media3.common.h hVarX7 = i0.x(str17, str71, str73);
                                                                                            if (str71 != 0) {
                                                                                                str24 = str71;
                                                                                            } else {
                                                                                                str24 = str17;
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i9 < arrayList29.size()) {
                                                                                                ...
                                                                                                qVar = new androidx.media3.common.q();
                                                                                                qVar.a = attributeValue23;
                                                                                                qVar.m = androidx.media3.common.i0.p(str811115);
                                                                                                qVar.n = androidx.media3.common.i0.p(strE);
                                                                                                qVar.j = str17;
                                                                                                qVar.i = i5;
                                                                                                qVar.e = i10;
                                                                                                ...
                                                                                                i20 = androidx.media3.common.i0.i(rVar9.o);
                                                                                                i21 = i43;
                                                                                                if (i21 != -1) {
                                                                                                    if (i20 != -1) {
                                                                                                        if (i21 == i20) {
                                                                                    ...
                                                                                    str17 = str69;
                                                                                    if (androidx.media3.common.i0.l(str17, str71)) {
                                                                                        androidx.media3.common.h hVarX8 = i0.x(str17, str71, str73);
                                                                                        if (str71 != 0) {
                                                                                            str24 = str71;
                                                                                        } else {
                                                                                            str24 = str17;
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i9 < arrayList29.size()) {
                                                                                            ...
                                                                                            qVar = new androidx.media3.common.q();
                                                                                            qVar.a = attributeValue23;
                                                                                            qVar.m = androidx.media3.common.i0.p(str8111112);
                                                                                            qVar.n = androidx.media3.common.i0.p(strE);
                                                                                            qVar.j = str17;
                                                                                            qVar.i = i5;
                                                                                            qVar.e = i10;
                                                                                            ...
                                                                                            i20 = androidx.media3.common.i0.i(rVar10.o);
                                                                                            i21 = i43;
                                                                                            if (i21 != -1) {
                                                                                                if (i20 != -1) {
                                                                                                    if (i21 == i20) {
                                                                            ...
                                                                            j34 = j34;
                                                                            j4 = j4;
                                                                            if (androidx.media3.common.util.b.n(xmlPullParser, str91)) {
                                                                                ...
                                                                                str45 = str90;
                                                                                if (androidx.media3.common.util.b.n(xmlPullParser, str45)) {
                                                                                    long jD7 = d(xmlPullParser, j41);
                                                                                    str46 = str91;
                                                                                    str55 = str55;
                                                                                    arrayList5 = arrayList50;
                                                                                    sVarR3 = q(xmlPullParser, (o) sVarR3, j50, j9, j8, jD7, j);
                                                                                    j = j;
                                                                                    j9 = j9;
                                                                                    j41 = jD7;
                                                                                    arrayList6 = arrayList27;
                                                                                    ...
                                                                                    arrayList5 = arrayList50;
                                                                                    long j51 = j41;
                                                                                    if (androidx.media3.common.util.b.n(xmlPullParser, str42)) {
                                                                                        long jD8 = d(xmlPullParser, j51);
                                                                                        sVarR3 = r(xmlPullParser, (p) sVarR3, arrayList4, j50, j9, j8, jD8, j);
                                                                                        j9 = j9;
                                                                                        j37 = j50;
                                                                                        j41 = jD8;
                                                                                        arrayList26 = arrayList26;
                                                                                        ...
                                                                                        j37 = j50;
                                                                                        if (androidx.media3.common.util.b.n(xmlPullParser, "InbandEventStream")) {
                                                                                            j9 = j9;
                                                                                            arrayList6 = arrayList27;
                                                                                            ...
                                                                                            arrayList6 = arrayList27;
                                                                                            if (androidx.media3.common.util.b.n(xmlPullParser, "Label")) {
                                                                                                j9 = j9;
                                                                                                str12 = str60;
                                                                                                ...
                                                                                                while (true) {
                                                                                                    ...
                                                                                                    if (androidx.media3.common.util.b.l(xmlPullParser, "Label")) {
                                                                                                        arrayList26 = arrayList26;
                                                    ...
                                                    if (androidx.media3.common.util.b.l(xmlPullParser, str43)) {
                                                        ...
                                                        while (i27 < arrayList32.size()) {
                                                            ...
                                                            if (sVar instanceof r) {
                                                                ...
                                                                if (sVar instanceof n) {
                                                                    kotlinx.coroutines.future.a.q("segmentBase must be of type SingleSegmentBase or MultiSegmentBase");
                                                                    return null;
                                                                }
                                                        ...
                                                        str2 = str12;
                                                        i3 = 1;
                                                        arrayList21.add(new a(j40, i4, arrayList14, arrayList28, arrayList30, arrayList4));
                                                        j5 = j37;
                                                        j6 = j9;
                                                        str3 = str44;
                                                        str4 = str52;
                                            ...
                                            j34 = j34;
                                            j4 = j23;
                                            if (androidx.media3.common.util.b.n(xmlPullParser, "EventStream")) {
                                                str3 = str95;
                                                ...
                                                long j54 = attributeValue35 == null ? 1L : Long.parseLong(attributeValue35);
                                                String attributeValue36 = xmlPullParser.getAttributeValue(null, "presentationTimeOffset");
                                                long j55 = attributeValue36 == null ? 0L : Long.parseLong(attributeValue36);
                                                ArrayList arrayList53 = new ArrayList();
                                                ByteArrayOutputStream byteArrayOutputStream3 = new ByteArrayOutputStream(512);
                                                while (true) {
                                                    xmlPullParser.next();
                                                    if (androidx.media3.common.util.b.n(xmlPullParser, "Event")) {
                                                        str6 = str94;
                                                        String attributeValue37 = xmlPullParser.getAttributeValue(null, str6);
                                                        long j56 = attributeValue37 == null ? 0L : Long.parseLong(attributeValue37);
                                                        str5 = str;
                                                        String attributeValue38 = xmlPullParser.getAttributeValue(null, str5);
                                                        long j57 = attributeValue38 == null ? -9223372036854775807L : Long.parseLong(attributeValue38);
                                                        String attributeValue39 = xmlPullParser.getAttributeValue(null, "presentationTime");
                                                        long j58 = attributeValue39 == null ? 0L : Long.parseLong(attributeValue39);
                                                        String str99 = i0.a;
                                                        RoundingMode roundingMode = RoundingMode.DOWN;
                                                        long jY = i0.Y(j57, 1000L, j54, roundingMode);
                                                        long jY2 = i0.Y(j58 - j55, 1000000L, j54, roundingMode);
                                                        ...
                                                        while (!androidx.media3.common.util.b.l(xmlPullParser, "Event")) {
                                                        ...
                                                        arrayList53.add(Pair.create(lValueOf, new androidx.media3.extractor.metadata.emsg.a(str96, str98, jY, j56, byteArray)));
                                                    } else {
                                                        j7 = j55;
                                                        byteArrayOutputStream = byteArrayOutputStream3;
                                                        str5 = str;
                                                    ...
                                                    if (androidx.media3.common.util.b.l(xmlPullParser, "EventStream")) {
                                                ...
                                                String str100 = str41;
                                                str3 = str95;
                                                if (androidx.media3.common.util.b.n(xmlPullParser, "SegmentBase")) {
                                                    ...
                                                    j2 = -9223372036854775807L;
                                                    str4 = str94;
                                                } else if (androidx.media3.common.util.b.n(xmlPullParser, "SegmentList")) {
                                                    j2 = -9223372036854775807L;
                                                    long jD9 = d(xmlPullParser, -9223372036854775807L);
                                                    arrayList22 = arrayList22;
                                                    str41 = str100;
                                                    str4 = str94;
                                                    sVarR2 = q(xmlPullParser, null, j53, j52, j3, jD9, j);
                                                    j = j;
                                                    j6 = j52;
                                                    j5 = j53;
                                                    j39 = jD9;
                                                    ...
                                                    if (androidx.media3.common.util.b.n(xmlPullParser, str42)) {
                                                        ...
                                                        j39 = jD10;
                                                    } else if (androidx.media3.common.util.b.n(xmlPullParser, "AssetIdentifier")) {
                                                        arrayList22 = arrayList22;
                                    ...
                                    if (androidx.media3.common.util.b.l(xmlPullParser, obj)) {
                                        Pair pairCreate2 = Pair.create(new h(attributeValue11, j36, arrayList21, arrayList22), Long.valueOf(j6));
                                        ...
                                        if (hVar2.b != j2) {
                                            ...
                                            if (!zEquals) {
                                                throw j0.b(null, "Unable to determine start of period " + arrayList18.size());
                                            }
                                            arrayList18 = arrayList18;
                                            i34 = i3;
                                            j16 = j4;
                        ...
                        if (androidx.media3.common.util.b.l(xmlPullParser, "MPD")) {
                            if (j18 == j2) {
                                if (j23 != j2) {
                                    j18 = j23;
                                } else if (!zEquals) {
                                    throw j0.b(null, "Unable to determine duration of static manifest.");
                                }
                            }
                            if (arrayList18.isEmpty()) {
                                throw j0.b(null, "No periods found.");
                            }
                            return new c(jT, j18, j19, zEquals, j20, j, j22, jT2, iVar, uVar, wVar, uriR, arrayList18);
                        }
                        arrayList18 = arrayList18;
                        j21 = j;
                        j17 = j2;
    ...
    public static int o(ArrayList arrayList) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            if (com.imsdk.a.j("http://dashif.org/guidelines/trickmode", ((f) arrayList.get(i2)).a)) {
                i = 16384;
            }
        }
        return i;
    ...
    public static r p(XmlPullParser xmlPullParser, r rVar) throws XmlPullParserException, IOException {
        ...
        while (true) {
            xmlPullParser.next();
            if (androidx.media3.common.util.b.n(xmlPullParser, "Initialization")) {
                jVarM = m(xmlPullParser, "sourceURL", "range");
            } else {
                b(xmlPullParser);
            }
            j jVar = jVarM;
            if (androidx.media3.common.util.b.l(xmlPullParser, "SegmentBase")) {
    ...
    public static o q(XmlPullParser xmlPullParser, o oVar, long j, long j2, long j3, long j4, long j5) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (androidx.media3.common.util.b.n(xmlPullParser, "Initialization")) {
                jVarM = m(xmlPullParser, "sourceURL", "range");
            } else if (androidx.media3.common.util.b.n(xmlPullParser, "SegmentTimeline")) {
                listS = s(xmlPullParser, j7, j2);
            } else if (androidx.media3.common.util.b.n(xmlPullParser, "SegmentURL")) {
                if (arrayList == null) {
        ...
        } while (!androidx.media3.common.util.b.l(xmlPullParser, "SegmentList"));
        if (oVar != null) {
            if (jVarM == null) {
                jVarM = oVar.a;
            }
        ...
        return new o(jVarM, j7, j9, j13, j11, listS, j15, arrayList, i0.Q(j5), i0.Q(j));
    }
    ...
    public static p r(XmlPullParser xmlPullParser, p pVar, List list, long j, long j2, long j3, long j4, long j5) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            f fVar = (f) list.get(i);
            if (com.imsdk.a.j("http://dashif.org/guidelines/last-segment-number", fVar.a)) {
        ...
        } while (!androidx.media3.common.util.b.l(xmlPullParser, "SegmentTemplate"));
        if (pVar != null) {
            if (jVarM == null) {
                jVarM = pVar.a;
            }
        ...
        return new p(jVarM, j8, j10, j14, j15, j12, listS, j17, c2VarT2, c2VarT, i0.Q(j5), i0.Q(j));
    }
    ...
    public static ArrayList s(XmlPullParser xmlPullParser, long j, long j2) throws XmlPullParserException, IOException {
        ...
        do {
            xmlPullParser.next();
            if (androidx.media3.common.util.b.n(xmlPullParser, "S")) {
        ...
        } while (!androidx.media3.common.util.b.l(xmlPullParser, "SegmentTimeline"));
        if (z2) {
            String str = i0.a;
            a(arrayList, jA, j4, i, i0.Y(j2, j, 1000L, RoundingMode.DOWN));
        }
        return arrayList;
    }
    ...
    public static c2 t(XmlPullParser xmlPullParser, String str, c2 c2Var) {
                ...
                if (strSubstring2.equals("RepresentationID")) {
                    ...
                    switch (strSubstring2) {
                        ...
                        case "Bandwidth":
                            ...
                            break;
                        default:
                            kotlinx.coroutines.future.a.q("Invalid template: ".concat(attributeValue));
                            return null;
                    }
        ...
        return new c2(18, arrayList, arrayList2, arrayList3);
    }

    @Override // androidx.media3.exoplayer.upstream.p
    public final Object e(Uri uri, androidx.media3.datasource.j jVar) throws IOException {
        try {
            ...
            throw j0.b(null, "inputStream does not contain a valid media presentation description");
        } catch (XmlPullParserException e) {
