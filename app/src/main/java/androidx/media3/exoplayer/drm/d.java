...
public final class d {
    ...
    public void a(androidx.media3.common.util.h hVar) {
        for (b0 b0Var : this.c) {
            i0.U(b0Var.a, new androidx.activity.c(23, hVar, b0Var.b));
        }
    }

    public void b(int i, r rVar, int i2, Object obj, long j) {
        a(new androidx.media3.exoplayer.analytics.c(3, this, new s(1, i, rVar, i2, obj, i0.d0(j), -9223372036854775807L)));
    }

    public void c(n nVar, int i, int i2, r rVar, int i3, Object obj, long j, long j2) {
        a(new y(this, nVar, new s(i, i2, rVar, i3, obj, i0.d0(j), i0.d0(j2)), 1));
    }

    public void d(n nVar, int i, int i2, r rVar, int i3, Object obj, long j, long j2) {
        a(new y(this, nVar, new s(i, i2, rVar, i3, obj, i0.d0(j), i0.d0(j2)), 0));
    }

    public void e(n nVar, int i, int i2, r rVar, int i3, Object obj, long j, long j2, IOException iOException, boolean z) {
        a(new z(this, nVar, new s(i, i2, rVar, i3, obj, i0.d0(j), i0.d0(j2)), iOException, z));
    }
    ...
    public void g(n nVar, int i, int i2, r rVar, int i3, Object obj, long j, long j2, int i4) {
        a(new x(this, nVar, new s(i, i2, rVar, i3, obj, i0.d0(j), i0.d0(j2)), i4));
    }

    public void h(long j, long j2, int i) {
        s sVar = new s(1, i, null, 3, null, i0.d0(j), i0.d0(j2));
        v vVar = this.b;
        vVar.getClass();
