...
public final class g {
    ...
    public g(androidx.media3.exoplayer.upstream.d dVar, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, boolean z, boolean z2, Map map) {
        ...
        this.c = dVar;
        this.d = androidx.media3.common.util.i0.Q(i);
        this.e = androidx.media3.common.util.i0.Q(i2);
        this.f = androidx.media3.common.util.i0.Q(i3);
        this.g = androidx.media3.common.util.i0.Q(i4);
        this.h = androidx.media3.common.util.i0.Q(i5);
        this.i = androidx.media3.common.util.i0.Q(i6);
        this.j = androidx.media3.common.util.i0.Q(i7);
        this.k = androidx.media3.common.util.i0.Q(i8);
        this.l = i9;
        this.m = z;
        this.n = z2;
        this.o = androidx.media3.common.util.i0.Q(0);
    ...
    public static void a(String str, int i, String str2, int i2) {
        _COROUTINE.a.r(i >= i2, "%s cannot be less than %s", str, str2);
    }
    ...
    public final boolean b(l0 l0Var) {
        ...
        float f = l0Var.e;
        if (f > 1.0f) {
            jMin = Math.min(androidx.media3.common.util.i0.B(f, jMin), j2);
        }
        if (j < Math.max(jMin, 500000L)) {
            boolean z3 = (z ? this.n : this.m) || !z2;
            fVar.b = z3;
            if (!z3 && j < 500000) {
                androidx.media3.common.util.b.t("DefaultLoadControl", "Target buffer size reached with less than 500ms of buffered media data.");
            }
        } else if (j >= j2 || z2) {
            fVar.b = false;
        }
