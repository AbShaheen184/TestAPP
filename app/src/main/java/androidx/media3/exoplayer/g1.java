...
public final class g1 extends androidx.media3.common.v0 {
    ...
    public final int b;
    public final androidx.media3.exoplayer.source.a1 c;
    public final int d;
    public final int e;
    public final int[] f;
    public final int[] g;
    ...
    public g1(androidx.media3.common.v0[] v0VarArr, Object[] objArr, androidx.media3.exoplayer.source.a1 a1Var) {
        this.c = a1Var;
        this.b = a1Var.b.length;
    ...
    public final int e(int i, int i2, boolean z) {
        int[] iArr = this.g;
        int iE = androidx.media3.common.util.i0.e(iArr, i + 1, false, false);
        int i3 = iArr[iE];
        androidx.media3.common.v0[] v0VarArr = this.h;
    ...
    public final int q(int i, boolean z) {
        ...
        androidx.media3.exoplayer.source.a1 a1Var = this.c;
        int i2 = a1Var.c[i] + 1;
        int[] iArr = a1Var.b;
        if (i2 < iArr.length) {
            return iArr[i2];
    ...
    public g1(ArrayList arrayList, androidx.media3.exoplayer.source.a1 a1Var) {
