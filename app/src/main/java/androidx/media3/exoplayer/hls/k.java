...
public final class k extends androidx.media3.exoplayer.source.chunk.k {
    ...
    public k(d dVar, androidx.media3.datasource.h hVar, androidx.media3.datasource.l lVar, androidx.media3.common.r rVar, boolean z, androidx.media3.datasource.h hVar2, androidx.media3.datasource.l lVar2, boolean z2, Uri uri, List list, int i, Object obj, long j, long j2, long j3, int i2, boolean z3, int i3, boolean z4, boolean z5, g0 g0Var, androidx.media3.common.m mVar, b bVar, androidx.media3.extractor.metadata.id3.h hVar3, v vVar, boolean z6, boolean z7, androidx.media3.exoplayer.analytics.k kVar) {
    ...
    public static byte[] d(String str) {
        if (com.imsdk.a.B(str).startsWith("0x")) {
            str = str.substring(2);
        }
    ...
    public final void c(androidx.media3.datasource.h hVar, androidx.media3.datasource.l lVar, boolean z, boolean z2) {
        ...
        try {
            androidx.media3.extractor.k kVarH = h(hVar, lVarC, z2);
            if (z3) {
                kVarH.d(this.b0, false);
            }
            while (!this.d0 && this.Z.a.c(kVarH, b.f) == 0) {
                try {
                    try {
                    ...
                    this.b0 = (int) (kVarH.A - lVar.f);
                    throw th;
                }
            }
            j = kVarH.A;
            this.b0 = (int) (j - lVar.f);
            com.google.android.gms.dynamite.g.l(hVar);
        } catch (Throwable th2) {
            com.google.android.gms.dynamite.g.l(hVar);
            throw th2;
        }
  ...
  0x0080: PHI (r16v1 long) = (r16v0 long), (r16v3 long), (r16v3 long) binds: [B:40:0x00d0, B:22:0x007e, B:37:0x00b5] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final androidx.media3.extractor.k h(androidx.media3.datasource.h hVar, androidx.media3.datasource.l lVar, boolean z) throws IOException {
        int i;
        long j;
        long jT;
        b bVar;
        ...
        if (this.Z == null) {
            ...
            try {
                ...
                if (vVar.C() != 4801587) {
                    ...
                    kVar.e(vVar.a, 10, iY, false);
                    androidx.media3.common.h0 h0VarD0 = this.V.d0(vVar.a, iY);
                    if (h0VarD0 == null) {
                        jT = j;
                    } else {
                        androidx.media3.common.g0[] g0VarArr = h0VarD0.a;
                        ...
                        while (true) {
                            ...
                            androidx.media3.common.g0 g0Var4 = g0VarArr[i5];
                            if (androidx.media3.extractor.metadata.id3.m.class.isAssignableFrom(g0Var4.getClass())) {
                                g0Var2 = (androidx.media3.common.g0) androidx.media3.extractor.metadata.id3.m.class.cast(g0Var4);
                                if (!((androidx.media3.extractor.metadata.id3.m) g0Var2).b.equals("com.apple.streaming.transportStreamTimestamp")) {
                                    g0Var2 = null;
                                }
                            } else {
                                g0Var2 = null;
                        ...
                        androidx.media3.extractor.metadata.id3.m mVar = (androidx.media3.extractor.metadata.id3.m) g0Var2;
                        if (mVar == null) {
                            jT = j;
                        } else {
                            System.arraycopy(mVar.c, 0, vVar.a, 0, 8);
                            vVar.M(0);
                            vVar.L(8);
                            jT = vVar.t() & 8589934591L;
                        }
                    }
                }
            ...
            if (bVar2 == null) {
                ...
                int iE = androidx.work.impl.v.E(rVar.o);
                List list = (List) mapL.get("Content-Type");
                int iE2 = androidx.work.impl.v.E((list == null || list.isEmpty()) ? null : (String) list.get(0));
                ...
                while (true) {
                    ...
                    if (i8 >= size) {
                        ...
                        i = 0;
                        nVar.getClass();
                        bVar = new b(nVar, rVar, g0Var5, dVar2.a, dVar2.b);
                        break;
                    }
                    ...
                    if (iIntValue == 0) {
                        ...
                        List list2 = this.T;
                        com.google.android.gms.common.internal.k kVar2 = androidx.media3.extractor.text.j.g;
                        if (iIntValue == 8) {
                            androidx.work.impl.model.f fVar = dVar2.a;
                            boolean z2 = dVar2.b;
                            int i10 = dVar2.c;
                            if (z2) {
                                jVar = fVar;
                            ...
                            iVar = new androidx.media3.extractor.mp4.i(jVar, i2 | androidx.media3.extractor.mp4.i.f(i10), g0Var5, list2 != null ? list2 : a1.B, null);
                            g0Var = g0Var5;
                        } else if (iIntValue == 11) {
                            androidx.work.impl.model.f fVar2 = dVar2.a;
                            boolean z3 = dVar2.b;
                            if (list2 != null) {
                                i3 = 48;
                            ...
                            iVar = new c0(2, !z3 ? 1 : 0, !z3 ? kVar2 : fVar2, g0Var, new androidx.compose.foundation.lazy.grid.t(i3, listSingletonList));
                            ...
                            j2 = j2;
                            arrayList = arrayList;
                            aVar = new u(rVar.d, g0Var5, dVar2.a, dVar2.b);
                            g0Var = g0Var5;
                        }
                        aVar = iVar;
                    } else {
                    ...
                    if (zA) {
                        bVar = new b(aVar, rVar, g0Var, dVar2.a, dVar2.b);
                        break;
                    }
                    androidx.media3.common.r rVar2 = rVar;
                    if (nVar == null && (iIntValue == iE || iIntValue == iE2 || iIntValue == iF || iIntValue == 11)) {
                        nVar = aVar;
                    }
                    i8 = i9 + 1;
                    rVar = rVar2;
                ...
                androidx.work.impl.model.f fVar3 = bVar2.d;
                androidx.media3.extractor.n nVar2 = bVar2.a;
                _COROUTINE.a.A(!((nVar2 instanceof c0) || (nVar2 instanceof androidx.media3.extractor.mp4.i)));
                if (nVar2 instanceof u) {
                    dVar = new u(bVar2.b.d, bVar2.c, fVar3, bVar2.e);
                    ...
                    if (!(nVar2 instanceof androidx.media3.extractor.mp3.d)) {
                        kotlinx.coroutines.future.a.u("Unexpected extractor type for recreation: ".concat(nVar2.getClass().getSimpleName()));
                        return null;
                    }
                    dVar = new androidx.media3.extractor.mp3.d(0);
                }
                bVar = new b(dVar, bVar2.b, bVar2.c, fVar3, bVar2.e);
                j2 = j2;
                i = 0;
            }
            b bVar3 = bVar;
