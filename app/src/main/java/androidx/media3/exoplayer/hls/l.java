...
public final class l implements androidx.media3.exoplayer.source.u, androidx.media3.exoplayer.hls.playlist.u {
    ...
    public final long U;
    public final d e;
    public final androidx.media3.exoplayer.hls.playlist.d y;
    public final c z;

    public l(d dVar, androidx.media3.exoplayer.hls.playlist.d dVar2, c cVar, androidx.media3.exoplayer.upstream.f fVar, androidx.media3.exoplayer.drm.f fVar2, androidx.media3.exoplayer.drm.d dVar3, t2 t2Var, androidx.media3.exoplayer.drm.d dVar4, c2 c2Var, com.google.android.material.shape.f fVar3, boolean z, int i, androidx.media3.exoplayer.analytics.k kVar) {
        this.e = dVar;
        this.y = dVar2;
        this.z = cVar;
        this.A = fVar;
    ...
    public static androidx.media3.common.r e(androidx.media3.common.r rVar, androidx.media3.common.r rVar2, boolean z) {
        ...
        String strE = androidx.media3.common.i0.e(str2);
        int i4 = z ? rVar.h : -1;
        int i5 = z ? rVar.i : -1;
        ...
        qVar.b = str3;
        qVar.c = h0.o(h0Var2);
        qVar.m = androidx.media3.common.i0.p(rVar.n);
        ...
        for (r rVar : this.Q) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if (iC == 1) {
                    if (!kVar.g()) {
                        _COROUTINE.a.A(i != -1);
                        androidx.media3.exoplayer.hls.playlist.m mVarB = jVar.g.b(false, kVar.J);
                        mVarB.getClass();
                        h0 h0Var = mVarB.r;
                        int i2 = (int) (kVar.G - mVarB.k);
                        kVar.h0 = i2 < 0 ? 0L : ((androidx.media3.exoplayer.hls.playlist.h) (i2 < h0Var.size() ? ((androidx.media3.exoplayer.hls.playlist.j) h0Var.get(i2)).J : mVarB.s).get(i)).z;
                    }
                } else if (iC == 0) {
        ...
        while (i2 < length) {
            ...
            while (true) {
                if (i3 < length2) {
                    ...
                    if (wVar.equals(cVar != null ? cVar.a : null)) {
                        if (z) {
                            hVarE = null;
                        } else {
                        ...
                        if (hVarE != null) {
                            ...
                            long j = hVarE.b;
                            if (i4 == 1) {
                                androidx.media3.exoplayer.hls.playlist.c cVar2 = (androidx.media3.exoplayer.hls.playlist.c) dVar.A.get(uri);
                                if (cVar2 != null) {
                                    zC = androidx.media3.exoplayer.hls.playlist.c.c(cVar2, uri, j);
                                }
                            } else {
                                if (i4 != 2) {
                                    kotlinx.coroutines.future.a.u(androidx.privacysandbox.ads.adservices.java.internal.a.n(i4, "Invalid fallback selection type: "));
                                    return false;
                                }
                                int i5 = 0;
                                while (true) {
                                    ...
                                    w wVar2 = wVarArr[i5];
                                    androidx.media3.exoplayer.hls.playlist.c cVar3 = (androidx.media3.exoplayer.hls.playlist.c) dVar.A.get(uri);
                                    if (wVar2.equals(cVar3 != null ? cVar3.a : null)) {
                                        break;
                                    }
                                    i5++;
                                }
                                if (i5 != -1 && (iU = jVar.r.u(i5)) != -1 && jVar.r.p(iU, j)) {
                                    androidx.media3.exoplayer.hls.playlist.c cVar4 = (androidx.media3.exoplayer.hls.playlist.c) dVar.A.get(uri);
                                    if (cVar4 != null ? androidx.media3.exoplayer.hls.playlist.c.c(cVar4, uri, j) : false) {
                                        zC = true;
                                    }
                                }
                            }
    ...
    public final r c(String str, int i, w[] wVarArr, androidx.media3.common.r[] rVarArr, androidx.media3.common.r rVar, List list, Map map, long j) throws Throwable {
        r rVar2 = new r(str, i, this.M, new j(this.e, this.y, wVarArr, rVarArr, this.z, this.A, this.H, list, this.L), map, this.F, j, rVar, this.B, this.C, this.D, this.E, this.K, null);
        long j2 = this.U;
        rVar2.r0 = j2;
        if (rVar2.Z) {
            for (q qVar : rVar2.S) {
    ...
    @Override // androidx.media3.exoplayer.source.u
    public final long j(long j, k1 k1Var) {
        for (r rVar : this.R) {
            if (rVar.X == 2) {
                j jVar = rVar.A;
                androidx.media3.exoplayer.hls.playlist.d dVar = jVar.g;
                int iD = jVar.r.d();
                w[] wVarArr = jVar.e;
                androidx.media3.exoplayer.hls.playlist.m mVarB = (iD >= wVarArr.length || iD == -1) ? null : dVar.b(true, wVarArr[jVar.r.m()].c());
                if (mVarB == null) {
                    break;
                }
                h0 h0Var = mVarB.r;
                ...
                long j3 = j - j2;
                int iD2 = i0.d(h0Var, Long.valueOf(j3), true);
                long j4 = ((androidx.media3.exoplayer.hls.playlist.j) h0Var.get(iD2)).B;
                return k1Var.a(j3, j4, (!mVarB.c || iD2 == h0Var.size() - 1) ? j4 : ((androidx.media3.exoplayer.hls.playlist.j) h0Var.get(iD2 + 1)).B) + j2;
            }
        }
        return j;
    }
    ...
    @Override // androidx.media3.exoplayer.source.u
    public final long k(long j) throws Throwable {
        r[] rVarArr = this.R;
        if (rVarArr.length > 0) {
    ...
    @Override // androidx.media3.exoplayer.source.u
    public final void l(long j) throws Throwable {
        for (r rVar : this.R) {
            if (rVar.Z && !rVar.E()) {
    ...
    @Override // androidx.media3.exoplayer.source.u
    public final long m(androidx.media3.exoplayer.trackselection.q[] qVarArr, boolean[] zArr, x0[] x0VarArr, boolean[] zArr2, long j) throws Throwable {
        ...
        while (true) {
            ...
            iArr3[i7] = x0Var == null ? -1 : ((Integer) identityHashMap.get(x0Var)).intValue();
            iArr4[i7] = -1;
        ...
        int i11 = 0;
        boolean z5 = false;
        Object[] objArr6 = new x0[length2];
        Object[] objArr7 = x0VarArr2;
        while (i10 < this.Q.length) {
            ...
            while (true) {
                ...
                objArr7[r7] = iArr3[r7] == i10 ? x0VarArr[r7] : null;
            ...
            j jVar2 = rVar3.A;
            w[] wVarArr = jVar2.e;
            androidx.media3.exoplayer.hls.playlist.d dVar = jVar2.g;
            ...
            boolean z9 = z7;
            if (rVar3.b0 == 0) {
                Uri uriC2 = wVarArr[jVar2.r.m()].c();
                androidx.media3.exoplayer.hls.playlist.c cVar2 = (androidx.media3.exoplayer.hls.playlist.c) dVar.A.get(uriC2);
                if (cVar2 != null) {
                    androidx.media3.exoplayer.hls.playlist.b bVar2 = (androidx.media3.exoplayer.hls.playlist.b) androidx.compose.runtime.j.c(cVar2.b, uriC2, uriC2);
                    bVar2.getClass();
                    bVar2.I = false;
                }
                jVar2.n = null;
        ...
        boolean z12 = z4;
        System.arraycopy(objArr6, z12 ? 1 : 0, x0VarArr, z12 ? 1 : 0, length2);
        r[] rVarArr5 = (r[]) i0.S(i11, rVarArr3);
        this.R = rVarArr5;
    ...
    public final void q(androidx.media3.exoplayer.source.t tVar, long j) throws Throwable {
        ...
        List list;
        this.N = tVar;
        androidx.media3.exoplayer.hls.playlist.d dVar2 = this.y;
        dVar2.getClass();
        dVar2.B.add(this);
        androidx.media3.exoplayer.hls.playlist.p pVar = dVar2.G;
        pVar.getClass();
        Map map3 = Collections.EMPTY_MAP;
        h0 h0VarC = dVar2.c(0);
        h0VarC.getClass();
        h0 h0VarC2 = dVar2.c(2);
        h0VarC2.getClass();
        h0 h0VarC3 = dVar2.c(3);
        h0VarC3.getClass();
        ...
        if (zIsEmpty) {
            ...
            androidx.media3.common.r rVar = pVar.h;
            List list2 = pVar.i;
            ...
            for (int i6 = 0; i6 < h0VarC.size(); i6++) {
                androidx.media3.common.r rVar2 = ((w) h0VarC.get(i6)).a.a;
                int i7 = rVar2.w;
                String str2 = rVar2.k;
                if (i7 > 0 || i0.w(2, str2) != null) {
                    int i8 = i5;
                    iArr[i6] = 2;
                    i4++;
                    i5 = i8;
                } else if (i0.w(1, str2) != null) {
                    iArr[i6] = 1;
                    i5++;
                } else {
                    iArr[i6] = -1;
            ...
            while (i12 < h0VarC.size()) {
                ...
                if (!z3 || iArr[i12] != 1) {
                    w wVar = (w) h0VarC.get(i12);
                    wVarArr[i11] = wVar;
                    rVarArr2[i11] = wVar.a.a;
                    iArr2[i11] = i12;
                    i11++;
                }
                i12++;
            ...
            dVar = dVar3;
            z = z4;
            r rVarC = c("main", i13, wVarArr, rVarArr2, rVar, list3, map3, j);
            ...
            if (z && z6) {
                ...
                if (iV > 0) {
                    ...
                    while (i14 < i3) {
                        ...
                        String strW = i0.w(2, rVar3.k);
                        String strE = androidx.media3.common.i0.e(strW);
                        androidx.media3.common.q qVar = new androidx.media3.common.q();
                        qVar.a = rVar3.a;
                        qVar.b = rVar3.b;
                        qVar.c = h0.o(rVar3.c);
                        qVar.m = androidx.media3.common.i0.p(rVar3.n);
                        qVar.n = androidx.media3.common.i0.p(strE);
                        qVar.j = strW;
                        qVar.k = rVar3.l;
                        qVar.h = rVar3.h;
                        ...
                        qVar.f = rVar3.f;
                        qVar.D = rVar3.E;
                        rVarArr3[i14] = new androidx.media3.common.r(qVar);
                        i14++;
                        rVarArr2 = rVarArr4;
                        map3 = map3;
                    }
                    ...
                    map = map3;
                    arrayList6.add(new w0("main", rVarArr3));
                    if (iV2 > 0 && (rVar != null || h0VarC2.isEmpty())) {
                        androidx.media3.common.q qVarA = e(rVarArr5[0], rVar, false).a();
                        qVarA.l = "main";
                        arrayList6.add(new w0("main:audio", new androidx.media3.common.r(qVarA)));
                    }
                    if (list3 != null) {
                        for (int i15 = 0; i15 < list3.size(); i15++) {
                            String strN = androidx.privacysandbox.ads.adservices.java.internal.a.n(i15, "main:cc:");
                            androidx.media3.common.q qVarA2 = dVar.b((androidx.media3.common.r) list3.get(i15)).a();
                            qVarA2.l = "main";
                            arrayList6.add(new w0(strN, new androidx.media3.common.r(qVarA2)));
                        }
                    }
                } else {
                    map = map3;
                    ...
                    arrayList6.add(new w0("main", rVarArr6));
                }
                androidx.media3.common.q qVar2 = new androidx.media3.common.q();
                str = "ID3";
                qVar2.a = str;
                qVar2.n = androidx.media3.common.i0.p("application/id3");
                qVar2.l = "main";
                w0 w0Var = new w0("main:id3", new androidx.media3.common.r(qVar2));
                arrayList6.add(w0Var);
                rVarC.H((w0[]) arrayList6.toArray(new w0[0]), arrayList6.indexOf(w0Var));
            } else {
                map = map3;
                str = "ID3";
            }
        ...
        while (i17 < h0VarC2.size()) {
            String str4 = ((w) h0VarC2.get(i17)).a.c;
            str4.getClass();
            if (hashSet3.add(str4)) {
                ...
                for (int i18 = 0; i18 < h0VarC2.size(); i18++) {
                    if (str4.equals(((w) h0VarC2.get(i18)).a.c)) {
                        w wVar2 = (w) h0VarC2.get(i18);
                        androidx.media3.common.r rVar4 = wVar2.a.a;
                ...
                i2 = i17;
                r rVarC2 = c(strConcat, 1, (w[]) arrayList7.toArray(new w[0]), (androidx.media3.common.r[]) arrayList8.toArray(new androidx.media3.common.r[0]), null, Collections.EMPTY_LIST, map2, j);
                arrayList5.add(com.imsdk.a.A(arrayList));
                arrayList4.add(rVarC2);
                if (z && z7) {
                    String strConcat2 = strConcat.concat(":id3");
                    androidx.media3.common.q qVar3 = new androidx.media3.common.q();
                    qVar3.a = str;
                    qVar3.n = androidx.media3.common.i0.p("application/id3");
                    qVar3.l = strConcat;
                    rVarC2.H(new w0[]{new w0(strConcat, (androidx.media3.common.r[]) arrayList3.toArray(new androidx.media3.common.r[0])), new w0(strConcat2, new androidx.media3.common.r(qVar3))}, 1);
                }
            } else {
                arrayList = arrayList9;
                hashSet2 = hashSet3;
        ...
        while (i19 < h0Var.size()) {
            h0Var = h0Var;
            String str6 = ((w) h0Var.get(i19)).a.c;
            str6.getClass();
            if (hashSet4.add(str6)) {
                ...
                for (int i20 = 0; i20 < h0Var.size(); i20++) {
                    if (str6.equals(((w) h0Var.get(i20)).a.c)) {
                        w wVar3 = (w) h0Var.get(i20);
                        arrayList12.add(Integer.valueOf(i20));
                        arrayList10.add(wVar3);
                        arrayList11.add(wVar3.a.a);
                    }
                }
                ...
                String str7 = i0.a;
                w[] wVarArr2 = (w[]) arrayList10.toArray(new w[0]);
                e0 e0Var = h0.y;
                hashSet = hashSet4;
                i = i19;
                r rVarC3 = c(strConcat3, 3, wVarArr2, rVarArr7, null, a1.B, map4, j);
                arrayList5.add(com.imsdk.a.A(arrayList12));
                ...
                rVarC3.H(new w0[]{new w0(strConcat3, rVarArr8)}, new int[0]);
            } else {
                hashSet = hashSet4;
                i = i19;
            }
