...
public final class p extends q {
    ...
    static {
        ...
        l = new p("", list, list, list, list, list, list, null, list, false, Collections.EMPTY_MAP, list);
    }

    public p(String str, List list, List list2, List list3, List list4, List list5, List list6, androidx.media3.common.r rVar, List list7, boolean z, Map map, List list8) {
        super(list, str, z);
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < list2.size(); i++) {
            Uri uri = ((o) list2.get(i)).a;
    ...
    public final Object a(List list) {
        ...
        return new p(this.a, this.b, arrayListC, list2, c(this.f, 1, list), c(this.g, 2, list), list2, this.h, this.i, this.c, this.j, this.k);
    }
}
