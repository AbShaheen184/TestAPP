...
public final class u implements androidx.media3.extractor.n {
    ...
    public u(String str, g0 g0Var, androidx.work.impl.model.f fVar, boolean z) {
        this.a = str;
        this.b = g0Var;
        this.d = fVar;
        this.e = z;
    ...
    public final boolean a(androidx.media3.extractor.o oVar) {
        ...
        v vVar = this.c;
        vVar.K(bArr, 6);
        if (androidx.media3.extractor.text.webvtt.j.a(vVar)) {
            return true;
        }
        kVar.e(this.g, 6, 3, false);
        vVar.K(this.g, 9);
        return androidx.media3.extractor.text.webvtt.j.a(vVar);
    }
    ...
    public final int c(androidx.media3.extractor.o oVar, androidx.media3.extractor.r rVar) throws j0 {
        ...
        v vVar = new v(this.g);
        androidx.media3.extractor.text.webvtt.j.d(vVar);
        String strN2 = vVar.n(StandardCharsets.UTF_8);
        long jY = 0;
        long jC = 0;
        while (true) {
            ...
            if (TextUtils.isEmpty(strN2)) {
                while (true) {
                    String strN3 = vVar.n(StandardCharsets.UTF_8);
                    if (strN3 == null) {
                        break;
                    }
                ...
                String str = i0.a;
                long jB = this.b.b(i0.Y((jY + jC2) - jC, 90000L, 1000000L, RoundingMode.DOWN) % 8589934592L);
                h0 h0VarF = f(jB - jC2);
                byte[] bArr3 = this.g;
                int i6 = this.h;
                v vVar2 = this.c;
                vVar2.K(bArr3, i6);
                h0VarF.f(this.h, vVar2);
            ...
            if (strN2.startsWith("X-TIMESTAMP-MAP")) {
                ...
                String str2 = i0.a;
                jY = i0.Y(j2, 1000000L, 90000L, RoundingMode.DOWN);
            }
            strN2 = vVar.n(StandardCharsets.UTF_8);
        }
    }
    ...
    public final h0 f(long j2) {
        h0 h0VarU = this.f.u(0, 3);
        androidx.media3.common.q qVar = new androidx.media3.common.q();
        qVar.n = androidx.media3.common.i0.p("text/vtt");
        qVar.d = this.a;
        qVar.s = j2;
