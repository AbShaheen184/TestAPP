...
public final class b extends h {
    ...
    public final androidx.media3.decoder.c i(androidx.media3.decoder.e eVar, androidx.media3.decoder.f fVar, boolean z) {
        ...
        byteBuffer.getClass();
        _COROUTINE.a.A(byteBuffer.hasArray());
        _COROUTINE.a.o(byteBuffer.arrayOffset() == 0);
        try {
            int iMax = this.o;
            if (iMax == -1) {
                Context context = this.n;
                if (context != null) {
                    Point pointY = i0.y(context);
                    int i = pointY.x;
                    int i2 = pointY.y;
                    r rVar = eVar.z;
                    if (rVar != null) {
            ...
            aVar.B = coil3.svg.internal.a.o(byteBuffer.array(), byteBuffer.remaining(), iMax);
            aVar.z = eVar.D;
            return null;
        } catch (j0 e) {
