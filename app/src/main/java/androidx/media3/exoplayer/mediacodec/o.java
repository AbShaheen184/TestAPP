...
public final class o {
    ...
    public static boolean a(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
        ...
        Point point = new Point(androidx.media3.common.util.i0.g(i, widthAlignment) * widthAlignment, androidx.media3.common.util.i0.g(i2, heightAlignment) * heightAlignment);
        int i3 = point.x;
        int i4 = point.y;
        if (d == -1.0d || d < 1.0d) {
    ...
    public final androidx.media3.exoplayer.d b(androidx.media3.common.r rVar, androidx.media3.common.r rVar2) {
        ...
        if (this.i) {
            ...
            if (i2 == 0 && Objects.equals(rVar2.o, "video/dolby-vision")) {
                ...
                Pair pairB2 = androidx.media3.common.util.e.b(rVar2);
            ...
            if (i2 == 0 && (str3.equals("audio/mp4a-latm") || str3.equals("audio/ac4"))) {
                Pair pairB3 = androidx.media3.common.util.e.b(rVar3);
                Pair pairB4 = androidx.media3.common.util.e.b(rVar4);
  ...
  0x00c0: PHI (r2v1 android.util.Pair) = (r2v0 android.util.Pair), (r2v0 android.util.Pair), (r2v0 android.util.Pair), (r2v14 android.util.Pair) binds: [B:3:0x000e, B:5:0x0016, B:10:0x002a, B:37:0x00bf] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        if (str != null && str.equals("video/mv-hevc")) {
            ...
            if (strP.equals("video/hevc")) {
                        ...
                        for (int i3 = 0; i3 < a1VarG.A; i3++) {
                            if (((Integer) a1VarG.get(i3)).intValue() + 3 < length) {
                                ...
                                if (jVarH.a == 33 && jVarH.b == 0) {
                                    ...
                                    strA = androidx.media3.common.util.e.a(kVarI.a, kVarI.b, kVarI.c, kVarI.d, kVarI.e, kVarI.f);
                                    break loop0;
                                }
                            }
                        }
                ...
                if (strA == null) {
                    ...
                    pairB = androidx.media3.common.util.e.c(strA, strTrim.split("\\.", -1), rVar.E);
                }
            }
        }
        if (pairB == null) {
        ...
        if (this.i) {
            ...
            if (i5 != -1) {
                ...
                if (maxInputChannelCount <= 1 && ((Build.VERSION.SDK_INT < 26 || maxInputChannelCount <= 0) && !"audio/mpeg".equals(str2) && !"audio/3gpp".equals(str2) && !"audio/amr-wb".equals(str2) && !"audio/mp4a-latm".equals(str2) && !"audio/vorbis".equals(str2) && !"audio/opus".equals(str2) && !"audio/raw".equals(str2) && !"audio/flac".equals(str2) && !"audio/g711-alaw".equals(str2) && !"audio/g711-mlaw".equals(str2) && !"audio/gsm".equals(str2))) {
                    ...
                    androidx.media3.common.util.b.t("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + this.a + ", [" + maxInputChannelCount + " to " + i + "]");
    ...
    public final boolean g(int i, int i2, double d) {
        ...
        if (i3 >= 29) {
            int iB = (i3 < 29 || ((bool = com.imsdk.a.k) != null && bool.booleanValue())) ? 0 : androidx.compose.ui.platform.coreshims.b.b(videoCapabilities, i, i2, d);
            if (iB != 2) {
                if (iB == 1) {
                ...
                if (!a(videoCapabilities, i, i2, d)) {
                    if (i < i2) {
                        ...
                        if ("OMX.MTK.VIDEO.DECODER.HEVC".equals(str)) {
                            ...
                            sbW2.append(d);
                            StringBuilder sbQ = androidx.compose.runtime.j.q("AssumedSupport [", sbW2.toString(), "] [", str, ", ");
                            sbQ.append(this.b);
                            sbQ.append("] [");
                            sbQ.append(androidx.media3.common.util.i0.a);
                            sbQ.append("]");
                            androidx.media3.common.util.b.e("MediaCodecInfo", sbQ.toString());
                            return true;
                        }
                        StringBuilder sbW3 = androidx.privacysandbox.ads.adservices.java.internal.a.w("sizeAndRate.rotated, ", "x", i, "@", i2);
                        sbW3.append(d);
                        StringBuilder sbQ2 = androidx.compose.runtime.j.q("AssumedSupport [", sbW3.toString(), "] [", str, ", ");
                        sbQ2.append(this.b);
                        sbQ2.append("] [");
                        sbQ2.append(androidx.media3.common.util.i0.a);
                        sbQ2.append("]");
                        androidx.media3.common.util.b.e("MediaCodecInfo", sbQ2.toString());
                        return true;
                    }
            ...
            if (i < i2) {
                ...
                if (("OMX.MTK.VIDEO.DECODER.HEVC".equals(str) || !"mcv5a".equals(Build.DEVICE)) && a(videoCapabilities, i2, i, d)) {
                    ...
                    sbW5.append(d);
                    StringBuilder sbQ3 = androidx.compose.runtime.j.q("AssumedSupport [", sbW5.toString(), "] [", str, ", ");
                    sbQ3.append(this.b);
                    sbQ3.append("] [");
                    sbQ3.append(androidx.media3.common.util.i0.a);
                    sbQ3.append("]");
                    androidx.media3.common.util.b.e("MediaCodecInfo", sbQ3.toString());
                    return true;
                }
            }
    ...
    public final void h(String str) {
        ...
        sbX.append(this.b);
        sbX.append("] [");
        sbX.append(androidx.media3.common.util.i0.a);
        sbX.append("]");
        androidx.media3.common.util.b.e("MediaCodecInfo", sbX.toString());
    }
