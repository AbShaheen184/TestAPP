...
public abstract class r extends androidx.media3.exoplayer.a {
    ...
    public final boolean H(long j, long j2) throws androidx.media3.exoplayer.j {
        ...
        if (fVar2.t()) {
            ...
            boolean zE = fVar2.e(4);
            androidx.media3.common.r rVar = this.c0;
            rVar.getClass();
            fVar = fVar2;
            if (m0(j, j2, null, byteBuffer, i, 0, i2, j3, zX, zE, rVar)) {
                i0(fVar.G);
                fVar.o();
            }
        }
                        ...
                        if (eVar.B.limit() - eVar.B.position() != 0) {
                            ...
                            if (r0Var.b == 2) {
                                if (bArr != null) {
                                    ...
                                    byteBuffer3.put(okhttp3.internal.platform.android.g.d(bArr.length));
                                    byteBuffer3.put(bArr);
                                    byteBuffer3.putInt(22, i0.p(byteBuffer3.arrayOffset(), byteBuffer3.array(), bArr.length + 28, 0));
                            ...
                            byteBuffer3.flip();
                            if (r0Var.b == 2) {
                                byteBuffer3.putInt(r28 + 66, i0.p(byteBuffer3.arrayOffset() + r28 + 44, byteBuffer3.array(), byteBuffer3.limit() - byteBuffer3.position(), 0));
                            } else {
                                byteBuffer3.putInt(22, i0.p(byteBuffer3.arrayOffset(), byteBuffer3.array(), byteBuffer3.limit() - byteBuffer3.position(), 0));
                            }
                            r0Var.b++;
                            r0Var.a = byteBuffer3;
                            eVar.o();
    ...
    public final List O(boolean z) {
        ...
        if (!arrayListR2.isEmpty()) {
            androidx.media3.common.util.b.t("MediaCodecRenderer", "Drm session requires secure decoder for " + rVar.o + ", but no secure decoder available. Trying to proceed with " + arrayListR2 + ".");
        }
        return arrayListR2;
    }
    ...
    public abstract x1 U(o oVar, androidx.media3.common.r rVar, MediaCrypto mediaCrypto, float f);
    ...
    public final void W(o oVar, MediaCrypto mediaCrypto) {
        ...
        x1 x1VarU = U(oVar, rVar, mediaCrypto, fQ);
        int i2 = Build.VERSION.SDK_INT;
        if (i2 >= 31) {
            androidx.media3.exoplayer.analytics.k kVar = this.C;
            kVar.getClass();
            androidx.compose.ui.contentcapture.b.l(x1VarU, kVar);
        }
        try {
            Trace.beginSection("createCodec:" + str);
            l lVarK = this.Q.k(x1VarU);
            this.k0 = lVarK;
            this.y0 = lVarK.t(new androidx.media3.exoplayer.hls.c(this, 2));
            Trace.endSection();
            this.D.getClass();
            ...
            if (!oVar.e(this.P, rVar)) {
                ...
                androidx.media3.common.util.b.t("MediaCodecRenderer", androidx.compose.runtime.j.k("Format exceeds selected codec's capabilities [", strC, ", ", str, "]"));
            }
            this.o0 = fQ;
            this.l0 = rVar;
            boolean z = false;
    ...
    public final void Y() throws androidx.media3.exoplayer.j {
        ...
        if (this.d0 == null) {
            try {
                tVar = this.d0;
                if (tVar != null && (tVar.L() == 3 || this.d0.L() == 4)) {
    ...
    public final void Z(MediaCrypto mediaCrypto, boolean z) throws p {
        ...
        while (this.k0 == null) {
            ...
            try {
                ...
                androidx.media3.common.util.b.u("MediaCodecRenderer", "Failed to initialize decoder: " + oVar, e2);
    ...
    public androidx.media3.exoplayer.d f0(androidx.localbroadcastmanager.content.b bVar) throws androidx.media3.exoplayer.j {
        androidx.media3.common.r rVar;
        int i;
        Pair pairB;
        String str;
        ...
        if (!str2.equals("video/av01") && !str2.equals("video/x-vnd.on2.vp9")) {
            if (str2.equals("video/dolby-vision")) {
                byte[] bArr = androidx.media3.common.util.e.a;
                if (str2.equals("video/dolby-vision") && (pairB = androidx.media3.common.util.e.b(rVar2)) != null) {
    ...
    */
    ...
    public boolean y0() {
        ...
        try {
            ...
            androidx.media3.common.util.b.u("MediaCodecRenderer", "Failed to update the DRM session, releasing the codec instead.", e);
            return true;
        }
    }
    ...
    public void z(long j, long j2) throws androidx.media3.exoplayer.j {
        ...
        try {
            ...
            throw g(e, this.b0, false, i0.z(e.getErrorCode()));
