...
public abstract class v {
    ...
    public static void a(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            ...
            Collections.sort(arrayList, new b0(new i(), 1));
        }
    ...
    public static String c(androidx.media3.common.r rVar) {
        ...
        if ("video/dolby-vision".equals(str2) && (pairB = androidx.media3.common.util.e.b(rVar)) != null) {
                            ...
                            if ((z2 || !zIsFeatureRequired) && (!z2 || zIsFeatureSupported)) {
                                ...
                                if ((z || !zIsFeatureRequired2) && (!z || zIsFeatureSupported2)) {
                                    ...
                                    if (i4 >= 29) {
                                        ...
                                        String strB = com.imsdk.a.B(mediaCodecInfo.getName());
                                    ...
                                    if (z != zIsFeatureSupported2) {
                                        ...
                                        try {
                                            ...
                                            e = e;
                                            androidx.media3.common.util.b.f("MediaCodecUtil", "Failed to query codec " + name + " (" + str + ")");
                                            throw e;
                                        }
                                    }
                                } else {
