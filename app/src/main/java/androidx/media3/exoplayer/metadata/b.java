...
public final class b extends androidx.media3.exoplayer.a implements Handler.Callback {
    ...
    public final void G(h0 h0Var, ArrayList arrayList) {
        ...
        while (true) {
            ...
            if (rVarA != null) {
                a aVar = this.P;
                if (aVar.b(rVarA)) {
                    _COROUTINE.a aVarA = aVar.a(rVarA);
    ...
    public final long H(long j) {
        ...
        _COROUTINE.a.A(this.Y != -9223372036854775807L);
        return j - this.Y;
    }
    ...
    public final void I(h0 h0Var) {
        ...
        if (!f0VarA.equals(c0Var.S)) {
            c0Var.S = f0VarA;
            oVar.c(14, new y(xVar, 9));
        }
        oVar.c(28, new y(h0Var, 10));
        oVar.b();
    }
            ...
            if (!this.U && this.X == null) {
                ...
                if (iY == -4) {
                    if (aVar.e(4)) {
                        ...
                        aVar.G = this.W;
                        aVar.r();
                        _COROUTINE.a aVar2 = this.T;
                        String str = i0.a;
                        h0 h0VarE = aVar2.E(aVar);
                        if (h0VarE != null) {
                            ArrayList arrayList = new ArrayList(h0VarE.a.length);
                            G(h0VarE, arrayList);
