...
public final class e implements p {
    ...
    public boolean C;
    public androidx.localbroadcastmanager.content.b D;
    public long E;
    public a0 F;
    ...
    public final void b(androidx.localbroadcastmanager.content.b bVar, long j, long j2) {
        this.D = bVar;
        this.E = j2;
        boolean z = this.C;
        n nVar = this.e;
