...
public final class h implements x0, z0, androidx.media3.exoplayer.upstream.i, androidx.media3.exoplayer.upstream.l {
    ...
    public final t2 E;
    public final n F;
    public final androidx.core.text.f G;
    public final ArrayList H;
    public final List I;
    public final w0 J;
    public final w0[] K;
    public final androidx.localbroadcastmanager.content.b L;
    public f M;
    public r N;
    ...
    public h(int i, int[] iArr, r[] rVarArr, androidx.media3.exoplayer.dash.m mVar, androidx.media3.exoplayer.dash.b bVar, c2 c2Var, long j, androidx.media3.exoplayer.drm.f fVar, androidx.media3.exoplayer.drm.d dVar, t2 t2Var, androidx.media3.exoplayer.drm.d dVar2, boolean z, long j2, androidx.media3.exoplayer.util.a aVar) {
        ...
        this.G = new androidx.core.text.f();
        ...
        fVar.getClass();
        w0 w0Var = new w0(c2Var, fVar, dVar);
        this.J = w0Var;
        iArr2[0] = i;
        w0VarArr[0] = w0Var;
        int i3 = 0;
        while (i3 < length) {
            w0 w0Var2 = new w0(c2Var, null, null);
            this.K[i3] = w0Var2;
            int i4 = i3 + 1;
            w0VarArr[i4] = w0Var2;
            iArr2[i4] = this.y[i3];
        ...
        this.L = new androidx.localbroadcastmanager.content.b(13, iArr2, w0VarArr);
        this.P = j;
        this.Q = j;
        this.T = z;
    ...
    public final boolean d(n0 n0Var) {
        ...
        androidx.core.text.f fVar4 = this.G;
        if (bVar2 == null) {
            fVar = fVar4;
            long j8 = n0Var.a;
            j2 = -9223372036854775807L;
            long j9 = j - j8;
            long jQ = i0.Q(mVar.k.b(mVar.l).b) + i0.Q(mVar.k.a) + j;
            p pVar = mVar.h;
            if (pVar != null) {
                q qVar = pVar.e;
                androidx.media3.exoplayer.dash.manifest.c cVar = qVar.C;
                androidx.media3.exoplayer.dash.f fVar5 = qVar.y;
                z = z6;
                if (!cVar.d) {
                    j3 = j8;
                    z3 = false;
                    ...
                    if (entryCeilingEntry == null || ((Long) entryCeilingEntry.getValue()).longValue() >= jQ) {
                        ...
                        androidx.media3.exoplayer.dash.i iVar2 = fVar5.a;
                        long j10 = iVar2.M;
                    ...
                    if (z3 && qVar.D) {
                        qVar.E = true;
                        qVar.D = false;
                        androidx.media3.exoplayer.dash.i iVar3 = fVar5.a;
                ...
                if (z5) {
                    ...
                    aVar.J = bVar;
                    w0VarArr = (w0[]) bVar.z;
                    iArr = new int[w0VarArr.length];
                    for (i = 0; i < w0VarArr.length; i++) {
                        w0 w0Var2 = w0VarArr[i];
                        iArr[i] = w0Var2.q + w0Var2.p;
                    }
                    aVar.K = iArr;
                    this.H.add(aVar);
                } else if (fVar3 instanceof j) {
                    ((j) fVar3).H = bVar;
                }
                nVar.f(fVar3, this, this.E.f(fVar3.z));
                return true;
            }
            z = z6;
            j3 = j8;
            long jQ2 = i0.Q(i0.C(mVar.f));
            androidx.media3.exoplayer.dash.manifest.c cVar2 = mVar.k;
            long j11 = cVar2.a;
            long jQ3 = j11 == -9223372036854775807L ? -9223372036854775807L : jQ2 - i0.Q(j11 + cVar2.b(mVar.l).b);
            if (list3.isEmpty()) {
                list2 = list3;
                kVar = null;
            } else {
            ...
            while (true) {
                ...
                long j14 = kVar2.f;
                long j15 = kVar2.e;
                androidx.work.impl.model.f fVar6 = l.c;
                if (jVar == null) {
                    lVarArr[i3] = fVar6;
                } else {
                    jVar.getClass();
                    ...
                    if (kVar != null) {
                        ...
                        jVar2.getClass();
                        jK2 = i0.k(jVar2.s(j, j15) + j14, jM, jB);
                    }
                    long j16 = jK2;
                    if (j16 < jM) {
                        lVarArr[i3] = fVar6;
            ...
            if (!mVar.k.d || kVarArr[0].c() == 0) {
                ...
                long j19 = cVar3.a;
                long jMin = Math.min(j19 == -9223372036854775807L ? -9223372036854775807L : jQ2 - i0.Q(j19 + cVar3.b(mVar.l).b), jD) - j3;
                j18 = 0;
            ...
            if (eVar != null) {
                ...
                if (jVar4 != null || jVarD != null) {
                    ...
                    fVar2.b = new j(hVar, t1.j(mVar2, bVar3.a, jVar4, 0), rVarN, iO, objR, kVarB.a);
                }
                z4 = fVar2.a;
                fVar3 = (f) fVar2.b;
                fVar2.b = null;
                ...
                if (z5) {
                    ...
                    w0VarArr = (w0[]) bVar.z;
                    iArr = new int[w0VarArr.length];
                    while (i < w0VarArr.length) {
                        w0 w0Var3 = w0VarArr[i];
                        iArr[i] = w0Var3.q + w0Var3.p;
                    }
                    aVar.K = iArr;
                    this.H.add(aVar);
                } else if (fVar3 instanceof j) {
            ...
            if (kVarB.c() == j20) {
                ...
                if (kVar != null) {
                    ...
                    jVar3.getClass();
                    j5 = jB2;
                    jK = i0.k(jVar3.s(j, j22) + j23, jM2, j5);
                }
                long j24 = jK;
                if (j24 < jM2) {
                    ...
                    if (mVar.n && j24 >= j5) {
                        ...
                        if (eVar == null) {
                            iVar = new m(hVar2, t1.j(mVar2, bVar3.a, jVarQ, kVarB.f(j24, j12) ? 0 : 8), rVarN2, iO2, objR2, jE, kVarB.d(j24), j24, i5, rVarN2);
                        } else {
                            int i6 = 1;
                            int i7 = 1;
                            while (true) {
                            ...
                            androidx.media3.datasource.l lVarJ = t1.j(mVar2, bVar3.a, jVarQ, kVarB.f(j27, j12) ? 0 : 8);
                            long j29 = -mVar2.z;
                            if (androidx.media3.common.i0.m(rVarN2.o)) {
                                j29 += jE;
                            }
                            iVar = new i(hVar2, lVarJ, rVarN2, iO2, objR2, jE, jD3, j26, j28, j24, i7, j29, kVarB.a);
                        }
                        fVar2.b = iVar;
                    } else {
                        fVar2.a = true;
            ...
            if (z5) {
                ...
                iArr = new int[w0VarArr.length];
                while (i < w0VarArr.length) {
                    w0 w0Var4 = w0VarArr[i];
                    iArr[i] = w0Var4.q + w0Var4.p;
                }
                aVar.K = iArr;
                this.H.add(aVar);
            } else if (fVar3 instanceof j) {
        ...
        if (z5) {
            ...
            iArr = new int[w0VarArr.length];
            while (i < w0VarArr.length) {
                w0 w0Var5 = w0VarArr[i];
                iArr[i] = w0Var5.q + w0Var5.p;
            }
            aVar.K = iArr;
            this.H.add(aVar);
        } else if (fVar3 instanceof j) {
    ...
    public final int e(androidx.localbroadcastmanager.content.b bVar, androidx.media3.decoder.e eVar, int i) {
        ...
        a aVar = this.S;
        w0 w0Var = this.J;
        if (aVar != null && aVar.c(0) <= w0Var.u()) {
            return -3;
        }
        B();
        return w0Var.E(bVar, eVar, i, this.W);
    }
    ...
    /* JADX WARN: Code duplicated, block: B:120:0x014d A[SYNTHETIC] */
    ...
    public final androidx.media3.exoplayer.upstream.h f(androidx.media3.exoplayer.upstream.k kVar, long j, long j2, IOException iOException, int i) {
        ...
        androidx.media3.exoplayer.dash.manifest.b bVarG;
        ...
        com.google.firebase.messaging.n nVar3 = mVar.b;
        t2 t2Var3 = this.E;
        if (z) {
            z3 = z7;
            p pVar = mVar.h;
                ...
                if (qVar2.C.d) {
                    if (!qVar2.E) {
                        if (z8) {
                            ...
                            bVar = kVar5.c;
                            bVarG = nVar3.G(mVar4.y);
                            if (bVarG != null || bVar.equals(bVarG)) {
                                qVar = mVar.j;
                                h0Var = kVar5.b.y;
                                boolean z11 = z;
                                jElapsedRealtime = SystemClock.elapsedRealtime();
            ...
            if (!zP) {
                ...
                androidx.media3.common.util.b.t("ChunkSampleStream", "Ignoring attempt to cancel non-cancelable load.");
                hVar = null;
            }
            t2Var2 = t2Var;
            if (hVar == null) {
    ...
    public final int h(long j) {
        ...
        a aVar = this.S;
        if (aVar != null) {
            iW = Math.min(iW, aVar.c(0) - w0Var.u());
        }
        w0Var.J(iW);
        B();
        return iW;
    ...
    public final a r(int i) {
        ...
        i0.V(arrayList, i, arrayList.size());
        ...
        if (fVar instanceof j) {
            ...
            if (kVar2.d == null) {
                ...
                if (jVarA != null) {
                    ...
                    kVarArr[iB] = new androidx.media3.exoplayer.dash.k(kVar2.e, mVar2, kVar2.c, kVar2.a, kVar2.f, new d3(jVarA, mVar2.z, 1));
                }
            }
        }
        p pVar = mVar.h;
    ...
    public final a u() {
        return (a) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, this.H);
    }
    ...
    public final long v() {
        ...
        if (!aVarU.b()) {
            ArrayList arrayList = this.H;
            aVarU = arrayList.size() > 1 ? (a) androidx.privacysandbox.ads.adservices.java.internal.a.l(2, arrayList) : null;
        }
        if (aVarU != null) {
            jMax = Math.max(jMax, aVarU.E);
        }
