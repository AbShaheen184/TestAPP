...
public final class f1 extends a {
    ...
    public f1(androidx.media3.common.b0 b0Var, androidx.localbroadcastmanager.content.b bVar, t2 t2Var) {
        this.i = bVar;
        this.l = t2Var;
        ...
        Uri uri2 = b0Var.a;
        _COROUTINE.a.v(uri2, "The uri must be set.");
        this.h = new androidx.media3.datasource.l(uri2, 0L, 1, null, map, 0L, -1L, null, 1);
        this.n = new b1(-9223372036854775807L, -9223372036854775807L, -9223372036854775807L, -9223372036854775807L, 0L, 0L, true, false, false, null, c0Var, null);
    }

    @Override // androidx.media3.exoplayer.source.a
    public final u b(v vVar, c2 c2Var, long j) {
        return new e1(this.h, this.i, this.p, this.j, this.k, this.l, a(vVar), this.m, null);
    }
