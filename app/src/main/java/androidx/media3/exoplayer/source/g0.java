...
public final class g0 extends h {
    ...
    public final com.google.android.material.shape.f o;
    public int p;
    public long[][] q;
    ...
    public g0(a... aVarArr) {
        com.google.android.material.shape.f fVar = new com.google.android.material.shape.f(11);
        this.k = aVarArr;
        this.o = fVar;
    ...
    public final void l(androidx.media3.exoplayer.upstream.f fVar) {
        this.j = fVar;
        this.i = androidx.media3.common.util.i0.q(null);
        int i = 0;
        while (true) {
            a[] aVarArr = this.k;
            if (i >= aVarArr.length) {
    ...
    public final void n(u uVar) {
        ...
        while (true) {
            ...
            u[] uVarArr = e0Var.e;
            u uVar2 = zArr[i] ? ((h1) uVarArr[i]).e : uVarArr[i];
            ...
            aVarArr[i].n(e0Var.y[i] ? ((h1) uVarArr[i]).e : uVarArr[i]);
            i++;
        }
    }
