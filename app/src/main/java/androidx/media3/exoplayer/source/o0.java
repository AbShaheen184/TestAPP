...
public final class o0 implements u, androidx.media3.extractor.p, androidx.media3.exoplayer.upstream.i, androidx.media3.exoplayer.upstream.l, v0 {
    ...
    public final c2 I;
    public final androidx.media3.common.util.g J;
    public final h0 K;
    public final h0 L;
    ...
    public boolean U;
    public boolean V;
    public com.google.firebase.messaging.n W;
    ...
    public o0(Uri uri, androidx.media3.datasource.h hVar, c2 c2Var, androidx.media3.exoplayer.drm.f fVar, androidx.media3.exoplayer.drm.d dVar, t2 t2Var, androidx.media3.exoplayer.drm.d dVar2, q0 q0Var, c2 c2Var2, int i, long j, androidx.media3.exoplayer.util.a aVar) {
        ...
        this.I = c2Var;
        this.G = j;
        this.J = new androidx.media3.common.util.g();
        this.K = new h0(this, 1);
        this.L = new h0(this, 2);
        this.M = androidx.media3.common.util.i0.q(null);
        this.R = new n0[0];
        this.Q = new w0[0];
        this.P = new k0[0];
    ...
    public final void A() {
        ...
        androidx.media3.common.util.g gVar = this.J;
        synchronized (gVar) {
            gVar.b = false;
        }
        ...
        this.W = new com.google.firebase.messaging.n(new j1(w0VarArr), zArr);
    ...
    public final void B(int i) {
        b();
        com.google.firebase.messaging.n nVar = this.W;
        boolean[] zArr = (boolean[]) nVar.B;
        if (zArr[i]) {
            return;
        }
        androidx.media3.common.r rVar = ((j1) nVar.y).a(i).d[0];
    ...
    public final androidx.media3.extractor.h0 D(n0 n0Var) {
        ...
        if (this.S) {
            androidx.media3.common.util.b.t("ProgressiveMediaPeriod", "Extractor added new track (id=" + n0Var.a + ") after finishing tracks.");
            return new androidx.media3.extractor.m();
        }
        androidx.media3.exoplayer.drm.f fVar = this.z;
        fVar.getClass();
        w0 w0Var = new w0(this.E, fVar, this.C);
        k0 k0Var = new k0(w0Var);
        w0Var.f = this;
        int i2 = length + 1;
        n0[] n0VarArr = (n0[]) Arrays.copyOf(this.R, i2);
        n0VarArr[length] = n0Var;
        this.R = n0VarArr;
        w0[] w0VarArr = (w0[]) Arrays.copyOf(this.Q, i2);
    ...
    public final void c() {
        for (w0 w0Var : this.Q) {
            w0Var.F(true);
            androidx.media3.exoplayer.dash.manifest.t tVar = w0Var.h;
            if (tVar != null) {
                tVar.M(w0Var.e);
                w0Var.h = null;
                w0Var.g = null;
    ...
    public final androidx.media3.exoplayer.upstream.h f(androidx.media3.exoplayer.upstream.k kVar, long j, long j2, IOException iOException, int i) {
        ...
        androidx.media3.common.util.i0.d0(l0Var.F);
        androidx.media3.common.util.i0.d0(this.Y);
        long jG = this.A.g(new androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.l(iOException, i, 3));
        if (jG == -9223372036854775807L) {
            hVar = androidx.media3.exoplayer.upstream.n.f;
        } else {
            int iE = e();
            int i2 = iE > this.k0 ? 1 : 0;
            ...
            hVar = new androidx.media3.exoplayer.upstream.h(jG, i2, false);
        }
    ...
    public final void h(androidx.media3.extractor.a0 a0Var) {
    ...
    public final long k(long j) {
        ...
        if (i2 == 7 || !(this.l0 || nVar.d())) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                w0 w0Var3 = this.Q[i3];
                if (this.P[i3].d.get() == j0.e && (w0Var3.u() != 0 || !z2)) {
                    if (!(this.V ? w0Var3.G(w0Var3.q) : w0Var3.H(j, this.l0)) && (zArr[i3] || !this.U)) {
                        z = false;
                        break;
                    }
                }
    ...
    public final long m(androidx.media3.exoplayer.trackselection.q[] qVarArr, boolean[] zArr, x0[] x0VarArr, boolean[] zArr2, long j) {
        ...
        com.google.firebase.messaging.n nVar = this.W;
        j1 j1Var = (j1) nVar.y;
        boolean[] zArr3 = (boolean[]) nVar.A;
        int i = this.f0;
        int i2 = 0;
        for (int i3 = 0; i3 < qVarArr.length; i3++) {
            x0 x0Var = x0VarArr[i3];
            if (x0Var != null && (qVarArr[i3] == null || !zArr[i3])) {
                int i4 = ((m0) x0Var).e;
                _COROUTINE.a.A(zArr3[i4]);
                this.f0--;
                zArr3[i4] = false;
                x0VarArr[i3] = null;
            }
        ...
        for (int i5 = 0; i5 < qVarArr.length; i5++) {
            if (x0VarArr[i5] == null && (qVar = qVarArr[i5]) != null) {
                _COROUTINE.a.A(qVar.length() == 1);
                _COROUTINE.a.A(qVar.i(0) == 0);
                int iB = j1Var.b(qVar.c());
                _COROUTINE.a.A(!zArr3[iB]);
                this.f0++;
                zArr3[iB] = true;
                this.e0 = qVar.n().u | this.e0;
                x0VarArr[i5] = new m0(this, iB);
                zArr2[i5] = true;
                if (!z) {
                    w0 w0Var = this.Q[iB];
                    z = (w0Var.u() == 0 || w0Var.H(j, true)) ? false : true;
                }
            }
        }
        if (this.f0 == 0) {
            ...
            this.d0 = false;
            this.e0 = false;
            androidx.media3.exoplayer.upstream.n nVar2 = this.H;
            if (nVar2.d()) {
                w0[] w0VarArr = this.Q;
    ...
    public final long v() {
        ...
        if (this.U) {
            ...
            for (int i = 0; i < length; i++) {
                com.google.firebase.messaging.n nVar = this.W;
                if (((boolean[]) nVar.z)[i] && ((boolean[]) nVar.A)[i]) {
                    w0 w0Var = this.Q[i];
                    synchronized (w0Var) {
                        z = w0Var.y;
                    }
    ...
    public final void w(long j) {
        ...
        if (this.b0 != Long.MIN_VALUE) {
            ...
            while (true) {
                ...
                com.google.firebase.messaging.n nVar = this.W;
                if (((boolean[]) nVar.A)[i] && (((boolean[]) nVar.z)[i] || !this.U)) {
                    i2 &= w0VarArr[i].y() ? 1 : 0;
                }
                i++;
            }
