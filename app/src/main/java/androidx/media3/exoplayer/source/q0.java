...
public final class q0 extends a {
    ...
    public q0(androidx.media3.common.c0 c0Var, androidx.localbroadcastmanager.content.b bVar, androidx.activity.y yVar, androidx.media3.exoplayer.drm.f fVar, t2 t2Var) {
        this.s = c0Var;
        this.h = bVar;
        this.i = yVar;
        this.j = fVar;
    ...
    public final u b(v vVar, c2 c2Var, long j) {
        androidx.media3.datasource.h hVarB = this.h.b();
        ...
        Uri uri = yVar.a;
        this.g.getClass();
        return new o0(uri, hVarB, new c2((androidx.media3.extractor.q) this.i.y), this.j, new androidx.media3.exoplayer.drm.d(this.d.c, 0, vVar), this.k, a(vVar), this, c2Var, this.l, androidx.media3.common.util.i0.Q(yVar.e), null);
    }
    ...
    public final void t() {
        ...
        androidx.media3.common.v0 b1Var = new b1(-9223372036854775807L, -9223372036854775807L, j, j, 0L, 0L, z, false, false, null, c0VarH, z2 ? c0VarH.c : null);
        if (this.m) {
            b1Var = new p0(b1Var);
        }
        m(b1Var);
