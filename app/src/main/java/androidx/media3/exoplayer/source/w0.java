...
public class w0 implements androidx.media3.extractor.h0 {
    public boolean B;
    ...
    public final androidx.appcompat.widget.x c = new androidx.appcompat.widget.x(new t0(0));
    ...
    public w0(c2 c2Var, androidx.media3.exoplayer.drm.f fVar, androidx.media3.exoplayer.drm.d dVar) {
        this.d = fVar;
        this.e = dVar;
        this.a = new s0(c2Var);
    }
    ...
    public final void B() {
        ...
        androidx.media3.exoplayer.drm.b bVarJ = this.h.J();
        bVarJ.getClass();
        throw bVarJ;
    }

    public final void C(androidx.media3.common.r rVar, androidx.localbroadcastmanager.content.b bVar) {
        ...
        if (z || !Objects.equals(mVar, mVar2)) {
            androidx.media3.exoplayer.dash.manifest.t tVar = this.h;
            fVar.getClass();
            androidx.media3.exoplayer.dash.manifest.t tVar2 = rVar.s == null ? null : new androidx.media3.exoplayer.dash.manifest.t(new androidx.media3.exoplayer.drm.b(new androidx.media3.exoplayer.drm.i(), 6001));
            this.h = tVar2;
            bVar.y = tVar2;
            if (tVar != null) {
                tVar.getClass();
    ...
    public final int E(androidx.localbroadcastmanager.content.b bVar, androidx.media3.decoder.e eVar, int i, boolean z) {
        int i2;
        boolean z2 = (i & 2) != 0;
        ...
        synchronized (this) {
            ...
            i2 = -5;
            if ((this.s != this.p) && !z3) {
                androidx.media3.common.r rVar = ((u0) this.c.j(iU)).a;
                if (z2 || rVar != this.g) {
                    C(rVar, bVar);
                } else {
                    int iV = v(this.s);
    ...
    public final void F(boolean z) {
        ...
        r0 r0Var3 = s0Var.d;
        int i = s0Var.b;
        _COROUTINE.a.A(((androidx.media3.exoplayer.upstream.a) r0Var3.z) == null);
        r0Var3.e = 0L;
        r0Var3.y = i;
        r0 r0Var4 = s0Var.d;
        s0Var.e = r0Var4;
        ...
        for (int i2 = 0; i2 < sparseArray.size(); i2++) {
            ((t0) xVar.A).accept(sparseArray.valueAt(i2));
        }
        xVar.y = -1;
        sparseArray.clear();
        if (z) {
            ...
            try {
                ...
                if (j != Long.MIN_VALUE) {
                    if (j <= this.w) {
                        w0Var = this;
                        j2 = j;
                        iO = w0Var.o(this.r, j2, this.p, false);
                    } else {
                        w0Var = this;
                        j2 = j;
                        iO = -1;
    ...
    public final void b(androidx.media3.common.util.v vVar, int i, int i2) {
        while (true) {
            ...
            vVar.k(aVar.a, ((int) (s0Var.g - r0Var.e)) + aVar.b, iB);
            i -= iB;
    ...
    /* JADX WARN: Type inference failed for: r6v26, types: [androidx.media3.exoplayer.source.v0, java.lang.Object] */
    @Override // androidx.media3.extractor.h0
            ...
            try {
                ...
                if (!Objects.equals(rVarQ, this.D)) {
                    if (((SparseArray) this.c.z).size() == 0) {
                        ...
                        if (((u0) sparseArray.valueAt(sparseArray.size() - 1)).a.equals(rVarQ)) {
                            SparseArray sparseArray2 = (SparseArray) this.c.z;
                            this.D = ((u0) sparseArray2.valueAt(sparseArray2.size() - 1)).a;
                        } else {
                            this.D = rVarQ;
                        }
                    }
    ...
    public void g(long j, int i, int i2, int i3, androidx.media3.extractor.g0 g0Var) {
        ...
        if (this.F) {
            ...
            if (i5 == 0) {
                if (!this.G) {
                    androidx.media3.common.util.b.t("SampleQueue", "Overriding unexpected non-sync sample for format: " + this.D);
                    this.G = true;
                }
                i |= 1;
            }
        ...
        synchronized (this) {
            try {
                ...
                if (i6 > 0) {
                    int iV = v(i6 - 1);
                    _COROUTINE.a.o(this.k[iV] + ((long) this.l[iV]) <= j3);
                }
                ...
                if (((SparseArray) this.c.z).size() == 0) {
                    ...
                    if (sparseArray.size() > 0) {
                        ...
                        _COROUTINE.a.o(z);
                        if (iKeyAt == i4) {
                            ((t0) xVar.A).accept(sparseArray.valueAt(sparseArray.size() - 1));
                        }
                    }
                    sparseArray.append(i4, u0Var);
                } else {
                    SparseArray sparseArray2 = (SparseArray) this.c.z;
                    if (!((u0) sparseArray2.valueAt(sparseArray2.size() - 1)).a.equals(this.D)) {
    ...
    public final long i(int i) {
        ...
        while (i6 < sparseArray.size() - 1) {
            ...
            ((t0) xVar.A).accept(sparseArray.valueAt(i6));
    ...
    public final long m(int i) {
        ...
        int i4 = (i2 + i3) - i;
        boolean z = false;
        _COROUTINE.a.o(i4 >= 0 && i4 <= i3 - this.s);
        int i5 = this.p - i4;
        this.p = i5;
        ...
        for (int size = sparseArray.size() - 1; size >= 0 && i < sparseArray.keyAt(size); size--) {
            ((t0) xVar.A).accept(sparseArray.valueAt(size));
