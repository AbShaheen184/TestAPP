...
public final /* synthetic */ class t implements Runnable {
    ...
    public /* synthetic */ t(Context context, boolean z, c0 c0Var, androidx.media3.exoplayer.analytics.k kVar) {
        this.z = context;
        this.y = z;
        this.A = c0Var;
        this.B = kVar;
    ...
    public final void run() {
        switch (this.e) {
            case 0:
                ...
                if (jVarG == null) {
                    androidx.media3.common.util.b.t("ExoPlayerImpl", "MediaMetricsService unavailable.");
                    return;
                }
                if (z) {
                ...
                synchronized (kVar) {
                    androidx.compose.ui.scrollcapture.h hVar = kVar.b;
                    hVar.getClass();
                    hVar.h(logSessionIdI);
                }
                return;
            case 1:
    ...
    public /* synthetic */ t(com.google.firebase.crashlytics.internal.persistence.c cVar, j2 j2Var, com.google.firebase.crashlytics.internal.metadata.c cVar2, boolean z) {
        this.z = cVar;
        this.A = j2Var;
        this.B = cVar2;
        this.y = z;
    ...
    public /* synthetic */ t(SeedDiscovery seedDiscovery, String str, boolean z, SeedDiscovery.StringCallback stringCallback) {
