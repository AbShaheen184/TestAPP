...
public final class b extends c {
    ...
    public b(w0 w0Var, int[] iArr, androidx.media3.exoplayer.upstream.f fVar, long j, long j2, long j3, h0 h0Var) {
        super(w0Var, iArr);
        if (j3 < j) {
            androidx.media3.common.util.b.t("AdaptiveTrackSelection", "Adjusting minDurationToRetainAfterDiscardMs to be at least minDurationForQualityIncreaseMs");
            j3 = j;
        }
        this.g = fVar;
        this.h = j * 1000;
    ...
    public static void v(ArrayList arrayList, long[] jArr) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            com.google.common.collect.d0 d0Var = (com.google.common.collect.d0) arrayList.get(i);
            if (d0Var != null) {
    ...
    public final int j(long j, List list) {
        ...
        int size = list.size();
        long jE = i0.E(this.q, ((androidx.media3.exoplayer.source.chunk.k) list.get(size - 1)).D - j);
        long j3 = this.j;
        if (jE >= j3) {
            x(list);
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (i0.E(this.q, kVar.D - j) >= j3 && rVar2.j < rVar.j && (i = rVar2.w) != -1 && i <= this.l && (i2 = rVar2.v) != -1 && i2 <= this.k && i < rVar.w) {
                    return i3;
                }
            }
        }
