...
public final class o {
    ...
    public final com.google.android.gms.common.internal.k e;
    public j f;
    public Thread g;
    ...
    public o(Context context) {
        com.google.android.gms.common.internal.k kVar = new com.google.android.gms.common.internal.k(12);
        j jVar = j.G;
        this.c = new Object();
        ...
        if (this.f.B && context == null) {
            androidx.media3.common.util.b.t("DefaultTrackSelector", "Audio channel count constraints cannot be applied without reference to Context. Build the track selector instance with one of the non-deprecated constructors that take a Context argument.");
        }
    }
    ...
    public static void b(s sVar, j jVar, p[] pVarArr) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (map != null && map.containsKey(j1Var)) {
                ...
                if (map2 != null && map2.get(j1Var) != null) {
    ...
    public static void d(s sVar, j jVar, p[] pVarArr) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (x0Var != null) {
                w0 w0Var = x0Var.a;
                h0 h0Var = x0Var.b;
                pVarArr[i3] = (h0Var.isEmpty() || j1VarArr[i3].b(w0Var) == -1) ? null : new p(0, w0Var, com.imsdk.a.A(h0Var));
            }
        }
    }

    public static void e(j1 j1Var, a1 a1Var, HashMap map) {
        for (int i = 0; i < j1Var.a; i++) {
            x0 x0Var = (x0) a1Var.v.get(j1Var.a(i));
            if (x0Var != null) {
                w0 w0Var = x0Var.a;
    ...
    public static p l(j1 j1Var, int[][] iArr, j jVar) {
        jVar.q.getClass();
        w0 w0Var = null;
        h hVar = null;
        int i = 0;
        for (int i2 = 0; i2 < j1Var.a; i2++) {
            w0 w0VarA = j1Var.a(i2);
            int[] iArr2 = iArr[i2];
    ...
    public final void k() {
        ...
        synchronized (this.c) {
            try {
                ...
                if (thread != null) {
                    _COROUTINE.a.z("DefaultTrackSelector is accessed on the wrong thread.", thread == Thread.currentThread());
                }
            } catch (Throwable th) {
                throw th;
            }
