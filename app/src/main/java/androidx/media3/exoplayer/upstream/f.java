...
public final class f {
    ...
    public f(Context context, HashMap map) {
        ...
        this.l = a(iB);
        e eVar = new e(this);
        Executor executorH = androidx.media3.common.util.b.h();
        CopyOnWriteArrayList<androidx.media3.common.util.r> copyOnWriteArrayList = tVarA.b;
        for (androidx.media3.common.util.r rVar : copyOnWriteArrayList) {
            if (rVar.a.get() == null) {
                copyOnWriteArrayList.remove(rVar);
            }
        }
        androidx.media3.common.util.r rVar2 = new androidx.media3.common.util.r(tVarA, eVar, executorH);
        synchronized (tVarA.c) {
            tVarA.b.add(rVar2);
            z = tVarA.e;
        }
        if (z) {
    ...
    public final void b(long j, long j2, int i) {
        ...
        this.m = j2;
        for (final c cVar : (CopyOnWriteArrayList) this.c.y) {
            if (cVar.c) {
                j3 = j;
                j4 = j2;
                i2 = i;
                ...
                cVar.a.post(new Runnable() { // from class: androidx.media3.exoplayer.upstream.b
                    ...
                    public final void run() {
                        ...
                        x1 x1Var = gVar.A;
                        androidx.media3.exoplayer.analytics.a aVarJ = gVar.J(((h0) x1Var.b).isEmpty() ? null : (v) com.google.common.collect.q.k((h0) x1Var.b));
