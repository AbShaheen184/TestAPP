        ...
        try {
            ...
            while (i < length) {
                ...
                try {
                    ...
                    long jC3 = c(bArr3, 40);
                    if (b4 == 3) {
                        kotlinx.coroutines.future.a.w("SNTP: Unsynchronized server");
                    } else if (b5 != 4 && b5 != 5) {
                        kotlinx.coroutines.future.a.w(androidx.privacysandbox.ads.adservices.java.internal.a.n(b5, "SNTP: Untrusted mode: "));
                    } else if (i3 == 0 || i3 > 15) {
                        kotlinx.coroutines.future.a.w(androidx.privacysandbox.ads.adservices.java.internal.a.n(i3, "SNTP: Untrusted stratum: "));
                    } else if (jC3 == 0) {
                        kotlinx.coroutines.future.a.w("SNTP: Zero transmitTime");
                    }
