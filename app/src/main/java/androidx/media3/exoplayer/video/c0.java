...
public final class c0 {
    ...
    public c0(androidx.localbroadcastmanager.content.b bVar, w wVar, x xVar) {
        this.a = bVar;
        this.b = wVar;
        this.g = xVar;
    ...
    public final void a(long j, long j2) {
        final androidx.localbroadcastmanager.content.b bVar = this.a;
        c cVar = (c) bVar.z;
        while (true) {
            ...
            if (iA == 0 || iA == 1) {
                ...
                wVar.e = 3;
                wVar.l.getClass();
                wVar.g = androidx.media3.common.util.i0.Q(SystemClock.elapsedRealtime());
                if (z2 && cVar.e != null) {
                    final int i2 = 0;
