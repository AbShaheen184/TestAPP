...
public final class k extends androidx.media3.exoplayer.mediacodec.r {
    ...
    public final w k1;
    public final v l1;
    public final androidx.localbroadcastmanager.content.b m1;
    ...
    public Surface x1;
    public m y1;
    public androidx.media3.common.util.w z1;
    ...
    public k(i iVar) {
        ...
        this.z1 = androidx.media3.common.util.w.c;
        this.B1 = 1;
        this.C1 = 0;
        this.N1 = f1.d;
        this.R1 = 0;
        ...
        this.m1 = new androidx.localbroadcastmanager.content.b(14);
    ...
    public static int F0(androidx.media3.exoplayer.mediacodec.o oVar, androidx.media3.common.r rVar) {
        ...
        if (i != -1 && i2 != -1) {
            ...
            if ("video/dolby-vision".equals(str)) {
                Pair pairB = androidx.media3.common.util.e.b(rVar);
                if (pairB == null) {
                    str = "video/hevc";
                } else {
            ...
            switch (str) {
                ...
                case "video/avc":
                    ...
                    if (!"BRAVIA 4K 2015".equals(str2) && (!"Amazon".equals(Build.MANUFACTURER) || (!"KFSOWI".equals(str2) && (!"AFTS".equals(str2) || !oVar.f)))) {
                        return ((i0.g(i2, 16) * i0.g(i, 16)) * 768) / 4;
                    }
                    break;
    ...
    public final int A0(androidx.media3.exoplayer.mediacodec.i iVar, androidx.media3.common.r rVar) {
        boolean z;
        int i = 0;
        if (!androidx.media3.common.i0.o(rVar.o)) {
        ...
        if (zE) {
            ...
            if (!listG1.isEmpty()) {
                ...
                Collections.sort(arrayList, new androidx.compose.ui.semantics.b0(new androidx.media3.exoplayer.analytics.c(i4, context, rVar), i2));
    ...
    public final Surface I0(androidx.media3.exoplayer.mediacodec.o oVar) {
        ...
        if (this.y1 == null) {
            ...
            if (z2) {
                ...
                lVar.y = handler;
                lVar.e = new androidx.media3.common.util.i(handler);
                synchronized (lVar) {
            ...
            lVar.y = handler2;
            lVar.e = new androidx.media3.common.util.i(handler2);
            synchronized (lVar) {
                lVar.y.obtainMessage(1, i, 0).sendToTarget();
                while (lVar.B == null) {
                    lVar.wait();
    ...
    public final void N0(androidx.media3.exoplayer.mediacodec.l lVar, int i, long j) {
        ...
        if (this.t1 == null) {
            ...
            wVar.e = 3;
            wVar.l.getClass();
            wVar.g = i0.Q(SystemClock.elapsedRealtime());
        ...
        if (j < -500000 && !z) {
            ...
            if (iH != 0) {
                ...
                if (z2) {
                    ...
                    cVar.j++;
                    S0(priorityQueue.size() + iH, this.G1);
                }
                if (this.k0 != null) {
                    if (y0()) {
                        o0();
    ...
    public final ArrayList R(androidx.media3.exoplayer.mediacodec.i iVar, androidx.media3.common.r rVar, boolean z) {
        ...
        Collections.sort(arrayList, new androidx.compose.ui.semantics.b0(new androidx.media3.exoplayer.analytics.c(2, context, rVar), 1));
        return arrayList;
    }
    ...
    @Override // androidx.media3.exoplayer.mediacodec.r
    public final x1 U(androidx.media3.exoplayer.mediacodec.o oVar, androidx.media3.common.r rVar, MediaCrypto mediaCrypto, float f) {
        ...
        if (rVarArr.length == 1) {
            ...
            if (z2) {
                androidx.media3.common.util.b.t("MediaCodecVideoRenderer", "Resolutions unknown. Codec max resolution: " + iMax + "x" + iMax2);
                boolean z3 = i3 > i2;
                int i8 = z3 ? i3 : i2;
                boolean z4 = z3;
                int i9 = z3 ? i2 : i3;
                    ...
                    if (i10 < 9) {
                        ...
                        if (i11 > i8 && i13 > i9) {
                            ...
                            if (codecCapabilities == null || (videoCapabilities = codecCapabilities.getVideoCapabilities()) == null) {
                                ...
                                point = new Point(i0.g(i13, widthAlignment) * widthAlignment, i0.g(i11, heightAlignment) * heightAlignment);
                            }
                            if (point != null) {
                                i = i3;
                        ...
                        if (point != null) {
                            ...
                            androidx.media3.common.util.b.t("MediaCodecVideoRenderer", "Codec max resolution adjusted to: " + iMax + "x" + iMax2);
                        }
                    }
                    i = i3;
                    point = null;
        ...
        androidx.media3.common.util.b.s(mediaFormat, rVar.r);
        if (f2 != -1.0f) {
            mediaFormat.setFloat("frame-rate", f2);
        }
        androidx.media3.common.util.b.o(mediaFormat, "rotation-degrees", rVar.A);
        if (hVar != null) {
            androidx.media3.common.h hVar3 = hVar;
            androidx.media3.common.util.b.o(mediaFormat, "color-transfer", hVar3.c);
            androidx.media3.common.util.b.o(mediaFormat, "color-standard", hVar3.a);
            androidx.media3.common.util.b.o(mediaFormat, "color-range", hVar3.b);
            byte[] bArr = hVar3.d;
            if (bArr != null) {
                mediaFormat.setByteBuffer("hdr-static-info", ByteBuffer.wrap(bArr));
            }
        }
        if ("video/dolby-vision".equals(rVar.o) && (pairB = androidx.media3.common.util.e.b(rVar)) != null) {
            androidx.media3.common.util.b.o(mediaFormat, "profile", ((Integer) pairB.first).intValue());
        }
        mediaFormat.setInteger("max-width", jVar.a);
        mediaFormat.setInteger("max-height", jVar.b);
        androidx.media3.common.util.b.o(mediaFormat, "max-input-size", jVar.c);
        ...
        G(mediaFormat);
        Surface surfaceI0 = I0(oVar);
        if (this.t1 != null && !i0.N(this.f1)) {
            mediaFormat.setInteger("allow-frame-drop", 0);
        }
        return new x1(oVar, mediaFormat, rVar, surfaceI0, mediaCrypto, null);
    }
    ...
    public final void b0(Exception exc) {
        androidx.media3.common.util.b.g("MediaCodecVideoRenderer", "Video codec error", exc);
        androidx.media3.exoplayer.audio.t tVar = this.h1;
        Handler handler = tVar.a;
        if (handler != null) {
            handler.post(new d0(tVar, exc, 1));
        }
    }
    ...
    public final void d(int i, Object obj) throws androidx.media3.exoplayer.j {
        ...
        if (i == 14) {
            obj.getClass();
            androidx.media3.common.util.w wVar = (androidx.media3.common.util.w) obj;
    ...
    public final void d0(androidx.media3.exoplayer.b bVar) {
        ...
        Handler handler = tVar.a;
        if (handler != null) {
            handler.post(new androidx.activity.c(26, tVar, bVar));
        }
    }
    ...
    public final void e0(String str) {
        ...
        Handler handler = tVar.a;
        if (handler != null) {
            handler.post(new d0(tVar, str, 2));
        }
    }

    @Override // androidx.media3.exoplayer.mediacodec.r
    public final androidx.media3.exoplayer.d f0(androidx.localbroadcastmanager.content.b bVar) throws androidx.media3.exoplayer.j {
    ...
    public final void k0(androidx.media3.decoder.e eVar) {
        ...
        androidx.localbroadcastmanager.content.b bVar = this.m1;
        if (bVar != null) {
            androidx.media3.exoplayer.mediacodec.o oVar = this.r0;
            oVar.getClass();
            if (oVar.b.equals("video/av01") && eVar.e(1) && (byteBuffer = eVar.B) != null) {
    ...
    public final boolean m0(long j, long j2, androidx.media3.exoplayer.mediacodec.l lVar, ByteBuffer byteBuffer, int i, int i2, int i3, long j3, boolean z, boolean z2, androidx.media3.common.r rVar) {
        ...
        kotlinx.coroutines.future.a.u(String.valueOf(iA));
        return false;
    }
    ...
    public final void p() {
        ...
        try {
            ...
            synchronized (cVar) {
                Handler handler = tVar.a;
                if (handler != null) {
                    handler.post(new androidx.activity.c(28, tVar, cVar));
                }
                tVar.b(f1.d);
            }
        }
    ...
    public final void q(boolean z, boolean z2) {
        ...
        h1Var.getClass();
        boolean z3 = h1Var.b;
        _COROUTINE.a.A((z3 && this.R1 == 0) ? false : true);
        if (this.Q1 != z3) {
            this.Q1 = z3;
            o0();
        }
        ...
        Handler handler = tVar.a;
        if (handler != null) {
            handler.post(new d0(tVar, cVar, 5));
        }
        boolean z4 = this.u1;
        w wVar = this.k1;
        if (!z4) {
            if (this.w1 != null && this.t1 == null) {
                ...
                androidx.media3.common.util.d0 d0Var = this.D;
                d0Var.getClass();
                nVar.e = d0Var;
                _COROUTINE.a.A(!nVar.f);
                if (nVar.c == null) {
                    nVar.c = new q();
                }
                s sVar = new s(nVar);
        ...
        h0 h0Var2 = this.t1;
        if (h0Var2 == null) {
            androidx.media3.common.util.d0 d0Var2 = this.D;
            d0Var2.getClass();
            wVar.l = d0Var2;
            wVar.e(!z2 ? 1 : 0);
            return;
        ...
        if (this.x1 != null && !this.z1.equals(androidx.media3.common.util.w.c)) {
                    ...
                    if (bVar != null) {
                        ...
                        if (oVar.b.equals("video/av01") && (byteBuffer = eVar.B) != null) {
                            ...
                            if (byteBuffer2.hasRemaining()) {
                                bVar.J(androidx.media3.container.r.o(byteBuffer2));
                            ...
                            if (iLimit == 0) {
                                ...
                                androidx.media3.container.j jVar = this.q1;
                                jVar.getClass();
                                if (jVar.c + iLimit < byteBufferAsReadOnlyBuffer.capacity() && !eVar.e(1073741824)) {
