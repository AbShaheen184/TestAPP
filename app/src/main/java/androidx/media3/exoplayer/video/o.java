...
public final class o implements h0 {
    ...
    @Override // androidx.media3.exoplayer.video.h0
    public final void d(Surface surface, androidx.media3.common.util.w wVar) {
        s sVar = this.f;
        Pair pair = sVar.l;
        if (pair != null && ((Surface) pair.first).equals(surface) && ((androidx.media3.common.util.w) sVar.l.second).equals(wVar)) {
            return;
        }
        sVar.l = Pair.create(surface, wVar);
        int i = wVar.a;
    }
    ...
    @Override // androidx.media3.exoplayer.video.h0
    public final void m() {
        int i = androidx.media3.common.util.w.c.a;
        this.f.l = null;
    }
    ...
    public final void o(boolean z) {
        ...
        if (sVar.n == 1) {
            ...
            androidx.media3.common.util.f0 f0Var = sVar.k;
            f0Var.getClass();
            f0Var.d(new androidx.activity.l(sVar, 24));
        }
    }
    ...
    /* JADX WARN: Code duplicated, block: B:25:0x0042 A[Catch: j -> 0x003d, TryCatch #0 {j -> 0x003d, blocks: (B:14:0x002b, B:17:0x0033, B:20:0x003a, B:25:0x0042, B:27:0x0046, B:34:0x0059, B:37:0x0060, B:42:0x0082, B:32:0x0051), top: B:47:0x002b }] */
    /* JADX WARN: Code duplicated, block: B:30:0x004d  */
    /* JADX WARN: Code duplicated, block: B:31:0x004f A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:32:0x0051 A[Catch: j -> 0x003d, TryCatch #0 {j -> 0x003d, blocks: (B:14:0x002b, B:17:0x0033, B:20:0x003a, B:25:0x0042, B:27:0x0046, B:34:0x0059, B:37:0x0060, B:42:0x0082, B:32:0x0051), top: B:47:0x002b }] */
    /* JADX WARN: Code duplicated, block: B:38:0x007b  */
    /* JADX WARN: Code duplicated, block: B:40:0x007e  */
    /* JADX WARN: Code duplicated, block: B:42:0x0082 A[Catch: j -> 0x003d, TRY_LEAVE, TryCatch #0 {j -> 0x003d, blocks: (B:14:0x002b, B:17:0x0033, B:20:0x003a, B:25:0x0042, B:27:0x0046, B:34:0x0059, B:37:0x0060, B:42:0x0082, B:32:0x0051), top: B:47:0x002b }] */
    @Override // androidx.media3.exoplayer.video.h0
    public final boolean u(androidx.media3.common.r rVar) throws g0 {
        boolean zM = true;
        _COROUTINE.a.A(!false);
        s sVar = this.f;
        _COROUTINE.a.A(sVar.n == 0);
        androidx.media3.common.h hVar = rVar.E;
        if (hVar == null || !hVar.d()) {
            hVar = androidx.media3.common.h.h;
        }
        ...
        if (i == 7) {
            try {
                ...
                if (i2 >= 34 || i2 < 33 || !androidx.media3.common.util.b.m("EGL_EXT_gl_colorspace_bt2020_pq")) {
                    if (i == 6) {
                        if (Build.VERSION.SDK_INT >= 33 || !androidx.media3.common.util.b.m("EGL_EXT_gl_colorspace_bt2020_pq")) {
                            zM = false;
                        }
                    } else if (i == 7) {
                        zM = androidx.media3.common.util.b.m("EGL_EXT_gl_colorspace_bt2020_hlg");
                    }
                    if (zM && Build.VERSION.SDK_INT >= 29) {
                        Locale locale = Locale.US;
                        androidx.media3.common.util.b.t("PlaybackVidGraphWrapper", "Color transfer " + i + " is not supported. Falling back to OpenGl tone mapping.");
        ...
        androidx.media3.common.util.d0 d0Var = sVar.f;
        Looper looperMyLooper = Looper.myLooper();
        looperMyLooper.getClass();
        sVar.k = d0Var.a(looperMyLooper, null);
        sVar.b.a();
        throw null;
    }
