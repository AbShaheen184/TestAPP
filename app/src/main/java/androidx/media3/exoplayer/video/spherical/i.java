...
public final class i implements u, a {
    ...
    public final void c(long j, long j2, r rVar, MediaFormat mediaFormat) {
        ...
        if (bArr3 != null) {
                    ...
                    while (true) {
                        if (i5 < i6) {
                            ...
                            if (iM2 > i5 && iM2 <= i6) {
                                ...
                                vVar.L(iM2);
                                arrayListS = okhttp3.internal.platform.android.g.s(vVar);
                            }
                        }
                        arrayListS = null;
                    }
            ...
            if (arrayListS != null) {
                ...
                if (size == 1) {
                    e eVar = (e) arrayListS.get(0);
                    fVar = new f(eVar, eVar, i4);
                } else if (size == 2) {
                    fVar = new f((e) arrayListS.get(0), (e) arrayListS.get(1), i4);
                }
            }
        }
    ...
    public final SurfaceTexture d() {
        try {
            ...
            androidx.media3.common.util.b.g("SceneRenderer", "Failed to initialize the renderer", e);
        }
