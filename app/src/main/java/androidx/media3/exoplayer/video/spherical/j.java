...
public final class j implements GLSurfaceView.Renderer, c {
    ...
    public final void onDrawFrame(GL10 gl10) {
        ...
        try {
            ...
            androidx.media3.common.util.b.g("SceneRenderer", "Failed to draw a frame", e);
        }
        if (iVar.e.compareAndSet(true, false)) {
            ...
            try {
                androidx.media3.common.util.b.b();
            } catch (androidx.media3.common.util.j e2) {
                androidx.media3.common.util.b.g("SceneRenderer", "Failed to draw a frame", e2);
            }
            ...
            if (fVar != null) {
                ...
                if (g.b(fVar)) {
                    ...
                    if (!fVar.d) {
                        ...
                        androidx.media3.common.util.b.d(fArr6);
                        androidx.media3.common.util.b.d((float[]) eVar2.e);
                    }
                }
            }
        }
        ...
        try {
            androidx.media3.common.util.b.b();
        } catch (androidx.media3.common.util.j e3) {
            androidx.media3.common.util.b.g("ProjectionRenderer", "Failed to bind uniforms", e3);
        }
        GLES20.glVertexAttribPointer(gVar2.f, 3, 5126, false, 12, (Buffer) eVar3.d);
        try {
            androidx.media3.common.util.b.b();
        } catch (androidx.media3.common.util.j e4) {
            androidx.media3.common.util.b.g("ProjectionRenderer", "Failed to load position data", e4);
        }
        GLES20.glVertexAttribPointer(gVar2.g, 2, 5126, false, 8, (Buffer) eVar3.e);
        try {
            androidx.media3.common.util.b.b();
        } catch (androidx.media3.common.util.j e5) {
            androidx.media3.common.util.b.g("ProjectionRenderer", "Failed to load texture data", e5);
        }
        GLES20.glDrawArrays(eVar3.c, 0, eVar3.b);
        try {
            androidx.media3.common.util.b.b();
        } catch (androidx.media3.common.util.j e6) {
            androidx.media3.common.util.b.g("ProjectionRenderer", "Failed to render", e6);
        }
    }
