...
public final class w {
    ...
    public float k = 1.0f;
    public androidx.media3.common.util.d0 l = androidx.media3.common.util.d0.a;
    ...
    public final int a(long j, long j2, long j3, long j4, boolean z, boolean z2, v vVar) {
        ...
        if (this.d) {
            this.l.getClass();
            jQ -= i0.Q(SystemClock.elapsedRealtime()) - j3;
        }
        vVar.a = jQ;
        if (!z || z2) {
            if (this.m || !this.o) {
                ...
                if (this.i == j5 || this.j) {
                    ...
                    if (i6 != 0) {
                        if (i6 == 1) {
                            ...
                            i = 3;
                            i2 = 5;
                            long jQ2 = i0.Q(SystemClock.elapsedRealtime()) - this.g;
                            if (this.d) {
                                long j28 = this.f;
    ...
    public final void d() {
        this.d = true;
        this.l.getClass();
        this.g = i0.Q(SystemClock.elapsedRealtime());
        b0 b0Var = this.b;
        b0Var.d = true;
        b0Var.b();
        ...
        if (displayManager != null) {
            try {
                ...
                androidx.media3.common.util.b.u("VideoFrameReleaseHelper", "Vsync sampling disabled due to platform error", e);
            }
        }
        b0Var.c = a0Var;
        if (a0Var != null) {
