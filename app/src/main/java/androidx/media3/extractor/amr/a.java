...
public final class a implements n {
    ...
    public final void b(long j, long j2) {
        ...
        x xVar = (x) a0Var;
        c cVar = xVar.b;
        long jD = cVar.b == 0 ? -9223372036854775807L : cVar.d(i0.c(xVar.a, j));
        this.i = jD;
  ...
  0x00f0: PHI (r4v1 androidx.media3.extractor.o) = (r4v0 androidx.media3.extractor.o), (r4v6 androidx.media3.extractor.o) binds: [B:53:0x00ee, B:56:0x00fc] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final int c(o oVar, r rVar) throws j0 {
        ...
        if (!this.p) {
            ...
            h0 h0Var = this.k;
            q qVar = new q();
            qVar.m = androidx.media3.common.i0.p(str2);
            qVar.n = androidx.media3.common.i0.p(str3);
            qVar.o = i3;
            qVar.F = 1;
            qVar.G = i2;
    ...
    public final int f(o oVar) throws j0 {
        boolean z;
        oVar.n();
        byte[] bArr = this.a;
        oVar.w(bArr, 0, 1);
        byte b = bArr[0];
        if ((b & 131) > 0) {
            throw j0.a(null, "Invalid padding bits for frame header " + ((int) b));
        }
        int i = (b >> 3) & 15;
