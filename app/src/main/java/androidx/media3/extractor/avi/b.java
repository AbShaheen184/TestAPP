...
public final class b implements n {
    ...
    public b(androidx.work.impl.model.f fVar) {
        this.d = fVar;
    }
    ...
    public final boolean a(o oVar) {
        ...
        oVar.w(vVar.a, 0, 12);
        vVar.M(0);
        if (vVar.o() != 1179011410) {
            return false;
        }
        vVar.N(4);
        return vVar.o() == 541677121;
    }
    ...
    public final void b(long j, long j2) {
        ...
        for (e eVar : this.i) {
            if (eVar.k == 0) {
                ...
                eVar.i = eVar.n[i0.f(eVar.m, j, true)];
            }
        }
        if (j != 0) {
            this.e = 6;
    ...
    public final int c(o oVar, r rVar) throws j0 {
        ...
        switch (i2) {
            case 0:
                if (!a(oVar)) {
                    throw j0.a(null, "AVI Header List not found");
                }
                oVar.o(12);
                this.e = 1;
                return 0;
            case 1:
                oVar.readFully(vVar.a, 0, 12);
                vVar.M(0);
                jVar.getClass();
                jVar.a = vVar.o();
                jVar.b = vVar.o();
                ...
                if (jVar.a != 1414744396) {
                    throw j0.a(null, "LIST expected, found: " + jVar.a);
                }
                int iO = vVar.o();
                jVar.c = iO;
                if (iO == 1819436136) {
                ...
                throw j0.a(null, "hdrl expected, found: " + jVar.c);
            case 2:
                int i4 = this.l - 4;
                v vVar2 = new v(i4);
                oVar.readFully(vVar2.a, 0, i4);
                f fVarC = f.c(1819436136, vVar2);
                int i5 = fVarC.b;
                if (i5 != 1819436136) {
                    throw j0.a(null, "Unexpected header list type " + i5);
                }
                c cVar = (c) fVarC.b(c.class);
                if (cVar == null) {
                    throw j0.a(null, "AviHeader not found");
                }
                this.g = cVar;
                ...
                while (e0VarListIterator.hasNext()) {
                    ...
                    if (aVar.a() == 1819440243) {
                        ...
                        if (dVar == null) {
                            androidx.media3.common.util.b.t("AviExtractor", "Missing Stream Header");
                        } else if (gVar == null) {
                            androidx.media3.common.util.b.t("AviExtractor", "Missing Stream Format");
                        } else {
                            long j2 = dVar.d;
                            long j3 = 1000000 * ((long) dVar.b);
                            long j4 = dVar.c;
                            String str = i0.a;
                            long jY = i0.Y(j2, j3, j4, RoundingMode.DOWN);
                            ...
                            int i9 = androidx.media3.common.i0.i(rVar2.o);
                            if (i9 == 1 || i9 == 2) {
            ...
            case 5:
                ...
                oVar.readFully(vVar3.a, 0, this.o);
                long j6 = 0;
                if (vVar3.a() >= 16) {
                    int i11 = vVar3.b;
                    vVar3.N(8);
