...
public final class d {
    ...
    public static d a(androidx.media3.common.util.v vVar) throws j0 {
        String str;
        int i;
        int i2;
        int i3;
        ...
        try {
            ...
            for (int i9 = 0; i9 < iZ2; i9++) {
                ...
                System.arraycopy(androidx.media3.common.util.e.a, 0, bArr2, 0, 4);
            ...
            for (int i11 = 0; i11 < iZ3; i11++) {
                ...
                System.arraycopy(androidx.media3.common.util.e.a, 0, bArr4, 0, 4);
            ...
            if (iZ2 > 0) {
                ...
                int i22 = qVarM.b;
                int i23 = qVarM.c;
                byte[] bArr5 = androidx.media3.common.util.e.a;
