        ...
        if (list != null) {
            ...
            try {
                ...
                if (i2 > 0) {
                    ...
                    try {
                        androidx.media3.common.util.b.t("IcyHeaders", "Invalid bitrate: " + str4);
                        z = false;
                        i2 = -1;
                    } catch (NumberFormatException unused) {
                        j.y("Invalid bitrate header: ", str4, "IcyHeaders");
                        z = false;
                    }
                }
        ...
        if (list6 != null) {
            ...
            try {
                ...
                if (i4 > 0) {
                    ...
                    try {
                        androidx.media3.common.util.b.t("IcyHeaders", "Invalid metadata interval: " + str5);
                        z2 = z;
                    } catch (NumberFormatException unused3) {
                        i3 = i4;
                        j.y("Invalid metadata interval: ", str5, "IcyHeaders");
                    }
                }
                z = z2;
