...
public final class c implements h {
    ...
    public c(long j, long[] jArr, long[] jArr2) {
        this.a = jArr;
        this.b = jArr2;
        this.c = j == -9223372036854775807L ? i0.Q(jArr2[jArr2.length - 1]) : j;
    }
    ...
    public final long a(long j) {
        return i0.Q(((Long) h(j, this.a, this.b).second).longValue());
    }
    ...
    public final z e(long j) {
        Pair pairH = h(i0.d0(i0.k(j, 0L, this.c)), this.b, this.a);
        b0 b0Var = new b0(i0.Q(((Long) pairH.first).longValue()), ((Long) pairH.second).longValue());
