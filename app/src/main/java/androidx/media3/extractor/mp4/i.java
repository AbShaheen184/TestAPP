...
public final class i implements androidx.media3.extractor.n {
    ...
    public int y;
    public long z;
    public final androidx.localbroadcastmanager.content.b k = new androidx.localbroadcastmanager.content.b(18);
    public final v l = new v(16);
    public final v e = new v(androidx.media3.container.r.a);
    ...
    public i(androidx.media3.extractor.text.j jVar, int i, g0 g0Var, List list, androidx.media3.exoplayer.dash.p pVar) {
        this.a = jVar;
        this.b = i;
        this.j = g0Var;
    ...
    public static androidx.media3.common.m h(List list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (eVar.y == 1886614376) {
                ...
                UUID uuid = tVarH == null ? null : (UUID) tVarH.e;
                if (uuid == null) {
                    androidx.media3.common.util.b.t("FragmentedMp4Extractor", "Skipped pssh atom (failed to extract uuid)");
                } else {
    ...
    public static void i(v vVar, int i, t tVar) throws j0 {
        vVar.M(i + 8);
        int iM = vVar.m();
        byte[] bArr = e.a;
        if ((iM & 1) != 0) {
        ...
        tVar.k = true;
        tVar.o = true;
        vVar.k(vVar2.a, 0, vVar2.c);
        vVar2.M(0);
        tVar.o = false;
    }

    public static Pair j(long j, v vVar) throws j0 {
        long jF;
        long jF2;
        v vVar2 = vVar;
        vVar2.M(8);
        ...
        long jY = androidx.media3.common.util.i0.Y(jF, 1000000L, jB, RoundingMode.DOWN);
        vVar2.N(2);
        int iG = vVar2.G();
        int[] iArr = new int[iG];
        ...
        while (i < iG) {
            ...
            long[] jArr4 = jArr2;
            long[] jArr5 = jArr3;
            long jY2 = androidx.media3.common.util.i0.Y(jF, 1000000L, jB, RoundingMode.DOWN);
            jArr4[i] = jY2 - jArr5[i];
            vVar2.N(4);
            j3 += (long) iArr[i];
            i++;
    ...
    public final int c(androidx.media3.extractor.o oVar, androidx.media3.extractor.r rVar) throws j0 {
            ...
            if (i8 != 0) {
                ...
                if (i8 != 1) {
                    ...
                    if (i8 != 2) {
                        ...
                        if (hVar3 != null) {
                            ...
                            if (position < 0) {
                                androidx.media3.common.util.b.t("FragmentedMp4Extractor", "Ignoring negative offset to sample data.");
                                position = 0;
                            }
                            oVar.o(position);
                            this.C = hVar3;
                        ...
                        if (hVar5 == null) {
                            ...
                            t tVar3 = hVar5.b;
                            v vVar2 = tVar3.n;
                            oVar.readFully(vVar2.a, 0, vVar2.c);
                            vVar2.M(0);
                            tVar3.o = false;
                        }
                    }
                    ...
                    v vVar3 = this.w;
                    if (vVar3 != null) {
                        oVar.readFully(vVar3.a, 8, i11);
                        int i12 = this.t;
                        androidx.media3.container.e eVar = new androidx.media3.container.e(i12, vVar3);
                        if (!arrayDeque2.isEmpty()) {
                            ((androidx.media3.container.d) arrayDeque2.peek()).A.add(eVar);
                        } else if (i12 == 1936286840) {
                            Pair pairJ = j(oVar.getPosition(), vVar3);
                            bVar.c((androidx.media3.extractor.j) pairJ.second);
                            ...
                            if (this.M) {
                                ...
                                i7 = 1;
                                this.I.h(linkedHashMap.size() == 1 ? (a0) pairJ.second : bVar.g());
                                this.L = true;
                            }
                            ...
                            if (iE == 0) {
                                ...
                                long jY2 = androidx.media3.common.util.i0.Y(jB3, 1000000L, jB2, roundingMode);
                                long j6 = this.B;
                                long j7 = j6 != -9223372036854775807L ? j6 + jY2 : -9223372036854775807L;
                                j = jY2;
                                jA = j7;
                                jY = androidx.media3.common.util.i0.Y(vVar3.B(), 1000L, jB2, roundingMode);
                                jB = vVar3.B();
                            } else if (iE != 1) {
                                androidx.compose.runtime.j.x("Skipping unsupported emsg version: ", iE, "FragmentedMp4Extractor");
                            } else {
                                long jB4 = vVar3.B();
                                long jF = vVar3.F();
                                RoundingMode roundingMode2 = RoundingMode.DOWN;
                                jA = androidx.media3.common.util.i0.Y(jF, 1000000L, jB4, roundingMode2);
                                long jY3 = androidx.media3.common.util.i0.Y(vVar3.B(), 1000L, jB4, roundingMode2);
                                long jB5 = vVar3.B();
                                strU = vVar3.u();
                                strU.getClass();
                                strU2 = vVar3.u();
                            ...
                            vVar3.k(bArr, 0, vVar3.a());
                            v vVar4 = new v(this.k.s(new androidx.media3.extractor.metadata.emsg.a(str, str2, jY, jB, bArr)));
                            int iA2 = vVar4.a();
                            h0[] h0VarArr = this.J;
                            ...
                            if (jA == j5) {
                                ...
                                this.y += iA2;
                            } else if (g0Var == null || g0Var.e()) {
                                if (g0Var != null) {
                                    jA = g0Var.a(jA);
                                }
                                long j8 = jA;
                                for (h0 h0Var2 : this.J) {
                                    h0Var2.g(j8, 1, iA2, 0, null);
                                }
                            } else {
                                arrayDeque.addLast(new g(jA, iA2, false));
                                this.y += iA2;
                ...
                if (this.N != -1) {
                    ...
                    if (i16 == 1936286840) {
                        ...
                        oVar.readFully(vVar.a, 8, (int) (this.u - ((long) this.v)));
                        bVar.c((androidx.media3.extractor.j) j(oVar.f(), vVar).second);
                    } else {
                    ...
                    if ((i17 == 1836019558 || i17 == 1835295092) && !this.L) {
                        this.I.h(new androidx.media3.extractor.s(this.A, position4));
                        this.L = true;
                    }
        ...
        if (this.s == 3) {
            ...
            if (zEquals) {
                this.E = hVar.d(i22, 7);
                androidx.media3.extractor.b.f(this.D, vVar);
                h0Var3.f(7, vVar);
                this.E += 7;
                i5 = 0;
            } else {
        ...
        if (i23 == 0) {
            ...
            while (true) {
                ...
                this.E += h0Var3.a(oVar, i25 - i24, false);
            }
        } else {
            v vVar8 = this.f;
            byte[] bArr2 = vVar8.a;
                ...
                if (this.E < this.D) {
                    ...
                    if (i27 == 0) {
                        ...
                        if (this.H) {
                            v vVar10 = this.g;
                            vVar10.J(i27);
                            oVar.readFully(vVar10.a, 0, this.F);
                            h0Var3.f(this.F, vVar10);
                            int i28 = this.F;
                            int iP = androidx.media3.container.r.p(vVar10.a, vVar10.c);
                            vVar10.M(0);
                            vVar10.L(iP);
                            int i29 = rVar4.q;
                            if (i29 == -1) {
        ...
        s sVarB2 = hVar2.b();
        long j16 = jA2;
        h0Var3.g(j16, i30, this.D, 0, sVarB2 != null ? sVarB2.c : null);
        while (!arrayDeque.isEmpty()) {
            ...
            long j17 = jA3;
            for (h0 h0Var4 : this.J) {
                h0Var4.g(j17, 1, gVar.c, this.y, null);
            }
        }
        if (!hVar2.c()) {
            this.C = null;
    ...
    public final void d(androidx.media3.extractor.p pVar) {
        ...
        h0[] h0VarArr2 = (h0[]) androidx.media3.common.util.i0.S(i, this.J);
        this.J = h0VarArr2;
            ...
            if (i8 == 1836019574) {
                ...
                while (i11 < size) {
                    ...
                    if (i12 == 1953654136) {
                        ...
                        Pair pairCreate = Pair.create(Integer.valueOf(vVar.m()), new f(vVar.m() - 1, vVar.m(), vVar.m(), vVar.m()));
                        sparseArray2.put(((Integer) pairCreate.first).intValue(), (f) pairCreate.second);
                    } else {
                        arrayList = arrayList6;
                        if (i12 == 1835362404) {
                            vVar.M(8);
                            jB = e.e(vVar.m()) == 0 ? vVar.B() : vVar.F();
                        }
                    }
                    i11++;
                ...
                ArrayList arrayListJ = e.j(dVar, vVar2, jB, mVarH, (i9 & 16) != 0, false, new androidx.media3.common.p(this), false);
                ...
                if (sparseArray.size() == 0) {
                    ...
                    _COROUTINE.a.A(sparseArray.size() == size2);
                    int i19 = 0;
                    while (i19 < size2) {
                ...
                while (i21 < size3) {
                    ...
                    if (dVar2.y == 1953653094) {
                        ...
                        int iM = vVar3.m();
                        byte[] bArr2 = e.a;
                        h hVar2 = (h) sparseArray.get(vVar3.m());
                        if (hVar2 == null) {
                            size3 = size3;
                            hVar2 = null;
                        } else {
                            ...
                            f fVar3 = hVar2.e;
                            tVar.a = new f((iM & 2) != 0 ? vVar3.m() - 1 : fVar3.a, (iM & 8) != 0 ? vVar3.m() : fVar3.b, (iM & 16) != 0 ? vVar3.m() : fVar3.c, (iM & 32) != 0 ? vVar3.m() : fVar3.d);
                        }
                        if (hVar2 != null) {
                            t tVar2 = hVar2.b;
                            long j4 = tVar2.p;
                            ...
                            if (eVarP4 == null || (i9 & 2) != 0) {
                                ...
                                v vVar4 = eVarP4.z;
                                vVar4.M(8);
                                tVar2.p = e.e(vVar4.m()) == 1 ? vVar4.F() : vVar4.B();
                                tVar2.q = true;
                            }
                            ...
                            while (true) {
                                ...
                                if (i27 >= size4) {
                                    ...
                                    if (eVarP6 != null) {
                                        ...
                                        tVar2.c += e.e(iM3) == 0 ? vVar7.B() : vVar7.F();
                                    }
                                ...
                                if (eVar5.y == i5) {
                                    ...
                                    tVar2.g[i28] = vVar12.D();
                                    long[] jArr = tVar2.f;
                                    i7 = i9;
                                    long j6 = tVar2.b;
                                    jArr[i28] = j6;
                                    if ((iM4 & 1) != 0) {
                                        jArr[i28] = j6 + ((long) vVar12.m());
                                    }
                                    boolean z6 = (iM4 & 4) != 0;
                                    int iM5 = fVar5.d;
                                    if (z6) {
                                    ...
                                    if (jArr2 == null || jArr2.length != 1 || jArr3 == null) {
                                        ...
                                        if (j7 == 0) {
                                            ...
                                            long j8 = rVar5.d;
                                            RoundingMode roundingMode = RoundingMode.DOWN;
                                            if (androidx.media3.common.util.i0.Y(j7, 1000000L, j8, roundingMode) + androidx.media3.common.util.i0.Y(jArr3[0], 1000000L, rVar5.c, roundingMode) >= rVar5.e) {
                                            }
                                        }
                                        j5 = jArr3[0];
                                    }
                                    ...
                                    int i41 = i40;
                                    while (i41 < i39) {
                                        int iM6 = z13 ? vVar12.m() : fVar5.b;
                                        boolean z16 = z15;
                                        if (iM6 < 0) {
                                            throw j0.a(null, "Unexpected negative value: " + iM6);
                                        }
                                        int iM7 = z9 ? vVar12.m() : fVar5.c;
                                        if (iM7 < 0) {
                                            throw j0.a(null, "Unexpected negative value: " + iM7);
                                        }
                                        int iM8 = z12 ? vVar12.m() : (i41 == 0 && z8) ? i38 : fVar5.d;
                                        int i42 = i39;
                                        long[] jArr5 = jArr4;
                                        long jY = androidx.media3.common.util.i0.Y((((long) (z16 ? vVar12.m() : 0)) + j10) - j5, 1000000L, j9, RoundingMode.DOWN);
                                        jArr5[i41] = jY;
                                        if (!tVar2.q) {
