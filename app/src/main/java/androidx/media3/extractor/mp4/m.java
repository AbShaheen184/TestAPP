...
public final class m implements androidx.media3.extractor.n {
    ...
    public m(androidx.media3.extractor.text.j jVar, int i) {
        ...
        this.d = new v(androidx.media3.container.r.a);
        this.e = new v(6);
        this.f = new v();
        this.q = -1;
        ...
        if (!this.c || !this.y) {
            while (true) {
                ...
                if (i9 != 0) {
                    ...
                    if (i9 != 1) {
                        if (i9 == 2) {
                            ...
                            if (i20 != 0) {
                                ...
                                if ("audio/ac4".equals(str2)) {
                                    if (this.s == 0) {
                                        androidx.media3.extractor.b.f(i21, vVar);
                                        h0Var.f(7, vVar);
                                        this.s += 7;
                                    }
                                    i21 += 7;
                                    ...
                                    if (yVar.a(vVar.m()) && !Objects.equals(rVar4.o, (String) yVar.g)) {
                        ...
                        if (i29 != 0) {
                            if (i29 != 1) {
                                ...
                                if (i29 == 2) {
                                    ...
                                    while (i32 < i31 / 12) {
                                        ...
                                        if (s2 != 2192 && s2 != s) {
                                            ...
                                            arrayList2.add(new o((length2 - ((long) pVar.c)) - ((long) vVar5.o()), vVar5.o()));
                                            i32++;
                                            i11 = i35;
                                            s = 2816;
                                            i30 = 8;
                                    ...
                                    oVar.readFully(vVar6.a, 0, length3);
                                    int i37 = 0;
                                    while (i37 < arrayList2.size()) {
                                        o oVar2 = (o) arrayList2.get(i37);
                                        vVar6.M((int) (oVar2.a - position2));
                                        vVar6.N(i10);
                                        int iO = vVar6.o();
                                        Charset charset = StandardCharsets.UTF_8;
                                        String strX = vVar6.x(iO, charset);
                                        switch (strX.hashCode()) {
                                            case -1711564334:
                                                ...
                                                if (c2 != 2192) {
                                                    ...
                                                    listD = p.e.d(vVar6.x(i6, charset));
                                ...
                                v vVar7 = new v(8);
                                oVar.readFully(vVar7.a, 0, 8);
                                pVar.c = vVar7.o() + 8;
                                if (vVar7.m() != 1397048916) {
                                    rVar.a = 0L;
                                } else {
                    ...
                    v vVar8 = this.p;
                    if (vVar8 != null) {
                        oVar.readFully(vVar8.a, this.o, (int) j16);
                        if (this.m == 1718909296) {
                            ...
                            ((androidx.media3.container.d) arrayDeque.peek()).A.add(new androidx.media3.container.e(this.m, vVar8));
                        }
                    } else {
                    ...
                    if (i39 != 0) {
                        ...
                        if (i8 != 1836019574 || i8 == 1953653099 || i8 == 1835297121 || i8 == 1835626086 || i8 == 1937007212 || i8 == 1701082227 || i8 == 1835365473 || i8 == 1635284069) {
                            ...
                            _COROUTINE.a.A(i40 == 8);
                            _COROUTINE.a.A(this.n <= 2147483647L);
                            v vVar10 = new v((int) this.n);
                            System.arraycopy(vVar9.a, 0, vVar10.a, 0, 8);
                            this.p = vVar10;
                            z3 = true;
                            this.l = 1;
                        } else {
                        ...
                        z4 = z3;
                    } else if (oVar.b(vVar9.a, 0, 8, true)) {
                        this.o = 8;
                        vVar9.M(0);
                        this.n = vVar9.B();
                        this.m = vVar9.m();
    ...
    public final void f(long j) {
        ...
        while (true) {
            ...
            if (dVar.y == 1836019574) {
                ...
                androidx.media3.extractor.v vVar = new androidx.media3.extractor.v();
                ...
                if (this.x) {
                    ...
                    _COROUTINE.a.z("The number of auxiliary track types from metadata (" + arrayList6.size() + ") is not same as the number of auxiliary tracks (" + arrayListJ.size() + ")", z2);
                }
                    ...
                    if (i13 == 0) {
                        ...
                        if (androidx.media3.common.i0.o(str3)) {
                            ...
                            if (jArr2.length > 0) {
                                ...
                                _COROUTINE.a.A(j4 != -9223372036854775807L);
