...
public abstract class q {
    ...
    public static androidx.media3.extractor.metadata.id3.a d(v vVar) {
        String str;
        int iM = vVar.m();
        if (vVar.m() != 1684108385) {
            androidx.media3.common.util.b.t("MetadataUtil", "Failed to parse cover art attribute");
            return null;
        }
        int iM2 = vVar.m();
        byte[] bArr = e.a;
        ...
        if (str == null) {
            androidx.compose.runtime.j.x("Unrecognized cover art flags: ", i, "MetadataUtil");
            return null;
        }
        vVar.N(4);
        int i2 = iM - 16;
    ...
    public static androidx.media3.extractor.metadata.id3.n e(int i, v vVar, String str) {
        int iM = vVar.m();
        if (vVar.m() == 1684108385 && iM >= 22) {
            vVar.N(10);
            int iG = vVar.G();
            if (iG > 0) {
                String strN = androidx.privacysandbox.ads.adservices.java.internal.a.n(iG, "");
                int iG2 = vVar.G();
                if (iG2 > 0) {
                    strN = strN + "/" + iG2;
                }
                return new androidx.media3.extractor.metadata.id3.n(str, null, h0.s(strN));
            }
        }
        androidx.media3.common.util.b.t("MetadataUtil", "Failed to parse index/count attribute: ".concat(androidx.media3.container.f.d(i)));
        return null;
    }
    ...
    public static int f(v vVar) {
        ...
        androidx.media3.common.util.b.t("MetadataUtil", "Failed to parse data atom to int");
        return -1;
    }

    public static androidx.media3.extractor.metadata.id3.i g(int i, String str, v vVar, boolean z, boolean z2) {
        int iF = f(vVar);
        if (z2) {
            iF = Math.min(1, iF);
        }
        ...
        androidx.media3.common.util.b.t("MetadataUtil", "Failed to parse uint8 attribute: ".concat(androidx.media3.container.f.d(i)));
        return null;
    }
    ...
    public static androidx.media3.exoplayer.dash.manifest.t h(byte[] bArr) {
        ...
        int iM = vVar.m();
        if (iM != iA) {
            androidx.media3.common.util.b.t("PsshAtomUtil", "Advertised atom size (" + iM + ") does not match buffer size: " + iA);
            return null;
        }
        int iM2 = vVar.m();
        if (iM2 != 1886614376) {
            androidx.compose.runtime.j.x("Atom type is not pssh: ", iM2, "PsshAtomUtil");
            return null;
        }
        int iE = e.e(vVar.m());
        if (iE > 1) {
            androidx.compose.runtime.j.x("Unsupported pssh version: ", iE, "PsshAtomUtil");
            return null;
        }
        UUID uuid = new UUID(vVar.t(), vVar.t());
        if (iE == 1) {
            int iD = vVar.D();
            UUID[] uuidArr = new UUID[iD];
            for (int i = 0; i < iD; i++) {
                uuidArr[i] = new UUID(vVar.t(), vVar.t());
            }
        }
        int iD2 = vVar.D();
        int iA2 = vVar.a();
        if (iD2 == iA2) {
            vVar.k(new byte[iD2], 0, iD2);
            androidx.media3.exoplayer.dash.manifest.t tVar = new androidx.media3.exoplayer.dash.manifest.t();
            tVar.e = uuid;
            return tVar;
        }
        androidx.media3.common.util.b.t("PsshAtomUtil", "Atom data size (" + iD2 + ") does not match the bytes left: " + iA2);
        return null;
    }

    public static androidx.media3.extractor.metadata.id3.n i(int i, v vVar, String str) {
        int iM = vVar.m();
        if (vVar.m() == 1684108385) {
            vVar.N(8);
            return new androidx.media3.extractor.metadata.id3.n(str, null, h0.s(vVar.v(iM - 16)));
        }
        androidx.media3.common.util.b.t("MetadataUtil", "Failed to parse text attribute: ".concat(androidx.media3.container.f.d(i)));
        return null;
    }
