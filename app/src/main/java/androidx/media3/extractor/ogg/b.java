                    ...
                    if (fVar.b(oVar, this.G)) {
                        ...
                        if (0 > j7 || j7 >= 72000) {
                            ...
                            if (j8 - j9 < 100000) {
                                ...
                                long j10 = this.G;
                                long j11 = this.F;
                                jK = i0.k((((j10 - j11) * j7) / (this.I - this.H)) + position3, j11, j10 - 1);
                            }
                        } else {
                            jK = -1;
                        }
                        ...
                        jK = this.F;
                        if (jK == position2) {
                            kotlinx.coroutines.future.a.w("No ogg page can be found.");
                            return 0L;
                        }
                    }
                    if (jK != -1) {
