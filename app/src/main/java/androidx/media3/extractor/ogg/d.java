...
public final class d implements n {
    ...
    public final int c(o oVar, r rVar) throws j0 {
        ...
        if (i != 0) {
            ...
            iVar2.k = 0L;
            v vVar = eVar.b;
            long jB2 = iVar2.b(vVar);
            if (jB2 >= 0) {
                long j = iVar2.g;
                if (j + jB2 >= iVar2.e) {
                    long j2 = (j * 1000000) / ((long) iVar2.i);
                    iVar2.b.f(vVar.c, vVar);
                    iVar2.b.g(j2, 1, vVar.c, 0, null);
                    iVar2.e = -1L;
                }
            }
            iVar2.g += jB2;
        ...
        while (true) {
            ...
            if (!iVar2.c(vVar2, j3, iVar2.j)) {
                ...
                if (r0Var == null) {
                    ...
                    vVar2.K(Arrays.copyOf(bArr, Math.max(65025, vVar2.c)), vVar2.c);
                    return 0;
                }
                iVar2.d = r0Var;
                iVar2.h = 2;
    ...
    public final boolean f(o oVar) {
        ...
        if (fVar.a(oVar, true) && (fVar.a & 2) == 2) {
            ...
            vVar.M(0);
            try {
                zW = androidx.media3.extractor.b.w(1, vVar, true);
            } catch (j0 unused) {
                zW = false;
            }
            if (zW) {
