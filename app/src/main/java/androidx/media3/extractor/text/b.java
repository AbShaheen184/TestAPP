...
public final class b implements d {
        ...
        while (i2 < a1VarW.A) {
            ...
            if (i3 != 0) {
                ...
                if (j8 < j5) {
                    ...
                    androidx.media3.common.util.b.t("CuesWithTimingSubtitle", "Truncating unsupported overlapping cues.");
                    this.y[i4] = j5;
                    arrayList.set(i4, h0Var2);
                }
            } else {
    ...
    public final long g(int i) {
        _COROUTINE.a.o(i < this.e.size());
        return this.y[i];
    }

    @Override // androidx.media3.extractor.text.d
    public final List k(long j) {
        int iF = i0.f(this.y, j, false);
        if (iF != -1) {
