...
public final class f extends h {
    ...
    public final androidx.media3.exoplayer.hls.c f() {
        ...
        this.o = list;
        list.getClass();
        return new androidx.media3.exoplayer.hls.c(list, 7);
    }
            ...
            if (i == 2 || i == 3) {
                if (z) {
                    if (i == 3) {
                        ...
                        if (i3 != -1 && i2 != (i3 + 1) % 4) {
                            l();
                            androidx.media3.common.util.b.t("Cea708Decoder", "Sequence number discontinuity. previous=" + this.j + " current=" + i2);
                        }
                        this.j = i2;
                        int i4 = bZ & 63;
                        if (i4 == 0) {
                        ...
                        u uVar2 = this.p;
                        if (uVar2 == null) {
                            androidx.media3.common.util.b.f("Cea708Decoder", "Encountered DTVCC_PACKET_DATA before DTVCC_PACKET_START");
                        } else {
                            byte[] bArr2 = uVar2.b;
                            int i5 = uVar2.e;
                            int i6 = i5 + 1;
    ...
    public final void j() {
        ...
        int i = 2;
        if (uVar.e != (uVar.d * 2) - 1) {
            androidx.media3.common.util.b.e("Cea708Decoder", "DtvCcPacket ended prematurely; size is " + ((this.p.d * 2) - 1) + ", but current index is " + this.p.e + " (sequence number " + this.p.c + ");");
        }
        u uVar2 = this.p;
        byte[] bArr = uVar2.b;
        int i2 = uVar2.e;
        ...
        while (uVar3.b() > 0) {
            ...
            if (iG == 7) {
                ...
                iG = uVar3.g(6);
                if (iG < 7) {
                    j.x("Invalid extended service number: ", iG, "Cea708Decoder");
                }
            }
            if (iG2 == 0) {
                if (iG != 0) {
                    androidx.media3.common.util.b.t("Cea708Decoder", "serviceNumber is non-zero (" + iG + ") when blockSize is 0");
                }
                if (z2) {
                    this.n = k();
                }
                            ...
                            if (iG3 != 0) {
                                if (iG3 == i3) {
                                    ...
                                    switch (iG3) {
                                        ...
                                        default:
                                            if (iG3 >= 17 && iG3 <= 23) {
                                                androidx.media3.common.util.b.t("Cea708Decoder", "Currently unsupported COMMAND_EXT1 Command: " + iG3);
                                                uVar3.o(8);
                                            } else if (iG3 < 24 || iG3 > 31) {
                                                j.x("Invalid C0 command: ", iG3, "Cea708Decoder");
                                            } else {
                                                androidx.media3.common.util.b.t("Cea708Decoder", "Currently unsupported COMMAND_P16 Command: " + iG3);
                                                uVar3.o(16);
                                            }
                                            break;
                                    }
                            ...
                            if (iG3 <= 159) {
                                ...
                                switch (iG3) {
                                    ...
                                    case Token.TARGET /* 145 */:
                                        if (this.m.c) {
                                            int iC = e.c(uVar3.g(2), uVar3.g(2), uVar3.g(2), uVar3.g(2));
                                            int iC2 = e.c(uVar3.g(2), uVar3.g(2), uVar3.g(2), uVar3.g(2));
                                            uVar3.o(2);
                                            e.c(uVar3.g(2), uVar3.g(2), uVar3.g(2), 0);
                                            this.m.f(iC, iC2);
                                        } else {
                                            uVar3.o(24);
                                        }
                                    ...
                                    case 150:
                                    default:
                                        j.x("Invalid C1 command: ", iG3, "Cea708Decoder");
                                        z = true;
                                        break;
                                    case Token.TYPEOFNAME /* 151 */:
                                        if (this.m.c) {
                                            int iC3 = e.c(uVar3.g(2), uVar3.g(2), uVar3.g(2), uVar3.g(2));
                                            uVar3.g(2);
                                            e.c(uVar3.g(2), uVar3.g(2), uVar3.g(2), 0);
                                            uVar3.f();
                                            uVar3.f();
                                ...
                                if (iG3 <= 255) {
                                    ...
                                    j.x("Invalid base command: ", iG3, "Cea708Decoder");
                                }
                                i = 2;
                                c = 7;
                            }
                            ...
                            if (iG13 <= 127) {
                                        ...
                                        default:
                                            switch (iG13) {
                                                ...
                                                case 127:
                                                    ...
                                                    break;
                                                default:
                                                    j.x("Invalid G2 character: ", iG13, "Cea708Decoder");
                                                    break;
                                            }
                                            break;
                                    }
                                ...
                                if (iG13 <= 255) {
                                    if (iG13 == 160) {
                                        ...
                                        j.x("Invalid G3 character: ", iG13, "Cea708Decoder");
                                        this.m.a('_');
                                    }
                                    z2 = true;
                                } else {
                                    j.x("Invalid extended command: ", iG13, "Cea708Decoder");
                                }
                            } else if (iG13 <= 135) {
                                uVar3.o(32);
                            } else if (iG13 <= 143) {
