...
public final class h implements l {
    ...
    public static byte[] a(int i, int i2, u uVar) {
        byte[] bArr = new byte[i];
        for (int i3 = 0; i3 < i; i3++) {
            bArr[i3] = (byte) uVar.g(i2);
        }
        return bArr;
    }
    ...
    public static a f(u uVar, int i) {
        int[] iArr;
        int iG;
        int i2;
        int iG2;
        ...
        while (i5 > 0) {
            ...
            double d2 = iG4 - 128;
            double d3 = iG - 128;
            iArr[iG6] = d((byte) (255 - (iG2 & 255)), i0.j((int) ((1.402d * d2) + d), 0, 255), i0.j((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, 255), i0.j((int) ((d3 * 1.772d) + d), 0, 255));
            i5 = i2;
            i6 = 0;
            iG5 = iG5;
            iArrC = iArrC;
    ...
    public final void j(byte[] bArr, int i, int i2, k kVar, androidx.media3.common.util.h hVar) {
        ...
        while (true) {
            ...
            gVar = this.C;
            z = true;
            if (iB >= 48 && uVar.g(8) == 15) {
                int iG4 = uVar.g(8);
                int iG5 = uVar.g(16);
                int iG6 = uVar.g(16);
                int iD = uVar.d() + iG6;
                if (iG6 * 8 > uVar.b()) {
                    androidx.media3.common.util.b.t("DvbParser", "Data field length exceeds limit");
                    uVar.o(uVar.b());
                } else {
                    switch (iG4) {
                        case 16:
                            if (iG5 == gVar.a) {
                                ...
                                while (i8 > 0) {
                                    ...
                                    uVar.o(8);
                                    i8 -= 6;
                                    sparseArray.put(iG9, new d(uVar.g(16), uVar.g(16)));
                                }
