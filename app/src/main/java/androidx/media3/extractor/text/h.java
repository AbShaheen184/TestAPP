...
public final class h implements n {
    ...
    public final void b(long j, long j2) {
        int i = this.h;
        _COROUTINE.a.A((i == 0 || i == 5) ? false : true);
        this.j = j2;
        if (this.h == 2) {
            this.h = 1;
        }
  ...
  0x007e: PHI (r22v4 int) = (r22v5 int), (r22v6 int) binds: [B:32:0x007c, B:29:0x0077] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    ...
    public final int c(o oVar, androidx.media3.extractor.r rVar) throws j0 {
        ...
        int i2;
        int i3 = this.h;
        _COROUTINE.a.A((i3 == 0 || i3 == 5) ? false : true);
        int i4 = this.h;
        int iF = LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY;
        if (i4 == 1) {
            int iF2 = oVar.getLength() != -1 ? com.imsdk.a.f(oVar.getLength()) : 1024;
            if (iF2 > this.e.length) {
                this.e = new byte[iF2];
            }
            this.g = 0;
            this.h = 2;
            ...
            if (length != -1) {
                ...
                if (this.g == length) {
                    try {
                        ...
                        this.a.j(this.e, 0, this.g, kVar, new y(this, 21));
                        ...
                        throw j0.a(e, "SubtitleParser failed.");
                    }
                }
            } else {
                i = 0;
        ...
        if (this.h == 3) {
            if (oVar.getLength() != -1) {
                iF = com.imsdk.a.f(oVar.getLength());
            }
            if (oVar.i(iF) == -1) {
                long j2 = this.j;
                for (int iF3 = j2 == -9223372036854775807L ? i : i0.f(this.i, j2, true); iF3 < arrayList.size(); iF3++) {
                    f((g) arrayList.get(iF3));
                }
                this.h = 4;
            }
        }
