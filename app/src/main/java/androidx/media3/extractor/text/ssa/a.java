...
public final class a implements l {
    ...
    public a(List list) {
        ...
        this.e = true;
        String strR = i0.r((byte[]) list.get(0));
        _COROUTINE.a.o(strR.startsWith("Format:"));
    ...
    public final void b(v vVar, Charset charset) {
        ...
        while (true) {
            ...
            if ("[Script Info]".equalsIgnoreCase(strN)) {
                while (true) {
                    String strN2 = vVar.n(charset);
                    if (strN2 == null) {
                        break;
                    }
                    if (vVar.a() != 0) {
                        int iH = vVar.h(charset);
                        if ((iH != 0 ? com.imsdk.a.f(iH >>> 8) : 1114112) == 91) {
                            break;
                        }
                    }
                    String[] strArrSplit = strN2.split(":");
                    if (strArrSplit.length == 2) {
                        String strB = com.imsdk.a.B(strArrSplit[0].trim());
                        strB.getClass();
                ...
                b bVar = null;
                while (true) {
                    String strN3 = vVar.n(charset);
                    if (strN3 != null) {
                        if (vVar.a() != 0) {
                            int iH2 = vVar.h(charset);
                            if ((iH2 != 0 ? com.imsdk.a.f(iH2 >>> 8) : 1114112) == i3) {
                            }
                        }
                        int i4 = -1;
                        if (strN3.startsWith("Format:")) {
                            ...
                            for (int i15 = i2; i15 < strArrSplit2.length; i15++) {
                                String strB2 = com.imsdk.a.B(strArrSplit2[i15].trim());
                                strB2.getClass();
                            ...
                            if (strN3.startsWith("Style:")) {
                                if (bVar == null) {
                                    androidx.media3.common.util.b.t("SsaParser", "Skipping 'Style:' line before 'Format:' line: ".concat(strN3));
                                } else {
                                    _COROUTINE.a.o(strN3.startsWith("Style:"));
                                    ...
                                    if (length != i16) {
                                        ...
                                        sbW.append(strN3);
                                        sbW.append("'");
                                        androidx.media3.common.util.b.t("SsaStyle", sbW.toString());
                                    } else {
                                        try {
                                            ...
                                            if (i20 != -1) {
                                                ...
                                                try {
                                                    ...
                                                    androidx.media3.common.util.b.u("SsaStyle", "Failed to parse font size: '" + strTrim2 + "'", e);
                                                }
                                            }
                                            float f2 = f;
                                            int i21 = bVar.f;
                                            ...
                                            if (i25 != -1) {
                                                ...
                                                try {
                                                    ...
                                                    if (i26 == 1 || i26 == 3) {
                                                        ...
                                                        androidx.media3.common.util.b.t("SsaStyle", "Ignoring unknown BorderStyle: " + strTrim3);
                                                    }
                                            ...
                                            androidx.media3.common.util.b.u("SsaStyle", "Skipping malformed 'Style:' line: '" + strN3 + "'", e2);
                                            dVar = null;
                                        }
                                        if (dVar != null) {
                ...
                androidx.media3.common.util.b.k("SsaParser", "[V4 Styles] are not supported");
        ...
        while (true) {
            ...
            if (strN == null) {
                ...
                if (arrayList3 != null) {
                    ...
                    while (it.hasNext()) {
                        hVar.accept((androidx.media3.extractor.text.a) it.next());
                    }
                    return;
                }
                return;
            ...
            if (strN.startsWith("Format:")) {
                ...
                if (strN.startsWith("Dialogue:")) {
                    if (bVarA == null) {
                        androidx.media3.common.util.b.t("SsaParser", "Skipping dialogue line before complete format: ".concat(strN));
                    } else {
                        int i16 = bVarA.f;
                        _COROUTINE.a.o(strN.startsWith("Dialogue:"));
                        String strSubstring = strN.substring(9);
                        int i17 = bVarA.a;
                        String[] strArrSplit = strSubstring.split(",", i16);
                        if (strArrSplit.length != i16) {
                            androidx.media3.common.util.b.t("SsaParser", "Skipping dialogue line with fewer columns than format: ".concat(strN));
                        } else {
                            if (i17 != -1) {
                                try {
                                    i3 = Integer.parseInt(strArrSplit[i17].trim());
                                } catch (RuntimeException unused) {
                                    androidx.media3.common.util.b.t("SsaParser", "Fail to parse layer: " + strArrSplit[i17]);
                                    i3 = 0;
                                }
                            } else {
                                i3 = 0;
                            ...
                            if (jC == -9223372036854775807L) {
                                androidx.media3.common.util.b.t("SsaParser", "Skipping invalid timing: ".concat(strN));
                                j = j2;
                                vVar = vVar2;
                            } else {
                                j = j2;
                                ...
                                if (jC2 == -9223372036854775807L || jC2 <= jC) {
                                    ...
                                    switch (i18) {
                                        case 0:
                                        default:
                                            j.x("Unknown alignment: ", i18, "SsaParser");
                                        case -1:
                                            alignment2 = null;
                                            break;
                                        case 1:
