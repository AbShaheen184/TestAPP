        ...
        while (true) {
            ...
            if (!strN.isEmpty()) {
                try {
                    ...
                    String strN2 = vVar.n(charsetI);
                    if (strN2 == null) {
                        androidx.media3.common.util.b.t("SubripParser", "Unexpected end");
                        break;
                    }
                    ...
                    if (matcher.matches()) {
                        ...
                        arrayList2.clear();
                        for (String strN3 = vVar.n(charsetI); !TextUtils.isEmpty(strN3); strN3 = vVar.n(charsetI)) {
                            if (sb.length() > 0) {
                                sb.append("<br>");
                            }
                        ...
                        if (j4 == j3 || jB2 >= j4) {
                            hVar.accept(new androidx.media3.extractor.text.a(jB, jB2 - jB, h0.s(a(spannedFromHtml, str))));
                        ...
                        androidx.media3.common.util.b.t("SubripParser", "Skipping invalid timing: ".concat(strN2));
                        aVar = this;
                    }
                } catch (NumberFormatException unused) {
                    androidx.media3.common.util.b.t("SubripParser", "Skipping invalid index: ".concat(strN));
                }
            }
        }
        if (arrayList != null) {
