...
public final class e implements l {
    ...
    public static int c(XmlPullParser xmlPullParser) {
        ...
        if (!matcher.matches()) {
            androidx.media3.common.util.b.t("TtmlParser", "Ignoring malformed cell resolution: ".concat(attributeValue));
            return 15;
        }
        boolean z2 = true;
        try {
            ...
            _COROUTINE.a.k(i, i2, "Invalid cell resolution %s %s", z2);
            return i2;
    ...
    public static void d(String str, g gVar) throws androidx.media3.extractor.text.f {
        ...
        if (length == 1) {
            ...
            if (strArrSplit.length != 2) {
                throw new androidx.media3.extractor.text.f(androidx.privacysandbox.ads.adservices.java.internal.a.o(strArrSplit.length, ".", new StringBuilder("Invalid number of entries for fontSize: ")));
            }
            matcher = pattern.matcher(strArrSplit[1]);
            androidx.media3.common.util.b.t("TtmlParser", "Multiple values in fontSize attribute. Picking the second value for vertical font size and ignoring the first.");
        }
        if (!matcher.matches()) {
            throw new androidx.media3.extractor.text.f(androidx.privacysandbox.ads.adservices.java.internal.a.r("Invalid expression for fontSize: '", str, "'."));
        }
        ...
        switch (strGroup) {
            ...
            case "px":
                ...
                break;
            default:
                throw new androidx.media3.extractor.text.f(androidx.privacysandbox.ads.adservices.java.internal.a.r("Invalid unit for fontSize: '", strGroup, "'."));
        }
    ...
    public static d e(XmlPullParser xmlPullParser) {
        ...
        if (attributeValue2 != null) {
            ...
            _COROUTINE.a.n("frameRateMultiplier doesn't have 2 parts", strArrSplit.length == 2);
    ...
    public static g h(XmlPullParser xmlPullParser, g gVar) {
        ...
        for (int i3 = 0; i3 < attributeCount; i3++) {
            ...
            switch (b) {
                ...
                case 3:
                    gVarA = a(gVarA);
                    String strB = com.imsdk.a.B(attributeValue);
                    strB.getClass();
                    switch (strB) {
                        case "center":
                ...
                case 4:
                    ...
                    break;
                case 5:
                    String strB2 = com.imsdk.a.B(attributeValue);
                    strB2.getClass();
                    switch (strB2) {
                        case "nounderline":
                            gVarA = a(gVarA);
                ...
                case 7:
                    ...
                    break;
                case 8:
                    String strB3 = com.imsdk.a.B(attributeValue);
                    strB3.getClass();
                    switch (strB3) {
                        case "baseContainer":
                        case "base":
                ...
                case 9:
                    gVarA = a(gVarA);
                    try {
                        gVarA.b = androidx.media3.common.util.f.a(attributeValue, false);
                        gVarA.c = true;
                    } catch (IllegalArgumentException unused) {
                        j.y("Failed parsing color value: ", attributeValue, "TtmlParser");
                    }
                    break;
                case 10:
                    g gVarA2 = a(gVarA);
                    ...
                    if (matcher.matches()) {
                        try {
                            ...
                            androidx.media3.common.util.b.u("TtmlParser", "Failed to parse shear: " + attributeValue, e);
                        }
                    } else {
                        j.y("Invalid value for shear: ", attributeValue, "TtmlParser");
                    }
                    gVarA2.s = fMin;
                    gVarA = gVarA2;
                    break;
                case 11:
                    String strB4 = com.imsdk.a.B(attributeValue);
                    strB4.getClass();
                    if (strB4.equals("all")) {
                        gVarA = a(gVarA);
                        gVarA.q = 1;
                ...
                case 12:
                    try {
                        ...
                        j.y("Failed parsing fontSize value: ", attributeValue, "TtmlParser");
                    }
                    break;
                case 13:
                    gVarA = a(gVarA);
                    ...
                    if (attributeValue == null) {
                        ...
                        String strB5 = com.imsdk.a.B(attributeValue.trim());
                        if (strB5.isEmpty()) {
                            bVar = null;
                        } else {
                            String[] strArrSplit = TextUtils.split(strB5, b.d);
                            int length = strArrSplit.length;
                    ...
                    break;
                case 14:
                    String strB6 = com.imsdk.a.B(attributeValue);
                    strB6.getClass();
                ...
                case 15:
                    gVarA = a(gVarA);
                    try {
                        gVarA.d = androidx.media3.common.util.f.a(attributeValue, false);
                        gVarA.e = true;
                    } catch (IllegalArgumentException unused3) {
                        j.y("Failed parsing background value: ", attributeValue, "TtmlParser");
                    }
                    break;
                case 16:
                    gVarA = a(gVarA);
                    String strB7 = com.imsdk.a.B(attributeValue);
                    strB7.getClass();
                    switch (strB7) {
                        case "center":
                            alignment = Layout.Alignment.ALIGN_CENTER;
    ...
    public static long i(String str, d dVar) throws androidx.media3.extractor.text.f {
        ...
        if (!matcher2.matches()) {
            throw new androidx.media3.extractor.text.f(j.i("Malformed time expression: ", str));
        }
    ...
    public static r k(XmlPullParser xmlPullParser) {
        String strI = androidx.media3.common.util.b.i(xmlPullParser, "extent");
        if (strI == null) {
            return null;
        }
        Matcher matcher = D.matcher(strI);
        if (!matcher.matches()) {
            androidx.media3.common.util.b.t("TtmlParser", "Ignoring non-pixel tts extent: ".concat(strI));
            return null;
        }
        try {
            String strGroup = matcher.group(1);
            ...
            androidx.media3.common.util.b.t("TtmlParser", "Ignoring malformed tts extent: ".concat(strI));
            return null;
        }
    }
    ...
    public final void j(byte[] bArr, int i, int i2, k kVar, h hVar) {
        _COROUTINE.b.I(o(bArr, i, i2), kVar, hVar);
    }
                ...
                if (i3 == 0) {
                    ...
                    if (eventType == 2) {
                        if ("tt".equals(name)) {
                            ...
                            rVarK = k(xmlPullParserNewPullParser);
                        }
                        d dVar = dVarE;
                        r rVar = rVarK;
                        int i4 = iC;
                        if (b(name)) {
                            if ("head".equals(name)) {
                                ...
                                try {
                                    ...
                                    androidx.media3.common.util.b.u("TtmlParser", "Suppressing parser error", e);
                                    i3++;
                                }
                            }
                            iC = i4;
                            ...
                            androidx.media3.common.util.b.k("TtmlParser", "Ignoring unsupported tag: " + xmlPullParserNewPullParser.getName());
                        }
                        i3++;
                        iC = i4;
                        rVarK = rVar;
