    ...
    public static void a(String str, e eVar, List list, SpannableStringBuilder spannableStringBuilder, List list2) {
        ...
        for (int i10 = 0; i10 < arrayListB.size(); i10++) {
            ...
            if (i != -1) {
                ...
                coil3.network.g.c(spannableStringBuilder, new StyleSpan(i3), i4, length);
            } else {
                i2 = 1;
            }
            if (bVar.j == i2) {
            ...
            if (bVar.g) {
                if (!bVar.g) {
                    kotlinx.coroutines.future.a.u("Font color not defined");
                    return;
                }
                coil3.network.g.c(spannableStringBuilder, new ForegroundColorSpan(bVar.f), i4, length);
            }
            if (bVar.i) {
                if (!bVar.i) {
                    kotlinx.coroutines.future.a.u("Background color not defined.");
                    return;
                }
                coil3.network.g.c(spannableStringBuilder, new BackgroundColorSpan(bVar.h), i4, length);
            }
            if (bVar.e != null) {
                coil3.network.g.c(spannableStringBuilder, new TypefaceSpan(bVar.e), i4, length);
            }
            int i13 = bVar.n;
            if (i13 == 1) {
                coil3.network.g.c(spannableStringBuilder, new AbsoluteSizeSpan((int) bVar.o, true), i4, length);
            } else if (i13 == 2) {
                coil3.network.g.c(spannableStringBuilder, new RelativeSizeSpan(bVar.o), i4, length);
            } else if (i13 == 3) {
                coil3.network.g.c(spannableStringBuilder, new RelativeSizeSpan(bVar.o / 100.0f), i4, length);
            }
            if (bVar.q) {
    ...
    public static c d(String str, Matcher matcher, v vVar, ArrayList arrayList) {
        ...
        try {
            ...
            while (!TextUtils.isEmpty(strN)) {
                ...
                sb.append(strN.trim());
                strN = vVar.n(StandardCharsets.UTF_8);
            }
            gVar.c = f(str, sb.toString(), arrayList);
            return new c(gVar.a().a(), gVar.a, gVar.b);
        } catch (IllegalArgumentException unused) {
            androidx.media3.common.util.b.t("WebvttCueParser", "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
                    ...
                    if ("align".equals(strGroup)) {
                        switch (strGroup2) {
                            ...
                            case "start":
                                ...
                                break;
                            default:
                                androidx.media3.common.util.b.t("WebvttCueParser", "Invalid alignment value: ".concat(strGroup2));
                                i = 2;
                                break;
                        }
                        gVar.d = i;
                        ...
                        if (iIndexOf != -1) {
                            ...
                            switch (strSubstring) {
                                ...
                                case "end":
                                    ...
                                    break;
                                default:
                                    androidx.media3.common.util.b.t("WebvttCueParser", "Invalid anchor value: ".concat(strSubstring));
                        ...
                        if (strGroup2.equals("lr")) {
                            ...
                            androidx.media3.common.util.b.t("WebvttCueParser", "Invalid 'vertical' value: ".concat(strGroup2));
                            i3 = Integer.MIN_VALUE;
                        }
                        gVar.k = i3;
                    } else {
                        androidx.media3.common.util.b.t("WebvttCueParser", "Unknown cue setting " + strGroup + ":" + strGroup2);
                    }
                }
            } catch (NumberFormatException unused) {
                androidx.media3.common.util.b.t("WebvttCueParser", "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
            ...
            if (cCharAt == '&') {
                ...
                if (iIndexOf != -1) {
                    ...
                    switch (strSubstring) {
                        ...
                        case "nbsp":
                            ...
                            break;
                        default:
                            androidx.media3.common.util.b.t("WebvttCueParser", "ignoring unsupported entity: '&" + strSubstring + ";'");
                            break;
                    }
                ...
                if (length < str2.length()) {
                    ...
                    if (!strSubstring2.trim().isEmpty()) {
                        ...
                        _COROUTINE.a.o(!strTrim2.isEmpty());
                        String str3 = i0.a;
                            ...
                            case "ruby":
                                if (!z) {
                                    if (!z2) {
                                        ...
                                        _COROUTINE.a.o(!strTrim3.isEmpty());
