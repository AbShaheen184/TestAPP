...
public final class b0 {
    ...
    public void a(long j, androidx.media3.common.util.v vVar) {
        if (vVar.a() < 9) {
            return;
        }
        int iM = vVar.m();
            ...
            case 0:
                ...
                while (true) {
                    ...
                    if (i < h0VarArr.length) {
                        ...
                        String str = rVar.o;
                        _COROUTINE.a.q("application/cea-608".equals(str) || "application/cea-708".equals(str), "Invalid closed caption MIME type provided: %s", str);
                        String str2 = rVar.a;
                        if (str2 == null) {
                            e0Var.b();
                            str2 = e0Var.e;
            ...
            default:
                ...
                while (true) {
                    ...
                    if (i2 < h0VarArr2.length) {
                        ...
                        String str3 = rVar2.o;
                        _COROUTINE.a.q("application/cea-608".equals(str3) || "application/cea-708".equals(str3), "Invalid closed caption MIME type provided: %s", str3);
