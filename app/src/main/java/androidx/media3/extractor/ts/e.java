...
public final class e implements h {
    ...
    public h0 v;
    public long w;
    public final androidx.media3.common.util.u b = new androidx.media3.common.util.u(new byte[7], 7);
    public final androidx.media3.common.util.v c = new androidx.media3.common.util.v(Arrays.copyOf(x, 10));
    public int o = -1;
    public int p = -1;
    ...
    public final void c(androidx.media3.common.util.v vVar) {
        ...
        while (vVar.a() > 0) {
            ...
            if (i7 == 0) {
                ...
                if (i7 == 2) {
                    byte[] bArr6 = vVar2.a;
                    int iMin = Math.min(vVar.a(), 10 - this.k);
                    vVar.k(bArr6, this.k, iMin);
                    int i26 = this.k + iMin;
                    this.k = i26;
                    if (i26 == 10) {
                        this.i.f(10, vVar2);
                    ...
                    int i27 = this.m ? 7 : 5;
                    byte[] bArr7 = uVar.b;
                    int iMin2 = Math.min(vVar.a(), i27 - this.k);
                    vVar.k(bArr7, this.k, iMin2);
                    ...
                    if (i28 == i27) {
                        ...
                        if (this.r) {
                            ...
                            int iG3 = uVar.g(2) + 1;
                            if (iG3 != 2) {
                                androidx.media3.common.util.b.t("AdtsReader", "Detected audio object type: " + iG3 + ", but assuming AAC LC.");
                                iG3 = 2;
                            }
                            uVar.o(5);
                            int iG4 = uVar.g(3);
                            ...
                            androidx.media3.extractor.a aVarN = androidx.media3.extractor.b.n(new androidx.media3.common.util.u(bArr8, 2), false);
                            androidx.media3.common.q qVar = new androidx.media3.common.q();
                            qVar.a = this.g;
                            qVar.m = androidx.media3.common.i0.p(this.f);
                            qVar.n = androidx.media3.common.i0.p("audio/mp4a-latm");
                            qVar.j = aVarN.a;
                            qVar.F = aVarN.c;
                            qVar.G = aVarN.b;
                    ...
                    int iMin3 = Math.min(vVar.a(), this.t - this.k);
                    this.v.f(iMin3, vVar);
                    int i31 = this.k + iMin3;
                    this.k = i31;
                    if (i31 == this.t) {
                        _COROUTINE.a.A(this.u != -9223372036854775807L);
    ...
    public final void f(androidx.media3.extractor.p pVar, e0 e0Var) {
        ...
        qVar.a = e0Var.e;
        qVar.m = androidx.media3.common.i0.p(this.f);
        qVar.n = androidx.media3.common.i0.p("application/id3");
