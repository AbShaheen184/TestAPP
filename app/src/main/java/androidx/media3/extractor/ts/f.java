...
public final class f implements h {
    public final androidx.media3.common.util.v a;
    ...
    public f(String str, int i, int i2) {
        this.a = new androidx.media3.common.util.v(new byte[i2]);
        this.c = str;
        this.d = i;
    }
    ...
    public final boolean b(androidx.media3.common.util.v vVar, byte[] bArr, int i) {
        int iMin = Math.min(vVar.a(), i - this.i);
        vVar.k(bArr, this.i, iMin);
        int i2 = this.i + iMin;
        this.i = i2;
        return i2 == i;
    }
    ...
    public final void c(androidx.media3.common.util.v vVar) throws j0 {
        ...
        while (vVar.a() > 0) {
            int i11 = this.h;
            androidx.media3.common.util.v vVar2 = this.a;
            switch (i11) {
                case 0:
                    while (vVar.a() > 0) {
                        int i12 = this.j << 8;
                ...
                case 1:
                    if (b(vVar, vVar2.a, 18)) {
                        ...
                        if (this.l == null) {
                            String str = this.f;
                            androidx.media3.common.util.u uVarK = androidx.media3.extractor.b.k(bArr2);
                            uVarK.o(60);
                            int i15 = androidx.media3.extractor.b.j[uVarK.g(6)];
                            int i16 = androidx.media3.extractor.b.k[uVarK.g(4)];
                            int iG4 = uVarK.g(5);
                            int i17 = iG4 >= 29 ? -1 : (androidx.media3.extractor.b.l[iG4] * 1000) / 2;
                            uVarK.o(10);
                            int i18 = i15 + (uVarK.g(2) > 0 ? 1 : 0);
                        ...
                        if (b3 != -2) {
                            ...
                            i2 = b2 & 60;
                            this.k = com.imsdk.a.f(androidx.media3.common.util.i0.W(this.l.H, (((i2 >> 2) | i) + 1) * 32));
                            vVar2.M(0);
                            this.g.f(18, vVar2);
                            this.h = 6;
                        } else {
                ...
                case 2:
                    if (b(vVar, vVar2.a, 7)) {
                        androidx.media3.common.util.u uVarK2 = androidx.media3.extractor.b.k(vVar2.a);
                        uVarK2.o(42);
                        this.o = uVarK2.g(uVarK2.f() ? 12 : 8) + 1;
                        this.h = 3;
                    }
                    break;
                case 3:
                    ...
                    if (b(vVar, vVar2.a, this.o)) {
                        androidx.media3.common.util.u uVarK3 = androidx.media3.extractor.b.k(vVar2.a);
                        uVarK3.o(40);
                        int iG5 = uVarK3.g(2);
                        if (uVarK3.f()) {
                            i3 = 20;
                        ...
                        uVarK3.o(i4);
                        int iG6 = uVarK3.g(i3) + 1;
                        boolean zF = uVarK3.f();
                        if (zF) {
                            iG = uVarK3.g(2);
                            iG2 = (uVarK3.g(3) + 1) * 512;
                            if (uVarK3.f()) {
                                uVarK3.o(36);
                            }
                            int iG7 = uVarK3.g(3) + 1;
                            int iG8 = uVarK3.g(3) + 1;
                            if (iG7 != 1 || iG8 != 1) {
                                throw j0.c("Multiple audio presentations or assets not supported");
                            }
                            int i20 = iG5 + 1;
                            int iG9 = uVarK3.g(i20);
                            int i21 = 0;
                            while (i21 < i20) {
                                if (((iG9 >> i21) & 1) == 1) {
                                    uVarK3.o(i19);
                            ...
                            if (uVarK3.f()) {
                                uVarK3.o(2);
                                int iG10 = (uVarK3.g(2) + 1) << 2;
                                int iG11 = uVarK3.g(2) + 1;
                        ...
                        if (zF) {
                            ...
                            if (uVarK3.f()) {
                                uVarK3.p(uVarK3.g(10) + 1);
                            }
                            uVarK3.o(5);
                            i5 = androidx.media3.extractor.b.m[uVarK3.g(4)];
                            iG3 = uVarK3.g(8) + 1;
                        } else {
                            iG3 = -1;
                            i5 = -2147483647;
                        ...
                        if (zF) {
                            ...
                            jY = androidx.media3.common.util.i0.Y(iG2, 1000000L, i6, RoundingMode.DOWN);
                        } else {
                ...
                case 4:
                    if (b(vVar, vVar2.a, 6)) {
                        androidx.media3.common.util.u uVarK4 = androidx.media3.extractor.b.k(vVar2.a);
                        uVarK4.o(32);
                        int iQ = androidx.media3.extractor.b.q(uVarK4, androidx.media3.extractor.b.r) + 1;
                        this.p = iQ;
                        int i23 = this.i;
                        if (i23 > iQ) {
                            int i24 = i23 - iQ;
                ...
                case 5:
                    if (b(vVar, vVar2.a, this.p)) {
                        byte[] bArr3 = vVar2.a;
                        androidx.media3.common.util.u uVarK5 = androidx.media3.extractor.b.k(bArr3);
                        int i25 = uVarK5.g(32) == 1078008818 ? 1 : 0;
                        int iQ2 = androidx.media3.extractor.b.q(uVarK5, androidx.media3.extractor.b.n);
                        int i26 = iQ2 + 1;
                        if (i25 == 0) {
                            ...
                            for (int i30 = 0; i30 < i27; i30++) {
                                byte b4 = bArr3[i30];
                                int[] iArr = androidx.media3.common.util.i0.l;
                            ...
                            int iG15 = i10 * (1 << uVarK5.g(2));
                            jY2 = androidx.media3.common.util.i0.Y(iG13, 1000000L, i10, RoundingMode.DOWN);
                            i7 = iG15;
                        }
                        int iQ3 = 0;
                        for (int i32 = 0; i32 < i25; i32++) {
                            iQ3 += androidx.media3.extractor.b.q(uVarK5, androidx.media3.extractor.b.o);
                        }
                        AtomicInteger atomicInteger = this.b;
                        if (i25 != 0) {
                            atomicInteger.set(androidx.media3.extractor.b.q(uVarK5, androidx.media3.extractor.b.p));
                        }
                        int iQ4 = iQ3 + (atomicInteger.get() != 0 ? androidx.media3.extractor.b.q(uVarK5, androidx.media3.extractor.b.q) : 0) + i26;
                    ...
                    break;
                case 6:
                    int iMin = Math.min(vVar.a(), this.m - this.i);
                    this.g.f(iMin, vVar);
                    int i33 = this.i + iMin;
                    this.i = i33;
                    if (i33 == this.m) {
                        _COROUTINE.a.A(this.q != -9223372036854775807L);
