...
public final class g implements h {
    ...
    public final void c(androidx.media3.common.util.v vVar) {
        ...
        switch (this.a) {
            case 0:
                ...
                break;
            default:
                androidx.media3.common.util.v vVar2 = (androidx.media3.common.util.v) this.f;
                ((h0) this.g).getClass();
                if (this.b) {
                    int iA2 = vVar.a();
                    int i2 = this.e;
                    if (i2 < 10) {
                        ...
                        System.arraycopy(vVar.a, vVar.b, vVar2.a, this.e, iMin);
                        if (this.e + iMin == 10) {
                            vVar2.M(0);
                            if (73 == vVar2.z() && 68 == vVar2.z() && 51 == vVar2.z()) {
                                ...
                                androidx.media3.common.util.b.t("Id3Reader", "Discarding invalid ID3 tag");
                                this.b = false;
                            }
                        }
                    }
                    int iMin2 = Math.min(iA2, this.d - this.e);
                    ((h0) this.g).f(iMin2, vVar);
                    this.e += iMin2;
                    break;
                }
                break;
    ...
    public final void d(boolean z) {
        ...
        switch (this.a) {
            case 0:
                if (this.b) {
                    _COROUTINE.a.A(this.c != -9223372036854775807L);
                    for (h0 h0Var : (h0[]) this.g) {
    ...
    public g() {
        this.a = 1;
        this.f = new androidx.media3.common.util.v(10);
        this.c = -9223372036854775807L;
    }
}
