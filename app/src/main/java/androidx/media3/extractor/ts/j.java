...
public final class j implements h {
    ...
    public final androidx.media3.common.util.v e;
    ...
    public j(b0 b0Var, String str) {
        ...
        this.h = iVar;
        if (b0Var != null) {
            this.f = new androidx.media3.exoplayer.h0(Token.ARROW);
            this.e = new androidx.media3.common.util.v();
        } else {
            this.f = null;
            this.e = null;
        }
    ...
    public final void a() {
        androidx.media3.container.r.b(this.g);
        i iVar = this.h;
        iVar.a = false;
        iVar.b = 0;
        iVar.c = 0;
        androidx.media3.exoplayer.h0 h0Var = this.f;
        if (h0Var != null) {
            h0Var.f();
        }
        this.i = 0L;
    ...
    /*  JADX ERROR: Types fix failed
        ...
        */
    @Override // androidx.media3.extractor.ts.h
    public final void c(androidx.media3.common.util.v r23) {
        /*
            Method dump skipped, instruction units count: 525
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media3.extractor.ts.j.c(androidx.media3.common.util.v):void");
    }
