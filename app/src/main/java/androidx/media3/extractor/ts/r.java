...
public final class r implements h {
    ...
    public final androidx.media3.common.util.v n = new androidx.media3.common.util.v();
    ...
    public final void b(int i, int i2, long j, long j2) {
        ...
        if (!this.e) {
            ...
            if (h0Var.d && h0Var2.d && h0Var3.d) {
                ...
                String strA = kVar != null ? androidx.media3.common.util.e.a(kVar.a, kVar.b, kVar.c, kVar.d, kVar.e, kVar.f) : null;
        ...
        androidx.media3.common.util.v vVar = this.n;
        if (zD) {
            vVar.K((byte[]) h0Var4.f, androidx.media3.container.r.p((byte[]) h0Var4.f, h0Var4.e));
            vVar.N(5);
            oVar.a(j2, vVar);
        }
        androidx.media3.exoplayer.h0 h0Var5 = this.k;
        if (h0Var5.d(i2)) {
            vVar.K((byte[]) h0Var5.f, androidx.media3.container.r.p((byte[]) h0Var5.f, h0Var5.e));
            vVar.N(5);
            oVar.a(j2, vVar);
        }
    }
