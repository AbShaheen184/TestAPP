...
public final class a implements b {
    ...
    public final int d;
    public final byte[] e;
    public final androidx.media3.common.util.v f;
    public final int g;
    public final r h;
    public int i;
    public long j;
    ...
    public a(p pVar, h0 h0Var, v vVar) throws j0 {
        ...
        this.g = iMax;
        androidx.media3.common.util.v vVar2 = new androidx.media3.common.util.v(vVar.e);
        vVar2.s();
        int iS = vVar2.s();
        this.d = iS;
        int i2 = vVar.a;
        ...
        this.f = new androidx.media3.common.util.v(iS * 2 * i2 * iG);
        int i5 = ((i3 * i) * 8) / iS;
        q qVar = new q();
    ...
    public final boolean b(o oVar, long j) {
        ...
        int i18 = this.k;
        v vVar2 = this.c;
        int i19 = i18 / (vVar2.a * 2);
        int i20 = this.g;
        int i21 = this.d;
        int iG = i0.g(i20 - i19, i21);
        int i22 = vVar2.c;
        int i23 = iG * i22;
        boolean z = j == 0;
        while (true) {
                    ...
                    while (true) {
                        ...
                        if (i5 < i6) {
                            ...
                            while (i11 < i8 * 2) {
                                ...
                                iJ = i0.j(iJ + i15, -32768, 32767);
                                i10 = (i6 * 2) + i10;
                                bArr2[i10] = (byte) (iJ & 255);
                                bArr2[i10 + 1] = (byte) (iJ >> 8);
                                iMin = i0.j(iMin + m[i14], 0, 88);
                                i9 = iArr[iMin];
                                i11 = i12 + 1;
                            }
                            i5++;
    ...
    public final void d(int i) {
        ...
        long j3 = vVar.b;
        String str = i0.a;
        long jY = j + i0.Y(j2, 1000000L, j3, RoundingMode.DOWN);
        int i2 = i * 2 * vVar.a;
