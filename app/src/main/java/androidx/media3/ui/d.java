...
public final class d extends View implements n0 {
    ...
    /* JADX WARN: Type inference failed for: r7v19, types: [androidx.compose.ui.platform.u1] */
    /* JADX WARN: Type inference failed for: r7v6, types: [androidx.compose.ui.platform.u1] */
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float fP = coil3.svg.internal.a.P(dVar.z, dVar.A, height, i10);
        float f4 = 0.0f;
        if (fP <= 0.0f) {
            return;
        }
        ...
        while (i11 < size) {
            ...
            float fP2 = coil3.svg.internal.a.P(bVarA.n, bVarA.o, height, i10);
            ...
            if ((r14 == spannableStringBuilder || (r14 != 0 && r14.equals(spannableStringBuilder))) && Objects.equals(m0Var.j, alignment) && m0Var.k == bitmap && m0Var.l == f12 && m0Var.m == i20) {
                i2 = i19;
                if (Integer.valueOf(m0Var.n).equals(Integer.valueOf(i2)) && m0Var.o == f && Integer.valueOf(m0Var.p).equals(Integer.valueOf(i18)) && m0Var.q == f9 && m0Var.r == f8 && m0Var.s == eVar.a && m0Var.t == eVar.b && m0Var.u == i && m0Var.w == eVar.d && m0Var.v == eVar.e && Objects.equals(textPaint.getTypeface(), eVar.f) && m0Var.x == f11 && m0Var.y == fP2 && m0Var.z == f7 && m0Var.A == paddingLeft && m0Var.B == paddingTop && m0Var.C == width && m0Var.D == paddingBottom) {
                    m0Var.a(canvas2, z);
                    i6 = paddingBottom;
                }
                i11 = i17 + 1;
                            ...
                            if (objArr != null) {
                                ...
                                while (i28 < objArr.length) {
                                    ...
                                    if (spanStart < 0 || spanStart >= spannableStringBuilder.length() || spanEnd < 0 || spanEnd > spannableStringBuilder.length()) {
                                        ...
                                        androidx.media3.common.util.b.t("BidiUtils", sbW.toString());
                                    } else {
            ...
            if (z) {
                ...
                int i34 = i33;
                if (i34 <= 0) {
                    androidx.media3.common.util.b.t("SubtitlePainter", "Skipped drawing subtitle cue (insufficient space)");
                    f11 = f11;
                } else {
                    if (m0Var.y > f5) {
                        i8 = 0;
