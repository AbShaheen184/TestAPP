...
public final class v extends FrameLayout {
    ...
    public v(Context context) {
        ...
        this.z = androidx.media3.common.util.i0.q(null);
    ...
    public static void a(v vVar, androidx.media3.common.q0 q0Var, long j) {
        if (vVar.S0) {
            ...
            if (c0Var.u(17) && c0Var.u(10)) {
                ...
                int i = 0;
                while (true) {
                    long jD0 = androidx.media3.common.util.i0.d0(v0VarL.m(i, vVar.p0, 0L).m);
                    if (j < jD0) {
                        break;
                    }
                    if (i == iO - 1) {
            ...
            if (keyCode == 90) {
                ...
                if (c0Var3.u(11)) {
                    ...
                    if (keyCode != 79 || keyCode == 85) {
                        if (androidx.media3.common.util.i0.a0(q0Var, this.R0)) {
                ...
                } else if (androidx.media3.common.util.i0.a0(q0Var, this.R0)) {
                    androidx.media3.common.util.i0.I(q0Var);
                } else {
                    c0Var = (androidx.media3.exoplayer.c0) q0Var;
                    if (c0Var.u(1)) {
            ...
            if (b1Var.b.c == i) {
                for (int i4 = 0; i4 < b1Var.a; i4++) {
                    if (b1Var.b(i4)) {
                        ...
                        if ((rVarA.e & 2) == 0) {
                            s sVar = new s(c1Var, i3, i4, this.N.A(rVarA));
                            int i5 = i2 + 1;
    ...
    public final void q() {
        ...
        if (l() && this.P0 && (imageView = this.S) != null) {
            boolean zA0 = androidx.media3.common.util.i0.a0(this.N0, this.R0);
    ...
    public final void s() {
        ...
        if (l() && this.P0) {
            ...
            if (textView != null && !this.T0) {
                textView.setText(androidx.media3.common.util.i0.F(this.m0, this.n0, jE));
            }
            o0 o0Var = this.l0;
            if (o0Var != null) {
                g gVar = (g) o0Var;
            ...
            if (q0Var != null) {
                ...
                if (c0Var2.w()) {
                    ...
                    postDelayed(lVar, androidx.media3.common.util.i0.k(f > 0.0f ? (long) (jMin / f) : 1000L, this.W0, 1000L));
                    return;
                }
            }
            if (iQ == 4 || iQ == 1) {
    ...
    public void setMediaRouteButtonViewProvider(g1 g1Var) {
        ...
        if (viewFindViewById == null) {
            kotlinx.coroutines.future.a.u("The media route button placeholder is missing.");
            return;
        }
        if (g1Var == null) {
        ...
        if (viewGroup == null) {
            kotlinx.coroutines.future.a.u("The media route button placeholder has no parent view.");
            return;
        }
        ...
        listenableFutureA.a(new com.google.common.util.concurrent.k0(0, listenableFutureA, c2Var), new androidx.compose.ui.text.input.b0(handler, 2));
    }
    ...
    public void setPlayer(androidx.media3.common.q0 q0Var) {
        _COROUTINE.a.A(Looper.myLooper() == Looper.getMainLooper());
        _COROUTINE.a.o(q0Var == null || ((androidx.media3.exoplayer.c0) q0Var).s == Looper.getMainLooper());
        androidx.media3.common.q0 q0Var2 = this.N0;
        if (q0Var2 == q0Var) {
            return;
        }
        ...
        this.N0 = q0Var;
        if (q0Var != null) {
            androidx.media3.common.util.o oVar = ((androidx.media3.exoplayer.c0) q0Var).m;
            kVar.getClass();
            oVar.a(kVar);
        }
        m();
    ...
    public void setTimeBarMinUpdateInterval(int i) {
        this.W0 = androidx.media3.common.util.i0.j(i, 16, 1000);
    }
    ...
    public final void w() {
        ...
        if (v0VarL.p()) {
            ...
            if (c0Var.u(16)) {
                ...
                if (v0VarL2.p()) {
                    ...
                    j = 0;
                    jD0 = androidx.media3.common.util.i0.d0(v0VarL2.m(c0Var.h(), c0Var.a, 0L).m);
                }
                if (jD0 != -9223372036854775807L) {
                    jQ = androidx.media3.common.util.i0.Q(jD0);
                }
                i = 0;
            } else {
                j = 0;
            ...
            while (i2 <= iO) {
                ...
                if (i2 == iH) {
                    this.c1 = androidx.media3.common.util.i0.d0(j3);
                }
                r5.n(i2, u0Var);
                if (u0Var.m == -9223372036854775807L) {
                    _COROUTINE.a.A(this.S0 ^ z6);
                    break;
                }
                int i3 = u0Var.n;
                ?? r6 = r5;
                ...
                while (i3 <= u0Var.o) {
                    ...
                    while (r4 < i4) {
                        ...
                        if (j7 >= j6) {
                            ...
                            r2 = r6;
                            r4 = z8;
                            this.Y0[i] = androidx.media3.common.util.i0.d0(j7 + j3);
        ...
        long jD1 = androidx.media3.common.util.i0.d0(jQ);
        TextView textView = this.j0;
        if (textView != null) {
            textView.setText(androidx.media3.common.util.i0.F(this.m0, this.n0, jD1));
        }
        o0 o0Var = this.l0;
        if (o0Var != null) {
            g gVar = (g) o0Var;
