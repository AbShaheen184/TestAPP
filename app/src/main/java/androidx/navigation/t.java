...
public abstract class t {
    ...
    public final Bundle b(Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            for (Map.Entry entry2 : linkedHashMap.entrySet()) {
                ...
                i0 i0Var = gVar2.a;
                str2.getClass();
                if (!bundleF.containsKey(str2) || !coil3.network.g.w(str2, bundleF)) {
                    try {
                        i0Var.a(str2, bundleF);
                    } catch (IllegalStateException unused) {
                    }
                }
                t0.l(androidx.privacysandbox.ads.adservices.java.internal.a.x("Wrong argument type for '", str2, "' in argument savedState. "), i0Var.b(), " expected.");
                return null;
            }
        }
        return bundleF;
    ...
    public final Map c() {
        return kotlin.collections.c0.o((LinkedHashMap) this.y.d);
    }
                ...
                if (bundleD == null) {
                    if (z) {
                        ...
                        if (uri != null && (iVar = (kotlin.text.i) oVar2.getValue()) != null && (gVarD = iVar.d(uri.toString())) != null) {
                            rVar.e(gVarD, bundleF, linkedHashMap);
                            if (((Boolean) rVar.e.getValue()).booleanValue()) {
                                rVar.f(uri, bundleF, linkedHashMap);
                            }
                        }
                        if (f.e(linkedHashMap, new p(1, bundleF)).isEmpty()) {
                        }
                    }
                }
    ...
    public boolean equals(Object obj) {
        ...
        if (this != obj) {
            if (obj != null && (obj instanceof t)) {
                ...
                Iterator it = ((kotlin.sequences.a) kotlin.sequences.k.K(new a1(z0Var2))).iterator();
                while (true) {
                    if (!it.hasNext()) {
                        z = true;
                        break;
                ...
                Iterator it2 = ((Iterable) kotlin.collections.p.u(c().entrySet()).b).iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        z2 = true;
                        break;
    ...
    public int hashCode() {
        ...
        for (String str2 : c().keySet()) {
            int iG = androidx.privacysandbox.ads.adservices.java.internal.a.g(iHashCode * 31, 31, str2);
            Object obj = c().get(str2);
            iHashCode = iG + (obj != null ? obj.hashCode() : 0);
        }
        return iHashCode;
    }
