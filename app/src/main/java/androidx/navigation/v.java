...
public class v extends t implements Iterable, kotlin.jvm.internal.markers.a {
    ...
    public final boolean equals(Object obj) {
        ...
        z0 z0Var = (z0) hVar.A;
        z0Var.getClass();
        for (t tVar : (kotlin.sequences.a) kotlin.sequences.k.K(new b1(z0Var, 0))) {
    ...
    public final s f(String str, boolean z, t tVar) {
        ...
        s sVar = (s) kotlin.collections.p.L(arrayList);
        v vVar2 = vVar.z;
        if (vVar2 != null && z && !vVar2.equals(tVar)) {
            sVarF = vVar2.f(str, true, vVar);
        }
        return (s) kotlin.collections.p.L(kotlin.collections.o.q(new s[]{sVarG, sVar, sVarF}));
    }
    ...
    public final Iterator iterator() {
        androidx.fragment.app.h hVar = this.C;
        hVar.getClass();
        return new androidx.navigation.internal.i(hVar);
    }
    ...
    public final String toString() {
        ...
        hVar.getClass();
        t tVarA = (str == null || kotlin.text.k.J(str)) ? null : hVar.A(str, true);
        if (tVarA == null) {
            tVarA = hVar.z(hVar.y);
        }
