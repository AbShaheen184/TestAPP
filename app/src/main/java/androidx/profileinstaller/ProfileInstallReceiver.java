...
public class ProfileInstallReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if ("androidx.profileinstaller.action.INSTALL_PROFILE".equals(action)) {
            c.t(context, new androidx.arch.core.executor.a(2), new androidx.media3.exoplayer.hls.c(this, 10), true);
            return;
        }
        if ("androidx.profileinstaller.action.SKIP_FILE".equals(action)) {
            ...
            if (extras2 != null) {
                ...
                androidx.media3.exoplayer.hls.c cVar = new androidx.media3.exoplayer.hls.c(this, 10);
                try {
        ...
        androidx.media3.exoplayer.hls.c cVar2 = new androidx.media3.exoplayer.hls.c(this, 10);
