...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        androidx.localbroadcastmanager.content.b bVar = new androidx.localbroadcastmanager.content.b(22);
        this.J = bVar;
        this.K = new Rect();
        ...
        this.D = true;
        if (i3 < 1) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i3, "Span count should be at least 1. Provided "));
            throw null;
        }
        this.E = i3;
        bVar.y();
    ...
    public final void Q0(i0 i0Var, l0 l0Var, q qVar, androidx.media3.exoplayer.audio.l lVar) {
        ...
        while (i7 < this.E && (i5 = qVar.d) >= 0 && i5 < l0Var.b() && iG1 > 0) {
            ...
            if (iG2 > this.E) {
                kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.o(this.E, " spans.", androidx.privacysandbox.ads.adservices.java.internal.a.w("Item at position ", " requires ", i8, " spans but GridLayoutManager has only ", iG2)));
                return;
            }
            iG1 -= iG2;
    ...
    */
    ...
    public final void X0(boolean z) {
        if (z) {
            com.google.firebase.platforminfo.b.n("GridLayoutManager does not support stack from end. Consider using reverse layout");
        } else {
            super.X0(false);
        }
    }
    ...
    public final int e1(int i, i0 i0Var, l0 l0Var) {
        ...
        if (!z) {
            bVar.getClass();
            return androidx.localbroadcastmanager.content.b.x(i, this.E);
        }
        int iB = i0Var.b(i);
        if (iB != -1) {
            bVar.getClass();
            return androidx.localbroadcastmanager.content.b.x(iB, this.E);
        }
    ...
    @Override // androidx.recyclerview.widget.LinearLayoutManager
    public final void z0(l0 l0Var, q qVar, androidx.media3.common.util.d dVar) {
        int i;
        int i2 = this.E;
        for (int i3 = 0; i3 < this.E && (i = qVar.d) >= 0 && i < l0Var.b() && i2 > 0; i3++) {
            dVar.b(qVar.d, Math.max(0, qVar.g));
            this.J.getClass();
            i2--;
            qVar.d += qVar.e;
        }
