...
public class LinearLayoutManager extends c0 {
    ...
    public final int A0(l0 l0Var) {
        ...
        boolean z = !this.v;
        return androidx.room.t.i(l0Var, gVar, H0(z), G0(z), this, this.v);
    }
    ...
    public final int B0(l0 l0Var) {
        ...
        androidx.emoji2.text.g gVar = this.q;
        boolean z = !this.v;
        return androidx.room.t.j(l0Var, gVar, H0(z), G0(z), this, this.v, this.t);
    }
    ...
    public final int C0(l0 l0Var) {
        ...
        androidx.emoji2.text.g gVar = this.q;
        boolean z = !this.v;
        return androidx.room.t.k(l0Var, gVar, H0(z), G0(z), this, this.v);
    }
    ...
    public final void W0(int i) {
        if (i != 0 && i != 1) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "invalid orientation:"));
            return;
        }
        b(null);
    ...
    public final void g(int i, int i2, l0 l0Var, androidx.media3.common.util.d dVar) {
        ...
        z0(l0Var, this.p, dVar);
    }

    @Override // androidx.recyclerview.widget.c0
    public final void h(int i, androidx.media3.common.util.d dVar) {
        boolean z;
        int i2;
        r rVar = this.y;
    ...
    public void z0(l0 l0Var, q qVar, androidx.media3.common.util.d dVar) {
        int i = qVar.d;
        if (i < 0 || i >= l0Var.b()) {
            return;
        }
        dVar.b(i, Math.max(0, qVar.g));
    }
