...
public class RecyclerView extends ViewGroup {
    ...
    public final c2 C;
    public ArrayList C0;
    public final androidx.localbroadcastmanager.content.b D;
    public boolean D0;
    public boolean E;
    public boolean E0;
    public final Rect F;
    ...
    public n y0;
    public final i0 z;
    public final androidx.media3.common.util.d z0;
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.z = new i0(this);
        this.D = new androidx.localbroadcastmanager.content.b(25);
        this.F = new Rect();
        this.G = new Rect();
        this.H = new RectF();
        ...
        this.w0 = true;
        this.x0 = new o0(this);
        this.z0 = W0 ? new androidx.media3.common.util.d() : null;
        l0 l0Var = new l0();
        l0Var.a = -1;
        l0Var.b = 0;
        l0Var.c = 0;
        ...
        if (typedArrayObtainStyledAttributes.getBoolean(3, false)) {
            ...
            if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
                kotlinx.coroutines.future.a.q("Trying to set fast scroller without both required drawables.".concat(w()));
                throw null;
            }
        ...
        if (string != null) {
            ...
            if (!strTrim.isEmpty()) {
                ...
                try {
                    try {
                        if (isInEditMode()) {
                            ...
                            try {
                                ...
                                e = e;
                                r16 = 0;
                                androidx.media3.exoplayer.source.t0.f(attributeSet.getPositionDescription(), ": Unable to find LayoutManager ", str, e);
                                throw r16;
                            } catch (IllegalAccessException e2) {
                                e = e2;
                                r16 = 0;
                                androidx.media3.exoplayer.source.t0.f(attributeSet.getPositionDescription(), ": Cannot access non-public constructor ", str, e);
                                throw r16;
                            } catch (InstantiationException e3) {
                                e = e3;
                                r16 = 0;
                                androidx.media3.exoplayer.source.t0.f(attributeSet.getPositionDescription(), ": Could not instantiate the LayoutManager: ", str, e);
                                throw r16;
                    ...
                    androidx.media3.exoplayer.source.t0.f(attributeSet.getPositionDescription(), ": Class is not a LayoutManager ", str, e11);
                    throw null;
                }
            }
        }
    ...
    public static int j(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i2) {
        if (i > 0 && edgeEffect != null && androidx.room.t.r(edgeEffect) != 0.0f) {
            int iRound = Math.round(androidx.room.t.x(edgeEffect, ((-i) * 4.0f) / i2, 0.5f) * ((-i2) / 4.0f));
            if (iRound != i) {
                edgeEffect.finish();
            }
            return i - iRound;
        }
        if (i >= 0 || edgeEffect2 == null || androidx.room.t.r(edgeEffect2) == 0.0f) {
            return i;
        }
        float f = i2;
        int iRound2 = Math.round(androidx.room.t.x(edgeEffect2, (i * 4.0f) / f, 0.5f) * (f / 4.0f));
        if (iRound2 != i) {
            edgeEffect2.finish();
        }
        return i - iRound2;
    ...
    public final void K() {
        int I = this.C.I();
        for (int i = 0; i < I; i++) {
            ((d0) this.C.H(i).getLayoutParams()).c = true;
        }
    ...
    public final void Q(p0 p0Var, androidx.core.view.r rVar) {
        p0Var.j &= -8193;
        boolean z = this.A0.h;
        androidx.localbroadcastmanager.content.b bVar = this.D;
    ...
    public final int R(int i, float f) {
        ...
        float f2 = 0.0f;
        if (edgeEffect == null || androidx.room.t.r(edgeEffect) == 0.0f) {
            EdgeEffect edgeEffect2 = this.h0;
            if (edgeEffect2 != null && androidx.room.t.r(edgeEffect2) != 0.0f) {
                boolean zCanScrollHorizontally = canScrollHorizontally(1);
                EdgeEffect edgeEffect3 = this.h0;
                if (zCanScrollHorizontally) {
                    edgeEffect3.onRelease();
                } else {
                    float fX = androidx.room.t.x(edgeEffect3, width, height);
                    if (androidx.room.t.r(this.h0) == 0.0f) {
                        this.h0.onRelease();
                    }
                    f2 = fX;
                }
            ...
            if (zCanScrollHorizontally2) {
                ...
                float f3 = -androidx.room.t.x(edgeEffect4, -width, 1.0f - height);
                if (androidx.room.t.r(this.f0) == 0.0f) {
                    this.f0.onRelease();
                }
                f2 = f3;
            }
        ...
        if (edgeEffect == null || androidx.room.t.r(edgeEffect) == 0.0f) {
            ...
            if (edgeEffect2 != null && androidx.room.t.r(edgeEffect2) != 0.0f) {
                ...
                if (zCanScrollVertically) {
                    ...
                    float fX = androidx.room.t.x(edgeEffect3, height, 1.0f - width);
                    if (androidx.room.t.r(this.i0) == 0.0f) {
                        this.i0.onRelease();
                    }
                    f2 = fX;
                }
            ...
            if (zCanScrollVertically2) {
                ...
                float f3 = -androidx.room.t.x(edgeEffect4, -height, width);
                if (androidx.room.t.r(this.g0) == 0.0f) {
                    this.g0.onRelease();
                }
                f2 = f3;
            }
  ...
  0x00fc: PHI (r7v10 boolean) = (r7v8 boolean), (r7v11 boolean) binds: [B:34:0x00e3, B:32:0x00de] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent == null || (motionEvent.getSource() & 8194) == 8194) {
                ...
                if (f < 0.0f) {
                    t();
                    z = true;
                    androidx.room.t.x(this.f0, (-f) / getWidth(), 1.0f - (y / getHeight()));
                } else {
                    z = true;
                    if (f > 0.0f) {
                        u();
                        androidx.room.t.x(this.h0, f / getWidth(), y / getHeight());
                    } else {
                        z2 = false;
                    }
                    if (f2 < 0.0f) {
                        v();
                        androidx.room.t.x(this.g0, (-f2) / getHeight(), x / getWidth());
                    } else if (f2 > 0.0f) {
                        s();
                        androidx.room.t.x(this.i0, f2 / getHeight(), 1.0f - (x / getWidth()));
    ...
    public final boolean X(EdgeEffect edgeEffect, int i, int i2) {
        ...
        float fR = androidx.room.t.r(edgeEffect) * i2;
    ...
    public final void e(p0 p0Var) {
        ...
        if (iIndexOfChild < 0) {
            com.google.firebase.platforminfo.b.f(view, "view is not a child, cannot hide ");
        } else {
            ((d3) c2Var.z).L(iIndexOfChild);
            c2Var.L(view);
        }
    }
    ...
    public final void f(String str) {
        if (!J()) {
            ...
            kotlinx.coroutines.future.a.u("Cannot call this method while RecyclerView is computing a layout or scrolling".concat(w()));
        } else {
    ...
    public final ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        kotlinx.coroutines.future.a.u("RecyclerView has no LayoutManager".concat(w()));
        return null;
    }
                ...
                if (p0VarG.o()) {
                    ...
                    if (p0Var2 == null || p0Var2.o()) {
                        ...
                        if (z8 && p0Var2 == p0VarG) {
                            ...
                            androidx.core.view.r rVarD = bVar.D(p0Var2, 4);
                            bVar.k(p0VarG, rVar2);
                            androidx.core.view.r rVarD2 = bVar.D(p0VarG, 8);
                            if (rVarD == null) {
                                int iX2 = this.C.x();
                                for (int i4 = 0; i4 < iX2; i4++) {
                                    p0 p0VarG2 = G(this.C.w(i4));
                                    if (p0VarG2 != p0VarG && E(p0VarG2) == jE) {
                                        ...
                                        if (vVar == null || !vVar.b) {
                                            ...
                                            sb.append(" \n View Holder 2:");
                                            sb.append(p0VarG);
                                            androidx.media3.exoplayer.source.t0.k(sb, w());
                                            return;
                                        }
                                        ...
                                        sb2.append(" \n View Holder 2:");
                                        sb2.append(p0VarG);
                                        androidx.media3.exoplayer.source.t0.k(sb2, w());
                                        return;
                                    }
                                }
                                ...
                                if (this.j0.a(p0Var2, p0VarG, rVarD, rVarD2)) {
                                    P();
                                }
                            }
                        }
    ...
    public final void n() {
        ...
        if (z6) {
            ...
            while (true) {
                ...
                int i5 = size + 1;
                androidx.compose.runtime.internal.c cVar3 = (androidx.compose.runtime.internal.c) tVar2.e;
        ...
        if (l0Var.k) {
            ...
            l0Var.f = z10;
            for (int i44 = 0; i44 < this.C.x(); i44++) {
                p0 p0VarG3 = G(this.C.w(i44));
    ...
    public final void onDetachedFromWindow() {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            coil3.network.g.h(((p0) arrayList.get(i2)).a);
        }
        ...
        while (i < getChildCount()) {
            ...
            ArrayList arrayList2 = coil3.network.g.s(childAt).a;
            for (int iH = kotlin.collections.q.h(arrayList2); -1 < iH; iH--) {
                ((n2) arrayList2.get(iH)).a.d();
            }
            i = i3;
        }
        ...
        if (!this.T) {
            ...
            if (c0Var != null) {
                ...
                if (actionMasked == 0) {
                    ...
                    this.o0 = y;
                    EdgeEffect edgeEffect = this.f0;
                    if (edgeEffect == null || androidx.room.t.r(edgeEffect) == 0.0f || canScrollHorizontally(-1)) {
                        z = false;
                    } else {
                        androidx.room.t.x(this.f0, 0.0f, 1.0f - (motionEvent.getY() / getHeight()));
                        z = true;
                    }
                    EdgeEffect edgeEffect2 = this.h0;
                    boolean z3 = z;
                    if (edgeEffect2 != null && androidx.room.t.r(edgeEffect2) != 0.0f && !canScrollHorizontally(1)) {
                        z3 = z;
                        z3 = z;
                        androidx.room.t.x(this.h0, 0.0f, motionEvent.getY() / getHeight());
                        z3 = true;
                    }
                    z3 = z;
                    z3 = z;
                    ...
                    EdgeEffect edgeEffect3 = this.g0;
                    boolean z4 = z3;
                    if (edgeEffect3 != null && androidx.room.t.r(edgeEffect3) != 0.0f && !canScrollVertically(-1)) {
                        z4 = z3;
                        z4 = z3;
                        androidx.room.t.x(this.g0, 0.0f, motionEvent.getX() / getWidth());
                        z4 = true;
                    }
                    z4 = z3;
                    z4 = z3;
                    ...
                    EdgeEffect edgeEffect4 = this.i0;
                    boolean z5 = z4;
                    if (edgeEffect4 != null && androidx.room.t.r(edgeEffect4) != 0.0f && !canScrollVertically(1)) {
                        z5 = z4;
                        z5 = z4;
                        androidx.room.t.x(this.i0, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
                        z5 = true;
                    }
                    if (z5 || this.k0 == 2) {
  ...
  0x01f5: PHI (r1v59 int) = (r1v43 int), (r1v63 int) binds: [B:90:0x01e0, B:95:0x01f1] A[DONT_GENERATE, DONT_INLINE]] */
                            ...
                            if (c0Var2 == null) {
                                ...
                                if (i7 != 0 || iMax2 != 0) {
                                    ...
                                    if (iMax2 == 0) {
                                        ...
                                        EdgeEffect edgeEffect3 = this.g0;
                                        if (edgeEffect3 == null || androidx.room.t.r(edgeEffect3) == 0.0f) {
                                            EdgeEffect edgeEffect4 = this.i0;
                                            if (edgeEffect4 == null || androidx.room.t.r(edgeEffect4) == 0.0f) {
                                                i2 = iMax2;
                                                iMax2 = 0;
    ...
    public final void removeDetachedView(View view, boolean z) {
        ...
        if (p0VarG != null) {
            if (p0VarG.j()) {
                ...
                sb.append(p0VarG);
                com.google.firebase.platforminfo.b.j(sb, w());
                return;
            }
        }
        view.clearAnimation();
    ...
    public void setAdapter(v vVar) {
        ...
        if (vVar2 != null) {
            vVar2.a.unregisterObserver(fVar);
            this.I.getClass();
        }
        z zVar = this.j0;
        if (zVar != null) {
        ...
        if (h0VarC.b == 0) {
            ...
            for (int i = 0; i < sparseArray.size(); i++) {
                ...
                while (it.hasNext()) {
                    coil3.network.g.h(((p0) it.next()).a);
                }
                g0Var.a.clear();
            }
        }
    ...
    public void setLayoutTransition(LayoutTransition layoutTransition) {
        if (layoutTransition == null) {
            ...
            kotlinx.coroutines.future.a.q("Providing a LayoutTransition into RecyclerView is not supported. Please use setItemAnimator() instead for animating changes to the items in this RecyclerView");
        }
    }
