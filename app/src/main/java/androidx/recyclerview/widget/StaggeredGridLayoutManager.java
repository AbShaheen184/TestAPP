...
public class StaggeredGridLayoutManager extends c0 {
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        this.o = -1;
        this.v = false;
        androidx.localbroadcastmanager.content.b bVar = new androidx.localbroadcastmanager.content.b(23, false);
        this.A = bVar;
        this.B = 2;
        this.F = new Rect();
        this.G = new s0(this);
        ...
        int i3 = b0VarH.a;
        if (i3 != 0 && i3 != 1) {
            kotlinx.coroutines.future.a.q("invalid orientation.");
            throw null;
        }
        b(null);
        if (i3 != this.s) {
    ...
    public final int A0(i0 i0Var, p pVar, l0 l0Var) {
        ...
        while (true) {
            ...
            int iB = t0Var.a.b();
            androidx.localbroadcastmanager.content.b bVar = this.A;
            int[] iArr = (int[]) bVar.y;
        ...
        while (i != iU) {
            ...
            if (bitSet.get(t0Var.e.e)) {
                ...
                if (this.w) {
                    ...
                    if (i3 < this.q.l()) {
                        ((t0) ((View) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, (ArrayList) uVar.f)).getLayoutParams()).getClass();
                        return viewT;
                    }
                } else {
                    int i4 = uVar.b;
    ...
    @Override // androidx.recyclerview.widget.c0
    public final void g(int i, int i2, l0 l0Var, androidx.media3.common.util.d dVar) {
        p pVar;
        int i3;
        int iK;
        if (this.s != 0) {
    ...
    public final int i(l0 l0Var) {
        ...
        boolean z = !this.H;
        return androidx.room.t.i(l0Var, this.q, C0(z), B0(z), this, this.H);
    }
    ...
    public final int k(l0 l0Var) {
        ...
        boolean z = !this.H;
        return androidx.room.t.k(l0Var, this.q, C0(z), B0(z), this, this.H);
    }
    ...
    public final int z0(l0 l0Var) {
        ...
        boolean z = !this.H;
        return androidx.room.t.j(l0Var, this.q, C0(z), B0(z), this, this.H, this.w);
    }
}
