...
public abstract class c0 {
    ...
    public final androidx.localbroadcastmanager.content.b c;
    ...
    public c0() {
        androidx.media3.exoplayer.hls.c cVar = new androidx.media3.exoplayer.hls.c(this, 11);
        androidx.media3.exoplayer.dash.manifest.t tVar = new androidx.media3.exoplayer.dash.manifest.t(this);
        this.c = new androidx.localbroadcastmanager.content.b(cVar);
        this.d = new androidx.localbroadcastmanager.content.b(tVar);
        this.e = false;
        this.f = false;
        this.g = true;
        this.h = true;
    ...
    public void N(int i) {
        RecyclerView recyclerView = this.b;
        if (recyclerView != null) {
            int iX = recyclerView.C.x();
            for (int i2 = 0; i2 < iX; i2++) {
                recyclerView.C.w(i2).offsetLeftAndRight(i);
            }
        }
    }
    ...
    public void O(int i) {
        ...
        if (recyclerView != null) {
            int iX = recyclerView.C.x();
            for (int i2 = 0; i2 < iX; i2++) {
                recyclerView.C.w(i2).offsetTopAndBottom(i);
            }
        }
    }
    ...
    public final void a(View view, int i, boolean z) {
        ...
        if (p0VarG.p() || p0VarG.i()) {
            ...
            if (parent == recyclerView) {
                ...
                int iB = (iIndexOfChild == -1 || d3Var.G(iIndexOfChild)) ? -1 : iIndexOfChild - d3Var.B(iIndexOfChild);
                if (i == -1) {
                    i = this.a.x();
                }
                if (iB == -1) {
                ...
                if (iB != i) {
                    c0 c0Var = this.b.J;
                    View viewT = c0Var.t(iB);
                    if (viewT == null) {
                        throw new IllegalArgumentException("Cannot move a child from non-existing index:" + iB + c0Var.b.toString());
                    }
                    c0Var.t(iB);
                    c0Var.a.t(iB);
    ...
    public final void k0(int i) {
        if (t(i) != null) {
            ...
            int iF = c2Var.F(i);
            u uVar = (u) c2Var.y;
            View childAt = uVar.a.getChildAt(iF);
            if (childAt == null) {
                return;
            }
            if (((d3) c2Var.z).J(iF)) {
    ...
    public void h(int i, androidx.media3.common.util.d dVar) {
    }

    public void W(i0 i0Var, l0 l0Var, View view, androidx.core.view.accessibility.d dVar) {
    }

    public void g(int i, int i2, l0 l0Var, androidx.media3.common.util.d dVar) {
    }
}
