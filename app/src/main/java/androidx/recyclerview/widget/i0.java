...
public final class i0 {
    ...
    public final void g() {
        ...
        arrayList.clear();
        if (RecyclerView.W0) {
            androidx.media3.common.util.d dVar = this.h.z0;
            int[] iArr = dVar.c;
            if (iArr != null) {
                Arrays.fill(iArr, -1);
            }
    ...
    public final void j(p0 p0Var) {
        ...
        int i4;
        RecyclerView recyclerView = this.h;
        androidx.media3.common.util.d dVar = recyclerView.z0;
        boolean zI = p0Var.i();
        View view = p0Var.a;
        boolean z3 = false;
        boolean z4 = true;
        ...
        if (p0Var.j()) {
            ...
            sb2.append(p0Var);
            com.google.firebase.platforminfo.b.j(sb2, recyclerView.w());
            return;
        }
        if (p0Var.o()) {
            kotlinx.coroutines.future.a.q("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.".concat(recyclerView.w()));
            return;
        }
        if ((p0Var.j & 16) == 0) {
    ...
    public final void k(View view) {
        ...
        if (p0VarG.f() && !p0VarG.h() && !recyclerView.I.b) {
            kotlinx.coroutines.future.a.q("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.".concat(recyclerView.w()));
            return;
        }
        p0VarG.n = this;
        p0VarG.o = false;
                ...
                while (true) {
                    if (i5 < size4) {
                        ...
                        if (view3 != null) {
                            ...
                            if (iIndexOfChild >= 0) {
                                com.google.firebase.platforminfo.b.f(view3, "view is not a child, cannot hide ");
                                return null;
                            }
                            if (d3Var.G(iIndexOfChild)) {
                                com.google.firebase.platforminfo.b.p(view3, "trying to unhide a view that was not hidden");
                                return null;
                            }
                            d3Var.z(iIndexOfChild);
                            c2Var.d0(view3);
                            c2 c2Var2 = recyclerView.C;
                            d3Var2 = (d3) c2Var2.z;
                            iIndexOfChild2 = ((u) c2Var2.y).a.indexOfChild(view3);
                            if (iIndexOfChild2 == -1 && !d3Var2.G(iIndexOfChild2)) {
                                iB = iIndexOfChild2 - d3Var2.B(iIndexOfChild2);
                            } else {
                                iB = -1;
                            }
                            if (iB != -1) {
                                ...
                                sb.append(p0VarG);
                                androidx.media3.exoplayer.source.t0.k(sb, recyclerView.w());
                                return null;
                            }
                            recyclerView.C.t(iB);
                            k(view3);
                ...
                if (i5 < size4) {
                    ...
                    if (view3 != null) {
                        ...
                        if (iB != -1) {
                            ...
                            sb2.append(p0VarG);
                            androidx.media3.exoplayer.source.t0.k(sb2, recyclerView.w());
                            return null;
                        }
                        recyclerView.C.t(iB);
                        k(view3);
