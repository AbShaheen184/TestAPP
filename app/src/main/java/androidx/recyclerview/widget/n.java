...
public final class n implements Runnable {
    ...
    public static p0 c(RecyclerView recyclerView, int i, long j) {
        int I = recyclerView.C.I();
        for (int i2 = 0; i2 < I; i2++) {
            p0 p0VarG = RecyclerView.G(recyclerView.C.H(i2));
    ...
    public final void b(long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            androidx.media3.common.util.d dVar = recyclerView3.z0;
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (recyclerView4.getWindowVisibility() == 0) {
                androidx.media3.common.util.d dVar2 = recyclerView4.z0;
                int iAbs = Math.abs(dVar2.b) + Math.abs(dVar2.a);
                for (int i5 = 0; i5 < dVar2.d * 2; i5 += 2) {
        ...
        for (int i7 = 0; i7 < arrayList.size() && (recyclerView = (mVar = (m) arrayList.get(i7)).d) != null; i7++) {
            ...
            if (p0VarC != null && p0VarC.b != null && p0VarC.e() && !p0VarC.f() && (recyclerView2 = (RecyclerView) p0VarC.b.get()) != null) {
                if (recyclerView2.a0 && recyclerView2.C.I() != 0) {
                ...
                androidx.media3.common.util.d dVar3 = recyclerView2.z0;
                ...
                if (dVar3.d != 0) {
                    try {
                        ...
                        l0Var.h = false;
                        l0Var.i = false;
                        for (int i9 = 0; i9 < dVar3.d * 2; i9 += 2) {
                            c(recyclerView2, dVar3.c[i9], j);
                        }
                        Trace.endSection();
                    } catch (Throwable th) {
