...
public final class e {
    ...
    public final Bundle a(String str) {
        ...
        if (!aVar.g) {
            kotlinx.coroutines.future.a.u("You can 'consumeRestoredStateForKey' only after the corresponding component has moved to the 'CREATED' state");
            return null;
        }
    ...
    public final void d() {
        if (!this.a.h) {
            kotlinx.coroutines.future.a.u("Can not perform this action after onSaveInstanceState");
            return;
        }
        a aVar = this.b;
        if (aVar == null) {
