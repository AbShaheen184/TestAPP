...
public final class a extends m {
    ...
    @Override // androidx.transition.m
    public final void C(okhttp3.internal.platform.android.g gVar) {
        this.b0 |= 8;
        int size = this.X.size();
        for (int i = 0; i < size; i++) {
            ((m) this.X.get(i)).C(gVar);
        }
    }
    ...
    @Override // androidx.transition.m
    public final void E(com.google.firebase.heartbeatinfo.e eVar) {
        super.E(eVar);
        this.b0 |= 4;
        if (this.X != null) {
            for (int i = 0; i < this.X.size(); i++) {
                ((m) this.X.get(i)).E(eVar);
            }
        }
    }
    ...
    @Override // androidx.transition.m
    public final void k(ViewGroup viewGroup, com.google.firebase.messaging.n nVar, com.google.firebase.messaging.n nVar2, ArrayList arrayList, ArrayList arrayList2) {
        long j = this.y;
        int size = this.X.size();
        for (int i = 0; i < size; i++) {
            ...
            mVar.k(viewGroup, nVar, nVar2, arrayList, arrayList2);
        }
    }
