...
public abstract class m implements Cloneable {
    ...
    public static final com.google.firebase.heartbeatinfo.e V = new com.google.firebase.heartbeatinfo.e(18);
    ...
    public com.google.firebase.messaging.n D = new com.google.firebase.messaging.n(15);
    public com.google.firebase.messaging.n E = new com.google.firebase.messaging.n(15);
    public a F = null;
    ...
    public com.google.firebase.heartbeatinfo.e S = V;

    public static void b(com.google.firebase.messaging.n nVar, View view, t tVar) {
        androidx.collection.f fVar = (androidx.collection.f) nVar.y;
        androidx.collection.f fVar2 = (androidx.collection.f) nVar.B;
        SparseArray sparseArray = (SparseArray) nVar.z;
        androidx.collection.s sVar = (androidx.collection.s) nVar.A;
        fVar.put(view, tVar);
        int id = view.getId();
        if (id >= 0) {
    ...
    public void E(com.google.firebase.heartbeatinfo.e eVar) {
        if (eVar == null) {
            this.S = V;
        } else {
            this.S = eVar;
    ...
    public m clone() {
        try {
            ...
            mVar.D = new com.google.firebase.messaging.n(15);
            mVar.E = new com.google.firebase.messaging.n(15);
            mVar.H = null;
            mVar.I = null;
            mVar.P = this;
            mVar.Q = null;
    ...
    public void k(ViewGroup viewGroup, com.google.firebase.messaging.n nVar, com.google.firebase.messaging.n nVar2, ArrayList arrayList, ArrayList arrayList2) {
        int i;
        int i2;
        View view;
        t tVar;
                ...
                if (animatorJ != null) {
                    ...
                    if (tVar4 != null) {
                        ...
                        if (strArrP != null && strArrP.length > 0) {
                            tVar2 = new t(view);
                            t tVar5 = (t) ((androidx.collection.f) nVar2.y).get(view);
                            i = size;
                            if (tVar5 != null) {
                                int i4 = 0;
    ...
    public void C(okhttp3.internal.platform.android.g gVar) {
    }
