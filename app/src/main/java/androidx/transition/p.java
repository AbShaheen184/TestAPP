...
public final class p implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    ...
    public final boolean onPreDraw() {
        ...
        int i12;
        View view6;
        com.google.firebase.messaging.n nVar4;
        Iterator it;
        m mVar2 = this.e;
        ...
        if (arrayList3 != null) {
            ...
            nVar = mVar2.D;
            nVar2 = mVar2.E;
            fVar = new androidx.collection.f((androidx.collection.f) nVar.y);
            fVar2 = new androidx.collection.f((androidx.collection.f) nVar2.y);
            i2 = 0;
            while (true) {
                iArr = mVar2.G;
                if (i2 < iArr.length) {
                ...
                if (i7 != z3) {
                    ...
                    nVar3 = nVar2;
                    z2 = z3;
                    fVar3 = (androidx.collection.f) nVar.B;
                    androidx.collection.f fVar4 = (androidx.collection.f) nVar3.B;
                    i9 = fVar3.z;
                    ...
                    nVar3 = nVar2;
                    SparseArray sparseArray2 = (SparseArray) nVar3.z;
                    ...
                    sVar = (androidx.collection.s) nVar.A;
                    androidx.collection.s sVar2 = (androidx.collection.s) nVar2.A;
                    iG = sVar.g();
                    i12 = i;
                    while (i12 < iG) {
        ...
        while (true) {
            ...
            if (i7 != z3) {
                ...
                z2 = z3;
                fVar3 = (androidx.collection.f) nVar.B;
                androidx.collection.f fVar5 = (androidx.collection.f) nVar3.B;
                i9 = fVar3.z;
                while (i10 < i9) {
                    view2 = (View) fVar3.i(i10);
                    if (view2 == null) {
                ...
                sparseArray = (SparseArray) nVar.z;
                nVar3 = nVar2;
                SparseArray sparseArray3 = (SparseArray) nVar3.z;
                size = sparseArray.size();
                while (i11 < size) {
                    view4 = (View) sparseArray.valueAt(i11);
                    if (view4 == null) {
                ...
                sVar = (androidx.collection.s) nVar.A;
                androidx.collection.s sVar3 = (androidx.collection.s) nVar2.A;
                iG = sVar.g();
                i12 = i;
                while (i12 < iG) {
                    view6 = (View) sVar.h(i12);
