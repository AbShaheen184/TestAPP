...
public abstract class a {
    ...
    public final c h() {
        ...
        try {
            ...
            t0.j("VersionedParcel encountered ClassNotFoundException", e);
            return null;
        } catch (IllegalAccessException e2) {
            t0.j("VersionedParcel encountered IllegalAccessException", e2);
            return null;
        } catch (NoSuchMethodException e3) {
            t0.j("VersionedParcel encountered NoSuchMethodException", e3);
            return null;
        } catch (InvocationTargetException e4) {
            if (e4.getCause() instanceof RuntimeException) {
                throw ((RuntimeException) e4.getCause());
            }
            t0.j("VersionedParcel encountered InvocationTargetException", e4);
            return null;
        }
    }
    ...
    public final void l(c cVar) {
        ...
        try {
            ...
            t0.j(cVar.getClass().getSimpleName().concat(" does not have a Parcelizer"), e5);
        }
    }
}
