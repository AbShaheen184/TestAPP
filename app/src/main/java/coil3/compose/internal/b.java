...
public final class b extends w0 {
    ...
    public b(coil3.request.g gVar, p pVar, coil3.compose.b bVar, l lVar, l lVar2, androidx.compose.ui.e eVar, j jVar, m mVar, String str) {
        this.b = gVar;
        this.c = pVar;
        this.d = bVar;
        this.e = lVar;
    ...
    public final q e() {
        ...
        coil3.compose.c cVar = new coil3.compose.c(pVar, gVar, bVar);
        i iVar = new i(cVar);
        iVar.J = this.e;
        iVar.K = this.f;
        iVar.L = this.h;
    ...
    public final void g(q qVar) {
        ...
        p pVar = this.c;
        coil3.request.g gVar = this.b;
        coil3.compose.c cVar2 = new coil3.compose.c(pVar, gVar, bVar);
        i iVar = cVar.R;
        iVar.J = this.e;
        iVar.K = this.f;
        j jVar = this.h;
        ...
        if (!kotlin.jvm.internal.l.a(str, str2)) {
            cVar.P = str2;
            androidx.compose.ui.node.l.m(cVar);
        }
        boolean zA2 = kotlin.jvm.internal.l.a(oVar, cVar.Q);
        if (!zA || !zA2) {
            androidx.compose.ui.node.l.l(cVar);
        }
        androidx.compose.ui.node.l.k(cVar);
    }

    public final int hashCode() {
        int iHashCode = (this.e.hashCode() + ((this.d.hashCode() + ((this.c.hashCode() + (this.b.hashCode() * 31)) * 31)) * 31)) * 31;
        l lVar = this.f;
        int iH = androidx.privacysandbox.ads.adservices.java.internal.a.h(androidx.privacysandbox.ads.adservices.java.internal.a.c(1.0f, (this.h.hashCode() + ((this.g.hashCode() + androidx.privacysandbox.ads.adservices.java.internal.a.d(1, (iHashCode + (lVar == null ? 0 : lVar.hashCode())) * 31, 31)) * 31)) * 31, 961), 31, true);
        m mVar = this.i;
        int iHashCode2 = (iH + (mVar == null ? 0 : mVar.hashCode())) * 31;
        String str = this.j;
