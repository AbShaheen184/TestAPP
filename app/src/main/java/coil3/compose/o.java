...
public final class o implements coil3.size.i, c0 {
    ...
    public final r0 c(s0 s0Var, p0 p0Var, long j) {
        g(j);
        d1 d1VarF = p0Var.F(j);
        return s0Var.q(d1VarF.e, d1VarF.y, x.e, new androidx.compose.foundation.layout.j(d1VarF, 11));
    }
        ...
        if (i2 == 0) {
            ...
            if (androidx.compose.ui.unit.a.k(this.b)) {
                ...
                try {
                    nVar.e = zVar2;
                    nVar.A = 1;
                    CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(kotlin.coroutines.intrinsics.h.f(nVar), 1);
