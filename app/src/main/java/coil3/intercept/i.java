...
public final class i {
    ...
    public j a() {
        ...
        int i = this.c;
        if (i == 0) {
            kotlinx.coroutines.future.a.u("The delivery method of the video stream has been set as null, which is not allowed. Pass a valid one instead with setDeliveryMethod.");
            return null;
        }
        Boolean bool = (Boolean) this.f;
        if (bool == null) {
            kotlinx.coroutines.future.a.u("The video stream has been not set as a video-only stream or as a video stream with embedded audio. Please specify this information with setIsVideoOnly.");
            return null;
        }
        ...
        kotlinx.coroutines.future.a.u("The resolution of the video stream has been not set. Please specify it with setResolution (use an empty string if you are not able to get it).");
        return null;
    }
    ...
    public Object c(kotlin.coroutines.jvm.internal.c cVar) throws Throwable {
        ...
        if (gVarB.a != gVar.a) {
            k.k(fVar, "' cannot modify the request's context.", "Interceptor '");
            return null;
        }
        if (gVarB.b == l.a) {
            k.k(fVar, "' cannot set the request's data to null.", "Interceptor '");
            return null;
        }
        if (gVarB.c != gVar.c) {
            k.k(fVar, "' cannot modify the request's target.", "Interceptor '");
            return null;
        }
        if (gVarB.o == gVar.o) {
            return jVar;
        }
        k.k(fVar, "' cannot modify the request's size resolver. Use `Interceptor.Chain.withSize` instead.", "Interceptor '");
        return null;
    }
}
