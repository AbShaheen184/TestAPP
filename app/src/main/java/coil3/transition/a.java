...
public final class a extends Drawable implements Drawable.Callback, Animatable {
    ...
    public final void b(Drawable drawable, Rect rect) {
        ...
        double dI = com.google.firebase.b.i(intrinsicWidth, intrinsicHeight, iWidth, iHeight, this.e, h.c);
        double d = 2;
        int iG = kotlin.math.a.G((((double) iWidth) - (((double) intrinsicWidth) * dI)) / d);
        int iG2 = kotlin.math.a.G((((double) iHeight) - (dI * ((double) intrinsicHeight))) / d);
    ...
    public final void draw(Canvas canvas) {
        ...
        double dB = i0.b(dUptimeMillis, 0.0d, 1.0d);
        int i2 = this.E;
    ...
    public final void setAlpha(int i) {
        if (i < 0 || i >= 256) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Invalid alpha: "));
        } else {
            this.E = i;
        }
    }
