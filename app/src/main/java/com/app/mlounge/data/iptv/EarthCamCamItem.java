...
final class EarthCamCamItem {
    ...
    public String toString() {
        ...
        String str9 = this.thumbnailLarge;
        String str10 = this.url;
        StringBuilder sbQ = androidx.compose.runtime.j.q("EarthCamCamItem(id=", str, ", title=", str2, ", city=");
        androidx.room.b0.i(sbQ, str3, ", country=", str4, ", state=");
        androidx.room.b0.i(sbQ, str5, ", stateFull=", str6, ", category=");
        androidx.room.b0.i(sbQ, str7, ", thumbnail=", str8, ", thumbnailLarge=");
        return androidx.compose.runtime.j.n(sbQ, str9, ", url=", str10, ")");
    }
}
