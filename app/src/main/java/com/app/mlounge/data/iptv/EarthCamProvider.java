...
public final class EarthCamProvider {
    ...
    public static final class AnonymousClass2 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
        ...
        /* JADX WARN: Code duplicated, block: B:21:0x00b5 A[Catch: Exception -> 0x0048, PHI: r1 r7 r8 r9 r10 r15
  0x00b5: PHI (r1v11 int) = (r1v12 int), (r1v14 int) binds: [B:19:0x00b2, B:10:0x0044] A[DONT_GENERATE, DONT_INLINE]
  0x00b5: PHI (r7v4 int) = (r7v5 int), (r7v6 int) binds: [B:19:0x00b2, B:10:0x0044] A[DONT_GENERATE, DONT_INLINE]
  0x00b5: PHI (r8v5 java.util.Iterator) = (r8v6 java.util.Iterator), (r8v10 java.util.Iterator) binds: [B:19:0x00b2, B:10:0x0044] A[DONT_GENERATE, DONT_INLINE]
  0x00b5: PHI (r9v3 java.util.Set) = (r9v4 java.util.Set), (r9v6 java.util.Set) binds: [B:19:0x00b2, B:10:0x0044] A[DONT_GENERATE, DONT_INLINE]
  0x00b5: PHI (r10v3 java.util.List) = (r10v4 java.util.List), (r10v6 java.util.List) binds: [B:19:0x00b2, B:10:0x0044] A[DONT_GENERATE, DONT_INLINE]
  0x00b5: PHI (r15v12 java.lang.Object) = (r15v21 java.lang.Object), (r15v0 java.lang.Object) binds: [B:19:0x00b2, B:10:0x0044] A[DONT_GENERATE, DONT_INLINE], TryCatch #0 {Exception -> 0x0048, blocks: (B:18:0x0095, B:21:0x00b5, B:22:0x00bb, B:24:0x00c1, B:26:0x00cd, B:27:0x00d1, B:29:0x00d7, B:10:0x0044), top: B:40:0x0044 }] */
        /* JADX WARN: Code duplicated, block: B:24:0x00c1 A[Catch: Exception -> 0x0048, TryCatch #0 {Exception -> 0x0048, blocks: (B:18:0x0095, B:21:0x00b5, B:22:0x00bb, B:24:0x00c1, B:26:0x00cd, B:27:0x00d1, B:29:0x00d7, B:10:0x0044), top: B:40:0x0044 }] */
        /* JADX WARN: Code duplicated, block: B:26:0x00cd A[Catch: Exception -> 0x0048, TryCatch #0 {Exception -> 0x0048, blocks: (B:18:0x0095, B:21:0x00b5, B:22:0x00bb, B:24:0x00c1, B:26:0x00cd, B:27:0x00d1, B:29:0x00d7, B:10:0x0044), top: B:40:0x0044 }] */
        /* JADX WARN: Code duplicated, block: B:34:0x0108  */
        /* JADX WARN: Code duplicated, block: B:37:0x011f  */
        /* JADX WARN: Code duplicated, block: B:44:0x00d7 A[SYNTHETIC] */
        /* JADX WARN: Code duplicated, block: B:46:0x00bb A[SYNTHETIC] */
    ...
    public static final class C00062 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                com.app.mlounge.util.a.a("D", EarthCamProvider.TAG, "Fetching from API: https://chq-api.ddns.me/api/earthcam");
                ...
                try {
                    if (g0VarE.N) {
                        ...
                        if (j0Var != null && (strA = j0Var.A()) != null) {
                            EarthCamApiResponse earthCamApiResponse = (EarthCamApiResponse) earthCamProvider.gson.d(EarthCamApiResponse.class, strA);
                            if (earthCamApiResponse.getStatus() == 200 && !earthCamApiResponse.getData().isEmpty()) {
                                com.app.mlounge.util.a.a("D", EarthCamProvider.TAG, "Fetched " + earthCamApiResponse.getData().size() + " cams from API");
                                List<IptvChannel> data = earthCamApiResponse.getData();
                                g0VarE.close();
                                return data;
                            }
                            com.app.mlounge.util.a.a("W", EarthCamProvider.TAG, "API returned status " + earthCamApiResponse.getStatus() + ", " + earthCamApiResponse.getData().size() + " cams");
                        }
                    } else {
                        com.app.mlounge.util.a.a("W", EarthCamProvider.TAG, "API HTTP " + g0VarE.A);
                    }
                    g0VarE.close();
                    return wVar;
                } catch (Throwable th) {
                ...
                androidx.room.b0.h("Error fetching from API: ", e.getMessage(), "E", EarthCamProvider.TAG);
                return wVar;
            }
        }
    }
    ...
    public static final class C00072 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                Context context = com.app.mlounge.util.a.a;
                com.app.mlounge.util.a.a("D", EarthCamProvider.TAG, "Resolving stream: " + this.$pageUrl);
                okhttp3.a0 a0Var = new okhttp3.a0();
                ...
                try {
                    if (g0VarE.N) {
                        j0 j0Var = g0VarE.D;
                        if (j0Var != null && (strA = j0Var.A()) != null) {
                            kotlin.text.g gVarA = earthCamProvider.domainRegex.a(strA);
                            kotlin.text.g gVarA2 = earthCamProvider.pathRegex.a(strA);
                            if (gVarA != null && gVarA2 != null) {
                                String strConcat = kotlin.text.r.s((String) ((d0) gVarA.a()).get(1), "\\/", "/", false).concat(kotlin.text.r.s((String) ((d0) gVarA2.a()).get(1), "\\/", "/", false));
                                com.app.mlounge.util.a.a("D", EarthCamProvider.TAG, "Resolved: ".concat(strConcat));
                                EarthCamStreamResult earthCamStreamResult = new EarthCamStreamResult(strConcat, kotlin.collections.c0.k(new kotlin.k("Origin", "https://www.earthcam.com"), new kotlin.k("Referer", "https://www.earthcam.com/")));
                                g0VarE.close();
                                return earthCamStreamResult;
                            }
                            com.app.mlounge.util.a.a("W", EarthCamProvider.TAG, "Could not find stream fields in page");
                        }
                    } else {
                        com.app.mlounge.util.a.a("W", EarthCamProvider.TAG, "Resolve HTTP " + g0VarE.A);
                    }
                    g0VarE.close();
                    return null;
                } catch (Throwable th) {
                ...
                Context context2 = com.app.mlounge.util.a.a;
                androidx.room.b0.h("Error resolving stream: ", e.getMessage(), "E", EarthCamProvider.TAG);
                return null;
            }
        }
    }
    ...
    public final List<IptvChannel> fetchSource(String str) {
        ...
        try {
            ...
            j0 j0Var = g0VarE.D;
            if (j0Var != null && (strA = j0Var.A()) != null) {
                EarthCamSourceResponse earthCamSourceResponse = (EarthCamSourceResponse) this.gson.d(EarthCamSourceResponse.class, strA);
                if (kotlin.jvm.internal.l.a(earthCamSourceResponse.getStatus(), "200")) {
                    ...
                    if ((data != null ? data.getCamItems() : null) != null) {
                        ...
                        for (EarthCamCamItem earthCamCamItem : camItems) {
                            ...
                            if (title == null || (string = kotlin.text.k.g0(title).toString()) == null || (url = earthCamCamItem.getUrl()) == null || (string2 = kotlin.text.k.g0(url).toString()) == null) {
                                iptvChannel = null;
                            } else {
