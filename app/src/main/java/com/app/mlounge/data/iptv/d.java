    ...
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        if (i == 1) {
            ...
            if (i == 2) {
                ...
                if (!list.isEmpty()) {
                    lVar = this.this$0;
                    arrayList2 = new ArrayList(kotlin.collections.r.p(list, 10));
                    it = list.iterator();
                    while (it.hasNext()) {
                        arrayList2.add(l.f(lVar, (IptvChannel) it.next()));
                    }
                    iVar = this.this$0.channelDao;
                    this.L$0 = null;
                    this.L$1 = null;
                    this.L$2 = null;
                    this.L$3 = xVar2;
                    ...
                    this.L$5 = null;
                    this.label = 3;
                    if (((com.app.mlounge.data.local.dao.j) iVar).b(arrayList2, this) != aVar) {
                        xVar3 = xVar2;
                    }
                    return aVar;
                }
                ...
                com.app.mlounge.util.a.a("D", "CustomIPTV", "M3U: " + xVar2.e + " channels saved to DB");
