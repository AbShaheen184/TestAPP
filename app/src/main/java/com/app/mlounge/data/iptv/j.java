...
public final class j extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public j(List list, kotlin.jvm.internal.x xVar, l lVar, kotlin.jvm.functions.l lVar2, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.$batch = list;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        j jVar = new j(this.$batch, this.$totalCount, this.this$0, this.$onProgress, dVar);
        jVar.L$0 = obj;
        return jVar;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((j) create((IptvChannel) obj, (kotlin.coroutines.d) obj2)).invokeSuspend(kotlin.y.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (this.$batch.size() >= 1000) {
                ...
                com.app.mlounge.data.local.dao.i iVar = this.this$0.channelDao;
                this.L$0 = null;
                this.L$1 = null;
                this.label = 1;
                Object objB = ((com.app.mlounge.data.local.dao.j) iVar).b(arrayList, this);
        ...
        kotlin.a.e(obj);
        this.$batch.clear();
        this.$onProgress.invoke("Synced " + this.$totalCount.e + " channels...");
        return kotlin.y.a;
    }
}
