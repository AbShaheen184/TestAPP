...
public final class l {
    ...
    public l(Context context, okhttp3.y yVar, com.app.mlounge.data.local.dao.i iVar) {
    ...
    public static final String e(l lVar, String str) throws Exception {
        ...
        throw new Exception(androidx.privacysandbox.ads.adservices.java.internal.a.n(g0VarE.A, "HTTP "));
    }
    ...
    public static String g(String str, String str2) {
        String strH0 = kotlin.text.k.h0(str, '/');
        if (!kotlin.text.r.u(strH0, "http://", false) && !kotlin.text.r.u(strH0, "https://", false)) {
            strH0 = "http://".concat(strH0);
        }
        return (str2 == null || kotlin.text.k.J(str2)) ? strH0 : androidx.compose.runtime.j.j(strH0, ":", str2);
    }

    public final Object h(c1 c1Var) {
        new File(this.playlistDir, CHANNELS_FILE).delete();
        new File(this.playlistDir, EPG_FILE).delete();
        Object objA = ((com.app.mlounge.data.local.dao.j) this.channelDao).a(SLUG, c1Var);
    ...
    public final Object k(String str, String str2, String str3, String str4, com.app.mlounge.ui.viewmodel.h hVar, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        try {
            ...
            androidx.room.b0.h("Xtream EPG failed: ", e.getMessage(), "W", TAG);
            ...
            try {
                ...
                while (aVar.a0()) {
                    ...
                    if (set.contains(strH0)) {
                        ...
                        eVar.getClass();
                        linkedHashMap.put(strH0, eVar.c(aVar, new com.google.gson.reflect.a(typeB)));
                    } else {
                        aVar.t0();
                    }
                }
                ...
                try {
                    ...
                    dagger.internal.d.b(aVar, th);
                    throw th2;
                }
            }
        } catch (Exception e) {
            Context context = com.app.mlounge.util.a.a;
            androidx.room.b0.h("Failed to load EPG for channels: ", e.getMessage(), "E", TAG);
            return linkedHashMap;
        }
    }
    ...
    public final void n(LinkedHashMap linkedHashMap) throws IOException {
        ...
        try {
            ...
            eVar.getClass();
            try {
                eVar.i(linkedHashMap, typeB, eVar.f(bufferedWriter));
            ...
            try {
                ...
                dagger.internal.d.b(bufferedWriter, th);
                throw th2;
            }
        }
    }
