 ...
 binds: [B:72:0x0112, B:93:0x014a, B:89:0x013f, B:88:0x013d, B:84:0x0132, B:85:0x0134, B:83:0x0130, B:79:0x0125, B:78:0x0123, B:75:0x011b, B:33:0x0084, B:51:0x00b5, B:47:0x00aa, B:43:0x009f, B:39:0x0094, B:36:0x008d, B:12:0x0049, B:26:0x006c, B:27:0x006e, B:28:0x0070, B:25:0x006a, B:21:0x0062] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static LinkedHashMap a(InputStream inputStream) {
            ...
            while (eventType != 1) {
                ...
                if (eventType != 2) {
                    if (eventType == 3) {
                            ...
                            switch (lowerCase2.hashCode()) {
                                case -968778980:
                                    if (lowerCase2.equals("programme")) {
                                        if (attributeValue != null && lB != null && lB2 != null && str != null && !kotlin.text.k.J(str) && lB2.longValue() > j && lB.longValue() < j3) {
                        ...
                        if (text == null || (string = kotlin.text.k.g0(text).toString()) == null) {
                            string = "";
                        }
                        if (z && str == null) {
                            str = string;
        ...
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            linkedHashMap2.put(entry.getKey(), kotlin.collections.p.W((List) entry.getValue(), new androidx.constraintlayout.core.e(9)));
        }
    ...
    public static Long b(String str) {
        ...
        try {
            try {
                ...
                Date date2 = sdfNoTz.parse(kotlin.text.k.e0(14, string));
                if (date2 != null) {
