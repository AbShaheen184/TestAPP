...
public final class a {
    ...
    public final int hashCode() {
        int iG = androidx.privacysandbox.ads.adservices.java.internal.a.g(androidx.privacysandbox.ads.adservices.java.internal.a.g(androidx.privacysandbox.ads.adservices.java.internal.a.g(androidx.privacysandbox.ads.adservices.java.internal.a.g(Long.hashCode(this.a) * 31, 31, this.b), 31, this.c), 31, this.d), 31, this.e);
        String str = this.f;
        ...
        String str4 = this.i;
        int iE = androidx.privacysandbox.ads.adservices.java.internal.a.e(androidx.privacysandbox.ads.adservices.java.internal.a.e(androidx.privacysandbox.ads.adservices.java.internal.a.d(this.k, androidx.privacysandbox.ads.adservices.java.internal.a.g((iHashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31, 31, this.j), 31), 31, this.l), 31, this.m);
        String str5 = this.n;
        int iHashCode4 = (iE + (str5 == null ? 0 : str5.hashCode())) * 31;
        String str6 = this.o;
        int iE2 = androidx.privacysandbox.ads.adservices.java.internal.a.e((iHashCode4 + (str6 == null ? 0 : str6.hashCode())) * 31, 31, this.p);
        Long l = this.q;
        int iD = androidx.privacysandbox.ads.adservices.java.internal.a.d(this.t, androidx.privacysandbox.ads.adservices.java.internal.a.d(this.s, androidx.privacysandbox.ads.adservices.java.internal.a.d(this.r, (iE2 + (l == null ? 0 : l.hashCode())) * 31, 31), 31), 31);
        String str7 = this.u;
        return iD + (str7 != null ? str7.hashCode() : 0);
    }
    ...
    public final String toString() {
        ...
        sb.append(", url=");
        sb.append(this.b);
        b0.i(sb, ", fileName=", this.c, ", title=", this.d);
        b0.i(sb, ", contentType=", this.e, ", contentId=", this.f);
        b0.i(sb, ", posterPath=", this.g, ", quality=", this.h);
        b0.i(sb, ", size=", this.i, ", status=", this.j);
        sb.append(", progress=");
        sb.append(this.k);
        ...
        sb.append(this.m);
        sb.append(", filePath=");
        b0.i(sb, this.n, ", headers=", this.o, ", addedAt=");
        sb.append(this.p);
