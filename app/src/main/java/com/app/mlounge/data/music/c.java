...
public final class c implements d {
    ...
    public c(y yVar) {
        yVar.getClass();
        androidx.collection.internal.b bVar = new androidx.collection.internal.b(4);
        this.a = bVar;
        x xVarA = yVar.a();
        xVarA.k = bVar;
        this.b = new y(xVarA);
    ...
    public static final ArrayList h(c cVar, org.jsoup.nodes.g gVar) {
        ...
        for (j jVar : eVarB0) {
            ...
            if (jVarC0 != null) {
                ...
                String str = (jVarC1 == null || (strD2 = jVarC1.d0()) == null || (string2 = k.g0(strD2).toString()) == null) ? "Unknown" : string2;
                j jVarC2 = jVar.c0("img.album_report__image");
                String strB = jVarC2 != null ? jVarC2.b("src") : null;
                j jVarK = k(jVar, "album_report__artist");
                String str2 = (jVarK == null || (strD1 = jVarK.d0()) == null || (string = k.g0(strD1).toString()) == null) ? "Unknown" : string;
                j jVarK2 = k(jVar, "album_report__date");
                if (jVarK2 != null && (strD0 = jVarK2.d0()) != null) {
                    musicAlbum = k.g0(strD0).toString();
                }
    ...
    public static final MusicTrack i(c cVar, j jVar, String str, String str2, String str3) {
        ...
        if (jVarC2 == null || (strD4 = jVarC2.d0()) == null || (string = k.g0(strD4).toString()) == null) {
            j jVarC3 = jVar.c0("td.song__name--search");
            string = (jVarC3 == null || (strD0 = jVarC3.d0()) == null) ? "Unknown" : k.g0(strD0).toString();
        }
        String str7 = string;
        j jVarC4 = jVar.c0("[itemprop=byArtist]");
        if (jVarC4 == null || (strD3 = jVarC4.d0()) == null || (string3 = k.g0(strD3).toString()) == null) {
            j jVarC5 = jVar.c0("td.song__artist--search");
            if (jVarC5 != null && (strD1 = jVarC5.d0()) != null) {
                str = k.g0(strD1).toString();
            }
            str4 = str;
        } else {
            str4 = string3;
        ...
        String str8 = (jVarC6 == null || (strD2 = jVarC6.d0()) == null || (string2 = k.g0(strD2).toString()) == null) ? str2 : string2;
        ...
        if (strD6 != null) {
            int i = 0;
            if (r.u(strD6, "PT", false)) {
                try {
                    Pattern patternCompile = Pattern.compile("(\\d+)M");
                    patternCompile.getClass();
                    Matcher matcher = patternCompile.matcher(strD6);
                    matcher.getClass();
                    kotlin.text.g gVarA = kotlin.coroutines.g.a(matcher, 0, strD6);
                    int i2 = (gVarA == null || (str6 = (String) ((d0) gVarA.a()).get(1)) == null) ? 0 : Integer.parseInt(str6);
                    Pattern patternCompile2 = Pattern.compile("(\\d+)S");
                    patternCompile2.getClass();
                    Matcher matcher2 = patternCompile2.matcher(strD6);
                    matcher2.getClass();
                    kotlin.text.g gVarA2 = kotlin.coroutines.g.a(matcher2, 0, strD6);
                    if (gVarA2 != null && (str5 = (String) ((d0) gVarA2.a()).get(1)) != null) {
    ...
    public static org.jsoup.nodes.g j(c cVar, String str) {
        try {
            ...
            if (g0VarE.N) {
                return e0.a(g0VarE.D.A(), str);
            }
            return null;
        } catch (Exception e) {
            Context context = com.app.mlounge.util.a.a;
            com.app.mlounge.util.a.d("MusicMp3Source", "Fetch failed: ".concat(str), e);
            return null;
        }
    }
