...
public final class l1 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public l1(String str, String str2, m1 m1Var, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.$mediaType = str;
        this.$tmdbId = str2;
        this.this$0 = m1Var;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        return new l1(this.$mediaType, this.$tmdbId, this.this$0, dVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            try {
                ...
                if (jVar == null || (gVarL = jVar.l("imdb_id")) == null || (strH = gVarL.h()) == null || !kotlin.text.r.u(strH, "tt", false)) {
                    strH = null;
                }
                g0VarE.close();
                return strH;
