...
public final class o1 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public o1(p1 p1Var, String str, String str2, Integer num, Integer num2, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.this$0 = p1Var;
        this.$tmdbId = str;
        this.$mediaType = str2;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        return new o1(this.this$0, this.$tmdbId, this.$mediaType, this.$season, this.$episode, dVar);
    }
        ...
        if (str8 != null) {
            try {
                ...
                if (g0VarE.N && (j0Var = g0VarE.D) != null && (strA = j0Var.A()) != null && (jVar = (com.google.gson.j) this.this$0.gson.d(com.google.gson.j.class, strA)) != null && (fVarM = jVar.m("streams")) != null) {
                    ...
                    return kotlin.collections.p.X(5, kotlin.collections.p.W(arrayList, new androidx.constraintlayout.core.e(13)));
                }
            } catch (Exception e) {
                Context context = com.app.mlounge.util.a.a;
                androidx.room.b0.h("Error: ", e.getMessage(), "E", "TorrentClaw");
                return wVar;
            }
        }
        return wVar;
