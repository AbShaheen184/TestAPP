...
public final class t0 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public t0(List list, boolean z, String str, String str2, Integer num, Integer num2, v0 v0Var, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.$order = list;
        this.$isTv = z;
        this.$base = str;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        t0 t0Var = new t0(this.$order, this.$isTv, this.$base, this.$tmdbId, this.$season, this.$episode, this.this$0, dVar);
        t0Var.L$0 = obj;
        return t0Var;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        while (it.hasNext()) {
            ...
            arrayList2.add(BuildersKt__Builders_commonKt.async$default(coroutineScope, null, null, new s0(z, str, str2, num, num2, (String) it.next(), v0Var2, null), 3, null));
