...
public interface RealDebridApi {
    ...
    @e
    Object c(@i("Authorization") String str, @s("id") String str2, @c("files") String str3, d<? super r0<j>> dVar);

    @f("rest/1.0/torrents/info/{id}")
    Object d(@i("Authorization") String str, @s("id") String str2, d<? super j> dVar);
    ...
    @e
    Object f(@i("Authorization") String str, @c("link") String str2, d<? super j> dVar);
    ...
    @e
    Object h(@i("Authorization") String str, @c("magnet") String str2, d<? super j> dVar);
}
