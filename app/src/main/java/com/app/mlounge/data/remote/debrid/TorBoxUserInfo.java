...
public final class TorBoxUserInfo {
    ...
    public static final class UserData {
        ...
        public final String b() {
            ...
            if (i != 3) {
                return i > 0 ? a.q("Premium (Plan ", i, ")") : "Free";
            }
            return "Standard";
        }
        ...
        public final int hashCode() {
            ...
            int iE = a.e(a.d(this.plan, (iHashCode + (str == null ? 0 : str.hashCode())) * 31, 31), 31, this.totalDownloaded);
            String str2 = this.customer;
            int iH = a.h((iE + (str2 == null ? 0 : str2.hashCode())) * 31, 31, this.isSubscribed);
            String str3 = this.premiumExpiresAt;
            int iHashCode2 = (iH + (str3 == null ? 0 : str3.hashCode())) * 31;
        ...
        public final String toString() {
            ...
            sb.append(z);
            b0.i(sb, ", premiumExpiresAt=", str3, ", createdAt=", str4);
            return j.m(sb, ", updatedAt=", str5, ")");
        }
    }
