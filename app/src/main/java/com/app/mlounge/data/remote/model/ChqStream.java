...
public final class ChqStream {
    ...
    public final int hashCode() {
        ...
        int iG = a.g((str == null ? 0 : str.hashCode()) * 31, 31, this.url);
    ...
    public final String toString() {
        ...
        List<HiAnimeTrack> list = this.animeSubtitles;
        StringBuilder sbQ = j.q("ChqStream(name=", str, ", url=", str2, ", quality=");
        b0.i(sbQ, str3, ", type=", str4, ", streamType=");
        b0.i(sbQ, str5, ", size=", str6, ", headers=");
        sbQ.append(map);
        sbQ.append(", seeders=");
        sbQ.append(num);
        sbQ.append(", infoHash=");
        ...
        sbQ.append(", fileIdx=");
        sbQ.append(num2);
        sbQ.append(", isTorrent=");
        sbQ.append(bool);
        sbQ.append(", description=");
        sbQ.append(str8);
        sbQ.append(", animeSubtitles=");
