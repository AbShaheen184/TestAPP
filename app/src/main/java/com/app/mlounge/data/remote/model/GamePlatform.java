...
jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v1 com.app.mlounge.data.remote.model.GamePlatform[], still in use, count: 1, list:
  (r0v1 com.app.mlounge.data.remote.model.GamePlatform[]) from 0x003e: CONSTRUCTOR (r0v1 com.app.mlounge.data.remote.model.GamePlatform[]) A[MD:(java.lang.Enum[]):void (m), WRAPPED] (LINE:63) call: kotlin.enums.c.<init>(java.lang.Enum[]):void type: CONSTRUCTOR
...
public final class GamePlatform {
    ...
    static {
        $ENTRIES = new c(new GamePlatform[]{r0, r1, r2});
    }
