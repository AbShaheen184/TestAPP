...
public final class GameSearchResponse {
    ...
    public final int hashCode() {
        ...
        return this.games.hashCode() + a.h(a.h(a.d(this.totalPages, a.d(this.totalResults, a.d(this.limit, a.d(this.page, (str == null ? 0 : str.hashCode()) * 31, 31), 31), 31), 31), 31, this.hasNext), 31, this.hasPrev);
    }
