...
public final class MusicTrack {
    ...
    public final int hashCode() {
        int iG = a.g(a.g(a.g(a.g(this.id.hashCode() * 31, 31, this.rel), 31, this.title), 31, this.artist), 31, this.album);
    ...
    public final String toString() {
        ...
        StringBuilder sbQ = j.q("MusicTrack(id=", str, ", rel=", str2, ", title=");
        b0.i(sbQ, str3, ", artist=", str4, ", album=");
        b0.i(sbQ, str5, ", duration=", str6, ", image=");
        return j.n(sbQ, str7, ", albumUrl=", str8, ")");
    }
}
