...
public final class n extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public /* synthetic */ n(Context context, String str, kotlin.coroutines.d dVar, int i) {
        super(2, dVar);
        this.e = i;
        this.z = context;
        this.A = str;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        switch (this.e) {
            case 0:
                return new n(this.z, this.A, dVar, 0);
            default:
                return new n(this.z, this.A, dVar, 1);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((n) create(coroutineScope, dVar)).invokeSuspend(y.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        switch (this.e) {
            case 0:
                ...
                webView.setWebViewClient(new m(handler, webView, vVar, vVar2, cancellableContinuationImpl));
                cancellableContinuationImpl.invokeOnCancellation(new h(1, vVar2, handler, webView));
            ...
            default:
                ...
                n nVar = new n(this.z, this.A, null, 0);
                this.y = 1;
                Object objWithContext = BuildersKt.withContext(main, nVar, this);
