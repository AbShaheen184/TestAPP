...
public final class TraktActivityTimestamps {
    ...
    public final String toString() {
        ...
        String str7 = this.hiddenAt;
        String str8 = this.updatedAt;
        StringBuilder sbQ = j.q("TraktActivityTimestamps(watchedAt=", str, ", collectedAt=", str2, ", ratedAt=");
        b0.i(sbQ, str3, ", watchlistedAt=", str4, ", commentedAt=");
        b0.i(sbQ, str5, ", pausedAt=", str6, ", hiddenAt=");
        return j.n(sbQ, str7, ", updatedAt=", str8, ")");
    }
}
