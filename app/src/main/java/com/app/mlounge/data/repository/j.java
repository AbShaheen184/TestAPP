...
public final class j extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public j(b2 b2Var, TmdbTvDetailResponse tmdbTvDetailResponse, int i, int i2, String str, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.C = b2Var;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        switch (this.e) {
            case 0:
                j jVar = new j((com.app.mlounge.data.providers.l0) this.D, this.B, this.z, this.A, dVar);
                jVar.C = obj;
                return jVar;
            default:
                return new j((b2) this.C, (TmdbTvDetailResponse) this.D, this.z, this.A, this.B, dVar);
        }
    }
        ...
        switch (this.e) {
            case 0:
                ...
                try {
                    if (i == 0) {
                        kotlin.a.e(obj);
                        com.app.mlounge.data.providers.l0 l0Var = (com.app.mlounge.data.providers.l0) this.D;
                        String str = this.B;
                        int i2 = this.z;
                        int i3 = this.A;
                        ...
                        this.C = null;
                        this.y = 1;
                        objA = l0Var.a(str, "tv", num, num2, this);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(com.app.mlounge.data.providers.l0 l0Var, String str, int i, int i2, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.D = l0Var;
        this.B = str;
        this.z = i;
