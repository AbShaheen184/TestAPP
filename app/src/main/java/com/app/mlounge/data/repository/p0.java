...
public final class p0 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.q {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        for (com.app.mlounge.data.local.entity.c cVar : list) {
            String str = cVar.l;
            if (str == null || (numW = kotlin.text.r.w(str)) == null) {
                string = null;
            } else {
                int iIntValue = numW.intValue();
                String str2 = cVar.b;
                if (kotlin.jvm.internal.l.a(str2, "movie")) {
                    string = androidx.privacysandbox.ads.adservices.java.internal.a.n(iIntValue, "movie:");
        ...
        return kotlin.collections.p.f0(kotlin.collections.p.O(arrayList, arrayList3));
    }
}
