...
import com.app.mlounge.data.providers.a2;
import com.app.mlounge.data.providers.d2;
import com.app.mlounge.data.providers.f1;
import com.app.mlounge.data.providers.g2;
import com.app.mlounge.data.providers.m1;
import com.app.mlounge.data.providers.p1;
import com.app.mlounge.data.providers.s1;
import com.app.mlounge.data.providers.v0;
import com.app.mlounge.data.providers.v1;
...
public final class r {
    ...
    public final f1 d;
    public final com.app.mlounge.data.providers.w e;
    public final y1 f;
    ...
    public r(ChqApi chqApi, com.app.mlounge.data.providers.s sVar, com.app.mlounge.data.providers.q qVar, f1 f1Var, com.app.mlounge.data.providers.w wVar, y1 y1Var, PremiumizeManager premiumizeManager, TorBoxManager torBoxManager, AllDebridManager allDebridManager, RealDebridManager realDebridManager, AnikotoScraper anikotoScraper, j0 j0Var, okhttp3.y yVar, m1 m1Var, Context context) {
        chqApi.getClass();
        sVar.getClass();
        qVar.getClass();
        f1Var.getClass();
        ...
        this.p = new kotlin.o(new kotlin.jvm.functions.a(this) { // from class: com.app.mlounge.data.repository.b
            ...
            public final Object invoke() {
                switch (i) {
                    case 0:
                        r rVar = this.y;
                        return new com.app.mlounge.data.providers.c0(rVar.m, rVar.n);
                    case 1:
                        return new v1(this.y.m);
                    case 2:
                        return new g2(this.y.m);
                    case 3:
                        r rVar2 = this.y;
                        return new com.app.mlounge.data.providers.z(rVar2.m, rVar2.n);
                    case 4:
                        r rVar3 = this.y;
                        return new com.app.mlounge.data.providers.o0(rVar3.m, rVar3.n);
                    case 5:
                        return new d2(this.y.m);
                    case 6:
                        return new a2(this.y.m);
                    case 7:
                        r rVar4 = this.y;
                        return new com.app.mlounge.data.providers.f(rVar4.m, rVar4.n);
                    case 8:
                        r rVar5 = this.y;
                        return new s1(rVar5.m, rVar5.n);
                    case 9:
                        r rVar6 = this.y;
                        return new com.app.mlounge.data.providers.k(rVar6.m, rVar6.n, rVar6.f);
                    case 10:
                        r rVar7 = this.y;
                        return new p1(rVar7.m, rVar7.n);
                    case 11:
                        r rVar8 = this.y;
                    ...
                    case 13:
                        r rVar10 = this.y;
                        return new com.app.mlounge.data.providers.f0(rVar10.m, rVar10.n);
                    case 14:
                        return new v0(this.y.m);
                    case 15:
                        return new com.app.mlounge.data.providers.k0(this.y.m);
                    case 16:
                        r rVar11 = this.y;
                        return kotlin.collections.c0.k(new kotlin.k("4KHDHub", rVar11.e), new kotlin.k("Castle", (com.app.mlounge.data.providers.f) rVar11.w.getValue()), new kotlin.k("FshareTV", (com.app.mlounge.data.providers.z) rVar11.s.getValue()), new kotlin.k("HDHub", (com.app.mlounge.data.providers.c0) rVar11.p.getValue()), new kotlin.k("MovieBlast", (com.app.mlounge.data.providers.o0) rVar11.t.getValue()), new kotlin.k("Movies111", (v0) rVar11.D.getValue()), new kotlin.k("VidApi", (v1) rVar11.q.getValue()), new kotlin.k("VidNest", (a2) rVar11.v.getValue()), new kotlin.k("Vidrock", (d2) rVar11.u.getValue()), new kotlin.k("VixSrc", (g2) rVar11.r.getValue()), new kotlin.k("Holly", (com.app.mlounge.data.providers.k0) rVar11.E.getValue()));
                    case 17:
                        r rVar12 = this.y;
                        return kotlin.collections.c0.k(new kotlin.k("Torrentio", (s1) rVar12.x.getValue()), new kotlin.k("Comet", (com.app.mlounge.data.providers.k) rVar12.y.getValue()), new kotlin.k("TorrentClaw", (p1) rVar12.z.getValue()), new kotlin.k("EasyNews", (com.app.mlounge.data.providers.n) rVar12.A.getValue()));
                    default:
                        r rVar13 = this.y;
                        return kotlin.collections.c0.k(new kotlin.k("AniZone", (com.app.mlounge.data.providers.c) rVar13.B.getValue()), new kotlin.k("HiAnime", (com.app.mlounge.data.providers.f0) rVar13.C.getValue()));
                }
            }
        });
        final int i2 = 1;
        ...
        this.F = kotlin.collections.q.k("4KHDHub", "Castle", "FshareTV", "HDHub", "Movies111", "VidApi", "Vidrock", "VixSrc", "Torrentio", "Comet", "TorrentClaw", "EasyNews");
        this.G = kotlin.collections.q.k("4KHDHub", "Castle", "FshareTV", "HDHub", "Movies111", "VidApi", "Vidrock", "VixSrc");
        this.H = kotlin.collections.q.k("Torrentio", "Comet", "TorrentClaw");
        this.I = kotlin.collections.q.k("AniZone", "HiAnime");
        final int i17 = 16;
    ...
    public static final List a(r rVar, String str, boolean z, boolean z2) {
        rVar.getClass();
        if (str.equals("anime")) {
            return kotlin.collections.p.b0(((Map) rVar.L.getValue()).values());
        }
        ArrayList arrayListC0 = kotlin.collections.p.c0(((Map) rVar.J.getValue()).values());
        arrayListC0.add((com.app.mlounge.data.providers.c) rVar.B.getValue());
        arrayListC0.add((com.app.mlounge.data.providers.f0) rVar.C.getValue());
        if (z) {
            Collection collectionValues = ((Map) rVar.K.getValue()).values();
            ArrayList arrayList = new ArrayList();
            for (Object obj : collectionValues) {
                if (!kotlin.jvm.internal.l.a(((com.app.mlounge.data.providers.l0) obj).getName(), "EasyNews")) {
                    arrayList.add(obj);
                }
            }
            arrayListC0.addAll(arrayList);
        }
        if (z2) {
            arrayListC0.add((com.app.mlounge.data.providers.n) rVar.A.getValue());
        }
        return arrayListC0;
    }
