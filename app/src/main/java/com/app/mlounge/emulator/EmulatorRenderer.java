...
public final class EmulatorRenderer implements GLSurfaceView.Renderer {
    ...
    private final int compileShader(int i, String str) {
        ...
        com.app.mlounge.util.a.a("E", TAG, "Compile error: " + GLES20.glGetShaderInfoLog(iGlCreateShader));
    ...
    private final int createProgram(String str, String str2) {
        ...
        Context context = com.app.mlounge.util.a.a;
        com.app.mlounge.util.a.a("E", TAG, "Link error: " + GLES20.glGetProgramInfoLog(iGlCreateProgram));
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
        ...
        if (iCreateProgram == 0) {
            Context context = com.app.mlounge.util.a.a;
            com.app.mlounge.util.a.a("E", TAG, "Failed to create shader program");
            return;
        }
        ...
        if (hwTextureId != 0) {
            ...
            com.app.mlounge.util.a.a("D", TAG, "HW render active: PPSSPP texture id=" + hwTextureId);
        }
    }
    ...
    public /* synthetic */ EmulatorRenderer(LibretroCore libretroCore, kotlin.jvm.functions.a aVar, kotlin.jvm.functions.a aVar2, int i, kotlin.jvm.internal.f fVar) {
        this(libretroCore, (i & 2) != 0 ? new c0(25) : aVar, (i & 4) != 0 ? new c0(26) : aVar2);
    }
}
