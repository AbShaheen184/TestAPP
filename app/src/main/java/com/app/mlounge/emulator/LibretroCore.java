...
public final class LibretroCore {
    ...
    static {
        try {
            ...
            com.app.mlounge.util.a.a("D", TAG, "Loaded retrowrapper native library");
        } catch (UnsatisfiedLinkError e) {
            Context context2 = com.app.mlounge.util.a.a;
            b0.h("retrowrapper not available: ", e.getMessage(), "W", TAG);
        }
    }
    ...
    private final void initAudio() {
        int iD = i0.d((int) this.coreSampleRate, 8000, 48000);
        AudioTrack audioTrack = new AudioTrack(3, iD, 12, 2, Math.max(AudioTrack.getMinBufferSize(iD, 12, 2), ((int) ((((double) iD) / this.coreFps) * ((double) 2))) * 16), 1);
        audioTrack.play();
    ...
    public final boolean initCore(String str) {
        ...
        try {
            ...
            Context context = com.app.mlounge.util.a.a;
            com.app.mlounge.util.a.a("D", TAG, zNativeInitCore ? "Core loaded: ".concat(str) : "Failed to load core");
            return this.coreLoaded;
        } catch (Exception e) {
            Context context2 = com.app.mlounge.util.a.a;
            com.app.mlounge.util.a.d(TAG, "Error initializing core", e);
            return false;
        }
    }
    ...
    public final boolean loadGame(String str) {
        ...
        if (zNativeLoadGame) {
            ...
            boolean z = str2 != null && kotlin.text.k.z(str2, "ppsspp", true);
            ...
            if (iArrNativeGetGameDimensions != null) {
                if (iArrNativeGetGameDimensions.length >= 2 && (i = iArrNativeGetGameDimensions[0]) > 0 && (i2 = iArrNativeGetGameDimensions[1]) > 0) {
                    ...
                    this.videoBuffer = new int[130560];
                }
            }
            double[] dArrNativeGetTiming = nativeGetTiming();
            if (dArrNativeGetTiming != null && dArrNativeGetTiming.length >= 2) {
                double d = dArrNativeGetTiming[0];
                this.coreFps = d;
                double d2 = dArrNativeGetTiming[1];
                this.coreSampleRate = d2;
                Context context = com.app.mlounge.util.a.a;
                com.app.mlounge.util.a.a("D", TAG, "Core timing: " + d + " fps, " + d2 + " Hz");
            ...
            Context context2 = com.app.mlounge.util.a.a;
            com.app.mlounge.util.a.a("D", TAG, "Game loaded: " + str + " (" + this.videoWidth + "x" + this.videoHeight + ")");
        }
        return this.gameLoaded;
    }
    ...
    public final void runFrame() {
        ...
        if (this.gameLoaded) {
            ...
            if (iArrNativeGetCurrentDimensions != null && iArrNativeGetCurrentDimensions.length >= 2 && (i = iArrNativeGetCurrentDimensions[0]) > 0 && (i2 = iArrNativeGetCurrentDimensions[1]) > 0 && (i != this.videoWidth || i2 != this.videoHeight)) {
                ...
                this.videoBuffer = new int[i * i2];
                Context context = com.app.mlounge.util.a.a;
                com.app.mlounge.util.a.a("D", TAG, androidx.compose.runtime.j.g("Resolution changed: ", i, "x", i2));
            }
