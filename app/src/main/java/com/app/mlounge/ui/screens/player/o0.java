...
public final class o0 {
    ...
    public static androidx.media3.exoplayer.source.a a(Context context, String str, boolean z, androidx.localbroadcastmanager.content.b bVar, androidx.media3.common.b0 b0Var, String str2, androidx.media3.extractor.q qVar) {
        String str3;
        char c;
        char c2;
        ...
        boolean z2 = kotlin.text.k.z(str, ".mpd", false) || (str2 != null && kotlin.text.k.z(str2, "dash", false));
        if (z) {
            str3 = "application/x-mpegURL";
        } else if (z2) {
            str3 = "application/dash+xml";
        } else if (kotlin.text.k.z(str, "vixsrc.to", true)) {
            str3 = "video/mp4";
        } else {
        ...
        if (z) {
            ...
            androidx.media3.exoplayer.hls.playlist.t bVar2 = hlsMediaSource$Factory.e;
            if (!zIsEmpty) {
                bVar2 = new androidx.localbroadcastmanager.content.b(11, bVar2, list2);
            }
            ...
            c = 0;
            c2 = 1;
            q0Var = new androidx.media3.exoplayer.hls.m(c0Var, cVar, dVar2, hlsMediaSource$Factory.g, fVar, t2Var, new androidx.media3.exoplayer.hls.playlist.d(cVar, t2Var, bVar2), hlsMediaSource$Factory.l, hlsMediaSource$Factory.j, hlsMediaSource$Factory.k);
        } else {
            c = 0;
            c2 = 1;
            if (z2) {
                ...
                List list3 = yVar.c;
                androidx.media3.exoplayer.upstream.p bVar3 = !list3.isEmpty() ? new androidx.localbroadcastmanager.content.b(12, eVar, list3) : eVar;
        ...
        f1 f1Var = new f1(b0Var, bVar, new t2(-1));
    ...
    public static okhttp3.y b(String str, Map map) {
        ...
        if (map != null) {
            ...
            host.getClass();
            xVar.d.add(new n0(str7, str5, host, kotlin.text.k.d0(host, "."), host2, str3, str9));
        }
    ...
    */
    public static java.nio.charset.Charset e(java.lang.String r1) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.app.mlounge.ui.screens.player.o0.e(java.lang.String):java.nio.charset.Charset");
    }
    ...
    public static String f(String str) {
        ...
        if (str != null) {
            ...
            lowerCase.getClass();
            string = kotlin.text.k.g0(lowerCase).toString();
            if (string == null) {
                string = "";
            }
        } else {
        ...
        if (kotlin.text.k.z(string, "english", false) || kotlin.text.k.z(string, "(en)", false)) {
            return "en";
        }
        if (kotlin.text.k.z(string, "french", false) || kotlin.text.k.z(string, "français", false) || kotlin.text.k.z(string, "(fr)", false)) {
            return "fr";
        }
        if (kotlin.text.k.z(string, "spanish", false) || kotlin.text.k.z(string, "español", false) || kotlin.text.k.z(string, "(es)", false)) {
            return "es";
        }
        if (kotlin.text.k.z(string, "german", false) || kotlin.text.k.z(string, "deutsch", false) || kotlin.text.k.z(string, "(de)", false)) {
            return "de";
        }
        if (kotlin.text.k.z(string, "italian", false) || kotlin.text.k.z(string, "italiano", false) || kotlin.text.k.z(string, "(it)", false)) {
            return "it";
        }
        if (kotlin.text.k.z(string, "portuguese", false) || kotlin.text.k.z(string, "português", false) || kotlin.text.k.z(string, "(pt)", false)) {
            return "pt";
        }
        if (kotlin.text.k.z(string, "japanese", false) || kotlin.text.k.z(string, "日本語", false) || kotlin.text.k.z(string, "(ja)", false)) {
            return "ja";
        }
        if (kotlin.text.k.z(string, "chinese", false) || kotlin.text.k.z(string, "中文", false) || kotlin.text.k.z(string, "(zh)", false)) {
            return "zh";
        }
        if (kotlin.text.k.z(string, "arabic", false) || kotlin.text.k.z(string, "العربية", false) || kotlin.text.k.z(string, "(ar)", false)) {
            return "ar";
        }
        if (kotlin.text.k.z(string, "korean", false) || kotlin.text.k.z(string, "한국어", false) || kotlin.text.k.z(string, "(ko)", false)) {
            return "ko";
        }
        if (kotlin.text.k.z(string, "dutch", false) || kotlin.text.k.z(string, "nederlands", false) || kotlin.text.k.z(string, "(nl)", false)) {
            return "nl";
        }
        return (kotlin.text.k.z(string, "russian", false) || kotlin.text.k.z(string, "русский", false) || kotlin.text.k.z(string, "(ru)", false)) ? "ru" : "en";
    }

    public final androidx.localbroadcastmanager.content.b d(Context context, okhttp3.y yVar) {
        context.getClass();
        androidx.localbroadcastmanager.content.b bVar = new androidx.localbroadcastmanager.content.b(yVar);
        ...
        nVar.A = bVar;
        nVar.e = 2;
        return new androidx.localbroadcastmanager.content.b(context, nVar);
    }
}
