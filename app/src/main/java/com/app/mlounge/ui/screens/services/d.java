...
public final /* synthetic */ class d implements p {
    ...
    public /* synthetic */ d(x1 x1Var, kotlin.jvm.functions.a aVar, kotlin.jvm.functions.l lVar) {
        this.y = x1Var;
        this.A = aVar;
        this.z = lVar;
    }
        ...
        switch (this.e) {
            case 0:
                ...
                if (sVar.T(iIntValue & 1, (iIntValue & 3) != 2)) {
                    ...
                    androidx.privacysandbox.ads.adservices.java.internal.a.z(iHashCode3, sVar, eVar3, sVar, dVar2);
                    t.x(sVar, rVarC3, eVar4);
                    x2 x2Var = n6.a;
                    boolean z3 = true;
                    z5.b("TorBox", null, com.app.mlounge.ui.theme.b.l, 0L, null, 0L, null, 0L, 0, false, 0, 0, ((m6) sVar.j(x2Var)).h, sVar, 390, 0, 131066);
                    z5.b("Torrent downloading and caching service", null, com.app.mlounge.ui.theme.b.m, 0L, null, 0L, null, 0L, 0, false, 0, 0, ((m6) sVar.j(x2Var)).l, sVar, 390, 0, 131066);
                    s sVar2 = sVar;
                    sVar2.p(true);
                    x1 x1Var = this.y;
                    boolean z4 = x1Var.a;
                    TorBoxUserInfo torBoxUserInfo = x1Var.c;
                    boolean z5 = x1Var.b;
                    n.l(z4, sVar2, 0);
                    sVar2.p(true);
                    ...
                    if (x1Var.a) {
                        ...
                        if (z5) {
                            ...
                            if ((torBoxUserInfo != null ? torBoxUserInfo.a() : null) != null) {
                                ...
                                bVarG.add(new kotlin.k("Email", strA));
                                bVarG.add(new kotlin.k("Plan", userDataA.b()));
                                bVarG.add(new kotlin.k("Premium", userDataA.d() ? "Yes" : "No"));
                                String strC = userDataA.c();
                                if (strC != null) {
                                    bVarG.add(new kotlin.k("Expires", n.p(strC)));
                                }
                        ...
                        if (x1Var.d != null) {
                            ...
                            z2 = false;
                            dVar = this;
                            z5.b(x1Var.d, androidx.compose.foundation.layout.b.u(oVar2, 0.0f, 0.0f, 0.0f, 8, 7), com.app.mlounge.ui.theme.b.o, 0L, null, 0L, null, 0L, 0, false, 0, 0, ((m6) sVar2.j(x2Var)).l, sVar2, 432, 0, 131064);
                            sVar2 = sVar2;
                            sVar2.p(false);
                        } else {
                            z = z5;
                        ...
                        n.c("TorBox API Key", z, dVar.z, sVar2, 6);
                        androidx.compose.foundation.layout.b.e(sVar2, i1.g(oVar, 8));
                        n.d("https://torbox.app/", sVar2, 6);
                        sVar2.p(z2);
                        z3 = true;
                    }
                    sVar2.p(z3);
            ...
            default:
                ...
                n.m(this.y, this.z, this.A, (s) obj, t.A(1));
                break;
        }
        return y.a;
    }

    public /* synthetic */ d(x1 x1Var, kotlin.jvm.functions.l lVar, kotlin.jvm.functions.a aVar, int i) {
        this.y = x1Var;
        this.z = lVar;
        this.A = aVar;
    }
