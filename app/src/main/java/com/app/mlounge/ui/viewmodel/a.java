        ...
        switch (this.e) {
            case 0:
                ...
                if (i == 0) {
                    ...
                    String strI = androidx.compose.runtime.j.i("adult_", epornerVideoDetail.c());
                    String strH = epornerVideoDetail.h();
                    if (strH == null) {
                        strH = "";
                    }
                    EpornerThumb epornerThumbB = epornerVideoDetail.b();
                    com.app.mlounge.data.local.entity.c cVar = new com.app.mlounge.data.local.entity.c(strI, "adult", strH, epornerThumbB != null ? epornerThumbB.a() : null, null, null, null, null, 0L, epornerVideoDetail.c(), null, null, null, 30704);
                    this.y = 1;
            ...
            default:
                ...
                if (i2 == 0) {
                    ...
                    String strI2 = androidx.compose.runtime.j.i("adult_", epornerVideoDetail2.c());
                    String strH2 = epornerVideoDetail2.h();
                    if (strH2 == null) {
                        strH2 = "";
                    }
                    EpornerThumb epornerThumbB2 = epornerVideoDetail2.b();
                    com.app.mlounge.data.local.entity.f fVar = new com.app.mlounge.data.local.entity.f(strI2, "adult", strH2, epornerThumbB2 != null ? epornerThumbB2.a() : null, null, null, null, null, 0L, epornerVideoDetail2.c(), null, 1520);
                    this.y = 1;
