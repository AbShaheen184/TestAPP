...
public final class c extends androidx.lifecycle.s0 {
    public static final List H = kotlin.collections.q.k(new kotlin.k(com.app.mlounge.data.repository.a.e, "XVideos"), new kotlin.k(com.app.mlounge.data.repository.a.y, "EPorner"));
    public final Flow A;
    public final Flow B;
    ...
    public c(com.app.mlounge.data.repository.r rVar, com.app.mlounge.data.repository.x xVar, com.app.mlounge.data.local.prefs.y1 y1Var, com.app.mlounge.data.local.prefs.a aVar) {
        ...
        MutableStateFlow MutableStateFlow10 = StateFlowKt.MutableStateFlow(kotlin.collections.x.e);
        ...
        this.E = 1;
        this.F = true;
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new androidx.room.s(this, (com.app.mlounge.data.repository.a) MutableStateFlow6.getValue(), null, 24), 3, null);
    }
    ...
    public final void e() {
        ...
        this.G = BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new b(this, (com.app.mlounge.data.repository.a) this.o.getValue(), str, dVar, 1), 3, null);
    }
}
