...
public final class d {
    ...
    public final int hashCode() {
        ...
        int iHashCode = (iH + (allDebridUserInfo == null ? 0 : allDebridUserInfo.hashCode())) * 31;
        AllDebridPinData allDebridPinData = this.d;
        int iH2 = androidx.privacysandbox.ads.adservices.java.internal.a.h((iHashCode + (allDebridPinData == null ? 0 : allDebridPinData.hashCode())) * 31, 31, this.e);
        String str = this.f;
