...
public final class d1 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public /* synthetic */ d1(int i, h1 h1Var, String str, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.e = i;
        this.z = h1Var;
        this.A = str;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        switch (this.e) {
            case 0:
                return new d1(0, this.z, this.A, dVar);
            default:
                return new d1(1, this.z, this.A, dVar);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((d1) create(coroutineScope, dVar)).invokeSuspend(kotlin.y.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        switch (this.e) {
            case 0:
                ...
                if (i == 0) {
                    kotlin.a.e(obj);
                    mutableStateFlow.setValue(m0.a((m0) mutableStateFlow.getValue(), true, null, null, 5));
                ...
                if (premiumizeUserInfo != null) {
                    mutableStateFlow.setValue(new m0(premiumizeUserInfo, 10));
                } else {
                    mutableStateFlow.setValue(m0.a((m0) mutableStateFlow.getValue(), false, null, "Invalid API key. Please check and try again.", 5));
                }
                return kotlin.y.a;
            default:
                h1 h1Var2 = this.z;
                ...
                if (i2 == 0) {
                    kotlin.a.e(obj);
                    mutableStateFlow2.setValue(x1.a((x1) mutableStateFlow2.getValue(), true, null, null, 5));
                ...
                if (torBoxUserInfo != null) {
                    mutableStateFlow2.setValue(new x1(torBoxUserInfo, 10));
                } else {
                    mutableStateFlow2.setValue(x1.a((x1) mutableStateFlow2.getValue(), false, null, "Invalid API key. Please check and try again.", 5));
                }
                return kotlin.y.a;
        }
    }
