            ...
            case 0:
                ...
                try {
                    if (i == 0) {
                        ...
                        this.y = 1;
                        rVar.getClass();
                        obj = BuildersKt.withContext(Dispatchers.getIO(), new androidx.room.coroutines.c0(1, rVar, str, str2, (kotlin.coroutines.d) null), this);
            ...
            default:
                ...
                try {
                    if (i2 == 0) {
                        ...
                        this.y = 1;
                        rVar2.getClass();
                        obj = BuildersKt.withContext(Dispatchers.getIO(), new androidx.compose.foundation.text.selection.q(rVar2, null, 5), this);
