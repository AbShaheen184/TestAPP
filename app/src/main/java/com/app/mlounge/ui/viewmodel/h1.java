...
public final class h1 extends androidx.lifecycle.s0 {
    ...
    public h1(com.app.mlounge.data.local.prefs.y1 y1Var, PremiumizeManager premiumizeManager, TorBoxManager torBoxManager, AllDebridManager allDebridManager, RealDebridManager realDebridManager, TraktManager traktManager, TraktSyncManager traktSyncManager) {
        y1Var.getClass();
        ...
        MutableStateFlow MutableStateFlow = StateFlowKt.MutableStateFlow(new m0(null, 15));
        this.i = MutableStateFlow;
        this.j = FlowKt.asStateFlow(MutableStateFlow);
        MutableStateFlow MutableStateFlow2 = StateFlowKt.MutableStateFlow(new x1(null, 15));
        ...
        MutableStateFlow MutableStateFlow4 = StateFlowKt.MutableStateFlow(new p0(null, 63));
        this.o = MutableStateFlow4;
        this.p = FlowKt.asStateFlow(MutableStateFlow4);
        MutableStateFlow MutableStateFlow5 = StateFlowKt.MutableStateFlow(new p(null, 15));
        this.q = MutableStateFlow5;
        this.r = FlowKt.asStateFlow(MutableStateFlow5);
        MutableStateFlow MutableStateFlow6 = StateFlowKt.MutableStateFlow(new y1(null, 63));
        this.s = MutableStateFlow6;
        this.t = FlowKt.asStateFlow(MutableStateFlow6);
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new c1(this, dVar, 0), 3, null);
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new c1(this, dVar, 1), 3, null);
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new c1(this, dVar, 2), 3, null);
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new c1(this, dVar, 3), 3, null);
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new c1(this, dVar, 4), 3, null);
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new c1(this, dVar, 5), 3, null);
    }
