...
public final class j0 extends androidx.lifecycle.s0 {
    ...
    public j0(Context context, com.app.mlounge.data.repository.a0 a0Var, com.app.mlounge.data.download.h hVar, com.app.mlounge.data.local.prefs.y1 y1Var) {
        a0Var.getClass();
        hVar.getClass();
        y1Var.getClass();
        this.b = context;
        ...
        this.m = true;
        MutableStateFlow MutableStateFlow4 = StateFlowKt.MutableStateFlow(kotlin.collections.p.B(com.app.mlounge.data.repository.a0.e));
        ...
        this.D = kotlin.collections.q.k("Top Albums", "New Releases");
        f();
    }

    public static final Object e(j0 j0Var, String str, String str2, Object obj, kotlin.coroutines.jvm.internal.i iVar) {
        com.app.mlounge.data.repository.a0 a0Var = j0Var.c;
        String str3 = (String) j0Var.p.getValue();
    ...
    public final void f() {
        ...
        g();
        BuildersKt__Builders_commonKt.launch$default(androidx.lifecycle.m0.g(this), null, null, new i0(this, null, 0), 3, null);
    }
