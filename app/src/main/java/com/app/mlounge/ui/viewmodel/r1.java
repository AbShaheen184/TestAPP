...
public final class r1 extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public /* synthetic */ r1(w1 w1Var, ChqStream chqStream, kotlin.coroutines.d dVar, int i) {
        super(2, dVar);
        this.e = i;
        this.z = w1Var;
        this.A = chqStream;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        switch (this.e) {
            case 0:
                return new r1(this.z, this.A, dVar, 0);
            case 1:
                return new r1(this.z, this.A, dVar, 1);
            default:
                return new r1(this.z, this.A, dVar, 2);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((r1) create(coroutineScope, dVar)).invokeSuspend(kotlin.y.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.e) {
            case 0:
                ...
                w1 w1Var = this.z;
                this.y = 1;
                objE = w1.e(w1Var, chqStream, this);
                if (objE == aVar) {
                    return aVar;
                }
                ...
                if (i2 == 0) {
                    ...
                    if (kotlin.jvm.internal.l.a(str, "anime")) {
                        ...
                        if (zA) {
                            ...
                            strN = androidx.privacysandbox.ads.adservices.java.internal.a.n(i3, "movie:");
                        }
                    }
                    String str3 = strN;
                    ...
                    w1 w1Var3 = this.z;
                    l0 l0Var = new l0(strM, str4, mapE, strK, w1Var3.t, w1Var3.r, w1Var3.v, w1Var3.w, str3);
                    this.y = 1;
                    if (mutableSharedFlow.emit(l0Var, this) == aVar2) {
                        return aVar2;
                    }
                } else {
                    if (i2 != 1) {
            ...
            default:
                w1 w1Var4 = this.z;
                MutableStateFlow mutableStateFlow = w1Var4.n;
                ...
                if (list.isEmpty()) {
                    ...
                    l lVar = (l) kotlin.collections.p.B(list);
                    this.y = 2;
                    if (w1.k(w1Var4, chqStream2, lVar, this) == aVar3) {
                        return aVar3;
                    }
                } else {
