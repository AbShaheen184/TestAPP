...
public final class u extends kotlin.coroutines.jvm.internal.i implements kotlin.jvm.functions.p {
    ...
    public /* synthetic */ u(a0 a0Var, IptvChannel iptvChannel, kotlin.coroutines.d dVar, int i) {
        super(2, dVar);
        this.e = i;
        this.z = a0Var;
        this.A = iptvChannel;
    ...
    public final kotlin.coroutines.d create(Object obj, kotlin.coroutines.d dVar) {
        switch (this.e) {
            case 0:
                return new u(this.z, this.A, dVar, 0);
            default:
                return new u(this.z, this.A, dVar, 1);
        }
    }
        ...
        switch (this.e) {
            case 0:
                ...
                if (i == 0) {
                    ...
                    String strE = androidx.room.b0.e("livetv_", iptvChannel.c(), "_", iptvChannel.d());
                    ...
                    com.app.mlounge.data.local.entity.c cVar = new com.app.mlounge.data.local.entity.c(strE, "live_tv", strC, strB, null, null, null, androidx.compose.runtime.j.j(strA, " - ", strD != null ? strD : ""), 0L, iptvChannel.f(), null, null, null, 30576);
                    this.y = 1;
            ...
            default:
                ...
                String strE2 = androidx.room.b0.e("livetv_", iptvChannel2.c(), "_", iptvChannel2.d());
                ...
                com.app.mlounge.data.local.entity.f fVar = new com.app.mlounge.data.local.entity.f(strE2, "live_tv", strC2, strB2, null, null, null, androidx.compose.runtime.j.j(strA2, " - ", strD2 != null ? strD2 : ""), 0L, iptvChannel2.f(), iptvChannel2.f(), 368);
                this.y = 1;
                if (xVar2.b(fVar, this) == aVar2) {
                    return aVar2;
                }
                MutableSharedFlow mutableSharedFlow = a0Var.A;
