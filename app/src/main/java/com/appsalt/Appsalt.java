...
public final class Appsalt {
    ...
    public static final class Companion implements u, v2 {
        ...
        public String getId() {
            ...
            k0 k0Var = f3Var.c;
            return ((a2) k0Var.b.get((g0) k0Var.c)).getId();
        }
        ...
        public boolean isBackground() {
            ...
            k0 k0Var = f3Var.c;
            return ((z) k0Var.a).a.getBoolean("isBackground", false) && ((m) k0Var.e).b();
        }
        ...
        public boolean isOptedIn() {
            ...
            k0 k0Var = f3Var.c;
            return ((a2) k0Var.b.get((g0) k0Var.c)).a();
        }
        ...
        public final void optIn() {
            ...
            k0 k0Var = f3Var.c;
            ((a2) k0Var.b.get((g0) k0Var.c)).b(true);
        }
        ...
        public void setBackground(boolean z) {
            ...
            k0 k0Var = f3Var.c;
            if (((z) k0Var.a).a.getBoolean("isBackground", false) == z) {
                return;
            }
            ((z) k0Var.a).a.edit().putBoolean("isBackground", z).apply();
            g0 g0Var = (z && ((m) k0Var.e).b()) ? g0.y : g0.e;
            ?? r0 = k0Var.b;
            Job job = (Job) k0Var.i;
            if (job != null) {
            ...
            k0Var.i = null;
            a2 a2Var = (a2) r0.get(g0Var);
            a2 a2Var2 = (a2) r0.get((g0) k0Var.c);
            k0Var.c = g0Var;
            a2Var.setOnError(new s(3, a2Var, k0Var));
            k0Var.g = null;
            if (a2Var2.isRunning()) {
                a2Var2.stop();
                k0Var.i = BuildersKt__Builders_commonKt.launch$default((CoroutineScope) k0Var.h, null, null, new o1(a2Var2, a2Var, k0Var, dVar, 5), 3, null);
            }
        }
