...
public final class e3 {
    ...
    public e3(androidx.work.impl.k kVar) {
    ...
    public static final Object a(e3 e3Var, j4 j4Var, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        if (cVar instanceof x1) {
            ...
            if ((i & Integer.MIN_VALUE) != 0) {
                x1Var.C = i - Integer.MIN_VALUE;
            } else {
                x1Var = new x1(e3Var, cVar);
            }
        } else {
            x1Var = new x1(e3Var, cVar);
        }
        ...
        try {
            if (i2 == 0) {
                ...
                x1Var.z = mutex;
                x1Var.C = 1;
                if (mutex.lock(null, x1Var) != aVar) {
                }
                return aVar;
            }
            if (i2 == 1) {
                Mutex mutex3 = x1Var.z;
                j4Var = x1Var.y;
                e3 e3Var3 = x1Var.e;
                kotlin.a.e(obj);
                mutex = mutex3;
            ...
            try {
                ...
                i3VarB = b0.b(kVar, 2);
                BuildersKt__Builders_commonKt.launch$default(e3Var2.c, null, null, new com.app.mlounge.ui.c0(i3VarB, j4Var, e3Var2, null), 3, null);
                return yVar;
            } catch (Throwable th) {
                mutex2.unlock(null);
                throw th;
            ...
            if (!zContainsKey) {
                ...
                x1Var.z = mutex4;
                x1Var.C = 2;
                if (mutex4.lock(null, x1Var) != aVar) {
                    e3Var2 = e3Var;
                    mutex2 = mutex4;
    ...
    public static final Object b(e3 e3Var, String str, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        try {
            if (i2 == 0) {
                ...
                j1Var.z = mutex;
                j1Var.C = 1;
                if (mutex.lock(null, j1Var) != aVar) {
                }
                return aVar;
            }
            if (i2 == 1) {
                Mutex mutex4 = j1Var.z;
                str = j1Var.y;
                e3 e3Var4 = j1Var.e;
                kotlin.a.e(obj);
                mutex = mutex4;
                ...
                if (i2 == 2) {
                    ...
                    j1Var.z = mutex2;
                    j1Var.C = 3;
                    if (mutex2.lock(null, j1Var) != aVar) {
                        e3Var3 = e3Var;
                        mutex3 = mutex2;
                    }
                    return aVar;
            ...
            if (i3Var != null) {
                ...
                j1Var.z = null;
                j1Var.C = 2;
                if (r11.invoke(e4Var, j1Var) != aVar) {
                    String str3 = str;
                    e3Var2 = e3Var;
                    str2 = str3;
                    e3 e3Var6 = e3Var2;
