...
public final class f {
    ...
    public f(Channel channel, Channel channel2, g5 g5Var, androidx.work.impl.k kVar, p0 p0Var, x xVar, o0 o0Var, CoroutineDispatcher coroutineDispatcher) {
        this.a = channel;
        this.b = channel2;
        this.c = g5Var;
        this.d = kVar;
    ...
    public static final Object a(f fVar, h2 h2Var, kotlin.coroutines.jvm.internal.c cVar) {
        m5 m5Var;
        Object objSend;
        ...
        if (sendChannel != null) {
            m5Var.z = 1;
            if (!(p3Var instanceof t1) || (objSend = sendChannel.send(h2Var, m5Var)) != aVar) {
                objSend = yVar;
            }
            if (objSend == aVar) {
                return aVar;
        ...
        if (p3Var instanceof e1) {
            ...
            BuildersKt__Builders_commonKt.launch$default(fVar.h, null, null, new androidx.compose.animation.core.f(fVar, str2, new a(str2, e1Var.a, i3, channelChannel$default, channel, fVar.d), e1Var, null, 24), 3, null);
            return yVar;
        }
        if (!(p3Var instanceof x0)) {
            if (p3Var instanceof u0) {
                m5Var.z = 2;
                Object objSend2 = channel.send(new h2(str, h2Var.b, new x0(8)), m5Var);
                if (objSend2 != aVar) {
                    objSend2 = yVar;
                }
                if (objSend2 == aVar) {
            ...
            } else if (p3Var instanceof p1) {
                m5Var.z = 3;
                Object objSend3 = channel.send(new h2(str, h2Var.b, new x0(7)), m5Var);
                if (objSend3 != aVar) {
                    objSend3 = yVar;
                }
                if (objSend3 == aVar) {
    ...
    */
    public static final java.lang.Object b(com.appsalt.internal.f r5, java.lang.String r6, com.appsalt.internal.a r7, com.appsalt.internal.e1 r8, kotlin.coroutines.jvm.internal.c r9) {
        /*
        ...
        L63:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsalt.internal.f.b(com.appsalt.internal.f, java.lang.String, com.appsalt.internal.a, com.appsalt.internal.e1, kotlin.coroutines.jvm.internal.c):java.lang.Object");
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    public static final Object f(f fVar, h2 h2Var, kotlin.coroutines.jvm.internal.c cVar) {
        q5 q5Var;
        int i;
        ...
        kotlin.a.e(obj);
        p3 p3Var = h2Var.c;
        if (p3Var.equals(c2.a)) {
            q5Var.z = 1;
            q0 q0VarA = ((x2) fVar.c).a();
            String str = h2Var.a;
            int i5 = h2Var.b;
            ...
            Object objSend = fVar.b.send(new h2(str, i5, new y2(i, q0VarA.g, b0.a(q0VarA.d), q0VarA.b, b0.a(q0VarA.e), b0.a(q0VarA.a), b0.a(q0VarA.c))), q5Var);
            kotlin.coroutines.intrinsics.a aVar = kotlin.coroutines.intrinsics.a.e;
            if (objSend != aVar) {
                objSend = yVar;
            }
        ...
        while (true) {
            ...
            n0 n0Var = kotlin.text.k.J(str2) ? null : new n0(str2, i6);
            if (n0Var != null) {
                arrayList.add(n0Var);
            }
        }
        ...
        for (String str3 : t0Var2) {
            n0 n0Var2 = kotlin.text.k.J(str3) ? null : new n0(str3, i6);
            if (n0Var2 != null) {
                arrayList2.add(n0Var2);
            }
        }
        o0Var.g = new androidx.appcompat.widget.c2(27, new kotlin.time.f(kotlin.time.e.b()), arrayList, arrayList2);
    ...
    public final Object c(String str, t5 t5Var) {
        n nVar = ((x2) this.c).b;
        String str2 = nVar.a;
        g2 g2Var = new g2(nVar.d, nVar.e);
        String str3 = Build.VERSION.RELEASE;
        String str4 = Build.VERSION.RELEASE;
        Object objSend = this.b.send(new h2("", -1, new p2(str2, g2Var, new l2(), kotlin.collections.c0.k(new kotlin.k("aid", nVar.b), new kotlin.k("puid", nVar.c)), str)), t5Var);
    ...
    public final Object d(String str, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        try {
            try {
                if (i2 == 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            t5Var.A = 4;
                            str.getClass();
                            Object objWithContext2 = BuildersKt.withContext(NonCancellable.INSTANCE, new androidx.compose.animation.core.c1(str, dVar, 27), t5Var);
                ...
                t5Var.A = 3;
                fVar.getClass();
                objWithContext = BuildersKt.withContext(NonCancellable.INSTANCE, new androidx.compose.animation.core.c1(fVar, dVar, 27), t5Var);
    ...
    public final java.lang.Object e(kotlin.coroutines.jvm.internal.c r13) {
        /*
            r12 = this;
            boolean r0 = r13 instanceof com.appsalt.internal.b5
            if (r0 == 0) goto L13
            r0 = r13
            com.appsalt.internal.b5 r0 = (com.appsalt.internal.b5) r0
            int r1 = r0.B
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r3 = r1 & r2
            if (r3 == 0) goto L13
            ...
            goto L18
        L13:
            com.appsalt.internal.b5 r0 = new com.appsalt.internal.b5
            r0.<init>(r12, r13)
        L18:
        ...
        L41:
            ...
            kotlin.coroutines.j r3 = r0.getContext()
            r13.<init>(r3)
            kotlinx.coroutines.channels.Channel r3 = r5.a
            kotlinx.coroutines.selects.SelectClause1 r3 = r3.getOnReceive()
            com.app.mlounge.ui.viewmodel.g0 r4 = new com.app.mlounge.ui.viewmodel.g0
            r6 = 0
            r7 = 11
            r4.<init>(r5, r6, r7)
            r13.invoke(r3, r4)
            ...
            androidx.compose.foundation.gestures.g2 r3 = new androidx.compose.foundation.gestures.g2
            r9 = 4
            r10 = 2
            r4 = 2
