...
public final class j {
    ...
    public static u1 a(d2 d2Var) {
        ...
        if (d2Var instanceof z3) {
        ...
        } else if (d2Var instanceof e4) {
            bArrE = e(d(((e4) d2Var).a), (byte) 3, new byte[0]);
        } else if (d2Var instanceof v1) {
            v1 v1Var = (v1) d2Var;
            byte[] bArrD2 = d(v1Var.a);
            byte b3 = v1Var.b;
            byte b4 = v1Var.c;
            byte b5 = v1Var.d;
            byte b6 = v1Var.e;
            byte b7 = (byte) v1Var.f;
            Boolean bool = v1Var.g;
            ...
            bArrE = e(bArrD2, (byte) 4, new byte[]{0, b3, 0, b4, b5, b6, b7, b, v1Var.h});
        } else if (d2Var instanceof r1) {
            r1 r1Var = (r1) d2Var;
            String str = r1Var.a;
            g1 g1Var = r1Var.b;
            String str2 = g1Var.a;
    ...
    public static d2 b(byte[] bArr) {
        ...
        while (true) {
            ...
            if (i4 >= iZ) {
                ...
                if (bY != 1) {
                    if (bY == 2) {
                        return new z3(f(bArrA), bArrA2);
                    }
                    if (bY == 3) {
                        return new e4(f(bArrA));
                    }
                    if (bY == 4) {
                        return new c1(f(bArrA));
                    }
                    if (bY == 7) {
                        org.msgpack.core.i iVarA2 = org.msgpack.core.h.a(bArrA2);
                        int iZ2 = iVarA2.Z();
                        List listC = kotlin.collections.w.e;
                        List listC2 = listC;
                        while (i3 < iZ2) {
                    ...
                    org.msgpack.core.i iVarA3 = org.msgpack.core.h.a(bArrA2);
                ...
                String strF = f(bArrA);
                org.msgpack.core.i iVarA4 = org.msgpack.core.h.a(bArrA2);
                int iZ4 = iVarA4.Z();
                int i7 = 0;
                byte bY2 = 0;
                String strA0 = "";
                                    ...
                                    if (i8 > 127 && i8 < 224) {
                                        ...
                                        switch (b) {
                                            case -52:
                                                ...
                                                break;
                                            case -51:
                                                i = iVarA4.x(2).getShort(iVarA4.H) & 65535;
                                                break;
                                            case -50:
                                                int i9 = iVarA4.x(4).getInt(iVarA4.H);
                                                i = i9;
                                                if (i9 < 0) {
                                            ...
                                            case -48:
                                                ...
                                                break;
                                            case -47:
                                                i = iVarA4.x(2).getShort(iVarA4.H);
                                                break;
                                            case -46:
                                                i = iVarA4.x(4).getInt(iVarA4.H);
                                                break;
                                            case -45:
                                                j = iVarA4.x(8).getLong(iVarA4.H);
            ...
            if (str != null) {
                ...
                if (iHashCode2 != -786701938) {
                    if (iHashCode2 != 3355) {
                        ...
                        bArrA = iVarA.A(iVarA.X());
                    }
                } else if (str.equals("payload")) {
                    bArrA2 = iVarA.A(iVarA.X());
                }
            }
            i4++;
        }
        ...
        for (int i = 0; i < iN; i++) {
            ...
            for (int i2 = 0; i2 < iZ; i2++) {
                ...
                if (kotlin.jvm.internal.l.a(lowerCase, "from")) {
                    eVar = new e(iVar.A(iVar.X()), tVar);
                } else if (kotlin.jvm.internal.l.a(lowerCase, "to")) {
                    eVar2 = new e(iVar.A(iVar.X()), tVar);
                }
            }
    ...
    public static byte[] d(String str) {
        ArrayList<String> arrayListY = kotlin.text.k.y(2, str);
        if (arrayListY.isEmpty() || kotlin.text.k.J((CharSequence) kotlin.collections.p.B(arrayListY))) {
            arrayListY = null;
        }
        if (arrayListY == null) {
            return new byte[0];
        }
        ArrayList arrayList = new ArrayList(kotlin.collections.r.p(arrayListY, 10));
        for (String str2 : arrayListY) {
    ...
    public static String f(byte[] bArr) {
        return kotlin.collections.o.x(bArr, "", new com.app.mlounge.ui.viewmodel.q0(5), 30);
    }
}
