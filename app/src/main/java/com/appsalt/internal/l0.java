...
public final class l0 implements i3 {
    ...
    public final Object c(String str, int i, t tVar, kotlin.coroutines.jvm.internal.c cVar) {
        ...
        try {
            ...
            this.h = BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(cVar.getContext()), null, null, new i0(this, socket2, this, null), 3, null);
            this.g = socket2;
    ...
    public final Object e(byte[] bArr, kotlin.coroutines.jvm.internal.c cVar) {
        Object objWithContext = BuildersKt.withContext(cVar.getContext(), new androidx.compose.animation.core.f(this, bArr, (kotlin.coroutines.d) null, 23), cVar);
