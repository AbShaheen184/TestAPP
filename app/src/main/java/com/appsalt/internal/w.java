        ...
        switch (this.e) {
            case 0:
                ...
                if (arrayList2.size() > 1) {
                    kotlin.collections.t.s(new s(i), arrayList2);
                }
                return arrayList2;
            default:
                kotlin.collections.w wVar = kotlin.collections.w.e;
                ...
                if (iE == 0) {
                    listJ = kotlin.collections.q.j(1);
                } else if (iE == 1) {
                    listJ = kotlin.collections.q.j(28);
                } else {
                    if (iE != 2) {
                        coil3.g.a();
                        return null;
                    }
                    listJ = kotlin.collections.q.k(1, 28);
                }
                ArrayList arrayList3 = new ArrayList();
                Iterator it = listJ.iterator();
                while (it.hasNext()) {
                    int iIntValue = ((Number) it.next()).intValue();
                    StringBuilder sbQ = androidx.compose.runtime.j.q("name=", URLEncoder.encode(str, "UTF-8"), "&do=false&ct=", URLEncoder.encode("application/dns-json", "UTF-8"), "&type=");
                    sbQ.append(iIntValue);
                    try {
                        HttpURLConnection httpURLConnection = (HttpURLConnection) new URI("https://cloudflare-dns.com/dns-query?".concat(sbQ.toString())).toURL().openConnection();
                        httpURLConnection.setConnectTimeout(1000);
                        httpURLConnection.setReadTimeout(1000);
                        httpURLConnection.setRequestMethod("GET");
                        httpURLConnection.setRequestProperty("Accept", "application/dns-json");
                        httpURLConnection.connect();
                        iterableB = httpURLConnection.getResponseCode() != 200 ? wVar : b(kotlin.collections.o.z(new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream(), kotlin.text.a.a), 8192)));
                    } catch (Throwable th) {
                    ...
                    kotlin.collections.p.t(arrayList3, iterableB);
                }
    ...
    public final kotlin.k c(int i, String str) {
        ...
        switch (this.e) {
            case 0:
                ...
                try {
                    lVar = (InetAddress) kotlin.collections.p.B(a(i, str));
                    break;
                } catch (Throwable th) {
                    lVar = new kotlin.l(th);
                }
            ...
            default:
                ...
                try {
                    lVar2 = (InetAddress) kotlin.collections.p.B(a(i, str));
                    break;
                } catch (Throwable th2) {
