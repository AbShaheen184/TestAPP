...
public final class x2 implements g5 {
    ...
    public x2(Context context) {
        ...
        androidx.media3.exoplayer.hls.c cVar = new androidx.media3.exoplayer.hls.c(context);
        this.a = cVar;
        String string = sharedPreferences.getString("uid", null);
        if (string == null) {
            string = kotlin.text.r.s(UUID.randomUUID().toString(), "-", "", false);
            sharedPreferences.edit().putString("uid", string).apply();
        }
        String str = string;
        String string2 = ((SharedPreferences) cVar.y).getString("apiKey", "");
        String string3 = sharedPreferences.getString("puid", null);
        if (string3 == null) {
            string3 = kotlin.text.r.s(UUID.randomUUID().toString(), "-", "", false);
  ...
  0x0082: PHI (r1v8 int) = (r1v0 int), (r1v6 int) binds: [B:40:0x0080, B:43:0x0089] A[DONT_GENERATE, DONT_INLINE]] */
    public final q0 a() {
        ...
        return new q0(boolValueOf2, numValueOf2, boolValueOf3, boolValueOf4, boolValueOf5, i3, numValueOf);
    }
}
