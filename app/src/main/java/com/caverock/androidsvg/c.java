...
public final class c extends androidx.compose.ui.text.android.selection.e {
    ...
    /* JADX WARN: Type inference failed for: r11v10, types: [com.caverock.androidsvg.n] */
    /* JADX WARN: Type inference failed for: r11v11 */
    /* JADX WARN: Type inference failed for: r11v12, types: [com.caverock.androidsvg.n] */
    /* JADX WARN: Type inference failed for: r11v13, types: [com.caverock.androidsvg.n] */
    /* JADX WARN: Type inference failed for: r11v14, types: [com.caverock.androidsvg.n] */
    /* JADX WARN: Type inference failed for: r11v15, types: [com.caverock.androidsvg.n] */
    /* JADX WARN: Type inference failed for: r11v16, types: [com.caverock.androidsvg.n] */
    ...
    /* JADX WARN: Type inference failed for: r11v9, types: [com.caverock.androidsvg.n] */
    ...
    /* JADX WARN: Type inference failed for: r9v18, types: [com.caverock.androidsvg.n] */
    ...
    /* JADX WARN: Type inference failed for: r9v25, types: [com.caverock.androidsvg.n] */
                    ...
                    if (m(':')) {
                        ...
                        switch (hVar.ordinal()) {
                            ...
                            case 7:
                                ...
                                break;
                            case 8:
                                f fVar4 = new f(0, 1, true, true, nVar3.b);
                                mVar.a();
                                r9 = nVar3;
                                obj = fVar4;
                                if (r9.d == null) {
                                ...
                                break;
                            case 9:
                                fVar = new f(0, 1, false, true, nVar3.b);
                                mVar.a();
                                r14 = nVar3;
                                obj = fVar;
                                r9 = r14;
                                ...
                                if (q()) {
                                    ...
                                    if (m('(')) {
                                        ...
                                        if (arrayListV != null && m(')')) {
                                            ...
                                            while (it.hasNext() && (arrayList2 = ((m) it.next()).a) != null) {
                                                Iterator it2 = arrayList2.iterator();
                                                while (true) {
                                                    if (it2.hasNext() && (arrayList3 = ((n) it2.next()).d) != null) {
