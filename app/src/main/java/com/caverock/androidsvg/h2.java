...
public final class h2 {
    ...
    public static void C(q0 q0Var, String str, String str2) {
        ...
        if (iOrdinal == 1) {
            if (!DebugKt.DEBUG_PROPERTY_VALUE_AUTO.equals(str2) && str2.startsWith("rect(")) {
                ...
                eVar.R();
                if (eVar.m(')') || eVar.q()) {
                    nVar = new com.google.firebase.messaging.n(19, false);
                    nVar.y = c0VarU;
                    nVar.z = c0VarU2;
                    nVar.A = c0VarU3;
                    nVar.B = c0VarU4;
        ...
        if (iOrdinal == 4) {
            q0Var.h0 = "nonzero".equals(str2) ? 1 : "evenodd".equals(str2) ? 2 : 0;
            q0Var.e |= 536870912;
        }
        try {
            if (iOrdinal == 5) {
            ...
            switch (iOrdinal) {
                case 14:
                    if (str2.indexOf(Token.IMPORT) < 0) {
                        if ("|inline|block|list-item|run-in|compact|marker|table|inline-table|table-row-group|table-header-group|table-footer-group|table-row|table-column-group|table-column|table-cell|table-caption|none|".contains("|" + str2 + '|')) {
                            q0Var.Q = Boolean.valueOf(!str2.equals("none"));
                            q0Var.e |= 16777216;
                            break;
                        }
                    }
                    ...
                    if ("|caption|icon|menu|message-box|small-caption|status-bar|".contains("|" + str2 + '|')) {
                        ...
                        while (true) {
                            ...
                            if (strG == null) {
                                ...
                                if (!strG.equals("normal") && (num != null || (num = (Integer) c2.a.get(strG)) == null)) {
                                    if (i10 == 0) {
                                        switch (strG) {
                                            case "oblique":
                                                i10 = 3;
                        ...
                        q0Var.I = q(strSubstring);
                        q0Var.J = c0VarS;
                        q0Var.K = Integer.valueOf(num == null ? 400 : num.intValue());
                        q0Var.d0 = i10 == 0 ? 1 : i10;
                        q0Var.e |= 122880;
                        break;
                    }
                    break;
                ...
                case 20:
                    try {
                        c0 c0Var = (c0) b2.a.get(str2);
                        c0VarS2 = c0Var == null ? s(str2) : c0Var;
                    } catch (y1 unused2) {
                        c0VarS2 = null;
                    }
                    q0Var.J = c0VarS2;
                    ...
                    break;
                case 21:
                    Integer num2 = (Integer) c2.a.get(str2);
                    q0Var.K = num2;
                    if (num2 != null) {
                        q0Var.e |= 32768;
                    }
                            ...
                            switch (iOrdinal) {
                                ...
                                case Token.ENUM_INIT_ARRAY /* 65 */:
                                    if (!"none".equals(str2)) {
                                        ...
                                        eVar3.R();
                                        if (eVar3.q() || (c0VarD = eVar3.D()) == null || c0VarD.f()) {
                                            c0VarArr = null;
                                        } else {
                                            float f = c0VarD.e;
                                            ...
                                            while (true) {
                                                if (!eVar3.q()) {
                                                    eVar3.Q();
                                                    c0 c0VarD2 = eVar3.D();
                                                    if (c0VarD2 != null && !c0VarD2.f()) {
                                                        arrayList.add(c0VarD2);
                                                        f += c0VarD2.e;
                                                    }
                                                } else if (f != 0.0f) {
                                                    c0VarArr = (c0[]) arrayList.toArray(new c0[arrayList.size()]);
                                                }
                                                c0VarArr = null;
                                            }
                                        }
                                ...
                                default:
                                    switch (iOrdinal) {
                                        ...
                                        case 89:
                                            q0Var.Z = v(str2);
                                            q0Var.e |= 17179869184L;
                                            break;
                                        case Token.TRY /* 90 */:
                                            if (str2.indexOf(Token.IMPORT) < 0) {
                                                if ("|visible|hidden|collapse|".contains("|" + str2 + '|')) {
                                                    q0Var.R = Boolean.valueOf(str2.equals("visible"));
                                                    q0Var.e |= 33554432;
                                                    break;
                                                }
                                            }
    ...
    public static void f(s0 s0Var, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            int iC = androidx.room.b0.c(attributes, i);
            if (iC != 73) {
                switch (iC) {
                    case Token.SHNE /* 52 */:
                    ...
                    case Token.THROW /* 55 */:
                        ...
                        s0Var.g(arrayListQ != null ? new HashSet(arrayListQ) : new HashSet(0));
                        break;
                }
            } else {
    ...
    public static void g(w0 w0Var, Attributes attributes) throws y1 {
        for (int i = 0; i < attributes.getLength(); i++) {
            String qName = attributes.getQName(i);
            if (qName.equals("id") || qName.equals("xml:id")) {
                w0Var.c = attributes.getValue(i).trim();
                return;
            }
            if (qName.equals("xml:space")) {
                String strTrim = attributes.getValue(i).trim();
                if ("default".equals(strTrim)) {
                    w0Var.d = Boolean.FALSE;
                    return;
                } else {
                    if (!"preserve".equals(strTrim)) {
                        throw new y1(androidx.compose.runtime.j.i("Invalid value for \"xml:space\" attribute: ", strTrim));
                    }
                    w0Var.d = Boolean.TRUE;
                    return;
                }
            }
        }
    ...
    public static void h(x xVar, Attributes attributes) throws y1 {
        int i;
        for (int i2 = 0; i2 < attributes.getLength(); i2++) {
            String strTrim = attributes.getValue(i2).trim();
            int iC = androidx.room.b0.c(attributes, i2);
            if (iC == 23) {
                xVar.j = z(strTrim);
            } else if (iC != 24) {
                if (iC != 26) {
                        ...
                        if (strTrim != null) {
                            try {
                                if (strTrim.equals("pad")) {
                                    ...
                                    kotlinx.coroutines.future.a.q("No enum constant com.caverock.androidsvg.SVG.GradientSpread.".concat(strTrim));
                                }
                                xVar.k = i;
                            } catch (IllegalArgumentException unused) {
                                throw new y1(androidx.privacysandbox.ads.adservices.java.internal.a.r("Invalid spreadMethod attribute. \"", strTrim, "\" is not a valid value."));
                            }
                        } else {
                ...
                if (!"userSpaceOnUse".equals(strTrim)) {
                    androidx.transition.k.p("Invalid value for attribute gradientUnits");
                    return;
                }
                xVar.i = Boolean.TRUE;
            }
    ...
    public static void i(l0 l0Var, Attributes attributes, String str) throws y1 {
        for (int i = 0; i < attributes.getLength(); i++) {
            if (e2.a(attributes.getLocalName(i)) == e2.y) {
                ...
                while (!eVar.q()) {
                    float fC = eVar.C();
                    if (Float.isNaN(fC)) {
                        throw new y1(androidx.privacysandbox.ads.adservices.java.internal.a.r("Invalid <", str, "> points attribute. Non-coordinate content found in list."));
                    }
                    eVar.Q();
                    float fC2 = eVar.C();
                    if (Float.isNaN(fC2)) {
                        throw new y1(androidx.privacysandbox.ads.adservices.java.internal.a.r("Invalid <", str, "> points attribute. There should be an even number of coordinates."));
                    }
                    eVar.Q();
                    arrayList.add(Float.valueOf(fC));
                    arrayList.add(Float.valueOf(fC2));
                }
                l0Var.o = new float[arrayList.size()];
                Iterator it = arrayList.iterator();
                int i2 = 0;
                while (it.hasNext()) {
                    l0Var.o[i2] = ((Float) it.next()).floatValue();
                    i2++;
                }
            }
        }
    ...
    public static void j(w0 w0Var, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (strTrim.length() != 0) {
                int iC = androidx.room.b0.c(attributes, i);
                if (iC == 0) {
                    ...
                    C(w0Var.e, attributes.getLocalName(i), attributes.getValue(i).trim());
                } else {
    ...
    public static void k(l1 l1Var, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            int iC = androidx.room.b0.c(attributes, i);
            if (iC == 9) {
    ...
    public static void l(a0 a0Var, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            if (e2.a(attributes.getLocalName(i)) == e2.z) {
                a0Var.k(z(attributes.getValue(i)));
            }
        }
    }

    public static void m(c1 c1Var, Attributes attributes) throws y1 {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            int iC = androidx.room.b0.c(attributes, i);
            if (iC == 48) {
                ...
                if (Float.isNaN(fC) || Float.isNaN(fC2) || Float.isNaN(fC3) || Float.isNaN(fC4)) {
                    androidx.transition.k.p("Invalid viewBox definition - should have four numbers");
                    return;
                } else if (fC3 < 0.0f) {
                    androidx.transition.k.p("Invalid viewBox. width cannot be negative");
                    return;
                } else {
                    if (fC4 < 0.0f) {
                        androidx.transition.k.p("Invalid viewBox. height cannot be negative");
                        return;
                    }
                    c1Var.o = new androidx.compose.ui.geometry.a(fC, fC2, fC3, fC4);
                }
            }
        }
    }

    public static t n(String str) throws y1 {
        long j;
        int i;
        if (str.charAt(0) == '#') {
            ...
            if (hVar == null) {
                throw new y1("Bad hex colour value: ".concat(str));
            }
            long j3 = hVar.b;
            int i3 = hVar.a;
            if (i3 == 4) {
                ...
                int i6 = i4 & 240;
                int i7 = i4 & 15;
                return new t(i7 | (i5 << 8) | (-16777216) | (i5 << 12) | (i6 << 8) | (i6 << 4) | (i7 << 4));
            }
            if (i3 != 5) {
                if (i3 == 7) {
                    return new t(((int) j3) | (-16777216));
                }
                if (i3 != 9) {
                    throw new y1("Bad hex colour value: ".concat(str));
                }
                int i8 = (int) j3;
                return new t((i8 >>> 8) | (i8 << 24));
            }
            int i9 = (int) j3;
            int i10 = 61440 & i9;
            int i11 = i9 & 3840;
            int i12 = i9 & 240;
            int i13 = i9 & 15;
            return new t((i13 << 24) | (i13 << 28) | (i10 << 8) | (i10 << 4) | (i11 << 4) | i11 | i12 | (i12 >> 4));
        }
        ...
        if (zStartsWith || lowerCase.startsWith("rgb(")) {
            ...
            if (!zStartsWith) {
                eVar.R();
                if (Float.isNaN(fK2) || !eVar.m(')')) {
                    throw new y1("Bad rgb() colour value: ".concat(str));
                }
                return new t((b(fC) << 16) | (-16777216) | (b(fK) << 8) | b(fK2));
            }
            float fK3 = eVar.k(fK2);
            eVar.R();
            if (Float.isNaN(fK3) || !eVar.m(')')) {
                throw new y1("Bad rgba() colour value: ".concat(str));
            }
            return new t((b(fK3 * 256.0f) << 24) | (b(fC) << 16) | (b(fK) << 8) | b(fK2));
        }
        boolean zStartsWith2 = lowerCase.startsWith("hsla(");
        if (!zStartsWith2 && !lowerCase.startsWith("hsl(")) {
            Integer num = (Integer) a2.a.get(lowerCase);
            if (num != null) {
                return new t(num.intValue());
            }
            throw new y1("Invalid colour keyword: ".concat(lowerCase));
        }
        ...
        if (!zStartsWith2) {
            ...
            if (Float.isNaN(fK5) || !eVar2.m(')')) {
                throw new y1("Bad hsl() colour value: ".concat(str));
            }
            return new t(d(fC2, fK4, fK5) | (-16777216));
        }
        float fK6 = eVar2.k(fK5);
        eVar2.R();
        if (Float.isNaN(fK6) || !eVar2.m(')')) {
            throw new y1("Bad hsla() colour value: ".concat(str));
        }
        return new t((b(fK6 * 256.0f) << 24) | d(fC2, fK4, fK5));
    }

    public static float o(int i, String str) throws y1 {
        float fA = new o().a(0, i, str);
        if (Float.isNaN(fA)) {
            throw new y1(androidx.compose.runtime.j.i("Invalid float value: ", str));
        }
        return fA;
    }

    public static float p(String str) throws y1 {
        int length = str.length();
        if (length != 0) {
            return o(length, str);
        }
        androidx.transition.k.p("Invalid float value (empty string)");
        return 0.0f;
    }
    ...
    public static c0 s(String str) throws y1 {
        int iM;
        if (str.length() == 0) {
            androidx.transition.k.p("Invalid length value (empty string)");
            return null;
        }
        int length = str.length();
        ...
        if (cCharAt == '%') {
            ...
            length -= 2;
            try {
                iM = androidx.room.b0.m(str.substring(length).toLowerCase(Locale.US));
            } catch (IllegalArgumentException unused) {
                throw new y1("Invalid length unit specifier: ".concat(str));
            }
        } else {
            iM = 1;
        }
        try {
            return new c0(iM, o(length, str));
        } catch (NumberFormatException e) {
            throw new y1("Invalid length value: ".concat(str), e);
        }
    }

    public static ArrayList t(String str) throws y1 {
        if (str.length() == 0) {
            androidx.transition.k.p("Invalid length list (empty string)");
            return null;
        }
        ...
        while (!eVar.q()) {
            ...
            if (Float.isNaN(fC)) {
                ...
                throw new y1(sb.toString());
            }
            int iH = eVar.H();
            if (iH == 0) {
                iH = 1;
            }
            arrayList.add(new c0(iH, fC));
            eVar.Q();
        }
        return arrayList;
    }

    public static c0 u(androidx.compose.ui.text.android.selection.e eVar) {
        return eVar.n(DebugKt.DEBUG_PROPERTY_VALUE_AUTO) ? new c0(0.0f) : eVar.D();
    }
    ...
    public static z0 w(String str) {
        ...
        return new h0(strTrim, z0Var);
    }

    public static void x(a1 a1Var, String str) throws y1 {
        int i;
        androidx.compose.ui.text.android.selection.e eVar = new androidx.compose.ui.text.android.selection.e(str);
        eVar.R();
        String strF = eVar.F();
        ...
        if (eVar.q()) {
            ...
            if (strF2.equals("meet")) {
                ...
                if (!strF2.equals("slice")) {
                    throw new y1("Invalid preserveAspectRatio definition: ".concat(str));
                }
                i = 2;
            }
        }
        a1Var.n = new q(pVar, i);
    }
    ...
    public static Matrix z(String str) throws y1 {
        ...
        while (!eVar.q()) {
            ...
            if (strSubstring == null) {
                throw new y1("Bad transform function encountered in transform list: ".concat(str));
            }
            switch (strSubstring) {
                case "matrix":
                    eVar.R();
                    ...
                    if (Float.isNaN(fC6) || !eVar.m(')')) {
                        throw new y1("Invalid transform list: ".concat(str));
                    }
                ...
                case "translate":
                    ...
                    break;
                default:
                    throw new y1(androidx.privacysandbox.ads.adservices.java.internal.a.r("Invalid transform list fn: ", strSubstring, ")"));
            }
            if (eVar.q()) {
                return matrix;
            }
    ...
    public final void A(InputStream inputStream) throws y1 {
        ...
        try {
            ...
            throw new y1("Stream error", e);
        } catch (ParserConfigurationException e2) {
            throw new y1("XML parser problem", e2);
        } catch (SAXException e3) {
            throw new y1("SVG parse error", e3);
        }
    }

    public final void B(InputStream inputStream) throws y1 {
        try {
            try {
                XmlPullParser xmlPullParserNewPullParser = Xml.newPullParser();
                g2 g2Var = new g2();
                g2Var.a = xmlPullParserNewPullParser;
                ...
                for (int eventType = xmlPullParserNewPullParser.getEventType(); eventType != 1; eventType = xmlPullParserNewPullParser.nextToken()) {
                    if (eventType == 0) {
                        ...
                        if (((r0) this.a.y) == null && xmlPullParserNewPullParser.getText().contains("<!ENTITY ")) {
                            try {
                        ...
                        E(xmlPullParserNewPullParser.getNamespace(), xmlPullParserNewPullParser.getName(), name, g2Var);
                    } else if (eventType == 3) {
    ...
    public final void D() {
        androidx.appcompat.widget.c2 c2Var = new androidx.appcompat.widget.c2(28, false);
        c2Var.y = null;
        c2Var.z = new androidx.compose.ui.graphics.vector.g(3);
        c2Var.A = new HashMap();
        this.a = c2Var;
    }
    ...
    public final void E(String str, String str2, String str3, Attributes attributes) throws y1 {
        int i;
        int iIntValue;
        float fC;
        float f;
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || "".equals(str)) {
            f2 f2Var = (f2) f2.B.get(str2.length() > 0 ? str2 : str3);
            if (f2Var == null) {
                f2Var = f2.A;
            }
            int i3 = 0;
            switch (f2Var.ordinal()) {
                case 0:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC = androidx.room.b0.c(attributes, i3);
                        if (iC == 25) {
                            c0 c0VarS = s(strTrim);
                            r0Var.s = c0VarS;
                            if (c0VarS.f()) {
                                androidx.transition.k.p("Invalid <svg> element. height cannot be negative");
                                return;
                            }
                        } else if (iC != 79) {
                            switch (iC) {
                                case Token.EXP /* 81 */:
                                    c0 c0VarS2 = s(strTrim);
                                    r0Var.r = c0VarS2;
                                    if (c0VarS2.f()) {
                                        androidx.transition.k.p("Invalid <svg> element. width cannot be negative");
                                        return;
                                    }
                                    break;
                                    break;
                ...
                case 7:
                    if (this.b == null) {
                        androidx.transition.k.p("Invalid document. Root element must be <svg>");
                        return;
                    }
                    z zVar = new z();
                    zVar.a = this.a;
                ...
                case 2:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC2 = androidx.room.b0.c(attributes, i3);
                        if (iC2 == 6) {
                            rVar.o = s(strTrim2);
                        } else if (iC2 == 7) {
                            rVar.p = s(strTrim2);
                            ...
                            c0 c0VarS3 = s(strTrim2);
                            rVar.q = c0VarS3;
                            if (c0VarS3.f()) {
                                androidx.transition.k.p("Invalid <circle> element. r cannot be negative");
                                return;
                            }
                        }
                        i3++;
                ...
                case 3:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        if (androidx.room.b0.c(attributes, i3) == 3) {
                            if ("objectBoundingBox".equals(strTrim3)) {
                                sVar.o = Boolean.FALSE;
                            } else {
                                if (!"userSpaceOnUse".equals(strTrim3)) {
                                    androidx.transition.k.p("Invalid value for attribute clipPathUnits");
                                    return;
                                }
                                sVar.o = Boolean.TRUE;
                            }
                ...
                case 6:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC3 = androidx.room.b0.c(attributes, i3);
                        if (iC3 == 6) {
                            wVar.o = s(strTrim4);
                        } else if (iC3 == 7) {
                            wVar.p = s(strTrim4);
                        } else if (iC3 == 56) {
                            c0 c0VarS4 = s(strTrim4);
                            wVar.q = c0VarS4;
                            if (c0VarS4.f()) {
                                androidx.transition.k.p("Invalid <ellipse> element. rx cannot be negative");
                                return;
                            }
                        } else if (iC3 != 57) {
                            continue;
                        } else {
                            c0 c0VarS5 = s(strTrim4);
                            wVar.r = c0VarS5;
                            if (c0VarS5.f()) {
                                androidx.transition.k.p("Invalid <ellipse> element. ry cannot be negative");
                                return;
                            }
                        }
                        i3++;
                ...
                case 8:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC4 = androidx.room.b0.c(attributes, i3);
                        if (iC4 == 25) {
                            c0 c0VarS6 = s(strTrim5);
                            b0Var.s = c0VarS6;
                            if (c0VarS6.f()) {
                                androidx.transition.k.p("Invalid <use> element. height cannot be negative");
                                return;
                            }
                        } else if (iC4 != 26) {
                            if (iC4 != 48) {
                                switch (iC4) {
                                    case Token.EXP /* 81 */:
                                        c0 c0VarS7 = s(strTrim5);
                                        b0Var.r = c0VarS7;
                                        if (c0VarS7.f()) {
                                            androidx.transition.k.p("Invalid <use> element. width cannot be negative");
                                            return;
                                        }
                                        break;
                                        break;
                ...
                case 9:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        switch (androidx.room.b0.c(attributes, i3)) {
                ...
                case 11:
                    ...
                    for (int i4 = 0; i4 < attributes.getLength(); i4++) {
                        ...
                        int iC5 = androidx.room.b0.c(attributes, i4);
                        if (iC5 != 41) {
                            if (iC5 == 50) {
                                e0Var.q = s(strTrim8);
                            } else if (iC5 != 51) {
                                switch (iC5) {
                                    case 32:
                                        c0 c0VarS8 = s(strTrim8);
                                        e0Var.t = c0VarS8;
                                        if (c0VarS8.f()) {
                                            androidx.transition.k.p("Invalid <marker> element. markerHeight cannot be negative");
                                            return;
                                        }
                                        break;
                                        break;
                                    case Token.GETPROP /* 33 */:
                                        if ("strokeWidth".equals(strTrim8)) {
                                            ...
                                            if (!"userSpaceOnUse".equals(strTrim8)) {
                                                androidx.transition.k.p("Invalid value for attribute markerUnits");
                                                return;
                                            }
                                            e0Var.p = true;
                                        }
                                    ...
                                    case Token.GETPROPNOWARN /* 34 */:
                                        c0 c0VarS9 = s(strTrim8);
                                        e0Var.s = c0VarS9;
                                        if (c0VarS9.f()) {
                                            androidx.transition.k.p("Invalid <marker> element. markerWidth cannot be negative");
                                            return;
                                        }
                                        break;
                                        break;
                            ...
                            e0Var.u = Float.valueOf(Float.NaN);
                        } else {
                            e0Var.u = Float.valueOf(p(strTrim8));
                        }
                    }
                    this.b.b(e0Var);
                    this.b = e0Var;
                ...
                case 12:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC6 = androidx.room.b0.c(attributes, i3);
                        if (iC6 == 25) {
                            c0 c0VarS10 = s(strTrim9);
                            f0Var.q = c0VarS10;
                            if (c0VarS10.f()) {
                                androidx.transition.k.p("Invalid <mask> element. height cannot be negative");
                                return;
                            }
                        } else if (iC6 != 36) {
                            if (iC6 != 37) {
                                switch (iC6) {
                                    case Token.EXP /* 81 */:
                                        c0 c0VarS11 = s(strTrim9);
                                        f0Var.p = c0VarS11;
                                        if (c0VarS11.f()) {
                                            androidx.transition.k.p("Invalid <mask> element. width cannot be negative");
                                            return;
                                        }
                                        break;
                                        break;
                                ...
                                if (!"userSpaceOnUse".equals(strTrim9)) {
                                    androidx.transition.k.p("Invalid value for attribute maskUnits");
                                    return;
                                }
                            ...
                            if (!"userSpaceOnUse".equals(strTrim9)) {
                                androidx.transition.k.p("Invalid value for attribute maskContentUnits");
                                return;
                            }
                ...
                case 13:
                    ...
                    while (i6 < attributes.getLength()) {
                        ...
                        int iC7 = androidx.room.b0.c(attributes, i6);
                        float f5 = 0.0f;
                        if (iC7 == 13) {
                            ...
                            if (iC7 == 43 && p(strTrim10) < 0.0f) {
                                androidx.transition.k.p("Invalid <path> element. pathLength cannot be negative");
                                return;
                            }
                            i = i6;
                        }
                ...
                case 14:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC8 = androidx.room.b0.c(attributes, i3);
                        if (iC8 == 25) {
                            c0 c0VarS12 = s(strTrim11);
                            k0Var.v = c0VarS12;
                            if (c0VarS12.f()) {
                                androidx.transition.k.p("Invalid <pattern> element. height cannot be negative");
                                return;
                            }
                        } else if (iC8 != 26) {
                            switch (iC8) {
                                case Token.NAME /* 44 */:
                                    if ("objectBoundingBox".equals(strTrim11)) {
                                        ...
                                        if (!"userSpaceOnUse".equals(strTrim11)) {
                                            androidx.transition.k.p("Invalid value for attribute patternContentUnits");
                                            return;
                                        }
                                ...
                                case Token.STRING /* 46 */:
                                    if ("objectBoundingBox".equals(strTrim11)) {
                                        ...
                                        if (!"userSpaceOnUse".equals(strTrim11)) {
                                            androidx.transition.k.p("Invalid value for attribute patternUnits");
                                            return;
                                        }
                                ...
                                default:
                                    switch (iC8) {
                                        case Token.EXP /* 81 */:
                                            c0 c0VarS13 = s(strTrim11);
                                            k0Var.u = c0VarS13;
                                            if (c0VarS13.f()) {
                                                androidx.transition.k.p("Invalid <pattern> element. width cannot be negative");
                                                return;
                                            }
                                            break;
                                            break;
                ...
                case 17:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC9 = androidx.room.b0.c(attributes, i3);
                        if (iC9 == 6) {
                            b1Var.m = s(strTrim12);
                        } else if (iC9 == 7) {
                            b1Var.n = s(strTrim12);
                            ...
                            c0 c0VarS14 = s(strTrim12);
                            b1Var.o = c0VarS14;
                            if (c0VarS14.f()) {
                                androidx.transition.k.p("Invalid <radialGradient> element. r cannot be negative");
                                return;
                            }
                        }
                        i3++;
                ...
                case 18:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC10 = androidx.room.b0.c(attributes, i3);
                        if (iC10 == 25) {
                            c0 c0VarS15 = s(strTrim13);
                            n0Var.r = c0VarS15;
                            if (c0VarS15.f()) {
                                androidx.transition.k.p("Invalid <rect> element. height cannot be negative");
                                return;
                            }
                        } else if (iC10 == 56) {
                            c0 c0VarS16 = s(strTrim13);
                            n0Var.s = c0VarS16;
                            if (c0VarS16.f()) {
                                androidx.transition.k.p("Invalid <rect> element. rx cannot be negative");
                                return;
                            }
                        } else if (iC10 != 57) {
                            switch (iC10) {
                                case Token.EXP /* 81 */:
                                    c0 c0VarS17 = s(strTrim13);
                                    n0Var.q = c0VarS17;
                                    if (c0VarS17.f()) {
                                        androidx.transition.k.p("Invalid <rect> element. width cannot be negative");
                                        return;
                                    }
                                    break;
                                    break;
                            ...
                            c0 c0VarS18 = s(strTrim13);
                            n0Var.t = c0VarS18;
                            if (c0VarS18.f()) {
                                androidx.transition.k.p("Invalid <rect> element. ry cannot be negative");
                                return;
                            }
                        }
                        i3++;
                ...
                case 20:
                    ...
                    if (!(u0Var10 instanceof x)) {
                        androidx.transition.k.p("Invalid document. <stop> elements are only valid inside <linearGradient> or <radialGradient> elements.");
                        return;
                    }
                    p0 p0Var = new p0();
                    p0Var.a = this.a;
                    ...
                    for (int i8 = 0; i8 < attributes.getLength(); i8++) {
                        ...
                        if (androidx.room.b0.c(attributes, i8) == 39) {
                            if (strTrim14.length() == 0) {
                                androidx.transition.k.p("Invalid offset value in <stop> (empty string)");
                                return;
                            }
                            ...
                            try {
                                ...
                                p0Var.h = Float.valueOf(f21);
                            } catch (NumberFormatException e) {
                                throw new y1("Invalid offset value in <stop>: ".concat(strTrim14), e);
                            }
                        }
                    }
                    this.b.b(p0Var);
                ...
                case 21:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC11 = androidx.room.b0.c(attributes, i3);
                        if (iC11 == 38) {
                            str4 = strTrim15;
                        } else if (iC11 == 77) {
                ...
                case 25:
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC12 = androidx.room.b0.c(attributes, i3);
                        if (iC12 != 26) {
                            if (iC12 == 61) {
                                k1Var.o = s(strTrim16);
                            }
                    ...
                    this.b = k1Var;
                    u0 u0Var11 = k1Var.b;
                    if (u0Var11 instanceof h1) {
                        k1Var.p = (h1) u0Var11;
                        return;
                    } else {
                        k1Var.p = ((i1) u0Var11).d();
                        return;
                    }
                case 27:
                    u0 u0Var12 = this.b;
                    ...
                    if (!(u0Var12 instanceof j1)) {
                        androidx.transition.k.p("Invalid document. <tref> elements are only valid inside <text> or <tspan> elements.");
                        return;
                    }
                    f1 f1Var = new f1();
                    f1Var.a = this.a;
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        if (androidx.room.b0.c(attributes, i3) == 26 && ("".equals(attributes.getURI(i3)) || "http://www.w3.org/1999/xlink".equals(attributes.getURI(i3)))) {
                            f1Var.n = strTrim17;
                        }
                        i3++;
                    }
                    this.b.b(f1Var);
                    u0 u0Var13 = f1Var.b;
                    if (u0Var13 instanceof h1) {
                        f1Var.o = (h1) u0Var13;
                        return;
                    } else {
                        f1Var.o = ((i1) u0Var13).d();
                        return;
                    }
                case 28:
                    u0 u0Var14 = this.b;
                    ...
                    if (!(u0Var14 instanceof j1)) {
                        androidx.transition.k.p("Invalid document. <tspan> elements are only valid inside <text> or other <tspan> elements.");
                        return;
                    }
                    g1 g1Var = new g1();
                    g1Var.a = this.a;
                    ...
                    this.b = g1Var;
                    u0 u0Var15 = g1Var.b;
                    if (u0Var15 instanceof h1) {
                        g1Var.r = (h1) u0Var15;
                        return;
                    } else {
                        g1Var.r = ((i1) u0Var15).d();
                        return;
                    }
                case 29:
                    if (this.b == null) {
                    ...
                    while (i3 < attributes.getLength()) {
                        ...
                        int iC13 = androidx.room.b0.c(attributes, i3);
                        if (iC13 == 25) {
                            c0 c0VarS19 = s(strTrim18);
                            n1Var.s = c0VarS19;
                            if (c0VarS19.f()) {
                                androidx.transition.k.p("Invalid <use> element. height cannot be negative");
                                return;
    ...
    public final void a(String str) {
        t0 t0Var = (t0) this.b;
        int size = t0Var.i.size();
        y0 y0Var = size == 0 ? null : (y0) t0Var.i.get(size - 1);
        if (y0Var instanceof m1) {
            m1 m1Var = (m1) y0Var;
            m1Var.c = androidx.privacysandbox.ads.adservices.java.internal.a.u(new StringBuilder(), m1Var.c, str);
        } else {
            u0 u0Var = this.b;
            m1 m1Var2 = new m1();
            m1Var2.c = str;
            ...
            switch (f2Var.ordinal()) {
                ...
                case 21:
                    ...
                    if (sb != null) {
                        ...
                        c cVar = new c(string);
                        cVar.R();
                        ((androidx.compose.ui.graphics.vector.g) c2Var.z).h(eVar.e(cVar));
                        this.i.setLength(0);
                    }
                    break;
            }
