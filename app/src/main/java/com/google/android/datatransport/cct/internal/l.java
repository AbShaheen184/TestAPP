...
public final class l extends a {
    ...
    public final boolean equals(Object obj) {
        ...
        a aVar = (a) obj;
        if (!this.a.equals(((l) aVar).a)) {
            return false;
        }
        if (!this.b.equals(((l) aVar).b)) {
            return false;
        }
        if (!this.c.equals(((l) aVar).c)) {
            return false;
        }
        if (!this.d.equals(((l) aVar).d)) {
            return false;
        }
    ...
    public final String toString() {
        ...
        return androidx.privacysandbox.ads.adservices.java.internal.a.u(sb, this.l, "}");
    }
}
