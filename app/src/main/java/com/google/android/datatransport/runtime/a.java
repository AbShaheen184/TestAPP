...
public abstract /* synthetic */ class a {
    ...
    public static Number b(int i, com.google.gson.stream.a aVar) throws IOException {
        ...
        if (i == 2) {
            return new com.google.gson.internal.j(aVar.l0());
        }
        if (i == 3) {
    ...
    public static /* synthetic */ int h(Object obj) {
        ...
        kotlinx.coroutines.future.a.o("invalid tag type: ".concat(String.valueOf(obj.getClass())));
        return 0;
    }
    ...
    public static androidx.compose.ui.res.e o() {
        FlowKt.noImpl();
        return new androidx.compose.ui.res.e(10);
    }

    public static r1 p(r1 r1Var) {
        int size = r1Var.size();
    ...
    public static String r(String str, StringBuilder sb) {
        return str + ((Object) sb);
    }

    public static HashMap s(Class cls, com.google.firebase.encoders.proto.a aVar) {
