        ...
        try {
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    String strR = androidx.privacysandbox.ads.adservices.java.internal.a.r("Activity not found while launching ", pendingIntent.toString(), ".");
                    ...
                    Log.e("GoogleApiActivity", strR, e);
                }
                googleApiActivity.e = 1;
                finish();
