...
public final class e extends f {
    ...
    public static AlertDialog d(Activity activity, int i, com.google.android.gms.common.internal.p pVar, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Log.w("GoogleApiAvailability", androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Creating dialog for Google Play services availability issue. ConnectionResult="), new IllegalArgumentException());
    ...
    public final void f(Context context, int i, PendingIntent pendingIntent) {
        int i2;
        Log.w("GoogleApiAvailability", androidx.privacysandbox.ads.adservices.java.internal.a.q("GMS core API Availability. ConnectionResult=", i, ", tag=null"), new IllegalArgumentException());
        if (i == 18) {
