...
public final class a0 extends com.google.android.gms.internal.base.g {
    ...
    public final void handleMessage(Message message) {
        ...
        if (i4 == 3) {
            ...
            eVar.G.d(new com.google.android.gms.common.b(message.arg2, obj instanceof PendingIntent ? (PendingIntent) obj : null, null));
            System.currentTimeMillis();
            return;
        }
        if (i4 == 6) {
        ...
        int i5 = message.what;
        if (i5 != 2 && i5 != 1 && i5 != 7) {
            Log.wtf("GmsClient", androidx.compose.runtime.j.e(i5, "Don't know how to handle message: ", new StringBuilder(String.valueOf(i5).length() + 34)), new Exception());
            return;
        }
