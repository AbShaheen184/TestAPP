    ...
    public final boolean a() {
        ...
        try {
            ...
            if (!eVar.u().equals(interfaceDescriptor)) {
                String strU = eVar.u();
                Log.w("GmsClient", androidx.compose.runtime.j.n(new StringBuilder(strU.length() + 34 + String.valueOf(interfaceDescriptor).length()), "service descriptor mismatch: ", strU, " vs. ", interfaceDescriptor));
                return false;
            }
