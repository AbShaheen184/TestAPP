...
public abstract class e {
    ...
    public final void a(androidx.media3.exoplayer.dash.manifest.t tVar) {
        ((com.google.android.gms.common.api.internal.k) tVar.e).o.J.post(new z0(tVar, 14));
    }
        ...
        try {
            synchronized (this.E) {
                try {
                    t tVar = this.F;
                    if (tVar != null) {
                        tVar.a(new b0(this, this.T.get()), gVar);
                    } else {
    ...
    public final void m() {
        ...
        if (iB == 0) {
            g(new androidx.media3.exoplayer.hls.c(this));
            return;
        }
        y(1, null);
        this.G = new androidx.media3.exoplayer.hls.c(this);
        int i = this.T.get();
        a0 a0Var = this.C;
        ...
        synchronized (this.D) {
            try {
                ...
                if (i == 1) {
                    ...
                    c0 c0Var2 = this.J;
                    if (c0Var2 != null && (vVar = this.y) != null) {
                        String str2 = vVar.b;
                    ...
                    String strV = v();
                    boolean zW = w();
                    this.y = new androidx.room.v(2, strV, zW);
                    if (zW && i() < 17895000) {
