...
public final class b extends com.google.android.gms.internal.base.b implements a {
    ...
    public static Object J(a aVar) {
        ...
        if (i != 1) {
            ...
            kotlinx.coroutines.future.a.q(j.e(length, "Unexpected number of IObjectWrapper declared fields: ", new StringBuilder(String.valueOf(length).length() + 53)));
            return null;
        }
        x.g(field);
        if (field.isAccessible()) {
            kotlinx.coroutines.future.a.q("IObjectWrapper declared field not private!");
            return null;
        }
