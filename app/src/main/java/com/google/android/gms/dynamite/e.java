...
public final class e {
    ...
    public static final androidx.work.impl.model.f l = new androidx.work.impl.model.f(21);
    public static final com.google.android.gms.common.internal.k b = new com.google.android.gms.common.internal.k(21);
    public static final com.google.android.material.shape.f c = new com.google.android.material.shape.f(21);
    public static final com.google.firebase.heartbeatinfo.e d = new com.google.firebase.heartbeatinfo.e(21);
    ...
    public static e c(Context context, d dVar, String str) throws b {
        ...
        i iVar2;
        boolean z;
        com.google.android.gms.dynamic.a aVarJ2;
        Cursor cursor2;
        ...
        try {
            ...
            androidx.media3.container.j jVarG = dVar.g(context, str, l);
            int i5 = jVarG.a;
            int i6 = jVarG.b;
                ...
                if (i7 != -1) {
                    if (i7 == 1 || jVarG.b != 0) {
                        ...
                        try {
                                                ...
                                                try {
                                                    ...
                                                    if (bool.booleanValue()) {
                                                        ...
                                                        if (z) {
                                                            ...
                                                            aVarJ2 = kVar.K(new com.google.android.gms.dynamic.b(applicationContext2), str, i3, new com.google.android.gms.dynamic.b(cursor3));
                                                        } else {
                                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                                                            aVarJ2 = kVar.J(new com.google.android.gms.dynamic.b(applicationContext2), str, i3, new com.google.android.gms.dynamic.b(cursor3));
                                                        }
                                                        Context context2 = (Context) com.google.android.gms.dynamic.b.J(aVarJ2);
                                                        if (context2 == null) {
                                                        ...
                                                        Parcel parcelA = jVarH.a(jVarH.h(), 6);
                                                        i4 = parcelA.readInt();
                                                        parcelA.recycle();
                                                        if (i4 >= 3) {
                                                            ...
                                                            aVarJ = jVarH.M(new com.google.android.gms.dynamic.b(context), str, i3, new com.google.android.gms.dynamic.b(iVar.a));
                                                        } else if (i4 == 2) {
                                                            Log.w("DynamiteModule", "IDynamite loader version = 2");
                                                            aVarJ = jVarH.K(new com.google.android.gms.dynamic.b(context), str, i3);
                                                        } else {
                                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                                                            aVarJ = jVarH.J(new com.google.android.gms.dynamic.b(context), str, i3);
                                                        }
                                                        objJ = com.google.android.gms.dynamic.b.J(aVarJ);
                                                        if (objJ != null) {
                                                            throw new b("Failed to load remote module.");
                                                        }
                                                        eVar = new e((Context) objJ);
                                                    }
                                                    if (jLongValue == 0) {
                                                        k.remove();
                                                    } else {
                            ...
                            i2 = jVarG.a;
                            if (i2 != 0 || dVar.g(r7, str, new t2(i2)).c != -1) {
                                throw new b("Remote load failed. No local fallback found.", e);
                            }
                            Log.i("DynamiteModule", "Selected local version of ".concat(str));
                    ...
                    synchronized (e.class) {
                        ...
                        Parcel parcelA2 = jVarH.a(jVarH.h(), 6);
                        i4 = parcelA2.readInt();
                        parcelA2.recycle();
                        if (i4 >= 3) {
                            iVar = (i) threadLocal.get();
                                        ...
                                        if (bool2.equals(null)) {
                                            ...
                                            try {
                                                ...
                                                if (str2 != null && !str2.isEmpty()) {
                                                    ClassLoader classLoaderC0 = g.c0();
                                                    if (classLoaderC0 == null) {
                                                        if (Build.VERSION.SDK_INT >= 29) {
                                                            a.b();
                                                            String str3 = f;
                                                            x.g(str3);
                                                            classLoaderC0 = a.a(str3, ClassLoader.getSystemClassLoader());
                                                        } else {
                                                            String str4 = f;
                                                            x.g(str4);
                                                            classLoaderC0 = new h(str4, ClassLoader.getSystemClassLoader());
                                                        }
                                                    }
                                                    g(classLoaderC0);
                                                    declaredField.set(null, classLoaderC0);
                                                    e = bool2;
                                                    return iF;
                                                }
                                                return iF;
                ...
                try {
                    ...
                    try {
                        ...
                        if (i3 >= 3) {
                            ...
                            Cursor cursor3 = (Cursor) com.google.android.gms.dynamic.b.J(jVarH.L(new com.google.android.gms.dynamic.b(context), str, z, ((Long) k.get()).longValue()));
                            if (cursor3 != null) {
                                try {
                        ...
                        if (i3 == 2) {
                            ...
                            Parcel parcelA2 = jVarH.a(parcelH, 5);
                            i2 = parcelA2.readInt();
                            parcelA2.recycle();
                        } else {
                            ...
                            Parcel parcelA3 = jVarH.a(parcelH2, 3);
                            i2 = parcelA3.readInt();
                            parcelA3.recycle();
                        }
                        return i2;
