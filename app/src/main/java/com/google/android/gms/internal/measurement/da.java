...
public final /* synthetic */ class da implements Runnable {
    ...
    public final void run() {
        switch (this.e) {
            case 0:
                com.google.common.util.concurrent.x0 x0Var = (com.google.common.util.concurrent.x0) this.y;
                AtomicBoolean atomicBoolean = (AtomicBoolean) this.z;
                Context context = (Context) this.A;
                ca caVar = (ca) this.B;
                if ((x0Var.e instanceof com.google.common.util.concurrent.d) && atomicBoolean.compareAndSet(false, true)) {
                    try {
