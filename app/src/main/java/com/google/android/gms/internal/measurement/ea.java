...
public abstract class ea {
    ...
    public static int B(int i, byte[] bArr, int i2, int i3, s2 s2Var, p0 p0Var) throws t1 {
        if ((i >>> 3) == 0) {
            androidx.transition.k.r("Protocol message contained an invalid tag (zero).");
            return 0;
        }
        int i4 = i & 7;
        if (i4 == 0) {
        ...
        if (i4 == 2) {
            ...
            int i5 = p0Var.a;
            if (i5 < 0) {
                androidx.transition.k.r("CodedInputStream encountered an embedded string or message which claimed to have negative size.");
                return 0;
            }
            if (i5 > bArr.length - iA) {
                androidx.transition.k.r("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
                return 0;
            }
            if (i5 == 0) {
                s2Var.d(i, t0.y);
        ...
        p0Var.d = i7;
        if (i7 >= 100) {
            androidx.transition.k.r("Protocol message had too many levels of nesting.  May be malicious.  Use setRecursionLimit() to increase the recursion depth limit.");
            return 0;
        }
        int i8 = 0;
        while (i2 < i3) {
        ...
        p0Var.d--;
        if (i2 > i3 || i8 != i6) {
            androidx.transition.k.r("Failed to parse the message.");
            return 0;
        }
        s2Var.d(i, s2VarA);
        return i2;
    ...
    public static void c(String str, int i, List list) {
        ...
        androidx.transition.k.j(i, str, " operation requires ", list.size());
    }
    ...
    public static void f(String str, int i, List list) {
        ...
        androidx.transition.k.j(i, str, " operation requires at least ", list.size());
    }
    ...
    public static void h(String str, int i, ArrayList arrayList) {
        ...
        androidx.transition.k.j(i, str, " operation requires at most ", arrayList.size());
    }
    ...
    public static com.google.common.util.concurrent.r j(Context context, Callable callable, Executor executor) {
        ...
        ca caVar = new ca(atomicBoolean, context, x0Var, s5Var, executor);
        ...
        if (!s(context) || !atomicBoolean.compareAndSet(false, true)) {
            x0Var.a(new da(x0Var, atomicBoolean, context, caVar, 0), com.google.common.util.concurrent.d0.e);
            return x0Var;
        }
        try {
        ...
        com.google.common.util.concurrent.z0 z0Var2 = new com.google.common.util.concurrent.z0();
        z0Var2.F = new com.google.common.util.concurrent.y0(z0Var2, s5Var);
    ...
    public static m5 m(String str) {
        ...
        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Unsupported commandId ", str));
        return null;
    }
    ...
    public static Object u(d5 d5Var) {
        ...
        if (!(d5Var instanceof l1)) {
            return !d5Var.h().isNaN() ? d5Var.h() : d5Var.e();
        }
        ...
        while (i < l1Var.p()) {
            if (i >= l1Var.p()) {
                androidx.transition.k.m(androidx.compose.runtime.j.e(i, "Out of bounds index: ", new StringBuilder(String.valueOf(i).length() + 21)));
                return null;
            }
            int i2 = i + 1;
    ...
    public static void y(b7 b7Var) {
        ...
        if (iP <= 1000000) {
            ...
            kotlinx.coroutines.future.a.u("Instructions allowed exceeded");
        }
    }
