...
public final class f1 implements c2, com.google.android.gms.common.api.internal.h, com.google.common.base.q, com.google.android.gms.tasks.b, n1 {
        ...
        for (p9 p9Var : q9Var.A) {
            for (t9 t9Var : p9Var.y) {
                ...
                if (i == 1) {
                    ...
                    abVarA.g(str3);
                    if (i != 1) {
                        kotlinx.coroutines.future.a.q("Not a long type");
                        return null;
                    }
                    long j2 = t9Var.y;
                    abVarA.b();
                    ...
                    abVarA2.g(str3);
                    if (i != 2) {
                        kotlinx.coroutines.future.a.q("Not a boolean type");
                        return null;
                    }
                    boolean z3 = t9Var.z;
                    abVarA2.b();
                    ...
                    abVarA3.g(str3);
                    if (i != 3) {
                        kotlinx.coroutines.future.a.q("Not a double type");
                        return null;
                    }
                    double d = t9Var.A;
                    abVarA3.b();
                    ...
                    abVarA4.g(str3);
                    if (i != 4) {
                        kotlinx.coroutines.future.a.q("Not a String type");
                        return null;
                    }
                    String str4 = t9Var.B;
                    ...
                    if (i != 5) {
                        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.e(i, "Unrecognized flag type: ", new StringBuilder(String.valueOf(i).length() + 24)));
                        return null;
                    }
                    ab abVarA5 = bb.A();
                    abVarA5.g(str3);
                    if (i != 5) {
                        kotlinx.coroutines.future.a.q("Not a bytes type");
                        return null;
                    }
                    byte[] bArr2 = t9Var.C;
    ...
    public Object get() {
        switch (this.e) {
            case 12:
                ...
                return scheduledExecutorServiceNewSingleThreadScheduledExecutor instanceof com.google.common.util.concurrent.v0 ? (com.google.common.util.concurrent.v0) scheduledExecutorServiceNewSingleThreadScheduledExecutor : new com.google.common.util.concurrent.v0(scheduledExecutorServiceNewSingleThreadScheduledExecutor);
            default:
