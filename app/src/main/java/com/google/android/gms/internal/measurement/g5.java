...
public final class g5 implements Iterable, d5 {
    ...
    public g5(String str) {
        if (str != null) {
            ...
            kotlinx.coroutines.future.a.q("StringValue cannot be null.");
            throw null;
        }
    }
  ...
  0x02e4: PHI (r8v6 boolean) = (r8v12 boolean), (r8v13 boolean), (r8v16 boolean) binds: [B:100:0x02d0, B:101:0x02d2, B:103:0x02e2] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final d5 j(String str, b7 b7Var, ArrayList arrayList) {
        ...
        if ("charAt".equals(str) || "concat".equals(str) || "hasOwnProperty".equals(str) || "indexOf".equals(str) || "lastIndexOf".equals(str) || "match".equals(str) || "replace".equals(str) || "search".equals(str) || "slice".equals(str) || "split".equals(str) || "substring".equals(str) || "toLowerCase".equals(str) || "toLocaleLowerCase".equals(str) || "toString".equals(str) || "toUpperCase".equals(str) || "toLocaleUpperCase".equals(str)) {
            ...
            str2 = "trim";
            if (!str2.equals(str)) {
                kotlinx.coroutines.future.a.q(str.concat(" is not a String function"));
                return null;
            }
        }
        int iHashCode = str.hashCode();
        String strE = "undefined";
        String str3 = this.e;
        z = false;
        boolean z = false;
        switch (iHashCode) {
            case -1789698943:
                if (str.equals("hasOwnProperty")) {
                    ...
                    boolean zEquals = "length".equals(d5VarF.e());
                    b2 b2Var = d5.r;
                    if (zEquals) {
                        return b2Var;
                    }
                ...
                kotlinx.coroutines.future.a.q("Command not supported");
                return null;
            case -1776922004:
                ...
                if (str.equals("concat")) {
                    if (!arrayList.isEmpty()) {
                        ...
                        for (int i4 = 0; i4 < arrayList.size(); i4++) {
                            sb.append(((j5) b7Var.z).f(b7Var, (d5) arrayList.get(i4)).e());
                        }
            ...
            case -906336856:
                if (str.equals("search")) {
                    ...
                    Matcher matcher = Pattern.compile(arrayList.isEmpty() ? "undefined" : ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).e()).matcher(str3);
            ...
            case -467511597:
                if (str.equals("lastIndexOf")) {
                    ...
                    String strE2 = arrayList.size() > 0 ? ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).e() : "undefined";
                    double dDoubleValue2 = arrayList.size() < 2 ? Double.NaN : ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(1)).h().doubleValue();
                    return new j3(Double.valueOf(str3.lastIndexOf(strE2, (int) (Double.isNaN(dDoubleValue2) ? Double.POSITIVE_INFINITY : ea.r(dDoubleValue2)))));
                }
                kotlinx.coroutines.future.a.q("Command not supported");
                return null;
            case -399551817:
            ...
            case 103668165:
                if (str.equals("match")) {
                    ...
                    Matcher matcher2 = Pattern.compile(arrayList.size() <= 0 ? "" : ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).e()).matcher(str3);
            ...
            case 109648666:
                if (str.equals("split")) {
                    ...
                    if (arrayList.isEmpty()) {
                        ...
                        String strE3 = ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).e();
                        long jP = arrayList.size() > 1 ? ((long) ea.p(((j5) b7Var.z).f(b7Var, (d5) arrayList.get(1)).h().doubleValue())) & 4294967295L : 2147483647L;
                        if (jP == 0) {
                            return new l1();
                        }
                        String[] strArrSplit = str3.split(Pattern.quote(strE3), ((int) jP) + 1);
                        int length = strArrSplit.length;
                        if (!strE3.isEmpty() || length <= 0) {
                            i3 = zIsEmpty;
                            z = zIsEmpty;
                            i2 = length;
                            i3 = z;
            ...
            case 1094496948:
                if (str.equals("replace")) {
                    ...
                    d5 d5VarA = d5.m;
                    if (!zIsEmpty2) {
                        strE = ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).e();
                        if (arrayList.size() > 1) {
                    ...
                    if (iIndexOf >= 0) {
                        ...
                        String strE4 = d5VarA.e();
                        String strSubstring2 = str3.substring(str4.length() + iIndexOf);
                        return new g5(androidx.compose.runtime.j.m(new StringBuilder(strSubstring.length() + String.valueOf(strE4).length() + strSubstring2.length()), strSubstring, strE4, strSubstring2));
                    }
                    return this;
                }
                kotlinx.coroutines.future.a.q("Command not supported");
            ...
            case 1943291465:
                if (str.equals("indexOf")) {
                    ...
                    if (arrayList.size() <= 0) {
                        ...
                        b7Var2 = b7Var;
                        strE = ((j5) b7Var2.z).f(b7Var2, (d5) arrayList.get(0)).e();
                    }
                    return new j3(Double.valueOf(str3.indexOf(strE, (int) ea.r(arrayList.size() < 2 ? 0.0d : ((j5) b7Var2.z).f(b7Var2, (d5) arrayList.get(1)).h().doubleValue()))));
                }
                kotlinx.coroutines.future.a.q("Command not supported");
                return null;
            default:
    ...
    public final String toString() {
        String str = this.e;
        return androidx.compose.runtime.j.m(new StringBuilder(str.length() + 2), "\"", str, "\"");
    }
}
