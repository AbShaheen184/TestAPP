...
public final class ga extends a5 {
    public final com.google.android.datatransport.runtime.j y;

    public ga(com.google.android.datatransport.runtime.j jVar) {
        this.y = jVar;
    }
    ...
    public final d5 j(String str, b7 b7Var, ArrayList arrayList) {
        ...
        com.google.android.datatransport.runtime.j jVar = this.y;
        switch (iHashCode) {
            case 21624207:
                if (str.equals("getEventName")) {
                    ea.c("getEventName", 0, arrayList);
                    return new g5(((b) jVar.z).a);
                }
                break;
            case 45521504:
                if (str.equals("getTimestamp")) {
                    ea.c("getTimestamp", 0, arrayList);
                    return new j3(Double.valueOf(((b) jVar.z).b));
                }
                break;
            case 146575578:
                if (str.equals("getParamValue")) {
                    ea.c("getParamValue", 1, arrayList);
                    String strE = ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).e();
                    HashMap map = ((b) jVar.z).c;
                    return ka.b(map.containsKey(strE) ? map.get(strE) : null);
                }
                break;
            case 700587132:
                if (str.equals("getParams")) {
                    ea.c("getParams", 0, arrayList);
                    HashMap map2 = ((b) jVar.z).c;
                    a5 a5Var = new a5();
            ...
            case 920706790:
                if (str.equals("setParamValue")) {
                    ...
                    String strE2 = ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).e();
                    ...
                    map3.put(strE2, b.b(map3.get(strE2), objU, strE2));
                    return d5VarF;
                }
                break;
            case 1570616835:
                if (str.equals("setEventName")) {
                    ...
                    if (d5.m.equals(d5VarF2) || d5.n.equals(d5VarF2)) {
                        kotlinx.coroutines.future.a.q("Illegal event name");
                        return null;
                    }
                    ((b) jVar.z).a = d5VarF2.e();
                    return new g5(d5VarF2.e());
                }
                break;
        }
