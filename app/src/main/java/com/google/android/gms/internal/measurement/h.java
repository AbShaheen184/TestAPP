...
public abstract class h {
    ...
    public static d5 d(l1 l1Var, b7 b7Var, ArrayList arrayList, boolean z) {
        ...
        if (!(d5VarF instanceof c4)) {
            kotlinx.coroutines.future.a.q("Callback should be a method");
            return null;
        }
        if (arrayList.size() == 2) {
            d5VarA = ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(1));
            if (d5VarA instanceof r2) {
                kotlinx.coroutines.future.a.q("Failed to parse initial value");
                return null;
            }
        } else {
            if (l1Var.p() == 0) {
                kotlinx.coroutines.future.a.u("Empty array with no initial value error");
                return null;
            }
            d5VarA = null;
        }
        ...
        while ((i2 - i) * i3 >= 0) {
            if (l1Var.s(i)) {
                ...
                if (d5VarA instanceof r2) {
                    kotlinx.coroutines.future.a.u("Reduce operation failed");
                    return null;
                }
                i += i3;
            } else {
    ...
    public static l1 f(l1 l1Var, b7 b7Var, c5 c5Var, Boolean bool, Boolean bool2) {
        ...
        while (itO.hasNext()) {
            ...
            if (l1Var.s(iIntValue)) {
                ...
                if (d5VarA.d().equals(bool)) {
                    break;
                }
                if (bool2 == null || d5VarA.d().equals(bool2)) {
