...
public final class i5 {
    ...
    public static c5 c(b7 b7Var, List list) {
        ...
        if (!(d5VarF2 instanceof l1)) {
            kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("FN requires an ArrayValue of parameter names found ", d5VarF2.getClass().getCanonicalName()));
            return null;
        }
        List listM = ((l1) d5VarF2).m();
        List arrayList = new ArrayList();
        if (list.size() > 2) {
            arrayList = list.subList(2, list.size());
        }
        return new c5(d5VarF.e(), (ArrayList) listM, arrayList, b7Var);
    }

    public static boolean d(d5 d5Var, d5 d5Var2) {
        if (d5Var instanceof z4) {
            d5Var = new g5(d5Var.e());
        }
        if (d5Var2 instanceof z4) {
            d5Var2 = new g5(d5Var2.e());
        }
    ...
    public static d5 e(l5 l5Var, d5 d5Var, d5 d5Var2) {
        ...
        kotlinx.coroutines.future.a.q("Non-iterable type in for...of loop.");
        return null;
    }
    ...
    public static boolean f(d5 d5Var, d5 d5Var2) {
        if (d5Var.getClass().equals(d5Var2.getClass())) {
            ...
            if (d5Var instanceof g5) {
                return d5Var.e().equals(d5Var2.e());
            }
        ...
        switch (this.b) {
            ...
            case 2:
                ...
                if (iOrdinal2 == 2) {
                    ...
                    String strE = j5Var2.f(b7Var, (d5) arrayList.get(1)).e();
                    d5 d5VarF4 = j5Var2.f(b7Var, (d5) arrayList.get(2));
                    if (!(d5VarF4 instanceof l1)) {
                        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Function arguments for Apply are not a list found ", d5VarF4.getClass().getCanonicalName()));
                        return null;
                    }
                    if (!strE.isEmpty()) {
                        return d5VarF3.j(strE, b7Var, (ArrayList) ((l1) d5VarF4).m());
                    }
                    kotlinx.coroutines.future.a.q("Function name for apply is undefined");
                    return null;
                }
                if (iOrdinal2 == 15) {
                ...
                if (iOrdinal2 != 19) {
                    ...
                    if (iOrdinal2 == 60) {
                        ...
                        if (!(d5VarF9 instanceof l1)) {
                            kotlinx.coroutines.future.a.q("Malformed SWITCH statement, cases are not a list");
                            return null;
                        }
                        if (!(d5VarF10 instanceof l1)) {
                            kotlinx.coroutines.future.a.q("Malformed SWITCH statement, case statements are not a list");
                            return null;
                        }
                    ...
                    if (iOrdinal2 == 61) {
                        ...
                        return j5Var7.f(b7Var, d5Var5).d().booleanValue() ? j5Var8.f(b7Var, (d5) arrayList.get(1)) : j5Var8.f(b7Var, (d5) arrayList.get(2));
                    }
                    switch (iOrdinal2) {
                        case 11:
            ...
            case 3:
                ...
                if (iOrdinal3 == 47) {
                    ...
                    return new b2(Boolean.valueOf(!((j5) b7Var.z).f(b7Var, (d5) arrayList.get(0)).d().booleanValue()));
                }
                if (iOrdinal3 != 50) {
                    b(str);
                    throw null;
            ...
            case 4:
                ...
                if (iOrdinal4 == 65) {
                    ...
                    if (j5Var10.f(b7Var, d5Var8).d().booleanValue()) {
                    ...
                    while (j5Var10.f(b7Var, d5Var6).d().booleanValue()) {
                ...
                switch (iOrdinal4) {
                    case 26:
                        ...
                        if (!(arrayList.get(0) instanceof g5)) {
                            kotlinx.coroutines.future.a.q("Variable name in FOR_IN must be a string");
                            return null;
                        }
                        String strE2 = ((d5) arrayList.get(0)).e();
                    ...
                    case 27:
                        ...
                        if (arrayList.get(0) instanceof g5) {
                            return g(new l5(b7Var, ((d5) arrayList.get(0)).e(), 0), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(1)).b(), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(2)));
                        }
                        kotlinx.coroutines.future.a.q("Variable name in FOR_IN_CONST must be a string");
                        return null;
                    case 28:
                        ea.c("FOR_IN_LET", 3, arrayList);
                        if (!(arrayList.get(0) instanceof g5)) {
                            kotlinx.coroutines.future.a.q("Variable name in FOR_IN_LET must be a string");
                            return null;
                        }
                        String strE3 = ((d5) arrayList.get(0)).e();
                    ...
                    case 29:
                        ...
                        if (!(d5VarF21 instanceof l1)) {
                            kotlinx.coroutines.future.a.q("Initializer variables in FOR_LET must be an ArrayList");
                            return null;
                        }
                        ...
                        for (int i3 = 0; i3 < l1Var4.p(); i3++) {
                            String strE4 = l1Var4.q(i3).e();
                            b7VarD2.f(strE4, b7Var.h(strE4));
                        }
                        while (j5Var12.f(b7Var, d5Var12).d().booleanValue()) {
                            ...
                            for (int i4 = 0; i4 < l1Var4.p(); i4++) {
                                String strE5 = l1Var4.q(i4).e();
                                b7VarD3.f(strE5, b7VarD2.h(strE5));
                            }
                            b7VarD3.a(d5Var13);
                            b7VarD2 = b7VarD3;
                        }
                    ...
                    case 30:
                        ...
                        if (arrayList.get(0) instanceof g5) {
                            return e(new l5(b7Var, ((d5) arrayList.get(0)).e(), 2), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(1)), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(2)));
                        }
                        kotlinx.coroutines.future.a.q("Variable name in FOR_OF must be a string");
                        return null;
                    case 31:
                        ea.c("FOR_OF_CONST", 3, arrayList);
                        if (arrayList.get(0) instanceof g5) {
                            return e(new l5(b7Var, ((d5) arrayList.get(0)).e(), 0), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(1)), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(2)));
                        }
                        kotlinx.coroutines.future.a.q("Variable name in FOR_OF_CONST must be a string");
                        return null;
                    case 32:
                        ea.c("FOR_OF_LET", 3, arrayList);
                        if (arrayList.get(0) instanceof g5) {
                            return e(new l5(b7Var, ((d5) arrayList.get(0)).e(), 1), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(1)), ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(2)));
                        }
                        kotlinx.coroutines.future.a.q("Variable name in FOR_OF_LET must be a string");
                        return null;
                    default:
                        b(str);
                        throw null;
            ...
            case 5:
                ...
                if (iOrdinal5 == 0) {
                    ...
                    g5Var = ((d5VarF23 instanceof z4) || (d5VarF23 instanceof g5) || (d5VarF24 instanceof z4) || (d5VarF24 instanceof g5)) ? new g5(String.valueOf(d5VarF23.e()).concat(String.valueOf(d5VarF24.e()))) : new j3(Double.valueOf(d5VarF24.h().doubleValue() + d5VarF23.h().doubleValue()));
                } else {
                    if (iOrdinal5 == 21) {
            ...
            case 6:
                if (str == null || str.isEmpty() || !b7Var.e(str)) {
                    kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Command not found: ", str));
                    return null;
                }
                ...
                kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.r("Function ", str, " is not defined"));
                return null;
            default:
                m5 m5Var6 = m5.ADD;
                ...
                if (iOrdinal6 == 3) {
                    ...
                    if (!(d5VarF26 instanceof g5)) {
                        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Expected string for assign var. got ", d5VarF26.getClass().getCanonicalName()));
                        return null;
                    }
                    String str10 = ((g5) d5VarF26).e;
                    if (!b7Var.e(str10)) {
                        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Attempting to assign undefined value ", str10));
                        return null;
                    }
                ...
                if (iOrdinal6 == 14) {
                    ...
                    if (arrayList.size() % 2 != 0) {
                        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(arrayList.size(), "CONST requires an even number of arguments, found "));
                        return null;
                    }
                    while (i < arrayList.size() - 1) {
                        d5 d5VarF28 = ((j5) b7Var.z).f(b7Var, (d5) arrayList.get(i));
                        if (!(d5VarF28 instanceof g5)) {
                            kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Expected string for const name. got ", d5VarF28.getClass().getCanonicalName()));
                            return null;
                        }
                ...
                if (iOrdinal6 == 24) {
                    ...
                    while (i < arrayList.size()) {
                        ...
                        if (d5VarF29 instanceof r2) {
                            kotlinx.coroutines.future.a.u("ControlValue cannot be in an expression list");
                            return null;
                        }
                        i++;
                        l1Var = d5VarF29;
                    ...
                    if (iOrdinal6 == 33) {
                        ...
                        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Expected string for get var. got ", d5VarF30.getClass().getCanonicalName()));
                        return null;
                    }
                    if (iOrdinal6 == 49) {
                    ...
                    if (iOrdinal6 == 58) {
                        ...
                        if (d5VarF31 == d5.m || d5VarF31 == d5.n) {
                            kotlinx.coroutines.future.a.u(androidx.room.b0.e("Can't set property ", d5VarF32.e(), " of ", d5VarF31.e()));
                            return null;
                        }
                        if ((d5VarF31 instanceof l1) && (d5VarF32 instanceof j3)) {
                            ...
                            ((z4) d5VarF31).f(d5VarF32.e(), d5VarF33);
                        }
                        return d5VarF33;
                    }
                    if (iOrdinal6 != 17) {
                        if (iOrdinal6 != 18) {
                            if (iOrdinal6 == 35 || iOrdinal6 == 36) {
                                ...
                                if (d5VarF34 instanceof z4) {
                                    return ((z4) d5VarF34).c(d5VarF35.e());
                                }
                                if (d5VarF34 instanceof g5) {
                                    if ("length".equals(d5VarF35.e())) {
                                ...
                                case Token.ENUM_INIT_VALUES /* 64 */:
                                    ...
                                    while (it.hasNext()) {
                                        ...
                                        if (!(d5VarF37 instanceof g5)) {
                                            kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("Expected string for var name. got ", d5VarF37.getClass().getCanonicalName()));
                                            return null;
                                        }
                        ...
                        if (arrayList.size() % 2 != 0) {
                            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(arrayList.size(), "CREATE_OBJECT requires an even number of arguments, found "));
                            return null;
                        }
                        l1Var = new a5();
                        while (i < arrayList.size() - 1) {
                            ...
                            if ((d5VarF38 instanceof r2) || (d5VarF39 instanceof r2)) {
                                kotlinx.coroutines.future.a.u("Failed to evaluate map entry");
                                return null;
                            }
                            l1Var.f(d5VarF38.e(), d5VarF39);
                            i += 2;
                        }
                    } else {
                        if (arrayList.isEmpty()) {
                        ...
                        while (it2.hasNext()) {
                            ...
                            if (d5VarF40 instanceof r2) {
                                kotlinx.coroutines.future.a.u("Failed to evaluate array element");
                                return null;
                            }
                            l1Var.r(i, d5VarF40);
                            i++;
