...
public final class jb implements Comparable {
    ...
    public jb(long j, String str, int i, long j2, Object obj) {
        _COROUTINE.a.o(((j > 0L ? 1 : (j == 0L ? 0 : -1)) == 0) == (str != null));
        this.e = j;
        this.y = str;
        this.z = i;
        this.A = j2;
    ...
    public final Object a() {
        ...
        if (i != 5) {
            kotlinx.coroutines.future.a.o("Impossible, this was validated when parsed or created");
            return null;
        }
        obj.getClass();
        try {
    ...
    public final String toString() {
        ...
        return androidx.compose.runtime.j.m(new StringBuilder(String.valueOf(string).length() + 1 + strValueOf.length()), string, ":", strValueOf);
    }
}
