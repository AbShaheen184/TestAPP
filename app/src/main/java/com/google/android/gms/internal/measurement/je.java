...
public final class je {
    ...
    public je(Uri uri, yb ybVar, com.google.common.base.m mVar, com.google.common.collect.h0 h0Var) {
        this.a = uri;
        this.b = ybVar;
        this.c = mVar;
        this.d = h0Var;
    ...
    public final String toString() {
        ...
        androidx.room.b0.i(sb, "ProtoDataStoreConfig{uri=", string, ", schema=", string2);
        androidx.room.b0.i(sb, ", handler=", strValueOf, ", migrations=", strValueOf2);
        return androidx.compose.runtime.j.m(sb, ", variantConfig=", string3, ", useGeneratedExtensionRegistry=true, enableTracing=false}");
    }
}
