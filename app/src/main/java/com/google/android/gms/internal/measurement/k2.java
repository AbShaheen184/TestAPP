...
public final class k2 extends n0 implements RandomAccess {
    ...
    public final void add(int i, Object obj) {
        ...
        if (i2 < length) {
            ...
            Object[] objArr2 = new Object[com.google.android.datatransport.runtime.a.n(length, 3, 2, 1, 10)];
    ...
    public final boolean add(Object obj) {
        ...
        if (i == length) {
            this.y = Arrays.copyOf(this.y, com.google.android.datatransport.runtime.a.n(length, 3, 2, 1, 10));
        }
        Object[] objArr = this.y;
        int i2 = this.z;
        this.z = i2 + 1;
