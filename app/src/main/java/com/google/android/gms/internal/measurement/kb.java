...
public final class kb {
    ...
    public static kb a(w0 w0Var) throws t1 {
        ...
        int iG = w0Var.G();
        if (iG < 0) {
            androidx.transition.k.r("Negative number of flags");
            return null;
        }
        int i = com.google.common.collect.m0.C;
        ...
        for (int i2 = 0; i2 < iG; i2++) {
            ...
            if (j3 == 0) {
                ...
                if (j4 > 2305843009213693951L) {
                    androidx.transition.k.r("Flag name larger than max size");
                    return null;
                }
                strW = null;
                j = j4;
            ...
            if (i4 == 0 || i4 == 1) {
                ...
                if (i4 != 5) {
                    androidx.transition.k.r(androidx.compose.runtime.j.e(i4, "Unrecognized flag type ", new StringBuilder(String.valueOf(i4).length() + 23)));
                    return null;
                }
