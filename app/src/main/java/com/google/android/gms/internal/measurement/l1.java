  ...
  0x0716: PHI (r0v33 int) = (r0v32 int), (r0v34 int) binds: [B:296:0x065d, B:328:0x0719] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final d5 q(int i) {
        ...
        com.google.firebase.platforminfo.b.l("Attempting to get element outside of current array");
        return null;
    }

    public final void r(int i, d5 d5Var) {
        if (i > 32468) {
            kotlinx.coroutines.future.a.u("Array too large");
            return;
        }
        if (i < 0) {
            com.google.firebase.platforminfo.b.l(androidx.compose.runtime.j.e(i, "Out of bounds index: ", new StringBuilder(String.valueOf(i).length() + 21)));
            return;
        }
        TreeMap treeMap = this.e;
        if (d5Var == null) {
