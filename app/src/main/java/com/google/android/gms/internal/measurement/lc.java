    ...
    public final void run() {
        ...
        switch (this.e) {
            case 0:
                pc pcVar = this.y;
                try {
                    com.google.common.util.concurrent.m0.b(this.z);
                    return;
                } catch (Exception e) {
                    String str = pcVar.c;
                    Log.w("FlagStore", androidx.compose.runtime.j.m(new StringBuilder(String.valueOf(str).length() + 73), "Failed to store account on flag read for: ", str, " which may lead to stale flags."), e);
                    return;
                }
            default:
                pc pcVar2 = this.y;
                try {
                    id idVar = (id) com.google.common.util.concurrent.m0.b(this.z);
                    ...
                    if (pcVar2.e) {
                        ...
                        com.google.common.util.concurrent.v0 v0VarA = naVar.a();
                        ...
                        aVarB.a(bVar, _COROUTINE.b.G(v0VarA, bVar));
                        return;
                    }
                    return;
                    ...
                    Log.w("FlagStore", androidx.compose.runtime.j.m(new StringBuilder(String.valueOf(str2).length() + 64), "Unable to update local snapshot for ", str2, ", may result in stale flags."), e);
                    return;
                } catch (ExecutionException e3) {
                    e = e3;
                    if (e.getCause() instanceof SecurityException) {
                        String str3 = pcVar2.c;
                        Log.w("FlagStore", androidx.compose.runtime.j.m(new StringBuilder(String.valueOf(str3).length() + 64), "Unable to update local snapshot for ", str3, ", may result in stale flags."), e);
                        return;
                    }
                    return;
                }
