            ...
            if (z5) {
                ...
                if (z5) {
                    ...
                    if (gVar != null) {
                        ...
                        if (!z2) {
                            kotlinx.coroutines.future.a.u("cannot get arguments unless a template context exists");
                            return;
                        }
                        objArr2 = zfVar.g;
                        str3 = "cannot get arguments before calling log()";
                        if (objArr2 == null) {
                            kotlinx.coroutines.future.a.u("cannot get arguments before calling log()");
                            return;
                        }
                        ...
                        if (!z) {
                            kotlinx.coroutines.future.a.u("cannot get literal argument if a template context exists");
                            return;
                        }
                        objArr = zfVar.g;
                        if (objArr == null) {
                            kotlinx.coroutines.future.a.u("cannot get literal argument before calling log()");
                            return;
                        }
                        ...
                        if (gVar != null) {
                            ...
                            while (true) {
                                ...
                                if (iB < 0) {
                                    ...
                                    if (!(zfVar.f != null)) {
                                        kotlinx.coroutines.future.a.u(str11);
                                        return;
                                    }
                                    Object[] objArr5 = zfVar.g;
                                    if (objArr5 == null) {
                                        kotlinx.coroutines.future.a.u(str12);
                                        return;
                                    } else {
