...
public final class s5 implements c2, com.google.android.gms.common.api.internal.h, com.google.common.util.concurrent.y, com.google.android.gms.tasks.d, com.google.common.base.q {
    ...
    public ac c(String str, boolean z2) {
        return new ac(str, (com.appsalt.internal.r0) this.y, z2);
    }
    ...
    public ListenableFuture call() {
        switch (this.e) {
            case 9:
                com.google.common.util.concurrent.z0 z0Var = new com.google.common.util.concurrent.z0((Callable) this.y);
                com.google.common.util.concurrent.d0.e.execute(z0Var);
                return z0Var;
            default:
    ...
    public Object get() {
        ...
        switch (i) {
            ...
            default:
                ld ldVar = (ld) obj;
                com.google.common.util.concurrent.v0 v0Var = (com.google.common.util.concurrent.v0) ldVar.c.get();
                v0Var.getClass();
                ...
                aVarB.a(bVar, _COROUTINE.b.G(v0Var, bVar));
                com.google.common.util.concurrent.t tVarF = com.google.common.util.concurrent.m0.f(bVar, new nc(ldVar, 2), v0Var);
                tVarF.a(new vc(tVarF, 4), v0Var);
                return tVarF;
        }
    }
    ...
    public void onComplete(com.google.android.gms.tasks.i iVar) {
        fa faVar = (fa) this.y;
        if (((com.google.android.gms.tasks.s) iVar).d) {
            faVar.cancel(false);
            return;
        }
        if (iVar.h()) {
