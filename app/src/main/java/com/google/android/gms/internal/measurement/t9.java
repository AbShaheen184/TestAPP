...
public final class t9 extends com.google.android.gms.common.internal.safeparcel.a implements Comparable {
    ...
    public final int compareTo(Object obj) {
        ...
        if (i3 != 5) {
            kotlinx.coroutines.future.a.o(androidx.compose.runtime.j.e(i3, "Invalid enum value: ", new StringBuilder(String.valueOf(i3).length() + 20)));
            return 0;
        }
        byte[] bArr = t9Var.C;
        byte[] bArr2 = this.C;
        ...
        if (obj instanceof t9) {
            ...
            if (wf.c(this.e, t9Var.e)) {
                ...
                if (i2 == i && this.E == t9Var.E && this.F == t9Var.F) {
                    ...
                    kotlinx.coroutines.future.a.o(androidx.compose.runtime.j.e(i2, "Invalid enum value: ", new StringBuilder(String.valueOf(i2).length() + 20)));
                    return false;
                }
            }
        }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        String str2 = this.B;
        if (str2 != null) {
            com.google.android.gms.dynamite.g.Z(parcel, 6, str2);
        }
        byte[] bArr = this.C;
        if (bArr != null) {
            com.google.android.gms.dynamite.g.U(parcel, 7, bArr);
        }
        int i2 = this.D;
        if (i2 != 0) {
