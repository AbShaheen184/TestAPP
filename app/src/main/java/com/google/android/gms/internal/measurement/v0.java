...
public final class v0 extends w0 {
    ...
    public /* synthetic */ v0(InputStream inputStream, int i) {
        this.d = inputStream;
    ...
    public final void J(int i) throws t1 {
        if (K(i)) {
            return;
        }
        if (i > (Integer.MAX_VALUE - this.j) - this.h) {
            androidx.transition.k.r("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit. If reading multiple messages, consider resetting the counter between each message using CodedInputStream.resetSizeCounter().");
        } else {
    ...
    public final byte[] L(int i) throws IOException {
        ...
        this.h = 0;
        this.f = 0;
        ArrayList<byte[]> arrayListN = N(i - i4);
    ...
    public final long O() throws t1 {
        ...
        androidx.transition.k.r("CodedInputStream encountered a malformed varint.");
        return 0L;
    }

    public final int P() throws t1 {
        int i = this.h;
        if (this.f - i < 4) {
            J(4);
            i = this.h;
    ...
    public final void m(int i) throws t1 {
        ...
        androidx.transition.k.r("Protocol message end-group tag did not match expected tag.");
    }
    ...
    public final String x() throws IOException {
        ...
        return z2.d(bArrL, i, iG);
    }

    @Override // com.google.android.gms.internal.measurement.w0
    public final s0 y() throws IOException {
        int iG = G();
        int i = this.f;
        int i2 = this.h;
        int i3 = i - i2;
        ...
        byte[] bArrM = M(iG);
        if (bArrM != null) {
            return t0.k(bArrM, 0, bArrM.length);
        }
        int i4 = this.h;
        int i5 = this.f;
        int i6 = i5 - i4;
        ...
        this.h = 0;
        this.f = 0;
        ArrayList<byte[]> arrayListN = N(iG - i6);
