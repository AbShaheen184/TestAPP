...
public final class vd implements ie {
    ...
    public final File c(Uri uri) throws IOException {
        ...
        String str;
        if (i(uri)) {
            kotlinx.coroutines.future.a.w("operation is not permitted in other authorities.");
            return null;
        }
    ...
    public final Uri h(Uri uri) throws IOException {
        ...
        return builderPath.encodedFragment(a1VarG.isEmpty() ? null : "transform=".concat(new androidx.emoji2.text.r("+").d(a1VarG))).build();
    }
