...
public abstract class we implements qf {
    ...
    public final void close() {
        ...
        String str = this.A;
        if (qfVar == null) {
            throw new androidx.media3.common.s(androidx.compose.runtime.j.m(new StringBuilder(str.length() + Token.ASSIGN_LOGICAL_OR), "Tried to end [", str, "], but no trace was active. This is caused by mismatched or missing calls to beginSpan."));
        }
        if (this == qfVar) {
        ...
        androidx.room.b0.i(sb, "Tried to end span ", str, ", but that span is not the current span. The current span is ", str2);
        sb.append(".");
