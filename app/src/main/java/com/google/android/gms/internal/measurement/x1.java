...
public final class x1 extends n0 implements RandomAccess, q1, i2 {
    ...
    public final void add(int i, Object obj) {
        ...
        b();
        if (i < 0 || i > (i2 = this.z)) {
            com.google.firebase.platforminfo.b.l(p0.a(this.z, i, (byte) 13, "Index:", ", Size:"));
            return;
        }
        int i3 = i + 1;
        long[] jArr = this.y;
        ...
        if (i2 < length) {
            ...
            long[] jArr2 = new long[com.google.android.datatransport.runtime.a.n(length, 3, 2, 1, 10)];
    ...
    public final void e(long j) {
        ...
        if (i == length) {
            long[] jArr = new long[com.google.android.datatransport.runtime.a.n(length, 3, 2, 1, 10)];
    ...
    public final void removeRange(int i, int i2) {
        b();
        if (i2 < i) {
            com.google.firebase.platforminfo.b.l("toIndex < fromIndex");
            return;
        }
        long[] jArr = this.y;
