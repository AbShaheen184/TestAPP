...
public abstract class z2 {
                        ...
                        if (cCharAt2 < 2048) {
                            ...
                            if (cCharAt2 >= 55296 && cCharAt2 <= 57343) {
                                if (Character.codePointAt(str, i2) < 65536) {
                                    throw new y2(p0.a(length2, i2, (byte) 32, "Unpaired surrogate at index ", " of "));
                                }
                                i2++;
                            }
                        }
    ...
    /* JADX WARN: Code duplicated, block: B:42:0x008f A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:43:0x0091  */
    /* JADX WARN: Code duplicated, block: B:44:0x0092 A[PHI: r4
  0x0092: PHI (r4v6 byte) = (r4v5 byte), (r4v9 byte) binds: [B:41:0x008d, B:43:0x0091] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:46:0x0098  */
    /* JADX WARN: Code duplicated, block: B:84:0x00aa A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:85:0x00aa A[SYNTHETIC] */
        ...
        while (i < i3) {
            ...
            if (b2 >= 0) {
                ...
                if (b2 >= -32) {
                    if (b2 >= -16) {
                        if (i5 >= i3 - 2) {
                            androidx.transition.k.r("Protocol message had invalid UTF-8.");
                            return null;
                        }
                        byte b4 = bArr[i5];
                        int i6 = i + 3;
                        ...
                        byte b6 = bArr[i6];
                        if (!wf.e(b4)) {
                            if ((((b4 + 112) + (b2 << 28)) >> 30) == 0 && !wf.e(b5) && !wf.e(b6)) {
