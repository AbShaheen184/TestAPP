...
public class AppMeasurement {
    ...
    public AppMeasurement(p1 p1Var) {
        this.a = new a(p1Var);
    }
    ...
    public static AppMeasurement getInstance(Context context) {
        if (b == null) {
            synchronized (AppMeasurement.class) {
                if (b == null) {
                    t2 t2Var = (t2) FirebaseAnalytics.class.getDeclaredMethod("getScionFrontendApiImplementation", Context.class, Bundle.class).invoke(null, context, null);
                    if (t2Var != null) {
                        b = new AppMeasurement(t2Var);
                    } else {
                        b = new AppMeasurement(p1.s(context, new j6(0L, 0L, true, null, null), null, null));
                    }
                }
            }
        }
    ...
    public List<ConditionalUserProperty> getConditionalUserProperties(String str, String str2) {
        ...
        for (Bundle bundle : listL) {
            ...
            conditionalUserProperty.mValue = d2.e(bundle, ES6Iterator.VALUE_PROPERTY, Object.class, null);
    ...
    public AppMeasurement(t2 t2Var) {
        this.a = new b(t2Var);
    }
}
