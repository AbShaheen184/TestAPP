...
public abstract class d2 {
    ...
    public static androidx.work.impl.model.f n;
  ...
  0x00bc: PHI (r1v5 int) = (r1v4 int), (r1v6 int) binds: [B:37:0x00ba, B:43:0x00ce] A[DONT_GENERATE, DONT_INLINE], TryCatch #1 {SQLiteException -> 0x00b7, blocks: (B:26:0x0044, B:28:0x0074, B:30:0x0082, B:32:0x008a, B:33:0x008d, B:34:0x00b6, B:38:0x00bc, B:40:0x00bf, B:42:0x00c7, B:43:0x00ce, B:44:0x00d1, B:46:0x00d7, B:49:0x00e6, B:50:0x00ea, B:27:0x006d), top: B:60:0x0044, inners: #3 }] */
    ...
    public static void d(u0 u0Var, SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String[] strArr) throws Throwable {
        ...
        int i3;
        if (u0Var == null) {
            kotlinx.coroutines.future.a.q("Monitor must not be null");
            return;
        }
        Cursor cursor = null;
        try {
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        e = e2;
                        u0Var.F.c(str, e, "Error querying for table");
                        if (cursorQuery != null) {
                            cursorQuery.close();
                        }
                    }
                    ...
                    try {
                        ...
                        u0Var.F.c(str, TextUtils.join(", ", hashSet), "Table has extra columns. table, columns");
                    } catch (Throwable th3) {
                        cursorRawQuery.close();
                        throw th3;
                    }
            ...
            try {
                ...
                u0Var.C.b(str, "Failed to verify columns on table that was just created");
                throw e5;
            }
        } catch (Throwable th4) {
            th = th4;
    ...
    public static Object e(Bundle bundle, String str, Class cls, Object obj) {
        ...
        kotlinx.coroutines.future.a.u(androidx.privacysandbox.ads.adservices.java.internal.a.u(androidx.compose.runtime.j.q("Invalid conditional user property field type. '", str, "' expected [", canonicalName, "] but was ["), obj2.getClass().getCanonicalName(), "]"));
        return null;
    }
