...
public final class j4 implements y1 {
    ...
    public final androidx.media3.exoplayer.hls.c g0 = new androidx.media3.exoplayer.hls.c(this, 27);
    public long X = -1;
    public final g4 G = new g4(this);

    public j4(androidx.emoji2.text.m mVar) {
        this.I = p1.s(mVar.a, null, null, null);
        ...
        this.Z = new HashMap();
        this.a0 = new HashMap();
        e().E(new androidx.appcompat.widget.z0(this, mVar));
    }
    ...
    public static j4 C(Context context) {
        ...
        if (h0 == null) {
            synchronized (j4.class) {
                try {
                    if (h0 == null) {
                        h0 = new j4(new androidx.emoji2.text.m(context, 3));
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public static final boolean T(r4 r4Var) {
        return !TextUtils.isEmpty(r4Var.y);
    }

    public static final void U(e4 e4Var) {
        if (e4Var == null) {
            kotlinx.coroutines.future.a.u("Upload Component not created");
        } else {
            if (e4Var.z) {
                return;
            }
            kotlinx.coroutines.future.a.u("Component not initialized: ".concat(String.valueOf(e4Var.getClass())));
        }
    }

    public static final Boolean V(r4 r4Var) {
        Boolean bool = r4Var.M;
        String str = r4Var.Z;
        if (!TextUtils.isEmpty(str)) {
            int iOrdinal = ((z1) androidx.media3.exoplayer.dash.manifest.t.Q(str).e).ordinal();
    ...
    public final void A(z0 z0Var) {
        ...
        if (x7VarH != null) {
            ...
            U(i1Var);
            i1Var.v();
            String str2 = (String) i1Var.L.get(strE2);
        ...
        y0 y0Var = this.y;
        U(y0Var);
        androidx.media3.exoplayer.dash.manifest.t tVar = new androidx.media3.exoplayer.dash.manifest.t(this);
        p1 p1Var = (p1) y0Var.e;
        y0Var.v();
        y0Var.w();
        g4 g4Var = y0Var.y.G;
        Uri.Builder builder = new Uri.Builder();
        Uri.Builder builderAppendQueryParameter = builder.scheme((String) f0.f.a(null)).encodedAuthority((String) f0.g.a(null)).path("config/app/".concat(String.valueOf(z0Var.H()))).appendQueryParameter("platform", "android");
        ((p1) g4Var.e).A.B();
        ...
        try {
            ...
            m1 m1Var = p1Var.D;
            p1.m(m1Var);
            m1Var.H(new x0(y0Var, z0Var.E(), url, (byte[]) null, fVar, tVar));
        } catch (IllegalArgumentException | MalformedURLException | URISyntaxException unused) {
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.C.c(u0.D(z0Var.E()), string, "Failed to parse config URL. Not fetching. appId");
        }
    }
  ...
  0x005c: PHI (r11v12 int) = (r11v2 int), (r11v0 int) binds: [B:18:0x005e, B:15:0x0058] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final void B(String str, int i, Throwable th, byte[] bArr, Map map) {
        ...
        s0Var.b(numValueOf, "onConfigFetched. Response size");
        if (f0().G(null, f0.e1)) {
            l4 l4Var = this.D;
            U(l4Var);
            l4Var.B(map);
        ...
        try {
            ...
            if (z0VarZ0 == null) {
                b().F.b(u0.D(str), "App does not exist in onConfigFetched. appId");
            } else {
                i1 i1Var = this.e;
                if (z || i == 404) {
                    k0();
                    String strG = l4.G("Last-Modified", map);
                    k0();
                    String strG2 = l4.G("ETag", map);
                    if (i == 404 || i == 304) {
                        U(i1Var);
                        if (i1Var.H(str) == null) {
                            U(i1Var);
                            i1Var.J(str, null, null, null);
                        }
                    } else {
                        U(i1Var);
                        i1Var.J(str, strG, strG2, bArr);
                    }
                    c().getClass();
                    z0VarZ0.f(System.currentTimeMillis());
                    m mVar3 = this.z;
                    U(mVar3);
                    mVar3.A0(z0VarZ0, false);
                    if (i == 404) {
                    ...
                    c().getClass();
                    z0VarZ0.g(System.currentTimeMillis());
                    m mVar5 = this.z;
                    U(mVar5);
                    mVar5.A0(z0VarZ0, false);
                    b().K.c(Integer.valueOf(i), th, "Fetching config failed. code, error");
                    U(i1Var);
                    i1Var.v();
                    i1Var.K.put(str, null);
                    androidx.media3.exoplayer.l1 l1Var = this.F.F;
                    c().getClass();
                    l1Var.h(System.currentTimeMillis());
                    if (i == 503 || i == 429) {
                        androidx.media3.exoplayer.l1 l1Var2 = this.F.D;
                        c().getClass();
    ...
    public final int F(String str, androidx.media3.exoplayer.hls.c cVar) throws Throwable {
        z1 z1VarZ;
        i1 i1Var = this.e;
        s7 s7VarR = i1Var.R(str);
        b2 b2Var = b2.AD_PERSONALIZATION;
        if (s7VarR == null) {
            cVar.L(b2Var, h.FAILSAFE);
            return 1;
        }
        m mVar = this.z;
        U(mVar);
        z0 z0VarZ0 = mVar.z0(str);
        if (z0VarZ0 == null || ((z1) androidx.media3.exoplayer.dash.manifest.t.Q(z0VarZ0.s()).e) != z1.POLICY || (z1VarZ = i1Var.z(str, b2Var)) == z1.UNINITIALIZED) {
            cVar.L(b2Var, h.REMOTE_DEFAULT);
            if (i1Var.Q(str, b2Var)) {
                return 0;
            }
        } else {
            cVar.L(b2Var, h.REMOTE_ENFORCED_DEFAULT);
            if (z1VarZ == z1.GRANTED) {
                return 0;
            }
        }
        return 1;
    ...
    public final HashMap G(t8 t8Var) {
        ...
        for (w8 w8Var : t8Var.w()) {
            if (w8Var.v().startsWith("gad_") && (serializableN = l4.N(w8Var)) != null) {
    ...
    public final void H() {
        ...
        if (this.e0 == null) {
            this.e0 = new t3(this, this.I, 2);
        }
        if (this.e0.c != 0) {
            return;
        }
        c().getClass();
        long jMax = Math.max(0L, ((long) ((Integer) f0.A0.a(null)).intValue()) - (SystemClock.elapsedRealtime() - this.f0));
  ...
  0x0531: PHI (r12v26 int) = (r12v22 int), (r12v28 int) binds: [B:158:0x0554, B:153:0x052d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public final boolean I(String str, long j) {
        ...
        j4Var.h0().j0();
        try {
            c1 c1Var = new c1(j4Var);
            j4Var.h0().h0(str, j, j4Var.X, c1Var);
            ArrayList arrayList3 = (ArrayList) c1Var.A;
            if (arrayList3 == null || arrayList3.isEmpty()) {
                h0().k0();
                z = false;
            } else {
                a9 a9Var2 = (a9) ((b9) c1Var.y).l();
                a9Var2.b();
                ((b9) a9Var2.y).f0();
                int i15 = -1;
                int i16 = -1;
                ...
                boolean z6 = false;
                while (true) {
                    int size = ((ArrayList) c1Var.A).size();
                    i = i18;
                    l = l3;
                    p1Var = j4Var.I;
                    if (i17 >= size) {
                    ...
                    s8 s8Var4 = (s8) ((t8) ((ArrayList) c1Var.A).get(i17)).l();
                    int i19 = i17;
                    if (j4Var.g0().K(((b9) c1Var.y).u(), s8Var4.m())) {
                        String str11 = str10;
                        j4Var.b().A().c(u0.D(((b9) c1Var.y).u()), p1Var.n().a(s8Var4.m()), "Dropping blocked raw event. appId");
                        if (!str7.equals(j4Var.g0().d(((b9) c1Var.y).u(), "measurement.upload.blacklist_internal")) && !str7.equals(j4Var.g0().d(((b9) c1Var.y).u(), "measurement.upload.blacklist_public")) && !"_err".equals(s8Var4.m())) {
                            j4Var.l0();
                            p4.N(j4Var.g0, ((b9) c1Var.y).u(), 11, "_ev", s8Var4.m(), 0);
                        }
                        str9 = str9;
                        i18 = i;
                        i10 = i19;
                        ...
                        if (strM2.equals(str9) || strM2.equals("_iap") || strM2.equals("ecommerce_purchase")) {
                            ...
                            a9Var = a9Var2;
                            i2 = i15;
                            if (j4Var.f0().G(null, f0.f1) && strM2.equals("in_app_purchase")) {
                            }
                            if (s8Var4.m().equals(d2.g(str8, d2.f, d2.a))) {
                                s8Var4.n(str8);
                                j4Var.b().C().a("Renaming ad_impression to _ai");
                                if (Log.isLoggable(j4Var.b().F(), 5)) {
                                    for (i14 = 0; i14 < s8Var4.h(); i14++) {
                                        if (!"ad_platform".equals(s8Var4.i(i14).v()) && !s8Var4.i(i14).x().isEmpty() && "admob".equalsIgnoreCase(s8Var4.i(i14).x())) {
                                            j4Var.b().H.a("AdMob ad impression logged from app. Potentially duplicative.");
                                        }
                                    }
                                }
                            }
                            gVarF0 = j4Var.f0();
                            e0Var = f0.f1;
                            if (gVarF0.G(null, e0Var) && s8Var4.m().equals("in_app_purchase")) {
                                s8Var4.n("_iap");
                                j4Var.b().C().a("Renaming in_app_purchase to _iap");
                            }
                            zL = j4Var.g0().L(((b9) c1Var.y).u(), s8Var4.m());
                            if (j4Var.f0().G(null, e0Var) && "_iap".equals(s8Var4.m())) {
                                zL = j4Var.y(s8Var4);
                                strU = ((b9) c1Var.y).u();
                                if ("_iap".equals(s8Var4.m())) {
                                    j4Var.L(s8Var4, ES6Iterator.VALUE_PROPERTY, strU);
                                    j4Var.L(s8Var4, "price", strU);
                                }
                                if (!"_iap".equals(s8Var4.m())) {
                            ...
                            if (zL) {
                                ...
                                if (!z3) {
                                    j4Var.b().C().b(p1Var.n().a(s8Var4.m()), "Marking event as real-time");
                                    v8 v8VarG3 = w8.G();
                                    v8VarG3.g("_r");
                                    v8VarG3.i(1L);
                                    s8Var4.k(v8VarG3);
                                }
                                if (j4Var.h0().B0(j4Var.g(), ((b9) c1Var.y).u(), false, true, false, false).e > j4Var.f0().E(((b9) c1Var.y).u(), f0.p)) {
                                    E(s8Var4, "_r");
                                } else {
                                    z6 = true;
                                }
                                if (p4.w0(s8Var4.m())) {
                                    j4Var.b().A().b(u0.D(((b9) c1Var.y).u()), "Too many conversions. Not logging as conversion. appId");
                                    z4 = false;
                                    v8Var = null;
                                    i6 = -1;
                                    ...
                                    if (z4) {
                                        if (v8Var != null) {
                                            ...
                                            if (v8Var != null) {
                                                ...
                                                j4Var.b().z().b(u0.D(((b9) c1Var.y).u()), "Did not find conversion parameter. appId");
                                            }
                                        }
                                    } else if (v8Var != null) {
                                ...
                                if (strM.hashCode() == 95027 && strM.equals("_ui")) {
                                    ...
                                    if (z2 && zL) {
                                        j4Var.b().C().b(p1Var.n().a(s8Var4.m()), "Marking event as conversion");
                                        v8 v8VarG4 = w8.G();
                                        v8VarG4.g("_c");
                                        v8VarG4.i(1L);
                                        s8Var4.k(v8VarG4);
                                    ...
                                    if (p4.w0(s8Var4.m()) && zL != 0 && j4Var.h0().B0(j4Var.g(), ((b9) c1Var.y).u(), true, false, false, false).c > j4Var.f0().E(((b9) c1Var.y).u(), f0.o)) {
                                        j4Var.b().A().b(u0.D(((b9) c1Var.y).u()), "Too many conversions. Not logging as conversion. appId");
                                        z4 = false;
                                        v8Var = null;
                                        i6 = -1;
                            ...
                            if (j4Var.f0().G(null, f0.e1) && s8Var4.t() && !s8Var4.r()) {
                                jC = j4Var.k0().C(s8Var4.u());
                                if (jC != 0) {
                                    s8Var4.s(jC);
                                }
                                s8Var4.b();
                                ...
                                while (i11 < s8Var4.h()) {
                                    ...
                                    if (w8VarI3.v().equals(str4) || w8VarI3.E().isEmpty()) {
                                        ...
                                        if (!w8VarI3.v().equals(str4)) {
                                            j4Var.x(s8Var4.m(), (v8) w8VarI3.l(), bundleE, ((b9) c1Var.y).u());
                                        }
                                    } else {
                                        String strU2 = ((b9) c1Var.y).u();
                                        ...
                                        while (i21 < r1VarE.size()) {
                                            ...
                                            j4Var.k0();
                                            Bundle bundleE2 = l4.E(w8Var9.E());
                                            Iterator it2 = w8Var9.E().iterator();
                                            while (it2.hasNext()) {
                                                j4Var.x(s8Var4.m(), (v8) ((w8) it2.next()).l(), bundleE2, strU2);
                                                r1VarE = r1VarE;
                                                str8 = str8;
                                            }
                            ...
                            i10 = i19;
                            ((ArrayList) c1Var.A).set(i10, (t8) s8Var4.d());
                            a9Var2.Z(s8Var4);
                            i18 = i + 1;
                        }
                        v8 v8VarG6 = w8.G();
                        ...
                        if (z5) {
                            ...
                            String strU3 = ((b9) c1Var.y).u();
                            if (j4Var.R(strU3, str9) && j4Var.R(strU3, "_iap") && j4Var.R(strU3, "ecommerce_purchase")) {
                                str6 = "new";
                            } else {
                                str6 = "returning";
                            }
                        ...
                        gVarF0 = j4Var.f0();
                        e0Var = f0.f1;
                        if (gVarF0.G(null, e0Var)) {
                            s8Var4.n("_iap");
                            j4Var.b().C().a("Renaming in_app_purchase to _iap");
                        }
                        zL = j4Var.g0().L(((b9) c1Var.y).u(), s8Var4.m());
                        if (j4Var.f0().G(null, e0Var)) {
                            zL = j4Var.y(s8Var4);
                            strU = ((b9) c1Var.y).u();
                            if ("_iap".equals(s8Var4.m())) {
                                j4Var.L(s8Var4, ES6Iterator.VALUE_PROPERTY, strU);
                ...
                while (i23 < i22) {
                    ...
                    if ("_e".equals(t8VarZ1.z())) {
                        j4Var.k0();
                        if (l4.F(t8VarZ1, "_fr") != null) {
                            a9Var2.a0(i23);
                            i22--;
                            i23--;
                        } else {
                            j4Var.k0();
                            w8VarF = l4.F(t8VarZ1, "_et");
                            if (w8VarF == null) {
                                if (w8VarF.y()) {
                ...
                j4Var.J(a9Var2, jLongValue, false);
                Iterator it3 = a9Var2.W().iterator();
                while (it3.hasNext()) {
                    if ("_s".equals(((t8) it3.next()).z())) {
                        j4Var.h0().p0(a9Var2.n(), "_se");
                        break;
                    }
                }
                if (l4.h0(a9Var2, "_sid") >= 0) {
                    j4Var.J(a9Var2, jLongValue, true);
                } else {
                    int iH0 = l4.h0(a9Var2, "_se");
                    if (iH0 >= 0) {
                        a9Var2.b();
                        ((b9) a9Var2.y).j0(iH0);
                        j4Var.b().z().b(u0.D(((b9) c1Var.y).u()), "Session engagement user property is in the bundle without session ID. appId");
                    }
                }
                String strU4 = ((b9) c1Var.y).u();
                j4Var.e().v();
                j4Var.m0();
                z0 z0VarZ1 = j4Var.h0().z0(strU4);
                if (z0VarZ1 == null) {
                    j4Var.b().z().b(u0.D(strU4), "Cannot fix consent fields without appInfo. appId");
                } else {
                    j4Var.m(z0VarZ1, a9Var2);
                }
                String strU5 = ((b9) c1Var.y).u();
                j4Var.e().v();
                j4Var.m0();
                z0 z0VarZ2 = j4Var.h0().z0(strU5);
                if (z0VarZ2 == null) {
                    j4Var.b().A().b(u0.D(strU5), "Cannot populate ad_campaign_info without appInfo. appId");
                } else {
                    j4Var.n(z0VarZ2, a9Var2);
                }
                a9Var2.b();
                ...
                a9Var2.O();
                c2 c2Var = c2.c;
                c2 c2VarJ = j4Var.d(((b9) c1Var.y).u()).j(c2.c(100, ((b9) c1Var.y).z0()));
                c2 c2VarE0 = j4Var.h0().e0(((b9) c1Var.y).u());
                j4Var.h0().d0(((b9) c1Var.y).u(), c2VarJ);
                b2 b2Var = b2.ANALYTICS_STORAGE;
                if (!c2VarJ.i(b2Var) && c2VarE0.i(b2Var)) {
                    j4Var.h0().n0(((b9) c1Var.y).u());
                } else if (c2VarJ.i(b2Var) && !c2VarE0.i(b2Var)) {
                    j4Var.h0().o0(((b9) c1Var.y).u());
                }
                ...
                if (j4Var.f0().G(((b9) c1Var.y).u(), f0.O0)) {
                    j4Var.l0();
                    if (p4.Y((String) f0.q0.a(null), ((b9) c1Var.y).u()) && j4Var.d(((b9) c1Var.y).u()).i(b2Var2) && ((b9) c1Var.y).E0()) {
                        j4Var.w(a9Var2, c1Var);
                    }
                }
                a9Var2.b();
                ((b9) a9Var2.y).Q1();
                a9Var2.K(j4Var.j0().z(a9Var2.n(), a9Var2.W(), Collections.unmodifiableList(((b9) a9Var2.y).a2()), Long.valueOf(((b9) a9Var2.y).g2()), Long.valueOf(((b9) a9Var2.y).i2()), !c2VarJ.i(b2Var)));
                if (j4Var.f0().x(((b9) c1Var.y).u())) {
                    HashMap map = new HashMap();
                    ArrayList arrayList4 = new ArrayList();
                    SecureRandom secureRandomV0 = j4Var.l0().v0();
                    int i25 = 0;
                    while (i25 < a9Var2.X()) {
                        s8 s8Var6 = (s8) ((b9) a9Var2.y).Z1(i25).l();
                        if (s8Var6.m().equals("_ep")) {
                            j4Var.k0();
                            String str14 = (String) l4.H((t8) s8Var6.d(), "_en");
                            r rVarV = (r) map.get(str14);
                            if (rVarV == null) {
                                m mVarH0 = j4Var.h0();
                                String strU6 = ((b9) c1Var.y).u();
                            ...
                            l2 = l;
                            i1 i1VarG0 = j4Var.g0();
                            String strU7 = ((b9) c1Var.y).u();
                            String strD = i1VarG0.d(strU7, "measurement.account.time_zone_offset_minutes");
                            if (TextUtils.isEmpty(strD)) {
                                ...
                                try {
                                    ...
                                    ((p1) i1VarG0.e).b().A().c(u0.D(strU7), e, "Unable to parse timezone offset. appId");
                                    j2 = 0;
                                }
                            }
                            j4Var.l0();
                                ...
                                while (true) {
                                    if (it4.hasNext()) {
                                        ...
                                        if ("_dbg".equals(w8Var18.v())) {
                                            iN = !l2.equals(Long.valueOf(w8Var18.z())) ? g0().N(((b9) c1Var.y).u(), s8Var6.m()) : 1;
                                        } else {
                                            j4 = j3;
                                        }
                                    } else {
                            ...
                            if (iN <= 0) {
                                ...
                                if (rVarB == null && (rVarB = h0().V("events", ((b9) c1Var.y).u(), s8Var6.m())) == null) {
                                    b().A().c(((b9) c1Var.y).u(), s8Var6.m(), "Event being bundled has no eventAggregate. appId, eventName");
                                    rVarB = new r(((b9) c1Var.y).u(), s8Var6.m(), 1L, 1L, 1L, s8Var6.o(), 0L, null, null, null, null);
                                }
                                k0();
                                Long l5 = (Long) l4.H((t8) s8Var6.d(), "_eid");
                                boolean z7 = l5 != null;
                                if (iN == 1) {
                                    arrayList4.add((t8) s8Var6.d());
                ...
                String strU8 = ((b9) c1Var.y).u();
                z0 z0VarZ3 = h0().z0(strU8);
                if (z0VarZ3 == null) {
                    b().z().b(u0.D(((b9) c1Var.y).u()), "Bundling raw events w/o app info. appId");
                } else if (a9Var2.X() > 0) {
                    m1 m1Var = z0VarZ3.a.D;
                    p1.m(m1Var);
                    m1Var.v();
                    long j5 = z0VarZ3.i;
                    if (j5 != 0) {
                    ...
                    z0VarZ3.h(a9Var2.X());
                    m1 m1Var3 = z0VarZ3.a.D;
                    p1.m(m1Var3);
                    m1Var3.v();
                    int i26 = (int) z0VarZ3.F;
                    a9Var2.b();
                    ((b9) a9Var2.y).o1(i26);
                    m1 m1Var4 = z0VarZ3.a.D;
                    p1.m(m1Var4);
                    m1Var4.v();
                    a9Var2.w((int) z0VarZ3.g);
                    z0VarZ3.M(((b9) a9Var2.y).g2());
                    z0VarZ3.N(((b9) a9Var2.y).i2());
                    String strV = z0VarZ3.v();
                    if (strV != null) {
                        a9Var2.G(strV);
                    } else {
                        a9Var2.H();
                ...
                if (a9Var2.X() > 0) {
                    p1Var.getClass();
                    if (f0().G(((b9) c1Var.y).u(), f0.j1)) {
                        String strN = a9Var2.n();
                        if (!TextUtils.isEmpty(strN) && (z0VarZ0 = h0().z0(strN)) != null) {
                            c().getClass();
                            long jCurrentTimeMillis = System.currentTimeMillis();
                            m1 m1Var5 = z0VarZ0.a.D;
                            p1.m(m1Var5);
                            m1Var5.v();
                            if (jCurrentTimeMillis - z0VarZ0.J >= f0().D(strN, f0.B0)) {
                                List listC0 = h0().c0("");
                                if (!listC0.isEmpty()) {
                                    a9Var2.b();
                                ...
                                z0VarZ0.u(jCurrentTimeMillis);
                                h0().A0(z0VarZ0, false);
                            }
                        }
                    }
                    x7 x7VarH = g0().H(((b9) c1Var.y).u());
                    if (x7VarH != null && x7VarH.u()) {
                        long jV = x7VarH.v();
                        a9Var2.b();
                        ((b9) a9Var2.y).V0(jV);
                    } else if (((b9) c1Var.y).J().isEmpty()) {
                        a9Var2.b();
                        ((b9) a9Var2.y).V0(-1L);
                    } else {
                        b().A().b(u0.D(((b9) c1Var.y).u()), "Did not find measurement config or missing version info. appId");
                    }
                    h0().E0((b9) a9Var2.d(), z6);
                }
                h0().L((ArrayList) c1Var.z);
                m mVarH1 = h0();
                try {
                    ...
                    ((p1) mVarH1.e).b().z().c(u0.D(strU8), e2, "Failed to remove unused event metadata. appId");
                }
                h0().k0();
                z = true;
            }
    ...
    public final void J(a9 a9Var, long j, boolean z) throws Throwable {
        ...
        m mVar = this.z;
        U(mVar);
        n4 n4VarR0 = mVar.r0(a9Var.n(), str);
        if (n4VarR0 == null || (obj = n4VarR0.e) == null) {
            String strN = a9Var.n();
            c().getClass();
            n4Var = new n4(strN, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, str, System.currentTimeMillis(), Long.valueOf(j));
        } else {
            String strN2 = a9Var.n();
            c().getClass();
            n4Var = new n4(strN2, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, str, System.currentTimeMillis(), Long.valueOf(((Long) obj).longValue() + j));
        }
        j9 j9VarF = k9.F();
        j9VarF.b();
        ((k9) j9VarF.y).H(str);
    ...
    public final boolean K(s8 s8Var, s8 s8Var2) {
        ...
        k0();
        w8 w8VarF = l4.F((t8) s8Var.d(), "_sc");
        String strX = w8VarF == null ? null : w8VarF.x();
        k0();
        w8 w8VarF2 = l4.F((t8) s8Var2.d(), "_pc");
        ...
        com.google.android.gms.common.internal.x.b("_e".equals(s8Var.m()));
        k0();
        w8 w8VarF3 = l4.F((t8) s8Var.d(), "_et");
        if (w8VarF3 == null || !w8VarF3.y() || w8VarF3.z() <= 0) {
            return true;
        }
        long jZ = w8VarF3.z();
        k0();
        w8 w8VarF4 = l4.F((t8) s8Var2.d(), "_et");
        if (w8VarF4 != null && w8VarF4.z() > 0) {
            jZ += w8VarF4.z();
        }
        k0();
        l4.D(s8Var2, "_et", Long.valueOf(jZ));
        k0();
        l4.D(s8Var, "_fr", 1L);
        return true;
    }
    ...
    public final void L(s8 s8Var, String str, String str2) {
        ...
        if (D > 9.223372036854776E18d || D < -9.223372036854776E18d) {
            b().F.c(u0.D(str2), Double.valueOf(D), androidx.privacysandbox.ads.adservices.java.internal.a.r("Data lost. Purchase ", str, " is too big. appId"));
            return;
        }
        s8Var.l(i);
        v8 v8VarG = w8.G();
    ...
    public final void N() {
        ...
        f0();
        long jMax4 = Math.max(0L, ((Long) f0.O.a(null)).longValue());
        m mVar = this.z;
        U(mVar);
        ...
        if (z) {
            ...
            if (TextUtils.isEmpty(strZ) || ".none.".equals(strZ)) {
                f0();
                jMax = Math.max(0L, ((Long) f0.I.a(null)).longValue());
            } else {
                f0();
                jMax = Math.max(0L, ((Long) f0.J.a(null)).longValue());
            }
        } else {
            f0();
            jMax = Math.max(0L, ((Long) f0.H.a(null)).longValue());
        }
        long jG2 = this.F.E.g();
        long jG3 = this.F.F.g();
        m mVar3 = this.z;
        ...
        if (jMax5 != 0) {
            ...
            U(l4Var);
            jMax2 = !l4Var.d0(jMax6, jMax) ? jMax6 + jMax : jMin;
            if (jAbs4 != 0 && jAbs4 >= jAbs2) {
                int i2 = 0;
                while (true) {
                    f0();
                    i = 0;
                    if (i2 >= Math.min(20, Math.max(0, ((Integer) f0.Q.a(null)).intValue()))) {
                        jMax2 = 0;
                        break;
                    }
                    f0();
                    jMax2 += Math.max(0L, ((Long) f0.P.a(null)).longValue()) * (1 << i2);
                    if (jMax2 > jAbs4) {
                        break;
                    } else {
                        i2++;
            ...
            if (y0Var.z()) {
                ...
                j4Var.e().v();
                if (!a1VarI0.b) {
                    j4Var.I.e.registerReceiver(a1VarI0, new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
                    y0 y0Var2 = j4Var.y;
                    U(y0Var2);
                    a1VarI0.c = y0Var2.z();
                    j4Var.b().K.b(Boolean.valueOf(a1VarI0.c), "Registering connectivity change receiver. Network connected");
                    a1VarI0.b = true;
                }
                z3 z3Var5 = this.B;
                U(z3Var5);
            ...
            jG = this.F.D.g();
            f0();
            jMax3 = Math.max(0L, ((Long) f0.G.a(null)).longValue());
            U(l4Var);
            if (!l4Var.d0(jG, jMax3)) {
            ...
            if (jCurrentTimeMillis <= 0) {
                f0();
                jCurrentTimeMillis = Math.max(0L, ((Long) f0.K.a(null)).longValue());
            ...
            if (!p4.r0(context)) {
                p1.m(u0Var);
                u0Var.J.a("Receiver not registered/enabled");
            }
            if (!p4.Q(context)) {
                p1.m(u0Var);
                u0Var.J.a("Service not registered/enabled");
            }
            z3Var.A();
            p1.m(u0Var);
            u0Var.K.b(Long.valueOf(jCurrentTimeMillis), "Scheduling upload, millis");
            p1Var.H.getClass();
            SystemClock.elapsedRealtime();
            if (jCurrentTimeMillis < Math.max(0L, ((Long) f0.L.a(null)).longValue()) && z3Var.z().c == 0) {
                z3Var.z().b(jCurrentTimeMillis);
            }
        ...
        p1Var2.H.getClass();
        SystemClock.elapsedRealtime();
        if (jCurrentTimeMillis < Math.max(0L, ((Long) f0.L.a(null)).longValue())) {
            z3Var.z().b(jCurrentTimeMillis);
        }
    ...
    public final Boolean P(z0 z0Var) {
        try {
            ...
            p1 p1Var = this.I;
            if (jQ != -2147483648L) {
                if (z0Var.Q() == com.google.android.gms.common.wrappers.b.a(p1Var.e).c(0, z0Var.E()).versionCode) {
                    return Boolean.TRUE;
                }
            } else {
                String str = com.google.android.gms.common.wrappers.b.a(p1Var.e).c(0, z0Var.E()).versionName;
                String strO = z0Var.O();
    ...
    public final r4 Q(String str) throws Throwable {
        m mVar = this.z;
        U(mVar);
        z0 z0VarZ0 = mVar.z0(str);
        if (z0VarZ0 != null) {
            p1 p1Var = z0VarZ0.a;
            if (!TextUtils.isEmpty(z0VarZ0.O())) {
                Boolean boolP = P(z0VarZ0);
                if (boolP != null && !boolP.booleanValue()) {
                    b().C.b(u0.D(str), "App version does not match; dropping. appId");
                    return null;
                }
                String strH = z0VarZ0.H();
                String strO = z0VarZ0.O();
                long jQ = z0VarZ0.Q();
                m1 m1Var = p1Var.D;
                p1.m(m1Var);
                m1Var.v();
                String str2 = z0VarZ0.l;
                m1 m1Var2 = p1Var.D;
                p1.m(m1Var2);
                m1Var2.v();
                long j = z0VarZ0.m;
                ...
                m1Var4.v();
                boolean z = z0VarZ0.o;
                String strK = z0VarZ0.K();
                m1 m1Var5 = p1Var.D;
                p1.m(m1Var5);
                m1Var5.v();
                boolean z2 = z0VarZ0.p;
                Boolean boolX = z0VarZ0.x();
                long jB = z0VarZ0.b();
                m1 m1Var6 = p1Var.D;
                p1.m(m1Var6);
                m1Var6.v();
                ArrayList arrayList = z0VarZ0.s;
                String strG = d(str).g();
                boolean z3 = z0VarZ0.z();
                m1 m1Var7 = p1Var.D;
                p1.m(m1Var7);
                m1Var7.v();
                long j3 = z0VarZ0.v;
                ...
                p1.m(m1Var9);
                m1Var9.v();
                return new r4(str, strH, strO, jQ, str2, j, j2, (String) null, z, false, strK, 0L, 0, z2, false, boolX, jB, (List) arrayList, strG, "", (String) null, z3, j3, i, str3, i2, z0VarZ0.B, z0VarZ0.D(), z0VarZ0.s(), 0L, z0VarZ0.t(), 0L);
            }
        }
    ...
    public final void W() {
        ...
        if (fileLock == null || !fileLock.isValid()) {
            ((p1) this.z.e).getClass();
            try {
                FileChannel channel = new RandomAccessFile(new File(new File(p1Var.e.getFilesDir(), "google_app_measurement.db").getPath()), "rw").getChannel();
                this.U = channel;
    ...
    public final void X(m4 m4Var, r4 r4Var) {
        ...
        if (zT) {
            ...
            p4 p4VarL0 = l0();
            String str2 = m4Var.y;
            int iF0 = p4VarL0.F0(str2);
            androidx.media3.exoplayer.hls.c cVar = this.g0;
            if (iF0 != 0) {
                l0();
                f0();
                ...
                l0();
                p4.N(cVar, r4Var.e, iF0, "_ev", strC, length);
                return;
            }
            int iK = l0().K(m4Var.d(), str2);
            if (iK != 0) {
                l0();
                f0();
                ...
                l0();
                p4.N(cVar, r4Var.e, iK, "_ev", strC2, length2);
                return;
            }
            Object objL = l0().L(m4Var.d(), str2);
            if (objL != null) {
                String str3 = "_sid";
                if ("_sid".equals(str2)) {
                    long j = m4Var.z;
                    ...
                    m mVar = this.z;
                    U(mVar);
                    n4 n4VarR0 = mVar.r0(str, "_sno");
                    if (n4VarR0 != null) {
                        Object obj = n4VarR0.e;
                        if (obj instanceof Long) {
                            jLongValue = ((Long) obj).longValue();
                        } else {
                            if (n4VarR0 != null) {
                                b().F.b(n4VarR0.e, "Retrieved last session number from database does not contain a valid (long) value");
                            }
                            m mVar2 = this.z;
                            U(mVar2);
                            ...
                            if (rVarV != null) {
                                s0 s0Var = b().K;
                                long j2 = rVarV.c;
                                s0Var.b(Long.valueOf(j2), "Backfill the session number. Last used session number");
                                jLongValue = j2;
                            } else {
                                jLongValue = 0;
                            }
                        ...
                        if (rVarV != null) {
                            s0 s0Var2 = b().K;
                            long j3 = rVarV.c;
                            s0Var2.b(Long.valueOf(j3), "Backfill the session number. Last used session number");
                            jLongValue = j3;
                        } else {
                            jLongValue = 0;
                        }
                    }
                    X(new m4(j, Long.valueOf(jLongValue + 1), "_sno", str4), r4Var);
                } else {
                    str3 = "_sid";
                }
                com.google.android.gms.common.internal.x.g(str);
                ...
                n4 n4Var = new n4(str, str5, str2, m4Var.z, objL);
                s0 s0Var3 = b().K;
                p1 p1Var = this.I;
                q0 q0Var = p1Var.G;
                String str6 = n4Var.c;
                s0Var3.c(q0Var.c(str6), objL, "Setting user property");
                m mVar4 = this.z;
                U(mVar4);
                mVar4.j0();
                try {
                    ...
                    if (zEquals) {
                        m mVar5 = this.z;
                        U(mVar5);
                        n4 n4VarR1 = mVar5.r0(str, "_id");
                        if (n4VarR1 != null && !obj2.equals(n4VarR1.e)) {
                            m mVar6 = this.z;
                            U(mVar6);
                            mVar6.p0(str, "_lair");
                        }
                    ...
                    m mVar7 = this.z;
                    U(mVar7);
                    boolean zQ0 = mVar7.q0(n4Var);
                    if (str3.equals(str2)) {
                        l4 l4Var = this.D;
                        U(l4Var);
                        String str7 = r4Var.R;
                        long jE0 = TextUtils.isEmpty(str7) ? 0L : l4Var.e0(str7.getBytes(StandardCharsets.UTF_8));
                        m mVar8 = this.z;
                        U(mVar8);
                        z0 z0VarZ0 = mVar8.z0(str);
                        if (z0VarZ0 != null) {
                            z0VarZ0.B(jE0);
                            if (z0VarZ0.o()) {
                                m mVar9 = this.z;
                                U(mVar9);
                                mVar9.A0(z0VarZ0, false);
                            }
                        }
                    }
                    m mVar10 = this.z;
                    ...
                    mVar10.k0();
                    if (!zQ0) {
                        b().C.c(p1Var.G.c(str6), obj2, "Too many unique user properties are set. Ignoring user property");
                        l0();
                        p4.N(cVar, str, 9, null, null, 0);
                    }
                } finally {
                    m mVar11 = this.z;
                    U(mVar11);
    ...
    public final void Y(String str, r4 r4Var) {
        e().v();
        m0();
        boolean zT = T(r4Var);
        String str2 = r4Var.e;
        if (zT) {
            ...
            Boolean boolV = V(r4Var);
            if ("_npa".equals(str) && boolV != null) {
                b().J.a("Falling back to manifest metadata value for ad personalization");
                c().getClass();
                X(new m4(System.currentTimeMillis(), Long.valueOf(true != boolV.booleanValue() ? 0L : 1L), "_npa", DebugKt.DEBUG_PROPERTY_VALUE_AUTO), r4Var);
                return;
            }
            s0 s0Var = b().J;
            p1 p1Var = this.I;
            s0Var.b(p1Var.G.c(str), "Removing user property");
            m mVar = this.z;
            U(mVar);
            mVar.j0();
            try {
                ...
                U(mVar4);
                mVar4.k0();
                b().J.b(p1Var.G.c(str), "User property removed");
            } finally {
                m mVar5 = this.z;
                U(mVar5);
                mVar5.l0();
    ...
    public final void Z(r4 r4Var) throws Throwable {
        long j;
        long j2;
        long j3;
        long j4;
        ...
        if (T(r4Var)) {
            m mVar2 = this.z;
            U(mVar2);
            z0 z0VarZ0 = mVar2.z0(str5);
            if (z0VarZ0 != null && TextUtils.isEmpty(z0VarZ0.H()) && !TextUtils.isEmpty(r4Var.y)) {
                z0VarZ0.f(0L);
                m mVar3 = this.z;
                U(mVar3);
                mVar3.A0(z0VarZ0, false);
            ...
            g gVarF0 = f0();
            e0 e0Var = f0.e1;
            long j14 = gVarF0.G(null, e0Var) ? r4Var.c0 : 0L;
            if (j13 == 0) {
                c().getClass();
                long jCurrentTimeMillis = System.currentTimeMillis();
                if (f0().G(null, e0Var)) {
            ...
            int i = r4Var.J;
            if (i != 0 && i != 1) {
                b().F.c(u0.D(str5), Integer.valueOf(i), "Incorrect app type, assuming installed app. appId, appType");
                i = 0;
            }
            m mVar4 = this.z;
            U(mVar4);
            ...
            try {
                m mVar5 = this.z;
                U(mVar5);
                n4 n4VarR0 = mVar5.r0(str5, "_npa");
                Boolean boolV = V(r4Var);
                if (n4VarR0 != null) {
                    j3 = 1;
                    if (!DebugKt.DEBUG_PROPERTY_VALUE_AUTO.equals(n4VarR0.b)) {
                        j4 = j2;
                    }
                    if (f0().G(null, f0.W0)) {
                        c0(r4Var, r4Var.a0);
                    ...
                    if (rVarV == null) {
                        ...
                        if (z) {
                            ...
                            long j15 = j4;
                            X(new m4(j15, lValueOf, "_fvt", DebugKt.DEBUG_PROPERTY_VALUE_AUTO), r4Var);
                            e().v();
                            m0();
                            bundle = new Bundle();
                            ...
                            i(new u("_v", new t(bundle), DebugKt.DEBUG_PROPERTY_VALUE_AUTO, j15, j), r4Var);
                        } else {
                            Long lValueOf2 = Long.valueOf(j6);
                            j7 = j4;
                            X(new m4(j7, lValueOf2, "_fot", DebugKt.DEBUG_PROPERTY_VALUE_AUTO), r4Var);
                            e().v();
                            f1 f1Var = this.H;
                            com.google.android.gms.common.internal.x.g(f1Var);
                            p1Var = f1Var.b;
                            if (str5 != null || str5.isEmpty()) {
                                ...
                                u0 u0Var = p1Var.C;
                                p1.m(u0Var);
                                u0Var.G.a("Install Referrer Reporter was called with invalid app package name");
                            } else {
                                str3 = "_et";
                                m1 m1Var = p1Var.D;
                                u0 u0Var2 = p1Var.C;
                                ...
                                if (f1Var.a()) {
                                    ...
                                    if (packageManager == null) {
                                        p1.m(u0Var2);
                                        u0Var2.G.a("Failed to obtain Package Manager to verify binding conditions for Install Referrer");
                                    } else {
                                        List<ResolveInfo> listQueryIntentServices = packageManager.queryIntentServices(intent, 0);
                                        if (listQueryIntentServices == null || listQueryIntentServices.isEmpty()) {
                                            p1.m(u0Var2);
                                            u0Var2.I.a("Play Service for fetching Install Referrer is unavailable on device");
                                        } else {
                                            ServiceInfo serviceInfo = listQueryIntentServices.get(0).serviceInfo;
                                            if (serviceInfo != null) {
                                                String str6 = serviceInfo.packageName;
                                                if (serviceInfo.name != null && "com.android.vending".equals(str6) && f1Var.a()) {
                                                    try {
                                                        boolean zA = com.google.android.gms.common.stats.a.b().a(context, new Intent(intent), e1Var, 1);
                                                        p1.m(u0Var2);
                                                        u0Var2.K.b(zA ? "available" : "not available", "Install Referrer Service is");
                                                    } catch (RuntimeException e) {
                                                        u0 u0Var3 = p1Var.C;
                                                        p1.m(u0Var3);
                                                        u0Var3.C.b(e.getMessage(), "Exception occurred while binding to Install Referrer Service");
                                                    }
                                                } else {
                                                    p1.m(u0Var2);
                                                    u0Var2.F.a("Play Store version 8.3.73 or higher required for Install Referrer");
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    p1.m(u0Var2);
                                    u0Var2.I.a("Install Referrer Reporter is not available");
                                    p1Var2 = p1Var4;
                                    str2 = str5;
                                }
                            }
                            ...
                            J = mVar6.J(str4);
                            p1Var3 = p1Var2;
                            if (p1Var3.e.getPackageManager() == null) {
                                b().C.b(u0.D(str4), "PackageManager is null, first open report might be inaccurate. appId");
                                r4Var2 = r4Var;
                            } else {
                                try {
                                    packageInfoC = com.google.android.gms.common.wrappers.b.a(p1Var3.e).c(0, str4);
                                } catch (PackageManager.NameNotFoundException e2) {
                                    b().C.c(u0.D(str4), e2, "Package info is null, first open report might be inaccurate. appId");
                                    packageInfoC = null;
                                }
                                if (packageInfoC != null) {
                                    ...
                                    if (j10 != 0) {
                                        ...
                                        m4 m4Var = new m4(j7, Long.valueOf(j11), "_fi", DebugKt.DEBUG_PROPERTY_VALUE_AUTO);
                                        r4Var2 = r4Var;
                                        X(m4Var, r4Var2);
                                    } else {
                                        r4Var2 = r4Var;
                                ...
                                try {
                                    applicationInfoB = com.google.android.gms.common.wrappers.b.a(p1Var3.e).b(0, str4);
                                } catch (PackageManager.NameNotFoundException e3) {
                                    b().C.c(u0.D(str4), e3, "Application info is null, first open report might be inaccurate. appId");
                            ...
                            i(new u("_f", new t(bundle2), DebugKt.DEBUG_PROPERTY_VALUE_AUTO, j7, j), r4Var2);
                        }
                    } else {
                        j5 = j4;
                        if (r4Var.F) {
                            i(new u("_cd", new t(new Bundle()), DebugKt.DEBUG_PROPERTY_VALUE_AUTO, j5, 0L), r4Var);
                        }
                    }
                    m mVar7 = this.z;
                    U(mVar7);
                ...
                j3 = 1;
                if (boolV != null) {
                    m4 m4Var2 = new m4(j2, Long.valueOf(true != boolV.booleanValue() ? 0L : j3), "_npa", DebugKt.DEBUG_PROPERTY_VALUE_AUTO);
                    j4 = j2;
                    if (n4VarR0 == null || !n4VarR0.e.equals(m4Var2.A)) {
                        X(m4Var2, r4Var);
                    }
                } else {
                    j4 = j2;
                ...
                if (rVarV == null) {
                    ...
                    if (z) {
                        ...
                        j7 = j4;
                        X(new m4(j7, lValueOf3, "_fot", DebugKt.DEBUG_PROPERTY_VALUE_AUTO), r4Var);
                        e().v();
                        f1 f1Var2 = this.H;
                        com.google.android.gms.common.internal.x.g(f1Var2);
                        p1Var = f1Var2.b;
                        if (str5 != null) {
                            p1Var2 = p1Var4;
                            str = "_elt";
                            ...
                            u0 u0Var4 = p1Var.C;
                            p1.m(u0Var4);
                            u0Var4.G.a("Install Referrer Reporter was called with invalid app package name");
                            e().v();
                            m0();
                            bundle2 = new Bundle();
                            j8 = j3;
                            ...
                            if (p1Var3.e.getPackageManager() == null) {
                                ...
                                if (packageInfoC != null) {
                                    ...
                                    if (j10 != 0) {
                                        ...
                                        m4 m4Var3 = new m4(j7, Long.valueOf(j11), "_fi", DebugKt.DEBUG_PROPERTY_VALUE_AUTO);
                                        r4Var2 = r4Var;
                                        X(m4Var3, r4Var2);
                                    } else {
                                        r4Var2 = r4Var;
                            ...
                            u0 u0Var5 = p1Var.C;
                            p1.m(u0Var5);
                            u0Var5.G.a("Install Referrer Reporter was called with invalid app package name");
                            e().v();
                            m0();
                            bundle2 = new Bundle();
                            j8 = j3;
                            ...
                            if (p1Var3.e.getPackageManager() == null) {
                                ...
                                if (packageInfoC != null) {
                                    ...
                                    if (j10 != 0) {
                                        ...
                                        m4 m4Var4 = new m4(j7, Long.valueOf(j11), "_fi", DebugKt.DEBUG_PROPERTY_VALUE_AUTO);
                                        r4Var2 = r4Var;
                                        X(m4Var4, r4Var2);
                                    } else {
                                        r4Var2 = r4Var;
                        ...
                        long j16 = j4;
                        X(new m4(j16, lValueOf4, "_fvt", DebugKt.DEBUG_PROPERTY_VALUE_AUTO), r4Var);
                        e().v();
                        m0();
                        bundle = new Bundle();
                        bundle.putLong("_c", 1L);
                        ...
                        c().getClass();
                        bundle.putLong("_elt", System.currentTimeMillis());
                        i(new u("_v", new t(bundle), DebugKt.DEBUG_PROPERTY_VALUE_AUTO, j16, j), r4Var);
                    }
                } else {
                    j5 = j4;
                    if (r4Var.F) {
        ...
        if (T(r4Var)) {
            ...
            try {
                ...
                if (eVarV0 != null && !eVarV0.y.equals(eVar2.y)) {
                    b().F.d("Updating a conditional user property with different origin. name, origin, origin (from DB)", p1Var.G.c(eVar2.z.y), eVar2.y, eVarV0.y);
                }
                if (eVarV0 != null && eVarV0.B) {
                    ...
                    eVar2.B = true;
                    m4 m4Var = eVar2.z;
                    eVar2.z = new m4(eVarV0.z.z, m4Var.d(), m4Var.y, eVarV0.z.C);
                } else if (TextUtils.isEmpty(eVar2.C)) {
                    m4 m4Var2 = eVar2.z;
                    eVar2.z = new m4(eVar2.A, m4Var2.d(), m4Var2.y, eVar2.z.C);
                    eVar2.B = true;
                    z = true;
                }
                if (eVar2.B) {
                    ...
                    com.google.android.gms.common.internal.x.g(str2);
                    String str3 = eVar2.y;
                    String str4 = m4Var3.y;
                    long j = m4Var3.z;
                    Object objD = m4Var3.d();
                    com.google.android.gms.common.internal.x.g(objD);
                    n4 n4Var = new n4(str2, str3, str4, j, objD);
                    Object obj = n4Var.e;
                    String str5 = n4Var.c;
                    m mVar3 = this.z;
                    U(mVar3);
                    if (mVar3.q0(n4Var)) {
                        b().J.d("User property updated immediately", eVar2.e, p1Var.G.c(str5), obj);
                    } else {
                        b().C.d("(2)Too many active user properties, ignoring", u0.D(eVar2.e), p1Var.G.c(str5), obj);
                    }
                    if (z && (uVar = eVar2.F) != null) {
                        l(new u(uVar, eVar2.A, 0L), r4Var);
                    }
                }
                m mVar4 = this.z;
                U(mVar4);
                if (mVar4.u0(eVar2)) {
                    b().J.d("Conditional property added", eVar2.e, p1Var.G.c(eVar2.z.y), eVar2.z.d());
                } else {
                    b().C.d("Too many conditional properties, ignoring", u0.D(eVar2.e), p1Var.G.c(eVar2.z.y), eVar2.z.d());
                }
                m mVar5 = this.z;
                U(mVar5);
                mVar5.k0();
    ...
    public final void b0(e eVar, r4 r4Var) {
        com.google.android.gms.common.internal.x.d(eVar.e);
        com.google.android.gms.common.internal.x.g(eVar.z);
        com.google.android.gms.common.internal.x.d(eVar.z.y);
        e().v();
        ...
        if (T(r4Var)) {
            ...
            try {
                ...
                p1 p1Var = this.I;
                if (eVarV0 != null) {
                    b().J.c(eVar.e, p1Var.G.c(eVar.z.y), "Removing conditional user property");
                    m mVar3 = this.z;
                    U(mVar3);
                    ...
                    b().F.c(u0.D(eVar.e), p1Var.G.c(eVar.z.y), "Conditional user property doesn't exist");
                }
                m mVar5 = this.z;
                U(mVar5);
                mVar5.k0();
    ...
    public final void c0(r4 r4Var, long j) throws Throwable {
        m mVar = this.z;
        U(mVar);
        String str = r4Var.e;
        com.google.android.gms.common.internal.x.g(str);
        ...
        if (z0VarZ0 != null) {
            ...
            if (!zIsEmpty && !zIsEmpty2) {
                com.google.android.gms.common.internal.x.g(str2);
                if (!str2.equals(strH)) {
                    b().F.b(u0.D(z0VarZ0.E()), "New GMP App Id passed in. Removing cached database data. appId");
                    m mVar2 = this.z;
                    U(mVar2);
                    p1 p1Var = (p1) mVar2.e;
                    String strE = z0VarZ0.E();
                    mVar2.w();
                    mVar2.v();
                    ...
                    try {
                        ...
                        if (iDelete > 0) {
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.K.c(strE, Integer.valueOf(iDelete), "Deleted application data. app, records");
                        }
                    } catch (SQLiteException e) {
                        u0 u0Var2 = p1Var.C;
                        p1.m(u0Var2);
                        u0Var2.C.c(u0.D(strE), e, "Error deleting application data. appId, error");
                    }
                    z0VarZ0 = null;
                }
            }
        ...
        if (z0VarZ0 != null) {
            boolean z = (z0VarZ0.Q() == -2147483648L || z0VarZ0.Q() == r4Var.G) ? false : true;
            String strO = z0VarZ0.O();
            if (z || ((z0VarZ0.Q() != -2147483648L || strO == null || strO.equals(r4Var.z)) ? false : true)) {
    ...
    public final c2 d(String str) throws Throwable {
        c2 c2Var = c2.c;
        e().v();
        m0();
        HashMap map = this.Y;
        c2 c2VarP = (c2) map.get(str);
        if (c2VarP == null) {
            m mVar = this.z;
            U(mVar);
            c2VarP = mVar.P(str);
    ...
    public final z0 d0(r4 r4Var) throws Throwable {
        boolean z;
        p1 p1Var;
        String str;
        long j;
        ...
        String str8 = r4Var.Q;
        if (!str8.isEmpty()) {
            this.a0.put(str7, new h4(this, str8));
        }
        m mVar = this.z;
        U(mVar);
        z0 z0VarZ0 = mVar.z0(str7);
        c2 c2VarJ = d(str7).j(c2.c(100, r4Var.P));
        String strB = this.F.B(r4Var, c2VarJ);
        boolean z9 = true;
        b2 b2Var = b2.AD_STORAGE;
        b2 b2Var2 = b2.ANALYTICS_STORAGE;
        if (z0VarZ0 != null) {
            p1 p1Var2 = z0VarZ0.a;
            if (c2VarJ.i(b2Var) && strB != null) {
                m1 m1Var = p1Var2.D;
                p1.m(m1Var);
                m1Var.v();
                if (!strB.equals(z0VarZ0.e)) {
                    m1 m1Var2 = p1Var2.D;
                    p1.m(m1Var2);
                    m1Var2.v();
                    boolean zIsEmpty = TextUtils.isEmpty(z0VarZ0.e);
                    z0VarZ0.J(strB);
                    if (z8 && !"00000000-0000-0000-0000-000000000000".equals(this.F.z(r4Var, c2VarJ).first) && !zIsEmpty) {
                        if (c2VarJ.i(b2Var2)) {
                            z0VarZ0.G(o(c2VarJ));
                            z = false;
                        } else {
                        ...
                        if (mVar2.r0(str7, "_id") != null) {
                            ...
                            if (mVar3.r0(str7, "_lair") == null) {
                                c().getClass();
                                n4 n4Var = new n4(str7, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lair", System.currentTimeMillis(), 1L);
                                m mVar4 = this.z;
                                U(mVar4);
                                mVar4.q0(n4Var);
                            }
                        }
                    } else if (TextUtils.isEmpty(z0VarZ0.F()) && c2VarJ.i(b2Var2)) {
                        z0VarZ0.G(o(c2VarJ));
                    }
                } else if (TextUtils.isEmpty(z0VarZ0.F())) {
                    z0VarZ0.G(o(c2VarJ));
                }
            } else if (TextUtils.isEmpty(z0VarZ0.F()) && c2VarJ.i(b2Var2)) {
                z0VarZ0.G(o(c2VarJ));
            ...
            p1.m(m1Var4);
            m1Var4.v();
            z0VarZ0.R |= !Objects.equals(z0VarZ0.q, bool);
            z0VarZ0.q = bool;
            z0VarZ0.c(r4Var.N);
            String str9 = r4Var.R;
            m1 m1Var5 = p1Var.D;
            p1.m(m1Var5);
            m1Var5.v();
            z0VarZ0.R |= !Objects.equals(z0VarZ0.t, str9);
            z0VarZ0.t = str9;
        ...
        z0VarZ0.R = z15 | z2;
        z0VarZ0.p = z8;
        Boolean bool2 = r4Var.M;
        m1 m1Var12 = p1Var.D;
        p1.m(m1Var12);
        m1Var12.v();
        z0VarZ0.R |= !Objects.equals(z0VarZ0.q, bool2);
        z0VarZ0.q = bool2;
        z0VarZ0.c(r4Var.N);
        String str10 = r4Var.R;
        m1 m1Var13 = p1Var.D;
        p1.m(m1Var13);
        m1Var13.v();
        z0VarZ0.R |= !Objects.equals(z0VarZ0.t, str10);
        z0VarZ0.t = str10;
        r3Var = com.google.android.gms.internal.measurement.r3.y;
        if (f0().G(null, f0.L0)) {
            z0VarZ0.y(r4Var.O);
    ...
    public final List e0(Bundle bundle, r4 r4Var) {
        int[] iArr;
        e().v();
        com.google.android.gms.internal.measurement.g4.a();
        g gVarF0 = f0();
        String str = r4Var.e;
        if (!gVarF0.G(str, f0.O0) || str == null) {
                    ...
                    while (i < intArray.length) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                s0Var.d(sb.toString(), str, Integer.valueOf(i2), Long.valueOf(j));
                            } catch (SQLiteException e) {
                                e = e;
                                u0 u0Var2 = p1Var.C;
                                p1.m(u0Var2);
                                u0Var2.C.c(u0.D(str), e, "Error pruning trigger URIs. appId");
                            }
                        } catch (SQLiteException e2) {
                            e = e2;
                            iArr = intArray;
        ...
        try {
            try {
                ...
                p1.m(u0Var3);
                u0Var3.C.c(u0.D(str2), e3, "Error querying trigger uris. appId");
    ...
    public final long g() {
        ...
        o3Var.w();
        o3Var.v();
        androidx.media3.exoplayer.l1 l1Var = o3Var.G;
        long jG = l1Var.g();
        if (jG == 0) {
            p4 p4Var = ((p1) o3Var.e).F;
            p1.k(p4Var);
            jG = ((long) p4Var.v0().nextInt(86400000)) + 1;
            l1Var.h(jG);
        }
            ...
            if (!TextUtils.isEmpty(z0VarZ0.O())) {
                ...
                if (boolP == null) {
                    if (!"_ui".equals(uVar.e)) {
                        b().F.b(u0.D(str), "Could not find package. appId");
                    }
                } else if (!boolP.booleanValue()) {
                    b().C.b(u0.D(str), "App version does not match; dropping event. appId");
                    return;
                }
                String strH = z0VarZ0.H();
                String strO = z0VarZ0.O();
                ...
                p1.m(m1Var9);
                m1Var9.v();
                i(uVar, new r4(str, strH, strO, jQ, str2, j, j2, (String) null, z, false, strK, 0L, 0, z2, false, boolX, jB, (List) arrayList, strG, "", (String) null, z3, j3, i, str3, i2, z0VarZ0.B, z0VarZ0.D(), z0VarZ0.s(), 0L, z0VarZ0.t(), 0L));
                return;
            }
        }
    ...
    public final void i(u uVar, r4 r4Var) throws Throwable {
        Throwable th;
        ...
        try {
            try {
                ...
                try {
                    if (cursorRawQuery.moveToFirst()) {
                        try {
                            t8 t8Var = (t8) ((s8) l4.g0(t8.K(), cursorRawQuery.getBlob(0))).d();
                            mVar.y.k0();
                            bundleE = l4.E(t8Var.w());
                            cursorRawQuery.close();
                        } catch (IOException e) {
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.C.c(u0.D(str), e, "Failed to retrieve default event parameters. appId");
                            if (cursorRawQuery != null) {
                                cursorRawQuery.close();
                            }
                            bundleE = null;
                        }
                        p4VarL0.I(bundle, bundleE);
                        p4 p4VarL1 = l0();
                        g gVarF0 = f0();
                        gVarF0.getClass();
                        p4VarL1.G(v0VarA, Math.max(Math.min(gVarF0.E(str, f0.X), 100), 25));
                        uVarB = v0VarA.b();
                        if (!f0().G(null, f0.Z0) && "_cmp".equals(uVarB.e)) {
                            tVar = uVarB.y;
                            if ("referrer API v2".equals(tVar.e.getString("_cis"))) {
                                string = tVar.e.getString("gclid");
                                if (!TextUtils.isEmpty(string)) {
                                    X(new m4(uVarB.A, string, "_lgclid", DebugKt.DEBUG_PROPERTY_VALUE_AUTO), r4Var);
                                }
                            }
                        }
                        j(uVarB, r4Var);
                    ...
                    u0 u0Var2 = p1Var.C;
                    p1.m(u0Var2);
                    u0Var2.K.a("Default event parameters not found");
                } catch (SQLiteException e2) {
                    e = e2;
                    u0 u0Var3 = p1Var.C;
                    p1.m(u0Var3);
                    u0Var3.C.b(e, "Error selecting default event parameters");
                }
            } catch (SQLiteException e3) {
                e = e3;
                cursorRawQuery = null;
            ...
            g gVarF1 = f0();
            gVarF1.getClass();
            p4VarL2.G(v0VarA, Math.max(Math.min(gVarF1.E(str, f0.X), 100), 25));
            uVarB = v0VarA.b();
            if (!f0().G(null, f0.Z0)) {
                tVar = uVarB.y;
                if ("referrer API v2".equals(tVar.e.getString("_cis"))) {
    ...
    public final a1 i0() {
        ...
        kotlinx.coroutines.future.a.u("Network broadcast receiver not created");
        return null;
    }
    ...
    public final void j(u uVar, r4 r4Var) {
        ...
        e().v();
        a3 a3Var = this.c0;
        if (a3Var == null || (str = this.d0) == null || !str.equals(str2)) {
            a3Var = null;
        }
        p4.s0(a3Var, v0VarA.e, false);
        u uVarB = v0VarA.b();
        k0();
        if (TextUtils.isEmpty(r4Var.y)) {
            return;
        }
        if (!r4Var.E) {
            d0(r4Var);
        ...
        try {
            ...
            if (i < 0) {
                u0 u0Var = ((p1) mVar8.e).C;
                p1.m(u0Var);
                u0Var.F.c(u0.D(str2), Long.valueOf(j2), "Invalid time querying timed out conditional properties");
            ...
            while (true) {
                ...
                e eVar = (e) it.next();
                if (eVar != null) {
                    b().K.d("User property timed out", eVar.e, p1Var.G.c(eVar.z.y), eVar.z.d());
                    u uVar2 = eVar.D;
                    if (uVar2 != null) {
                        j = j2;
            ...
            mVar10.w();
            if (i < 0) {
                u0 u0Var2 = ((p1) mVar10.e).C;
                p1.m(u0Var2);
                u0Var2.F.c(u0.D(str2), Long.valueOf(j4), "Invalid time querying expired conditional properties");
            ...
            while (it2.hasNext()) {
                ...
                if (eVar2 != null) {
                    ...
                    int i2 = i;
                    long j5 = j4;
                    b().K.d("User property expired", eVar2.e, p1Var.G.c(eVar2.z.y), eVar2.z.d());
                    m mVar11 = this.z;
                    U(mVar11);
            ...
            while (it4.hasNext()) {
                long j7 = j6;
                l(new u((u) it4.next(), j7, j3), r4Var);
                j6 = j7;
                j3 = j3;
            }
            long j8 = j3;
            ...
            mVar13.w();
            if (i3 < 0) {
                p1 p1Var2 = (p1) mVar13.e;
                u0 u0Var3 = p1Var2.C;
                p1.m(u0Var3);
                u0Var3.F.d("Invalid time querying triggered conditional properties", u0.D(str2), p1Var2.G.a(str4), Long.valueOf(j9));
            ...
            for (e eVar3 : listY2) {
                if (eVar3 != null) {
                    ...
                    Object objD = m4Var.d();
                    com.google.android.gms.common.internal.x.g(objD);
                    n4 n4Var = new n4(str5, str6, str7, j10, objD);
                    j9 = j10;
                    Object obj = n4Var.e;
                    String str8 = n4Var.c;
                    m mVar14 = this.z;
                    U(mVar14);
                    if (mVar14.q0(n4Var)) {
                        b().K.d("User property triggered", eVar3.e, p1Var.G.c(str8), obj);
                    } else {
                        b().C.d("Too many active user properties, ignoring", u0.D(eVar3.e), p1Var.G.c(str8), obj);
                    }
                    u uVar4 = eVar3.F;
                    if (uVar4 != null) {
                        arrayList2.add(uVar4);
                    }
                    eVar3.z = new m4(n4Var);
                    eVar3.B = true;
                    m mVar15 = this.z;
                    U(mVar15);
                    mVar15.u0(eVar3);
            ...
            while (it5.hasNext()) {
                long j11 = j8;
                l(new u((u) it5.next(), j9, j11), r4Var);
                j8 = j11;
            }
            m mVar16 = this.z;
            U(mVar16);
    ...
    public final void l(u uVar, r4 r4Var) throws Throwable {
        j4 j4Var;
        String str;
        t tVar;
        long jRound;
        ...
        i1 i1VarG0 = g0();
        String str19 = uVar.e;
        boolean zK = i1VarG0.K(str17, str19);
        String str20 = "_err";
        p1 p1Var2 = this.I;
        String str21 = str18;
        androidx.media3.exoplayer.hls.c cVar2 = this.g0;
        if (zK) {
            b().A().c(u0.D(str17), p1Var2.n().a(str19), "Dropping blocked event. appId");
            if (!"1".equals(g0().d(str17, "measurement.upload.blacklist_internal")) && !"1".equals(g0().d(str17, "measurement.upload.blacklist_public"))) {
                ...
                l0();
                p4.N(cVar2, str17, 11, "_ev", str19, 0);
                return;
            }
            z0 z0VarZ2 = h0().z0(str17);
            if (z0VarZ2 != null) {
                p1 p1Var3 = z0VarZ2.a;
                m1 m1Var = p1Var3.D;
                p1.m(m1Var);
                ...
                p1.m(m1Var2);
                m1Var2.v();
                long jMax2 = Math.max(j6, z0VarZ2.S);
                c().getClass();
                long jAbs = Math.abs(System.currentTimeMillis() - jMax2);
                f0();
                if (jAbs > ((Long) f0.N.a(null)).longValue()) {
        ...
        g gVarF1 = f0();
        gVarF1.getClass();
        p4VarL0.G(v0VarA, Math.max(Math.min(gVarF1.E(str17, f0.X), 100), 25));
        int iMax = Math.max(Math.min(f0().E(str17, f0.f0), 35), 10);
        Bundle bundle = v0VarA.e;
        ...
        if (Log.isLoggable(b().F(), 2)) {
            b().C().b(p1Var2.n().d(uVarB), "Logging event");
        }
        h0().j0();
        try {
            d0(r4Var);
            ...
            if (!"_iap".equals(str23)) {
                ...
                long j7 = jVarC0.b;
                f0();
                jIntValue = j7 - ((long) ((Integer) f0.l.a(null)).intValue());
                if (jIntValue > 0) {
                    if (jIntValue % 1000 == 1) {
                        b().z().c(u0.D(str17), Long.valueOf(jVarC0.b), "Data loss. Too many events logged. appId, count");
                    }
                    h0().k0();
                } else {
                    if (zW0) {
                        long j8 = jVarC0.a;
                        f0();
                        jIntValue2 = j8 - ((long) ((Integer) f0.n.a(null)).intValue());
                        if (jIntValue2 > 0) {
                            if (jIntValue2 % 1000 == 1) {
                                b().z().c(u0.D(str17), Long.valueOf(jVarC0.a), "Data loss. Too many public events logged. appId, count");
                            }
                            l0();
                            p4.N(cVar, str17, 16, "_ev", uVarB.e, 0);
                            h0().k0();
                        }
                    }
                    if (zEquals) {
                        jMax = jVarC0.d - ((long) Math.max(0, Math.min(1000000, f0().E(str17, f0.m))));
                        if (jMax > 0) {
                            if (jMax == 1) {
                                b().z().c(u0.D(str17), Long.valueOf(jVarC0.d), "Too many error events logged. appId, count");
                            }
                            h0().k0();
                        }
                    }
                    ...
                    if (l0().b0(str17, r4Var.Y)) {
                        l0().M(bundleH, "_dbg", 1L);
                        l0().M(bundleH, "_r", 1L);
                    }
                    if ("_s".equals(str3) && (n4VarR0 = h0().r0(str17, "_sno")) != null) {
                        obj = n4VarR0.e;
                        if (obj instanceof Long) {
                    ...
                    mVarH1.w();
                    try {
                        jDelete = mVarH1.m0().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str17, String.valueOf(Math.max(0, Math.min(1000000, ((p1) mVarH1.e).A.E(str17, f0.q))))});
                    } catch (SQLiteException e) {
                        ((p1) mVarH1.e).b().z().c(u0.D(str17), e, "Error deleting over the limit events. appId");
                        jDelete = 0;
                    }
                    if (jDelete > 0) {
                        b().A().c(u0.D(str17), Long.valueOf(jDelete), "Data lost. Too many events stored on disk, deleted. appId");
                    }
                    p1Var = this.I;
                    qVar = new q(p1Var, uVarB.z, str17, uVarB.e, uVarB.A, uVarB.B, 0L, bundleH);
                    str4 = str17;
                    m mVarH4 = h0();
                    str5 = qVar.b;
                    ...
                    if (rVarV == null) {
                        ...
                        gVarF0.getClass();
                        e0Var = f0.W;
                        if (jM >= Math.max(Math.min(gVarF0.E(str4, e0Var), 2000), 500) || !zW0 || l0().E0(str5)) {
                            str4 = str4;
                            ...
                            s0 s0VarZ = b().z();
                            t0 t0VarD = u0.D(str4);
                            String strA = p1Var.n().a(str5);
                            g gVarF2 = f0();
                            gVarF2.getClass();
                            s0VarZ.d("Too many event names used, ignoring event. appId, name, supported count", t0VarD, strA, Integer.valueOf(Math.max(Math.min(gVarF2.E(str4, e0Var), 2000), 500)));
                            l0();
                            p4.N(cVar, str4, 8, null, null, 0);
                        }
                    } else {
                        q qVarA = qVar.a(p1Var, rVarV.f);
                    ...
                    c2 c2VarD = d(str4);
                    str9 = str8;
                    String str25 = r4Var.P;
                    c2VarJ = c2VarD.j(c2.c(100, str25));
                    a9VarZ.S(c2VarJ.f());
                    com.google.android.gms.internal.measurement.g4.a();
                    zG = f0().G(str4, f0.O0);
                    b2Var = b2.AD_STORAGE;
                    if (zG) {
                        l0();
                        if (p4.Y((String) f0.q0.a(null), str4)) {
                            a9VarZ.z(r4Var.W);
                            str10 = str21;
                            str11 = str7;
                            j5 = r4Var.X;
                            if (!c2VarJ.i(b2Var) && j5 != 0) {
                                j5 = (j5 & (-2)) | 32;
                            }
                            if (j5 == 1) {
                                z2 = true;
                    ...
                    if (f0().G(null, f0.V0) && (listM = g0().M(str4)) != null) {
                        a9VarZ.P(listM);
                    }
                    c2VarJ2 = d(str4).j(c2.c(100, str25));
                    if (c2VarJ2.i(b2Var)) {
                        try {
                            z = r4Var.K;
                            if (z) {
                                pairZ = this.F.z(r4Var, c2VarJ2);
                                if (TextUtils.isEmpty((CharSequence) pairZ.first) && z) {
                                    ...
                                    String str26 = str16;
                                    if (qVar2.b.equals(str26) || ((String) pairZ.first).equals("00000000-0000-0000-0000-000000000000") || (z0VarZ0 = h0().z0(str4)) == null) {
                                        j4 = j4;
                                    } else {
                                        m1 m1Var3 = z0VarZ0.a.D;
                                        p1.m(m1Var3);
                                        m1Var3.v();
                                        if (z0VarZ0.y) {
                                            u(str4, false, null, null);
                                            Bundle bundle2 = new Bundle();
                                            m1 m1Var4 = z0VarZ0.a.D;
                                            p1.m(m1Var4);
                                            m1Var4.v();
                                            Long l = z0VarZ0.z;
                                            if (l != null) {
                    ...
                    z0VarZ1 = h0().z0(str4);
                    if (z0VarZ1 == null) {
                        z0VarZ1 = new z0(p1Var, str4);
                        j4Var = this;
                        try {
                            z0VarZ1.G(j4Var.o(c2VarJ2));
                            z0VarZ1.L(r4Var.H);
                            z0VarZ1.I(str12);
                            if (c2VarJ2.i(b2Var)) {
                                z0VarZ1.J(j4Var.F.B(r4Var, c2VarJ2));
                            }
                            z0VarZ1.e(0L);
                            z0VarZ1.M(0L);
                            z0VarZ1.N(0L);
                    ...
                    if (c2VarJ2.i(b2.ANALYTICS_STORAGE) && !TextUtils.isEmpty(z0VarZ1.F())) {
                        String strF = z0VarZ1.F();
                        com.google.android.gms.common.internal.x.g(strF);
                        a9VarZ.u(strF);
                    }
                    if (!TextUtils.isEmpty(z0VarZ1.K())) {
                        String strK = z0VarZ1.K();
                        com.google.android.gms.common.internal.x.g(strK);
                        a9VarZ.L(strK);
                    }
                    listS0 = j4Var.h0().s0(str4);
                    i2 = i;
                    while (i2 < listS0.size()) {
                        j9 j9VarF = k9.F();
                        String str29 = ((n4) listS0.get(i2)).c;
                        j9VarF.b();
                        ((k9) j9VarF.y).H(str29);
                        long j9 = ((n4) listS0.get(i2)).d;
                        j9VarF.b();
                        ((k9) j9VarF.y).G(j9);
                        j4Var.k0().S(j9VarF, ((n4) listS0.get(i2)).e);
                        a9VarZ.b0(j9VarF);
                        if ("_sid".equals(((n4) listS0.get(i2)).c)) {
                            m1 m1Var6 = z0VarZ1.a.D;
                            p1.m(m1Var6);
                            m1Var6.v();
                            if (z0VarZ1.w != 0) {
                                l4VarK0 = j4Var.k0();
                                if (TextUtils.isEmpty(str9)) {
                                    ...
                                    str15 = str9;
                                    jE0 = l4VarK0.e0(str15.getBytes(StandardCharsets.UTF_8));
                                }
                                m1 m1Var7 = z0VarZ1.a.D;
                                p1.m(m1Var7);
                                m1Var7.v();
                                if (jE0 != z0VarZ1.w) {
                                    a9VarZ.b();
                    ...
                    try {
                        ...
                        try {
                            ...
                            it2 = tVar4.e.keySet().iterator();
                            do {
                                if (!it2.hasNext()) {
                                    i1 i1VarG1 = j4Var.g0();
                                    String str31 = qVar3.a;
                                    zL = i1VarG1.L(str31, qVar3.b);
                                    j jVarB0 = j4Var.h0().B0(j4Var.g(), str31, false, false, false, false);
                                    if (!zL && jVarB0.e < j4Var.f0().E(str31, f0.p)) {
                                        break;
                                    }
                                    i3 = i;
                                    break;
                            ...
                            try {
                                if (mVarH3.m0().insert("raw_events", null, contentValues) == -1) {
                                    ((p1) mVarH3.e).b().z().b(u0.D(str14), "Failed to insert raw event (got -1). appId");
                                } else {
                                    j4Var.L = 0L;
                                }
                            } catch (SQLiteException e2) {
                                ((p1) mVarH3.e).b().z().c(u0.D(qVar3.a), e2, "Error storing raw event. appId");
                            }
                            j4Var.h0().k0();
                            j4Var.h0().l0();
                            j4Var.N();
                            j4Var.b().C().b(Long.valueOf(((System.nanoTime() - jNanoTime) + 500000) / 1000000), "Background event processing time, ms");
                            return;
                        } catch (SQLiteException e3) {
                            ((p1) mVarH2.e).b().z().c(u0.D(b9Var.u()), e3, "Error storing raw event metadata. appId");
                            throw e3;
                        }
                    } catch (IOException e4) {
                        j4Var.b().z().c(u0.D(a9VarZ.n()), e4, "Data loss. Failed to insert raw event metadata. appId");
                    }
                }
                h0().l0();
            }
            String strF2 = tVar3.f();
            str = "app_id";
            Bundle bundle3 = tVar3.e;
            tVar = tVar3;
            if (z11) {
                ...
                if (dDoubleValue > 9.223372036854776E18d || dDoubleValue < -9.223372036854776E18d) {
                    b().A().c(u0.D(str17), Double.valueOf(dDoubleValue), "Data lost. Currency value is too big. appId");
                    h0().k0();
                } else {
            ...
            if (!TextUtils.isEmpty(strF2)) {
                ...
                if (upperCase.matches("[A-Z]{3}")) {
                    ...
                    n4 n4VarR1 = h0().r0(str17, strConcat);
                    try {
                        if (n4VarR1 != null) {
                            Object obj3 = n4VarR1.e;
                            if (obj3 instanceof Long) {
                                String str32 = uVarB.z;
                                c().getClass();
                                str2 = str23;
                                n4Var = new n4(str17, str32, strConcat, System.currentTimeMillis(), Long.valueOf(((Long) obj3).longValue() + jRound));
                            }
                            if (h0().q0(n4Var)) {
                                cVar = cVar2;
                            } else {
                                b().z().d("Too many unique user properties are set. Ignoring user property. appId", u0.D(str17), p1Var2.n().c(n4Var.c), n4Var.e);
                                l0();
                                p4.N(cVar2, str17, 9, null, null, 0);
                                cVar = cVar2;
                            }
                        }
                        ...
                        ((p1) mVarH0.e).b().z().c(u0.D(str17), e5, "Error pruning currencies. appId");
                    }
                    long j10 = jRound;
                    str2 = str23;
                    mVarH0 = h0();
                    iE = f0().E(str17, f0.T) - 1;
                    com.google.android.gms.common.internal.x.d(str17);
                    mVarH0.v();
                    mVarH0.w();
                    String str33 = uVarB.z;
                    c().getClass();
                    n4Var = new n4(str17, str33, strConcat, System.currentTimeMillis(), Long.valueOf(j10));
                    if (h0().q0(n4Var)) {
                        b().z().d("Too many unique user properties are set. Ignoring user property. appId", u0.D(str17), p1Var2.n().c(n4Var.c), n4Var.e);
                        l0();
                        p4.N(cVar2, str17, 9, null, null, 0);
                ...
                long j11 = jVarC0.b;
                f0();
                jIntValue = j11 - ((long) ((Integer) f0.l.a(null)).intValue());
                if (jIntValue > 0) {
                    if (zW0) {
                        long j12 = jVarC0.a;
                        f0();
                        jIntValue2 = j12 - ((long) ((Integer) f0.n.a(null)).intValue());
                        if (jIntValue2 > 0) {
                            if (jIntValue2 % 1000 == 1) {
                                b().z().c(u0.D(str17), Long.valueOf(jVarC0.a), "Data loss. Too many public events logged. appId, count");
                            }
                    ...
                    if (rVarV == null) {
                        ...
                        gVarF0.getClass();
                        e0Var = f0.W;
                        if (jM >= Math.max(Math.min(gVarF0.E(str4, e0Var), 2000), 500)) {
                        }
                        str4 = str4;
                        rVar = new r(str4, str5, 0L, 0L, 0L, qVar.d, 0L, null, null, null, null);
                        qVar2 = qVar;
                    } else {
                        q qVarA2 = qVar.a(p1Var, rVarV.f);
                    ...
                    c2 c2VarD2 = d(str4);
                    str9 = str8;
                    String str211 = r4Var.P;
                    c2VarJ = c2VarD2.j(c2.c(100, str211));
                    a9VarZ.S(c2VarJ.f());
                    com.google.android.gms.internal.measurement.g4.a();
                    zG = f0().G(str4, f0.O0);
                    b2Var = b2.AD_STORAGE;
                    ...
                    c2VarJ2 = d(str4).j(c2.c(100, str211));
                    if (c2VarJ2.i(b2Var)) {
                        z = r4Var.K;
                        if (z) {
                            pairZ = this.F.z(r4Var, c2VarJ2);
                    ...
                    if (c2VarJ2.i(b2.ANALYTICS_STORAGE)) {
                        String strF3 = z0VarZ1.F();
                        com.google.android.gms.common.internal.x.g(strF3);
                        a9VarZ.u(strF3);
                    }
                    if (!TextUtils.isEmpty(z0VarZ1.K())) {
                        String strK2 = z0VarZ1.K();
                    ...
                    while (i2 < listS0.size()) {
                        j9 j9VarF2 = k9.F();
                        String str214 = ((n4) listS0.get(i2)).c;
                        j9VarF2.b();
                        ((k9) j9VarF2.y).H(str214);
                        long j13 = ((n4) listS0.get(i2)).d;
                        j9VarF2.b();
                        ((k9) j9VarF2.y).G(j13);
                        j4Var.k0().S(j9VarF2, ((n4) listS0.get(i2)).e);
                        a9VarZ.b0(j9VarF2);
                        if ("_sid".equals(((n4) listS0.get(i2)).c)) {
                            m1 m1Var8 = z0VarZ1.a.D;
                            p1.m(m1Var8);
                            m1Var8.v();
                            if (z0VarZ1.w != 0) {
                                l4VarK0 = j4Var.k0();
                    ...
                    it2 = tVar5.e.keySet().iterator();
                    do {
                        if (!it2.hasNext()) {
                            i1 i1VarG2 = j4Var.g0();
                            String str35 = qVar3.a;
                            zL = i1VarG2.L(str35, qVar3.b);
                            j jVarB1 = j4Var.h0().B0(j4Var.g(), str35, false, false, false, false);
                            if (!zL) {
                                i3 = i;
                                break;
                            } else {
            ...
            long j14 = jVarC0.b;
            f0();
            jIntValue = j14 - ((long) ((Integer) f0.l.a(null)).intValue());
            if (jIntValue > 0) {
                if (zW0) {
                    long j15 = jVarC0.a;
                    f0();
                    jIntValue2 = j15 - ((long) ((Integer) f0.n.a(null)).intValue());
                    if (jIntValue2 > 0) {
                        if (jIntValue2 % 1000 == 1) {
                            b().z().c(u0.D(str17), Long.valueOf(jVarC0.a), "Data loss. Too many public events logged. appId, count");
                        }
                ...
                c2 c2VarD3 = d(str4);
                str9 = str8;
                String str216 = r4Var.P;
                c2VarJ = c2VarD3.j(c2.c(100, str216));
                a9VarZ.S(c2VarJ.f());
                com.google.android.gms.internal.measurement.g4.a();
                zG = f0().G(str4, f0.O0);
                b2Var = b2.AD_STORAGE;
                ...
                c2VarJ2 = d(str4).j(c2.c(100, str216));
                if (c2VarJ2.i(b2Var)) {
                    z = r4Var.K;
                    if (z) {
                        pairZ = this.F.z(r4Var, c2VarJ2);
                ...
                while (i2 < listS0.size()) {
                    j9 j9VarF3 = k9.F();
                    String str219 = ((n4) listS0.get(i2)).c;
                    j9VarF3.b();
                    ((k9) j9VarF3.y).H(str219);
                    long j16 = ((n4) listS0.get(i2)).d;
                    j9VarF3.b();
                    ((k9) j9VarF3.y).G(j16);
                    j4Var.k0().S(j9VarF3, ((n4) listS0.get(i2)).e);
                    a9VarZ.b0(j9VarF3);
                    if ("_sid".equals(((n4) listS0.get(i2)).c)) {
                        m1 m1Var10 = z0VarZ1.a.D;
                        p1.m(m1Var10);
                        m1Var10.v();
                        if (z0VarZ1.w != 0) {
                            l4VarK0 = j4Var.k0();
                ...
                do {
                    if (!it2.hasNext()) {
                        ...
                        zL = i1VarG3.L(str37, qVar3.b);
                        j jVarB2 = j4Var.h0().B0(j4Var.g(), str37, false, false, false, false);
                        if (!zL) {
                            i3 = i;
                            break;
                        } else {
    ...
    public final void m(z0 z0Var, a9 a9Var) throws Throwable {
        androidx.media3.exoplayer.hls.c cVar;
        k9 k9Var;
        h hVar;
        e().v();
        ...
        if (length < length2 || strG0.charAt(0) != '1') {
            cVar = new androidx.media3.exoplayer.hls.c(24);
        } else {
            b2[] b2VarArrValues = b2.values();
            int length3 = b2VarArrValues.length;
            int i2 = 0;
            int i3 = 1;
            while (i2 < length3) {
                b2 b2Var = b2VarArrValues[i2];
                int i4 = i3 + 1;
                ...
                enumMap.put(b2Var, hVar);
                i2++;
                i3 = i4;
                i = 0;
            }
            cVar = new androidx.media3.exoplayer.hls.c(enumMap);
        }
        String strE = z0Var.E();
        e().v();
        m0();
        c2 c2VarD = d(strE);
        EnumMap enumMap2 = c2VarD.a;
        b2 b2Var2 = b2.AD_STORAGE;
        ...
        e().v();
        m0();
        o oVarR0 = r0(strE2, p0(strE2), d(strE2), cVar);
        String str = oVarR0.d;
        ...
        if (k9Var != null) {
            EnumMap enumMap3 = (EnumMap) cVar.y;
            ...
            if (hVar5 == hVar2) {
                m mVar = this.z;
                U(mVar);
                n4 n4VarR0 = mVar.r0(z0Var.E(), "_npa");
                h hVar6 = h.MANIFEST;
                h hVar7 = h.API;
                if (n4VarR0 != null) {
                    String str2 = n4VarR0.b;
                    if ("tcf".equals(str2)) {
                        cVar.L(b2Var4, h.TCF);
        ...
        String strE3 = z0Var.E();
        i1 i1Var = this.e;
        i1Var.v();
        i1Var.B(strE3);
        s7 s7VarR = i1Var.R(strE3);
    ...
    public final void m0() {
        ...
        kotlinx.coroutines.future.a.u("UploadController is not initialized");
    }

    public final void n(z0 z0Var, a9 a9Var) {
        Serializable serializableN;
        e().v();
        m0();
        d8 d8VarZ = g8.Z();
        ...
        if (bArr != null) {
            try {
                d8VarZ = (d8) l4.g0(d8VarZ, bArr);
            } catch (com.google.android.gms.internal.measurement.t1 unused) {
                b().F.b(u0.D(z0Var.E()), "Failed to parse locally stored ad campaign info. appId");
            }
        }
        ...
        while (it.hasNext()) {
            ...
            if (t8Var.z().equals("_cmp")) {
                w8 w8VarF = l4.F(t8Var, "gclid");
                Serializable serializableN2 = w8VarF == null ? null : l4.N(w8VarF);
                if (serializableN2 == null) {
                    serializableN2 = "";
                }
                String str = (String) serializableN2;
                w8 w8VarF2 = l4.F(t8Var, "gbraid");
                Serializable serializableN3 = w8VarF2 == null ? null : l4.N(w8VarF2);
                if (serializableN3 == null) {
                    serializableN3 = "";
                }
                String str2 = (String) serializableN3;
                w8 w8VarF3 = l4.F(t8Var, "gad_source");
                Serializable serializableN4 = w8VarF3 == null ? null : l4.N(w8VarF3);
                if (serializableN4 == null) {
                    serializableN4 = "";
                }
                String str3 = (String) serializableN4;
                w8 w8VarF4 = l4.F(t8Var, "deep_link_url");
                Serializable serializableN5 = w8VarF4 == null ? null : l4.N(w8VarF4);
                String str4 = (String) (serializableN5 != null ? serializableN5 : "");
                String[] strArrSplit = ((String) f0.b1.a(null)).split(",");
                k0();
                HashMap map = new HashMap();
                for (w8 w8Var : t8Var.w()) {
                    Iterator it2 = it;
                    if (Arrays.asList(strArrSplit).contains(w8Var.v()) && (serializableN = l4.N(w8Var)) != null) {
                ...
                Iterator it3 = it;
                if (!map.isEmpty()) {
                    w8 w8VarF5 = l4.F(t8Var, "click_timestamp");
                    Serializable serializableN6 = w8VarF5 == null ? null : l4.N(w8VarF5);
                    long jLongValue = ((Long) (serializableN6 != null ? serializableN6 : 0L)).longValue();
                    if (jLongValue <= 0) {
                        jLongValue = t8Var.B();
                    }
                    long j = jLongValue;
                    w8 w8VarF6 = l4.F(t8Var, "_cis");
                    if ("referrer API v2".equals(w8VarF6 == null ? null : l4.N(w8VarF6))) {
                        if (j > ((g8) d8VarZ.y).W()) {
                            if (str.isEmpty()) {
                                d8VarZ.b();
                                ((g8) d8VarZ.y).x();
        ...
        if (f0().G(null, f0.Z0)) {
            m mVar2 = this.z;
            U(mVar2);
            mVar2.p0(z0Var.E(), "_lgclid");
        }
    }

    public final void n0(r4 r4Var) throws Throwable {
        e().v();
        m0();
        String str = r4Var.e;
        com.google.android.gms.common.internal.x.d(str);
        c2 c2VarC = c2.c(r4Var.U, r4Var.P);
        d(str);
        b().K.c(str, c2VarC, "Setting storage consent for package");
        e().v();
        m0();
        this.Y.put(str, c2VarC);
        m mVar = this.z;
        U(mVar);
        mVar.b0(str, c2VarC);
    }
    ...
    public final void o0(r4 r4Var) throws Throwable {
        e().v();
        m0();
        String str = r4Var.e;
        com.google.android.gms.common.internal.x.d(str);
        ...
        z1 z1VarA2 = o.c(100, q0(str)).a();
        e().v();
        m0();
        z1 z1Var = z1.GRANTED;
        z1 z1Var2 = z1.DENIED;
        boolean z = z1VarA == z1Var2 && z1VarA2 == z1Var;
        boolean z2 = z1VarA == z1Var && z1VarA2 == z1Var2;
        if (z || z2) {
            b().K.b(str, "Generated _dcu event for");
            Bundle bundle = new Bundle();
            m mVar2 = this.z;
            U(mVar2);
            if (mVar2.B0(g(), str, false, false, false, false).f < f0().E(str, f0.l0)) {
                bundle.putLong("_r", 1L);
                m mVar3 = this.z;
                U(mVar3);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r11v0, types: [com.google.android.gms.measurement.internal.j4] */
            ...
            if (bool == null) {
                ...
                if (this.V != null) {
                    ...
                    if (y0Var.z()) {
                        ...
                        string = null;
                        String string = null;
                        int iE = f0().E(null, f0.h0);
                        f0();
                        long jLongValue = CurrentTimeMillis - ((Long) f0.e.a(null)).longValue();
                        ...
                        if (TextUtils.isEmpty(strD)) {
                            try {
                                ...
                                U(mVar2);
                                f0();
                                long jLongValue2 = CurrentTimeMillis - ((Long) f0.e.a(null)).longValue();
                                mVar2.v();
                                mVar2.w();
                                try {
                                    ...
                                    try {
                                        if (CurrentTimeMillis.moveToFirst()) {
                                            ...
                                            u0 u0Var = ((p1) mVar2.e).C;
                                            p1.m(u0Var);
                                            u0Var.K.a("No expired configs for apps with pending events");
                                        }
                                    } catch (SQLiteException e2) {
                                        e = e2;
                                        u0 u0Var2 = ((p1) mVar2.e).C;
                                        p1.m(u0Var2);
                                        u0Var2.C.b(e, "Error selecting expired configs");
                                        if (CurrentTimeMillis != 0) {
                                        }
                                        if (!TextUtils.isEmpty(string)) {
                                            m mVar3 = this.z;
                                            U(mVar3);
                                            z0VarZ0 = mVar3.z0(string);
                                            if (z0VarZ0 != null) {
                                                A(z0VarZ0);
                                            }
                                        }
                            ...
                            if (this.X == -1) {
                                ...
                                try {
                                    try {
                                        ...
                                        u0 u0Var3 = ((p1) mVar5.e).C;
                                        p1.m(u0Var3);
                                        u0Var3.C.b(e4, "Error querying raw events");
                                        if (cursorRawQuery != null) {
                                        }
                                        this.X = j;
    ...
    public final Bundle q0(String str) throws Throwable {
        ...
        c2 c2VarD = d(str);
        Bundle bundle2 = new Bundle();
        Iterator it = c2VarD.a.entrySet().iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            Map.Entry entry = (Map.Entry) it.next();
            int iOrdinal = ((z1) entry.getValue()).ordinal();
            String str2 = iOrdinal != 2 ? iOrdinal != 3 ? null : "granted" : "denied";
            if (str2 != null) {
                bundle2.putString(((b2) entry.getKey()).e, str2);
            }
        }
        bundle.putAll(bundle2);
        o oVarR0 = r0(str, p0(str), c2VarD, new androidx.media3.exoplayer.hls.c(24));
        Bundle bundle3 = new Bundle();
        for (Map.Entry entry2 : oVarR0.e.entrySet()) {
            int iOrdinal2 = ((z1) entry2.getValue()).ordinal();
            String str3 = iOrdinal2 != 2 ? iOrdinal2 != 3 ? null : "granted" : "denied";
            if (str3 != null) {
                bundle3.putString(((b2) entry2.getKey()).e, str3);
            }
        }
        Boolean bool = oVarR0.c;
        if (bool != null) {
        ...
        m mVar = this.z;
        U(mVar);
        n4 n4VarR0 = mVar.r0(str, "_npa");
        bundle.putString("ad_personalization", 1 != (n4VarR0 != null ? n4VarR0.e.equals(1L) : F(str, new androidx.media3.exoplayer.hls.c(24))) ? "granted" : "denied");
        return bundle;
    }
  ...
  0x006f: PHI (r24v19 long) = (r24v2 long), (r24v20 long) binds: [B:108:0x0225, B:16:0x006d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Type inference failed for: r31v0, types: [com.google.android.gms.measurement.internal.j4] */
    public final void r(String str, long j) throws Throwable {
        ...
        long jA2;
        String str3 = str;
        int iE = f0().E(str3, f0.h);
        int i9 = 0;
        int iMax = Math.max(0, f0().E(str3, f0.i));
        m mVarH0 = h0();
        p1 p1Var4 = (p1) mVarH0.e;
        mVarH0.v();
        mVarH0.w();
        int i10 = 1;
            ...
            try {
                try {
                    ...
                    try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            while (true) {
                                                ...
                                                try {
                                                    ((p1) l4VarK0.e).b().z().b(e, "Failed to ungzip content");
                                                    throw e;
                                                } catch (IOException e3) {
                                                    e = e3;
                                                    p1Var4.b().z().c(u0.D(str3), e, "Failed to unzip queued bundle. appId");
                                                    try {
                                                        ...
                                                        e = e4;
                                                        p1Var4.b().z().c(u0.D(str3), e, "Error querying bundles. appId");
                                                    ...
                                                    g gVarF0 = f0();
                                                    e0Var = f0.c1;
                                                    zG = gVarF0.G(null, e0Var);
                                                    b2Var = b2.ANALYTICS_STORAGE;
                                                    if (zG) {
                                                        if (!f0().G(null, e0Var)) {
                                                            list6 = list2;
                                                        } else if (d(str).i(b2Var)) {
                                                            ...
                                                            if (cursorQuery2.moveToFirst()) {
                                                                list7 = list2;
                                                                while (true) {
                                                                    arrayList6.add((t8) ((s8) l4.g0(t8.K(), cursorQuery2.getBlob(0))).d());
                                                                                ...
                                                                                while (true) {
                                                                                    try {
                                                                                        try {
                                                                                            ...
                                                                                            p1Var3.b().H.c(u0.D(str3), e5, "Failed to parse stored NO_DATA mode event, appId");
                                                                                        }
                                                                                        try {
                                                                                            try {
                                                                                                if (!cursorQuery2.moveToNext()) {
                                                                                            ...
                                                                                            e = e6;
                                                                                            p1Var3.b().z().c(u0.D(str3), e, "Error flushing NO_DATA mode events. appId");
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            while (it3.hasNext()) {
                                                                                                ...
                                                                                                if ("_fx".equals(t8Var.z())) {
                                                                                                    ...
                                                                                                    k0();
                                                                                                    w8VarF = l4.F(t8Var, "_pfo");
                                                                                                    if (w8VarF != null) {
                                                                                                        lValueOf = Long.valueOf(w8VarF.z());
                                                                                                    }
                                                                                                    k0();
                                                                                                    w8VarF2 = l4.F(t8Var, "_uwa");
                                                                                                    if (w8VarF2 != null) {
                                                                                        ...
                                                                                        if (z2Var != z2.SGTM) {
                                                                                            ...
                                                                                            if (y0Var.z()) {
                                                                                                ...
                                                                                                this.R = true;
                                                                                                U(y0Var);
                                                                                                y0Var.C(str3, f4VarW, z8Var, new com.google.android.datatransport.runtime.j((j4) this, str3, (Object) arrayList2, 13));
                                                                                                return;
                                                                                            }
                                                                                            return;
                                                                                        }
                                                                                        ...
                                                                                        s0VarC2.b(strG, "[sgtm] Processed MeasurementBatch for sGTM with sgtmJoinId: ");
                                                                                        z8Var2 = (z8) y8VarC.d();
                                                                                        if (TextUtils.isEmpty(string)) {
                                                                                            str2 = null;
                                                                                        } else {
                                                                                            ...
                                                                                            strI2 = g4Var.y.g0().I(str3);
                                                                                            zIsEmpty = TextUtils.isEmpty(strI2);
                                                                                            z2Var2 = z2.GOOGLE_SIGNAL;
                                                                                            z2Var3 = z2.GOOGLE_SIGNAL_PENDING;
                                                                                            if (zIsEmpty) {
                                                                                                str2 = null;
                                                                                                String str4 = (String) f0.s.a(null);
                                                                                                if (z2) {
                                                                                                    z2Var2 = z2Var3;
                                                                                                }
                                                                                                f4Var = new f4(str4, Collections.EMPTY_MAP, z2Var2, null);
                                                                                            } else {
                                                                                                Uri uri = Uri.parse((String) f0.s.a(null));
                                                                                                ...
                                                                                                str2 = null;
                                                                                                f4Var = new f4(string2, Collections.EMPTY_MAP, z2Var2, null);
                                                                                            }
                                                                                            arrayList2.add(Pair.create(z8Var5, f4Var));
                                                                                        }
                                                                                        if (z2) {
                                                                                            str3 = str;
                                                                                            z8Var = z8Var2;
                                                                                        ...
                                                                                        arrayList2.add(Pair.create((z8) y8Var.d(), f4VarW));
                                                                                        p(arrayList);
                                                    ...
                                                    s0VarC4.b(strG, "[sgtm] Processed MeasurementBatch for sGTM with sgtmJoinId: ");
                                                    z8Var2 = (z8) y8VarC.d();
                                                    if (TextUtils.isEmpty(string)) {
                                                        ...
                                                        z2Var3 = z2.GOOGLE_SIGNAL_PENDING;
                                                        if (zIsEmpty) {
                                                            Uri uri2 = Uri.parse((String) f0.s.a(null));
                                                            ...
                                                            str2 = null;
                                                            f4Var = new f4(string3, Collections.EMPTY_MAP, z2Var2, null);
                                                        } else {
                                                            str2 = null;
                                                            String str5 = (String) f0.s.a(null);
                                                            if (z2) {
                                                                z2Var2 = z2Var3;
                                                            }
                                                            f4Var = new f4(str5, Collections.EMPTY_MAP, z2Var2, null);
                                                        }
                                                        arrayList2.add(Pair.create(z8Var8, f4Var));
                                                    } else {
                                                        str2 = null;
                                                    }
                                                    if (z2) {
                                            ...
                                            try {
                                                a9 a9Var5 = (a9) l4.g0(b9.Z(), byteArray);
                                                ...
                                                p1Var4.b().z().c(u0.D(str3), e11, "Failed to merge queued bundle. appId");
                                            }
                                            p1Var4 = p1Var4;
                        ...
                        s0VarC7.b(strG, "[sgtm] Processed MeasurementBatch for sGTM with sgtmJoinId: ");
                        z8Var2 = (z8) y8VarC.d();
                        if (TextUtils.isEmpty(string)) {
                            ...
                            z2Var3 = z2.GOOGLE_SIGNAL_PENDING;
                            if (zIsEmpty) {
                                Uri uri3 = Uri.parse((String) f0.s.a(null));
                                ...
                                str2 = null;
                                f4Var = new f4(string4, Collections.EMPTY_MAP, z2Var2, null);
                            } else {
                                str2 = null;
                                String str6 = (String) f0.s.a(null);
                                if (z2) {
                                    z2Var2 = z2Var3;
                                }
                                f4Var = new f4(str6, Collections.EMPTY_MAP, z2Var2, null);
                            }
                            arrayList2.add(Pair.create(z8Var11, f4Var));
                        } else {
                            str2 = null;
                        }
                        if (z2) {
                ...
                g gVarF2 = f0();
                e0Var = f0.c1;
                zG = gVarF2.G(null, e0Var);
                b2Var = b2.ANALYTICS_STORAGE;
                if (zG) {
                    if (!f0().G(null, e0Var)) {
                        list6 = list2;
                    } else if (d(str).i(b2Var) || !g0().A(str3)) {
                        arrayList5 = new ArrayList(list2.size());
                        m mVarH5 = h0();
                        p1Var2 = (p1) mVarH5.e;
                        com.google.android.gms.common.internal.x.d(str3);
                        ...
                        List listAsList = Arrays.asList(((String) f0.d1.a(null)).split(","));
                            ...
                            try {
                                ...
                                for (t8 t8Var2 : ((b9) pair7.first).U1()) {
                                    if (listAsList.contains(t8Var2.z())) {
                                        ...
                                        mVarH6.w();
                                        com.google.android.gms.common.internal.x.d(str3);
                                        p1 p1Var5 = (p1) mVarH6.e;
                                        p1Var5.b().C().b(t8Var2, "Caching events in NO_DATA mode");
                                        ContentValues contentValues = new ContentValues();
                                        ...
                                        try {
                                            if (mVarH6.m0().insert("no_data_mode_events", null, contentValues) == j2) {
                                                p1Var5.b().z().b(u0.D(str3), "Failed to insert NO_DATA mode event (got -1). appId");
                                            }
                                        } catch (SQLiteException e17) {
                                            ((p1) mVarH6.e).b().z().c(u0.D(str3), e17, "Error storing NO_DATA mode event. appId");
                                        }
                                    }
                                }
                ...
                s0VarC9.b(strG, "[sgtm] Processed MeasurementBatch for sGTM with sgtmJoinId: ");
                z8Var2 = (z8) y8VarC.d();
                if (TextUtils.isEmpty(string)) {
                    ...
                    z2Var3 = z2.GOOGLE_SIGNAL_PENDING;
                    if (zIsEmpty) {
                        Uri uri4 = Uri.parse((String) f0.s.a(null));
                        ...
                        str2 = null;
                        f4Var = new f4(string5, Collections.EMPTY_MAP, z2Var2, null);
                    } else {
                        str2 = null;
                        String str7 = (String) f0.s.a(null);
                        if (z2) {
                            z2Var2 = z2Var3;
                        }
                        f4Var = new f4(str7, Collections.EMPTY_MAP, z2Var2, null);
                    }
                    arrayList2.add(Pair.create(z8Var14, f4Var));
                } else {
                    str2 = null;
                }
                if (z2) {
    ...
    public final o r0(String str, o oVar, c2 c2Var, androidx.media3.exoplayer.hls.c cVar) {
        b2 b2VarG;
        z1 z1VarZ;
        i1 i1Var = this.e;
        U(i1Var);
        ...
        if (z1VarA == z1Var2 || z1VarA == z1Var) {
            i = oVar.a;
            cVar.K(b2Var, i);
        } else {
            z1 z1Var3 = z1.POLICY;
            z1 z1Var4 = z1.UNINITIALIZED;
            if (z1VarA != z1Var3 || (z1VarZ = i1Var.z(str, b2Var)) == z1Var4) {
                i1Var.v();
                i1Var.B(str);
                s7 s7VarR2 = i1Var.R(str);
                if (s7VarR2 != null) {
                ...
                EnumMap enumMap = c2Var.a;
                b2 b2Var2 = b2.AD_STORAGE;
                z1 z1Var5 = (z1) enumMap.get(b2Var2);
                if (z1Var5 != null) {
                    z1Var4 = z1Var5;
                }
                boolean z = z1Var4 == z1Var2 || z1Var4 == z1Var;
                if (b2VarG == b2Var2 && z) {
                    cVar.L(b2Var, h.REMOTE_DELEGATION);
                    z1VarA = z1Var4;
                } else {
                    cVar.L(b2Var, h.REMOTE_DEFAULT);
                    z1VarA = true != i1Var.Q(str, b2Var) ? z1Var : z1Var2;
                }
            } else {
                cVar.L(b2Var, h.REMOTE_ENFORCED_DEFAULT);
                z1VarA = z1VarZ;
        ...
        if (z1VarA == z1Var || treeSet.isEmpty()) {
    ...
    public final boolean s(String str, String str2) throws Throwable {
        ...
        z0 z0VarZ0 = mVar.z0(str);
        HashMap map = this.b0;
        if (z0VarZ0 != null && l0().b0(str, z0VarZ0.D())) {
            map.remove(str2);
            return true;
        }
        i4 i4Var = (i4) map.get(str2);
        if (i4Var != null) {
            i4Var.a.c().getClass();
            if (System.currentTimeMillis() < i4Var.c) {
                return false;
            }
        }
        return true;
            ...
            if (bool == null) {
                ...
                if (y0Var.z()) {
                    ...
                    if (mVar.B(str)) {
                        ...
                        mVar2.v();
                        mVar2.w();
                        List listA = mVar2.A(str, c4.d(z2.GOOGLE_SIGNAL), 1);
                        k4 k4Var = listA.isEmpty() ? null : (k4) listA.get(0);
                        if (k4Var != null) {
                            z8 z8Var = k4Var.b;
                            b().K.d("[sgtm] Uploading data from upload queue. appId, type, url", str, k4Var.e, k4Var.c);
                            byte[] bArrA = z8Var.a();
                            if (Log.isLoggable(b().F(), 2)) {
                                l4 l4Var = this.D;
                                U(l4Var);
                                b().K.d("[sgtm] Uploading data from upload queue. appId, uncompressed size, data", str, Integer.valueOf(bArrA.length), l4Var.W(z8Var));
                            }
                            f4 f4Var = new f4(k4Var.c, k4Var.d, k4Var.e, null);
                            this.R = true;
                            y0 y0Var2 = this.y;
                            U(y0Var2);
                            y0Var2.C(str, f4Var, z8Var, new com.google.android.datatransport.runtime.j(this, str, (Object) k4Var, 14));
                        }
                    } else {
    ...
    public final void u(String str, boolean z, Long l, Long l2) throws Throwable {
        ...
        if (z0VarZ0 != null) {
            ...
            p1.m(m1Var);
            m1Var.v();
            z0VarZ0.R |= z0VarZ0.y != z;
            z0VarZ0.y = z;
            m1 m1Var2 = p1Var.D;
            p1.m(m1Var2);
            m1Var2.v();
            z0VarZ0.R |= !Objects.equals(z0VarZ0.z, l);
            z0VarZ0.z = l;
            m1 m1Var3 = p1Var.D;
            p1.m(m1Var3);
            m1Var3.v();
            z0VarZ0.R |= !Objects.equals(z0VarZ0.A, l2);
            z0VarZ0.A = l2;
            if (z0VarZ0.o()) {
                m mVar2 = this.z;
                U(mVar2);
                mVar2.A0(z0VarZ0, false);
            }
        }
    }
    ...
    public final void v(a9 a9Var, String str) {
        ...
        i1Var.v();
        i1Var.B(str);
        androidx.collection.f fVar = i1Var.B;
        ...
        i1Var.v();
        i1Var.B(str);
        if (fVar.get(str) != null && ((Set) fVar.get(str)).contains("user_id") && (iH0 = l4.h0(a9Var, "_id")) != -1) {
            a9Var.b();
            ((b9) a9Var.y).j0(iH0);
        }
        U(i1Var);
        ...
        if (i1Var.P(str)) {
            a9Var.b();
            ((b9) a9Var.y).I1();
            if (d(str).i(b2.ANALYTICS_STORAGE)) {
                HashMap map = this.a0;
                h4 h4Var = (h4) map.get(str);
                if (h4Var != null) {
                    long jD = f0().D(str, f0.j0) + h4Var.b;
                    c().getClass();
                    if (jD < SystemClock.elapsedRealtime()) {
                        h4Var = new h4(this, l0().t0());
                        map.put(str, h4Var);
                    }
                } else {
                    h4Var = new h4(this, l0().t0());
    ...
    public final void w(a9 a9Var, c1 c1Var) {
        String strT0;
        String strT1;
        for (int i = 0; i < a9Var.X(); i++) {
            ...
            while (it.hasNext()) {
                if ("_c".equals(((w8) it.next()).v())) {
                    if (((b9) c1Var.y).L0() >= f0().E(((b9) c1Var.y).u(), f0.k0)) {
                        int iE = f0().E(((b9) c1Var.y).u(), f0.x0);
                        LinkedList linkedList = this.N;
                        l4 l4Var = this.D;
                        if (iE > 0) {
                            m mVar = this.z;
                            U(mVar);
                            if (mVar.B0(g(), ((b9) c1Var.y).u(), false, false, false, true).g > iE) {
                                v8 v8VarG = w8.G();
                                v8VarG.g("_tnr");
                                v8VarG.i(1L);
                                s8Var.j((w8) v8VarG.d());
                            } else {
                                if (f0().G(((b9) c1Var.y).u(), f0.Q0)) {
                                    strT1 = l0().t0();
                                    v8 v8VarG2 = w8.G();
                                    v8VarG2.g("_tu");
                                    v8VarG2.h(strT1);
                                ...
                                U(l4Var);
                                y3 y3VarU = l4Var.U(((b9) c1Var.y).u(), a9Var, s8Var, strT1);
                                if (y3VarU != null) {
                                    b().K.c(((b9) c1Var.y).u(), y3VarU.e, "Generated trigger URI. appId, uri");
                                    m mVar2 = this.z;
                                    U(mVar2);
                                    mVar2.Q(((b9) c1Var.y).u(), y3VarU);
                                    if (!linkedList.contains(((b9) c1Var.y).u())) {
                                        linkedList.add(((b9) c1Var.y).u());
                                    }
                                }
                            }
                        } else {
                            ...
                            U(l4Var);
                            y3 y3VarU2 = l4Var.U(((b9) c1Var.y).u(), a9Var, s8Var, strT0);
                            if (y3VarU2 != null) {
                                b().K.c(((b9) c1Var.y).u(), y3VarU2.e, "Generated trigger URI. appId, uri");
                                m mVar3 = this.z;
                                U(mVar3);
                                mVar3.Q(((b9) c1Var.y).u(), y3VarU2);
                                if (!linkedList.contains(((b9) c1Var.y).u())) {
                                    linkedList.add(((b9) c1Var.y).u());
                                }
                            }
    ...
    public final void x(String str, v8 v8Var, Bundle bundle, String str2) {
        int iA;
        List listD = f0().G(str2, f0.a1) ? com.google.android.gms.common.util.b.d("_o", "_sn", "_sc", "_si", "deep_link_url") : com.google.android.gms.common.util.b.d("_o", "_sn", "_sc", "_si");
        if (p4.a0(((w8) v8Var.y).v()) || p4.a0(str)) {
            iA = f0().A(str2, true);
        } else {
            g gVarF0 = f0();
            gVarF0.getClass();
            iA = Math.max(Math.min(gVarF0.E(str2, f0.g0), 500), 100);
        }
        long j = iA;
        ...
        f0();
        String strC = p4.C(40, strV, true);
        if (jCodePointCount <= j || listD.contains(((w8) v8Var.y).v())) {
            return;
        }
        if ("_ev".equals(((w8) v8Var.y).v())) {
            l0();
            bundle.putString("_ev", p4.C(f0().A(str2, true), ((w8) v8Var.y).x(), true));
            return;
        }
    ...
    public final boolean y(s8 s8Var) {
        ...
        if (i == -1) {
            if (!f0().G(null, f0.f1) || !"_iap".equals(s8Var.m())) {
                return true;
            }
            E(s8Var, "_c");
        ...
        if (z) {
            if (i2 == 200) {
                if (th != null) {
                    ...
                    s0Var.c(numValueOf, Boolean.valueOf(z), "Network upload successful with code, uploadAttempted");
                    if (z) {
                        androidx.media3.exoplayer.l1 l1Var = this.F.E;
                        c().getClass();
                        l1Var.h(System.currentTimeMillis());
                    ...
                    while (true) {
                        ...
                        if (z2Var2 != z2Var) {
                            ...
                            jZ = mVar3.z(str, z8Var2, str2, map4, z2Var3, null);
                            if (z2Var3 == z2.GOOGLE_SIGNAL_PENDING) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (f4Var.c == z2Var) {
                            ...
                            mVar4.z(str, z8Var, str3, map3, f4Var.c, l);
                            z2Var = z2Var4;
                        }
                    }
                    m mVar5 = this.z;
                    U(mVar5);
                    listA = mVar5.A(str, c4.d(z2Var), 1);
                    if (!listA.isEmpty()) {
                        j = ((k4) listA.get(0)).f;
                        c().getClass();
                        if (System.currentTimeMillis() > ((Long) f0.F.a(null)).longValue() + j) {
                ...
                if (th != null) {
                    s0 s0Var2 = b().K;
                    numValueOf = Integer.valueOf(i2);
                    s0Var2.c(numValueOf, Boolean.valueOf(z), "Network upload successful with code, uploadAttempted");
                    if (z) {
                        androidx.media3.exoplayer.l1 l1Var2 = this.F.E;
                        c().getClass();
                        l1Var2.h(System.currentTimeMillis());
                    ...
                    while (true) {
                        ...
                        f4Var2 = (f4) pair3.second;
                        z2Var2 = f4Var2.c;
                        z2Var3 = f4Var2.c;
                        if (z2Var2 != z2Var) {
                            m mVar10 = this.z;
                            U(mVar10);
                            String str4 = f4Var2.a;
                            map4 = f4Var2.b;
                            if (map4 == null) {
                                map4 = Collections.EMPTY_MAP;
                            }
                            jZ = mVar10.z(str, z8Var2, str4, map4, z2Var3, null);
                            if (z2Var3 == z2.GOOGLE_SIGNAL_PENDING) {
                                map2.put(z8Var2.y(), Long.valueOf(jZ));
                            }
                        }
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (f4Var.c == z2Var) {
                            ...
                            mVar11.z(str, z8Var, str5, map3, f4Var.c, l3);
                            z2Var = z2Var5;
                        }
                    }
                    m mVar12 = this.z;
                    U(mVar12);
                    listA = mVar12.A(str, c4.d(z2Var), 1);
                    if (!listA.isEmpty()) {
                        j = ((k4) listA.get(0)).f;
                        c().getClass();
                        if (System.currentTimeMillis() > ((Long) f0.F.a(null)).longValue() + j) {
            ...
            s0 s0Var3 = b().K;
            numValueOf = Integer.valueOf(i2);
            s0Var3.c(numValueOf, Boolean.valueOf(z), "Network upload successful with code, uploadAttempted");
            if (z) {
                try {
            ...
            try {
                ...
                while (true) {
                    ...
                    f4Var2 = (f4) pair5.second;
                    z2Var2 = f4Var2.c;
                    z2Var3 = f4Var2.c;
                    if (z2Var2 != z2Var) {
                        m mVar18 = this.z;
                        U(mVar18);
                        String str7 = f4Var2.a;
                        map4 = f4Var2.b;
                        if (map4 == null) {
                            map4 = Collections.EMPTY_MAP;
                        }
                        jZ = mVar18.z(str, z8Var2, str7, map4, z2Var3, null);
                        if (z2Var3 == z2.GOOGLE_SIGNAL_PENDING && jZ != -1 && !z8Var2.y().isEmpty()) {
                            map2.put(z8Var2.y(), Long.valueOf(jZ));
                        }
                    }
                }
                ...
                while (it2.hasNext()) {
                    ...
                    if (f4Var.c == z2Var) {
                        ...
                        mVar19.z(str, z8Var, str8, map3, f4Var.c, l4);
                        z2Var = z2Var6;
                    }
                }
                m mVar110 = this.z;
                U(mVar110);
                listA = mVar110.A(str, c4.d(z2Var), 1);
                if (!listA.isEmpty()) {
                    j = ((k4) listA.get(0)).f;
                    c().getClass();
                    if (System.currentTimeMillis() > ((Long) f0.F.a(null)).longValue() + j) {
