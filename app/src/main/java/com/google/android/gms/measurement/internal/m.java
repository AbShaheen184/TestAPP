...
public final class m extends e4 {
    ...
    public final l A;
    public final androidx.compose.foundation.gestures.d3 B;

    public m(j4 j4Var) {
        super(j4Var);
        this.B = new androidx.compose.foundation.gestures.d3(((p1) this.e).H);
        ((p1) this.e).getClass();
        this.A = new l(this, ((p1) this.e).e);
    }

    public static final String a0(List list) {
        return list.isEmpty() ? "" : androidx.privacysandbox.ads.adservices.java.internal.a.r(" AND (upload_type IN (", TextUtils.join(", ", list), "))");
    }
    ...
    public static final void i0(ContentValues contentValues, Object obj) {
        ...
        if (obj instanceof Long) {
            ...
            kotlinx.coroutines.future.a.q("Invalid value type");
        }
    }

    /* JADX WARN: Code duplicated, block: B:27:0x00de  */
    public final List A(String str, c4 c4Var, int i) throws Throwable {
        List list;
        ...
        try {
            ...
            while (cursorQuery.moveToNext()) {
                k4 k4VarY = Y(str, cursorQuery.getLong(0), cursorQuery.getBlob(2), cursorQuery.getString(3), cursorQuery.getString(4), cursorQuery.getInt(5), cursorQuery.getInt(6), cursorQuery.getLong(7), cursorQuery.getLong(8), cursorQuery.getLong(9));
                if (k4VarY != null) {
                    arrayList.add(k4VarY);
                }
            }
            list = arrayList;
            ...
            try {
                ...
                p1.m(u0Var);
                u0Var.C.c(str, e, "Error to querying MeasurementBatch from upload_queue. appId");
    ...
    public final void A0(z0 z0Var, boolean z) {
        ...
        } else if (j4Var.d(strE).i(b2Var)) {
            contentValues.put("app_instance_id", z0Var.F());
        }
        contentValues.put("gmp_app_id", z0Var.H());
        if (j4Var.d(strE).i(b2.AD_STORAGE)) {
            m1 m1Var = p1Var2.D;
            p1.m(m1Var);
            m1Var.v();
            contentValues.put("resettable_device_id_hash", z0Var.e);
        }
        m1 m1Var2 = p1Var2.D;
        p1.m(m1Var2);
        m1Var2.v();
        contentValues.put("last_bundle_index", Long.valueOf(z0Var.g));
        m1 m1Var3 = p1Var2.D;
        p1.m(m1Var3);
        m1Var3.v();
        contentValues.put("last_bundle_start_timestamp", Long.valueOf(z0Var.h));
        m1 m1Var4 = p1Var2.D;
        p1.m(m1Var4);
        m1Var4.v();
        contentValues.put("last_bundle_end_timestamp", Long.valueOf(z0Var.i));
        contentValues.put("app_version", z0Var.O());
        m1 m1Var5 = p1Var2.D;
        p1.m(m1Var5);
        m1Var5.v();
        contentValues.put("app_store", z0Var.l);
        m1 m1Var6 = p1Var2.D;
        p1.m(m1Var6);
        m1Var6.v();
        contentValues.put("gmp_version", Long.valueOf(z0Var.m));
        m1 m1Var7 = p1Var2.D;
        p1.m(m1Var7);
        m1Var7.v();
        contentValues.put("dev_cert_hash", Long.valueOf(z0Var.n));
        m1 m1Var8 = p1Var2.D;
        p1.m(m1Var8);
        m1Var8.v();
        contentValues.put("measurement_enabled", Boolean.valueOf(z0Var.o));
        m1 m1Var9 = p1Var2.D;
        m1 m1Var10 = p1Var2.D;
        p1.m(m1Var9);
        m1Var9.v();
        contentValues.put("day", Long.valueOf(z0Var.K));
        p1.m(m1Var10);
        m1Var10.v();
        contentValues.put("daily_public_events_count", Long.valueOf(z0Var.L));
        p1.m(m1Var10);
        m1Var10.v();
        contentValues.put("daily_events_count", Long.valueOf(z0Var.M));
        p1.m(m1Var10);
        m1Var10.v();
        contentValues.put("daily_conversions_count", Long.valueOf(z0Var.N));
        m1 m1Var11 = p1Var2.D;
        p1.m(m1Var11);
        m1Var11.v();
        contentValues.put("config_fetched_time", Long.valueOf(z0Var.S));
        m1 m1Var12 = p1Var2.D;
        p1.m(m1Var12);
        m1Var12.v();
        contentValues.put("failed_config_fetch_time", Long.valueOf(z0Var.T));
        contentValues.put("app_version_int", Long.valueOf(z0Var.Q()));
        contentValues.put("firebase_instance_id", z0Var.K());
        p1.m(m1Var10);
        m1Var10.v();
        contentValues.put("daily_error_events_count", Long.valueOf(z0Var.O));
        p1.m(m1Var10);
        m1Var10.v();
        contentValues.put("daily_realtime_events_count", Long.valueOf(z0Var.P));
        p1.m(m1Var10);
        m1Var10.v();
        contentValues.put("health_monitor_sample", z0Var.Q);
        contentValues.put("android_id", (Long) 0L);
        m1 m1Var13 = p1Var2.D;
        p1.m(m1Var13);
        m1Var13.v();
        contentValues.put("adid_reporting_enabled", Boolean.valueOf(z0Var.p));
        contentValues.put("dynamite_version", Long.valueOf(z0Var.b()));
        if (j4Var.d(strE).i(b2Var)) {
            m1 m1Var14 = p1Var2.D;
            p1.m(m1Var14);
            m1Var14.v();
            contentValues.put("session_stitching_token", z0Var.t);
        }
        contentValues.put("sgtm_upload_enabled", Boolean.valueOf(z0Var.z()));
        m1 m1Var15 = p1Var2.D;
        p1.m(m1Var15);
        m1Var15.v();
        contentValues.put("target_os_version", Long.valueOf(z0Var.v));
        m1 m1Var16 = p1Var2.D;
        p1.m(m1Var16);
        m1Var16.v();
        contentValues.put("session_stitching_token_hash", Long.valueOf(z0Var.w));
        com.google.android.gms.internal.measurement.g4.a();
        g gVar = p1Var.A;
        u0 u0Var = p1Var.C;
        if (gVar.G(strE, f0.O0)) {
            m1 m1Var17 = p1Var2.D;
            p1.m(m1Var17);
            m1Var17.v();
            contentValues.put("ad_services_version", Integer.valueOf(z0Var.x));
            m1 m1Var18 = p1Var2.D;
            p1.m(m1Var18);
            m1Var18.v();
        ...
        p1.m(m1Var19);
        m1Var19.v();
        contentValues.put("unmatched_first_open_without_ad_id", Boolean.valueOf(z0Var.y));
        contentValues.put("npa_metadata_value", z0Var.x());
        m1 m1Var20 = p1Var2.D;
        p1.m(m1Var20);
        m1Var20.v();
        contentValues.put("bundle_delivery_index", Long.valueOf(z0Var.F));
        contentValues.put("sgtm_preview_key", z0Var.D());
        p1.m(m1Var10);
        m1Var10.v();
        ...
        if (arrayList != null) {
            if (arrayList.isEmpty()) {
                p1.m(u0Var);
                u0Var.F.b(strE, "Safelisted events should not be an empty list. appId");
            } else {
                contentValues.put("safelisted_events", TextUtils.join(",", arrayList));
            }
        }
        if (gVar.G(null, f0.K0) && !contentValues.containsKey("safelisted_events")) {
            contentValues.put("safelisted_events", (String) null);
        }
        m1 m1Var22 = p1Var2.D;
        p1.m(m1Var22);
        m1Var22.v();
        contentValues.put("unmatched_pfo", z0Var.z);
        m1 m1Var23 = p1Var2.D;
        p1.m(m1Var23);
        m1Var23.v();
        ...
        if (gVar.G(strE, f0.j1)) {
            m1 m1Var25 = p1Var2.D;
            p1.m(m1Var25);
            m1Var25.v();
            contentValues.put("last_diagnostics_signal_upload_timestamp", Long.valueOf(z0Var.J));
        }
        try {
            SQLiteDatabase sQLiteDatabaseM0 = m0();
            if (sQLiteDatabaseM0.update("apps", contentValues, "app_id = ?", new String[]{strE}) == 0 && sQLiteDatabaseM0.insertWithOnConflict("apps", null, contentValues, 5) == -1) {
                p1.m(u0Var);
                u0Var.C.b(u0.D(strE), "Failed to insert/update app (got -1). appId");
            }
        } catch (SQLiteException e) {
            p1.m(u0Var);
            u0Var.C.c(u0.D(strE), e, "Error storing app. appId");
        }
    }
    ...
    public final boolean B(String str) {
        ...
        String strZ = Z();
        return R(androidx.compose.runtime.j.n(new StringBuilder((strA0.length() + 61) + strZ.length()), "SELECT COUNT(1) > 0 FROM upload_queue WHERE app_id=?", strA0, " AND NOT ", strZ), new String[]{str}) != 0;
    }
    ...
    public final void C(Long l) {
        ...
        try {
            if (m0().delete("upload_queue", "rowid=?", new String[]{l.toString()}) != 1) {
                u0 u0Var = p1Var.C;
                p1.m(u0Var);
                u0Var.F.a("Deleted fewer rows from upload_queue than expected");
            }
        } catch (SQLiteException e) {
            u0 u0Var2 = p1Var.C;
            p1.m(u0Var2);
            u0Var2.C.b(e, "Failed to delete a MeasurementBatch in a upload_queue table");
            throw e;
        }
    }
        ...
        try {
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    ...
                    u0 u0Var = p1Var.C;
                    p1.m(u0Var);
                    u0Var.F.b(u0.D(str), "Not updating daily counts, app is not known. appId");
                }
            } catch (SQLiteException e) {
                u0 u0Var2 = p1Var.C;
                p1.m(u0Var2);
                u0Var2.C.c(u0.D(str), e, "Error updating daily counts. appId");
            }
            return jVar;
        } finally {
            if (0 != 0) {
        ...
        try {
            try {
                ...
                try {
                    ...
                    u0 u0Var = ((p1) this.e).C;
                    p1.m(u0Var);
                    u0Var.C.b(e, "Database error getting next bundle app id");
                }
    ...
    public final com.google.android.datatransport.runtime.j D0(String str) {
        Throwable th;
        Cursor cursorQuery;
        Cursor cursor;
        p1 p1Var = (p1) this.e;
                ...
                try {
                    if (cursorQuery.moveToFirst()) {
                        ...
                        if (cursorQuery.moveToNext()) {
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.C.b(u0.D(str), "Got multiple records for app config, expected one. appId");
                        }
                        if (blob != null) {
                            com.google.android.datatransport.runtime.j jVar = new com.google.android.datatransport.runtime.j(blob, string, string2, 10);
                            cursorQuery.close();
                            return jVar;
                        }
                    }
                    ...
                    u0 u0Var2 = p1Var.C;
                    p1.m(u0Var2);
                    u0Var2.C.c(u0.D(str), e, "Error querying remote config. appId");
                }
            } catch (SQLiteException e2) {
                e = e2;
                cursorQuery = null;
    ...
    public final void E(long j) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.C.b(e, "Failed to delete a bundle in a queue table");
            throw e;
        }
    }
    ...
    public final void E0(b9 b9Var, boolean z) {
        ...
        long jI2 = b9Var.i2();
        e0 e0Var = f0.R;
        if (jI2 < jCurrentTimeMillis - ((Long) e0Var.a(null)).longValue() || b9Var.i2() > ((Long) e0Var.a(null)).longValue() + jCurrentTimeMillis) {
            p1.m(u0Var);
            u0Var.F.d("Storing bundle outside of the max uploading time span. appId, now, timestamp", u0.D(b9Var.u()), Long.valueOf(jCurrentTimeMillis), Long.valueOf(b9Var.i2()));
        }
        byte[] bArrA = b9Var.a();
        try {
            l4 l4Var = this.y.D;
            j4.U(l4Var);
            byte[] bArrF0 = l4Var.f0(bArrA);
            p1.m(u0Var);
            u0Var.K.b(Integer.valueOf(bArrF0.length), "Saving bundle, size");
            ContentValues contentValues = new ContentValues();
            ...
            try {
                if (m0().insert("queue", null, contentValues) == -1) {
                    p1.m(u0Var);
                    u0Var.C.b(u0.D(b9Var.u()), "Failed to insert bundle (got -1). appId");
                }
            } catch (SQLiteException e) {
                p1.m(u0Var);
                u0Var.C.c(u0.D(b9Var.u()), e, "Error storing bundle. appId");
            }
        } catch (IOException e2) {
            p1.m(u0Var);
            u0Var.C.c(u0.D(b9Var.u()), e2, "Data loss. Failed to serialize bundle. appId");
        }
    }
    ...
    public final void F() {
        ...
        if (g0()) {
            ...
            if (Math.abs(jElapsedRealtime - jG) > ((Long) f0.M.a(null)).longValue()) {
                j4Var.F.B.h(jElapsedRealtime);
                v();
                w();
                if (g0()) {
                    SQLiteDatabase sQLiteDatabaseM0 = m0();
                    p1Var.H.getClass();
                    int iDelete = sQLiteDatabaseM0.delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{String.valueOf(System.currentTimeMillis()), String.valueOf(((Long) f0.R.a(null)).longValue())});
                    if (iDelete > 0) {
                        u0 u0Var = p1Var.C;
                        p1.m(u0Var);
                        u0Var.K.b(Integer.valueOf(iDelete), "Deleted stale rows. rowsDeleted");
                    }
                }
            }
        }
    ...
    public final void G(ArrayList arrayList) {
        ...
        if (arrayList.size() == 0) {
            kotlinx.coroutines.future.a.q("Given Integer is zero");
            return;
        }
        if (g0()) {
            String strJoin = TextUtils.join(",", arrayList);
            String strM = androidx.compose.runtime.j.m(new StringBuilder(String.valueOf(strJoin).length() + 2), "(", strJoin, ")");
            if (R(androidx.compose.runtime.j.m(new StringBuilder(strM.length() + 80), "SELECT COUNT(1) FROM queue WHERE rowid IN ", strM, " AND retry_count =  2147483647 LIMIT 1"), null) > 0) {
                u0 u0Var = p1Var.C;
                p1.m(u0Var);
                u0Var.F.a("The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                SQLiteDatabase sQLiteDatabaseM0 = m0();
                ...
                u0 u0Var2 = p1Var.C;
                p1.m(u0Var2);
                u0Var2.C.b(e, "Error incrementing retry count. error");
            }
        }
    }
    ...
    public final Object I(Cursor cursor, int i) {
        ...
        if (type == 0) {
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.C.a("Loaded invalid null value from database");
            return null;
        }
        if (type == 1) {
        ...
        if (type != 4) {
            u0 u0Var2 = p1Var.C;
            p1.m(u0Var2);
            u0Var2.C.b(Integer.valueOf(type), "Loaded invalid unknown value type, ignoring it");
            return null;
        }
        u0 u0Var3 = p1Var.C;
        p1.m(u0Var3);
        u0Var3.C.a("Loaded invalid blob type value, ignoring it");
        return null;
    }
            ...
            try {
                ...
                if (jS == -1) {
                    ...
                    if (sQLiteDatabaseM0.insertWithOnConflict("app2", null, contentValues2, 5) == -1) {
                        u0 u0Var = p1Var.C;
                        p1.m(u0Var);
                        u0Var.C.c(u0.D(str), "first_open_count", "Failed to insert column (got -1). appId");
                    } else {
                        jS = 0;
                        try {
                            ...
                            if (sQLiteDatabaseM0.update("app2", contentValues, "app_id = ?", new String[]{str}) == 0) {
                                u0 u0Var2 = p1Var.C;
                                p1.m(u0Var2);
                                u0Var2.C.c(u0.D(str), "first_open_count", "Failed to update column (got 0). appId");
                            } else {
                            ...
                            u0 u0Var3 = p1Var.C;
                            p1.m(u0Var3);
                            u0Var3.C.d("Error inserting column. appId", u0.D(str), "first_open_count", e);
                            j = j2;
                        }
                    }
                } else {
                    ...
                    if (sQLiteDatabaseM0.update("app2", contentValues, "app_id = ?", new String[]{str}) == 0) {
                        u0 u0Var4 = p1Var.C;
                        p1.m(u0Var4);
                        u0Var4.C.c(u0.D(str), "first_open_count", "Failed to update column (got 0). appId");
                    } else {
                        sQLiteDatabaseM0.setTransactionSuccessful();
                        j = jS;
                    }
    ...
    public final void L(List list) {
        ...
        if (iDelete != list.size()) {
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.C.c(Integer.valueOf(iDelete), Integer.valueOf(list.size()), "Deleted fewer rows from raw events table than expected");
        }
    }
    ...
    public final void N(String str, Long l, long j, t8 t8Var) {
        ...
        u0 u0Var2 = p1Var.C;
        p1.m(u0Var);
        u0Var.K.c(p1Var.G.a(str), Integer.valueOf(bArrA.length), "Saving complex main event, appId, data size");
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        ...
        try {
            if (m0().insertWithOnConflict("main_event_params", null, contentValues, 5) == -1) {
                p1.m(u0Var2);
                u0Var2.C.b(u0.D(str), "Failed to insert complex main event (got -1). appId");
            }
        } catch (SQLiteException e) {
            p1.m(u0Var2);
            u0Var2.C.c(u0.D(str), e, "Error storing complex main event. appId");
        }
    }
            ...
            for (k kVar : listI) {
                try {
                            ...
                            try {
                                ...
                                try {
                                    try {
                                        if (cursorQuery.moveToFirst()) {
                                            try {
                                                b9Var = (b9) ((a9) l4.g0(b9.Z(), cursorQuery.getBlob(0))).d();
                                                try {
                                                    if (cursorQuery.moveToNext()) {
                                                        u0 u0Var3 = p1Var.C;
                                                        p1.m(u0Var3);
                                                        u0Var3.F.b(u0.D(str4), "Get multiple raw event metadata records, expected one. appId");
                                                    }
                                                    cursorQuery.close();
                                                    cursorQuery.close();
                                                } catch (SQLiteException e) {
                                                    ...
                                                    u0 u0Var4 = p1Var.C;
                                                    p1.m(u0Var4);
                                                    u0Var4.C.c(u0.D(str4), e, "Data loss. Error selecting raw event. appId");
                                                    if (cursor != null) {
                                                        cursor.close();
                                                    }
                                                }
                                                ...
                                                u0 u0Var5 = p1Var.C;
                                                p1.m(u0Var5);
                                                u0Var5.C.c(u0.D(str4), e2, "Data loss. Failed to merge raw event metadata. appId");
                                                cursorQuery.close();
                                            }
                                            if (b9Var2 != null) {
                                            ...
                                            u0 u0Var6 = p1Var.C;
                                            p1.m(u0Var6);
                                            u0Var6.C.b(u0.D(str4), "Raw event metadata record is missing. appId");
                                        }
                                        cursorQuery.close();
                                    } catch (Throwable th) {
                                        th = th;
                    ...
                    if (jUpdate != 1) {
                        ...
                        u0Var2 = u0Var;
                        try {
                            u0Var2.C.c(u0.D(str3), Long.valueOf(jUpdate), "Failed to update raw event. appId, updatedRows");
                        } catch (SQLiteException e5) {
                            e = e5;
                            p1.m(u0Var2);
                            u0Var2.C.c(u0.D(str3), e, "Error updating raw event. appId");
                        }
                    }
                ...
                for (w8 w8Var : t8Var.w()) {
                    if (w8Var.C()) {
                        ...
                        u0 u0Var7 = ((p1) l4Var.e).C;
                        p1.m(u0Var7);
                        u0Var7.C.b(w8Var, "Unexpected parameter type for parameter");
                    } else {
                        bundle3.putParcelableArray(w8Var.v(), l4.i0(w8Var.E()));
                    }
                }
                ...
                k kVar3 = kVar;
                p4Var.I(bundle3, bundle2);
                q qVar = new q((p1) mVar.e, string, str4, t8Var.z(), t8Var.B(), t8Var.J(), t8Var.D(), bundle3);
                j = kVar3.a;
                long j2 = kVar3.b;
                boolean z = kVar3.c;
                v();
    ...
    public final c2 P(String str) throws Throwable {
        Throwable th;
        SQLiteException e;
        p1 p1Var = (p1) this.e;
            ...
            try {
                ...
                try {
                    if (RawQuery.moveToFirst()) {
                        c2VarC = c2.c(RawQuery.getInt(1), RawQuery.getString(0));
                    } else {
                        u0 u0Var = p1Var.C;
                        p1.m(u0Var);
                        u0Var.K.a("No data found");
                    }
                } catch (SQLiteException e2) {
                    e = e2;
                    u0 u0Var2 = p1Var.C;
                    p1.m(u0Var2);
                    u0Var2.C.b(e, "Error querying database.");
                    if (RawQuery != 0) {
                    }
                    if (c2VarC == null) {
                        return c2.c;
    ...
    public final void Q(String str, y3 y3Var) {
        v();
        w();
        com.google.android.gms.common.internal.x.d(str);
        p1 p1Var = (p1) this.e;
        ...
        if (j < jLongValue || j > ((Long) e0Var.a(null)).longValue() + jCurrentTimeMillis) {
            p1.m(u0Var);
            u0Var.F.d("Storing trigger URI outside of the max retention time span. appId, now, timestamp", u0.D(str), Long.valueOf(jCurrentTimeMillis), Long.valueOf(j));
        }
        p1.m(u0Var);
        u0Var.K.a("Saving trigger URI");
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("trigger_uri", y3Var.e);
        contentValues.put("source", Integer.valueOf(y3Var.z));
        contentValues.put("timestamp_millis", Long.valueOf(j));
        try {
            if (m0().insert("trigger_uris", null, contentValues) == -1) {
                p1.m(u0Var);
                u0Var.C.b(u0.D(str), "Failed to insert trigger URI (got -1). appId");
            }
        } catch (SQLiteException e) {
            p1.m(u0Var);
            u0Var.C.c(u0.D(str), e, "Error storing trigger URI. appId");
        }
    }
    ...
    public final long R(String str, String[] strArr) {
        ...
        try {
            try {
                ...
                u0 u0Var = ((p1) this.e).C;
                p1.m(u0Var);
                u0Var.C.c(str, e, "Database error");
                throw e;
            }
        } catch (Throwable th) {
            if (0 != 0) {
    ...
    public final void U(ContentValues contentValues) {
        ...
        try {
            ...
            if (asString == null) {
                u0 u0Var = p1Var.C;
                p1.m(u0Var);
                u0Var.E.b(u0.D("app_id"), "Value of the primary key is not set.");
                return;
            }
            ...
            if (sQLiteDatabaseM0.update("consent_settings", contentValues, sb.toString(), new String[]{asString}) == 0 && sQLiteDatabaseM0.insertWithOnConflict("consent_settings", null, contentValues, 5) == -1) {
                u0 u0Var2 = p1Var.C;
                p1.m(u0Var2);
                u0Var2.C.c(u0.D("consent_settings"), u0.D("app_id"), "Failed to insert/update table (got -1). key");
            }
        } catch (SQLiteException e) {
            u0 u0Var3 = p1Var.C;
            p1.m(u0Var3);
            u0Var3.C.d("Error storing into table. key", u0.D("consent_settings"), u0.D("app_id"), e);
        }
    }
    ...
    public final r V(String str, String str2, String str3) throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    if (cursorQuery.moveToFirst()) {
                        ...
                        if (cursorQuery.moveToNext()) {
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.C.b(u0.D(str2), "Got multiple records for event aggregates, expected one. appId");
                        }
                        cursorQuery.close();
                        return rVar;
                    }
                ...
                u0 u0Var2 = p1Var.C;
                p1.m(u0Var2);
                u0Var2.C.d("Error querying events. appId", u0.D(str2), p1Var.G.a(str3), e);
            }
        } catch (SQLiteException e2) {
            e = e2;
            cursorQuery = null;
    ...
    public final void W(String str, r rVar) {
        ...
        try {
            if (m0().insertWithOnConflict(str, null, contentValues, 5) == -1) {
                u0 u0Var = p1Var.C;
                p1.m(u0Var);
                u0Var.C.b(u0.D(str2), "Failed to insert/update event aggregates (got -1). appId");
            }
        } catch (SQLiteException e) {
            u0 u0Var2 = p1Var.C;
            p1.m(u0Var2);
            u0Var2.C.c(u0.D(str2), e, "Error storing event aggregates. appId");
        }
    }
    ...
    public final void X(String str, String str2) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.C.c(u0.D(str2), e, "Error deleting snapshot. appId");
        }
    }

    public final k4 Y(String str, long j, byte[] bArr, String str2, String str3, int i, int i2, long j2, long j3, long j4) {
        z2 z2Var;
        p1 p1Var = (p1) this.e;
        if (TextUtils.isEmpty(str2)) {
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.J.a("Upload uri is null or empty. Destination is unknown. Dropping batch. ");
            return null;
        }
        try {
            y8 y8Var = (y8) l4.g0(z8.B(), bArr);
            z2[] z2VarArrValues = z2.values();
            int length = z2VarArrValues.length;
            int i3 = 0;
            while (true) {
                if (i3 >= length) {
                    z2Var = z2.UNKNOWN;
                ...
                z2Var = z2VarArrValues[i3];
                if (z2Var.e == i) {
                    break;
                }
                i3++;
            }
            if (z2Var != z2.GOOGLE_SIGNAL && z2Var != z2.GOOGLE_SIGNAL_PENDING && i2 > 0) {
                ArrayList arrayList = new ArrayList();
            ...
            if (str3 != null) {
                for (String str4 : str3.split("\r\n")) {
                    ...
                    if (strArrSplit.length != 2) {
                        u0 u0Var2 = p1Var.C;
                        p1.m(u0Var2);
                        u0Var2.C.b(str4, "Invalid upload header: ");
                        break;
                    }
                    map.put(strArrSplit[0], strArrSplit[1]);
                }
            }
            return new k4(j, (z8) y8Var.d(), str2, map, z2Var, j2, j3, j4, i2);
        } catch (IOException e) {
            u0 u0Var3 = p1Var.C;
            p1.m(u0Var3);
            u0Var3.C.c(str, e, "Failed to queued MeasurementBatch from upload_queue. appId");
            return null;
        }
    }

    public final String Z() {
        ((p1) this.e).H.getClass();
        long jCurrentTimeMillis = System.currentTimeMillis();
        Locale locale = Locale.US;
        Long l = (Long) f0.S.a(null);
        l.getClass();
        String str = "(upload_type = 1 AND ABS(creation_timestamp - " + jCurrentTimeMillis + ") > " + l + ")";
        String strP = androidx.privacysandbox.ads.adservices.java.internal.a.p(((Long) f0.R.a(null)).longValue(), ")", androidx.compose.runtime.j.o(jCurrentTimeMillis, "(upload_type != 1 AND ABS(creation_timestamp - ", ") > "));
        StringBuilder sb = new StringBuilder(str.length() + 5 + strP.length() + 1);
        androidx.room.b0.i(sb, "(", str, " OR ", strP);
        sb.append(")");
        return sb.toString();
    }

    public final void b0(String str, c2 c2Var) {
        com.google.android.gms.common.internal.x.g(str);
        com.google.android.gms.common.internal.x.g(c2Var);
        v();
        w();
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("consent_state", c2Var.g());
        contentValues.put("consent_source", Integer.valueOf(c2Var.b));
        U(contentValues);
    }
        ...
        try {
            ...
            try {
                try {
                    ...
                    if (cursorQuery.moveToFirst()) {
                        ...
                        do {
                            ...
                            if (string2 == null) {
                                u0 u0Var = p1Var.C;
                                p1.m(u0Var);
                                u0Var.C.b(u0.D(str), "Read null value from diagnostic signals table, ignoring it. appId");
                            } else {
                    ...
                    u0 u0Var2 = p1Var.C;
                    p1.m(u0Var2);
                    u0Var2.C.c(u0.D(str), e, "Error querying or deleting diagnostic signals. appId");
                    list = Collections.EMPTY_LIST;
                }
                if (cursorQuery != null) {
                    list = arrayList;
            ...
            u0 u0Var3 = p1Var.C;
            p1.m(u0Var3);
            u0Var3.C.c(u0.D(str), e2, "Error opening database for diagnostic signals. appId");
            return Collections.EMPTY_LIST;
        }
    }

    public final void d0(String str, c2 c2Var) {
        com.google.android.gms.common.internal.x.g(str);
        v();
        w();
        b0(str, P(str));
    ...
    public final c2 e0(String str) {
        ...
        v();
        w();
        return c2.c(100, T("select storage_consent_at_bundling from consent_settings where app_id=? limit 1;", new String[]{str}));
    }
    ...
    public final r f0(String str, t8 t8Var, String str2) throws Throwable {
        ...
        u0 u0Var = p1Var.C;
        p1.m(u0Var);
        u0Var.F.c(u0.D(str), p1Var.G.a(str2), "Event aggregate wasn't created during raw event logging. appId, event");
        return new r(str, t8Var.z(), 1L, 1L, 1L, t8Var.B(), 0L, null, null, null, null);
    }

    public final boolean g0() {
        return ((p1) this.e).e.getDatabasePath("google_app_measurement.db").exists();
    }
    ...
    public final void h0(String str, long j, long j2, c1 c1Var) {
        ?? IsEmpty;
        ?? string;
        String str2;
        String[] strArr;
                    ...
                    try {
                        if (cursorRawQuery.moveToFirst()) {
                            ...
                            try {
                                ...
                                if (cursorRawQuery.moveToFirst()) {
                                    try {
                                        b9 b9Var = (b9) ((a9) l4.g0(b9.Z(), cursorRawQuery.getBlob(0))).d();
                                        if (cursorRawQuery.moveToNext()) {
                                            u0 u0Var = p1Var.C;
                                            p1.m(u0Var);
                                            u0Var.F.b(u0.D(r4), "Get multiple raw event metadata records, expected one. appId");
                                        }
                                        cursorRawQuery.close();
                                        c1Var.y = b9Var;
                                            ...
                                            if (cursorRawQuery.moveToFirst()) {
                                                do {
                                                    ...
                                                    try {
                                                        ...
                                                        s8Var.b();
                                                        ((t8) s8Var.y).u(j5);
                                                        if (!c1Var.e(j4, (t8) s8Var.d())) {
                                                            break;
                                                        }
                                                    } catch (IOException e) {
                                                        u0 u0Var2 = p1Var.C;
                                                        p1.m(u0Var2);
                                                        u0Var2.C.c(u0.D(r4), e, "Data loss. Failed to merge raw event. appId");
                                                    }
                                                } while (cursorRawQuery.moveToNext());
                                            } else {
                                                u0 u0Var3 = p1Var.C;
                                                p1.m(u0Var3);
                                                u0Var3.F.b(u0.D(r4), "Raw event data disappeared while in transaction. appId");
                                            }
                                        } else {
                                            j3 = j2;
                                        }
                                        ...
                                        if (cursorRawQuery.moveToFirst()) {
                                            ...
                                            u0 u0Var4 = p1Var.C;
                                            p1.m(u0Var4);
                                            u0Var4.F.b(u0.D(r4), "Raw event data disappeared while in transaction. appId");
                                        }
                                    } catch (IOException e2) {
                                        u0 u0Var5 = p1Var.C;
                                        p1.m(u0Var5);
                                        u0Var5.C.c(u0.D(r4), e2, "Data loss. Failed to merge raw event metadata. appId");
                                    }
                                } else {
                                    u0 u0Var6 = p1Var.C;
                                    p1.m(u0Var6);
                                    u0Var6.C.b(u0.D(r4), "Raw event metadata record is missing. appId");
                                }
                            } catch (SQLiteException e3) {
                                e = e3;
                                u0 u0Var7 = p1Var.C;
                                p1.m(u0Var7);
                                u0Var7.C.c(u0.D(string), e, "Data loss. Error selecting raw event. appId");
                            }
                        }
                    } catch (SQLiteException e4) {
                        e = e4;
                    ...
                    try {
                        ...
                        if (cursorRawQuery.moveToFirst()) {
                            ...
                            if (cursorRawQuery.moveToFirst()) {
                                u0 u0Var8 = p1Var.C;
                                p1.m(u0Var8);
                                u0Var8.C.b(u0.D(r4), "Raw event metadata record is missing. appId");
                            } else {
                                b9 b9Var2 = (b9) ((a9) l4.g0(b9.Z(), cursorRawQuery.getBlob(0))).d();
                                if (cursorRawQuery.moveToNext()) {
                                    u0 u0Var9 = p1Var.C;
                                    p1.m(u0Var9);
                                    u0Var9.F.b(u0.D(r4), "Get multiple raw event metadata records, expected one. appId");
                                }
                                cursorRawQuery.close();
                                c1Var.y = b9Var2;
                                jS = S("select (rowid - 1) as max_rowid from raw_events where app_id = ? and metadata_fingerprint != ? order by rowid limit 1;", new String[]{r4, string2}, -1L);
                                if (j2 == -1) {
                                    ...
                                    if (cursorRawQuery.moveToFirst()) {
                                        ...
                                        u0 u0Var10 = p1Var.C;
                                        p1.m(u0Var10);
                                        u0Var10.F.b(u0.D(r4), "Raw event data disappeared while in transaction. appId");
                                    }
                                } else {
                                    j3 = j2;
                                }
                                ...
                                if (cursorRawQuery.moveToFirst()) {
                                    ...
                                    u0 u0Var11 = p1Var.C;
                                    p1.m(u0Var11);
                                    u0Var11.F.b(u0.D(r4), "Raw event data disappeared while in transaction. appId");
                                }
                            }
                        }
                    } catch (SQLiteException e5) {
                        ...
                        u0 u0Var12 = p1Var.C;
                        p1.m(u0Var12);
                        u0Var12.C.c(u0.D(string), e, "Data loss. Error selecting raw event. appId");
                    }
                }
            } finally {
                if (0 != 0) {
    ...
    public final SQLiteDatabase m0() {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.F.b(e, "Error opening database");
            throw e;
        }
    }
    ...
    public final void n0(String str) {
        ...
        try {
            try {
                ...
                u0 u0Var = ((p1) this.e).C;
                p1.m(u0Var);
                u0Var.C.c(u0.D(str), e, "Error creating snapshot. appId");
            }
        } finally {
            if (cursorQuery != null) {
                cursorQuery.close();
                ...
                do {
                    try {
                        ...
                        try {
                            u0 u0Var = ((p1) this.e).C;
                            p1.m(u0Var);
                            u0Var.C.c(u0.D(str), e, "Error querying snapshot. appId");
                            z3 = z2;
                        } catch (Throwable th) {
                            th = th;
                            if (cursorQuery != null) {
    ...
    public final void p0(String str, String str2) {
        ...
        try {
            ...
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.C.d("Error deleting user property. appId", u0.D(str), p1Var.G.c(str2), e);
        }
    }

    public final boolean q0(n4 n4Var) {
        p1 p1Var = (p1) this.e;
        String str = n4Var.b;
        v();
        w();
        ...
        if (r0(str2, str3) == null) {
            if (p4.w0(str3)) {
                if (R("select count(1) from user_attributes where app_id=? and name not like '!_%' escape '!'", new String[]{str2}) >= Math.max(Math.min(p1Var.A.E(str2, f0.V), 100), 25)) {
                    return false;
                }
        ...
        contentValues.put("set_timestamp", Long.valueOf(n4Var.d));
        i0(contentValues, n4Var.e);
        try {
            ...
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.C.b(u0.D(str2), "Failed to insert/update user property (got -1). appId");
            return true;
        } catch (SQLiteException e) {
            u0 u0Var2 = p1Var.C;
            p1.m(u0Var2);
            u0Var2.C.c(u0.D(str2), e, "Error storing user property. appId");
            return true;
        }
    }
    ...
    public final n4 r0(String str, String str2) throws Throwable {
        Throwable th;
        String str3;
        String str4;
                ...
                try {
                    if (cursorQuery.moveToFirst()) {
                        ...
                        if (objI != null) {
                            ...
                            str4 = str2;
                            try {
                                n4 n4Var = new n4(str3, cursorQuery.getString(2), str4, j, objI);
                                if (cursorQuery.moveToNext()) {
                                    u0 u0Var = p1Var.C;
                                    p1.m(u0Var);
                                    u0Var.C.b(u0.D(str3), "Got multiple records for user property, expected one. appId");
                                }
                                cursorQuery.close();
                                return n4Var;
                            } catch (SQLiteException e) {
                        ...
                        u0 u0Var2 = p1Var.C;
                        p1.m(u0Var2);
                        u0Var2.C.d("Error querying user property. appId", u0.D(str3), p1Var.G.c(str4), sQLiteException);
                    }
                } catch (SQLiteException e2) {
                    e = e2;
                    str3 = str;
                    ...
                    if (cursorQuery.moveToFirst()) {
                        while (true) {
                            ...
                            if (objI == null) {
                                u0 u0Var = p1Var.C;
                                p1.m(u0Var);
                                u0Var.C.b(u0.D(str), "Read invalid user property value, ignoring it. appId");
                                str2 = str;
                            } else {
                                str2 = str;
                                arrayList.add(new n4(str2, str3, string, j, objI));
                            }
                            try {
                                if (!cursorQuery.moveToNext()) {
                                    break;
                                ...
                                u0 u0Var2 = p1Var.C;
                                p1.m(u0Var2);
                                u0Var2.C.c(u0.D(str2), e, "Error querying user properties. appId");
                        ...
                        while (true) {
                            try {
                                if (arrayList.size() >= 1000) {
                                    p1.m(u0Var);
                                    u0Var.C.b(1000, "Read more than the max allowed user properties, ignoring excess");
                                    break;
                                }
                                String string2 = cursorQuery.getString(0);
                                ...
                                if (objI == null) {
                                    try {
                                        p1.m(u0Var);
                                        u0Var.C.d("(2)Read invalid user property value, ignoring it", u0.D(str6), string3, str3);
                                        str5 = string3;
                                    } catch (SQLiteException e) {
                                        e = e;
                                        str5 = string3;
                                        ...
                                        try {
                                            u0 u0Var2 = p1Var.C;
                                            p1.m(u0Var2);
                                            u0Var2.C.d("(2)Error querying user properties", u0.D(str), str4, e);
                                            arrayList = Collections.EMPTY_LIST;
                                            cursorQuery = cursor;
                                            if (cursorQuery != null) {
                                                cursorQuery.close();
                                    ...
                                    str5 = string3;
                                    arrayList.add(new n4(str, str5, string2, j, objI));
                                }
                                try {
                                    if (!cursorQuery.moveToNext()) {
                                        break;
                                    ...
                                    u0 u0Var3 = p1Var.C;
                                    p1.m(u0Var3);
                                    u0Var3.C.d("(2)Error querying user properties", u0.D(str), str4, e);
                                    arrayList = Collections.EMPTY_LIST;
                                    cursorQuery = cursor;
                                }
                            } catch (SQLiteException e3) {
                                ...
                                u0 u0Var4 = p1Var.C;
                                p1.m(u0Var4);
                                u0Var4.C.d("(2)Error querying user properties", u0.D(str), str4, e);
                                arrayList = Collections.EMPTY_LIST;
                                cursorQuery = cursor;
                                if (cursorQuery != null) {
                                    cursorQuery.close();
    ...
    public final boolean u0(e eVar) {
        ...
        u0 u0Var = p1Var.C;
        p1.k(p4Var);
        contentValues.put("timed_out_event", p4.f0(uVar));
        contentValues.put("creation_timestamp", Long.valueOf(eVar.A));
        p1.k(p4Var);
        contentValues.put("triggered_event", p4.f0(eVar.F));
        contentValues.put("triggered_timestamp", Long.valueOf(eVar.z.z));
        contentValues.put("time_to_live", Long.valueOf(eVar.G));
        contentValues.put("expired_event", p4.f0(eVar.H));
        try {
            if (m0().insertWithOnConflict("conditional_properties", null, contentValues, 5) != -1) {
                return true;
            }
            p1.m(u0Var);
            u0Var.C.b(u0.D(str), "Failed to insert/update conditional user property (got -1)");
            return true;
        } catch (SQLiteException e) {
            p1.m(u0Var);
            u0Var.C.c(u0.D(str), e, "Error storing conditional user property");
            return true;
        }
    }
    ...
    public final e v0(String str, String str2) throws Throwable {
        ...
        try {
            try {
                ...
                try {
                    ...
                    u uVar = (u) l4Var.Y(blob, creator);
                    long j2 = cursorQuery.getLong(6);
                    j4.U(l4Var);
                    u uVar2 = (u) l4Var.Y(cursorQuery.getBlob(7), creator);
                    long j3 = cursorQuery.getLong(8);
                    long j4 = cursorQuery.getLong(9);
                    j4.U(l4Var);
                    str3 = str2;
                    try {
                        e eVar = new e(str, str4, new m4(j3, objI, str3, str4), j2, z, string2, uVar, j, uVar2, j4, (u) l4Var.Y(cursorQuery.getBlob(10), creator));
                        if (cursorQuery.moveToNext()) {
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.C.c(u0.D(str), p1Var.G.c(str3), "Got multiple records for conditional property, expected one");
                        }
                        cursorQuery.close();
                        return eVar;
                    } catch (SQLiteException e) {
        ...
        u0 u0Var2 = p1Var.C;
        p1.m(u0Var2);
        u0Var2.C.d("Error querying conditional property", u0.D(str), p1Var.G.c(str3), e);
    }
    ...
    public final void w0(String str, String str2) {
        ...
        try {
            ...
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.C.d("Error deleting conditional property", u0.D(str), p1Var.G.c(str2), e);
        }
    }
    ...
    public final void y() {
        ...
        if (p1Var.A.G(null, f0.e1)) {
            m1 m1Var = p1Var.D;
            p1.m(m1Var);
            m1Var.E(new androidx.appcompat.widget.z0(this, 17));
        }
    }
                ...
                if (cursorQuery.moveToFirst()) {
                    do {
                        if (arrayList.size() >= 1000) {
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.C.b(1000, "Read more than the max allowed conditional properties, ignoring extra");
                            break;
                        }
                        String string = cursorQuery.getString(0);
                        String string2 = cursorQuery.getString(1);
                        ...
                        j4.U(l4Var);
                        u uVar2 = (u) l4Var.Y(cursorQuery.getBlob(9), creator);
                        long j3 = cursorQuery.getLong(10);
                        long j4 = cursorQuery.getLong(11);
                        j4.U(l4Var);
                        arrayList.add(new e(string, string2, new m4(j3, objI, string3, string2), j2, z, string4, uVar, j, uVar2, j4, (u) l4Var.Y(cursorQuery.getBlob(12), creator)));
                    } while (cursorQuery.moveToNext());
                }
            } catch (SQLiteException e) {
                u0 u0Var2 = p1Var.C;
                p1.m(u0Var2);
                u0Var2.C.b(e, "Error querying conditional user property value");
                arrayList = Collections.EMPTY_LIST;
            }
            return arrayList;
        } finally {
    ...
    public final long z(String str, z8 z8Var, String str2, Map map, z2 z2Var, Long l) {
        int iDelete;
        p1 p1Var = (p1) this.e;
        v();
        w();
        ...
        if (g0()) {
            ...
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            if (Math.abs(jElapsedRealtime - jG) > ((Long) f0.M.a(null)).longValue()) {
                j4Var.F.C.h(jElapsedRealtime);
                v();
                w();
                if (g0() && (iDelete = m0().delete("upload_queue", Z(), new String[0])) > 0) {
                    p1.m(u0Var);
                    u0Var.K.b(Integer.valueOf(iDelete), "Deleted stale MeasurementBatch rows from upload_queue. rowsDeleted");
                }
                com.google.android.gms.common.internal.x.d(str);
                v();
                w();
                try {
                    int iE = p1Var.A.E(str, f0.A);
                    if (iE > 0) {
                    ...
                    p1.m(u0Var);
                    u0Var.C.c(u0.D(str), e, "Error deleting over the limit queued batches. appId");
                }
            }
        }
        ArrayList arrayList = new ArrayList();
        ...
        contentValues.put("upload_type", Integer.valueOf(z2Var.e));
        ...
        try {
            ...
            p1.m(u0Var2);
            u0Var2.C.b(str, "Failed to insert MeasurementBatch (got -1) to upload_queue. appId");
            return -1L;
        } catch (SQLiteException e2) {
            p1.m(u0Var2);
            u0Var2.C.c(str, e2, "Error storing MeasurementBatch to upload_queue. appId");
            return -1L;
        }
    }

    /* JADX WARN: Code duplicated, block: B:131:0x0408  */
    public final z0 z0(String str) throws Throwable {
        Cursor cursorQuery;
        Boolean boolValueOf;
        String string;
        p1 p1Var = (p1) this.e;
        ...
        try {
            ...
            try {
                try {
                    if (cursorQuery.moveToFirst()) {
                        j4 j4Var = this.y;
                        z0 z0Var = new z0(j4Var.I, str);
                        p1 p1Var2 = z0Var.a;
                        c2 c2VarD = j4Var.d(str);
                        b2 b2Var = b2.ANALYTICS_STORAGE;
                        if (c2VarD.i(b2Var)) {
                            z0Var.G(cursorQuery.getString(0));
                        }
                        boolean z = true;
                        z0Var.I(cursorQuery.getString(1));
                        if (j4Var.d(str).i(b2.AD_STORAGE)) {
                            z0Var.J(cursorQuery.getString(2));
                        }
                        z0Var.e(cursorQuery.getLong(3));
                        z0Var.M(cursorQuery.getLong(4));
                        z0Var.N(cursorQuery.getLong(5));
                        z0Var.P(cursorQuery.getString(6));
                        z0Var.S(cursorQuery.getString(7));
                        z0Var.T(cursorQuery.getLong(8));
                        z0Var.a(cursorQuery.getLong(9));
                        z0Var.d(cursorQuery.isNull(10) || cursorQuery.getInt(10) != 0);
                        z0Var.i(cursorQuery.getLong(11));
                        z0Var.j(cursorQuery.getLong(12));
                        z0Var.k(cursorQuery.getLong(13));
                        z0Var.l(cursorQuery.getLong(14));
                        z0Var.f(cursorQuery.getLong(15));
                        z0Var.g(cursorQuery.getLong(16));
                        z0Var.R(cursorQuery.isNull(17) ? -2147483648L : cursorQuery.getInt(17));
                        z0Var.L(cursorQuery.getString(18));
                        z0Var.n(cursorQuery.getLong(19));
                        z0Var.m(cursorQuery.getLong(20));
                        z0Var.w(cursorQuery.getString(21));
                        ...
                        z0Var.R |= z0Var.p != z2;
                        z0Var.p = z2;
                        z0Var.c(cursorQuery.isNull(25) ? 0L : cursorQuery.getLong(25));
                        if (!cursorQuery.isNull(26)) {
                            z0Var.y(Arrays.asList(cursorQuery.getString(26).split(",", -1)));
                        }
                        if (j4Var.d(str).i(b2Var)) {
                            String string2 = cursorQuery.getString(28);
                            m1 m1Var2 = p1Var2.D;
                            p1.m(m1Var2);
                            m1Var2.v();
                            z0Var.R |= !Objects.equals(z0Var.t, string2);
                            z0Var.t = string2;
                        }
                        ...
                        z0Var.R |= z0Var.u != z3;
                        z0Var.u = z3;
                        z0Var.r(cursorQuery.getLong(39));
                        String string3 = cursorQuery.getString(36);
                        m1 m1Var4 = p1Var2.D;
                        p1.m(m1Var4);
                        m1Var4.v();
                        z0Var.R |= z0Var.C != string3;
                        z0Var.C = string3;
                        z0Var.A(cursorQuery.getLong(30));
                        z0Var.B(cursorQuery.getLong(31));
                        com.google.android.gms.internal.measurement.g4.a();
                        if (p1Var.A.G(str, f0.O0)) {
                            ...
                            z0Var.R |= z0Var.x != i;
                            z0Var.x = i;
                            z0Var.C(cursorQuery.getLong(35));
                        }
                        ...
                        p1.m(m1Var7);
                        m1Var7.v();
                        z0Var.R |= !Objects.equals(z0Var.q, boolValueOf);
                        z0Var.q = boolValueOf;
                        z0Var.p(cursorQuery.getInt(37));
                        z0Var.q(cursorQuery.getInt(38));
                        ...
                        if (!cursorQuery.isNull(41)) {
                            ...
                            p1.m(m1Var9);
                            m1Var9.v();
                            z0Var.R |= !Objects.equals(z0Var.z, lValueOf);
                            z0Var.z = lValueOf;
                        }
                        if (!cursorQuery.isNull(42)) {
                            ...
                            p1.m(m1Var10);
                            m1Var10.v();
                            z0Var.R |= !Objects.equals(z0Var.A, lValueOf2);
                            z0Var.A = lValueOf2;
                        }
                        ...
                        if (p1Var.A.G(str, f0.j1) && !cursorQuery.isNull(45)) {
                            z0Var.u(cursorQuery.getLong(45));
                        }
                        m1 m1Var13 = p1Var2.D;
                        p1.m(m1Var13);
                        m1Var13.v();
                        ...
                        if (cursorQuery.moveToNext()) {
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.C.b(u0.D(str), "Got multiple records for app, expected one. appId");
                        }
                        cursorQuery.close();
                        return z0Var;
                    }
                ...
                u0 u0Var2 = p1Var.C;
                p1.m(u0Var2);
                u0Var2.C.c(u0.D(str), e, "Error querying app. appId");
            }
        } catch (SQLiteException e2) {
            e = e2;
            cursorQuery = null;
