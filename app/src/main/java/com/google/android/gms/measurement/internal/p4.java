...
public final class p4 extends x1 {
    ...
    public static void N(o4 o4Var, String str, int i, String str2, String str3, int i2) {
    ...
    public static void s0(a3 a3Var, Bundle bundle, boolean z) {
    ...
    public final void A(String str, String str2, Bundle bundle, List list, boolean z) {
        ...
        u0 u0Var = p1Var.C;
        q0 q0Var = p1Var.G;
        p4 p4Var = ((p1) gVar.e).F;
        p1.k(p4Var);
        int i = true != p4Var.g0(231100000) ? 0 : 35;
        int i2 = 0;
        boolean z2 = false;
        for (String str3 : new TreeSet(bundle.keySet())) {
            ...
            if (iG0 != 0) {
                ...
                if (I0(bundle.get(str3))) {
                    p1.m(u0Var);
                    u0Var.H.d("Nested Bundle parameters are not allowed; discarded. event name, param name, child param name", str, str2, str3);
                    iD = 22;
                } else {
                ...
                if (iD != 0 && !"_ev".equals(str3)) {
                    ...
                    bundle.remove(str3);
                } else if (w0(str3) && !X(str3, d2.k)) {
                    i2++;
                    if (!g0(231100000)) {
                        p1.m(u0Var);
                        u0Var.E.c(q0Var.a(str), q0Var.e(bundle), "Item array not supported on client's version of Google Play Services (Android Only)");
                        U(23, bundle);
                        bundle.remove(str3);
                    } else if (i2 > i) {
                        if (!z2) {
                            ...
                            s0Var.c(q0Var.a(str), q0Var.e(bundle), sb.toString());
                        }
                        U(28, bundle);
                        bundle.remove(str3);
                        z2 = true;
    ...
    public final boolean A0(String str, String str2) {
        ...
        if (str2 == null) {
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.E.b(str, "Name is required and can't be null. Type");
            return false;
        }
        if (str2.length() == 0) {
            u0 u0Var2 = p1Var.C;
            p1.m(u0Var2);
            u0Var2.E.b(str, "Name is required and can't be empty. Type");
            return false;
        }
        ...
        if (!Character.isLetter(iCodePointAt)) {
            if (iCodePointAt != 95) {
                u0 u0Var3 = p1Var.C;
                p1.m(u0Var3);
                u0Var3.E.c(str, str2, "Name must start with a letter or _ (underscore). Type, name");
                return false;
            }
            iCodePointAt = 95;
        }
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt2 != 95 && !Character.isLetterOrDigit(iCodePointAt2)) {
                u0 u0Var4 = p1Var.C;
                p1.m(u0Var4);
                u0Var4.E.c(str, str2, "Name must consist of letters, digits or _ (underscores). Type, name");
                return false;
            }
    ...
    public final boolean B(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.E.a("Missing google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI");
            return false;
        }
        ...
        u0 u0Var2 = p1Var.C;
        p1.m(u0Var2);
        u0Var2.E.b(u0.D(str), "Invalid google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI. provided id");
        return false;
    }
    ...
    public final boolean B0(String str, String[] strArr, String[] strArr2, String str2) {
        ...
        for (int i = 0; i < 3; i++) {
            if (str2.startsWith(F[i])) {
                u0 u0Var2 = p1Var.C;
                p1.m(u0Var2);
                u0Var2.E.c(str, str2, "Name starts with reserved prefix. Type, name");
                return false;
            }
        }
        ...
        u0 u0Var3 = p1Var.C;
        p1.m(u0Var3);
        u0Var3.E.c(str, str2, "Name is reserved. Type, name");
        return false;
    }
    ...
    public final boolean C0(String str, int i, String str2) {
        ...
        u0 u0Var2 = p1Var.C;
        p1.m(u0Var2);
        u0Var2.E.d("Name is too long. Type, maximum supported length, name", str, Integer.valueOf(i), str2);
        return false;
    }
    ...
    public final int D(String str, String str2, Object obj, Bundle bundle, List list, boolean z, boolean z2) {
        ...
        if (!I0(obj)) {
            ...
            if (size > 200) {
                u0 u0Var = p1Var.C;
                p1.m(u0Var);
                u0Var.H.d("Parameter array is too long; discarded. Value kind, name, array length", "param", str2, Integer.valueOf(size));
                i = 17;
                if (z3) {
            ...
            if (obj instanceof Parcelable[]) {
                ...
                while (i2 < length) {
                    ...
                    if (!(parcelable instanceof Bundle)) {
                        u0 u0Var2 = p1Var.C;
                        p1.m(u0Var2);
                        u0Var2.H.c(parcelable.getClass(), str2, "All Parcelable[] elements must be of type Bundle. Value type, name");
                        return 4;
                    }
                ...
                while (i2 < size2) {
                    ...
                    if (!(obj2 instanceof Bundle)) {
                        u0 u0Var3 = p1Var.C;
                        p1.m(u0Var3);
                        u0Var3.H.c(obj2 != null ? obj2.getClass() : "null", str2, "All ArrayList elements must be of type Bundle. Value type, name");
                        return 4;
                    }
    ...
    public final int D0(String str) {
        ...
        if (B0(Hopmn.EVENT, d2.a, ((p1) this.e).A.G(null, f0.f1) ? d2.c : d2.b, str)) {
    ...
    public final boolean E0(String str) {
        return ((p1) this.e).A.G(null, f0.f1) ? X(str, d2.e) : X(str, d2.d);
    }

    public final Bundle F(String str, Bundle bundle, List list, boolean z) {
        int iG0;
        boolean zX = X(str, d2.g);
        if (bundle == null) {
            return null;
        }
        ...
        p4 p4Var = ((p1) gVar.e).F;
        p1.k(p4Var);
        int i = p4Var.g0(201500000) ? 100 : 25;
        int i2 = 0;
        boolean z2 = false;
                ...
                if (w0(str2)) {
                    ...
                    if (i2 > i) {
                        if (!z2) {
                            ...
                            u0 u0Var = p1Var.C;
                            p1.m(u0Var);
                            u0Var.E.c(q0Var.a(str), q0Var.e(bundle), string);
                        }
                        U(5, bundle2);
                        bundle2.remove(str2);
                        z2 = true;
    ...
    public final int F0(String str) {
        ...
        if (!B0("user property", d2.l, null, str)) {
            return 15;
        }
        ((p1) this.e).getClass();
    ...
    public final void G(v0 v0Var, int i) {
        ...
        for (String str : new TreeSet(bundle.keySet())) {
            if (w0(str) && (i2 = i2 + 1) > i) {
                if (!z) {
                    ...
                    q0 q0Var = p1Var.G;
                    p1.m(u0Var);
                    u0Var.E.c(q0Var.a(v0Var.a), q0Var.e(bundle), string);
                    U(5, bundle);
                }
                bundle.remove(str);
                z = true;
    ...
    public final void H(Parcelable[] parcelableArr, int i) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            boolean z = false;
            for (String str : new TreeSet(bundle.keySet())) {
                if (w0(str) && !X(str, d2.k) && (i2 = i2 + 1) > i) {
                    if (!z) {
                        p1 p1Var = (p1) this.e;
                        u0 u0Var = p1Var.C;
                        q0 q0Var = p1Var.G;
                        ...
                        s0Var.c(q0Var.b(str), q0Var.e(bundle), sb.toString());
                    }
                    U(28, bundle);
                    bundle.remove(str);
                    z = true;
    ...
    public final void I(Bundle bundle, Bundle bundle2) {
        ...
        for (String str : bundle2.keySet()) {
            if (!bundle.containsKey(str)) {
                ...
                p1.k(p4Var);
                p4Var.M(bundle, str, bundle2.get(str));
            }
        }
    }
    ...
    public final void M(Bundle bundle, String str, Object obj) {
        ...
        if (str != null) {
            ...
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.H.c(p1Var.G.b(str), simpleName, "Not putting event parameter. Invalid value type. name, type");
        }
    }
    ...
    public final long T() {
        ...
        n0 n0VarR = p1Var.r();
        u0 u0Var = p1Var.C;
        if (!Y((String) f0.q0.a(null), n0VarR.B())) {
            return 0L;
        }
        if (Build.VERSION.SDK_INT < 30) {
            ...
            j = S() < ((Integer) f0.k0.a(null)).intValue() ? 16L : 0L;
        }
        ...
        if (j == 0) {
            if (this.D == null) {
                ...
                if (aVarR != null) {
                    try {
                        ...
                        if (num != null) {
                            try {
                                ...
                                e = e2;
                                p1.m(u0Var);
                                u0Var.F.b(e, "Measurement manager api exception");
                    ...
                    p1.m(u0Var);
                    u0Var.K.b(num, "Measurement manager api status result");
    ...
    public final boolean Z(String str) {
        v();
        p1 p1Var = (p1) this.e;
        if (((Context) com.google.android.gms.common.wrappers.b.a(p1Var.e).a).checkCallingOrSelfPermission(str) == 0) {
            return true;
        }
        u0 u0Var = p1Var.C;
        p1.m(u0Var);
        u0Var.J.b(str, "Permission not granted");
        return false;
    }
    ...
    public final boolean b0(String str, String str2) {
        ...
        return ((p1) this.e).A.z("debug.firebase.analytics.app").equals(str);
    }
        ...
        if (bundle != null) {
            for (String str : bundle.keySet()) {
                ...
                if (objE == null) {
                    ...
                    u0 u0Var = p1Var.C;
                    p1.m(u0Var);
                    u0Var.H.b(p1Var.G.b(str), "Param value can't be null");
                } else {
                    M(bundle2, str, objE);
                }
            }
    ...
    public final u d0(String str, Bundle bundle, String str2, long j, long j2, boolean z) {
        ...
        if (D0(str) != 0) {
            ...
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.C.b(p1Var.G.c(str), "Invalid conditional property event name");
    ...
    public final boolean e0(Context context, String str) {
        ...
        try {
            ...
            u0 u0Var = p1Var.C;
            p1.m(u0Var);
            u0Var.C.b(e, "Package name not found");
            return true;
        } catch (CertificateException e2) {
            u0 u0Var2 = p1Var.C;
            p1.m(u0Var2);
            u0Var2.C.b(e2, "Error obtaining certificate");
            return true;
        }
    }

    public final boolean g0(int i) {
        Boolean bool = ((p1) this.e).p().B;
        if (h0() < i / 1000) {
    ...
    public final void i0(Bundle bundle, long j) {
        ...
        if (j2 != 0) {
            ...
            p1.m(u0Var);
            u0Var.F.b(Long.valueOf(j2), "Params already contained engagement");
        } else {
            j2 = 0;
        }
    ...
    public final void j0(String str, b6 b6Var) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.F.b(e, "Error returning string value to wrapper");
        }
    }
    ...
    public final void k0(b6 b6Var, long j) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.F.b(e, "Error returning long value to wrapper");
        }
    }
    ...
    public final void l0(b6 b6Var, int i) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.F.b(e, "Error returning int value to wrapper");
        }
    }
    ...
    public final void m0(b6 b6Var, byte[] bArr) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.F.b(e, "Error returning byte array to wrapper");
        }
    }
    ...
    public final void n0(b6 b6Var, boolean z) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.F.b(e, "Error returning boolean value to wrapper");
        }
    }
    ...
    public final void p0(b6 b6Var, ArrayList arrayList) {
        ...
        try {
            ...
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.F.b(e, "Error returning bundle list to wrapper");
        }
    }
    ...
    public final Bundle x0(Uri uri) {
        ...
        if (uri != null) {
            try {
                ...
                u0 u0Var = p1Var.C;
                p1.m(u0Var);
                u0Var.F.b(e, "Install referrer url isn't a hierarchical URI");
                return null;
            }
        }
        return null;
    ...
    public final boolean z(String str, String str2, int i, Object obj) {
        ...
        if (string.codePointCount(0, string.length()) > i) {
            u0 u0Var = ((p1) this.e).C;
            p1.m(u0Var);
            u0Var.H.d("Value is too long; discarded. Value kind, name, value length", str, str2, Integer.valueOf(string.length()));
            return false;
        }
        return true;
    }
    ...
    public final boolean z0(String str, String str2) {
        ...
        if (!Character.isLetter(iCodePointAt)) {
            u0 u0Var3 = p1Var.C;
            p1.m(u0Var3);
            u0Var3.E.c(str, str2, "Name must start with a letter. Type, name");
            return false;
        }
        int length = str2.length();
        int iCharCount = Character.charCount(iCodePointAt);
