...
public final class s4 {
    ...
    public s4(c cVar, String str, e9 e9Var, BitSet bitSet, BitSet bitSet2, androidx.collection.f fVar, androidx.collection.f fVar2) {
        this.h = cVar;
        this.a = str;
        this.d = bitSet;
        this.e = bitSet2;
    ...
    public final void a(b bVar) {
        ...
        if (bVar.f != null) {
            ...
            com.google.android.gms.internal.measurement.t3.a();
            boolean zG = p1Var.A.G(str, e0Var);
            Long l2 = bVar.f;
            if (!zG) {
    ...
    public final l8 b(int i) {
        ...
        d9 d9VarC = e9.C();
        ArrayList arrayListB0 = l4.b0(this.d);
        d9VarC.b();
        ((e9) d9VarC.y).G(arrayListB0);
        ArrayList arrayListB1 = l4.b0(this.e);
        d9VarC.b();
