...
public class MaterialToolbar extends Toolbar {
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayE = i.e(context2, attributeSet, com.google.android.material.a.p, R.attr.toolbarStyle, R.style.Widget_MaterialComponents_Toolbar, new int[0]);
    ...
    public final void onAttachedToWindow() {
        ...
        if (background instanceof com.google.android.material.shape.i) {
            g.O(this, (com.google.android.material.shape.i) background);
        }
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.r0 || this.s0) {
            ArrayList arrayListD = i.d(this, getTitle());
            TextView textView = arrayListD.isEmpty() ? null : (TextView) Collections.min(arrayListD, jVar);
            ArrayList arrayListD2 = i.d(this, getSubtitle());
            TextView textView2 = arrayListD2.isEmpty() ? null : (TextView) Collections.max(arrayListD2, jVar);
    ...
    public void setElevation(float f) {
        ...
        Drawable background = getBackground();
        if (background instanceof com.google.android.material.shape.i) {
            ((com.google.android.material.shape.i) background).m(f);
        }
    }
