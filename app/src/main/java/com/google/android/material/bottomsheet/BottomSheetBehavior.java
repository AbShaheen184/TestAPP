...
public class BottomSheetBehavior<V extends View> extends androidx.coordinatorlayout.widget.a {
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(3)) {
            this.j = v.s(context, typedArrayObtainStyledAttributes, 3);
        }
        if (typedArrayObtainStyledAttributes.hasValue(22)) {
            this.y = m.b(context, attributeSet, R.attr.bottomSheetStyle, R.style.Widget_Design_BottomSheet_Modal).a();
        }
        m mVar = this.y;
        if (mVar != null) {
            i iVar = new i(mVar);
        ...
        if (f <= 0.0f || f >= 1.0f) {
            kotlinx.coroutines.future.a.q("ratio must be a float value between 0 and 1");
            throw null;
        }
        this.F = f;
        if (this.W != null) {
        ...
        if (typedValuePeekValue2 == null || typedValuePeekValue2.type != 16) {
            ...
            if (dimensionPixelOffset < 0) {
                kotlinx.coroutines.future.a.q("offset must be greater than or equal to 0");
                throw null;
            }
    ...
    */
    public final void E(android.view.View r3, int r4, boolean r5) {
        ...
        L32:
            ...
            r3 = 1
            r2.G(r4, r3)
            androidx.compose.ui.platform.u1 r3 = r2.A
            r3.a(r4)
            return
        L40:
            r2.C(r4)
    ...
    public final void G(int i, boolean z) {
        ...
        if (z && valueAnimator != null) {
            if (valueAnimator.isRunning()) {
                ...
                valueAnimator.setFloatValues(iVar.y.j, z2 ? s() : 1.0f);
                valueAnimator.start();
                return;
            }
        }
    ...
    public final boolean g(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (this.W == null) {
            ...
            if (this.o || this.p || this.q || this.s || this.t || this.u || z) {
                ...
                com.google.android.material.internal.k kVar = new com.google.android.material.internal.k(i2, fVar, jVar);
                Field field = s0.a;
                k0.c(view, kVar);
    ...
    public final float s() {
        ...
        if (this.i != null && (weakReference = this.W) != null && weakReference.get() != null && Build.VERSION.SDK_INT >= 31) {
            ...
            if (z() && (rootWindowInsets = view.getRootWindowInsets()) != null) {
                i iVar = this.i;
                float[] fArr = iVar.Y;
                float fA = fArr != null ? fArr[3] : iVar.y.a.e.a(iVar.g());
                ...
                i iVar2 = this.i;
                float[] fArr2 = iVar2.Y;
                float fA2 = fArr2 != null ? fArr2[0] : iVar2.y.a.f.a(iVar2.g());
    ...
    public final int y(int i) {
        ...
        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Invalid state to get top offset: "));
        return 0;
    }
