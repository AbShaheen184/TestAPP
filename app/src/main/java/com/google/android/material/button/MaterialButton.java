...
public class MaterialButton extends p implements Checkable, w {
    ...
    public MaterialButton(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayE = i.e(context2, attributeSet, com.google.android.material.a.i, com.app.mlounge.R.attr.materialButtonStyle, com.app.mlounge.R.style.Widget_MaterialComponents_Button, new int[0]);
        this.K = typedArrayE.getDimensionPixelSize(13, 0);
        int i = typedArrayE.getInt(16, -1);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.D = i.f(i, mode);
        this.E = v.s(getContext(), typedArrayE, 15);
        this.F = v.w(getContext(), typedArrayE, 11);
        this.N = typedArrayE.getInteger(12, 1);
        this.H = typedArrayE.getDimensionPixelSize(14, 0);
        z zVarB = z.b(context2, typedArrayE, 19);
        m mVarC = zVarB != null ? zVarB.c() : m.b(context2, attributeSet, com.app.mlounge.R.attr.materialButtonStyle, com.app.mlounge.R.style.Widget_MaterialComponents_Button).a();
        ...
        if (typedArrayE.hasValue(9)) {
            ...
            l lVarF = eVar.b.f();
            lVarF.e = new com.google.android.material.shape.a(f);
            lVarF.f = new com.google.android.material.shape.a(f);
            lVarF.g = new com.google.android.material.shape.a(f);
            lVarF.h = new com.google.android.material.shape.a(f);
            eVar.b = lVarF.a();
            eVar.c = null;
            eVar.d();
            eVar.s = true;
        ...
        eVar.l = i.f(typedArrayE.getInt(8, -1), mode);
        eVar.m = v.s(getContext(), typedArrayE, 7);
        eVar.n = v.s(getContext(), typedArrayE, 21);
        eVar.o = v.s(getContext(), typedArrayE, 18);
    ...
    private int getOpticalCenterShift() {
        com.google.android.material.shape.i iVarA;
        if (this.T && this.V && (iVarA = this.A.a(false)) != null) {
    ...
    public final androidx.dynamicanimation.animation.f d() {
        ...
        TypedValue typedValueD = t.D(context, com.app.mlounge.R.attr.motionSpringFastSpatial);
        int[] iArr = com.google.android.material.a.n;
        TypedArray typedArrayObtainStyledAttributes = typedValueD == null ? context.obtainStyledAttributes(null, iArr, 0, com.app.mlounge.R.style.Motion_Material3_Spring_Standard_Fast_Spatial) : context.obtainStyledAttributes(typedValueD.resourceId, iArr);
    ...
    public final void f(boolean z) {
        ...
        if (this.V) {
            ...
            a0 a0Var = (a0) (i4 < 0 ? b0Var.b : b0Var.d[i4]).e;
            int width = getWidth();
            float f = a0Var.b;
            int i6 = a0Var.a;
            if (i6 != 1) {
    ...
    public m getShapeAppearanceModel() {
        ...
        kotlinx.coroutines.future.a.u("Attempted to get ShapeAppearanceModel from a MaterialButton which has an overwritten background.");
        return null;
    }
    ...
    public z getStateListShapeAppearanceModel() {
        ...
        kotlinx.coroutines.future.a.u("Attempted to get StateListShapeAppearanceModel from a MaterialButton which has an overwritten background.");
        return null;
    }
    ...
    public void setBackgroundResource(int i) {
        setBackgroundDrawable(i != 0 ? v.v(getContext(), i) : null);
    }
    ...
    public void setIconResource(int i) {
        setIcon(i != 0 ? v.v(getContext(), i) : null);
    }

    public void setIconSize(int i) {
        if (i < 0) {
            kotlinx.coroutines.future.a.q("iconSize cannot be less than 0");
        } else if (this.H != i) {
            this.H = i;
            h(true);
        }
    ...
    public void setIconTintResource(int i) {
        setIconTint(_COROUTINE.a.L(getContext(), i));
    }
    ...
    public void setOpticalCenterEnabled(boolean z) {
        if (this.T != z) {
            ...
            e eVar = this.A;
            if (z) {
                com.google.android.datatransport.runtime.scheduling.jobscheduling.j jVar = new com.google.android.datatransport.runtime.scheduling.jobscheduling.j(this, 1);
                eVar.e = jVar;
                com.google.android.material.shape.i iVarA = eVar.a(false);
                if (iVarA != null) {
                    iVarA.a0 = jVar;
                }
            } else {
                eVar.e = null;
                com.google.android.material.shape.i iVarA2 = eVar.a(false);
                if (iVarA2 != null) {
                    iVarA2.a0 = null;
                }
            }
            post(new androidx.work.p(this, 2));
        }
    }
    ...
    public void setPressed(boolean z) {
        b bVar = this.C;
        if (bVar != null) {
            ((MaterialButtonToggleGroup) ((q) bVar).e).invalidate();
        }
        super.setPressed(z);
        f(false);
    }
    ...
    public void setRippleColorResource(int i) {
        if (e()) {
            setRippleColor(_COROUTINE.a.L(getContext(), i));
        }
    }
    ...
    public void setShapeAppearanceModel(m mVar) {
        if (!e()) {
            kotlinx.coroutines.future.a.u("Attempted to set ShapeAppearanceModel on a MaterialButton which has an overwritten background.");
            return;
        }
        e eVar = this.A;
        eVar.b = mVar;
    ...
    public void setStateListShapeAppearanceModel(z zVar) {
        if (!e()) {
            kotlinx.coroutines.future.a.u("Attempted to set StateListShapeAppearanceModel on a MaterialButton which has an overwritten background.");
            return;
        }
        e eVar = this.A;
        if (eVar.d == null && zVar.d()) {
            eVar.d = d();
            if (eVar.c != null) {
                eVar.d();
            }
    ...
    public void setStrokeColorResource(int i) {
        if (e()) {
            setStrokeColor(_COROUTINE.a.L(getContext(), i));
        }
    }
