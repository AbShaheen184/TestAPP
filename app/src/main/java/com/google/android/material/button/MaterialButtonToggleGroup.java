...
public class MaterialButtonToggleGroup extends d {
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        ...
        this.I = false;
        this.M = new HashSet();
        TypedArray typedArrayE = i.e(getContext(), attributeSet, com.google.android.material.a.k, R.attr.materialButtonToggleGroupStyle, R.style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
        ...
        if (this.C == null) {
            this.C = x.b(new com.google.android.material.shape.a(0.0f));
        }
