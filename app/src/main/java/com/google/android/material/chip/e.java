...
public final class e extends i implements Drawable.Callback {
    ...
    public e(Context context, AttributeSet attributeSet) {
        super(m.b(context, attributeSet, com.app.mlounge.R.attr.chipStyle, com.app.mlounge.R.style.Widget_MaterialComponents_Chip_Action).a());
        this.g0 = -1.0f;
        this.L0 = new Paint(1);
    ...
    public final boolean B(int[] iArr, int[] iArr2) {
        ...
        com.google.android.material.resources.d dVar = this.Q0.f;
        int colorForState3 = (dVar == null || (colorStateList = dVar.k) == null) ? 0 : colorStateList.getColorForState(iArr, this.W0);
    ...
    public final void X(com.google.android.material.resources.d dVar) {
        g gVar = this.Q0;
        b bVar = gVar.b;
