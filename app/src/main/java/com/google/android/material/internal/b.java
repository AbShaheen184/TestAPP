...
public final class b {
    ...
    public Typeface x;
    public Typeface y;
    public com.google.android.material.resources.a z;
    public int f = 16;
    public int g = 16;
    ...
    public final void b() {
        ...
        this.H = com.google.android.material.animation.a.a(0.0f, this.S, f);
        this.I = com.google.android.material.animation.a.a(0.0f, this.T, f);
        this.J = com.google.android.material.animation.a.a(0.0f, this.U, f);
    ...
    public final boolean c(CharSequence charSequence) {
        ...
        if (this.E) {
            return (z ? androidx.core.text.g.d : androidx.core.text.g.c).e(charSequence, charSequence.length());
        }
        return z;
    }
    ...
    public final StaticLayout e(int i, TextPaint textPaint, CharSequence charSequence, float f, boolean z) {
        ...
        f fVar = new f(charSequence, textPaint, (int) f);
        fVar.l = this.A;
        fVar.k = z;
        fVar.e = alignment;
        fVar.j = false;
    ...
    public final void i(Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            if (typeface != null) {
                this.t = androidx.compose.ui.contentcapture.b.i(configuration, typeface);
            }
            Typeface typeface2 = this.x;
            if (typeface2 != null) {
                this.w = androidx.compose.ui.contentcapture.b.i(configuration, typeface2);
            }
    ...
    public final boolean l(Typeface typeface) {
        com.google.android.material.resources.a aVar = this.z;
        if (aVar != null) {
            aVar.l = true;
        }
        if (this.u == typeface) {
        ...
        this.u = typeface;
        Typeface typefaceI = androidx.compose.ui.contentcapture.b.i(this.a.getContext().getResources().getConfiguration(), typeface);
        this.t = typefaceI;
        if (typefaceI == null) {
            typefaceI = this.u;
        }
