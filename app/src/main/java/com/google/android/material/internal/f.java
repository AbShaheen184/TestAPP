...
public final class f {
    ...
    public int d;
    public boolean k;
    public com.google.android.datatransport.runtime.scheduling.jobscheduling.j m;
    ...
    public final StaticLayout a() {
        ...
        com.google.android.datatransport.runtime.scheduling.jobscheduling.j jVar = this.m;
        if (jVar != null) {
            builderObtain.setBreakStrategy(((TextInputLayout) jVar.y).R.getBreakStrategy());
        }
