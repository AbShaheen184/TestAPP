...
public final class d {
    ...
    public d(Context context, int i) {
        ...
        this.k = v.s(context, typedArrayObtainStyledAttributes, 3);
        v.s(context, typedArrayObtainStyledAttributes, 4);
        v.s(context, typedArrayObtainStyledAttributes, 5);
        ...
        this.a = v.s(context, typedArrayObtainStyledAttributes, 6);
    ...
    public final void e(Context context, TextPaint textPaint, g gVar) {
        ...
        b(context, new c(this, context, textPaint, gVar));
    }

    public final void f(Context context, TextPaint textPaint, Typeface typeface) {
        Typeface typefaceI = androidx.compose.ui.contentcapture.b.i(context.getResources().getConfiguration(), typeface);
        if (typefaceI != null) {
            typeface = typefaceI;
        }
