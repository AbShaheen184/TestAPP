...
public final class b0 {
    public int a;
    public com.google.android.gms.tasks.q b;
    public int[][] c;
    public com.google.android.gms.tasks.q[] d;
        ...
        while (true) {
            ...
            if (next == 2 && depth2 <= depth && xmlResourceParser.getName().equals("item")) {
                ...
                if (typedValuePeekValue != null) {
                    ...
                    if (i == 5) {
                        a0Var = new a0(2, TypedValue.complexToDimensionPixelSize(typedValuePeekValue.data, typedArrayObtainAttributes.getResources().getDisplayMetrics()));
                    } else if (i == 6) {
                        a0Var = new a0(1, typedValuePeekValue.getFraction(1.0f, 1.0f));
                    } else {
                        a0Var = null;
                    }
                } else {
                ...
                if (i5 >= iArr3.length) {
                    ...
                    this.c = iArr4;
                    com.google.android.gms.tasks.q[] qVarArr = new com.google.android.gms.tasks.q[i6];
                    System.arraycopy(this.d, 0, qVarArr, 0, i5);
                    this.d = qVarArr;
                }
                int[][] iArr5 = this.c;
                int i7 = this.a;
