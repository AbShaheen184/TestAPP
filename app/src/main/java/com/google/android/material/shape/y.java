...
public final class y {
    ...
    public static ArrayList g(String str) {
        ...
        while (i <= str.length()) {
            ...
            if (iG2 == -1 || iG2 > iG) {
                ...
                arrayList.add(str.substring(i, iG2));
                arrayList.add(str.substring(iG2 + 1, iG));
            }
            i = iG + 1;
        }
        return arrayList;
    ...
    /* JADX WARN: Type inference failed for: r1v4, types: [com.google.android.material.shape.m[], java.io.Serializable, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r3v0, types: [int[][], java.io.Serializable, java.lang.Object] */
    public void b(int[] iArr, m mVar) {
        int i = this.b;
        ...
        if (i >= iArr2.length) {
            ...
            this.d = r3;
            ?? r1 = new m[i2];
            System.arraycopy((m[]) this.e, 0, r1, 0, i);
            this.e = r1;
        }
    ...
    public okhttp3.s c() {
        ...
        if (str == null) {
            kotlinx.coroutines.future.a.u("scheme == null");
            return null;
        }
        ...
        if (str2 == null) {
            kotlinx.coroutines.future.a.u("host == null");
            return null;
        }
        int iD = d();
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [com.google.android.material.shape.m[], java.io.Serializable] */
    ...
    public void f(okhttp3.s sVar, String str) {
        ...
        if (i == -1) {
            if (sVar == null) {
                kotlinx.coroutines.future.a.q("Expected URL scheme 'http' or 'https' but no scheme was found for ".concat(str.length() > 6 ? kotlin.text.k.e0(6, str).concat("...") : str));
                return;
            }
            this.c = sVar.a;
        } else if (kotlin.text.r.t(iJ, str, "https:", true)) {
            this.c = "https";
            iJ += 6;
        } else {
            if (!kotlin.text.r.t(iJ, str, "http:", true)) {
        ...
        if (i3 >= 2 || sVar == null || !kotlin.jvm.internal.l.a(sVar.a, (String) this.c)) {
            ...
            while (true) {
                ...
                if (bCharAt == 64) {
                    if (z) {
                        ...
                        if (z2) {
                            strA = androidx.compose.runtime.j.m(new StringBuilder(), (String) this.d, "%40", strA);
                        }
                        this.d = strA;
                        if (iE != iF) {
            ...
            if (i7 < iF) {
                ...
                this.b = i2;
                if (i2 == -1) {
                    kotlinx.coroutines.future.a.f(str.substring(i7, iF), "Invalid URL port: \"", 34);
                    return;
                }
            } else {
                this.f = okhttp3.internal.d.b(okhttp3.internal.url.a.d(i5, str, i6, 4));
            ...
            if (((String) this.f) == null) {
                kotlinx.coroutines.future.a.f(str.substring(i5, i6), "Invalid URL host: \"", 34);
                return;
            }
            iJ = iF;
        } else {
            ...
            while (iJ < iF2) {
                ...
                if (!strA2.equals(".") && !strA2.equalsIgnoreCase("%2e")) {
                    if (!strA2.equals("..") && !strA2.equalsIgnoreCase("%2e.") && !strA2.equalsIgnoreCase(".%2e") && !strA2.equalsIgnoreCase("%2e%2e")) {
                        if (((CharSequence) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, arrayList)).length() == 0) {
