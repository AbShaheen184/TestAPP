...
public class SideSheetBehavior<V extends View> extends androidx.coordinatorlayout.widget.a {
    ...
    public SideSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(3)) {
            this.c = v.s(context, typedArrayObtainStyledAttributes, 3);
        }
    ...
    public final boolean g(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (weakReference == null) {
            ...
            android.support.v4.media.session.b.E(context, R.attr.motionDurationMedium2, 300);
            android.support.v4.media.session.b.E(context, R.attr.motionDurationShort3, 150);
            android.support.v4.media.session.b.E(context, R.attr.motionDurationShort2, 100);
            ...
            if (i6 == 0) {
                ...
                if (mVar != null) {
                    ...
                    if (dVar == null || ((ViewGroup.MarginLayoutParams) dVar).rightMargin <= 0) {
                        l lVarF = mVar.f();
                        lVarF.f = new com.google.android.material.shape.a(0.0f);
                        lVarF.g = new com.google.android.material.shape.a(0.0f);
                        m mVarA = lVarF.a();
                        if (iVar != null) {
                ...
                if (i6 != 1) {
                    kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.q("Invalid sheet edge position value: ", i6, ". Must be 0 or 1."));
                    return false;
                }
                ...
                if (mVar != null) {
                    ...
                    if (dVar == null || ((ViewGroup.MarginLayoutParams) dVar).leftMargin <= 0) {
                        l lVarF2 = mVar.f();
                        lVarF2.e = new com.google.android.material.shape.a(0.0f);
                        lVarF2.h = new com.google.android.material.shape.a(0.0f);
                        m mVarA2 = lVarF2.a();
                        if (iVar != null) {
        ...
        int i7 = this.h;
        if (i7 == 1 || i7 == 2) {
            iE = iE2 - this.a.E(view);
        } else if (i7 == 3) {
            iE = 0;
        } else {
            if (i7 != 5) {
                kotlinx.coroutines.future.a.n(this.h, "Unexpected value: ");
                return false;
            }
            iE = this.a.B();
        }
        Field field2 = s0.a;
        view.offsetLeftAndRight(iE);
    ...
    */
    public final void t(android.view.View r3, int r4, boolean r5) {
        /*
            ...
            r0 = 5
            if (r4 != r0) goto Ld
            com.google.firebase.b r0 = r2.a
            int r0 = r0.B()
            goto L1d
        Ld:
            java.lang.String r3 = "Invalid state to get outer edge offset: "
            java.lang.String r3 = androidx.privacysandbox.ads.adservices.java.internal.a.n(r4, r3)
            kotlinx.coroutines.future.a.q(r3)
            return
        L17:
            com.google.firebase.b r0 = r2.a
            int r0 = r0.A()
        ...
        L4b:
            r3 = 2
            r2.r(r3)
            androidx.compose.ui.platform.u1 r3 = r2.e
            r3.a(r4)
            return
        L55:
            r2.r(r4)
    ...
    public final void u() {
        ...
        int i = 5;
        if (this.h != 5) {
            s0.k(view, androidx.core.view.accessibility.b.l, new n(this, i, 2));
        }
        int i2 = 3;
        if (this.h != 3) {
            s0.k(view, androidx.core.view.accessibility.b.j, new n(this, i2, 2));
        }
    }
