...
public class TextInputEditText extends androidx.appcompat.widget.u {
    public final Rect D;
    public boolean E;

    public TextInputEditText(Context context, AttributeSet attributeSet) {
        super(com.google.android.material.theme.overlay.a.a(context, attributeSet, R.attr.editTextStyle, 0), attributeSet);
        this.D = new Rect();
        ...
        int[] iArr = com.google.android.material.a.w;
    ...
    public CharSequence getHint() {
        TextInputLayout textInputLayout = getTextInputLayout();
        return (textInputLayout == null || !textInputLayout.f0) ? super.getHint() : textInputLayout.getHint();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f0 && super.getHint() == null) {
