...
public final class c extends o {
    ...
    public c(n nVar) {
        ...
        this.e = android.support.v4.media.session.b.E(nVar.getContext(), R.attr.motionDurationShort3, 100);
        this.f = android.support.v4.media.session.b.E(nVar.getContext(), R.attr.motionDurationShort3, 150);
        this.g = android.support.v4.media.session.b.F(nVar.getContext(), R.attr.motionEasingLinearInterpolator, com.google.android.material.animation.a.a);
        this.h = android.support.v4.media.session.b.F(nVar.getContext(), R.attr.motionEasingEmphasizedInterpolator, com.google.android.material.animation.a.d);
    }
    ...
    public final void r() {
        ...
        if (editText != null) {
            editText.post(new androidx.work.p(this, 5));
        }
    }
