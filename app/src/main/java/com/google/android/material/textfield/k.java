...
public final class k extends o {
    ...
    public k(n nVar) {
        ...
        this.f = android.support.v4.media.session.b.E(nVar.getContext(), R.attr.motionDurationShort3, 67);
        this.e = android.support.v4.media.session.b.E(nVar.getContext(), R.attr.motionDurationShort3, 50);
    ...
    public final void a() {
        ...
        this.h.post(new androidx.work.p(this, 6));
    }
