...
public final class n extends LinearLayout {
    ...
    public n(TextInputLayout textInputLayout, c2 c2Var) {
        ...
        if (typedArray.hasValue(38)) {
            this.A = androidx.work.impl.v.t(getContext(), c2Var, 38);
        }
        if (typedArray.hasValue(39)) {
            this.B = com.google.android.material.internal.i.f(typedArray.getInt(39, -1), null);
        }
        ...
        if (!typedArray.hasValue(54)) {
            if (typedArray.hasValue(32)) {
                this.H = androidx.work.impl.v.t(getContext(), c2Var, 32);
            }
            if (typedArray.hasValue(33)) {
                this.I = com.google.android.material.internal.i.f(typedArray.getInt(33, -1), null);
            }
        }
        if (typedArray.hasValue(30)) {
            ...
            if (typedArray.hasValue(55)) {
                this.H = androidx.work.impl.v.t(getContext(), c2Var, 55);
            }
            if (typedArray.hasValue(56)) {
                this.I = com.google.android.material.internal.i.f(typedArray.getInt(56, -1), null);
            }
        ...
        if (typedArray.hasValue(31)) {
            ImageView.ScaleType scaleTypeQ = t1.q(typedArray.getInt(31, -1));
            this.K = scaleTypeQ;
    ...
    public final CheckableImageButton a(ViewGroup viewGroup, LayoutInflater layoutInflater, int i) {
        ...
        if (androidx.work.impl.v.H(getContext())) {
    ...
    public final o b() {
        ...
        if (i == -1) {
            ...
            dVar = new s(nVar, eVar.c);
        } else if (i == 2) {
            dVar = new c(nVar);
        } else {
            if (i != 3) {
                kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Invalid end icon mode: "));
                return null;
            }
            dVar = new k(nVar);
        }
    ...
    public final void f(boolean z) {
        ...
        if (z || z4) {
            t1.z(this.e, checkableImageButton, this.H);
        }
    }
    ...
    public final void g(int i) {
        ...
        Drawable drawableV = iD != 0 ? androidx.work.impl.v.v(getContext(), iD) : null;
        CheckableImageButton checkableImageButton = this.D;
        checkableImageButton.setImageDrawable(drawableV);
        TextInputLayout textInputLayout = this.e;
        if (drawableV != null) {
            t1.g(textInputLayout, checkableImageButton, this.H, this.I);
            t1.z(textInputLayout, checkableImageButton, this.H);
        }
        int iC = oVarB2.c();
    ...
    public final void i(Drawable drawable) {
        ...
        l();
        t1.g(this.e, checkableImageButton, this.A, this.B);
    }
