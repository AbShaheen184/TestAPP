...
class ClockFaceView extends h implements f {
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet) {
        ...
        ColorStateList colorStateListS = v.s(context, typedArrayObtainStyledAttributes, 1);
        this.j0 = colorStateListS;
        ...
        int colorForState = colorStateListS.getColorForState(new int[]{android.R.attr.state_selected}, colorStateListS.getDefaultColor());
        this.b0 = new int[]{colorForState, colorForState, colorStateListS.getDefaultColor()};
        clockHandView.z.add(this);
        int defaultColor = _COROUTINE.a.L(context, R.color.material_timepicker_clockface).getDefaultColor();
        ColorStateList colorStateListS2 = v.s(context, typedArrayObtainStyledAttributes, 0);
        setBackgroundColor(colorStateListS2 != null ? colorStateListS2.getDefaultColor() : defaultColor);
