...
class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attributeSet) {
        ...
        android.support.v4.media.session.b.E(context, R.attr.motionDurationLong2, org.mozilla.javascript.Context.VERSION_ES6);
        android.support.v4.media.session.b.F(context, R.attr.motionEasingEmphasizedInterpolator, com.google.android.material.animation.a.b);
