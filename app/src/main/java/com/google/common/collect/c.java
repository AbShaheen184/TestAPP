...
public class c implements Iterator {
    ...
    public final void remove() {
        switch (this.e) {
            case 0:
                _COROUTINE.a.z("no calls to next() since the last call to remove()", ((Collection) this.z) != null);
                this.y.remove();
                ...
                break;
            case 1:
                _COROUTINE.a.z("no calls to next() since the last call to remove()", ((Map.Entry) this.z) != null);
