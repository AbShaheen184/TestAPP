...
public abstract class q {
    ...
    public static void e(int i, Object[] objArr) {
        for (int i2 = 0; i2 < i; i2++) {
            if (objArr[i2] == null) {
                com.google.firebase.platforminfo.b.h(androidx.privacysandbox.ads.adservices.java.internal.a.n(i2, "at index "));
                return;
            }
        }
    }
    ...
    public static Object g(int i) {
        if (i < 2 || i > 1073741824 || Integer.highestOneBit(i) != i) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "must be power of 2 between 2^1 and 2^30: "));
            return null;
        }
        if (i <= 256) {
            return new byte[i];
    ...
    public static l1 n(Set set, k0 k0Var) {
        _COROUTINE.a.v(set, "set1");
        _COROUTINE.a.v(k0Var, "set2");
    ...
    public static ArrayList p(Object... objArr) {
        ...
        f(length, "arraySize");
        ArrayList arrayList = new ArrayList(com.imsdk.a.z(((long) length) + 5 + ((long) (length / 10))));
    ...
    public static int q(Object obj, Object obj2, int i, Object obj3, int[] iArr, Object[] objArr, Object[] objArr2) {
        ...
        if (iU != 0) {
            ...
            while (true) {
                int i6 = iU - 1;
                int i7 = iArr[i6];
                if ((i7 & i3) == i4 && okhttp3.internal.platform.android.g.g(obj, objArr[i6]) && (objArr2 == null || okhttp3.internal.platform.android.g.g(obj2, objArr2[i6]))) {
                    int i8 = i7 & i;
                    if (i5 == -1) {
                        v(i2, i8, obj3);
                        return i6;
    ...
    public static AbstractList w(List list, com.google.common.base.d dVar) {
        return list instanceof RandomAccess ? new t0(list, dVar) : new u0(list, dVar);
    }
