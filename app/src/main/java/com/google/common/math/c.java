...
public abstract class c {
    ...
    public static boolean a(double d) {
        if (coil3.svg.internal.a.B(d)) {
            return d == 0.0d || 52 - Long.numberOfTrailingZeros(coil3.svg.internal.a.v(d)) <= Math.getExponent(d);
        }
        return false;
    }

    public static boolean b(double d) {
        if (d > 0.0d && coil3.svg.internal.a.B(d)) {
            long jV = coil3.svg.internal.a.v(d);
            if ((jV & (jV - 1)) == 0) {
                return true;
            }
        }
    ...
    public static int c(double d) {
        ...
        boolean z = false;
        _COROUTINE.a.n("x must be positive and finite", d > 0.0d && coil3.svg.internal.a.B(d));
