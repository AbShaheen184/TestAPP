...
public abstract class r implements ListenableFuture {
    ...
    public static final org.jsoup.helper.n C;
    ...
    static {
        ...
        if (th2 != null) {
            s0 s0Var = B;
            Logger loggerA = s0Var.a();
            Level level = Level.SEVERE;
            loggerA.log(level, "UnsafeAtomicHelper is broken!", th);
            s0Var.a().log(level, "SafeAtomicHelper is broken!", th2);
        }
        D = new Object();
    }
    ...
    public static void e(r rVar, boolean z) {
        f fVar = null;
        while (true) {
            for (q qVarQ = C.q(rVar); qVarQ != null; qVarQ = qVarQ.b) {
                Thread thread = qVarQ.a;
                if (thread != null) {
                    qVarQ.a = null;
    ...
    public void a(Runnable runnable, Executor executor) {
        f fVar;
        f fVar2 = f.d;
        _COROUTINE.a.v(executor, "Executor was null.");
        if (!isDone() && (fVar = this.y) != fVar2) {
            f fVar3 = new f(runnable, executor);
            do {
                fVar3.c = fVar;
                if (C.i(this, fVar, fVar3)) {
                    return;
                } else {
                    fVar = this.y;
                }
    ...
    public Object get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        if (nanos >= 1000) {
            ...
            if (qVar2 != qVar) {
                ...
                z = true;
                while (true) {
                    org.jsoup.helper.n nVar = C;
                    nVar.H(qVar3, qVar2);
                    if (nVar.k(this, qVar2, qVar3)) {
                        j2 = j3;
                        do {
        ...
        StringBuilder sbO = androidx.compose.runtime.j.o(j, "Waited ", " ");
        ...
        throw new TimeoutException(androidx.compose.runtime.j.j(string3, " for ", string));
    }
    ...
    public boolean n(ListenableFuture listenableFuture) {
        ...
        if (obj != null) {
            ...
            if (C.j(this, null, h(listenableFuture))) {
                e(this, false);
                return true;
            }
        } else {
            h hVar = new h(this, listenableFuture);
            if (C.j(this, null, hVar)) {
                try {
