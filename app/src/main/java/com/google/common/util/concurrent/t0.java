...
public final class t0 extends com.google.common.collect.q implements ScheduledFuture, ListenableFuture, Future {
    public final r y;
    public final ScheduledFuture z;

    public t0(r rVar, ScheduledFuture scheduledFuture) {
        this.y = rVar;
