    ...
    public final Object get() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                Set<com.google.firebase.components.j> set = bVar.c;
                Set set2 = bVar.g;
                for (com.google.firebase.components.j jVar : set) {
                    int i = jVar.c;
                    int i2 = jVar.b;
                    boolean z2 = i == 0;
                    r rVar = jVar.a;
                ...
                x1Var.a = Collections.unmodifiableSet(hashSet);
                x1Var.b = Collections.unmodifiableSet(hashSet2);
                x1Var.c = Collections.unmodifiableSet(hashSet3);
                x1Var.d = Collections.unmodifiableSet(hashSet4);
                x1Var.e = Collections.unmodifiableSet(hashSet5);
                x1Var.f = gVar2;
                return eVar.g(x1Var);
            default:
