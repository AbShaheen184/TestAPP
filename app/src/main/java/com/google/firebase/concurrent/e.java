...
public final class e implements ScheduledExecutorService, AutoCloseable {
    ...
    public final ScheduledFuture schedule(Runnable runnable, long j, TimeUnit timeUnit) {
        return new g(new com.google.android.datatransport.runtime.scheduling.jobscheduling.g(this, runnable, j, timeUnit, 1));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final ScheduledFuture scheduleAtFixedRate(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        return new g(new c(this, runnable, j, j2, timeUnit, 0));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final ScheduledFuture scheduleWithFixedDelay(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        return new g(new c(this, runnable, j, j2, timeUnit, 1));
    }
    ...
    public final ScheduledFuture schedule(Callable callable, long j, TimeUnit timeUnit) {
        return new g(new com.google.android.datatransport.runtime.scheduling.jobscheduling.g(this, callable, j, timeUnit, 2));
    }
}
