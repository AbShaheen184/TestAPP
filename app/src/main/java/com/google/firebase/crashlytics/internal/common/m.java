...
public final class m {
    ...
    public static com.google.android.gms.tasks.s a(m mVar) {
        com.google.android.gms.tasks.s sVarH;
        mVar.getClass();
        ...
        for (File file : com.google.firebase.crashlytics.internal.persistence.c.k(((File) mVar.g.c).listFiles(r))) {
            try {
                ...
                try {
                    ...
                    sVarH = org.jsoup.helper.n.o(null);
                } catch (ClassNotFoundException unused) {
                    if (Log.isLoggable("FirebaseCrashlytics", 3)) {
                        Log.d("FirebaseCrashlytics", "Logging app exception event to Firebase Analytics", null);
                    }
                    sVarH = org.jsoup.helper.n.h(new ScheduledThreadPoolExecutor(1), new l(mVar, j));
                }
                arrayList.add(sVarH);
        ...
        return org.jsoup.helper.n.Q(arrayList);
    }
     ...
     */
    public final void b(boolean z, k0 k0Var, boolean z2) throws Throwable {
        ArrayList arrayList;
        int i;
        int i2;
        ?? r10;
        ...
        if (z2 && k0Var.b().b.b) {
            ...
            if (i4 >= 30) {
                ...
                if (historicalProcessExitReasons.size() != 0) {
                    ...
                    if (str2 != null) {
                        fVar.b = new com.google.firebase.crashlytics.internal.metadata.m(cVar.f(str2, "userlog"));
                    }
                    ...
                    synchronized (a1Var) {
                        a1Var.b.clear();
                        if (listB.size() > a1Var.a) {
                            Log.w("FirebaseCrashlytics", "Ignored 0 entries when adding rollout assignments. Maximum allowable: " + a1Var.a, null);
                            a1Var.b.addAll(listB.subList(0, a1Var.a));
                        } else {
                            a1Var.b.addAll(listB);
                        }
                    }
                    ...
                    if (next == null) {
                        String strI = androidx.compose.runtime.j.i("No relevant ApplicationExitInfo occurred during session: ", str2);
                        if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                        ...
                        if (processName == null) {
                            com.google.firebase.platforminfo.b.h("Null processName");
                            return;
                        }
                        c0Var.b = processName;
                        ...
                        if (!rVar.e.b().b.c || aVar2.c.size() <= 0) {
                            ...
                            while (it2.hasNext()) {
                                ...
                                String str4 = dVar2.a;
                                if (str4 == null) {
                                    com.google.firebase.platforminfo.b.h("Null libraryName");
                                    return;
                                }
                                Iterator it3 = it2;
                                String str5 = dVar2.b;
                                if (str5 == null) {
                                    com.google.firebase.platforminfo.b.h("Null arch");
                                    return;
                                }
                                String str6 = dVar2.c;
                                if (str6 == null) {
                                    com.google.firebase.platforminfo.b.h("Null buildId");
                                    return;
                                }
                        ...
                        List listA = rVar.a();
                        if (listA == null) {
                            com.google.firebase.platforminfo.b.h("Null binaries");
                            return;
                        }
                        ...
                        o0Var.d = rVar.b(i3);
                        p0 p0VarA = o0Var.a();
                        String strI2 = androidx.compose.runtime.j.i("Persisting anr for session ", str2);
                        if (Log.isLoggable("FirebaseCrashlytics", 3)) {
                            Log.d("FirebaseCrashlytics", strI2, null);
                        }
                    ...
                    i = 4;
                    i2 = 8;
                    String strI3 = androidx.compose.runtime.j.i("No ApplicationExitInfo available. Session: ", str2);
                    if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                        Log.v("FirebaseCrashlytics", strI3, null);
                    }
                }
            } else {
                arrayList = arrayList2;
                i = 4;
                i2 = 8;
                String strN = androidx.privacysandbox.ads.adservices.java.internal.a.n(i4, "ANR feature enabled, but device is API ");
                if (Log.isLoggable("FirebaseCrashlytics", 2)) {
        ...
        if (z2 && this.j.c()) {
            String strI4 = androidx.compose.runtime.j.i("Finalizing native report for session ", str2);
            if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                th = null;
                Log.v("FirebaseCrashlytics", strI4, null);
            } else {
                th = null;
            }
            this.j.a().getClass();
        ...
        if (navigableSetC.size() > i9) {
            while (navigableSetC.size() > i9) {
                ...
                String strI5 = androidx.compose.runtime.j.i("Removing session over cap: ", str10);
                if (Log.isLoggable("FirebaseCrashlytics", 3)) {
                    Log.d("FirebaseCrashlytics", strI5, null);
                }
        ...
        for (String str11 : navigableSetC) {
            String strI6 = androidx.compose.runtime.j.i("Finalizing report for session ", str11);
            if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                Log.v("FirebaseCrashlytics", strI6, null);
            }
            ...
            if (listK.isEmpty()) {
                String strR = androidx.privacysandbox.ads.adservices.java.internal.a.r("Session ", str11, " has no events.");
                if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                    ...
                    try {
                        ...
                        if (m2Var4 != null) {
                            ...
                            try {
                                ...
                                com.google.firebase.crashlytics.internal.persistence.a.f(z5 ? new File((File) cVar5.f, ((j0) m2Var4).b) : new File((File) cVar5.e, ((j0) m2Var4).b), com.google.firebase.crashlytics.internal.model.serialization.a.a.d(b0VarA3));
    ...
    public final void c(String str, Boolean bool) {
        ...
        List listUnmodifiableList;
        long jCurrentTimeMillis = System.currentTimeMillis() / 1000;
        String strI = androidx.compose.runtime.j.i("Opening a new session with ID ", str);
        if (Log.isLoggable("FirebaseCrashlytics", 3)) {
        ...
        v vVar = this.f;
        a aVar = this.h;
        l1 l1Var = new l1(vVar.c, aVar.f, aVar.g, vVar.c().a, com.google.android.datatransport.runtime.a.j(aVar.d != null ? 4 : 1), aVar.h);
        ...
        if (!TextUtils.isEmpty(str4)) {
            f fVar2 = (f) f.y.get(str4.toLowerCase(locale));
            if (fVar2 != null) {
                fVar = fVar2;
            }
        ...
        if (bool.booleanValue() && str != null) {
            ...
            synchronized (((String) q2Var.c)) {
                ...
                a1 a1Var = (a1) q2Var.f;
                synchronized (a1Var) {
                    listUnmodifiableList = Collections.unmodifiableList(new ArrayList(a1Var.b));
                }
                ((com.google.firebase.crashlytics.internal.concurrency.d) q2Var.b).b.a(new androidx.work.impl.h(q2Var, str, mapUnmodifiableMap, listUnmodifiableList));
            }
        }
        com.google.firebase.crashlytics.internal.metadata.f fVar3 = this.i;
        ((com.google.firebase.crashlytics.internal.metadata.d) fVar3.b).b();
        fVar3.b = com.google.firebase.crashlytics.internal.metadata.f.c;
        if (str != null) {
            fVar3.b = new com.google.firebase.crashlytics.internal.metadata.m(((com.google.firebase.crashlytics.internal.persistence.c) fVar3.a).f(str, "userlog"));
        }
        this.l.a(str);
        ...
        String str8 = aVar2.a;
        if (str8 == null) {
            com.google.firebase.platforminfo.b.h("Null gmpAppId");
            return;
        }
        a0Var.b = str8;
        v vVar2 = rVar.b;
        String str9 = vVar2.c().a;
        if (str9 == null) {
            com.google.firebase.platforminfo.b.h("Null installationUuid");
            return;
        }
        a0Var.d = str9;
        a0Var.e = vVar2.c().b;
        ...
        if (str10 == null) {
            com.google.firebase.platforminfo.b.h("Null buildVersion");
            return;
        }
        a0Var.h = str10;
        String str11 = aVar2.g;
        if (str11 == null) {
            com.google.firebase.platforminfo.b.h("Null displayVersion");
            return;
        }
        a0Var.i = str11;
        a0Var.c = 4;
        ...
        i0Var.m = (byte) (b | 1);
        if (str == null) {
            com.google.firebase.platforminfo.b.h("Null identifier");
            return;
        }
        i0Var.b = str;
        String str12 = r.g;
        if (str12 == null) {
            com.google.firebase.platforminfo.b.h("Null generator");
            return;
        }
        i0Var.a = str12;
        ...
        String str14 = vVar2.c().a;
        com.google.android.material.internal.k kVar = aVar2.h;
        if (((androidx.media3.exoplayer.dash.manifest.u) kVar.z) == null) {
            kVar.z = new androidx.media3.exoplayer.dash.manifest.u(kVar);
        }
        androidx.media3.exoplayer.dash.manifest.u uVar = (androidx.media3.exoplayer.dash.manifest.u) kVar.z;
        String str15 = uVar.b;
        if (uVar == null) {
            kVar.z = new androidx.media3.exoplayer.dash.manifest.u(kVar);
        }
        i0Var.g = new com.google.firebase.crashlytics.internal.model.k0(str13, str10, str11, str14, str15, ((androidx.media3.exoplayer.dash.manifest.u) kVar.z).c);
        h1 h1Var = new h1();
        h1Var.a = 3;
        h1Var.e = (byte) (h1Var.e | 1);
        if (str2 == null) {
            com.google.firebase.platforminfo.b.h("Null version");
            return;
        }
        h1Var.b = str2;
        if (str3 == null) {
        ...
        m0Var.j = b2;
        if (str5 == null) {
            com.google.firebase.platforminfo.b.h("Null model");
            return;
        }
        m0Var.b = str5;
        ...
        if (str6 == null) {
            com.google.firebase.platforminfo.b.h("Null manufacturer");
            return;
        }
        m0Var.h = str6;
        if (str7 == 0) {
            com.google.firebase.platforminfo.b.h("Null modelClass");
            return;
        }
        m0Var.i = str7;
        i0Var.j = m0Var.a();
        ...
        try {
            ...
            com.google.firebase.crashlytics.internal.persistence.a.f(cVar2.f(str16, "report"), com.google.firebase.crashlytics.internal.model.serialization.a.a.d(b0VarA));
            File fileF = cVar2.f(str16, "start-time");
            long j = ((j0) m2Var).d;
            ...
            String strI2 = androidx.compose.runtime.j.i("Could not persist report for session ", str16);
            if (Log.isLoggable("FirebaseCrashlytics", 3)) {
    ...
    public final boolean d(k0 k0Var) throws Throwable {
        com.google.firebase.crashlytics.internal.concurrency.d.a();
        s sVar = this.n;
    ...
    public final void g() {
        try {
            ...
            if (strF != null) {
                try {
                    ((b1) this.d.e).p("com.crashlytics.version-control-info", strF);
    ...
    public final void h(com.google.android.gms.tasks.s sVar) {
        com.google.android.gms.tasks.s sVar2;
        com.google.android.gms.tasks.s sVarA;
        ...
        if (mVar.a()) {
            ...
            jVar.d(Boolean.FALSE);
            sVarA = org.jsoup.helper.n.o(Boolean.TRUE);
        } else {
            bVar.b("Automatic data collection is disabled.");
            bVar.c("Notifying that unsent reports are available.");
            jVar.d(Boolean.TRUE);
            synchronized (mVar.z) {
                sVar2 = ((com.google.android.gms.tasks.j) mVar.A).a;
            }
            com.google.android.gms.measurement.internal.b0 b0Var = new com.google.android.gms.measurement.internal.b0(22);
            sVar2.getClass();
            androidx.work.impl.utils.taskexecutor.b bVar2 = com.google.android.gms.tasks.k.a;
            com.google.android.gms.tasks.s sVar3 = new com.google.android.gms.tasks.s();
            sVar2.b.h(new com.google.android.gms.tasks.n(bVar2, b0Var, sVar3));
            sVar2.p();
            bVar.b("Waiting for send/deleteUnsentReports to be called.");
            sVarA = com.google.firebase.crashlytics.internal.concurrency.a.a(sVar3, this.p.a);
        }
        sVarA.i(this.e.a, new com.google.android.material.internal.k(7, this, sVar, false));
    }
}
