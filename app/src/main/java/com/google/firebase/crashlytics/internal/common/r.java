...
public final class r {
    ...
    static {
        ...
        f = map;
        androidx.compose.runtime.j.u(5, map, "armeabi", 6, "armeabi-v7a");
        androidx.compose.runtime.j.u(9, map, "arm64-v8a", 0, "x86");
        map.put("x86_64", 1);
        Locale locale = Locale.US;
        g = "Crashlytics Android SDK/20.0.5";
    }

    public r(Context context, v vVar, a aVar, com.google.android.material.internal.k kVar, k0 k0Var) {
        this.a = context;
        this.b = vVar;
        this.c = aVar;
        this.d = kVar;
    ...
    public static t0 c(com.google.firebase.messaging.n nVar, int i) {
        String str = (String) nVar.z;
        String str2 = (String) nVar.y;
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) nVar.A;
        int i2 = 0;
        if (stackTraceElementArr == null) {
            stackTraceElementArr = new StackTraceElement[0];
        }
        com.google.firebase.messaging.n nVar2 = (com.google.firebase.messaging.n) nVar.B;
        if (i >= 8) {
            com.google.firebase.messaging.n nVar3 = nVar2;
            while (nVar3 != null) {
                nVar3 = (com.google.firebase.messaging.n) nVar3.B;
                i2++;
            }
        }
        int i3 = i2;
