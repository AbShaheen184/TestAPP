...
public abstract class w {
    ...
    public static void a(com.google.android.gms.tasks.s sVar) throws InterruptedException, TimeoutException {
        CountDownLatch countDownLatch = new CountDownLatch(1);
        sVar.j(a, new com.google.android.datatransport.runtime.scheduling.jobscheduling.j(countDownLatch, 5));
        ...
        if (sVar.h()) {
            ...
            throw new IllegalStateException(sVar.e());
        }
    }
}
