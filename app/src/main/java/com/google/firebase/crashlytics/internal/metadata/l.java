...
public final class l implements Closeable {
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                if (!file2.renameTo(file)) {
                    kotlinx.coroutines.future.a.w("Rename failed!");
                    throw null;
                }
            } catch (Throwable th) {
                randomAccessFile.close();
    ...
    public final i A(int i) throws IOException {
        if (i == 0) {
            return i.c;
        }
        ...
        synchronized (this) {
            if (length >= 0) {
                if (length <= bArr.length) {
                    ...
                    Y(this.C, iA0, 4);
                    Y(bArr, iA0 + 4, length);
                    b0(this.y, this.z + 1, zX ? iA0 : this.A.a, iA0);
                    this.B = iVar2;
                    this.z++;
                    if (zX) {
                        this.A = iVar2;
    ...
    public final void g(int i) throws IOException {
        ...
        if (iA0 < this.A.a) {
            ...
            if (channel.transferTo(16L, j, channel) != j) {
                kotlinx.coroutines.future.a.o("Copied insufficient number of bytes!");
                return;
            }
        }
        int i4 = this.B.a;
    ...
    public final synchronized void n(k kVar) {
        ...
        for (int i = 0; i < this.z; i++) {
            i iVarA = A(iA0);
            kVar.a(new j(this, iVarA), iVarA.b);
            iA0 = a0(iVarA.a + 4 + iVarA.b);
        }
    }
