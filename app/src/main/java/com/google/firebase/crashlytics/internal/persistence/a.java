...
public final class a {
    ...
    public a(c cVar, k0 k0Var, j jVar) {
        this.b = cVar;
        this.c = k0Var;
        this.d = jVar;
    }
    ...
    public final void d(j2 j2Var, String str, boolean z) {
        ...
        g.getClass();
        try {
            f(cVar.f(str, androidx.privacysandbox.ads.adservices.java.internal.a.r(Hopmn.EVENT, String.format(Locale.US, "%010d", Integer.valueOf(this.a.getAndIncrement())), z ? "_" : "")), com.google.firebase.crashlytics.internal.model.serialization.a.a.d(j2Var));
