        ...
        switch (i) {
            ...
            default:
                synchronized (dVar) {
                    ...
                    String strA = ((com.google.firebase.platforminfo.c) dVar.c.get()).a();
                    synchronized (hVar2) {
                        String strB = hVar2.b(jCurrentTimeMillis);
                        strA.getClass();
                        hVar2.a.a(new i0(hVar2, strB, strA, new androidx.datastore.preferences.core.d(strA), 15));
                    }
                }
                return null;
        }
