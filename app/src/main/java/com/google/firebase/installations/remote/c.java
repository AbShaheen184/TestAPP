...
public final class c {
    ...
    public static void b(HttpURLConnection httpURLConnection, String str, String str2, String str3) {
        ...
        Log.w("Firebase-Installations", j.k("Firebase options used while communicating with Firebase server APIs: ", str2, ", ", str3, TextUtils.isEmpty(str) ? "" : j.i(", ", str)));
    }
    ...
    public static void i(HttpURLConnection httpURLConnection, byte[] bArr) throws IOException {
        ...
        if (outputStream == null) {
            kotlinx.coroutines.future.a.w("Cannot send request to FIS servers. No OutputStream available.");
            return;
        }
    ...
    public final HttpURLConnection c(URL url, String str) {
        ...
        try {
            ...
            if (fVar != null) {
                try {
                    httpURLConnection.addRequestProperty("x-firebase-client", (String) n.f(((d) fVar).a()));
