...
public class FirebaseMessagingService extends Service {
    ...
    public final void b(Intent intent) {
        String stringExtra;
        Bundle extras;
        com.google.android.material.behavior.d dVar;
        ...
        public final synchronized IBinder onBind(Intent intent) {
            try {
                ...
                if (this.y == null) {
                    this.y = new v(new com.google.android.gms.tasks.q(this));
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        public final int onStartCommand(Intent intent, int i, int i2) {
            ...
            Intent intent2 = (Intent) ((ArrayDeque) n.x().B).poll();
            if (intent2 == null) {
                a(intent);
                return 2;
            }
            com.google.android.gms.tasks.j jVar = new com.google.android.gms.tasks.j();
            this.e.execute(new androidx.compose.foundation.text.contextmenu.internal.g(9, this, intent2, jVar));
            com.google.android.gms.tasks.s sVar = jVar.a;
            if (sVar.g()) {
                a(intent);
                return 2;
            }
            sVar.a(new androidx.arch.core.executor.a(2), new androidx.media3.exoplayer.analytics.c(10, this, intent));
            return 3;
        }
