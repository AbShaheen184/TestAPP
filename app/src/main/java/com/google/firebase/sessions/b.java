...
public final class b {
    ...
    public final int hashCode() {
        return this.b.hashCode() + ((a0.LOG_ENVIRONMENT_PROD.hashCode() + androidx.privacysandbox.ads.adservices.java.internal.a.g((((Build.MODEL.hashCode() + (this.a.hashCode() * 31)) * 31) + 48517564) * 31, 31, Build.VERSION.RELEASE)) * 31);
    }
