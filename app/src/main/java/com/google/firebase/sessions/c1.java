    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.e) {
            ...
            default:
                ...
                if (z) {
                    mapB = f0Var.b(kotlin.collections.x.e);
                } else if (zD) {
                    mapB = f0Var.b(mapB);
                }
                ...
                t0 t0Var = e1Var.c;
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(t0Var.e), null, null, new com.app.mlounge.ui.c0(t0Var, p0VarA, null), 3, null);
                f0Var.f = true;
