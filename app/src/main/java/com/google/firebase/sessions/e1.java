...
public final class e1 {
    ...
    public e1(com.google.firebase.sessions.settings.j jVar, v0 v0Var, t0 t0Var, j1 j1Var, androidx.datastore.core.e eVar, f0 f0Var, kotlin.coroutines.j jVar2) {
        jVar.getClass();
        v0Var.getClass();
        t0Var.getClass();
        j1Var.getClass();
        ...
        this.g = jVar2;
        this.k = "";
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(jVar2), null, null, new a1(this, null, 0), 3, null);
    }
    ...
    public final void c() {
        ...
        if (e(k0Var) || d(k0Var)) {
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.g), null, null, new com.app.mlounge.ui.viewmodel.g0(this, k0Var, dVar, 15), 3, null);
        }
    }
    ...
    public final boolean e(k0 k0Var) {
        ...
        long jI = dagger.hilt.android.internal.a.i(i1VarA.a - i1Var.a, kotlin.time.c.MILLISECONDS);
        com.google.firebase.sessions.settings.j jVar = this.a;
        kotlin.time.a aVarB2 = jVar.a.b();
        if (aVarB2 != null) {
            jH = aVarB2.e;
            if (jH <= 0 || kotlin.time.a.h(jH)) {
                aVarB = jVar.b.b();
                if (aVarB != null) {
                    jH = aVarB.e;
                    if (jH > 0 || kotlin.time.a.h(jH)) {
                        jH = dagger.hilt.android.internal.a.h(30, kotlin.time.c.MINUTES);
                    }
                } else {
                    jH = dagger.hilt.android.internal.a.h(30, kotlin.time.c.MINUTES);
                }
        ...
        boolean z = kotlin.time.a.e(jI, jH) > 0;
        if (z) {
