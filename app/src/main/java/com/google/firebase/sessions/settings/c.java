...
public final class c implements o {
    ...
    static {
        ...
        g = (int) kotlin.time.a.j(dagger.hilt.android.internal.a.h(24, kotlin.time.c.HOURS), kotlin.time.c.SECONDS);
    ...
    public final kotlin.time.a b() {
        ...
        kotlin.time.g gVar = kotlin.time.a.y;
        return new kotlin.time.a(dagger.hilt.android.internal.a.h(num.intValue(), kotlin.time.c.SECONDS));
    }
        ...
        try {
            ...
            if (r4 == 1) {
                ...
                if (r4 == 2) {
                    ...
                    cVar.c.getClass();
                    Map mapK = c0.k(kVar, kVar2, kVar3, kVar4, new kotlin.k("X-Crashlytics-API-Client-Version", "3.0.5"));
                    Log.d("FirebaseSessions", "Fetching settings from server.");
                    d dVar3 = cVar.d;
                    g0 g0Var = new g0(cVar, dVar2, 16);
                    v1 v1Var = new v1(i2, 11, dVar2);
                    bVar.e = mutex2;
                    bVar.y = null;
                    bVar.B = 3;
                    objWithContext = BuildersKt.withContext(dVar3.b, new androidx.compose.animation.core.f(dVar3, mapK, g0Var, v1Var, (kotlin.coroutines.d) null), bVar);
            ...
            if (objA != obj2) {
                ...
                cVar.c.getClass();
                Map mapK2 = c0.k(kVar5, kVar6, kVar7, kVar8, new kotlin.k("X-Crashlytics-API-Client-Version", "3.0.5"));
                Log.d("FirebaseSessions", "Fetching settings from server.");
                d dVar5 = cVar.d;
                g0 g0Var2 = new g0(cVar, dVar2, 16);
                v1 v1Var2 = new v1(i2, 11, dVar2);
                bVar.e = mutex2;
                bVar.y = null;
                bVar.B = 3;
                objWithContext = BuildersKt.withContext(dVar5.b, new androidx.compose.animation.core.f(dVar5, mapK2, g0Var2, v1Var2, (kotlin.coroutines.d) null), bVar);
                if (objWithContext != obj2) {
                    objWithContext = obj;
                }
                if (objWithContext != obj2) {
