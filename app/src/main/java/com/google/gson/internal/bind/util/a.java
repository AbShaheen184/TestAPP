    ...
    public static Date b(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            if (str == null) {
                ...
                strM = androidx.privacysandbox.ads.adservices.java.internal.a.m('\"', "\"", str);
            }
            message = e.getMessage();
            if (message != null || message.isEmpty()) {
                message = "(" + e.getClass().getName() + ")";
            }
            ParseException parseException = new ParseException(b0.e("Failed to parse date [", strM, "]: ", message), parsePosition.getIndex());
            ...
            ParseException parseException2 = new ParseException(b0.e("Failed to parse date [", strM, "]: ", message), parsePosition.getIndex());
