...
public class a<T> {
    ...
    public a() {
        ...
        if (genericSuperclass instanceof ParameterizedType) {
            ...
            kotlinx.coroutines.future.a.u("TypeToken must be created with a type argument: new TypeToken<...>() {}; When using code shrinkers (ProGuard, R8, ...) make sure that generic signatures are preserved.\nSee ".concat("https://github.com/google/gson/blob/main/Troubleshooting.md#".concat("type-token-raw")));
            throw null;
        }
        kotlinx.coroutines.future.a.u("Must only create direct subclasses of TypeToken");
        throw null;
    }
    ...
    public static void c(Type type) {
        ...
        if (!(type instanceof WildcardType)) {
            ...
            kotlinx.coroutines.future.a.q("TypeToken captured `null` as type argument; probably a compiler / runtime bug");
            return;
        }
