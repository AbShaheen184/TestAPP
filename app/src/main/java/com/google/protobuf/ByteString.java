...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    private static ByteString balancedConcat(Iterator<ByteString> it, int i) {
        if (i < 1) {
            ...
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.q("length (", i, ") must be >= 1"));
            return null;
        }
        if (i == 1) {
            return it.next();
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? com.google.firebase.crashlytics.internal.model.t1.s(toByteArray()) : com.google.firebase.crashlytics.internal.model.t1.s(substringNoCopy(0, 47).toByteArray()).concat("...");
    }
    ...
    public static ByteString wrap(ByteBuffer byteBuffer, boolean z) throws x0 {
        ...
        if (z) {
            ...
            if (byteBuffer.hasArray()) {
                ...
                zY = aVar.x(byteBuffer.array(), iPosition + iArrayOffset, iArrayOffset + iRemaining);
            } else if (byteBuffer.isDirect()) {
                zY = aVar.z(byteBuffer, iPosition, iRemaining);
            } else {
                aVar.getClass();
                zY = kotlin.math.a.y(byteBuffer, iPosition, iRemaining);
            }
            if (!zY) {
                throw x0.b();
            }
    ...
    public static ByteString copyFrom(byte[] bArr, int i, int i2, boolean z) throws x0 {
        ...
        if (z && !o2.a.x(bArrA, 0, bArrA.length)) {
            throw x0.b();
        }
        return new p(bArrA);
    }
    ...
    public static ByteString wrap(byte[] bArr, boolean z) throws x0 {
        ...
        if (z && !o2.a.x(bArr, 0, bArr.length)) {
            throw x0.b();
        }
        return new p(bArr);
    }
