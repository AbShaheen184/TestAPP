...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends h0> extends b {
    ...
    public static Object invokeOrDie(Method method, Object obj, Object... objArr) {
        try {
            ...
            androidx.media3.exoplayer.source.t0.j("Couldn't use Java reflection to implement protocol message reflection.", e);
            return null;
            ...
            androidx.media3.exoplayer.source.t0.j("Unexpected exception thrown by generated accessor method.", cause);
            return null;
        }
    }
    ...
    public int getSerializedSize(a2 a2Var) {
        if (isMutable()) {
            ...
            kotlinx.coroutines.future.a.u(androidx.privacysandbox.ads.adservices.java.internal.a.n(iComputeSerializedSize, "serialized size must be non-negative, was "));
            return 0;
        }
    ...
    public final void mergeLengthDelimitedField(int i, ByteString byteString) {
        ...
        if (i != 0) {
            ...
            kotlinx.coroutines.future.a.q("Zero is not a valid field number.");
        }
    }
    ...
    public void setMemoizedSerializedSize(int i) {
        if (i < 0) {
            kotlinx.coroutines.future.a.u(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "serialized size must be non-negative, was "));
        } else {
