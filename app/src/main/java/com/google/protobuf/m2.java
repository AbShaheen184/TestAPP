...
public final class m2 extends kotlin.math.a {
    ...
    public final String l(byte[] bArr, int i, int i2) throws x0 {
        int i3;
        byte b;
        int i4;
        byte b2;
                        ...
                        while (i < i5) {
                            ...
                            if (b < 0) {
                                ...
                                if (b >= -16) {
                                    ...
                                    int i9 = i6 + 1;
                                    if (!com.imsdk.a.u(b4)) {
                                        if ((((b4 + 112) + (b << 28)) >> 30) != 0 && !com.imsdk.a.u(b7) && !com.imsdk.a.u(b8)) {
                                ...
                                byte b9 = bArr[i11];
                                int i12 = i6 + 1;
                                if (!com.imsdk.a.u(b3) || ((b == -32 && b3 < -96) || ((b == -19 && b3 >= -96) || com.imsdk.a.u(b9)))) {
                                    throw x0.b();
                                }
    ...
    @Override // kotlin.math.a
    public final int m(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        char cCharAt;
        switch (this.L) {
                    ...
                    if (cCharAt2 < 128 && i7 < i5) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i7 > i5 - 3) {
                            if (i7 > i5 - 4) {
                                ...
                                return kotlin.math.a.n(str, bArr, i, i2);
                            }
                            i6++;
                            if (i6 != str.length()) {
    ...
    @Override // kotlin.math.a
    public final boolean x(byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        long j;
        long j2;
        ...
        switch (this.L) {
            case 1:
                if (!byteBuffer.isDirect()) {
                    kotlinx.coroutines.future.a.q("ByteBuffer must be direct");
                    return false;
                }
                ...
                break;
            default:
                return super.z(byteBuffer, i, i2);
        }
    }
}
