...
public final class s extends t {
    ...
    public final boolean P(int i) throws IOException {
        ...
        int i4 = this.f;
        if (i3 <= i4) {
            kotlinx.coroutines.future.a.u(androidx.privacysandbox.ads.adservices.java.internal.a.q("refillBuffer() called when ", i, " bytes were already available in buffer"));
            return false;
        }
        int i5 = this.j;
