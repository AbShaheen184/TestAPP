    ...
    public final a2 a(Class cls) {
        ...
        if (!GeneratedMessageLite.class.isAssignableFrom(cls)) {
            ...
            if (cls4 != null && !cls4.isAssignableFrom(cls)) {
                kotlinx.coroutines.future.a.q("Message classes must extend GeneratedMessage or GeneratedMessageLite");
                return null;
            }
        }
        ...
        if ((i & 2) == 2) {
            ...
            if (GeneratedMessageLite.class.isAssignableFrom(cls)) {
                ...
                b0 b0Var2 = c0.b;
                if (b0Var2 == null) {
                    kotlinx.coroutines.future.a.u("Protobuf runtime is not correctly loaded.");
                    return null;
                }
