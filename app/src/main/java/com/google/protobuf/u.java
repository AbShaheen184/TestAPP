...
public final class u extends w {
    ...
    public u(byte[] bArr, int i) {
        if (((bArr.length - i) | i) < 0) {
            ...
            kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.g("Array range is invalid. Buffer.length=", bArr.length, ", offset=0, length=", i));
            throw null;
        }
        this.c = bArr;
        this.e = 0;
    ...
    public final void u(String str) throws androidx.datastore.preferences.protobuf.i {
        ...
        try {
            ...
            if (iF2 != iF) {
                x(o2.a(str));
                int i2 = this.e;
                this.e = o2.a.m(str, bArr, i2, bArr.length - i2);
                return;
            }
            int i3 = i + iF2;
            this.e = i3;
            int iM = o2.a.m(str, bArr, i3, bArr.length - i3);
            this.e = i;
            x((iM - i) - iF2);
            this.e = iM;
        } catch (IndexOutOfBoundsException e) {
