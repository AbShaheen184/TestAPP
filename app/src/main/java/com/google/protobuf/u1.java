...
public final class u1 extends c implements RandomAccess {
    ...
    public final void add(int i, Object obj) {
        ...
        b();
        if (i < 0 || i > (i2 = this.z)) {
            com.google.firebase.platforminfo.b.i(androidx.privacysandbox.ads.adservices.java.internal.a.v("Index:", i, ", Size:"), this.z);
            return;
        }
        ...
        if (i2 < objArr.length) {
            ...
            Object[] objArr2 = new Object[com.google.android.datatransport.runtime.a.n(objArr.length, 3, 2, 1, 10)];
    ...
    public final boolean add(Object obj) {
        ...
        Object[] objArr = this.y;
        if (i == objArr.length) {
            this.y = Arrays.copyOf(this.y, com.google.android.datatransport.runtime.a.n(objArr.length, 3, 2, 1, 10));
        }
