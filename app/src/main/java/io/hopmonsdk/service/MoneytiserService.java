...
public class MoneytiserService extends Service {
    ...
    public class AnonymousClass1 implements SeedDiscovery.StringCallback {
        ...
        public void onSuccess(String str) {
            ...
            this.val$acp.getDataStore().set("hopmon.registered_version", "15.0.16");
    ...
    public void registerWithSeedMode(String str, int i) {
        try {
            ...
            String str2 = "/?domain=" + hopmn.getDomain() + "&uid=" + str + "&pub=" + publisher + "&foreground=" + String.valueOf(hopmn.isForegroundRunning()) + "&ver=15.0.16&regcc=1&cid=" + category;
            LogUtils.d(TAG, "Seed-mode registration attempt %d/%d, path: %s", Integer.valueOf(i + 1), 6, str2);
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        try {
            ...
            boolean z = j > j2;
            boolean zEquals = "15.0.16".equals(str4);
            boolean z2 = !zEquals;
    ...
    public void onTimeout(int i, int i2) {
        LogUtils.w(TAG, "FGS onTimeout(startId=%d, type=%d) — stopping to comply with Android 15 dataSync limit", Integer.valueOf(i), Integer.valueOf(i2));
        stopSelfSafely();
    }

    @Override // android.app.Service
    public void onTimeout(int i) {
        LogUtils.w(TAG, "FGS onTimeout(startId=%d) — stopping to comply with platform limit", Integer.valueOf(i));
        stopSelfSafely();
    }
}
