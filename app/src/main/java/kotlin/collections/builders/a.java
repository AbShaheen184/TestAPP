...
public final class a extends kotlin.collections.g implements RandomAccess, Serializable {
    public final a A;
    public final b B;
    public Object[] e;
    public final int y;
    ...
    public final List subList(int i, int i2) {
        kotlin.collections.c.b(i, i2, this.z);
    ...
    public final String toString() {
        h();
        return c.C(this.e, this.y, this.z, this);
    }
