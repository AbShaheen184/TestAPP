...
public final class f implements Map, Serializable, kotlin.jvm.internal.markers.d {
    ...
    public int F;
    public g G;
    public androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.h H;
    public g I;
    public boolean J;
    public Object[] e;
    public Object[] y;
    ...
    public final int hashCode() {
        ...
        while (dVar.hasNext()) {
            ...
            dVar.e = i2 + 1;
            dVar.y = i2;
            Object obj = fVar.e[i2];
            int iHashCode = obj != null ? obj.hashCode() : 0;
            Object[] objArr = fVar.y;
            objArr.getClass();
            Object obj2 = objArr[dVar.y];
    ...
    public final void j(int i) {
        ...
        while (i2 < this.C) {
            ...
            while (true) {
                ...
                i5--;
                if (i5 < 0) {
                    kotlinx.coroutines.future.a.u("This cannot happen with fixed magic multiplier and grow-only hash array. Have object hashCodes changed?");
                    return;
                }
    ...
    public final Collection values() {
        androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.h hVar = this.H;
        if (hVar != null) {
            return hVar;
        }
        androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.h hVar2 = new androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.h(this, 1);
        this.H = hVar2;
        return hVar2;
    }
