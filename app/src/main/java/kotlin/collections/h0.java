...
public final class h0 extends kotlin.coroutines.jvm.internal.h implements kotlin.jvm.functions.p {
    public int A;
    public int B;
    ...
    public h0(int i, int i2, Iterator it, kotlin.coroutines.d dVar) {
        super(2, dVar);
        this.D = i;
        this.E = i2;
        this.F = it;
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((h0) create((kotlin.sequences.j) obj, (kotlin.coroutines.d) obj2)).invokeSuspend(kotlin.y.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i9 == 0) {
            ...
            if (i >= 0) {
                ...
                f0 f0Var3 = new f0(new Object[i12], 0);
                i2 = i12;
                i3 = i;
                it = it3;
                f0Var = f0Var3;
                while (true) {
                    ...
                    z = z2;
                    if (f0Var.b() != i6) {
                        kotlinx.coroutines.future.a.u("ring buffer is full");
                        return null;
                    }
                    int i13 = f0Var.z;
                    int i14 = f0Var.A;
                    ...
                    if (f0Var.b() != i6) {
                        if (f0Var.A < i11) {
                            ArrayList arrayList2 = new ArrayList(f0Var);
                            this.C = jVar;
                            this.e = f0Var;
                            this.y = it;
                            this.z = i2;
                        ...
                        if (f0Var.z == 0) {
                            ...
                            array = f0Var.toArray(new Object[i8]);
                        }
                        f0Var = new f0(array, f0Var.A);
                    }
                    z2 = z;
                }
                if (f0Var2.A > i10) {
                    ArrayList arrayList3 = new ArrayList(f0Var2);
                    this.C = jVar;
                    this.e = f0Var2;
                    this.y = null;
                    this.z = i7;
            ...
            if (i9 != 2) {
                if (i9 == 3) {
                    ...
                    while (true) {
                        ...
                        if (f0Var.b() != i6) {
                            if (f0Var.A < i11) {
                                ArrayList arrayList4 = new ArrayList(f0Var);
                                this.C = jVar;
                                this.e = f0Var;
                                this.y = it;
                                this.z = i2;
                ...
                if (f0Var2.A > i10) {
                    ArrayList arrayList5 = new ArrayList(f0Var2);
                    this.C = jVar;
                    this.e = f0Var2;
                    this.y = null;
                    this.z = i7;
