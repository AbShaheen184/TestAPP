...
public abstract class a implements kotlin.coroutines.d, d, Serializable {
    ...
    public StackTraceElement getStackTraceElement() {
        ...
        if (jVar == null) {
            try {
                j jVar3 = new j(21, Class.class.getDeclaredMethod("getModule", null), getClass().getClassLoader().loadClass("java.lang.Module").getDeclaredMethod("getDescriptor", null), getClass().getClassLoader().loadClass("java.lang.module.ModuleDescriptor").getDeclaredMethod("name", null));
                f.b = jVar3;
                jVar = jVar3;
        ...
        if (jVar != jVar2 && (method = (Method) jVar.y) != null && (objInvoke = method.invoke(getClass(), null)) != null && (method2 = (Method) jVar.z) != null && (objInvoke2 = method2.invoke(objInvoke, null)) != null) {
            Method method3 = (Method) jVar.A;
