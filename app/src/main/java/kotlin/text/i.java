...
public final class i implements Serializable {
    ...
    public static kotlin.io.h b(i iVar, String str) {
        ...
        str.getClass();
        if (str.length() >= 0) {
            return new kotlin.io.h(2, new com.app.mlounge.ui.screens.adult.b(20, iVar, str), h.e);
        }
        com.google.firebase.platforminfo.b.i(androidx.privacysandbox.ads.adservices.java.internal.a.v("Start index out of bounds: ", 0, ", input length: "), str.length());
        return null;
    }
    ...
    public final g a(CharSequence charSequence) {
        ...
        matcher.getClass();
        return kotlin.coroutines.g.a(matcher, 0, charSequence);
    }
