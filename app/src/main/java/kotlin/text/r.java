...
public abstract class r extends q {
    ...
    public static final void p(String str) {
        throw new NumberFormatException(androidx.privacysandbox.ads.adservices.java.internal.a.m('\'', "Invalid number format: '", str));
    }
    ...
    public static String s(String str, String str2, String str3, boolean z) {
        ...
        do {
            sb.append((CharSequence) str, i, iE);
            sb.append(str3);
            i = iE + length;
            if (iE >= str.length()) {
                break;
            }
            iE = k.E(str, str2, iE + i2, z);
        } while (iE > 0);
