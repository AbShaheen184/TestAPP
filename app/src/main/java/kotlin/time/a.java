...
public final class a implements Comparable {
    ...
    public static final long z = dagger.hilt.android.internal.a.b(4611686018427387903L);
    public static final long A = dagger.hilt.android.internal.a.b(-4611686018427387903L);
    public static final long B = 9223372036854759646L;

    public static final long a(long j, long j2) {
        long j3 = 1000000;
        long j4 = j2 / j3;
        long jA = dagger.hilt.android.internal.a.a(j, j4);
        if (-4611686018426L > jA || jA >= 4611686018427L) {
            return dagger.hilt.android.internal.a.b(jA);
        }
    ...
    public static final void d(StringBuilder sb, int i, int i2, int i3, String str, boolean z2) {
        ...
        if (i2 != 0) {
            sb.append('.');
            String strN = k.N(i3, String.valueOf(i2));
            int i4 = -1;
            int length = strN.length() - 1;
            if (length >= 0) {
                while (true) {
                    int i5 = length - 1;
                    if (strN.charAt(length) != '0') {
                        i4 = length;
                        break;
                    } else if (i5 < 0) {
                        break;
            ...
            int i6 = i4 + 1;
            if (z2 || i6 >= 3) {
                sb.append((CharSequence) strN, 0, ((i4 + 3) / 3) * 3);
            } else {
                sb.append((CharSequence) strN, 0, i6);
            }
        }
        sb.append(str);
    }
    ...
    public static final long i(long j, long j2) {
        ...
        if (i == 0) {
            ...
            if (-4611686018426999999L > j3 || j3 >= 4611686018427000000L) {
                return dagger.hilt.android.internal.a.b(j3 / ((long) 1000000));
            }
            long j4 = j3 << 1;
            int i2 = b.a;
            return j4;
        }
        long jA = dagger.hilt.android.internal.a.a(j >> 1, j2 >> 1);
        if (jA == 9223372036854759646L) {
            kotlinx.coroutines.future.a.q("Summing infinite durations of different signs yields an undefined result.");
            return 0L;
        }
        ...
        if (-4611686018426L > jA || jA >= 4611686018427L) {
            return dagger.hilt.android.internal.a.b(i0.e(jA, -4611686018427387903L, 4611686018427387903L));
        }
