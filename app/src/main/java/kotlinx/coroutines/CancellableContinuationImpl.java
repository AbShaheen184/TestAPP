...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, d, Waiter {
    ...
    private final void callSegmentOnCancellation(Segment<?> segment, Throwable th) {
        ...
        if (i == 536870911) {
            kotlinx.coroutines.future.a.u("The index for Segment.onCancellation(..) is broken");
            return;
        }
        try {
    ...
    public static final y resume$lambda$13$lambda$12(l lVar, Throwable th, Object obj, j jVar) {
        lVar.invoke(th);
        return y.a;
    }
    ...
    public static /* synthetic */ void resumeImpl$kotlinx_coroutines_core$default(CancellableContinuationImpl cancellableContinuationImpl, Object obj, int i, q qVar, int i2, Object obj2) {
        if (obj2 != null) {
            b.n("Super calls with default arguments not supported in this target, function: resumeImpl");
            return;
        }
        if ((i2 & 4) != 0) {
            qVar = null;
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object obj, Throwable th) {
        ...
        while (true) {
            Object obj2 = atomicReferenceFieldUpdater.get(this);
            if (obj2 instanceof NotCompleted) {
                kotlinx.coroutines.future.a.u("Not completed");
                return;
            }
            if (obj2 instanceof CompletedExceptionally) {
                return;
            ...
            CompletedContinuation completedContinuation2 = (CompletedContinuation) obj2;
            if (completedContinuation2.getCancelled()) {
                kotlinx.coroutines.future.a.u("Must be called at most once");
                return;
            }
            Throwable th3 = th;
    ...
    public void invokeOnCancellation(Segment<?> segment, int i) {
        ...
        do {
            ...
            if ((i2 & 536870911) != 536870911) {
                kotlinx.coroutines.future.a.u("invokeOnCancellation should be called at most once");
                return;
            }
    ...
    public void resume(T t, l lVar) {
        resumeImpl$kotlinx_coroutines_core(t, this.resumeMode, lVar != null ? new androidx.compose.foundation.gestures.y(lVar, 13) : null);
    }
