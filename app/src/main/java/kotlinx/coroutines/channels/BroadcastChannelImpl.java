...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public BroadcastChannelImpl(int i) {
        ...
        this.capacity = i;
        if (i < 1 && i != -1) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.q("BroadcastChannel capacity must be positive or Channel.CONFLATED, but ", i, " was specified"));
            throw null;
        }
        this.lock = new ReentrantLock();
        this.subscribers = w.e;
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            this.subscribers = kotlin.collections.p.N(this.subscribers, subscriberConflated);
            return subscriberConflated;
        } finally {
            reentrantLock.unlock();
        }
    ...
    public String toString() {
        ...
        sb.append(kotlin.collections.p.I(this.subscribers, ";", "<", ">", null, 56));
        return sb.toString();
    }
