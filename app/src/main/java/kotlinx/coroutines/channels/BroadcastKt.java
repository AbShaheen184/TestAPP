...
public final class BroadcastKt {
    ...
    public static /* synthetic */ BroadcastChannel broadcast$default(CoroutineScope coroutineScope, j jVar, int i, CoroutineStart coroutineStart, l lVar, p pVar, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            jVar = k.e;
        }
        if ((i2 & 2) != 0) {
        ...
        return broadcast(coroutineScope, jVar, i, coroutineStart2, lVar, pVar);
    }
    ...
    @ObsoleteCoroutinesApi
    @kotlin.c
    public static final <E> BroadcastChannel<E> broadcast(CoroutineScope coroutineScope, j jVar, int i, CoroutineStart coroutineStart, l lVar, p pVar) {
        ...
        if (coroutineStart.isLazy()) {
            broadcastCoroutine = new LazyBroadcastCoroutine(jVarNewCoroutineContext, BroadcastChannel, pVar);
        } else {
            broadcastCoroutine = new BroadcastCoroutine(jVarNewCoroutineContext, BroadcastChannel, true);
        }
        if (lVar != null) {
