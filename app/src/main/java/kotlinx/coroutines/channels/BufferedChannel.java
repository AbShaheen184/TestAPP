...
import com.app.mlounge.ui.components.e0;
...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public /* synthetic */ class AnonymousClass1 extends j implements q {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
            m37invoke5_sEAP8((Throwable) obj, ((ChannelResult) obj2).m54unboximpl(), (kotlin.coroutines.j) obj3);
            return y.a;
        }

        /* JADX INFO: renamed from: invoke-5_sEAP8, reason: not valid java name */
        public final void m37invoke5_sEAP8(Throwable th, Object obj, kotlin.coroutines.j jVar) {
            ((BufferedChannel) this.receiver).m31onCancellationChannelResultImplDoNotCall5_sEAP8(th, obj, jVar);
        }
    }
    ...
    public BufferedChannel(int i, l lVar) {
        ...
        if (i < 0) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.q("Invalid channel capacity: ", i, ", should be >=0"));
            throw null;
        }
    ...
    public final q bindCancellationFun(l lVar, E e) {
        return new i(11, lVar, e);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final y bindCancellationFun$lambda$89(l lVar, Object obj, Throwable th, Object obj2, kotlin.coroutines.j jVar) {
        OnUndeliveredElementKt.callUndeliveredElement(lVar, obj, jVar);
        return y.a;
    }
    ...
    public static /* synthetic */ void incCompletedExpandBufferAttempts$default(BufferedChannel bufferedChannel, long j, int i, Object obj) {
        if (obj != null) {
            com.google.firebase.platforminfo.b.n("Super calls with default arguments not supported in this target, function: incCompletedExpandBufferAttempts");
            return;
        }
        if ((i & 1) != 0) {
            j = 1;
    ...
    private final boolean isClosed(long j, boolean z) {
        ...
        kotlinx.coroutines.future.a.c(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "unexpected close status: "));
        return false;
    }
    ...
    public final void m31onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable th, Object obj, kotlin.coroutines.j jVar) {
        ...
        OnUndeliveredElementKt.callUndeliveredElement(lVar, objM47getOrNullimpl, jVar);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onCancellationImplDoNotCall(Throwable th, E e, kotlin.coroutines.j jVar) {
        l lVar = this.onUndeliveredElement;
        lVar.getClass();
        OnUndeliveredElementKt.callUndeliveredElement(lVar, e, jVar);
    }
    ...
    public static final q onUndeliveredElementReceiveCancellationConstructor$lambda$57$lambda$56(BufferedChannel bufferedChannel, SelectInstance selectInstance, Object obj, Object obj2) {
        return new e0(9, obj2, bufferedChannel, selectInstance);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final y onUndeliveredElementReceiveCancellationConstructor$lambda$57$lambda$56$lambda$55(Object obj, BufferedChannel bufferedChannel, SelectInstance selectInstance, Throwable th, Object obj2, kotlin.coroutines.j jVar) {
    ...
    public static /* synthetic */ <E> Object receive$suspendImpl(BufferedChannel<E> bufferedChannel, kotlin.coroutines.d<? super E> dVar) throws Throwable {
        ...
        while (!bufferedChannel.isClosedForReceive()) {
            ...
            if (objUpdateCellReceive == BufferedChannelKt.SUSPEND) {
                kotlinx.coroutines.future.a.u("unexpected");
                return null;
            }
    ...
    public final Object m33receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, kotlin.coroutines.d<? super ChannelResult<? extends E>> dVar) throws Throwable {
        ...
        if (i3 == 0) {
            ...
            CancellableContinuationImpl orCreateCancellableContinuation = CancellableContinuationKt.getOrCreateCancellableContinuation(h.f(bufferedChannel$receiveCatchingOnNoWaiterSuspend$1));
            try {
    ...
    public static /* synthetic */ Object receiveImpl$default(BufferedChannel bufferedChannel, Object obj, l lVar, q qVar, kotlin.jvm.functions.a aVar, q qVar2, int i, Object obj2) {
        ChannelSegment channelSegment;
        if (obj2 != null) {
            com.google.firebase.platforminfo.b.n("Super calls with default arguments not supported in this target, function: receiveImpl");
            return null;
        }
        if ((i & 16) != 0) {
    ...
    public final Object receiveOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, long j, kotlin.coroutines.d<? super E> dVar) {
        ChannelSegment channelSegment2;
        CancellableContinuationImpl orCreateCancellableContinuation = CancellableContinuationKt.getOrCreateCancellableContinuation(h.f(dVar));
        try {
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        ...
        if (waiter instanceof BufferedChannelIterator) {
            ...
            com.google.firebase.platforminfo.b.q(waiter, "Unexpected waiter: ");
        }
    }
    ...
    public static <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, kotlin.coroutines.d<? super Boolean> dVar) {
        ...
        if (bufferedChannel.onUndeliveredElement != null) {
            kotlinx.coroutines.future.a.u("the `onUndeliveredElement` feature is unsupported for `sendBroadcast(e)`");
            return null;
        }
    ...
    public static /* synthetic */ Object sendImpl$default(BufferedChannel bufferedChannel, Object obj, Object obj2, kotlin.jvm.functions.a aVar, p pVar, kotlin.jvm.functions.a aVar2, r rVar, int i, Object obj3) {
        if (obj3 != null) {
            com.google.firebase.platforminfo.b.n("Super calls with default arguments not supported in this target, function: sendImpl");
            return null;
        }
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (!(obj instanceof CancellableContinuation)) {
            com.google.firebase.platforminfo.b.q(obj, "Unexpected receiver type: ");
            return false;
        }
    ...
    private final boolean tryResumeSender(Object obj, ChannelSegment<E> channelSegment, int i) {
        ...
        com.google.firebase.platforminfo.b.q(obj, "Unexpected waiter: ");
        return false;
    }
            ...
            if (state$kotlinx_coroutines_core instanceof Waiter) {
                ...
                if (state$kotlinx_coroutines_core == null) {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.RESUMING_BY_RCV) {
                        com.google.firebase.platforminfo.b.q(state$kotlinx_coroutines_core, "Unexpected cell state: ");
                        return false;
                    }
                }
            }
    ...
    public final void checkSegmentStructureInvariants() {
        if (isRendezvousOrUnlimited()) {
            if (bufferEndSegment$volatile$FU.get(this) != BufferedChannelKt.NULL_SEGMENT) {
                kotlinx.coroutines.future.a.e(this, "bufferEndSegment must be NULL_SEGMENT for rendezvous and unlimited channels; they do not manipulate it.\nChannel state: ");
                return;
            }
        } else if (((ChannelSegment) receiveSegment$volatile$FU.get(this)).id > ((ChannelSegment) bufferEndSegment$volatile$FU.get(this)).id) {
            kotlinx.coroutines.future.a.e(this, "bufferEndSegment should not have lower id than receiveSegment.\nChannel state: ");
            return;
        }
        List listK = kotlin.collections.q.k(receiveSegment$volatile$FU.get(this), sendSegment$volatile$FU.get(this), bufferEndSegment$volatile$FU.get(this));
        ...
        if (channelSegment.getPrev() != 0) {
            kotlinx.coroutines.future.a.e(this, "All processed segments should be unreachable from the data structure, but the `prev` link of the leftmost segment is non-null.\nChannel state: ");
            return;
        }
        while (channelSegment.getNext() != 0) {
            ...
            if (((ChannelSegment) next3).getPrev() != 0) {
                ...
                if (((ChannelSegment) next4).getPrev() != channelSegment) {
                    kotlinx.coroutines.future.a.e(this, "The `segment.next.prev === segment` invariant is violated.\nChannel state: ");
                    return;
                }
            }
            int i = BufferedChannelKt.SEGMENT_SIZE;
            ...
            if (i2 == BufferedChannelKt.SEGMENT_SIZE && channelSegment != receiveSegment$volatile$FU.get(this) && channelSegment != sendSegment$volatile$FU.get(this) && channelSegment != bufferEndSegment$volatile$FU.get(this)) {
                kotlinx.coroutines.future.a.e(this, "Logically removed segment is reachable.\nChannel state: ");
                return;
            } else {
                ...
                while (true) {
                    ...
                    if (obj != BufferedChannelKt.CLOSE_HANDLER_CLOSED) {
                        if (obj == BufferedChannelKt.CLOSE_HANDLER_INVOKED) {
                            kotlinx.coroutines.future.a.u("Another handler was already registered and successfully invoked");
                            return;
                        } else {
                            com.google.firebase.platforminfo.b.q(obj, "Another handler is already registered: ");
                            return;
                        }
                    }
    ...
    public /* synthetic */ class AnonymousClass2 extends j implements q {
        ...
        @Override // kotlin.jvm.functions.q
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
            invoke((Throwable) obj, obj2, (kotlin.coroutines.j) obj3);
            return y.a;
        }

        public final void invoke(Throwable th, E e, kotlin.coroutines.j jVar) {
    ...
    public final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public E next() throws Throwable {
            ...
            if (e == BufferedChannelKt.NO_RECEIVE_RESULT) {
                kotlinx.coroutines.future.a.u("`hasNext()` has not been invoked");
                return null;
            }
