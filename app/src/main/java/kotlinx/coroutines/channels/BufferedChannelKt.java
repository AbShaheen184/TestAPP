...
public final class BufferedChannelKt {
    ...
    public static final long constructEBCompletedAndPauseFlag(long j, boolean z) {
        return (z ? EB_COMPLETED_PAUSE_EXPAND_BUFFERS_BIT : BUFFER_END_RENDEZVOUS) + j;
    }
    ...
    public static final <E> kotlin.reflect.e createSegmentFunction() {
    ...
    private static final boolean getEbPauseExpandBuffers(long j) {
        return (j & EB_COMPLETED_PAUSE_EXPAND_BUFFERS_BIT) != BUFFER_END_RENDEZVOUS;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final <T> boolean tryResume0(CancellableContinuation<? super T> cancellableContinuation, T t, q qVar) {
        Object objTryResume = cancellableContinuation.tryResume(t, null, qVar);
    ...
    public static /* synthetic */ boolean tryResume0$default(CancellableContinuation cancellableContinuation, Object obj, q qVar, int i, Object obj2) {
        if ((i & 2) != 0) {
            qVar = null;
        }
