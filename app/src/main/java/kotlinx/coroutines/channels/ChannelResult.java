...
public final class ChannelResult<T> {
    ...
    public static final T m48getOrThrowimpl(Object obj) throws Throwable {
        ...
        if (!(obj instanceof Closed)) {
            kotlinx.coroutines.future.a.u("Trying to call 'getOrThrow' on a failed result of a non-closed channel");
            return null;
        }
        ...
        kotlinx.coroutines.future.a.u("Trying to call 'getOrThrow' on a channel closed without a cause");
        return null;
    }
