...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    public ConflatedBufferedChannel(int i, BufferOverflow bufferOverflow, l lVar) {
        ...
        if (bufferOverflow == BufferOverflow.SUSPEND) {
            t0.g(a0.a(BufferedChannel.class).c(), " instead", "This implementation does not support suspension for senders, use ");
            throw null;
        }
        if (i >= 1) {
            return;
        }
        kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.q("Buffered channel capacity must be at least 1, but ", i, " was specified"));
        throw null;
    }
