...
public final class TickerChannelsKt {
    ...
    */
    ...
    public static final ReceiveChannel<y> ticker(long j, long j2, j jVar, TickerMode tickerMode) {
        if (j < 0) {
            e.a("Expected non-negative delay, but has ", j, " ms");
            return null;
        }
        if (j2 >= 0) {
            return ProduceKt.produce(GlobalScope.INSTANCE, Dispatchers.getUnconfined().plus(jVar), 0, new AnonymousClass3(tickerMode, j, j2, null));
        }
        e.a("Expected non-negative initial delay, but has ", j2, " ms");
        return null;
    }

    public static /* synthetic */ ReceiveChannel ticker$default(long j, long j2, j jVar, TickerMode tickerMode, int i, Object obj) {
        if ((i & 2) != 0) {
            j2 = j;
        }
        if ((i & 4) != 0) {
        ...
        return ticker(j, j2, jVar, tickerMode);
    }
}
