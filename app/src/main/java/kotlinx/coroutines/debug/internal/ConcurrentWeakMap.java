...
public final class ConcurrentWeakMap<K, V> extends h {
    ...
    /* JADX INFO: compiled from: r8-map-id-e67002de5a40c891c754bff9e68f2bf8edbc7d2191d59a60e5e311fc3b432df9 */
    public final class KeyValueSet<E> extends i {
        private final p factory;
    ...
    public Set<Map.Entry<K, V>> getEntries() {
        return new KeyValueSet(new b(11));
    }

    @Override // kotlin.collections.h
    public Set<K> getKeys() {
        return new KeyValueSet(new b(10));
    }
    ...
    public final void runWeakRefQueueCleaningLoopUntilInterrupted() {
        if (this.weakRefQueue == null) {
            kotlinx.coroutines.future.a.u("Must be created with weakRefQueue = true");
            return;
        }
        while (true) {
            try {
