...
public final class DebugCoroutineInfoImpl {
    ...
    public static final class AnonymousClass1 extends h implements p {
        ...
        public final Object invoke(kotlin.sequences.j jVar, kotlin.coroutines.d<? super y> dVar) {
    ...
    public DebugCoroutineInfoImpl(j jVar, StackTraceFrame stackTraceFrame, long j) {
    ...
    private final List<StackTraceElement> creationStackTrace() {
        ...
        if (stackTraceFrame != null) {
            i iVarI = kotlin.collections.builders.c.I(new AnonymousClass1(stackTraceFrame, null));
            if (iVarI.hasNext()) {
