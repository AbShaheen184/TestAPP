...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    final /* synthetic */ f $this_asFlow$inlined;
    ...
    @e(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", f = "Builders.kt", l = {Token.ASSIGN_DIV}, m = "collect")
    ...
    public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10(f fVar) {
        this.$this_asFlow$inlined = fVar;
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Override // kotlinx.coroutines.flow.Flow
    public Object collect(FlowCollector<? super Long> flowCollector, kotlin.coroutines.d<? super y> dVar) {
        ...
        while (it.hasNext()) {
            Long l = new Long(((kotlin.ranges.e) it).nextLong());
            anonymousClass1.L$0 = flowCollector2;
            anonymousClass1.L$1 = it;
            anonymousClass1.label = 1;
            Object objEmit = flowCollector2.emit(l, anonymousClass1);
