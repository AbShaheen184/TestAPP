...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    final /* synthetic */ h $this_asFlow$inlined;
    ...
    @e(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", f = "Builders.kt", l = {Token.ASSIGN_DIV}, m = "collect")
    ...
    public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5(h hVar) {
        this.$this_asFlow$inlined = hVar;
    }
