...
@e(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", f = "Delay.kt", l = {273}, m = "invokeSuspend")
public final class FlowKt__DelayKt$sample$2$values$1 extends i implements p {
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public final Object emit(T t, kotlin.coroutines.d<? super y> dVar) {
            ...
            if (dVar instanceof FlowKt__DelayKt$sample$2$values$1$1$emit$1) {
                flowKt__DelayKt$sample$2$values$1$1$emit$1 = (FlowKt__DelayKt$sample$2$values$1$1$emit$1) dVar;
                ...
                if ((i & Integer.MIN_VALUE) != 0) {
                    ...
                    flowKt__DelayKt$sample$2$values$1$1$emit$1 = new FlowKt__DelayKt$sample$2$values$1$1$emit$1(this, dVar);
                }
            } else {
                flowKt__DelayKt$sample$2$values$1$1$emit$1 = new FlowKt__DelayKt$sample$2$values$1$1$emit$1(this, dVar);
            }
            ...
            if (i2 == 0) {
                ...
                Object objSend = producerScope.send(t, flowKt__DelayKt$sample$2$values$1$1$emit$1);
    ...
    public FlowKt__DelayKt$sample$2$values$1(Flow<? extends T> flow, kotlin.coroutines.d<? super FlowKt__DelayKt$sample$2$values$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(ProducerScope<Object> producerScope, kotlin.coroutines.d<? super y> dVar) {
        return ((FlowKt__DelayKt$sample$2$values$1) create(producerScope, dVar)).invokeSuspend(y.a);
    }

    /* JADX WARN: Type inference incomplete: some casts might be missing */
    /*  JADX ERROR: JadxRuntimeException in pass: ModVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't change immutable type kotlin.coroutines.d to kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1 for r3v1 'this'  kotlin.coroutines.d
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r4) {
        ...
        L12:
            ...
            kotlinx.coroutines.flow.Flow<T> r0 = r3.$this_sample
            kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1$1 r2 = new kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1$1
            r2.<init>(r4)
            r3.label = r1
