...
public final class FlowKt__LogicKt$all$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    final /* synthetic */ v $foundCounterExample$inlined;
    ...
    @e(c = "kotlinx.coroutines.flow.FlowKt__LogicKt$all$$inlined$collectWhile$1", f = "Logic.kt", l = {Token.FOR}, m = "emit")
    ...
    public FlowKt__LogicKt$all$$inlined$collectWhile$1(p pVar, v vVar) {
        this.$predicate$inlined = pVar;
        this.$foundCounterExample$inlined = vVar;
    }
    ...
    public Object emit(T t, kotlin.coroutines.d<? super y> dVar) {
        ...
        if (!zBooleanValue) {
            flowKt__LogicKt$all$$inlined$collectWhile$1.$foundCounterExample$inlined.e = true;
        }
        if (zBooleanValue) {
            return y.a;
        }
