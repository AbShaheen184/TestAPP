...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @e(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", f = "Reduce.kt", l = {Token.FOR}, m = "emit")
    ...
    public FlowKt__ReduceKt$first$$inlined$collectWhile$2(p pVar, z zVar) {
    ...
    public Object emit(T t, kotlin.coroutines.d<? super y> dVar) {
        ...
        flowKt__ReduceKt$first$$inlined$collectWhile$2.$result$inlined.e = t;
