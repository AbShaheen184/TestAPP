...
public final class FlowKt__TransformKt$withIndex$1$1<T> implements FlowCollector {
    ...
    final /* synthetic */ FlowCollector<z> $this_flow;

    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__TransformKt$withIndex$1$1(FlowCollector<? super z> flowCollector, x xVar) {
    ...
    public final Object emit(T t, kotlin.coroutines.d<? super y> dVar) {
        ...
        if (i2 == 0) {
            kotlin.a.e(obj);
            FlowCollector<z> flowCollector = this.$this_flow;
            x xVar = this.$index;
            int i3 = xVar.e;
            xVar.e = i3 + 1;
            if (i3 < 0) {
            ...
            Object objEmit = flowCollector.emit(zVar, flowKt__TransformKt$withIndex$1$1$emit$1);
