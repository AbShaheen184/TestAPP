...
final /* synthetic */ class FlowKt__TransformKt {
    ...
    public static final <T> Flow<List<T>> chunked(Flow<? extends T> flow, int i) {
        ...
        kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Expected positive chunk size, but got "));
        return null;
    }
    ...
    public static final <T> Flow<kotlin.collections.z> withIndex(final Flow<? extends T> flow) {
        return new Flow<kotlin.collections.z>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$withIndex$$inlined$unsafeFlow$1
            @Override // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector<? super kotlin.collections.z> flowCollector, kotlin.coroutines.d<? super y> dVar) {
                Object objCollect = flow.collect(new FlowKt__TransformKt$withIndex$1$1(flowCollector, new x()), dVar);
                return objCollect == kotlin.coroutines.intrinsics.a.e ? objCollect : y.a;
            }
        };
    }
