...
@e(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2", f = "Zip.kt", l = {288, 288}, m = "invokeSuspend")
public final class FlowKt__ZipKt$combine$6$2 extends i implements q {
    ...
    public FlowKt__ZipKt$combine$6$2(p pVar, kotlin.coroutines.d<? super FlowKt__ZipKt$combine$6$2> dVar) {
        super(3, dVar);
        this.$transform = pVar;
    }
