...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelFlowMerge(Flow flow, int i, j jVar, int i2, BufferOverflow bufferOverflow, int i3, f fVar) {
        this(flow, i, (i3 & 4) != 0 ? k.e : jVar, (i3 & 8) != 0 ? -2 : i2, (i3 & 16) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
    ...
    public ChannelFlow<T> create(j jVar, int i, BufferOverflow bufferOverflow) {
        return new ChannelFlowMerge(this.flow, this.concurrency, jVar, i, bufferOverflow);
    }
    ...
    public ChannelFlowMerge(Flow<? extends Flow<? extends T>> flow, int i, j jVar, int i2, BufferOverflow bufferOverflow) {
