...
public final class ChannelFlowTransformLatest<T, R> extends ChannelFlowOperator<T, R> {
    ...
    public /* synthetic */ ChannelFlowTransformLatest(q qVar, Flow flow, j jVar, int i, BufferOverflow bufferOverflow, int i2, f fVar) {
        this(qVar, flow, (i2 & 4) != 0 ? k.e : jVar, (i2 & 8) != 0 ? -2 : i, (i2 & 16) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
    ...
    public ChannelFlowTransformLatest(q qVar, Flow<? extends T> flow, j jVar, int i, BufferOverflow bufferOverflow) {
