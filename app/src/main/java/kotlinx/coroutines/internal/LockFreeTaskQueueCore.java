...
public final class LockFreeTaskQueueCore<E> {
    ...
    private final LockFreeTaskQueueCore<E> allocateOrGetNextCopy(long j) {
        ...
        while (true) {
            ...
            LockFreeTaskQueueCore<E> lockFreeTaskQueueCoreAllocateNextCopy = allocateNextCopy(j);
    ...
    private final /* synthetic */ long updateAndGet$atomicfu$ATOMIC_FIELD_UPDATER$Long(AtomicLongFieldUpdater atomicLongFieldUpdater, Object obj, l lVar) {
        while (true) {
            long j = atomicLongFieldUpdater.get(obj);
            Number number = (Number) lVar.invoke(Long.valueOf(j));
            AtomicLongFieldUpdater atomicLongFieldUpdater2 = atomicLongFieldUpdater;
            Object obj2 = obj;
    ...
    public final int addLast(E e) {
        ...
        while (true) {
            ...
            if (!this.singleConsumer && getArray().get(i2 & i3) != null) {
                ...
                while ((_state$volatile$FU.get(lockFreeTaskQueueCoreFillPlaceholder) & FROZEN_MASK) != 0 && (lockFreeTaskQueueCoreFillPlaceholder = lockFreeTaskQueueCoreFillPlaceholder.next().fillPlaceholder(i2, e)) != null) {
                }
                return 0;
            }
        }
    ...
    public static final class Companion {
        ...
        public final <T> T withState(long j, p pVar) {
            return (T) pVar.invoke(Integer.valueOf((int) (LockFreeTaskQueueCore.HEAD_MASK & j)), Integer.valueOf((int) ((j & LockFreeTaskQueueCore.TAIL_MASK) >> 30)));
        }
