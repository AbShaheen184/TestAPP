...
public final class StackTraceRecoveryKt {
    private static final StackTraceElement ARTIFICIAL_FRAME = _COROUTINE.a.d(new Exception(), _COROUTINE.a.class.getSimpleName());
    ...
    public static final boolean isArtificial(StackTraceElement stackTraceElement) {
        return r.u(stackTraceElement.getClassName(), "_COROUTINE", false);
    }
