...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public CoroutineScheduler(int i, int i2, long j, String str) {
        ...
        if (i < 1) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.q("Core pool size ", i, " should be at least 1"));
            throw null;
        }
        if (i2 < i) {
            kotlinx.coroutines.future.a.s(j.g("Max pool size ", i2, " should be greater than or equals to core pool size ", i));
            throw null;
        }
        if (i2 > 2097150) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.q("Max pool size ", i2, " should not exceed maximal supported number of threads 2097150"));
            throw null;
        }
        if (j <= 0) {
