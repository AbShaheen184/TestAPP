...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    private final void checkClauseObject(Object obj) {
        ...
        while (it.hasNext()) {
            if (((ClauseData) it.next()).clauseObject == obj) {
                kotlinx.coroutines.future.a.c(androidx.compose.runtime.j.f(obj, "Cannot use select clauses on the same object: "));
                return;
            }
        }
    }
    ...
    public static /* synthetic */ void register$default(SelectImplementation selectImplementation, ClauseData clauseData, boolean z, int i, Object obj) {
        if (obj != null) {
            b.n("Super calls with default arguments not supported in this target, function: register");
            return;
        }
        if ((i & 1) != 0) {
            z = false;
        ...
        while (true) {
            ...
            if (!(obj3 instanceof CancellableContinuation)) {
                ...
                if (kotlin.jvm.internal.l.a(obj3, SelectKt.STATE_REG)) {
                    ...
                    List listJ = kotlin.collections.q.j(obj);
                    while (!atomicReferenceFieldUpdater.compareAndSet(this, obj3, listJ)) {
                ...
                if (!(obj3 instanceof List)) {
                    b.q(obj3, "Unexpected state: ");
                    return 0;
                }
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = state$volatile$FU;
                ArrayList arrayListN = kotlin.collections.p.N((Collection) obj3, obj);
                while (!atomicReferenceFieldUpdater2.compareAndSet(this, obj3, arrayListN)) {
