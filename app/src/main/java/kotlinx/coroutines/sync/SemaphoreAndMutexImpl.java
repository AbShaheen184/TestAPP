...
public class SemaphoreAndMutexImpl {
    ...
    public SemaphoreAndMutexImpl(int i, int i2) {
        this.permits = i;
        if (i <= 0) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Semaphore should have at least 1 permit, but had "));
            throw null;
        }
        if (i2 < 0 || i2 > i) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "The number of acquired permits should be in 0.."));
            throw null;
        }
        ...
        this.onCancellationRelease = new y(this, 15);
    }
            ...
            if (acquirers.get(i) != null) {
                ...
                if (z) {
                    ...
                    if (!(waiter instanceof SelectInstance)) {
                        com.google.firebase.platforminfo.b.q(waiter, "unexpected: ");
                        return false;
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final kotlin.y onCancellationRelease$lambda$2(SemaphoreAndMutexImpl semaphoreAndMutexImpl, Throwable th, kotlin.y yVar, j jVar) {
    ...
    private final boolean tryResumeAcquire(Object obj) {
        ...
        if (!z) {
            ...
            com.google.firebase.platforminfo.b.q(obj, "unexpected: ");
            return false;
        }
