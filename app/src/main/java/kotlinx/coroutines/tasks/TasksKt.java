...
public final class TasksKt {
    ...
    private static final <T> Deferred<T> asDeferredImpl(i iVar, a aVar) {
        ...
        if (iVar.g()) {
            ...
            iVar.a(DirectExecutor.INSTANCE, new j(completableDeferredCompletableDeferred$default, 13));
        }
        if (aVar != null) {
            completableDeferredCompletableDeferred$default.invokeOnCompletion(new s2(aVar, 29));
        }
        return new Deferred<T>() { // from class: kotlinx.coroutines.tasks.TasksKt.asDeferredImpl.3
            ...
            @Override // kotlinx.coroutines.Deferred, kotlinx.coroutines.Job, kotlin.coroutines.j
            public <E extends h> E get(kotlin.coroutines.i iVar2) {
                return (E) completableDeferredCompletableDeferred$default.get(iVar2);
            }
            ...
            @Override // kotlinx.coroutines.Deferred, kotlinx.coroutines.Job, kotlin.coroutines.j
            public kotlin.coroutines.j minusKey(kotlin.coroutines.i iVar2) {
                return completableDeferredCompletableDeferred$default.minusKey(iVar2);
            }

            @Override // kotlinx.coroutines.Deferred, kotlinx.coroutines.Job, kotlin.coroutines.j
            public kotlin.coroutines.j plus(kotlin.coroutines.j jVar) {
                return completableDeferredCompletableDeferred$default.plus(jVar);
            }
    ...
    public static final <T> i asTask(Deferred<? extends T> deferred) {
        a aVar = new a();
        com.google.android.gms.tasks.j jVar = new com.google.android.gms.tasks.j(aVar.a);
        deferred.invokeOnCompletion(new androidx.compose.animation.core.a(23, aVar, deferred, jVar));
        return jVar.a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final y asTask$lambda$0(a aVar, Deferred deferred, com.google.android.gms.tasks.j jVar, Throwable th) {
        ...
        if (gVar == null) {
            gVar = new g(completionExceptionOrNull);
        }
        jVar.a(gVar);
        return yVar;
    }
    ...
    public static final <T> Object awaitImpl(i iVar, final a aVar, d<? super T> dVar) throws Exception {
        if (!iVar.g()) {
            final CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(kotlin.coroutines.intrinsics.h.f(dVar), 1);
