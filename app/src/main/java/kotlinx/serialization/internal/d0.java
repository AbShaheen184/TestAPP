...
public final class d0 extends a {
    ...
    public final void j(kotlinx.serialization.encoding.a aVar, int i, Object obj) {
        ...
        int iS = aVar.s(c0Var);
        if (iS != i + 1) {
            kotlinx.coroutines.future.a.s(androidx.compose.runtime.j.g("Value must follow key in a map, index for key: ", i, ", returned index for value: ", iS));
            return;
        }
        boolean zContainsKey = map.containsKey(objW);
        kotlinx.serialization.a aVar2 = this.a;
        map.put(objW, (!zContainsKey || (aVar2.d().e() instanceof kotlinx.serialization.descriptors.d)) ? aVar.w(c0Var, iS, aVar2, null) : aVar.w(c0Var, iS, aVar2, kotlin.collections.c0.g(objW, map)));
    }
