...
public abstract class m0 {
    ...
    public static final int d(kotlinx.serialization.descriptors.e eVar, kotlinx.serialization.descriptors.e[] eVarArr) {
        ...
        while (true) {
            ...
            kotlin.collections.i0 i0VarE = eVar.i(eVar.f() - iF2).e();
            iHashCode3 = i5 + (i0VarE != null ? i0VarE.hashCode() : 0);
            iF2 = i4;
        }
    }
    ...
    public static final void f(String str, kotlin.jvm.internal.e eVar) {
        ...
        if (str == null) {
            string = androidx.privacysandbox.ads.adservices.java.internal.a.m('.', "Class discriminator was missing and no default serializers were registered ", str2);
        } else {
            StringBuilder sbQ = androidx.compose.runtime.j.q("Serializer for subclass '", str, "' is not found ", str2, ".\nCheck if class with serial name '");
            androidx.room.b0.i(sbQ, str, "' exists and serializer is registered in a corresponding SerializersModule.\nTo be registered automatically, class '", str, "' has to be '@Serializable', and the base class '");
            sbQ.append(eVar.c());
