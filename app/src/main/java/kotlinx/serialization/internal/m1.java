...
public final class m1 implements kotlinx.serialization.a {
    ...
    public static final s0 b = new s0("kotlin.uuid.Uuid", kotlinx.serialization.descriptors.d.j);
    ...
    public final Object a(kotlinx.serialization.encoding.b bVar) {
        ...
        if (length == 32) {
            ...
            while (i < 16) {
                ...
                kotlin.collections.c.f(strM, i, "a hexadecimal digit");
                throw null;
            }
            long j4 = 0;
            for (int i2 = 16; i2 < 32; i2++) {
                ...
                kotlin.collections.c.f(strM, i2, "a hexadecimal digit");
                throw null;
            }
            if (j != 0 || j4 != 0) {
            ...
            if (strM.charAt(8) != '-') {
                kotlin.collections.c.f(strM, 8, "'-' (hyphen)");
                throw null;
            }
            long j10 = 0;
            for (int i3 = 9; i3 < 13; i3++) {
                ...
                kotlin.collections.c.f(strM, i3, "a hexadecimal digit");
                throw null;
            }
            if (strM.charAt(13) != '-') {
                kotlin.collections.c.f(strM, 13, "'-' (hyphen)");
                throw null;
            }
            long j13 = 0;
            for (int i4 = 14; i4 < 18; i4++) {
                ...
                kotlin.collections.c.f(strM, i4, "a hexadecimal digit");
                throw null;
            }
            if (strM.charAt(18) != '-') {
                kotlin.collections.c.f(strM, 18, "'-' (hyphen)");
                throw null;
            }
            long j16 = 0;
            for (int i5 = 19; i5 < 23; i5++) {
                ...
                kotlin.collections.c.f(strM, i5, "a hexadecimal digit");
                throw null;
            }
            if (strM.charAt(23) != '-') {
                kotlin.collections.c.f(strM, 23, "'-' (hyphen)");
                throw null;
            }
            long j19 = 0;
            for (int i6 = 24; i6 < 36; i6++) {
                ...
                kotlin.collections.c.f(strM, i6, "a hexadecimal digit");
                throw null;
            }
