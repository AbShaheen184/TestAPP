...
public final class m extends kotlin.collections.builders.c implements kotlinx.serialization.encoding.b, kotlinx.serialization.encoding.a {
    ...
    public m(kotlinx.serialization.json.b bVar, q qVar, androidx.fragment.app.h hVar, kotlinx.serialization.descriptors.e eVar) {
        ...
        l0 l0Var = bVar.a;
        this.f = l0Var;
        this.g = l0Var.b ? null : new h(eVar);
    }
    ...
    public final float A() {
        ...
        try {
            ...
            androidx.fragment.app.h.x(hVar, androidx.privacysandbox.ads.adservices.java.internal.a.m('\'', "Failed to parse type 'float' for input '", strM), 0, null, 6);
            throw null;
        }
    }
    ...
    public final double B() {
        ...
        try {
            ...
            androidx.fragment.app.h.x(hVar, androidx.privacysandbox.ads.adservices.java.internal.a.m('\'', "Failed to parse type 'double' for input '", strM), 0, null, 6);
            throw null;
        }
    }

    public final kotlinx.serialization.json.i K() {
        return new androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.l(this.a.a, this.c).i();
    }
    ...
    public final char e() {
        ...
        androidx.fragment.app.h.x(hVar, androidx.privacysandbox.ads.adservices.java.internal.a.m('\'', "Expected single char, but got '", strM), 0, null, 6);
        throw null;
    }

    @Override // kotlin.collections.builders.c, kotlinx.serialization.encoding.a
    ...
    public final kotlinx.serialization.encoding.a n(kotlinx.serialization.descriptors.e eVar) {
        ...
        return (this.b == qVarI && bVar.a.b) ? this : new m(bVar, qVarI, hVar, eVar);
    }
    ...
    public final Object p(kotlinx.serialization.a aVar) {
        ...
        try {
            ...
            if (strH != null) {
                try {
                    kotlin.collections.o.r((kotlinx.serialization.c) aVar, this, strH);
                    throw null;
                } catch (kotlinx.serialization.d e) {
                    String message2 = e.getMessage();
                    message2.getClass();
                    String strQ = kotlin.text.k.Q(kotlin.text.k.a0(message2, '\n'), ".");
                    String message3 = e.getMessage();
                    message3.getClass();
                    String strSubstring = "";
                    int iG = kotlin.text.k.G(message3, '\n', 0, 6);
                    if (iG != -1) {
                        strSubstring = message3.substring(iG + 1, message3.length());
                    }
                    androidx.fragment.app.h.x(hVar, strQ, 0, strSubstring, 2);
                    throw null;
                }
            }
            if (!(aVar instanceof kotlinx.serialization.c)) {
            ...
            kotlinx.serialization.json.i iVarK = K();
            String strA = ((kotlinx.serialization.c) aVar).d().a();
            if (!(iVarK instanceof s)) {
                throw i.b(-1, iVarK.toString(), "Expected " + a0.a(s.class).c() + ", but had " + a0.a(iVarK.getClass()).c() + " as the serialized body of " + strA + " at element: " + xVar.l());
            }
            s sVar = (s) iVarK;
            ...
            try {
                kotlin.collections.o.r((kotlinx.serialization.c) aVar, this, strB);
                throw null;
            ...
            message.getClass();
            if (kotlin.text.k.z(message, "at path", false)) {
                throw e;
            }
    ...
    public final int s(kotlinx.serialization.descriptors.e eVar) {
        ...
        if (iOrdinal == 0) {
            ...
            if (zE) {
                ...
                int iD = eVar.d(strG);
                if (iD == -3 && l0Var2.c) {
                    com.google.android.material.behavior.d dVar = bVar.c;
                    com.app.mlounge.ui.screens.adult.b bVar2 = new com.app.mlounge.ui.screens.adult.b(21, eVar, bVar);
                    dVar.getClass();
                    ConcurrentHashMap concurrentHashMap = (ConcurrentHashMap) dVar.e;
                    Map map = (Map) concurrentHashMap.get(eVar);
                    j jVar = i.a;
                    Object obj2 = map != null ? map.get(jVar) : null;
                    Object objInvoke = obj2 != null ? obj2 : null;
                    if (objInvoke == null) {
                        objInvoke = bVar2.invoke();
                ...
                if (iIntValue == -3) {
                    hVar.w(androidx.privacysandbox.ads.adservices.java.internal.a.m('\'', "Encountered an unknown key '", strG), kotlin.text.k.L(((String) hVar.C).subSequence(0, hVar.y).toString(), 6, strG), "Use 'ignoreUnknownKeys = true' in 'Json {}' builder to ignore unknown keys.");
                    throw null;
                }
                if (hVar2 != null) {
                ...
                if (hVar2 != null) {
                    ...
                    while (true) {
                            ...
                            loop1: while (i < length) {
                                ...
                                while (true) {
                                    if (j3 != j2) {
                                        ...
                                        if (((Boolean) t0Var.invoke(eVar2, Integer.valueOf(i5))).booleanValue()) {
                                            jArr2[i] = j3;
                                            iIntValue = i5;
                                            break;
                                        }
                        ...
                        if (((Boolean) t0Var.invoke(eVar2, Integer.valueOf(iNumberOfTrailingZeros2))).booleanValue()) {
    ...
    public final kotlinx.serialization.encoding.b u(kotlinx.serialization.descriptors.e eVar) {
        eVar.getClass();
        return o.a(eVar) ? new f(this.c, this.a) : this;
    }
