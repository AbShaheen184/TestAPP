...
import net.luminis.quic.impl.l;
...
public final class f {
    ...
    public final void a(net.luminis.quic.frame.c cVar) throws Exception {
        try {
            ...
            if (cVar.b() - (((long) this.r) + j) > 4096) {
                throw new l(net.luminis.quic.a.CRYPTO_BUFFER_EXCEEDED);
            }
            if (!zA) {
            ...
            while (true) {
                ...
                if (this.o) {
                    ...
                    if (j >= i2) {
                        ...
                        j -= (long) iD;
                        this.o = false;
                        net.luminis.tls.handshake.e eVarI = this.j.i(byteBufferAllocate2, this.d, this.c);
    ...
    public final String b(List list) {
        ...
        return "CryptoStream[" + com.google.android.datatransport.runtime.a.w(this.b).charAt(0) + "|" + stringJoiner + "]";
    }
    ...
    public final void c(net.luminis.tls.handshake.e eVar) {
        ...
        this.n += bArrA.length;
        this.f.e(new e(this, 0), 10, this.b, new y0(this, 2));
        this.f.j();
        this.i.add(eVar);
    }
