...
public final class c extends n implements net.luminis.quic.stream.h {
    ...
    public final void a(net.luminis.quic.impl.i iVar, net.luminis.quic.packet.g gVar, Long l) throws Exception {
        ...
        try {
            ...
            if (iVar.L == 2) {
                ...
                iVar.z.c("Processing crypto frame failed with ", e);
            }
            iVar.e(gVar.k(), e.e.e, "");
            ...
            if (iVar.L == 2) {
                ...
                iVar.z.c("Processing crypto frame failed with ", e2);
            }
            int iK = gVar.k();
    ...
    @Override // net.luminis.quic.frame.n
    public final int d() {
        return kotlin.coroutines.g.c(this.z.length) + kotlin.coroutines.g.c(this.e) + 1 + this.z.length;
    }
