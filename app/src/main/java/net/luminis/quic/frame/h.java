...
public final class h extends n {
    ...
    public final void a(net.luminis.quic.impl.i iVar, net.luminis.quic.packet.g gVar, Long l) {
        ...
        if (i6 > 0) {
            ...
            if (androidx.constraintlayout.core.g.b(((net.luminis.quic.cid.a) dVar3.a.get(Integer.valueOf(iIntValue))).c, 4)) {
                ...
                if (aVar == null) {
                    kotlinx.coroutines.future.a.u("Can't find connection id that is not retired");
                    return;
                } else {
                    aVar.c = 2;
                    dVar3.b = aVar.b;
    ...
    @Override // net.luminis.quic.frame.n
    public final int d() {
        return kotlin.coroutines.g.c(this.y) + kotlin.coroutines.g.c(this.e) + 1 + 1 + this.z.length + 16;
    }
    ...
    public final String toString() {
        return "NewConnectionIdFrame[" + this.e + ",<" + this.y + "|" + kotlin.coroutines.intrinsics.h.c(this.z) + "|" + kotlin.coroutines.intrinsics.h.c(this.A) + "]";
    }
}
