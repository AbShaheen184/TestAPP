...
public final class o {
        ...
        while (it.hasNext()) {
            ...
            if (j == j2 - 1 || j == j3 + 1) {
                ...
                if (j == j9) {
                    ...
                    long j11 = j10 - 1;
                    if (j != j11) {
                        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.h("Range cannot be extended with that number ", j));
                        return;
                    }
                    oVar = new o(j11, j8);
                }
    ...
    public final String toString() {
        ...
        sb.append(this.b);
        sb.append("..");
        return androidx.privacysandbox.ads.adservices.java.internal.a.p(this.a, "]", sb);
    }
