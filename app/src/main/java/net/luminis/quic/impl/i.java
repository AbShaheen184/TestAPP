...
public final class i implements net.luminis.quic.packet.e {
    ...
    public i(InetAddress inetAddress, String str, int i, String str2, long j, a aVar, n nVar, net.luminis.quic.log.a aVar2, List list) {
        ...
        this.k0 = kVar.k;
        this.U = new net.luminis.quic.receive.b(datagramSocket, aVar2, new y0(this, 3), new net.luminis.quic.ack.a(this, 1));
        this.W = new net.luminis.quic.stream.n(this, aVar2, aVar);
        this.Y = new net.luminis.quic.cid.b(kVar, new g(this), aVar2);
        this.L = 1;
        this.Q = new net.luminis.tls.engine.impl.a(new com.google.android.material.internal.k(17, this, aVar2, false), this);
    }
    ...
    public static String c(net.luminis.quic.frame.b bVar) {
        ...
        int i2 = bVar.A;
        if (i2 == -1) {
            kotlinx.coroutines.future.a.u("Close does not have a TLS error");
            return null;
        }
        sb5.append(i2);
        if (bVar.z != null) {
    ...
    public final void a(Throwable th) {
        ...
        this.L = 4;
        if (th != null) {
            this.z.c("Aborting connection because of error", th);
        }
        this.d0.countDown();
        this.T.i();
        l();
    ...
    public final void b() {
        ...
        synchronized (this) {
            try {
                ...
                kotlin.coroutines.intrinsics.h.c(bVar.h);
                kotlin.coroutines.intrinsics.h.c(this.Y.g);
                aVar.getClass();
    ...
    public final m f() {
        ...
        int i = aVar.a;
        if (i <= 0) {
            kotlinx.coroutines.future.a.q("maxIdleTimeout must be set");
            return null;
        }
        mVar.b = i;
        long j = aVar.d;
        if (j <= 0) {
            kotlinx.coroutines.future.a.q("maxConnectionBufferSize must be set");
            return null;
        }
        mVar.c = j;
        long j2 = aVar.e;
        if (j2 <= 0) {
            kotlinx.coroutines.future.a.q("maxBidirectionalStreamBufferSize must be set");
            return null;
        }
        mVar.f = j2;
        long j3 = aVar.f;
        ...
        int i2 = aVar.c;
        if (i2 < 0) {
            kotlinx.coroutines.future.a.q("maxOpenBidirectionalStreams must be set");
            return null;
        }
        mVar.g = i2;
        int i3 = aVar.b;
        if (i3 < 0) {
            kotlinx.coroutines.future.a.q("maxOpenUnidirectionalStreams must be set");
            return null;
        }
        mVar.h = i3;
        int i4 = aVar.g;
        if (i4 < 2) {
            kotlinx.coroutines.future.a.q("activeConnectionIdLimit must be set");
            return null;
        }
        mVar.l = i4;
        int i5 = aVar.h;
        ...
        kotlinx.coroutines.future.a.q("maxUdpPayloadSize must be set");
        return null;
    }
    ...
    public final void g(net.luminis.quic.packet.g gVar, net.luminis.quic.packet.f fVar) {
        ...
        qVar.getClass();
        if (gVar.c()) {
            ((net.luminis.quic.ack.b[]) qVar.e)[androidx.constraintlayout.core.g.e(gVar.m())].d(gVar);
        }
        d dVar = this.F;
        if (dVar.f) {
    ...
    public final void k(String str, boolean z) {
        ...
        if (this.e.a.b()) {
            ...
            arrayList.add(nVar);
            arrayList.add(n.b);
            this.X.q = new com.google.android.material.internal.k(18, nVar, arrayList);
        }
    ...
    public final String toString() {
        ...
        sb.append(kotlin.coroutines.intrinsics.h.c(this.Y.h));
        sb.append("/");
        sb.append(kotlin.coroutines.intrinsics.h.c(this.Y.g));
        sb.append("(");
        int i = this.e.a.a;
        char c = 1;
        if (i != 1) {
