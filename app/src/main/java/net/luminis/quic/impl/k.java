    ...
    public final void g(net.luminis.quic.packet.g gVar, net.luminis.quic.packet.f fVar) {
        switch (this.y) {
            case 0:
                ...
                iVar.z.b("Dropping packet because dcid " + kotlin.coroutines.intrinsics.h.c(bArrJ) + " is not an active connection ID.");
                gVar.toString();
                return;
            case 1:
                if (!com.google.android.datatransport.runtime.a.a(((i) this.z).L)) {
                    q(gVar, fVar);
                    return;
                }
                int i = ((i) this.z).L;
