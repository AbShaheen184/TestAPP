...
public final class a {
    ...
    public a(net.luminis.quic.crypto.d dVar, o oVar, int i, byte[] bArr, k kVar, kotlinx.coroutines.future.b bVar, net.luminis.quic.log.a aVar) {
        this.a = dVar;
        this.b = oVar;
        this.c = i;
        this.d = kVar;
    ...
    public final g a(ByteBuffer byteBuffer) {
        ...
        if (gVar.k() != 0) {
            if (gVar.a.equals(this.b.a)) {
                ...
                aVar.getClass();
                net.luminis.quic.crypto.d dVar = new net.luminis.quic.crypto.d(new o(gVar.a), new y(27));
                dVar.b(this.h);
                aVarE = dVar.e(gVar.k());
            }
