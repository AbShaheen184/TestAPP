...
public abstract class d extends g {
    ...
    public final byte[] h(net.luminis.quic.crypto.a aVar) {
        ...
        kotlin.coroutines.g.e(byteBufferAllocate, byteBufferI.limit() + 16 + bArrE.length);
    ...
    public final void r(ByteBuffer byteBuffer, net.luminis.quic.crypto.a aVar, long j, net.luminis.quic.log.a aVar2, int i) throws net.luminis.quic.impl.e {
        ...
        try {
            try {
                s(byteBuffer, b, kotlin.coroutines.g.m(byteBuffer), aVar, j, aVar2);
            } finally {
    ...
    public String toString() {
        ...
        sb.append(this.f ? "P" : "");
        sb.append(com.google.android.datatransport.runtime.a.w(k()).charAt(0));
        sb.append("|");
        long j = this.b;
