...
public final class h extends g {
    ...
    public final int a(net.luminis.quic.impl.i iVar, Long l2) {
        if (!Arrays.equals(v(iVar.Y.h), this.j)) {
            iVar.z.b("Discarding Retry packet, because integrity tag is invalid.");
        } else if (iVar.o0) {
            iVar.z.b("Ignoring RetryPacket, because already processed one.");
        } else {
            iVar.o0 = true;
            iVar.c0 = this.h;
            k kVar = iVar.T;
            ...
            "Changing destination connection id into: ".concat(kotlin.coroutines.intrinsics.h.c(bArr2));
            aVar.getClass();
    ...
    public final String toString() {
        return "Packet " + "Initial".charAt(0) + "|-|R|" + this.d + "| Retry Token (" + this.h.length + "): " + kotlin.coroutines.intrinsics.h.c(this.h);
    }
