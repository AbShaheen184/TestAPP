...
public final class g {
    ...
    public g(int i, h hVar, net.luminis.quic.cc.a aVar, k kVar, net.luminis.quic.log.a aVar2) {
        ...
        for (int i2 : androidx.constraintlayout.core.g.f(3)) {
            this.c[androidx.constraintlayout.core.g.e(i2)] = new a(this, hVar, aVar, new c(0, kVar), aVar2.e());
        }
        this.d = kVar;
        this.e = aVar2;
    ...
    public final void h(Long l) {
        try {
            synchronized (this.i) {
                this.h.cancel(false);
                this.k = l;
                this.h = this.f.schedule(new p(this, 14), l.longValue() - System.currentTimeMillis(), TimeUnit.MILLISECONDS);
            }
    ...
    public final void i(int i, int i2) {
        ...
        if (i != 2) {
            int iD = com.google.android.datatransport.runtime.a.d(i);
            List listB2 = b(i);
            if (listB2.isEmpty()) {
                aVar.getClass();
