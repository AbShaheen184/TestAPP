...
public final class k {
    ...
    public k(o oVar, DatagramSocket datagramSocket, InetSocketAddress inetSocketAddress, net.luminis.quic.impl.i iVar, net.luminis.quic.log.a aVar) {
        ...
        q qVar = new q();
        qVar.e = new net.luminis.quic.ack.b[androidx.constraintlayout.core.g.f(3).length];
        for (int i3 : androidx.constraintlayout.core.g.f(3)) {
            ((net.luminis.quic.ack.b[]) qVar.e)[androidx.constraintlayout.core.g.e(i3)] = new net.luminis.quic.ack.b(i3, this);
        }
        this.k = qVar;
        j[] jVarArr = this.i;
        ...
        while (i4 < length) {
            ...
            net.luminis.quic.ack.b eVar = i5 != 2 ? ((net.luminis.quic.ack.b[]) qVar.e)[androidx.constraintlayout.core.g.e(com.google.android.datatransport.runtime.a.e(i5))] : new e(i, null);
        ...
        iVar.I = gVar;
        this.m = iVar.F;
        Thread thread = new Thread(new net.luminis.quic.recovery.c(1, this), androidx.compose.runtime.j.i("sender", ""));
        this.n = thread;
    ...
    public final long a() {
        ...
        if (this.x) {
            ...
            if (iIncrementAndGet % 20 == 3) {
                this.g.b("possible bug: sender is looping in busy wait; got " + iIncrementAndGet + " iterations");
            }
        ...
        synchronized (this.o) {
            try {
                if (!this.o[androidx.constraintlayout.core.g.e(i)]) {
                    androidx.emoji2.text.f fVar = this.j;
                    g gVar = ((g[]) fVar.b)[androidx.constraintlayout.core.g.e(com.google.android.datatransport.runtime.a.d(i))];
                    gVar.g = new c(fVar, i);
                    gVar.c.b(false);
                    gVar.f = true;
        ...
        while (true) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                try {
                    ...
                    this.g.b("Buffer overflow while generating datagram for " + arrayList);
                    throw e2;
                }
            }
            if (arrayList.isEmpty()) {
    ...
    public final void g(int i, int i2) {
        j jVar = this.i[androidx.constraintlayout.core.g.e(com.google.android.datatransport.runtime.a.d(i))];
        jVar.getClass();
    ...
    public final void h(int i, List list) {
        synchronized (this.o) {
            try {
                if (this.o[androidx.constraintlayout.core.g.e(com.google.android.datatransport.runtime.a.e(i))]) {
                    net.luminis.quic.log.a aVar = this.g;
                    com.google.android.datatransport.runtime.a.e(i);
                    aVar.getClass();
                } else {
