...
public final class n {
    ...
    public final e f(boolean z, long j, TimeUnit timeUnit, com.google.android.datatransport.runtime.scheduling.jobscheduling.j jVar) throws TimeoutException {
        try {
    ...
    public final void h(net.luminis.quic.frame.r rVar) throws net.luminis.quic.impl.l {
        ...
        if (eVar != null || (((i2 = (i = rVar.y) % 4) > 1 && i >= this.v) || (i2 < 2 && i >= this.w))) {
            long jX = eVar != null ? eVar.e.x() : 0L;
            if (rVar.b() > jX) {
                if (this.x + (rVar.b() - jX) > this.o) {
