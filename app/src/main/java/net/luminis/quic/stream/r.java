...
public class r extends o {
    ...
    public static void n(r rVar, net.luminis.quic.frame.n nVar) {
        if (rVar.I) {
            return;
        }
    ...
    public static net.luminis.quic.frame.n x(r rVar) {
        b bVar = rVar.M;
        e eVar = rVar.e;
        bVar.getClass();
        int i = eVar.a;
    ...
    public final void A() throws IOException {
        ...
        if (this.N) {
            kotlinx.coroutines.future.a.w("output aborted because connection is closed");
        }
    }
    ...
    public final void g(long j) {
        ...
        this.C.set(0);
        e eVar = this.e;
        eVar.b.i(new p(this, 1), kotlin.coroutines.g.c(j) + kotlin.coroutines.g.c(eVar.a) + 1 + 8, 4, new q(this, 1), true);
        Thread thread = this.L;
        if (thread != null) {
            thread.interrupt();
        }
