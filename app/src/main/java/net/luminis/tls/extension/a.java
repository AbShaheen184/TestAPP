...
public final class a extends g {
    ...
    public a(ByteBuffer byteBuffer, int i) throws net.luminis.tls.alert.a {
        ...
        switch (i) {
            ...
            default:
                ...
                if (i7 != iB3 - 2) {
                    kotlinx.coroutines.future.a.g("inconsistent lengths");
                    throw null;
                }
                this.b = new ArrayList();
                while (i7 > 0) {
                    ...
                    if (i8 > i7 - 1) {
                        kotlinx.coroutines.future.a.g("incorrect length");
                        throw null;
                    }
    ...
    public a(String str) {
        ...
        kotlinx.coroutines.future.a.q("protocol cannot be empty");
        throw null;
    }
