...
import net.luminis.tls.extension.l;
...
public abstract class e {
    ...
    public static ArrayList c(ByteBuffer byteBuffer, net.luminis.tls.e eVar, j jVar) throws net.luminis.tls.alert.a {
        int i;
        int i2;
        ...
        if (byteBuffer.remaining() < 2) {
            kotlinx.coroutines.future.a.g("Extension field must be at least 2 bytes long");
            return null;
        }
        ...
        if (byteBuffer.remaining() < i5) {
            kotlinx.coroutines.future.a.g("Extensions too short");
            return null;
        }
        while (true) {
            int i6 = 4;
            ...
            int i9 = i5 - 4;
            if (i8 > i9) {
                kotlinx.coroutines.future.a.g("Extension length exceeds extensions length");
                return null;
            }
            ...
            if (i7 == s3) {
                ...
                if (i7 == net.luminis.tls.d.supported_groups.e) {
                    ...
                    if (i7 == dVar.e) {
                        ...
                        if (s5 % 2 != 0) {
                            kotlinx.coroutines.future.a.g("invalid group length");
                            return null;
                        }
                        int i13 = 0;
                        while (i13 < s5) {
                        ...
                        if (i7 != s6) {
                            ...
                            if (i7 == s7) {
                                ...
                                if (eVar == net.luminis.tls.e.new_session_ticket) {
                                    if (iB3 != 4) {
                                        kotlinx.coroutines.future.a.g("invalid extension data length");
                                        return null;
                                    }
                                ...
                                if (i7 == dVar3.e) {
                                    net.luminis.tls.extension.j jVar2 = new net.luminis.tls.extension.j();
                                    jVar2.b = new ArrayList();
                                    int iB4 = jVar2.b(byteBuffer, dVar3.e, 1);
                                    i2 = 2;
                                    if (iB4 < 2) {
                                        kotlinx.coroutines.future.a.g("extension underflow");
                                        return null;
                                    ...
                                    i2 = 2;
                                    if (jVar != null) {
                                        net.luminis.quic.crypto.f fVar2 = (net.luminis.quic.crypto.f) jVar.y;
                                            ...
                                            if (i19 == 1 || i19 == 1798521807) {
                                                ...
                                                while (byteBuffer.position() - iPosition < s) {
                                                    try {
                                                        ...
                                                        kotlinx.coroutines.future.a.g("invalid integer encoding in transport parameter extension");
                                                        return null;
                                                    }
                                                }
                                                if (byteBuffer.position() - iPosition != s) {
                                                    kotlinx.coroutines.future.a.g("inconsistent size in transport parameter extension");
                                                    return null;
                                                }
                                            } else {
                                                if (i18 != 65445) {
                                    ...
                                    if (aVar != null) {
                                        ...
                                        if (byteBuffer.remaining() < 4) {
                                            kotlinx.coroutines.future.a.g("Extension must be at least 4 bytes long");
                                            return null;
                                        }
                                        byteBuffer.getShort();
                                        int i20 = byteBuffer.getShort() & s4;
                                        if (byteBuffer.remaining() < i20) {
                                            kotlinx.coroutines.future.a.g("Invalid extension length");
                                            return null;
                                        }
                            ...
                            l lVar = new l();
                            lVar.b(byteBuffer, s6, 2);
                            lVar.a = byteBuffer.getShort();
                            arrayList.add(lVar);
                        } else {
                            if (eVar != net.luminis.tls.e.client_hello) {
                            ...
                            while (i21 > 0) {
                                if (i23 < i22) {
                                    kotlinx.coroutines.future.a.g("Incomplete psk identity");
                                    return null;
                                }
                                int i24 = byteBuffer.getShort() & s4;
                                int i25 = i23 - 2;
                                if (i24 > i25) {
                                    kotlinx.coroutines.future.a.g("Incorrect identity length value");
                                    return null;
                                }
                            ...
                            i = i9;
                            if (i21 != 0) {
                                kotlinx.coroutines.future.a.g("Incorrect identities length value");
                                return null;
                            }
                            eVar4.c = byteBuffer.position() - iPosition3;
                            eVar4.b = new ArrayList();
                            if (i23 < 2) {
                                kotlinx.coroutines.future.a.g("Incomplete binders");
                                return null;
                            }
                            ...
                            while (i27 > 0) {
                                if (i28 < 1) {
                                    kotlinx.coroutines.future.a.g("Incorrect binder value");
                                    return null;
                                }
                                int i29 = byteBuffer.get() & 255;
                                int i30 = i28 - 1;
                                if (i29 > i30) {
                                    kotlinx.coroutines.future.a.g("Incorrect binder length value");
                                    return null;
                                }
                                if (i29 < 32) {
                                    kotlinx.coroutines.future.a.g("Invalid binder length");
                                    return null;
                                }
                            ...
                            if (i27 != 0) {
                                kotlinx.coroutines.future.a.g("Incorrect binders length value");
                                return null;
                            }
                            if (i28 > 0) {
                                kotlinx.coroutines.future.a.g("Incorrect extension data length value");
                                return null;
                            }
                            if (eVar4.a.size() != eVar4.b.size()) {
                                kotlinx.coroutines.future.a.g("Inconsistent number of identities vs binders");
                                return null;
                            }
                            if (eVar4.a.size() == 0) {
                                kotlinx.coroutines.future.a.g("Empty OfferedPsks");
                                return null;
                            }
                            arrayList.add(eVar4);
                        }
    ...
    public final int d(ByteBuffer byteBuffer, net.luminis.tls.e eVar, int i) {
        if (byteBuffer.remaining() < 4) {
            kotlinx.coroutines.future.a.g("handshake message underflow");
            return 0;
        }
