...
public final class a {
    ...
    public a(String str, int i, o oVar, SocketFactory socketFactory, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, i iVar, b bVar, List list, List list2, ProxySelector proxySelector) {
        ...
        if (str2.equalsIgnoreCase("http")) {
            ...
            if (!str2.equalsIgnoreCase("https")) {
                kotlinx.coroutines.future.a.q("unexpected scheme: ".concat(str2));
                throw null;
            }
            yVar.c = "https";
        }
        ...
        if (strB == null) {
            kotlinx.coroutines.future.a.q("unexpected host: ".concat(str));
            throw null;
        }
        yVar.f = strB;
        if (1 > i || i >= 65536) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "unexpected port: "));
            throw null;
        }
        yVar.b = i;
        this.h = yVar.c();
    ...
    public final int hashCode() {
        return Objects.hashCode(this.e) + ((Objects.hashCode(this.d) + ((Objects.hashCode(this.c) + ((this.g.hashCode() + ((this.j.hashCode() + ((this.i.hashCode() + ((this.f.hashCode() + ((this.a.hashCode() + androidx.privacysandbox.ads.adservices.java.internal.a.g(527, 31, this.h.i)) * 31)) * 31)) * 31)) * 31)) * 961)) * 31)) * 31);
    }
