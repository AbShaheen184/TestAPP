...
public final class h implements Closeable, Flushable {
    ...
    public static void c0(String str) {
        ...
        kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.m('\"', "keys must match regex [a-z0-9_-]{1,120}: \"", str));
    }
    ...
    public final void X() throws Throwable {
        ...
        try {
            ...
            if (!"libcore.io.DiskLruCache".equals(strT) || !"1".equals(strT2) || !l.a(String.valueOf(201105), strT3) || !l.a(String.valueOf(2), strT4) || strT5.length() > 0) {
                throw new IOException("unexpected journal header: [" + strT + ", " + strT2 + ", " + strT4 + ", " + strT5 + ']');
            }
            int i = 0;
            while (true) {
                try {
                    Y(b0Var.t(Long.MAX_VALUE));
                    i++;
                    ...
                    if (b0Var.a()) {
                        ...
                        gVar.getClass();
                        xVar.getClass();
                        this.E = new z(new i(gVar.a(xVar), new kotlinx.serialization.descriptors.f(this, 2)));
                    } else {
                        Z();
                    }
                    try {
    ...
    public final void Y(String str) throws IOException {
        ...
        if (iG2 == -1) {
            ...
            String str2 = T;
            if (iG == str2.length() && r.u(str, str2, false)) {
        ...
        if (iG2 != -1) {
            String str3 = R;
            if (iG == str3.length() && r.u(str, str3, false)) {
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size2; i2++) {
                        dVar.b[i2] = Long.parseLong((String) listV.get(i2));
                    }
                    return;
        ...
        if (iG2 == -1) {
            String str4 = S;
            if (iG == str4.length() && r.u(str, str4, false)) {
        ...
        if (iG2 == -1) {
            String str5 = U;
            if (iG == str5.length() && r.u(str, str5, false)) {
                return;
            }
        }
        kotlinx.coroutines.future.a.w("unexpected journal line: ".concat(str));
    ...
    public final synchronized void Z() {
        ...
        try {
            ...
            gVar2.getClass();
            xVar.getClass();
            this.E = new z(new i(gVar2.a(xVar), new kotlinx.serialization.descriptors.f(this, 2)));
            this.H = false;
            this.M = false;
        } catch (Throwable th5) {
            throw th5;
    ...
    public final synchronized b1 n(String str, long j) {
        str.getClass();
        A();
        a();
        c0(str);
