...
public final class c {
    ...
    public final boolean f(a aVar, long j, boolean z) {
        ...
        if (cVar != this) {
            if (cVar != null) {
                kotlinx.coroutines.future.a.u("task is in multiple queues");
                return false;
            }
            aVar.c = this;
        }
        ...
        if (iIndexOf == -1) {
            ...
            if (logger.isLoggable(Level.FINE)) {
                if (z) {
                    strConcat = "run again after ".concat(h.e(j2 - jNanoTime));
                } else {
                    strConcat = "scheduled after ".concat(h.e(j2 - jNanoTime));
                }
                h.a(logger, aVar, this, strConcat);
            }
