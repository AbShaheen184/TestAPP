...
public final class d {
    ...
    static {
        ...
        q qVar = new q();
        qVar.e = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue(), fVar);
        l = new d(qVar);
    }
    ...
    public final c d() {
        ...
        return new c(this, androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Q"));
    }
