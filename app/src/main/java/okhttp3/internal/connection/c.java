...
public final class c implements r, okhttp3.internal.http.d {
    ...
    public okhttp3.q s;
    public z t;
    public com.google.android.datatransport.runtime.j u;
    public n v;
    ...
    @Override // okhttp3.internal.connection.r
    public final n d() {
        com.google.android.material.behavior.d dVar = this.i.e.D;
        k0 k0Var = this.k;
        synchronized (dVar) {
            k0Var.getClass();
            ((LinkedHashSet) dVar.e).remove(k0Var);
        }
        n nVar = this.v;
        nVar.getClass();
        this.k.getClass();
    ...
    public final q e() {
        ...
        if (this.q != null) {
            kotlinx.coroutines.future.a.u("TCP already connected");
            return null;
        }
    ...
    public final q g() throws Throwable {
        ...
        if (socket2 == null) {
            kotlinx.coroutines.future.a.q("TCP not connected");
            return null;
        }
        if (a()) {
            kotlinx.coroutines.future.a.u("already connected");
            return null;
        }
        k0 k0Var = this.k;
        okhttp3.a aVar2 = k0Var.a;
        ...
        try {
            try {
                ...
                if (aVar3.c != null) {
                    com.google.android.datatransport.runtime.j jVar = this.u;
                    if (jVar == null) {
                        kotlin.jvm.internal.l.f("socket");
                        throw null;
                    }
                    if (((okio.b0) jVar.z).y.X()) {
                        com.google.android.datatransport.runtime.j jVar2 = this.u;
                        if (jVar2 == null) {
                            kotlin.jvm.internal.l.f("socket");
                            throw null;
                        }
                        if (((okio.z) jVar2.A).y.X()) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                zVar2.getClass();
                                try {
                                    com.google.android.datatransport.runtime.j jVar3 = this.u;
                                    try {
                                        if (jVar3 == null) {
                                            kotlin.jvm.internal.l.f("socket");
                                            throw null;
                                        ...
                                        aVar.getClass();
                                        cVar = null;
                                        n nVar = new n(dVar, aVar4, k0Var2, socket2, socket4, qVar, zVar2, jVar3, i);
                                        this.v = nVar;
                                        nVar.i();
    ...
    public final void i() throws IOException {
        ...
        try {
            ...
            try {
                this.u = new com.google.android.datatransport.runtime.j(new com.google.firebase.messaging.n(socketCreateSocket));
    ...
    public final void j(SSLSocket sSLSocket, okhttp3.l lVar) {
        ...
        try {
            ...
            session.getClass();
            okhttp3.q qVarC = dagger.internal.d.c(session);
            HostnameVerifier hostnameVerifier = aVar.d;
            hostnameVerifier.getClass();
            if (hostnameVerifier.verify(aVar.h.d, session)) {
                okhttp3.i iVar = aVar.e;
                iVar.getClass();
                this.s = new okhttp3.q(qVarC.a, qVarC.b, qVarC.c, new androidx.compose.foundation.gestures.g(23, iVar, qVarC, aVar));
                aVar.h.d.getClass();
                ...
                this.r = sSLSocket;
                this.u = new com.google.android.datatransport.runtime.j(new com.google.firebase.messaging.n(sSLSocket));
                if (strF != null) {
                    z.y.getClass();
                    zVarH = okhttp3.b.h(strF);
                } else {
                    zVarH = z.HTTP_1_1;
                }
                this.t = zVarH;
            ...
            encoded.getClass();
            sb2.append(a0.h(encoded).e("SHA-256").a());
            sb.append(sb2.toString());
            sb.append("\n            |    DN: ");
            sb.append(x509Certificate.getSubjectDN().getName());
            sb.append("\n            |    subjectAltNames: ");
            sb.append(kotlin.collections.p.O(okhttp3.internal.tls.c.a(x509Certificate, 7), okhttp3.internal.tls.c.a(x509Certificate, 2)));
            sb.append("\n            ");
    ...
    public final q k() throws IOException {
        ...
        okhttp3.internal.http1.f fVar = new okhttp3.internal.http1.f(null, this, jVar);
        com.google.android.datatransport.runtime.j jVar2 = this.u;
        if (jVar2 == null) {
            kotlin.jvm.internal.l.f("socket");
            throw null;
        }
        j0 j0VarE = ((okio.b0) jVar2.z).e.e();
        long j = this.c;
        ...
        ((okio.z) jVar3.A).e.e().g(this.d, timeUnit);
        fVar.l(b0Var.c, str);
        fVar.a();
        ...
        if (i != 407) {
            kotlinx.coroutines.future.a.w(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Unexpected response code for CONNECT: "));
            return null;
        }
        k0Var.a.f.getClass();
        kotlinx.coroutines.future.a.w("Failed to authenticate with proxy");
        return null;
    }
    ...
    public final c l(List list, SSLSocket sSLSocket) {
        ...
        for (int i2 = i + 1; i2 < size; i2++) {
            ...
            lVar.getClass();
            if (lVar.a && (((strArr = lVar.d) == null || okhttp3.internal.e.h(strArr, sSLSocket.getEnabledProtocols(), kotlin.comparisons.b.y)) && ((strArr2 = lVar.c) == null || okhttp3.internal.e.h(strArr2, sSLSocket.getEnabledCipherSuites(), okhttp3.k.c)))) {
