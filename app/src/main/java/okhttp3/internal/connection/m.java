...
public final class m implements Cloneable {
    ...
    public final void d(okhttp3.h hVar) {
        if (!this.C.compareAndSet(false, true)) {
            kotlinx.coroutines.future.a.u("Already Executed");
            return;
        }
        okhttp3.internal.platform.e eVar = okhttp3.internal.platform.e.a;
        this.D = okhttp3.internal.platform.e.a.g();
        com.google.firebase.messaging.n nVar = this.e.a;
        j jVar = new j(this, hVar);
        nVar.getClass();
        com.google.firebase.messaging.n.D(nVar, jVar, null, null, 6);
    }
    ...
    public final g0 e() {
        ...
        try {
            com.google.firebase.messaging.n nVar = this.e.a;
            synchronized (nVar) {
                ((ArrayDeque) nVar.A).add(this);
            }
            g0 g0VarG = g();
            com.google.firebase.messaging.n nVar2 = this.e.a;
            nVar2.getClass();
            com.google.firebase.messaging.n.D(nVar2, null, this, null, 5);
            return g0VarG;
        } catch (Throwable th) {
            com.google.firebase.messaging.n nVar3 = this.e.a;
            nVar3.getClass();
            com.google.firebase.messaging.n.D(nVar3, null, this, null, 5);
            throw th;
        }
    }
    ...
    public final g0 g() {
        ...
        kotlin.collections.p.t(arrayList, this.e.b);
        ...
        arrayList.add(a.a);
        if (!this.z) {
            kotlin.collections.p.t(arrayList, this.e.c);
        }
