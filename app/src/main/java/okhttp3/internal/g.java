...
public abstract class g {
    ...
    static {
        ...
        timeZone.getClass();
        a = timeZone;
        b = k.Q(k.P(y.class.getName(), "okhttp3."), "Client");
    }
    ...
    public static final int b(String str, long j) {
        ...
        timeUnit.getClass();
        if (j < 0) {
            kotlinx.coroutines.future.a.c(str.concat(" < 0"));
            return 0;
        }
        long millis = timeUnit.toMillis(j);
        if (millis > 2147483647L) {
            kotlinx.coroutines.future.a.s(str.concat(" too large"));
            return 0;
        }
        if (millis != 0 || j <= 0) {
            return (int) millis;
        }
        kotlinx.coroutines.future.a.s(str.concat(" too small"));
        return 0;
    }
    ...
    public static final r h(List list) {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(strU);
            arrayList.add(k.g0(strU2).toString());
        }
    ...
    public static final String i(s sVar, boolean z) {
        ...
        String strM = sVar.d;
        if (k.z(strM, ":", false)) {
            strM = androidx.privacysandbox.ads.adservices.java.internal.a.m(']', "[", strM);
        }
        if (!z) {
            String str = sVar.a;
            str.getClass();
