...
public final class b implements t {
    ...
    public final g0 a(u uVar) throws Throwable {
        ...
        boolean z = false;
        ?? r14 = 1;
        boolean z2 = kotlin.enums.b.d(b0Var.b) && e0Var != null;
            ...
            try {
                ...
                try {
                    ...
                    if (zEqualsIgnoreCase && z) {
                        f0 f0VarN3 = g0VarA2.n();
                        f0VarN3.g = new okhttp3.internal.c(j0Var.x(), j0Var.n());
                        f0VarN3.h = b1Var.s();
                        g0VarA = f0VarN3.a();
                        i = i2;
                    } else {
                    ...
                    if ((i != 204 && i != 205) || g0VarA.D.n() <= 0) {
                        return g0VarA;
                    }
                    throw new ProtocolException("HTTP " + i + " had non-zero Content-Length: " + g0VarA.D.n());
