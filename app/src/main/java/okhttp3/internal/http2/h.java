...
public abstract class h {
    ...
    static {
        ...
        a = com.google.android.gms.measurement.internal.a0.g("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    public static String b(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (i4 == 0) {
            ...
            if (i3 == 2 || i3 == 3) {
                ...
                if (i3 != 5 || (i4 & 4) == 0) {
                    strS = (i3 != 0 || (i4 & 32) == 0) ? str : kotlin.text.r.s(str, "PRIORITY", "COMPRESSED", false);
                } else {
                    strS = kotlin.text.r.s(str, "HEADERS", "PUSH_PROMISE", false);
                }
            }
        }
        return okhttp3.internal.g.d("%s 0x%08x %5d %-13s %s", z ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), strA, strS);
    }
