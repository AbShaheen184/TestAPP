...
import com.appsalt.internal.u1;
...
public final class g implements Closeable {
    ...
    public final void a() throws IOException {
        ...
        while (!this.B) {
            ...
            if (this.E) {
                ...
                if (i == 1) {
                    ...
                    n4Var.a.getClass();
                    n4Var.h.mo28trySendJP2dKIU(new u1(strI0.getBytes(kotlin.text.a.a)));
                    return;
                }
                i iVarL = fVar.l(fVar.y);
                iVarL.getClass();
                if (!l.a(n4Var.e, eVar)) {
                    m mVar2 = eVar.h;
                    mVar2.getClass();
                ...
                n4Var.a.getClass();
                n4Var.h.mo28trySendJP2dKIU(new u1(iVarL.t()));
                return;
            }
            while (!this.B) {
                n();
        ...
        kotlinx.coroutines.future.a.w("closed");
    }
        ...
        switch (this.C) {
            case 8:
                ...
                if (j2 != 0) {
                    ...
                    strI0 = this.H.i0();
                    if (s < 1000 || s >= 5000) {
                        strN = androidx.privacysandbox.ads.adservices.java.internal.a.n(s, "Code must be in range [1000,5000): ");
                    } else {
                        strN = ((1004 > s || s >= 1007) && (1015 > s || s >= 3000)) ? null : androidx.privacysandbox.ads.adservices.java.internal.a.q("Code ", s, " is reserved and may not be used.");
                    }
                    if (strN != null) {
                        throw new ProtocolException(strN);
                    }
                } else {
                    strI0 = "";
                    s = 1005;
