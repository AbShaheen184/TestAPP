...
public final class h implements Closeable {
    ...
    public final void a(int i, i iVar) {
        ...
        int iF = iVar.f();
        if (iF > 125) {
            kotlinx.coroutines.future.a.q("Payload size must be less than or equal to 125");
            return;
        }
        okio.f fVar = this.D;
        fVar.o0(i | 128);
    ...
    public final void g(i iVar) throws IOException {
        ...
        if (j2 > 125) {
            ...
            if (j2 > r5) {
                ...
                fVar.c0(eVar2);
                eVar2.g(0L);
                dagger.internal.d.f(eVar2, bArr);
                eVar2.close();
            }
            fVar3.E(fVar, j2);
            this.e.flush();
        ...
        if (j2 > r5) {
            ...
            fVar.c0(eVar3);
            eVar3.g(0L);
            dagger.internal.d.f(eVar3, bArr);
            eVar3.close();
        }
        fVar3.E(fVar, j2);
        this.e.flush();
