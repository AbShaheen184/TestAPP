...
public final class l {
    ...
    static {
        ...
        k kVar8 = k.q;
        k kVar9 = k.p;
        List listK = kotlin.collections.q.k(kVar, kVar2, kVar3, kVar4, kVar5, kVar6, kVar7, kVar8, kVar9);
        List listK2 = kotlin.collections.q.k(kVar, kVar2, kVar3, kVar4, kVar5, kVar6, kVar7, kVar8, kVar9, k.j, k.k, k.h, k.i, k.f, k.g, k.e);
        a2 a2Var = new a2();
        k[] kVarArr = (k[]) listK.toArray(new k[0]);
        ...
        a2Var.a();
        a2 a2Var2 = new a2();
        k[] kVarArr2 = (k[]) listK2.toArray(new k[0]);
        a2Var2.b((k[]) Arrays.copyOf(kVarArr2, kVarArr2.length));
        a2Var2.c(l0Var, l0Var2);
        a2Var2.b = true;
        e = a2Var2.a();
        a2 a2Var3 = new a2();
        k[] kVarArr3 = (k[]) listK2.toArray(new k[0]);
    ...
    public final void a(SSLSocket sSLSocket, boolean z) {
        ...
        if (strArr2 != null) {
            ...
            enabledProtocols = okhttp3.internal.e.l(enabledProtocols2, strArr2, kotlin.comparisons.b.y);
        } else {
