...
public final class c implements t {
    ...
    public final g0 a(u uVar) throws Exception {
        ...
        try {
            ...
            j0Var.getClass();
            long jN = j0Var.n();
            String str3 = jN != -1 ? jN + "-byte" : "unknown-length";
            b bVar2 = this.a;
            ...
            if (z2) {
                ...
                if (z && okhttp3.internal.http.f.a(g0VarF)) {
                    ...
                    okhttp3.u uVarX = g0VarF.D.x();
                    if (uVarX != null && uVarX.b.equals("text") && uVarX.c.equals("event-stream")) {
                    ...
                    okhttp3.u uVarX2 = j0Var.x();
                    if (uVarX2 == null || (charsetA = okhttp3.u.a(uVarX2)) == null) {
                        charsetA = kotlin.text.a.a;
                    }
                    if (!c0.h(fVarD)) {
                        this.a.d("");
                        b bVar3 = this.a;
                        StringBuilder sbO = j.o(jNanoTime3, "<-- END HTTP (", "ms, binary ");
                        sbO.append(fVarD.y);
                        sbO.append("-byte body omitted)");
                        bVar3.d(sbO.toString());
                        return g0VarF;
                    }
                    if (jN != 0) {
                        this.a.d("");
                        this.a.d(fVarD.clone().C(charsetA));
                    }
                    b bVar4 = this.a;
                    StringBuilder sb4 = new StringBuilder();
                    StringBuilder sbO2 = j.o(jNanoTime3, "<-- END HTTP (", "ms, ");
                    sbO2.append(fVarD.y);
                    sbO2.append("-byte");
                    sb4.append(sbO2.toString());
                    if (lValueOf != null) {
