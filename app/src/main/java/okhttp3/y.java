...
public final class y {
    ...
    public final int B;
    public final long C;
    public final com.google.android.material.behavior.d D;
    public final okhttp3.internal.concurrent.d E;
    public final com.google.android.material.behavior.d F;
    public final com.google.firebase.messaging.n a;
    public final List b;
    public final List c;
    public final kotlinx.coroutines.future.a d;
    ...
    public final i u;
    public final dagger.hilt.android.internal.b v;
    public final int w;
    public final int x;
    public final int y;
    public final int z;
    ...
    public y(x xVar) throws NoSuchAlgorithmException, KeyStoreException {
        ...
        this.B = xVar.C;
        this.C = xVar.D;
        com.google.android.material.behavior.d dVar = xVar.E;
        this.D = dVar == null ? new com.google.android.material.behavior.d(14, false) : dVar;
        okhttp3.internal.concurrent.d dVar2 = xVar.F;
        this.E = dVar2 == null ? okhttp3.internal.concurrent.d.l : dVar2;
        com.google.android.material.behavior.d dVar3 = xVar.b;
        if (dVar3 == null) {
            dVar3 = new com.google.android.material.behavior.d(5);
            xVar.b = dVar3;
        }
        this.F = dVar3;
        ...
        while (true) {
            ...
            if (((l) it.next()).a) {
                ...
                if (sSLSocketFactory != null) {
                    ...
                    dagger.hilt.android.internal.b bVar = xVar.w;
                    bVar.getClass();
                    this.v = bVar;
                    ...
                    i iVar = xVar.v;
                    iVar.getClass();
                    this.u = kotlin.jvm.internal.l.a(iVar.b, bVar) ? iVar : new i(iVar.a, bVar);
                    break;
                }
                ...
                if (trustManagers.length == 1) {
                    ...
                    if (trustManager instanceof X509TrustManager) {
                        ...
                        try {
                            ...
                            dagger.hilt.android.internal.b bVarC = okhttp3.internal.platform.e.a.c(x509TrustManager2);
                            this.v = bVarC;
                            i iVar2 = xVar.v;
                            iVar2.getClass();
                ...
                string.getClass();
                kotlinx.coroutines.future.a.c("Unexpected default trust managers: ".concat(string));
                throw null;
            }
        }
        X509TrustManager x509TrustManager3 = this.q;
        dagger.hilt.android.internal.b bVar2 = this.v;
        SSLSocketFactory sSLSocketFactory2 = this.p;
        List list2 = this.c;
        List list3 = this.b;
        list3.getClass();
        if (list3.contains(null)) {
            kotlinx.coroutines.future.a.e(list3, "Null interceptor: ");
            throw null;
        }
        list2.getClass();
        if (list2.contains(null)) {
            kotlinx.coroutines.future.a.e(list2, "Null network interceptor: ");
            throw null;
        }
        List list4 = this.r;
            ...
            while (it2.hasNext()) {
                if (((l) it2.next()).a) {
                    if (sSLSocketFactory2 == null) {
                        kotlinx.coroutines.future.a.u("sslSocketFactory == null");
                        throw null;
                    }
                    if (bVar2 == null) {
                        kotlinx.coroutines.future.a.u("certificateChainCleaner == null");
                        throw null;
                    }
                    if (x509TrustManager3 != null) {
                        return;
                    }
                    kotlinx.coroutines.future.a.u("x509TrustManager == null");
                    throw null;
                }
            }
        }
    ...
    public final x a() {
        ...
        xVar.a = this.a;
        xVar.b = this.F;
        kotlin.collections.p.t(xVar.c, this.b);
        kotlin.collections.p.t(xVar.d, this.c);
        xVar.e = this.d;
        xVar.f = this.e;
        xVar.g = this.f;
        xVar.h = this.g;
    ...
    public final okhttp3.internal.ws.e b(b0 b0Var, n4 n4Var) {
        ...
        xVarA.e = new kotlinx.coroutines.future.a();
        ...
        eVar.h = mVar;
        mVar.d(new com.google.android.material.internal.k(21, eVar, b0Var2));
        return eVar;
    }
