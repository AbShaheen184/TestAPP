...
public final class e implements Closeable {
    ...
    public final void a(long j) {
        f fVar = this.e;
        if (fVar == null) {
            kotlinx.coroutines.future.a.u("not attached to a buffer");
            return;
        }
        if (!this.y) {
            kotlinx.coroutines.future.a.u("resizeBuffer() only permitted for read/write buffers");
            return;
        }
        long j2 = fVar.y;
        if (j <= j2) {
            if (j < 0) {
                kotlinx.coroutines.future.a.s(androidx.compose.runtime.j.h("newSize < 0: ", j));
                return;
            }
            long j3 = j2 - j;
            while (j3 > 0) {
    ...
    public final int g(long j) {
        ...
        StringBuilder sbO = androidx.compose.runtime.j.o(j, "offset=", " > size=");
        sbO.append(fVar.y);
