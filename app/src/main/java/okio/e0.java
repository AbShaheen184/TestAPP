...
public final class e0 extends i {
    ...
    public final i q(int i, int i2) {
        ...
        if (i < 0) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.q("beginIndex=", i, " < 0"));
            return null;
        }
        if (i2 > f()) {
        ...
        int i3 = i2 - i;
        if (i3 < 0) {
            kotlinx.coroutines.future.a.s(androidx.compose.runtime.j.g("endIndex=", i2, " < beginIndex=", i));
            return null;
        }
        if (i == 0 && i2 == f()) {
            return this;
        ...
        byte[][] bArr = this.B;
        byte[][] bArr2 = (byte[][]) kotlin.collections.o.l(bArr, i4, i5 + 1);
    ...
    public final byte[] t() {
        ...
        while (i < length) {
            ...
            int i5 = iArr[i];
            int i6 = i5 - i2;
            kotlin.collections.o.g(bArr2[i], i3, bArr, i4, i4 + i6);
            i3 += i6;
            i++;
            i2 = i5;
        }
