...
public final class f implements h, g, Cloneable, ByteChannel {
    ...
    public final void E(f fVar, long j) {
        ...
        fVar.getClass();
        if (fVar == this) {
            kotlinx.coroutines.future.a.q("source == this");
            return;
        }
        b.d(fVar.y, 0L, j);
        while (j > 0) {
            ...
            if (j < j2) {
                ...
                if (i3 <= 0 || i3 > c0Var6.c - c0Var6.b) {
                    kotlinx.coroutines.future.a.q("byteCount out of range");
                    return;
                }
                if (i3 >= 1024) {
                    c0VarB = c0Var6.c();
                    ...
                    byte[] bArr2 = c0VarB.a;
                    int i4 = c0Var6.b;
                    kotlin.collections.o.g(bArr, 0, bArr2, i4, i4 + i3);
                }
            ...
            if (c0Var9 == null) {
                ...
                c0 c0Var11 = c0Var8.g;
                if (c0Var11 == c0Var8) {
                    kotlinx.coroutines.future.a.u("cannot compact");
                    return;
                }
                c0Var11.getClass();
                if (c0Var11.e) {
    ...
    public final e c0(e eVar) {
        ...
        if (eVar.e != null) {
            kotlinx.coroutines.future.a.u("already attached to a buffer");
            return null;
        }
        eVar.e = this;
        eVar.y = true;
    ...
    public final byte[] d0(long j) throws EOFException {
        if (j < 0 || j > 2147483647L) {
            kotlinx.coroutines.future.a.s(androidx.compose.runtime.j.h("byteCount: ", j));
            return null;
        }
        if (this.y < j) {
            throw new EOFException();
    ...
    public final i k0(int i) {
        ...
        while (i3 < i) {
            ...
            int i6 = c0Var.b;
            if (i5 == i6) {
                kotlinx.coroutines.future.a.o("s.limit == s.pos");
                return null;
            }
            i3 += i5 - i6;
            i4++;
    ...
    @Override // okio.h
    public final i l(long j) throws EOFException {
        if (j < 0 || j > 2147483647L) {
            kotlinx.coroutines.future.a.s(androidx.compose.runtime.j.h("byteCount: ", j));
            return null;
        }
    ...
    public final c0 l0(int i) {
        if (i < 1 || i > 8192) {
            kotlinx.coroutines.future.a.q("unexpected capacity");
            return null;
        }
        c0 c0Var = this.e;
        if (c0Var == null) {
    ...
    public final int read(byte[] bArr, int i, int i2) {
        ...
        byte[] bArr2 = c0Var.a;
        int i3 = c0Var.b;
        kotlin.collections.o.g(bArr2, i, bArr, i3, i3 + iMin);
        int i4 = c0Var.b + iMin;
        c0Var.b = i4;
        this.y -= (long) iMin;
        if (i4 == c0Var.c) {
    ...
    public final String t(long j) throws EOFException {
        ...
        throw new EOFException("\\n not found: limit=" + Math.min(this.y, j) + " content=" + fVar.l(fVar.y).g() + (char) 8230);
    }
    ...
    public final void t0(int i, int i2, String str) {
        ...
        str.getClass();
        if (i < 0) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "beginIndex < 0: "));
            return;
        }
        if (i2 < i) {
            kotlinx.coroutines.future.a.s(androidx.compose.runtime.j.g("endIndex < beginIndex: ", i2, " < ", i));
            return;
        }
        if (i2 > str.length()) {
            kotlinx.coroutines.future.a.k(androidx.privacysandbox.ads.adservices.java.internal.a.v("endIndex > string.length: ", i2, " > "), str.length());
            return;
        }
        while (i < i2) {
    ...
    public final void v0(int i) {
        ...
        if (i > 1114111) {
            kotlinx.coroutines.future.a.q("Unexpected code point: 0x".concat(b.g(i)));
            return;
        }
        c0 c0VarL2 = l0(4);
        byte[] bArr3 = c0VarL2.a;
    ...
    @Override // okio.g
    public final /* bridge */ /* synthetic */ g w(byte[] bArr, int i) {
        write(bArr, 0, i);
        return this;
    }
    ...
    public final void write(byte[] bArr, int i, int i2) {
        ...
        while (i < i3) {
            ...
            int i4 = i + iMin;
            kotlin.collections.o.g(bArr, c0VarL0.c, c0VarL0.a, i, i4);
            c0VarL0.c += iMin;
            i = i4;
        }
        this.y += j;
