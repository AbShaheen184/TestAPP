...
public class i implements Serializable, Comparable {
    ...
    public i q(int i, int i2) {
        ...
        if (i < 0) {
            kotlinx.coroutines.future.a.q("beginIndex < 0");
            return null;
        }
        byte[] bArr = this.e;
        if (i2 > bArr.length) {
            kotlinx.coroutines.future.a.s(androidx.privacysandbox.ads.adservices.java.internal.a.t(new StringBuilder("endIndex > length("), bArr.length, ')'));
            return null;
        }
        if (i2 - i >= 0) {
            return (i == 0 && i2 == bArr.length) ? this : new i(kotlin.collections.o.k(bArr, i, i2));
        }
        kotlinx.coroutines.future.a.q("endIndex < beginIndex");
        return null;
    }
    ...
    public String toString() {
        ...
        if (i3 != -1) {
            String strU = u();
            String strS = kotlin.text.r.s(kotlin.text.r.s(kotlin.text.r.s(strU.substring(0, i3), "\\", "\\\\", false), "\n", "\\n", false), "\r", "\\r", false);
            if (i3 >= strU.length()) {
                return androidx.privacysandbox.ads.adservices.java.internal.a.m(']', "[text=", strS);
            }
            return "[size=" + bArr.length + " text=" + strS + "…]";
        }
        if (bArr.length <= 64) {
            return "[hex=" + g() + ']';
        }
        ...
        sb.append((64 == bArr.length ? this : new i(kotlin.collections.o.k(bArr, 0, 64))).g());
        sb.append("…]");
        return sb.toString();
    }
