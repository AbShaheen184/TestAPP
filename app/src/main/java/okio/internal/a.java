...
public abstract class a {
    ...
    public static final long a(okio.f fVar, okio.i iVar, long j, long j2, int i) {
        ...
        if (i <= 0) {
            kotlinx.coroutines.future.a.q("byteCount == 0");
            return 0L;
        }
        long j6 = 0;
        if (j3 < 0) {
            kotlinx.coroutines.future.a.s(androidx.compose.runtime.j.h("fromIndex < 0: ", j3));
            return 0L;
        }
        if (j3 > j4) {
            StringBuilder sbO = androidx.compose.runtime.j.o(j3, "fromIndex > toIndex: ", " > ");
            sbO.append(j4);
