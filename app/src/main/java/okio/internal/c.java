...
public abstract class c {
    ...
    public static final x d(okio.f fVar, boolean z) throws EOFException {
        ...
        if (z3) {
            ...
            if (i2 <= 0) {
                ...
                while (true) {
                    ...
                    iVar3 = e;
                    if (kotlin.jvm.internal.l.a(iVarL, iVar3)) {
                        if (z2 || !arrayList.isEmpty()) {
                            if (z || (!z2 && (arrayList.isEmpty() || kotlin.jvm.internal.l.a(p.J(arrayList), iVar3)))) {
                                arrayList.add(iVarL);
                            } else if (!z3 || arrayList.size() != 1) {
                                p.T(arrayList);
                            }
                        }
                    } else if (kotlin.jvm.internal.l.a(iVarL, iVar2) && !kotlin.jvm.internal.l.a(iVarL, okio.i.A)) {
                        arrayList.add(iVarL);
                    }
                }
                size = arrayList.size();
        ...
        while (true) {
            ...
            if (kotlin.jvm.internal.l.a(iVarL, iVar3)) {
                ...
                arrayList.add(iVarL);
            } else if (kotlin.jvm.internal.l.a(iVarL, iVar2)) {
            }
        }
        size = arrayList.size();
        while (i < size) {
    ...
    public static final okio.i e(byte b2) {
        ...
        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(b2, "not a directory separator: "));
        return null;
    }
    ...
    public static final okio.i f(String str) {
        ...
        kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("not a directory separator: ", str));
        return null;
    }
}
