...
public final class p implements h0 {
    ...
    public static void a(int i, int i2, String str) throws IOException {
        ...
        sbD.append(kotlin.text.k.N(8, b.g(i2)));
        sbD.append(" != expected 0x");
        sbD.append(kotlin.text.k.N(8, b.g(i)));
    ...
    public final long K(f fVar, long j) throws IOException {
        ...
        if (pVar.e == 2) {
            a(b0Var.x(), (int) crc32.getValue(), "CRC");
            a(b0Var.x(), (int) pVar.z.getBytesWritten(), "ISIZE");
            pVar.e = (byte) 3;
            if (!b0Var.a()) {
                kotlinx.coroutines.future.a.w("gzip finished without exhausting source");
                return 0L;
            }
        }
        return -1L;
