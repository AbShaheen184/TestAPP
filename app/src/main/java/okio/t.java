...
public class t extends k {
    ...
    public final void A(x xVar) throws IOException {
        ...
        kotlinx.coroutines.future.a.x(xVar, "failed to delete ");
    }
    ...
    public final List X(x xVar) throws IOException {
        ...
        if (list == null) {
            if (file.exists()) {
                kotlinx.coroutines.future.a.x(xVar, "failed to list ");
                return null;
            }
    ...
    public final void x(x xVar) throws IOException {
        ...
        if (eVarZ == null || !eVarZ.c) {
            kotlinx.coroutines.future.a.x(xVar, "failed to create directory: ");
        }
    }
}
