...
public final class x implements Comparable {
    ...
    public final x f(x xVar) {
        ...
        if (!kotlin.jvm.internal.l.a(xVar2, iA2 != -1 ? new x(iVar.q(0, iA2)) : null)) {
            kotlinx.coroutines.future.a.h("Paths of different roots cannot be relative to each other: ", this, " and ", xVar);
            return null;
        }
        ...
        if (i == iMin && iVar2.f() == iVar.f()) {
            return com.google.android.gms.measurement.internal.b0.d(".");
        }
        if (arrayListA2.subList(i, arrayListA2.size()).indexOf(okio.internal.c.e) != -1) {
            kotlinx.coroutines.future.a.h("Impossible relative path to resolve: ", this, " and ", xVar);
            return null;
        }
