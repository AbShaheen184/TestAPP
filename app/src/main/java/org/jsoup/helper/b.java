...
public abstract class b {
    ...
    public static com.google.android.datatransport.runtime.j a(org.jsoup.internal.a aVar, String str, String str2, e0 e0Var) throws IOException {
        String str3;
        w wVar;
        ...
        if (str == null) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            reentrantLock.lock();
                            l3 l3Var = e0Var.e;
                            l3Var.i(eVar, str2, e0Var);
                            l3Var.p();
                            org.jsoup.nodes.g gVar2 = l3Var.d;
                            ...
                            n.D(pVar);
                            String strD = null;
                            for (org.jsoup.nodes.j jVar : q.f(pVar, gVar2)) {
            ...
            n.B(str, "Must set charset arg to character set of file to parse. Set to null to attempt to detect from HTML");
        }
        if (str == null) {
            str = str4;
        }
        ...
        com.google.android.datatransport.runtime.j jVar2 = new com.google.android.datatransport.runtime.j(25, false);
        jVar2.y = charsetForName;
        jVar2.z = aVar;
        jVar2.A = gVar;
        return jVar2;
    }
    ...
    public static org.jsoup.nodes.g c(com.google.android.datatransport.runtime.j jVar, String str, e0 e0Var) {
        org.jsoup.nodes.g gVar = (org.jsoup.nodes.g) jVar.A;
        if (gVar != null) {
            return gVar;
        }
        org.jsoup.internal.a aVar = (org.jsoup.internal.a) jVar.z;
        Charset charset = (Charset) jVar.y;
