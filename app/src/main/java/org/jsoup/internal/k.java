...
public abstract class k {
    ...
    public static final com.google.android.material.internal.k e = new com.google.android.material.internal.k(new c(2));
    ...
    public static Collector k(String str) {
        return Collector.of(new g(str, 0), new h(), new i(0), new androidx.media3.exoplayer.audio.f(5), new Collector.Characteristics[0]);
    }
    ...
    public static URL m(URL url, String str) {
        ...
        if (url2.getRef() != null) {
            StringBuilder sbD = androidx.constraintlayout.core.g.d(strReplaceFirst, "#");
            sbD.append(url2.getRef());
            strReplaceFirst = sbD.toString();
        }
