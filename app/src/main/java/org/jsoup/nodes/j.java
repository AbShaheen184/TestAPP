...
public class j extends o implements Iterable {
    ...
    public final org.jsoup.select.e V(String str) {
        ...
        return kotlin.collections.q.f(new org.jsoup.select.h(2, str, false), this);
    }

    public final org.jsoup.select.e W(String str) {
        org.jsoup.helper.n.A(str);
        return kotlin.collections.q.f(new org.jsoup.select.h(9, org.jsoup.internal.b.d(str), false), this);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r6v1, types: [com.google.android.datatransport.runtime.j] */
    /* JADX WARN: Type inference failed for: r6v2, types: [org.jsoup.select.u] */
    /* JADX WARN: Type inference failed for: r6v3, types: [com.google.android.datatransport.runtime.j, org.jsoup.nodes.q] */
    public final String X() {
        ...
        if (oVarP != null) {
            ...
            fVar.getClass();
            if (fVar.z) {
                jVar = new q(26, oVarP, bVarE, fVar);
                jVar.C = false;
                ...
                jVar = new com.google.android.datatransport.runtime.j(26, oVarP, bVarE, fVar);
            }
            while (oVarP != null) {
                jVar.j(oVarP);
                oVarP = oVarP.u();
    ...
    public final org.jsoup.select.e b0(String str) {
        org.jsoup.helper.n.A(str);
        return kotlin.collections.q.f(org.jsoup.select.v.Z(str), this);
    }
    ...
    public final j c0(String str) {
        ...
        pVarZ.e();
        j jVar = (j) kotlin.collections.o.B(this, j.class).filter(new org.jsoup.select.f(pVarZ, this, 1)).findFirst().orElse(null);
        pVarZ.e();
        return jVar;
    }
    ...
    public final String d0() {
        StringBuilder sbB = org.jsoup.internal.k.b();
        new com.google.android.material.behavior.d(sbB).j(this);
        return org.jsoup.internal.k.l(sbB).trim();
    }
    ...
    public final void forEach(Consumer consumer) {
        kotlin.collections.o.B(this, j.class).forEach(consumer);
    }
