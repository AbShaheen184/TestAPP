...
public final class a implements AutoCloseable {
    public static final com.google.android.material.internal.k K = new com.google.android.material.internal.k(new org.jsoup.internal.c(4));
    public static final com.google.android.material.internal.k L = new com.google.android.material.internal.k(new org.jsoup.internal.c(5));
    public int A;
    public int B;
    public int C;
    public int D;
    ...
    public static String n(char[] cArr, String[] strArr, int i, int i2) {
        if (i2 > 12) {
    ...
    public final String A() {
        ...
        this.A = i3;
        return i3 > i ? n(this.z, this.e, i, i3 - i) : "";
    }
    ...
    public final String N(kotlinx.coroutines.future.a aVar) {
        g();
        int i = this.A;
        int i2 = this.B;
        char[] cArr = this.z;
    ...
    public final String X(char c) {
        ...
        String strN = n(this.z, this.e, this.A, i);
        this.A += i;
        return strN;
    }
    ...
    public final String a0() {
        ...
        int i = this.A;
        String strN = n(cArr, strArr, i, this.B - i);
        this.A = this.B;
        return strN;
    }
    ...
    public final void close() {
        com.google.android.material.internal.k kVar = K;
        com.google.android.material.internal.k kVar2 = L;
