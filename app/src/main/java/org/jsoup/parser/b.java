...
public final class b extends l3 {
    ...
    public final void I(i0 i0Var, boolean z2) {
        ...
        String strF = kVar.F();
        if (strF.indexOf(0) != -1) {
            String strReplace = z2 ? strF.replace((char) 0, (char) 65533) : strF.replace(i0.e, "");
            kVar.C();
            kVar.y = strReplace;
        }
        J(i0Var, b());
    ...
    public final void J(i0 i0Var, org.jsoup.nodes.j jVar) {
        ...
        if (i0Var instanceof h0) {
            eVar = new org.jsoup.nodes.c(strF);
        } else {
            eVar = jVar.A.b(LibretroCore.SCREEN_WIDTH) ? new org.jsoup.nodes.e(strF) : new org.jsoup.nodes.v(strF);
        }
        jVar.J(eVar);
    }

    public final void K(j0 j0Var) {
        b().J(new org.jsoup.nodes.d(j0Var.d.F()));
    }
        ...
        if (n0Var.f) {
            ...
            if (!f0Var.c()) {
                if ((f0Var.A & 1) == 0 || !f0Var.d()) {
                    ...
                    c0 c0Var = s0Var.b;
                    if (c0Var.b()) {
                        c0Var.add(new androidx.media3.exoplayer.dash.manifest.u(s0Var.a, "Tag [%s] cannot be self-closing; not a void tag", objArr));
                    }
                } else {
                    this.c.o(k3.e);
                    s0 s0Var2 = this.c;
    ...
    public final void W() {
        ...
        boolean z2 = true;
        org.jsoup.nodes.j jVar = this.r.size() > 0 ? (org.jsoup.nodes.j) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, this.r) : null;
    ...
    public final List a() {
        ...
        if (!list.isEmpty()) {
            ...
            org.jsoup.helper.n.y("Insert position out of bounds.", size >= 0);
            ...
            if ("http://www.w3.org/1999/xhtml".equals(jVar.A.e)) {
                ...
                switch (str) {
                    case "frameset":
                        ...
                        return false;
                    case "template":
                        b0 b0Var2 = this.s.size() > 0 ? (b0) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, this.s) : null;
                        if (b0Var2 == null) {
    ...
    public final boolean m(q0 q0Var) {
        ...
        if (!this.e.isEmpty()) {
            ...
            if (!"http://www.w3.org/1999/xhtml".equals(str)) {
                ...
                } else if ("http://www.w3.org/1998/Math/MathML".equals(str) || !jVarB.s("annotation-xml") || !q0Var.e() || !"svg".equals(((n0) q0Var).e)) {
        ...
        return (zC ? this.l : b0.U).f(q0Var, this);
    }
    ...
    public final org.jsoup.nodes.j x(n0 n0Var, String str, boolean z2) {
        ...
        f0 f0VarD = this.i.d(n0Var.d.F(), n0Var.e, str, (z2 ? d0.d : this.h).a);
    ...
    public final void y(org.jsoup.nodes.j jVar) {
        ...
        if (this.w && org.jsoup.internal.k.d(b().A.z, a0.z)) {
            ...
            if (jVarC != null) {
                ...
                if (z2) {
                    org.jsoup.helper.n.D(jVarC);
                    org.jsoup.helper.n.D(jVarC.e);
                    if (jVar.e == jVarC.e) {
                        jVar.F();
                    }
