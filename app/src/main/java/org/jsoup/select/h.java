...
public final class h extends p {
    ...
    public final boolean b(org.jsoup.nodes.j jVar, org.jsoup.nodes.j jVar2) {
        switch (this.a) {
            ...
            case 3:
                jVar2.getClass();
                StringBuilder sbB = org.jsoup.internal.k.b();
                new com.google.android.datatransport.runtime.scheduling.jobscheduling.j(sbB, 16).j(jVar2);
            ...
            case 7:
                jVar2.getClass();
                return ((String) kotlin.collections.o.B(jVar2, org.jsoup.nodes.o.class).map(new androidx.media3.exoplayer.audio.f(7)).collect(org.jsoup.internal.k.k(""))).contains(this.b);
            case 8:
    ...
    public final String toString() {
        switch (this.a) {
            case 0:
                return androidx.privacysandbox.ads.adservices.java.internal.a.r("[", this.b, "]");
            case 1:
                return androidx.privacysandbox.ads.adservices.java.internal.a.r("[^", this.b, "]");
            case 2:
                return androidx.compose.runtime.j.i(".", this.b);
            case 3:
                return androidx.privacysandbox.ads.adservices.java.internal.a.r(":containsData(", this.b, ")");
            case 4:
                return androidx.privacysandbox.ads.adservices.java.internal.a.r(":containsOwn(", this.b, ")");
            case 5:
                return androidx.privacysandbox.ads.adservices.java.internal.a.r(":contains(", this.b, ")");
            case 6:
                return androidx.privacysandbox.ads.adservices.java.internal.a.r(":containsWholeOwnText(", this.b, ")");
            case 7:
                return androidx.privacysandbox.ads.adservices.java.internal.a.r(":containsWholeText(", this.b, ")");
            case 8:
