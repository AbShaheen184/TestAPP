...
public final class v implements AutoCloseable {
    ...
    public static p Z(String str) {
        try {
            ...
            try {
                ...
                r0 r0Var = vVar.e;
                r0Var.x();
                org.jsoup.parser.a aVar = r0Var.e;
                if (!aVar.c0()) {
    ...
    public final p A(boolean z) {
        ...
        String strN = r0.N(n());
        org.jsoup.helper.n.B(strN, str.concat("(text) query must not be empty"));
  ...
  0x001d: PHI (r3v7 int) = (r3v0 int), (r3v5 int) binds: [B:6:0x001b, B:18:0x0057] A[DONT_GENERATE, DONT_INLINE]] */
    public final n L(boolean z, boolean z2) {
        String strD = org.jsoup.internal.b.d(n());
        int i = 1;
        int i2 = 2;
        if (!"odd".equals(strD)) {
            if ("even".equals(strD)) {
    ...
    public final p X(boolean z) {
        ...
        String strN = n();
        org.jsoup.helper.n.B(strN, str.concat("(regex) query must not be empty"));
        org.jsoup.helper.k kVarA = org.jsoup.helper.k.a(strN);
        if (this.z) {
            return new r(kVarA);
        }
    ...
    public final p a0() {
        ...
        while (true) {
            ...
            if (cX == ' ') {
                ...
                if (cX != '~') {
                    throw new androidx.media3.common.s("Unknown combinator '%s'", Character.valueOf(cX));
                }
    ...
    public final p c0() {
        ...
        if (Character.isLetterOrDigit(aVar.b0()) || aVar.j0("*|")) {
            ...
            while (!aVar.c0()) {
                char cB0 = aVar.b0();
                if (cB0 != '\\') {
                    if (!Character.isLetterOrDigit(aVar.b0()) && !aVar.h0(r0.y)) {
                        break;
                    }
                    sbB.append(cB0);
                    r0Var.a();
  ...
  (r5v0 int) from 0x0391: CONSTRUCTOR (r5v0 int) A[MD:(int):void (m), REMOVE, WRAPPED] (LINE:914) call: org.jsoup.select.g.<init>(int):void type: CONSTRUCTOR
    ...
    */
    ...
    public final int g() {
        ...
        org.jsoup.helper.n.y("Index must be numeric", z);
