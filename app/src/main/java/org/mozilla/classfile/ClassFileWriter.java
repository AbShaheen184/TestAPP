...
public class ClassFileWriter {
    ...
    public static void A(int i) {
        throw new IllegalStateException(i < 0 ? androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Stack underflow: ") : androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Too big stack: "));
    }
    ...
    public static String B(String str) {
        ...
        switch (cCharAt) {
            ...
            case Token.ENUM_ID /* 68 */:
                return str;
            default:
                kotlinx.coroutines.future.a.q("bad descriptor:".concat(str));
                return null;
        }
    }
  ...
  0x00b1: PHI (r6v3 int) = (r6v2 int), (r6v2 int), (r6v2 int), (r6v2 int), (r6v6 int), (r6v2 int), (r6v2 int), (r6v2 int) binds: [B:47:0x0098, B:48:0x009a, B:49:0x009c, B:52:0x00a2, B:58:0x00af, B:54:0x00a6, B:55:0x00a8, B:56:0x00aa] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static int L(String str) {
        ...
        kotlinx.coroutines.future.a.q("Bad parameter signature: ".concat(str));
        return 0;
    }
    ...
    public static int M(int i) {
        ...
        switch (i) {
            ...
            case Token.DEFAULTNAMESPACE /* 82 */:
                return -4;
            default:
                kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Bad opcode: "));
                return 0;
        }
    }
    ...
    public static int[] a(ClassFileWriter classFileWriter) {
        ...
        if (iIndexOf != 0 || iIndexOf2 < 0) {
            kotlinx.coroutines.future.a.q("bad method type");
            return null;
        }
        int i3 = iIndexOf + 1;
        ...
        while (i3 < iIndexOf2) {
            ...
            if (cCharAt != 'F') {
                ...
                iB = c0.b(B(sb.toString()), classFileWriter.k);
                i2 = i + 1;
                iArr[i] = iB;
                if (c0.i(iB)) {
                    i += 2;
    ...
    public final int C(int i) {
        if (i >= 0) {
            kotlinx.coroutines.future.a.q("Bad label, no biscuit");
            return 0;
        }
        ...
        kotlinx.coroutines.future.a.q("Bad label");
        return 0;
    }
    ...
    public final void D(int i) {
        ...
        if (iArr[i2] == -1) {
            ...
            kotlinx.coroutines.future.a.u("Can only mark label once");
        }
    }
    ...
    public final void G(int i, int i2, int i3) {
        if (i3 < 0 || i3 > this.n) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i3, "Bad stack index: "));
            return;
        }
        this.m = (short) i3;
        v(this.j);
    ...
    public final void K(int i, int i2, int i3) {
        ...
        if (i3 < 0 || (i4 = this.j) < i3) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i3, "Bad jump target: "));
            return;
        }
        if (i2 < -1) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i2, "Bad case index: "));
            return;
        }
        int i5 = (~i) & 3;
        int i6 = i2 < 0 ? i + 1 + i5 : i + 1 + i5 + ((i2 + 3) * 4);
        if (i < 0 || ((i4 - 16) - i5) - 1 < i) {
            kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.d(i, " is outside a possible range of tableswitch in already generated code"));
            return;
        }
        byte[] bArr = this.i;
        if ((bArr[i] & 255) != 170) {
            kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.d(i, " is not offset of tableswitch statement"));
        } else {
            if (i6 < 0 || i4 < i6 + 4) {
                throw new d(androidx.privacysandbox.ads.adservices.java.internal.a.n(i2, "Too big case index: "));
            }
            J(bArr, i3 - i, i6);
        }
    }
    ...
    public final void O(int i) {
        ...
        int i15;
        if (this.l == null) {
            kotlinx.coroutines.future.a.u("No method to stop");
            return;
        }
        byte[] bArr2 = this.i;
        int i16 = 0;
        ...
        if (z) {
            ...
            while (i34 < length) {
                ...
                if (kVar2.f) {
                    ...
                    int[] iArr4 = new int[0];
                    int[] iArr5 = {c0.a(hVar.a("java/lang/Throwable"))};
                    int i35 = kVar2.b;
                    int i36 = kVar2.c;
                    int i37 = 0;
                    while (true) {
        ...
        if (fVar != null) {
            ...
            if (i7 > 0) {
                ...
                for (i12 = 0; i12 < this.f; i12++) {
                    ...
                    s = iVar3.d;
                    if (iC != -1) {
                        kotlinx.coroutines.future.a.u("start label not defined");
                        return;
                    }
                    if (iC2 != -1) {
                        kotlinx.coroutines.future.a.u("end label not defined");
                        return;
                    } else {
                        if (iC3 != -1) {
                            kotlinx.coroutines.future.a.u("handler label not defined");
                            return;
                        }
    ...
    public final void c(int i) {
        if (i != 254 && i != 255) {
            switch (i) {
                ...
                case Token.DOTDOTDOT /* 184 */:
                case 185:
                    kotlinx.coroutines.future.a.q("Unexpected operands");
                    return;
                default:
                    switch (i) {
                        case Token.LAST_TOKEN /* 187 */:
    ...
    public final void d(int i, int i2) {
        ...
        if (i == 180 || i == 181) {
            if (i2 < 0 || i2 >= 65536) {
                kotlinx.coroutines.future.a.q("out of range field");
                return;
            } else {
                x(i);
                y(i2);
            ...
            if (i == 198 || i == 199) {
                ...
                if (i3 == Integer.MIN_VALUE && (i2 < 0 || i2 > 65535)) {
                    kotlinx.coroutines.future.a.q("Bad label for branch");
                    return;
                }
                i4 = this.j;
                x(i);
                ...
                switch (i) {
                    case 16:
                        byte b = (byte) i2;
                        if (b != i2) {
                            kotlinx.coroutines.future.a.q("out of range byte");
                            return;
                        } else {
                            x(i);
                            x(b);
                    ...
                    case 17:
                        if (((short) i2) != i2) {
                            kotlinx.coroutines.future.a.q("out of range short");
                            return;
                        } else {
                            x(i);
                            y(i2);
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case Token.SETCONST /* 169 */:
                                        break;
                                    default:
                                        kotlinx.coroutines.future.a.q("Unexpected opcode for 1 operand");
                                        return;
                                }
                            case Token.BINDNAME /* 54 */:
                            case Token.THROW /* 55 */:
            ...
            kotlinx.coroutines.future.a.q("out of range index");
            return;
        } else {
            x(i);
            x(i2);
    ...
    public final void e(int i, String str) {
        ...
        if (i != 187 && i != 189 && i != 192 && i != 193) {
            kotlinx.coroutines.future.a.q("bad opcode for class reference");
            return;
        }
    ...
    public final void f(String str, int i, String str2, String str3) {
        ...
        switch (i) {
            ...
            case Token.TEMPLATE_CHARS /* 181 */:
                ...
                break;
            default:
                kotlinx.coroutines.future.a.q("bad opcode for field reference");
                return;
        }
        if (i2 < 0 || 32767 < i2) {
            A(i2);
    ...
    public final void j(int i, String str, int i2, int i3) {
        if ((i & Integer.MIN_VALUE) != Integer.MIN_VALUE) {
            kotlinx.coroutines.future.a.q("Bad startLabel");
            return;
        }
        if ((i2 & Integer.MIN_VALUE) != Integer.MIN_VALUE) {
            kotlinx.coroutines.future.a.q("Bad endLabel");
            return;
        }
        if ((i3 & Integer.MIN_VALUE) != Integer.MIN_VALUE) {
            kotlinx.coroutines.future.a.q("Bad handlerLabel");
            return;
        }
    ...
    public final void m(String str, int i, String str2, String str3) {
        ...
        switch (i) {
            ...
            case 185:
                ...
                return;
            default:
                kotlinx.coroutines.future.a.q("bad opcode for method reference");
                return;
        }
    }
    ...
    public final void n(short s) {
        if (this.l == null) {
            kotlinx.coroutines.future.a.q("No method to stop");
            return;
        }
        int i = this.h;
        if (i == 0) {
    ...
    public final int u(int i) {
        if (this.l == null) {
            kotlinx.coroutines.future.a.q("No method to add to");
            return 0;
        }
        int i2 = this.j;
        int i3 = i + i2;
    ...
    public final int w(int i, int i2) {
        byte[] bArr;
        if (i > i2) {
            throw new d(androidx.compose.runtime.j.g("Bad bounds: ", i, " ", i2));
        }
        int iM = M(170) + this.m;
        if (iM < 0 || 32767 < iM) {
            A(iM);
