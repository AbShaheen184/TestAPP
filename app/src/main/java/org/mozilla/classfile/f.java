...
public final class f {
    ...
    public final void b(int i) {
        ...
        if (i3 == 7 || i3 == 6 || i3 == 8 || i3 == 5) {
            ...
            kotlinx.coroutines.future.a.u(androidx.compose.runtime.j.g("bad local variable type: ", i2, " at index: ", i));
        }
    }
                ...
                switch (i16) {
                    ...
                    case Context.VERSION_ES6 /* 200 */:
                                    ...
                                    default:
                                        switch (i16) {
                                            ...
                                            case 197:
                                                ...
                                                break;
                                            default:
                                                kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i16, "Bad opcode: "));
                                                break;
                                        }
                                        break;
                                }
                        ...
                        for (i5 = iMin; i5 < iMax; i5++) {
                            ...
                            if (i12 < iC && i12 < iC2) {
                                ...
                                short s = iVar2.d;
                                kVarG.b(this.a, this.b, new int[]{s == 0 ? c0.a(hVar.a("java/lang/Throwable")) : c0.a(s)}, 1, classFileWriter.k);
                                a(kVarG);
                            }
                        }
                        i12 += iF;
                    ...
                    case 20:
                        ...
                        if (bByteValue == 3) {
                            ...
                            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(bByteValue, "bad const type "));
                        } else {
                            j(c0.a(hVar.a("java/lang/String")));
                        }
                        i = 5;
                        iF = 0;
                        if (iF == 0) {
                    ...
                    case Token.TRUE /* 50 */:
                        ...
                        if (str.charAt(0) == '[') {
                            j(c0.a(hVar.a(ClassFileWriter.B(str.substring(z ? 1 : 0)))));
                            i = 5;
                            iF = 0;
                            if (iF == 0) {
                                boolean z15 = this.j;
                            ...
                            kotlinx.coroutines.future.a.u("bad array type");
                        }
                        break;
                    case Token.BINDNAME /* 54 */:
                    ...
                    case Token.ARROW /* 178 */:
                        boolean z38 = z ? 1 : 0;
                        j(c0.b(ClassFileWriter.B(((j) hVar.k(f(i12 + 1, 2))).c), hVar));
                        i = 5;
                        iF = 0;
                        if (iF == 0) {
                    ...
                    case 185:
                        ...
                        if (i16 != 184 && ((iH2 = (iH = h()) & 255) == 8 || iH2 == 6)) {
                            if (!"<init>".equals(str3)) {
                                kotlinx.coroutines.future.a.u("bad instance");
                            } else {
                                int iA = iH2 == 8 ? c0.a(hVar.a(jVar.a)) : c0.a(classFileWriter.t);
                                int[] iArr7 = this.a;
                                int i27 = this.b;
                                int i28 = 0;
                                while (i28 < i27) {
                    ...
                    case 188:
                        ...
                        switch (classFileWriter.i[i12 + 1]) {
                            ...
                            case 11:
                                ...
                                break;
                            default:
                                kotlinx.coroutines.future.a.q("bad operand");
                                break;
                        }
                        j(c0.a(hVar.a("[" + c)));
                        i = 5;
    ...
    public final int f(int i, int i2) {
        if (i2 > 4) {
            kotlinx.coroutines.future.a.q("bad operand size");
            return 0;
        }
        int i3 = 0;
    ...
    public final k g(int i) {
        ...
        if (iBinarySearch >= classFileWriter.b) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "bad offset: "));
            return null;
        }
    ...
    public final long i() {
        long jH = h();
        return c0.i((int) jH) ? jH : (jH << 32) | ((long) (h() & 16777215));
    }
