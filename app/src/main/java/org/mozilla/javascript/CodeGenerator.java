...
class CodeGenerator extends Icode {
    ...
    /* JADX WARN: Code duplicated, block: B:109:0x0357  */
    /* JADX WARN: Code duplicated, block: B:112:0x0373  */
    /* JADX WARN: Code duplicated, block: B:113:0x0376  */
    /* JADX WARN: Code duplicated, block: B:122:0x03cb  */
    /* JADX WARN: Code duplicated, block: B:124:0x03de  */
    /* JADX WARN: Code duplicated, block: B:127:0x03f7  */
    /* JADX WARN: Code duplicated, block: B:128:0x03fa  */
    /* JADX WARN: Code duplicated, block: B:152:0x048d  */
    /* JADX WARN: Code duplicated, block: B:154:0x0493  */
    /* JADX WARN: Code duplicated, block: B:155:0x0495  */
    /* JADX WARN: Code duplicated, block: B:157:0x0498  */
    /* JADX WARN: Code duplicated, block: B:158:0x049d  */
    /* JADX WARN: Code duplicated, block: B:160:0x04a3  */
    /* JADX WARN: Code duplicated, block: B:164:0x04b1 A[LOOP:2: B:162:0x04ab->B:164:0x04b1, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:167:0x04c1 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:172:0x04d9  */
    /* JADX WARN: Code duplicated, block: B:174:0x04e1  */
    /* JADX WARN: Code duplicated, block: B:175:0x04e7  */
    /* JADX WARN: Code duplicated, block: B:177:0x04eb  */
    /* JADX WARN: Code duplicated, block: B:186:0x0502  */
    /* JADX WARN: Code duplicated, block: B:187:0x0507  */
    /* JADX WARN: Code duplicated, block: B:190:0x0512  */
    /* JADX WARN: Code duplicated, block: B:192:0x0516  */
    /* JADX WARN: Code duplicated, block: B:193:0x051e  */
    /* JADX WARN: Code duplicated, block: B:195:0x0525  */
    /* JADX WARN: Code duplicated, block: B:196:0x052e  */
    /* JADX WARN: Code duplicated, block: B:197:0x0532  */
    /* JADX WARN: Code duplicated, block: B:198:0x0543  */
    /* JADX WARN: Code duplicated, block: B:211:0x0588  */
    /* JADX WARN: Code duplicated, block: B:216:0x04b7 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:217:? A[RETURN, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:68:0x01e1 A[FALL_THROUGH] */
                    ...
                    case 30:
                        ...
                        while (true) {
                            ...
                            if (firstChild == null) {
                                ...
                                if (i3 > interpreterData.itsMaxCalleeArgs) {
                                    interpreterData.itsMaxCalleeArgs = i3;
                                }
                                if (completeOptionalCallJumpGenerateCallFunAndThis != null) {
                    ...
                    default:
                        switch (type) {
                            ...
                            case Token.HOOK /* 115 */:
                                ...
                                stackChange(-1);
                                int i12 = i & 1;
                                visitExpression(next7, i12);
                                int i13 = this.iCodeTop;
                                addGotoOp(5);
                                resolveForwardGoto(i11);
                                this.stackDepth = i6;
                                visitExpression(next8, i12);
                                                        ...
                                                        switch (type) {
                                                            ...
                                                            case Token.REF_SPECIAL /* 77 */:
                                                                ...
                                                                if (node.getIntProp(30, 0) != 1) {
                                                                    ...
                                                                    addIcode(-1);
                                                                    stackChange(1);
                                                                    int i18 = this.iCodeTop;
                                                                    addGotoOp(-83);
                                                                    stackChange(-1);
                                                                    addStringOp(type, (String) node.getProp(17));
                                                                    int i19 = this.iCodeTop;
                                                                    addGotoOp(5);
                                                                    resolveForwardGoto(i18);
                                                                    addIcode(-4);
                                                                    addStringOp(44, "undefined");
                                                                    ...
                                                                    default:
                                                                        switch (type) {
                                                                            ...
                                                                            case Token.SETELEM_OP /* 154 */:
                                                                                visitExpression(firstChild, 0);
                                                                                Node next15 = firstChild.getNext();
                                                                                visitExpression(next15, 0);
                                                                                Node next16 = next15.getNext();
                                                                                if (type == 154) {
                                                                                    addIcode(-2);
                                                                                    stackChange(2);
                                                                                    addToken(39);
                                                                            ...
                                                                            default:
                                                                                switch (type) {
                                                                                    case Token.SETCONST /* 169 */:
                                                                                        String string4 = firstChild.getString();
                                                                                        visitExpression(firstChild, 0);
                                                                                        visitExpression(firstChild.getNext(), 0);
                                                                                        addStringOp(-66, string4);
                                                                                        stackChange(-1);
                                                                                        break;
                                                                                    case 170:
                                                                                        if (this.itsData.itsNeedsActivation) {
    ...
    private void visitObjectLiteral(Node node, Node node2) {
        ...
        int i = (objArr == null || !Arrays.stream(objArr).anyMatch(new b(0))) ? 0 : 1;
        int size = this.literalIds.size();
    ...
    /* JADX WARN: Code duplicated, block: B:76:0x0193 A[LOOP:0: B:75:0x0191->B:76:0x0193, LOOP_END] */
    private void visitStatement(Node node, int i) {
        ...
        if (type == -69) {
            ...
            if (node4 != null) {
                int i4 = codeGenerator.labelTable[getTargetLabel(node4)];
                codeGenerator.addExceptionHandler(i2, i4, i4, true, localBlockRef3, iAllocLocal2);
            }
            addIndexOp(-63, iAllocLocal2);
