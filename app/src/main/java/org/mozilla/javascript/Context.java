...
public class Context implements Closeable {
    ...
    public Context(ContextFactory contextFactory) {
        ...
        if (contextFactory == null) {
            kotlinx.coroutines.future.a.q("factory == null");
            throw null;
        }
    ...
    public static void checkLanguageVersion(int i) {
        ...
        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Bad language version: "));
    }
    ...
    public static void checkOptimizationLevel(int i) {
        ...
        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Optimization level outside [-1..9]: "));
    }
        ...
        if (context2 == null) {
            if (context == null) {
                ...
                if (context.enterCount != 0) {
                    kotlinx.coroutines.future.a.u("factory.makeContext() returned Context instance already associated with some thread");
                    return null;
                }
                ...
                kotlinx.coroutines.future.a.u("can not use Context instance already associated with some thread");
                return null;
            }
    ...
    public static void exit() {
        ...
        if (context == null) {
            kotlinx.coroutines.future.a.u("Calling Context.exit without previous Context.enter");
            return;
        }
    ...
    private ScriptNode parse(String str, String str2, int i, CompilerEnvirons compilerEnvirons, ErrorReporter errorReporter, boolean z) {
        ...
        if (z && (astRoot.getFirstChild() == null || astRoot.getFirstChild().getType() != 122)) {
            kotlinx.coroutines.future.a.q(androidx.compose.runtime.j.i("compileFunction only accepts source with single JS function: ", str));
            return null;
        }
    ...
    public Object callFunctionWithContinuations(Callable callable, Scriptable scriptable, Object[] objArr) {
        if (!(callable instanceof InterpretedFunction)) {
            kotlinx.coroutines.future.a.q("Function argument was not created by interpreted mode ");
            return null;
        }
        if (ScriptRuntime.hasTopCall(this)) {
            kotlinx.coroutines.future.a.u("Cannot have any pending top calls when executing a script with continuations");
            return null;
        }
    ...
    public Object compileImpl(Scriptable scriptable, String str, String str2, int i, Object obj, boolean z, Evaluator evaluator, ErrorReporter errorReporter, Consumer<CompilerEnvirons> consumer) {
        ...
        if (obj != null && getSecurityController() == null) {
            kotlinx.coroutines.future.a.q("securityDomain should be null if setSecurityController() was never called");
            return null;
        }
    ...
    public final String decompileFunction(Function function, int i) {
        return function instanceof BaseFunction ? ((BaseFunction) function).decompile(i, EnumSet.noneOf(DecompilerFlag.class)) : androidx.privacysandbox.ads.adservices.java.internal.a.r("function ", function.getClassName(), "() {\n\t[native code]\n}\n");
    }
    ...
    public Object executeScriptWithContinuations(Script script, Scriptable scriptable) {
        ...
        kotlinx.coroutines.future.a.q("Script argument was not a script or was not created by interpreted mode ");
        return null;
    }
    ...
    public final void setApplicationClassLoader(ClassLoader classLoader) {
        ...
        if (classLoader == null) {
            ...
            kotlinx.coroutines.future.a.q("Loader can not resolve Rhino classes");
        }
    }
    ...
    public void setJavaToJSONConverter(UnaryOperator<Object> unaryOperator) {
        if (unaryOperator != null) {
            ...
            kotlinx.coroutines.future.a.q("javaToJSONConverter == null");
        }
    }
    ...
    public final void setMaximumInterpreterStackDepth(int i) {
        ...
        if (!this.interpretedMode) {
            kotlinx.coroutines.future.a.u("Cannot set maximumInterpreterStackDepth outside interpreted mode");
        } else if (i >= 1) {
            this.maximumInterpreterStackDepth = i;
        } else {
            kotlinx.coroutines.future.a.q("Cannot set maximumInterpreterStackDepth to less than 1");
        }
    }
