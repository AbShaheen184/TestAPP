...
public class Hashtable implements Serializable, Iterable<Entry> {
    ...
    public void clear() {
        iterator().forEachRemaining(new h());
        if (this.first != null) {
    ...
    public void put(Object obj, final Object obj2) {
        ...
        this.map.compute(entry, new BiFunction() { // from class: org.mozilla.javascript.i
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj3, Object obj4) {
                return this.e.lambda$put$0(entry, obj2, obj3, (Hashtable.Entry) obj4);
            }
        });
    }
