...
public abstract class IdScriptableObject extends ScriptableObject implements IdFunctionCall {
    ...
    public void setInstanceIdAttributes(int i, int i2) {
        throw ScriptRuntime.constructError("InternalError", androidx.compose.runtime.j.k("Changing attributes not supported for ", getClassName(), " ", getInstanceIdName(i), " property"));
    }
    ...
    public static final class PrototypeValues implements Serializable {
        ...
        public final IdFunctionObject createPrecachedConstructor() {
            ...
            if (iFindPrototypeId == 0) {
                kotlinx.coroutines.future.a.u("No id for constructor property");
                return null;
            }
        ...
        public final void initValue(int i, String str, Object obj, int i2) {
            ...
            if (i != this.constructorId) {
                ...
                kotlinx.coroutines.future.a.q("constructor should be initialized with IdFunctionObject");
            } else {
        ...
        public final void initValue(int i, Symbol symbol, Object obj, int i2) {
            ...
            if (symbol != null) {
                if (obj != Scriptable.NOT_FOUND) {
                    ...
                    kotlinx.coroutines.future.a.s(symbol);
                    return;
                }
                kotlinx.coroutines.future.a.r();
                return;
