...
public final class JavaAdapter implements IdFunctionCall {
    ...
    private static Class<?> getAdapterClass(Scriptable scriptable, Class<?> cls, Class<?>[] clsArr, Scriptable scriptable2) {
        ...
        String strN = androidx.privacysandbox.ads.adservices.java.internal.a.n(classCache.newClassSerialNumber(), "adapter");
        Class<?> clsLoadAdapterClass = loadAdapterClass(strN, createAdapterCode(objectFunctionNames, strN, cls, clsArr, null));
