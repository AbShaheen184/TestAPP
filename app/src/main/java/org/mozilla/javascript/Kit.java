...
public class Kit {
    ...
    public static RuntimeException codeBug(String str) {
        IllegalStateException illegalStateException = new IllegalStateException(androidx.compose.runtime.j.i("FAILED ASSERTION: ", str));
    ...
    public static byte[] readStream(InputStream inputStream, int i) throws IOException {
        int i2;
        if (i <= 0) {
            kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Bad initialBufferCapacity: "));
            return null;
        }
