...
final class MemberBox implements Serializable {
    ...
    private static Member readMember(ObjectInputStream objectInputStream) throws IOException {
        ...
        try {
            ...
            kotlinx.coroutines.future.a.w("Cannot find member: ".concat(String.valueOf(e)));
            return null;
        }
    }
    ...
    private static void writeMember(ObjectOutputStream objectOutputStream, Member member) throws IOException {
        ...
        if (!z && !(member instanceof Constructor)) {
            kotlinx.coroutines.future.a.q("not Method or Constructor");
            return;
        }
        ...
        for (Class<?> cls : clsArr) {
            ...
            if (zIsPrimitive) {
                ...
                while (true) {
                    ...
                    if (i >= clsArr2.length) {
                        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.r("Primitive ", String.valueOf(cls), " not found"));
                        return;
                    } else {
