...
public class NativeJavaClass extends NativeJavaObject implements Function {
    ...
    private static Class<?> findNestedClass(Class<?> cls, String str) {
        String strJ = androidx.compose.runtime.j.j(cls.getName(), "$", str);
        ClassLoader classLoader = cls.getClassLoader();
        return classLoader == null ? Kit.classOrNull(strJ) : Kit.classOrNull(classLoader, strJ);
    }
    ...
    public String toString() {
        return androidx.privacysandbox.ads.adservices.java.internal.a.r("[JavaClass ", getClassObject().getName(), "]");
    }
