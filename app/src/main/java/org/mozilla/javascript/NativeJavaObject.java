...
public class NativeJavaObject implements Scriptable, SymbolScriptable, Wrapper, Serializable {
    ...
    private static Callable symbol_iterator = new v(22);
    ...
    private static Object coerceToNumber(Class<?> cls, Object obj) {
        ...
        Class<?> cls4 = ScriptRuntime.BigIntegerClass;
        if (cls != cls4) {
            Class<?> cls5 = ScriptRuntime.FloatClass;
            ...
            Class<?> cls6 = ScriptRuntime.IntegerClass;
            if (cls == cls6 || cls == Integer.TYPE) {
                return cls2 == cls6 ? obj : Integer.valueOf((int) toInteger(obj, cls6, -2.147483648E9d, 2.147483647E9d));
            }
            Class<?> cls7 = ScriptRuntime.LongClass;
            if (cls == cls7 || cls == Long.TYPE) {
                if (cls2 == cls7) {
                    return obj;
                }
                return Long.valueOf(toInteger(obj, cls7, Double.longBitsToDouble(-4332462841530417152L), Double.longBitsToDouble(4890909195324358655L)));
            }
            Class<?> cls8 = ScriptRuntime.ShortClass;
            if (cls == cls8 || cls == Short.TYPE) {
                return cls2 == cls8 ? obj : Short.valueOf((short) toInteger(obj, cls8, -32768.0d, 32767.0d));
            }
            Class<?> cls9 = ScriptRuntime.ByteClass;
            if (cls != cls9 && cls != Byte.TYPE) {
                return Double.valueOf(toDouble(obj));
            }
            if (cls2 != cls9) {
                return Byte.valueOf((byte) toInteger(obj, cls9, -128.0d, 127.0d));
            }
        } else if (cls2 != cls4) {
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARN: Code duplicated, block: B:122:0x00fe A[RETURN] */
