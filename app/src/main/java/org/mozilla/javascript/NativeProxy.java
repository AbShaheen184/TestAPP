...
final class NativeProxy extends ScriptableObject implements Callable, Constructable {
    ...
    public static void init(Context context, Scriptable scriptable, boolean z) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, PROXY_TAG, 2, 2, new g0(0)) { // from class: org.mozilla.javascript.NativeProxy.1
        ...
        lambdaConstructor.defineConstructorMethod(scriptable, "revocable", 2, new v(5), 2, 3);
    ...
    public boolean defineOwnProperty(Context context, Object obj, ScriptableObject scriptableObject) {
        ...
        if (ownPropertyDescriptor == null) {
            ...
            if (z && bool.equals(ownPropertyDescriptor.get("configurable"))) {
                throw ScriptRuntime.typeError("proxy can't define an incompatible property descriptor");
            }
    ...
    public Object[] getIds(boolean z, boolean z2) {
        ...
        if (trap != null) {
            ...
            Context context = Context.getContext();
            List<Object> listCreateListFromArrayLike = AbstractEcmaObjectOperations.createListFromArrayLike(context, scriptable, new b(1), "proxy [[OwnPropertyKeys]] must return an array with only string and symbol elements");
            boolean zIsExtensible = targetThrowIfRevoked.isExtensible();
