...
public class ScriptRuntime {
    ...
    public static Ref callRef(Callable callable, Scriptable scriptable, Object[] objArr, Context context) {
        ...
        kotlinx.coroutines.future.a.u(refCallable.getClass().getName().concat(".refCall() returned null"));
        return null;
    }
    ...
    public static String defaultObjectToString(Scriptable scriptable) {
        ...
        return property instanceof CharSequence ? androidx.privacysandbox.ads.adservices.java.internal.a.r("[object ", String.valueOf(property), "]") : androidx.privacysandbox.ads.adservices.java.internal.a.r("[object ", scriptable.getClassName(), "]");
    }
                ...
                if (th instanceof EcmaError) {
                    ...
                    if (th instanceof WrappedException) {
                        ...
                        if (isVisible(context, wrappedException2)) {
                            ...
                            strJ = androidx.compose.runtime.j.j(wrappedException2.getClass().getName(), ": ", wrappedException2.getMessage());
                        } else {
                            nativeErrors = TopLevel.NativeErrors.InternalError;
                            strJ = wrappedException2.getMessage();
                        }
                    ...
                    if (iLineNumber > 0) {
                        objArr = new Object[]{strJ, strSourceName, Integer.valueOf(iLineNumber)};
                    } else {
                        objArr = new Object[]{strJ, strSourceName};
                    }
    ...
    public static Scriptable wrapException(Throwable th, Scriptable scriptable, Context context) {
        ...
        if (!(th instanceof EcmaError)) {
            if (th instanceof WrappedException) {
                WrappedException wrappedException = (WrappedException) th;
                Throwable wrappedException2 = wrappedException.getWrappedException();
                string = androidx.compose.runtime.j.j(wrappedException2.getClass().getName(), ": ", wrappedException2.getMessage());
                th2 = wrappedException2;
                name = "JavaException";
    ...
    public static class DefaultMessageProvider implements MessageProvider {
        ...
        public String getMessage(String str, Object[] objArr) {
            ...
            try {
                ...
                c.b(androidx.compose.runtime.j.i("no message resource found for message property ", str));
                return null;
            }
        }
