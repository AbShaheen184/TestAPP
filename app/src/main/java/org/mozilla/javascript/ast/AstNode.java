...
public abstract class AstNode extends Node implements Comparable<AstNode> {
    ...
    static {
        ...
        INDENTATIONS = strArr;
        a.f(57, map, "in", 32, "typeof");
        a.f(58, map, "instanceof", 31, "delete");
        a.f(98, map, ",", Token.COLON, ":");
        a.f(Token.OR, map, "||", 185, "??");
        a.f(Token.QUESTION_DOT, map, "?.", Token.AND, "&&");
        a.f(Token.INC, map, "++", 120, "--");
        a.f(9, map, "|", 10, "^");
        a.f(11, map, "&", 12, "==");
        a.f(13, map, "!=", 14, "<");
        a.f(16, map, ">", 15, "<=");
        ...
        a.f(51, map, "===", 52, "!==");
        a.f(99, map, "=", 100, "|=");
        a.f(Token.ASSIGN_LOGICAL_OR, map, "||=", Token.ASSIGN_BITAND, "&=");
        a.f(Token.ASSIGN_LOGICAL_AND, map, "&&=", Token.ASSIGN_LSH, "<<=");
        a.f(Token.ASSIGN_RSH, map, ">>=", Token.ASSIGN_URSH, ">>>=");
        a.f(Token.ASSIGN_ADD, map, "+=", Token.ASSIGN_SUB, "-=");
        a.f(110, map, "*=", Token.ASSIGN_DIV, "/=");
        a.f(Token.ASSIGN_MOD, map, "%=", Token.ASSIGN_BITXOR, "^=");
        a.f(Token.ASSIGN_EXP, map, "**=", 114, "??=");
    ...
    public static String operatorToString(int i) {
        ...
        kotlinx.coroutines.future.a.q(androidx.privacysandbox.ads.adservices.java.internal.a.n(i, "Invalid operator: "));
        return null;
    }
    ...
    public void assertNotNull(Object obj) {
        ...
        kotlinx.coroutines.future.a.q("arg cannot be null");
    }
