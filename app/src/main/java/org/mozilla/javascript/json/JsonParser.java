        ...
        do {
            ...
            while (true) {
                ...
                if (cCharAt2 == '\"') {
                    ...
                    int i6 = this.pos;
                    if (i5 - i6 < 5) {
                        throw new ParseException("Invalid character code: \\u".concat(this.src.substring(this.pos)));
                    }
                    ...
                    if (iFromHex < 0) {
                        ...
                        int i7 = this.pos;
                        throw new ParseException("Invalid character code: ".concat(str3.substring(i7, i7 + 4)));
                    }
                    this.pos += 4;
                    sb.append((char) iFromHex);
                }
                i = this.pos;
                while (true) {
                    int i8 = this.pos;
