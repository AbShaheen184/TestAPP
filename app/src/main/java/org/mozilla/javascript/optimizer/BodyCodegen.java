...
class BodyCodegen {
    ...
    private void addDynamicInvoke(String str, String str2) {
        ...
        if (ClassFileWriter.E < 51) {
            c.b("Please build and run with JDK 1.7 for invokedynamic support");
            return;
        }
    ...
    private void finishGetPropGeneration(Node node, Node node2) {
        ...
        if (node.getIntProp(31, 0) == 1) {
            ...
            addDynamicInvoke(j.i("PROP:GETSUPER:", node2.getString()), Signatures.PROP_GET_SUPER);
        } else if (node.getType() == 34) {
            addDynamicInvoke(j.i("PROP:GETNOWARN:", node2.getString()), "(Ljava/lang/Object;Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;)Ljava/lang/Object;");
        } else {
            addDynamicInvoke(j.i("PROP:GET:", node2.getString()), "(Ljava/lang/Object;Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;)Ljava/lang/Object;");
        }
    }
                        ...
                        default:
                            switch (type) {
                                ...
                                case Token.NAME /* 44 */:
                                    this.cfw.g(this.variableObjectLocal);
                                    this.cfw.g(this.contextLocal);
                                    addDynamicInvoke(j.i("NAME:GET:", node.getString()), Signatures.NAME_GET);
                                    return;
                                ...
                                case Token.BINDNAME /* 54 */:
                                    ...
                                    this.cfw.g(this.variableObjectLocal);
                                    this.cfw.g(this.contextLocal);
                                    addDynamicInvoke(j.i("NAME:BIND:", node.getString()), Signatures.NAME_BIND);
                                    return;
                                default:
                                    switch (type) {
                                        case Token.IN /* 57 */:
                                                                        ...
                                                                        default:
                                                                            switch (type) {
                                                                                ...
                                                                                case Token.ARRAYCOMP /* 171 */:
                                                                                    ...
                                                                                    return;
                                                                                default:
                                                                                    c.b(androidx.privacysandbox.ads.adservices.java.internal.a.n(type, "Unexpected node type "));
                                                                                    return;
                                                                            }
                                                                    }
                                                            }
    ...
    private void generateFunctionAndThisObj(Node node, Node node2) {
        ...
        if (type2 != 33) {
            ...
            if (type2 != 39) {
                if (type2 != 44) {
                    ...
                    this.cfw.g(this.variableObjectLocal);
                    this.cfw.g(this.contextLocal);
                    addDynamicInvoke(b0.e("NAME:", z ? "GETWITHTHISOPTIONAL" : "GETWITHTHIS", ":", string), Signatures.NAME_GET_THIS);
                    return;
                }
            }
        }
        ...
        if (type == 33) {
            ...
            this.cfw.g(this.contextLocal);
            this.cfw.g(this.variableObjectLocal);
            addDynamicInvoke(b0.e("PROP:", z ? "GETWITHTHISOPTIONAL" : "GETWITHTHIS", ":", string2), Signatures.PROP_GET_THIS);
            return;
        }
    ...
    private void generateYieldPoint(Node node, boolean z) {
        ...
        if (nodeFindNestedYield != null) {
            ...
            String strN = androidx.privacysandbox.ads.adservices.java.internal.a.n(this.unnestedYieldCount, "__nested__yield__");
            this.unnestedYieldCount++;
            this.cfw.g(this.variableObjectLocal);
            this.cfw.c(95);
            this.cfw.g(this.contextLocal);
            this.cfw.g(this.variableObjectLocal);
            addDynamicInvoke("PROP:SET:".concat(strN), "(Ljava/lang/Object;Ljava/lang/Object;Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;)Ljava/lang/Object;");
            this.cfw.c(87);
            this.unnestedYields.put(nodeFindNestedYield, strN);
        }
  ...
  0x00e5: PHI (r1v3 java.lang.String) = (r1v2 java.lang.String), (r1v8 java.lang.String) binds: [B:33:0x00ce, B:37:0x00d8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private void visitSetProp(int i, Node node, Node node2) {
        ...
        this.cfw.g(this.variableObjectLocal);
        if (node.getIntProp(31, 0) != 1) {
            addDynamicInvoke(j.i("PROP:SET:", next.getString()), "(Ljava/lang/Object;Ljava/lang/Object;Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;)Ljava/lang/Object;");
        } else {
            this.cfw.g(this.thisObjLocal);
            addDynamicInvoke(j.i("PROP:SETSUPER:", next.getString()), "(Ljava/lang/Object;Ljava/lang/Object;Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Ljava/lang/Object;)Ljava/lang/Object;");
        }
    }
    ...
    private void visitSuperIncDec(Node node, Node node2, int i) {
        ...
        if (type == 33) {
            ...
            this.cfw.g(this.thisObjLocal);
            this.cfw.o(0);
            addDynamicInvoke(j.i("PROP:GETSUPER:", node2.getFirstChild().getNext().getString()), Signatures.PROP_GET_SUPER);
        } else if (type != 39) {
            Codegen.badTree();
        } else {
            generateExpression(firstChild.getNext(), node);
        ...
        if (type2 == 33) {
            ...
            this.cfw.g(this.variableObjectLocal);
            this.cfw.g(this.thisObjLocal);
            addDynamicInvoke(j.i("PROP:SETSUPER:", node2.getFirstChild().getNext().getString()), "(Ljava/lang/Object;Ljava/lang/Object;Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Ljava/lang/Object;)Ljava/lang/Object;");
        } else if (type2 == 39) {
            generateExpression(firstChild.getNext(), node);
            this.cfw.c(95);
            this.cfw.g(this.contextLocal);
    ...
    public void generateBodyCode() {
        ...
        initBodyGeneration();
        if (this.isGenerator) {
            String strR = androidx.privacysandbox.ads.adservices.java.internal.a.r("(", this.codegen.mainClassSignature, "Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Ljava/lang/Object;Ljava/lang/Object;I)Ljava/lang/Object;");
            this.cfw.N(this.codegen.getBodyMethodName(this.scriptOrFn) + "_gen", strR, (short) 10);
        } else {
            this.cfw.N(this.codegen.getBodyMethodName(this.scriptOrFn), this.codegen.getBodyMethodSignature(this.scriptOrFn), (short) 10);
        }
        generatePrologue();
