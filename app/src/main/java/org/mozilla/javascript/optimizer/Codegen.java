...
public class Codegen implements Evaluator {
    ...
    private void emitConstantDudeInitializers(ClassFileWriter classFileWriter) {
        ...
        for (int i2 = 0; i2 != i; i2++) {
            double d = dArr[i2];
            String strN = a.n(i2, "_k");
            String staticConstantWrapperType = getStaticConstantWrapperType(d);
            classFileWriter.k(strN, staticConstantWrapperType, (short) 10);
            int i3 = (int) d;
            if (i3 == d) {
            ...
            classFileWriter.f(this.mainClassName, Token.YIELD_STAR, strN, staticConstantWrapperType);
        }
    ...
    private void generateResumeGenerator(ClassFileWriter classFileWriter) {
        ...
        while (true) {
            ...
            if (isGenerator(scriptNode2)) {
                classFileWriter.m(this.mainClassName, Token.DOTDOTDOT, g.c(getBodyMethodName(scriptNode2), "_gen"), a.r("(", this.mainClassSignature, "Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Ljava/lang/Object;Ljava/lang/Object;I)Ljava/lang/Object;"));
                classFileWriter.c(Token.GENEXPR);
            } else {
    ...
    public Function createFunctionObject(Context context, Scriptable scriptable, Object obj, Object obj2) {
        try {
            ...
            c.b(j.i("Unable to instantiate compiled class:", e.toString()));
            return null;
        }
    }
    ...
    public String getTemplateLiteralName(ScriptNode scriptNode) {
        return a.n(getIndex(scriptNode), "_q");
    }
    ...
    public void pushNumberAsObject(ClassFileWriter classFileWriter, double d) {
        ...
        classFileWriter.f(this.mainClassName, Token.ARROW, a.n(i2, "_k"), getStaticConstantWrapperType(d));
    }
