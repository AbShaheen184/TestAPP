...
public final class i implements Closeable {
    ...
    public static c L(String str, byte b) {
        ...
        if (bVar == bVar2) {
            return new e(androidx.privacysandbox.ads.adservices.java.internal.a.r("Expected ", str, ", but encountered 0xC1 \"NEVER_USED\" byte"), 0);
        }
        if (bVar == bVar2) {
            bVar.getClass();
    ...
    public final int N() {
        ...
        if (b == -36) {
            return x(2).getShort(this.H) & 65535;
        }
        if (b != -35) {
            throw L("Array", b);
        }
        int i = x(4).getInt(this.H);
        if (i >= 0) {
            return i;
        }
        throw new c(2);
        ...
        if (this.e) {
            switch (b) {
                case -39:
                    ...
                    break;
                case -38:
                    i2 = x(2).getShort(this.H) & 65535;
                    if (i2 >= 0) {
                        return i2;
                    }
                    break;
                case -37:
                    i2 = x(4).getInt(this.H);
                    if (i2 < 0) {
                        throw new c(2);
                    }
                    if (i2 >= 0) {
    ...
    public final byte Y() {
        ...
        switch (b) {
            ...
            case -48:
                return readByte();
            case -47:
                short s2 = x(2).getShort(this.H);
                if (s2 < -128 || s2 > 127) {
                    throw new d(BigInteger.valueOf(s2));
                }
                return (byte) s2;
            case -46:
                int i3 = x(4).getInt(this.H);
                if (i3 < -128 || i3 > 127) {
    ...
    public final MessageBuffer x(int i) {
        int size = this.E.size();
        int i2 = this.F;
        int i3 = size - i2;
        if (i3 >= i) {
