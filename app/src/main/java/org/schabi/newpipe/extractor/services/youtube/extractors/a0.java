...
public class a0 implements org.schabi.newpipe.extractor.stream.h {
    ...
    public a0(com.grack.nanojson.c cVar, com.google.android.material.internal.k kVar) {
        this.a = cVar;
        this.b = kVar;
    }
    ...
    public static long u(String str, boolean z) {
        ...
        if (z) {
            return org.schabi.newpipe.extractor.utils.g.k(str);
        }
    ...
    public String e() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        if (!org.schabi.newpipe.extractor.utils.g.h(strN2)) {
            return strN2;
        }
        String strN3 = org.schabi.newpipe.extractor.services.youtube.i.n(cVar.e("shortBylineText"), false);
        if (!org.schabi.newpipe.extractor.utils.g.h(strN3)) {
            return strN3;
        }
    ...
    public final String getName() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        if (!org.schabi.newpipe.extractor.utils.g.j(cVarE) && !cVarE.containsKey("runs")) {
            return "";
        }
    ...
    public final void h() {
        ...
        if (cVar.containsKey("channelThumbnailSupportedRenderers")) {
            org.schabi.newpipe.extractor.services.youtube.i.k((com.grack.nanojson.b) org.schabi.newpipe.extractor.utils.b.e(cVar, "channelThumbnailSupportedRenderers.channelThumbnailWithLinkRenderer.thumbnail.thumbnails", com.grack.nanojson.b.class));
        } else if (cVar.containsKey("channelThumbnail")) {
            org.schabi.newpipe.extractor.services.youtube.i.k((com.grack.nanojson.b) org.schabi.newpipe.extractor.utils.b.e(cVar, "channelThumbnail.thumbnails", com.grack.nanojson.b.class));
        } else {
    ...
    public final void l() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        try {
            ...
            boolean zContainsKey = !org.schabi.newpipe.extractor.utils.g.h(strF) && strF.equals("WEB_PAGE_TYPE_SHORTS");
            if (!zContainsKey) {
    ...
    public final String m() {
        if (p() != 4) {
            ...
            if (org.schabi.newpipe.extractor.utils.g.h(strN) && cVar.containsKey("videoInfo")) {
    ...
    public final org.schabi.newpipe.extractor.localization.b n() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        String strM = m();
        if (org.schabi.newpipe.extractor.utils.g.h(strM)) {
            return null;
        }
        try {
            return kVar.y(strM);
    ...
    public final Instant s() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        try {
            ...
            org.mozilla.javascript.typedarrays.c.d(androidx.privacysandbox.ads.adservices.java.internal.a.r("Could not parse date from premiere: \"", strF, "\""), e2);
            return null;
        }
    }

    public final long t() throws org.schabi.newpipe.extractor.utils.e {
        String strF = this.a.e("title").e("accessibility").e("accessibilityData").f("label", "");
        if (strF.toLowerCase().endsWith("no views")) {
            return 0L;
        }
        String strJ = org.schabi.newpipe.extractor.utils.b.j(e, strF, 1);
        Pattern pattern = org.schabi.newpipe.extractor.utils.g.a;
