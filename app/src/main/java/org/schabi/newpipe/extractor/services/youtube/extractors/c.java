...
public final class c extends org.schabi.newpipe.extractor.f {
    ...
    public org.schabi.newpipe.extractor.services.youtube.c g;
    public String h;
    ...
    public final List O() {
        a();
        return this.i != null ? Collections.EMPTY_LIST : (List) this.f.e("microformat").e("microformatDataRenderer").a("tags").stream().filter(new com.grack.nanojson.a(14)).map(new org.schabi.newpipe.extractor.services.youtube.b(16)).collect(DesugarCollectors.toUnmodifiableList());
    }

    public final List c0() {
        a();
        com.grack.nanojson.c cVar = this.i;
        return cVar != null ? (List) Optional.ofNullable(cVar.e("avatar").a("thumbnails")).map(new org.schabi.newpipe.extractor.services.youtube.b(15)).orElseThrow(new org.jsoup.internal.c(12)) : (List) Optional.ofNullable(this.g).map(new org.schabi.newpipe.extractor.services.youtube.b(12)).map(new org.schabi.newpipe.extractor.services.youtube.b(15)).orElseThrow(new org.jsoup.internal.c(11));
    }

    public final String d0() throws org.schabi.newpipe.extractor.exceptions.f {
        a();
        if (this.i != null) {
            return null;
        }
        try {
            org.schabi.newpipe.extractor.services.youtube.c cVar = this.g;
            return (cVar == null || cVar.y != 2) ? this.f.e("metadata").e("channelMetadataRenderer").f("description", null) : org.schabi.newpipe.extractor.services.youtube.i.n(cVar.e.e("description"), false);
        } catch (Exception e) {
    ...
    public final long e0() {
        ...
        int i;
        a();
        if (this.i != null || (cVar = this.g) == null || (i = cVar.y) == 2) {
            return -1L;
        }
        ...
        if (i != 4) {
            ...
            try {
                return org.schabi.newpipe.extractor.utils.g.k(org.schabi.newpipe.extractor.services.youtube.i.n(cVarE, false));
        ...
        try {
            return org.schabi.newpipe.extractor.utils.g.k(bVarA2.b(0).e("text").f("content", null));
    ...
    public final List f0() {
        ...
        if (this.i != null) {
            ...
            b bVar = new b(this, arrayList, l());
            bVar.accept("videos");
            bVar.accept("shorts");
            bVar.accept("livestreams");
            return Collections.unmodifiableList(arrayList);
        }
        com.grack.nanojson.b bVarA = this.f.e("contents").e("twoColumnBrowseResultsRenderer").a("tabs");
        ...
        String strH = h();
        String strL = l();
        bVarA.c().filter(new com.grack.nanojson.a(13)).map(new org.schabi.newpipe.extractor.services.youtube.b(13)).forEach(new b(this, arrayList2, strH, g(), strL, aVar));
        return Collections.unmodifiableList(arrayList2);
    }

    @Override // androidx.work.j0
    public final String g() throws org.schabi.newpipe.extractor.exceptions.f {
        a();
        org.schabi.newpipe.extractor.services.youtube.c cVar = this.g;
        com.grack.nanojson.c cVar2 = this.f;
        String str = this.h;
        if (cVar != null) {
        ...
        if (!org.schabi.newpipe.extractor.utils.g.h(strF4)) {
            return strF4;
        }
    ...
    public final String h() throws org.schabi.newpipe.extractor.exceptions.f {
        a();
        org.schabi.newpipe.extractor.services.youtube.c cVar = this.g;
        com.grack.nanojson.c cVar2 = this.i;
        com.grack.nanojson.c cVar3 = this.f;
        if (cVar2 != null) {
    ...
    public final String l() {
        try {
            return org.schabi.newpipe.extractor.services.youtube.linkHandler.a.b.i("channel/" + g());
    ...
    public final void m(com.app.mlounge.data.music.e eVar) throws org.schabi.newpipe.extractor.exceptions.d {
        ...
        c cVar4 = this;
        String str2 = ((org.schabi.newpipe.extractor.linkhandler.a) cVar4.d).z;
        ...
        if (strArrSplit[0].startsWith("UC")) {
            ...
            if (strArrSplit[0].equals("channel")) {
                ...
                while (true) {
                    ...
                    com.google.android.material.internal.k kVarZ = org.schabi.newpipe.extractor.services.youtube.i.z(cVar6, aVar);
                    kVarZ.G(strConcat, "url");
                    com.grack.nanojson.c cVarL = org.schabi.newpipe.extractor.services.youtube.i.l("navigation/resolve_url", okhttp3.internal.platform.android.g.z((com.grack.nanojson.c) kVarZ.z).getBytes(StandardCharsets.UTF_8), cVar6);
                    kotlin.collections.builders.c.D(cVarL);
        ...
        org.schabi.newpipe.extractor.localization.c cVarC = ((w0) cVar4.c).c();
        org.schabi.newpipe.extractor.localization.a aVarF = cVar4.f();
        int i3 = 0;
        while (true) {
            if (i3 >= 3) {
                cVar = null;
            ...
            com.google.android.material.internal.k kVarZ2 = org.schabi.newpipe.extractor.services.youtube.i.z(cVarC, aVarF);
            kVarZ2.G(str, "browseId");
            org.schabi.newpipe.extractor.localization.a aVar2 = aVarF;
            int i4 = i3;
            kVarZ2.G("EgZ2aWRlb3PyBgQKAjoA", "params");
            com.grack.nanojson.c cVarL2 = org.schabi.newpipe.extractor.services.youtube.i.l("browse", okhttp3.internal.platform.android.g.z((com.grack.nanojson.c) kVarZ2.z).getBytes(StandardCharsets.UTF_8), cVarC);
            kotlin.collections.builders.c.D(cVarL2);
        ...
        if (cVarE3.containsKey("c4TabbedHeaderRenderer")) {
            ...
            if (!cVarE3.containsKey("carouselHeaderRenderer")) {
                ...
                this.g = cVar2;
                this.h = str;
                this.i = (com.grack.nanojson.c) this.f.e("contents").e("twoColumnBrowseResultsRenderer").a("tabs").c().flatMap(new org.schabi.newpipe.extractor.services.youtube.b(5)).filter(new com.grack.nanojson.a(5)).map(new androidx.media3.exoplayer.audio.f(28)).findFirst().orElse(null);
            }
