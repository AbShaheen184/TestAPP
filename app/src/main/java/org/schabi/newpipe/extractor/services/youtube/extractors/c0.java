...
public class c0 implements org.schabi.newpipe.extractor.stream.h {
    ...
    public final com.google.android.material.internal.k b;
    ...
    public c0(com.grack.nanojson.c cVar, com.google.android.material.internal.k kVar) {
        this.a = cVar;
        this.b = kVar;
    ...
    public String b() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        if (strF != null && strF.startsWith("UC")) {
            return org.schabi.newpipe.extractor.services.youtube.linkHandler.a.b.i("channel/".concat(strF));
        }
    ...
    public final long f() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        com.grack.nanojson.b bVar = (com.grack.nanojson.b) androidx.privacysandbox.ads.adservices.java.internal.a.l(1, arrayListU);
        if (bVar.isEmpty()) {
        ...
        return org.schabi.newpipe.extractor.utils.g.k(strF);
    }
    ...
    public final long getDuration() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        List list = (List) ((com.grack.nanojson.b) org.schabi.newpipe.extractor.utils.b.e(this.a, "contentImage.thumbnailViewModel.overlays", com.grack.nanojson.b.class)).c().flatMap(new z(8)).map(new z(9)).collect(Collectors.toList());
        if (list.isEmpty()) {
            return -1L;
        }
    ...
    public final String getName() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        String str2 = (String) org.schabi.newpipe.extractor.utils.b.e(this.a, "metadata.lockupMetadataViewModel.title.content", String.class);
    ...
    public final String getUrl() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        try {
            ...
            if (org.schabi.newpipe.extractor.utils.g.h(strF)) {
                strF = (String) org.schabi.newpipe.extractor.utils.b.e(cVar, "rendererContext.commandContext.onTap.innertubeCommand.watchEndpoint.videoId", String.class);
            }
            return org.schabi.newpipe.extractor.services.youtube.linkHandler.c.c.i(strF);
        } catch (Exception e) {
    ...
    @Override // org.schabi.newpipe.extractor.stream.h
    public final void h() {
        org.schabi.newpipe.extractor.services.youtube.i.k((com.grack.nanojson.b) org.schabi.newpipe.extractor.utils.b.e(s().k(), "avatarViewModel.image.sources", com.grack.nanojson.b.class));
    }
    ...
    @Override // org.schabi.newpipe.extractor.d
    public final List o() {
        return org.schabi.newpipe.extractor.services.youtube.i.k((com.grack.nanojson.b) org.schabi.newpipe.extractor.utils.b.e(this.a, "contentImage.thumbnailViewModel.image.sources", com.grack.nanojson.b.class));
    }

    @Override // org.schabi.newpipe.extractor.stream.h
    public final int p() {
        if (this.d == 0) {
            com.grack.nanojson.b bVar = (com.grack.nanojson.b) org.schabi.newpipe.extractor.utils.b.e(this.a, "contentImage.thumbnailViewModel.overlays", com.grack.nanojson.b.class);
            int i = 4;
