...
public final class d implements org.schabi.newpipe.extractor.channel.c {
    ...
    public final String getUrl() throws org.schabi.newpipe.extractor.exceptions.f {
        try {
            return org.schabi.newpipe.extractor.services.youtube.linkHandler.a.b.i("channel/" + this.a.f("channelId", null));
        } catch (Exception e) {
    ...
    public final long q() throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        try {
            ...
            if (!this.b) {
                return org.schabi.newpipe.extractor.utils.g.k(org.schabi.newpipe.extractor.services.youtube.i.n(cVar.e("subscriberCountText"), false));
            }
            if (cVar.containsKey("videoCountText")) {
                return org.schabi.newpipe.extractor.utils.g.k(org.schabi.newpipe.extractor.services.youtube.i.n(cVar.e("videoCountText"), false));
            }
            return -1L;
        } catch (Exception e) {
