...
public abstract class h {
    ...
    public static void a(String str) throws org.schabi.newpipe.extractor.exceptions.f {
        ...
        try {
            ...
            new URL(strA);
            try {
                str2 = (String) g0.a.t(strA, null, cVar).B;
                b = str2;
            } catch (Exception e2) {
            ...
            try {
                String str3 = (String) g0.a.t("https://www.youtube.com/embed/" + str, null, cVar).B;
                ...
                do {
                    if (!it2.hasNext()) {
                        try {
                            strJ = org.schabi.newpipe.extractor.utils.b.j(g.b, str3, 1);
                            break;
                        } catch (org.schabi.newpipe.extractor.utils.e e3) {
                ...
                try {
                    new URL(strJ);
                    try {
                        str2 = (String) g0.a.t(strJ, null, cVar).B;
                    } catch (Exception e4) {
