...
public final class j extends w0 {
    ...
    static {
        ...
        arrayList.add((org.schabi.newpipe.extractor.localization.c) org.schabi.newpipe.extractor.utils.b.c(str).map(new androidx.media3.exoplayer.audio.f(16)).orElseThrow(new org.jsoup.internal.g(str, 1)));
