        ...
        switch (this.c) {
            case 0:
                ...
                for (Map.Entry entry : map.entrySet()) {
                    ...
                    if (value == null) {
                        throw z0.m(method, i, androidx.privacysandbox.ads.adservices.java.internal.a.r("Field map contained null value for key '", str, "'."), new Object[0]);
                    }
            ...
            case 1:
                ...
                for (Map.Entry entry2 : map2.entrySet()) {
                    ...
                    if (value2 == null) {
                        throw z0.m(method2, i2, androidx.privacysandbox.ads.adservices.java.internal.a.r("Header map contained null value for key '", str2, "'."), new Object[0]);
                    }
            ...
            default:
                ...
                for (Map.Entry entry3 : map3.entrySet()) {
                    ...
                    if (value3 == null) {
                        throw z0.m(method3, i3, androidx.privacysandbox.ads.adservices.java.internal.a.r("Query map contained null value for key '", str3, "'."), new Object[0]);
                    }
