...
public final class g0 extends z0 {
    ...
    public final void a(o0 o0Var, Object obj) throws EOFException {
        ...
        String str = this.e;
        if (obj == null) {
            throw z0.m(this.c, this.d, androidx.privacysandbox.ads.adservices.java.internal.a.r("Path parameter \"", str, "\" value must not be null."), new Object[0]);
        }
        this.f.getClass();
        ...
        if (o0.m.matcher(strReplace).matches()) {
            kotlinx.coroutines.future.a.q("@Path parameters shouldn't perform path traversal ('.' or '..'): ".concat(string));
        } else {
            o0Var.c = strReplace;
        }
    }
