...
public abstract class t {
    ...
    /* JADX WARN: Code duplicated, block: B:386:0x08fa A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:387:0x08fc  */
    /* JADX WARN: Code duplicated, block: B:589:0x0913 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:596:0x08fe A[SYNTHETIC] */
                                        ...
                                        if (annotation instanceof retrofit2.http.v) {
                                            ...
                                            if (annotation instanceof retrofit2.http.i) {
                                                ...
                                                if (strValue5.isEmpty()) {
                                                    ...
                                                    String[] strArr = {"Content-Disposition", androidx.privacysandbox.ads.adservices.java.internal.a.r("form-data; name=\"", strValue5, "\""), "Content-Transfer-Encoding", qVar.encoding()};
                                                    okhttp3.r rVar = okhttp3.r.y;
                                                    okhttp3.r rVarE = kotlin.collections.c.e(strArr);
                                                    if (Iterable.class.isAssignableFrom(clsH8)) {
                                                        ...
                                                        a0Var = new a0(new f0(method, i8, rVarE, t0Var2.c(typeG4, annotationArr3, annotationArr)), 0);
                                                    } else if (clsH8.isArray()) {
                                                        Class clsA = p0.a(clsH8.getComponentType());
                                                        if (okhttp3.v.class.isAssignableFrom(clsA)) {
                                                            throw z0.m(method, i8, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                                                        }
                                                        a0Var = new a0(new f0(method, i8, rVarE, t0Var2.c(clsA, annotationArr3, annotationArr)), 1);
                                                    } else {
                                                        if (okhttp3.v.class.isAssignableFrom(clsH8)) {
                                                            throw z0.m(method, i8, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                                                        }
                                                        f0Var = new f0(method, i8, rVarE, t0Var2.c(type, annotationArr3, annotationArr));
                                                        j0Var = f0Var;
                                                    }
                                                    j0Var = a0Var;
                                                }
                                                ...
                                                for (int i12 = i8 - 1; i12 >= 0; i12--) {
                                                    ...
                                                    if ((z0Var3 instanceof j0) && ((j0) z0Var3).c.equals(clsA2)) {
                                                        throw z0.m(method, i8, "@Tag type " + clsA2.getName() + " is duplicate of " + k0.b.d(i12, method) + " and would always overwrite its value.", new Object[0]);
                                                    }
                                                }
                                                j0Var = new j0(clsA2);
                                            } else {
