...
public final class t0 {
    ...
    public t0(okhttp3.y yVar, okhttp3.s sVar, List list, List list2) {
        this.b = yVar;
        this.c = sVar;
        this.d = list;
        this.e = list2;
    ...
    public final f a(Type type, Annotation[] annotationArr) {
        ...
        for (int i = iIndexOf; i < size; i++) {
            f fVarA = ((e) list.get(i)).a(type, annotationArr);
            if (fVarA != null) {
                return fVarA;
            }
        }
    ...
    public final Object b(Class cls) {
        if (!cls.isInterface()) {
            kotlinx.coroutines.future.a.q("API declarations must be interfaces.");
            return null;
        }
    ...
    public final m d(Type type, Annotation[] annotationArr) {
        ...
        int size = list.size();
        for (int i = iIndexOf; i < size; i++) {
            m mVarB = ((l) list.get(i)).b(type, annotationArr, this);
            if (mVarB != null) {
                return mVarB;
            }
        }
